...
public final class VintageMarketDeliverItemReqOuterClass {
  ...
  public interface VintageMarketDeliverItemReqOrBuilder extends
     ...
     * <code>repeated .ItemParam deliver_item_list = 12;</code>
     */
    emu.gingerps.net.proto.ItemParamOuterClass.ItemParam getDeliverItemList(int index);
    /**
     * <code>repeated .ItemParam deliver_item_list = 12;</code>
     */
     ...
     * <code>repeated .ItemParam deliver_item_list = 12;</code>
     */
    emu.gingerps.net.proto.ItemParamOuterClass.ItemParamOrBuilder getDeliverItemListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 98: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                deliverItemList_ = new java.util.ArrayList<emu.gingerps.net.proto.ItemParamOuterClass.ItemParam>();
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.gingerps.net.proto.VintageMarketDeliverItemReqOuterClass.internal_static_VintageMarketDeliverItemReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.gingerps.net.proto.VintageMarketDeliverItemReqOuterClass.internal_static_VintageMarketDeliverItemReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.VintageMarketDeliverItemReqOuterClass.VintageMarketDeliverItemReq.class, emu.gingerps.net.proto.VintageMarketDeliverItemReqOuterClass.VintageMarketDeliverItemReq.Builder.class);
    }

    public static final int DELIVER_ITEM_LIST_FIELD_NUMBER = 12;
    private java.util.List<emu.gingerps.net.proto.ItemParamOuterClass.ItemParam> deliverItemList_;
    /**
     * <code>repeated .ItemParam deliver_item_list = 12;</code>
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.ItemParamOuterClass.ItemParam> getDeliverItemListList() {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.ItemParamOuterClass.ItemParam getDeliverItemList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.ItemParamOuterClass.ItemParamOrBuilder getDeliverItemListOrBuilder(
        int index) {
      return deliverItemList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.VintageMarketDeliverItemReqOuterClass.VintageMarketDeliverItemReq)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.VintageMarketDeliverItemReqOuterClass.VintageMarketDeliverItemReq other = (emu.gingerps.net.proto.VintageMarketDeliverItemReqOuterClass.VintageMarketDeliverItemReq) obj;
    ...
    public static emu.gingerps.net.proto.VintageMarketDeliverItemReqOuterClass.VintageMarketDeliverItemReq parseFrom(
    ...
    public static emu.gingerps.net.proto.VintageMarketDeliverItemReqOuterClass.VintageMarketDeliverItemReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.VintageMarketDeliverItemReqOuterClass.VintageMarketDeliverItemReq parseFrom(
    ...
    public static emu.gingerps.net.proto.VintageMarketDeliverItemReqOuterClass.VintageMarketDeliverItemReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.VintageMarketDeliverItemReqOuterClass.VintageMarketDeliverItemReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.VintageMarketDeliverItemReqOuterClass.VintageMarketDeliverItemReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.VintageMarketDeliverItemReqOuterClass.VintageMarketDeliverItemReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.VintageMarketDeliverItemReqOuterClass.VintageMarketDeliverItemReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.VintageMarketDeliverItemReqOuterClass.internal_static_VintageMarketDeliverItemReq_descriptor;
      }
      ...
      // Construct using emu.gingerps.net.proto.VintageMarketDeliverItemReqOuterClass.VintageMarketDeliverItemReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.VintageMarketDeliverItemReqOuterClass.VintageMarketDeliverItemReq getDefaultInstanceForType() {
        return emu.gingerps.net.proto.VintageMarketDeliverItemReqOuterClass.VintageMarketDeliverItemReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.VintageMarketDeliverItemReqOuterClass.VintageMarketDeliverItemReq build() {
        emu.gingerps.net.proto.VintageMarketDeliverItemReqOuterClass.VintageMarketDeliverItemReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.VintageMarketDeliverItemReqOuterClass.VintageMarketDeliverItemReq buildPartial() {
        emu.gingerps.net.proto.VintageMarketDeliverItemReqOuterClass.VintageMarketDeliverItemReq result = new emu.gingerps.net.proto.VintageMarketDeliverItemReqOuterClass.VintageMarketDeliverItemReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.VintageMarketDeliverItemReqOuterClass.VintageMarketDeliverItemReq) {
          return mergeFrom((emu.gingerps.net.proto.VintageMarketDeliverItemReqOuterClass.VintageMarketDeliverItemReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.VintageMarketDeliverItemReqOuterClass.VintageMarketDeliverItemReq other) {
        if (other == emu.gingerps.net.proto.VintageMarketDeliverItemReqOuterClass.VintageMarketDeliverItemReq.getDefaultInstance()) return this;
        if (deliverItemListBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        emu.gingerps.net.proto.VintageMarketDeliverItemReqOuterClass.VintageMarketDeliverItemReq parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (emu.gingerps.net.proto.VintageMarketDeliverItemReqOuterClass.VintageMarketDeliverItemReq) e.getUnfinishedMessage();
      ...
      private void ensureDeliverItemListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          deliverItemList_ = new java.util.ArrayList<emu.gingerps.net.proto.ItemParamOuterClass.ItemParam>(deliverItemList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.ItemParamOuterClass.ItemParam, emu.gingerps.net.proto.ItemParamOuterClass.ItemParam.Builder, emu.gingerps.net.proto.ItemParamOuterClass.ItemParamOrBuilder> deliverItemListBuilder_;
       ...
       * <code>repeated .ItemParam deliver_item_list = 12;</code>
       */
      public Builder addDeliverItemList(emu.gingerps.net.proto.ItemParamOuterClass.ItemParam value) {
        if (deliverItemListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .ItemParam deliver_item_list = 12;</code>
       */
      public emu.gingerps.net.proto.ItemParamOuterClass.ItemParam.Builder getDeliverItemListBuilder(
          int index) {
       ...
       * <code>repeated .ItemParam deliver_item_list = 12;</code>
       */
      public emu.gingerps.net.proto.ItemParamOuterClass.ItemParam.Builder addDeliverItemListBuilder() {
    ...
    private static final emu.gingerps.net.proto.VintageMarketDeliverItemReqOuterClass.VintageMarketDeliverItemReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.VintageMarketDeliverItemReqOuterClass.VintageMarketDeliverItemReq();
    }

    public static emu.gingerps.net.proto.VintageMarketDeliverItemReqOuterClass.VintageMarketDeliverItemReq getDefaultInstance() {
