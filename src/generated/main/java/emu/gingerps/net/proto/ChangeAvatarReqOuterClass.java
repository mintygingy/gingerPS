...
public final class ChangeAvatarReqOuterClass {
  ...
  public interface ChangeAvatarReqOrBuilder extends
     ...
     * @return The movePos.
     */
    emu.gingerps.net.proto.VectorOuterClass.Vector getMovePos();
    /**
     * <code>.Vector move_pos = 9;</code>
     */
    emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder getMovePosOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.ChangeAvatarReqOuterClass.internal_static_ChangeAvatarReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.ChangeAvatarReqOuterClass.ChangeAvatarReq.class, emu.gingerps.net.proto.ChangeAvatarReqOuterClass.ChangeAvatarReq.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.VectorOuterClass.Vector getMovePos() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.ChangeAvatarReqOuterClass.ChangeAvatarReq)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.ChangeAvatarReqOuterClass.ChangeAvatarReq other = (emu.gingerps.net.proto.ChangeAvatarReqOuterClass.ChangeAvatarReq) obj;
    ...
    public static emu.gingerps.net.proto.ChangeAvatarReqOuterClass.ChangeAvatarReq parseFrom(
    ...
    public static emu.gingerps.net.proto.ChangeAvatarReqOuterClass.ChangeAvatarReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.ChangeAvatarReqOuterClass.ChangeAvatarReq parseFrom(
    ...
    public static emu.gingerps.net.proto.ChangeAvatarReqOuterClass.ChangeAvatarReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.ChangeAvatarReqOuterClass.ChangeAvatarReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.ChangeAvatarReqOuterClass.ChangeAvatarReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.ChangeAvatarReqOuterClass.ChangeAvatarReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.ChangeAvatarReqOuterClass.ChangeAvatarReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.ChangeAvatarReqOuterClass.internal_static_ChangeAvatarReq_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.ChangeAvatarReqOuterClass.ChangeAvatarReq getDefaultInstanceForType() {
        return emu.gingerps.net.proto.ChangeAvatarReqOuterClass.ChangeAvatarReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.ChangeAvatarReqOuterClass.ChangeAvatarReq build() {
        emu.gingerps.net.proto.ChangeAvatarReqOuterClass.ChangeAvatarReq result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.ChangeAvatarReqOuterClass.ChangeAvatarReq) {
          return mergeFrom((emu.gingerps.net.proto.ChangeAvatarReqOuterClass.ChangeAvatarReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.ChangeAvatarReqOuterClass.ChangeAvatarReq other) {
        if (other == emu.gingerps.net.proto.ChangeAvatarReqOuterClass.ChangeAvatarReq.getDefaultInstance()) return this;
        if (other.hasMovePos()) {
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.VectorOuterClass.Vector, emu.gingerps.net.proto.VectorOuterClass.Vector.Builder, emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder> movePosBuilder_;
      /**
       * <code>.Vector move_pos = 9;</code>
       * @return Whether the movePos field is set.
       */
       ...
       * <code>.Vector move_pos = 9;</code>
       */
      public Builder setMovePos(emu.gingerps.net.proto.VectorOuterClass.Vector value) {
        if (movePosBuilder_ == null) {
          if (value == null) {
      ...
      public emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder getMovePosOrBuilder() {
        if (movePosBuilder_ != null) {
          ...
          return movePos_ == null ?
              emu.gingerps.net.proto.VectorOuterClass.Vector.getDefaultInstance() : movePos_;
        }
      }
      /**
       * <code>.Vector move_pos = 9;</code>
    ...
    private static final emu.gingerps.net.proto.ChangeAvatarReqOuterClass.ChangeAvatarReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.ChangeAvatarReqOuterClass.ChangeAvatarReq();
    }

    public static emu.gingerps.net.proto.ChangeAvatarReqOuterClass.ChangeAvatarReq getDefaultInstance() {
