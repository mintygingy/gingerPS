...
public final class FoundationNotifyOuterClass {
  ...
  public interface FoundationNotifyOrBuilder extends
     ...
     * @return The info.
     */
    emu.gingerps.net.proto.FoundationInfoOuterClass.FoundationInfo getInfo();
    /**
     * <code>.FoundationInfo info = 6;</code>
     */
    emu.gingerps.net.proto.FoundationInfoOuterClass.FoundationInfoOrBuilder getInfoOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.FoundationNotifyOuterClass.internal_static_FoundationNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.FoundationNotifyOuterClass.FoundationNotify.class, emu.gingerps.net.proto.FoundationNotifyOuterClass.FoundationNotify.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.FoundationInfoOuterClass.FoundationInfo getInfo() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.FoundationNotifyOuterClass.FoundationNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.FoundationNotifyOuterClass.FoundationNotify other = (emu.gingerps.net.proto.FoundationNotifyOuterClass.FoundationNotify) obj;
    ...
    public static emu.gingerps.net.proto.FoundationNotifyOuterClass.FoundationNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.FoundationNotifyOuterClass.FoundationNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.FoundationNotifyOuterClass.FoundationNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.FoundationNotifyOuterClass.FoundationNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.FoundationNotifyOuterClass.FoundationNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.FoundationNotifyOuterClass.FoundationNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.FoundationNotifyOuterClass.FoundationNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.FoundationNotifyOuterClass.FoundationNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.FoundationNotifyOuterClass.internal_static_FoundationNotify_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.FoundationNotifyOuterClass.FoundationNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.FoundationNotifyOuterClass.FoundationNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.FoundationNotifyOuterClass.FoundationNotify build() {
        emu.gingerps.net.proto.FoundationNotifyOuterClass.FoundationNotify result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.FoundationNotifyOuterClass.FoundationNotify) {
          return mergeFrom((emu.gingerps.net.proto.FoundationNotifyOuterClass.FoundationNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.FoundationNotifyOuterClass.FoundationNotify other) {
        if (other == emu.gingerps.net.proto.FoundationNotifyOuterClass.FoundationNotify.getDefaultInstance()) return this;
        if (other.hasInfo()) {
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.FoundationInfoOuterClass.FoundationInfo, emu.gingerps.net.proto.FoundationInfoOuterClass.FoundationInfo.Builder, emu.gingerps.net.proto.FoundationInfoOuterClass.FoundationInfoOrBuilder> infoBuilder_;
      /**
       * <code>.FoundationInfo info = 6;</code>
       * @return Whether the info field is set.
       */
       ...
       * <code>.FoundationInfo info = 6;</code>
       */
      public Builder setInfo(emu.gingerps.net.proto.FoundationInfoOuterClass.FoundationInfo value) {
        if (infoBuilder_ == null) {
          if (value == null) {
      ...
      public emu.gingerps.net.proto.FoundationInfoOuterClass.FoundationInfoOrBuilder getInfoOrBuilder() {
        if (infoBuilder_ != null) {
          ...
          return info_ == null ?
              emu.gingerps.net.proto.FoundationInfoOuterClass.FoundationInfo.getDefaultInstance() : info_;
        }
      }
      /**
       * <code>.FoundationInfo info = 6;</code>
    ...
    private static final emu.gingerps.net.proto.FoundationNotifyOuterClass.FoundationNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.FoundationNotifyOuterClass.FoundationNotify();
    }

    public static emu.gingerps.net.proto.FoundationNotifyOuterClass.FoundationNotify getDefaultInstance() {
