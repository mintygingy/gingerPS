...
public final class WorldPlayerRTTNotifyOuterClass {
  ...
  public interface WorldPlayerRTTNotifyOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.PlayerRTTInfoOuterClass.PlayerRTTInfo> 
        getPlayerRttListList();
    /**
     * <code>repeated .PlayerRTTInfo player_rtt_list = 6;</code>
     */
    emu.gingerps.net.proto.PlayerRTTInfoOuterClass.PlayerRTTInfo getPlayerRttList(int index);
    /**
     * <code>repeated .PlayerRTTInfo player_rtt_list = 6;</code>
     */
     ...
     * <code>repeated .PlayerRTTInfo player_rtt_list = 6;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.PlayerRTTInfoOuterClass.PlayerRTTInfoOrBuilder> 
        getPlayerRttListOrBuilderList();
    /**
     * <code>repeated .PlayerRTTInfo player_rtt_list = 6;</code>
     */
    emu.gingerps.net.proto.PlayerRTTInfoOuterClass.PlayerRTTInfoOrBuilder getPlayerRttListOrBuilder(
        int index);
  }
  /**
   * <pre>
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.WorldPlayerRTTNotifyOuterClass.internal_static_WorldPlayerRTTNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.WorldPlayerRTTNotifyOuterClass.WorldPlayerRTTNotify.class, emu.gingerps.net.proto.WorldPlayerRTTNotifyOuterClass.WorldPlayerRTTNotify.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.PlayerRTTInfoOuterClass.PlayerRTTInfo> getPlayerRttListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.PlayerRTTInfoOuterClass.PlayerRTTInfoOrBuilder> 
        getPlayerRttListOrBuilderList() {
      return playerRttList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.PlayerRTTInfoOuterClass.PlayerRTTInfo getPlayerRttList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.PlayerRTTInfoOuterClass.PlayerRTTInfoOrBuilder getPlayerRttListOrBuilder(
        int index) {
      return playerRttList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.WorldPlayerRTTNotifyOuterClass.WorldPlayerRTTNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.WorldPlayerRTTNotifyOuterClass.WorldPlayerRTTNotify other = (emu.gingerps.net.proto.WorldPlayerRTTNotifyOuterClass.WorldPlayerRTTNotify) obj;
    ...
    public static emu.gingerps.net.proto.WorldPlayerRTTNotifyOuterClass.WorldPlayerRTTNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.WorldPlayerRTTNotifyOuterClass.WorldPlayerRTTNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.WorldPlayerRTTNotifyOuterClass.WorldPlayerRTTNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.WorldPlayerRTTNotifyOuterClass.WorldPlayerRTTNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.WorldPlayerRTTNotifyOuterClass.WorldPlayerRTTNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.WorldPlayerRTTNotifyOuterClass.WorldPlayerRTTNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.WorldPlayerRTTNotifyOuterClass.WorldPlayerRTTNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.WorldPlayerRTTNotifyOuterClass.WorldPlayerRTTNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.WorldPlayerRTTNotifyOuterClass.internal_static_WorldPlayerRTTNotify_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.WorldPlayerRTTNotifyOuterClass.WorldPlayerRTTNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.WorldPlayerRTTNotifyOuterClass.WorldPlayerRTTNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.WorldPlayerRTTNotifyOuterClass.WorldPlayerRTTNotify build() {
        emu.gingerps.net.proto.WorldPlayerRTTNotifyOuterClass.WorldPlayerRTTNotify result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.WorldPlayerRTTNotifyOuterClass.WorldPlayerRTTNotify) {
          return mergeFrom((emu.gingerps.net.proto.WorldPlayerRTTNotifyOuterClass.WorldPlayerRTTNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.WorldPlayerRTTNotifyOuterClass.WorldPlayerRTTNotify other) {
        if (other == emu.gingerps.net.proto.WorldPlayerRTTNotifyOuterClass.WorldPlayerRTTNotify.getDefaultInstance()) return this;
        if (playerRttListBuilder_ == null) {
      ...
      private void ensurePlayerRttListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          playerRttList_ = new java.util.ArrayList<emu.gingerps.net.proto.PlayerRTTInfoOuterClass.PlayerRTTInfo>(playerRttList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.PlayerRTTInfoOuterClass.PlayerRTTInfo, emu.gingerps.net.proto.PlayerRTTInfoOuterClass.PlayerRTTInfo.Builder, emu.gingerps.net.proto.PlayerRTTInfoOuterClass.PlayerRTTInfoOrBuilder> playerRttListBuilder_;
      ...
      public Builder setPlayerRttList(
          int index, emu.gingerps.net.proto.PlayerRTTInfoOuterClass.PlayerRTTInfo value) {
        if (playerRttListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setPlayerRttList(
          int index, emu.gingerps.net.proto.PlayerRTTInfoOuterClass.PlayerRTTInfo.Builder builderForValue) {
        if (playerRttListBuilder_ == null) {
          ensurePlayerRttListIsMutable();
       ...
       * <code>repeated .PlayerRTTInfo player_rtt_list = 6;</code>
       */
      public Builder addPlayerRttList(emu.gingerps.net.proto.PlayerRTTInfoOuterClass.PlayerRTTInfo value) {
        if (playerRttListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addPlayerRttList(
          emu.gingerps.net.proto.PlayerRTTInfoOuterClass.PlayerRTTInfo.Builder builderForValue) {
        if (playerRttListBuilder_ == null) {
          ensurePlayerRttListIsMutable();
      ...
      public Builder addAllPlayerRttList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.PlayerRTTInfoOuterClass.PlayerRTTInfo> values) {
        if (playerRttListBuilder_ == null) {
          ensurePlayerRttListIsMutable();
       ...
       * <code>repeated .PlayerRTTInfo player_rtt_list = 6;</code>
       */
      public emu.gingerps.net.proto.PlayerRTTInfoOuterClass.PlayerRTTInfo.Builder getPlayerRttListBuilder(
          int index) {
       ...
       * <code>repeated .PlayerRTTInfo player_rtt_list = 6;</code>
       */
      public emu.gingerps.net.proto.PlayerRTTInfoOuterClass.PlayerRTTInfo.Builder addPlayerRttListBuilder() {
        return getPlayerRttListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.PlayerRTTInfoOuterClass.PlayerRTTInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .PlayerRTTInfo player_rtt_list = 6;</code>
       */
      public emu.gingerps.net.proto.PlayerRTTInfoOuterClass.PlayerRTTInfo.Builder addPlayerRttListBuilder(
          int index) {
        return getPlayerRttListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.PlayerRTTInfoOuterClass.PlayerRTTInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .PlayerRTTInfo player_rtt_list = 6;</code>
       */
      public java.util.List<emu.gingerps.net.proto.PlayerRTTInfoOuterClass.PlayerRTTInfo.Builder> 
           getPlayerRttListBuilderList() {
        return getPlayerRttListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.PlayerRTTInfoOuterClass.PlayerRTTInfo, emu.gingerps.net.proto.PlayerRTTInfoOuterClass.PlayerRTTInfo.Builder, emu.gingerps.net.proto.PlayerRTTInfoOuterClass.PlayerRTTInfoOrBuilder> 
          getPlayerRttListFieldBuilder() {
        if (playerRttListBuilder_ == null) {
    ...
    private static final emu.gingerps.net.proto.WorldPlayerRTTNotifyOuterClass.WorldPlayerRTTNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.WorldPlayerRTTNotifyOuterClass.WorldPlayerRTTNotify();
    }

    public static emu.gingerps.net.proto.WorldPlayerRTTNotifyOuterClass.WorldPlayerRTTNotify getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.PlayerRTTInfoOuterClass.getDescriptor(),
        });
    internal_static_WorldPlayerRTTNotify_descriptor =
