...
public final class MiracleRingDeliverItemRspOuterClass {
  ...
  public interface MiracleRingDeliverItemRspOrBuilder extends
     ...
     */
    emu.gingerps.net.proto.InteractTypeOuterClass.InteractType getInteractType();
  }
  /**
   * <pre>
   * enum CmdId {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.MiracleRingDeliverItemRspOuterClass.internal_static_MiracleRingDeliverItemRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp.class, emu.gingerps.net.proto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp.Builder.class);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (interactType_ != emu.gingerps.net.proto.InteractTypeOuterClass.InteractType.INTERACT_TYPE_NONE.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp other = (emu.gingerps.net.proto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp) obj;
    ...
    public static emu.gingerps.net.proto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.MiracleRingDeliverItemRspOuterClass.internal_static_MiracleRingDeliverItemRsp_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp getDefaultInstanceForType() {
        return emu.gingerps.net.proto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp build() {
        emu.gingerps.net.proto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp) {
          return mergeFrom((emu.gingerps.net.proto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp other) {
        if (other == emu.gingerps.net.proto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp.getDefaultInstance()) return this;
       ...
       * @return This builder for chaining.
       */
      public Builder setInteractType(emu.gingerps.net.proto.InteractTypeOuterClass.InteractType value) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    private static final emu.gingerps.net.proto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp();
    }

    public static emu.gingerps.net.proto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "nteract_type\030\014 \001(\0162\r.InteractTypeB\030\n\026emu" +
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          ...
          emu.gingerps.net.proto.InteractTypeOuterClass.getDescriptor(),
        });
    internal_static_MiracleRingDeliverItemRsp_descriptor =
