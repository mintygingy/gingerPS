...
public final class PlayerQuitFromHomeNotifyOuterClass {
  ...
  public interface PlayerQuitFromHomeNotifyOrBuilder extends
     ...
     * @return The reason.
     */
    emu.gingerps.net.proto.PlayerQuitFromHomeNotifyOuterClass.PlayerQuitFromHomeNotify.QuitReason getReason();
  }
  /**
   * <pre>
   * enum CmdId {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.PlayerQuitFromHomeNotifyOuterClass.internal_static_PlayerQuitFromHomeNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.PlayerQuitFromHomeNotifyOuterClass.PlayerQuitFromHomeNotify.class, emu.gingerps.net.proto.PlayerQuitFromHomeNotifyOuterClass.PlayerQuitFromHomeNotify.Builder.class);
    }
    ...
    public enum QuitReason
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return emu.gingerps.net.proto.PlayerQuitFromHomeNotifyOuterClass.PlayerQuitFromHomeNotify.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.PlayerQuitFromHomeNotifyOuterClass.PlayerQuitFromHomeNotify)) {
    ...
    public static emu.gingerps.net.proto.PlayerQuitFromHomeNotifyOuterClass.PlayerQuitFromHomeNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.PlayerQuitFromHomeNotifyOuterClass.PlayerQuitFromHomeNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.PlayerQuitFromHomeNotifyOuterClass.PlayerQuitFromHomeNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.PlayerQuitFromHomeNotifyOuterClass.PlayerQuitFromHomeNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.PlayerQuitFromHomeNotifyOuterClass.PlayerQuitFromHomeNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.PlayerQuitFromHomeNotifyOuterClass.PlayerQuitFromHomeNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.PlayerQuitFromHomeNotifyOuterClass.PlayerQuitFromHomeNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.PlayerQuitFromHomeNotifyOuterClass.PlayerQuitFromHomeNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.PlayerQuitFromHomeNotifyOuterClass.internal_static_PlayerQuitFromHomeNotify_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.PlayerQuitFromHomeNotifyOuterClass.PlayerQuitFromHomeNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.PlayerQuitFromHomeNotifyOuterClass.PlayerQuitFromHomeNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.PlayerQuitFromHomeNotifyOuterClass.PlayerQuitFromHomeNotify build() {
        emu.gingerps.net.proto.PlayerQuitFromHomeNotifyOuterClass.PlayerQuitFromHomeNotify result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.PlayerQuitFromHomeNotifyOuterClass.PlayerQuitFromHomeNotify) {
          return mergeFrom((emu.gingerps.net.proto.PlayerQuitFromHomeNotifyOuterClass.PlayerQuitFromHomeNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.PlayerQuitFromHomeNotifyOuterClass.PlayerQuitFromHomeNotify other) {
        if (other == emu.gingerps.net.proto.PlayerQuitFromHomeNotifyOuterClass.PlayerQuitFromHomeNotify.getDefaultInstance()) return this;
        if (other.reason_ != 0) {
       ...
       * @return This builder for chaining.
       */
      public Builder setReason(emu.gingerps.net.proto.PlayerQuitFromHomeNotifyOuterClass.PlayerQuitFromHomeNotify.QuitReason value) {
        if (value == null) {
    ...
    private static final emu.gingerps.net.proto.PlayerQuitFromHomeNotifyOuterClass.PlayerQuitFromHomeNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.PlayerQuitFromHomeNotifyOuterClass.PlayerQuitFromHomeNotify();
    }

    public static emu.gingerps.net.proto.PlayerQuitFromHomeNotifyOuterClass.PlayerQuitFromHomeNotify getDefaultInstance() {
