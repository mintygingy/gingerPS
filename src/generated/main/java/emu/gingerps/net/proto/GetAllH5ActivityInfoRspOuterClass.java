...
public final class GetAllH5ActivityInfoRspOuterClass {
  ...
  public interface GetAllH5ActivityInfoRspOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.H5ActivityInfoOuterClass.H5ActivityInfo> 
        getH5ActivityInfoListList();
    /**
     * <code>repeated .H5ActivityInfo h5_activity_info_list = 5;</code>
     */
    emu.gingerps.net.proto.H5ActivityInfoOuterClass.H5ActivityInfo getH5ActivityInfoList(int index);
    /**
     * <code>repeated .H5ActivityInfo h5_activity_info_list = 5;</code>
     */
     ...
     * <code>repeated .H5ActivityInfo h5_activity_info_list = 5;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.H5ActivityInfoOuterClass.H5ActivityInfoOrBuilder> 
        getH5ActivityInfoListOrBuilderList();
    /**
     * <code>repeated .H5ActivityInfo h5_activity_info_list = 5;</code>
     */
    emu.gingerps.net.proto.H5ActivityInfoOuterClass.H5ActivityInfoOrBuilder getH5ActivityInfoListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.GetAllH5ActivityInfoRspOuterClass.internal_static_GetAllH5ActivityInfoRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.GetAllH5ActivityInfoRspOuterClass.GetAllH5ActivityInfoRsp.class, emu.gingerps.net.proto.GetAllH5ActivityInfoRspOuterClass.GetAllH5ActivityInfoRsp.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.H5ActivityInfoOuterClass.H5ActivityInfo> getH5ActivityInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.H5ActivityInfoOuterClass.H5ActivityInfoOrBuilder> 
        getH5ActivityInfoListOrBuilderList() {
      return h5ActivityInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.H5ActivityInfoOuterClass.H5ActivityInfo getH5ActivityInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.H5ActivityInfoOuterClass.H5ActivityInfoOrBuilder getH5ActivityInfoListOrBuilder(
        int index) {
      return h5ActivityInfoList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.GetAllH5ActivityInfoRspOuterClass.GetAllH5ActivityInfoRsp)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.GetAllH5ActivityInfoRspOuterClass.GetAllH5ActivityInfoRsp other = (emu.gingerps.net.proto.GetAllH5ActivityInfoRspOuterClass.GetAllH5ActivityInfoRsp) obj;
    ...
    public static emu.gingerps.net.proto.GetAllH5ActivityInfoRspOuterClass.GetAllH5ActivityInfoRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.GetAllH5ActivityInfoRspOuterClass.GetAllH5ActivityInfoRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.GetAllH5ActivityInfoRspOuterClass.GetAllH5ActivityInfoRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.GetAllH5ActivityInfoRspOuterClass.GetAllH5ActivityInfoRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.GetAllH5ActivityInfoRspOuterClass.GetAllH5ActivityInfoRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.GetAllH5ActivityInfoRspOuterClass.GetAllH5ActivityInfoRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.GetAllH5ActivityInfoRspOuterClass.GetAllH5ActivityInfoRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.GetAllH5ActivityInfoRspOuterClass.GetAllH5ActivityInfoRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.GetAllH5ActivityInfoRspOuterClass.internal_static_GetAllH5ActivityInfoRsp_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.GetAllH5ActivityInfoRspOuterClass.GetAllH5ActivityInfoRsp getDefaultInstanceForType() {
        return emu.gingerps.net.proto.GetAllH5ActivityInfoRspOuterClass.GetAllH5ActivityInfoRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.GetAllH5ActivityInfoRspOuterClass.GetAllH5ActivityInfoRsp build() {
        emu.gingerps.net.proto.GetAllH5ActivityInfoRspOuterClass.GetAllH5ActivityInfoRsp result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.GetAllH5ActivityInfoRspOuterClass.GetAllH5ActivityInfoRsp) {
          return mergeFrom((emu.gingerps.net.proto.GetAllH5ActivityInfoRspOuterClass.GetAllH5ActivityInfoRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.GetAllH5ActivityInfoRspOuterClass.GetAllH5ActivityInfoRsp other) {
        if (other == emu.gingerps.net.proto.GetAllH5ActivityInfoRspOuterClass.GetAllH5ActivityInfoRsp.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.H5ActivityInfoOuterClass.H5ActivityInfo, emu.gingerps.net.proto.H5ActivityInfoOuterClass.H5ActivityInfo.Builder, emu.gingerps.net.proto.H5ActivityInfoOuterClass.H5ActivityInfoOrBuilder> h5ActivityInfoListBuilder_;
      ...
      public Builder setH5ActivityInfoList(
          int index, emu.gingerps.net.proto.H5ActivityInfoOuterClass.H5ActivityInfo value) {
        if (h5ActivityInfoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setH5ActivityInfoList(
          int index, emu.gingerps.net.proto.H5ActivityInfoOuterClass.H5ActivityInfo.Builder builderForValue) {
        if (h5ActivityInfoListBuilder_ == null) {
          ensureH5ActivityInfoListIsMutable();
       ...
       * <code>repeated .H5ActivityInfo h5_activity_info_list = 5;</code>
       */
      public Builder addH5ActivityInfoList(emu.gingerps.net.proto.H5ActivityInfoOuterClass.H5ActivityInfo value) {
        if (h5ActivityInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addH5ActivityInfoList(
          emu.gingerps.net.proto.H5ActivityInfoOuterClass.H5ActivityInfo.Builder builderForValue) {
        if (h5ActivityInfoListBuilder_ == null) {
          ensureH5ActivityInfoListIsMutable();
      ...
      public Builder addAllH5ActivityInfoList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.H5ActivityInfoOuterClass.H5ActivityInfo> values) {
        if (h5ActivityInfoListBuilder_ == null) {
          ensureH5ActivityInfoListIsMutable();
       ...
       * <code>repeated .H5ActivityInfo h5_activity_info_list = 5;</code>
       */
      public emu.gingerps.net.proto.H5ActivityInfoOuterClass.H5ActivityInfo.Builder getH5ActivityInfoListBuilder(
          int index) {
       ...
       * <code>repeated .H5ActivityInfo h5_activity_info_list = 5;</code>
       */
      public emu.gingerps.net.proto.H5ActivityInfoOuterClass.H5ActivityInfo.Builder addH5ActivityInfoListBuilder() {
        return getH5ActivityInfoListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.H5ActivityInfoOuterClass.H5ActivityInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .H5ActivityInfo h5_activity_info_list = 5;</code>
       */
      public emu.gingerps.net.proto.H5ActivityInfoOuterClass.H5ActivityInfo.Builder addH5ActivityInfoListBuilder(
          int index) {
        return getH5ActivityInfoListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.H5ActivityInfoOuterClass.H5ActivityInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .H5ActivityInfo h5_activity_info_list = 5;</code>
       */
      public java.util.List<emu.gingerps.net.proto.H5ActivityInfoOuterClass.H5ActivityInfo.Builder> 
    ...
    private static final emu.gingerps.net.proto.GetAllH5ActivityInfoRspOuterClass.GetAllH5ActivityInfoRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.GetAllH5ActivityInfoRspOuterClass.GetAllH5ActivityInfoRsp();
    }

    public static emu.gingerps.net.proto.GetAllH5ActivityInfoRspOuterClass.GetAllH5ActivityInfoRsp getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.H5ActivityInfoOuterClass.getDescriptor(),
        });
    internal_static_GetAllH5ActivityInfoRsp_descriptor =
