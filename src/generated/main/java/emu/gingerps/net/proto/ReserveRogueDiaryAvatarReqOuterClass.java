...
public final class ReserveRogueDiaryAvatarReqOuterClass {
  ...
  public interface ReserveRogueDiaryAvatarReqOrBuilder extends
     ...
     * <code>repeated .RogueDiaryAvatar reserve_avatar_list = 3;</code>
     */
    emu.gingerps.net.proto.RogueDiaryAvatarOuterClass.RogueDiaryAvatar getReserveAvatarList(int index);
    /**
     * <code>repeated .RogueDiaryAvatar reserve_avatar_list = 3;</code>
     */
     ...
     * <code>repeated .RogueDiaryAvatar reserve_avatar_list = 3;</code>
     */
    emu.gingerps.net.proto.RogueDiaryAvatarOuterClass.RogueDiaryAvatarOrBuilder getReserveAvatarListOrBuilder(
        int index);
  }
  /**
   * <pre>
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.ReserveRogueDiaryAvatarReqOuterClass.internal_static_ReserveRogueDiaryAvatarReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.ReserveRogueDiaryAvatarReqOuterClass.ReserveRogueDiaryAvatarReq.class, emu.gingerps.net.proto.ReserveRogueDiaryAvatarReqOuterClass.ReserveRogueDiaryAvatarReq.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.RogueDiaryAvatarOuterClass.RogueDiaryAvatar> getReserveAvatarListList() {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.RogueDiaryAvatarOuterClass.RogueDiaryAvatar getReserveAvatarList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.RogueDiaryAvatarOuterClass.RogueDiaryAvatarOrBuilder getReserveAvatarListOrBuilder(
        int index) {
      return reserveAvatarList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.ReserveRogueDiaryAvatarReqOuterClass.ReserveRogueDiaryAvatarReq)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.ReserveRogueDiaryAvatarReqOuterClass.ReserveRogueDiaryAvatarReq other = (emu.gingerps.net.proto.ReserveRogueDiaryAvatarReqOuterClass.ReserveRogueDiaryAvatarReq) obj;
    ...
    public static emu.gingerps.net.proto.ReserveRogueDiaryAvatarReqOuterClass.ReserveRogueDiaryAvatarReq parseFrom(
    ...
    public static emu.gingerps.net.proto.ReserveRogueDiaryAvatarReqOuterClass.ReserveRogueDiaryAvatarReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.ReserveRogueDiaryAvatarReqOuterClass.ReserveRogueDiaryAvatarReq parseFrom(
    ...
    public static emu.gingerps.net.proto.ReserveRogueDiaryAvatarReqOuterClass.ReserveRogueDiaryAvatarReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.ReserveRogueDiaryAvatarReqOuterClass.ReserveRogueDiaryAvatarReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.ReserveRogueDiaryAvatarReqOuterClass.ReserveRogueDiaryAvatarReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.ReserveRogueDiaryAvatarReqOuterClass.ReserveRogueDiaryAvatarReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.ReserveRogueDiaryAvatarReqOuterClass.ReserveRogueDiaryAvatarReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.ReserveRogueDiaryAvatarReqOuterClass.internal_static_ReserveRogueDiaryAvatarReq_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.ReserveRogueDiaryAvatarReqOuterClass.ReserveRogueDiaryAvatarReq getDefaultInstanceForType() {
        return emu.gingerps.net.proto.ReserveRogueDiaryAvatarReqOuterClass.ReserveRogueDiaryAvatarReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.ReserveRogueDiaryAvatarReqOuterClass.ReserveRogueDiaryAvatarReq build() {
        emu.gingerps.net.proto.ReserveRogueDiaryAvatarReqOuterClass.ReserveRogueDiaryAvatarReq result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.ReserveRogueDiaryAvatarReqOuterClass.ReserveRogueDiaryAvatarReq) {
          return mergeFrom((emu.gingerps.net.proto.ReserveRogueDiaryAvatarReqOuterClass.ReserveRogueDiaryAvatarReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.ReserveRogueDiaryAvatarReqOuterClass.ReserveRogueDiaryAvatarReq other) {
        if (other == emu.gingerps.net.proto.ReserveRogueDiaryAvatarReqOuterClass.ReserveRogueDiaryAvatarReq.getDefaultInstance()) return this;
        if (reserveAvatarListBuilder_ == null) {
      ...
      private void ensureReserveAvatarListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          reserveAvatarList_ = new java.util.ArrayList<emu.gingerps.net.proto.RogueDiaryAvatarOuterClass.RogueDiaryAvatar>(reserveAvatarList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.RogueDiaryAvatarOuterClass.RogueDiaryAvatar, emu.gingerps.net.proto.RogueDiaryAvatarOuterClass.RogueDiaryAvatar.Builder, emu.gingerps.net.proto.RogueDiaryAvatarOuterClass.RogueDiaryAvatarOrBuilder> reserveAvatarListBuilder_;
       ...
       * <code>repeated .RogueDiaryAvatar reserve_avatar_list = 3;</code>
       */
      public Builder addReserveAvatarList(emu.gingerps.net.proto.RogueDiaryAvatarOuterClass.RogueDiaryAvatar value) {
        if (reserveAvatarListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .RogueDiaryAvatar reserve_avatar_list = 3;</code>
       */
      public emu.gingerps.net.proto.RogueDiaryAvatarOuterClass.RogueDiaryAvatar.Builder getReserveAvatarListBuilder(
          int index) {
       ...
       * <code>repeated .RogueDiaryAvatar reserve_avatar_list = 3;</code>
       */
      public emu.gingerps.net.proto.RogueDiaryAvatarOuterClass.RogueDiaryAvatar.Builder addReserveAvatarListBuilder() {
    ...
    private static final emu.gingerps.net.proto.ReserveRogueDiaryAvatarReqOuterClass.ReserveRogueDiaryAvatarReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.ReserveRogueDiaryAvatarReqOuterClass.ReserveRogueDiaryAvatarReq();
    }

    public static emu.gingerps.net.proto.ReserveRogueDiaryAvatarReqOuterClass.ReserveRogueDiaryAvatarReq getDefaultInstance() {
