...
public final class BrickBreakerDetailInfoOuterClass {
  ...
  public interface BrickBreakerDetailInfoOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo> 
        getStageInfoListList();
    /**
     * <code>repeated .BrickBreakerActivityStageInfo stage_info_list = 13;</code>
     */
    emu.gingerps.net.proto.BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo getStageInfoList(int index);
    /**
     * <code>repeated .BrickBreakerActivityStageInfo stage_info_list = 13;</code>
     */
     ...
     * <code>repeated .BrickBreakerActivityStageInfo stage_info_list = 13;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfoOrBuilder> 
        getStageInfoListOrBuilderList();
    /**
     * <code>repeated .BrickBreakerActivityStageInfo stage_info_list = 13;</code>
     */
    emu.gingerps.net.proto.BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfoOrBuilder getStageInfoListOrBuilder(
        int index);

    /**
     * <code>repeated .BrickBreakerLevelInfo Unk3300_AIEGOACOINO = 9;</code>
     */
    java.util.List<emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo> 
        getUnk3300AIEGOACOINOList();
    /**
     * <code>repeated .BrickBreakerLevelInfo Unk3300_AIEGOACOINO = 9;</code>
     */
    emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo getUnk3300AIEGOACOINO(int index);
    /**
     * <code>repeated .BrickBreakerLevelInfo Unk3300_AIEGOACOINO = 9;</code>
     */
     ...
     * <code>repeated .BrickBreakerLevelInfo Unk3300_AIEGOACOINO = 9;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfoOrBuilder> 
        getUnk3300AIEGOACOINOOrBuilderList();
    /**
     * <code>repeated .BrickBreakerLevelInfo Unk3300_AIEGOACOINO = 9;</code>
     */
    emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfoOrBuilder getUnk3300AIEGOACOINOOrBuilder(
        int index);
     ...
     * <code>repeated .BrickBreakerLevelInfo Unk3300_BCHEELFPNCD = 11;</code>
     */
    emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo getUnk3300BCHEELFPNCD(int index);
    /**
     * <code>repeated .BrickBreakerLevelInfo Unk3300_BCHEELFPNCD = 11;</code>
     */
     ...
     * <code>repeated .BrickBreakerLevelInfo Unk3300_BCHEELFPNCD = 11;</code>
     */
    emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfoOrBuilder getUnk3300BCHEELFPNCDOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 74: {
              if (!((mutable_bitField0_ & 0x00000002) != 0)) {
                unk3300AIEGOACOINO_ = new java.util.ArrayList<emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo>();
                mutable_bitField0_ |= 0x00000002;
              }
              unk3300AIEGOACOINO_.add(
                  input.readMessage(emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.parser(), extensionRegistry));
              break;
            }
            case 90: {
              if (!((mutable_bitField0_ & 0x00000004) != 0)) {
                unk3300BCHEELFPNCD_ = new java.util.ArrayList<emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo>();
            ...
            case 106: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                stageInfoList_ = new java.util.ArrayList<emu.gingerps.net.proto.BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo>();
                mutable_bitField0_ |= 0x00000001;
              }
              stageInfoList_.add(
                  input.readMessage(emu.gingerps.net.proto.BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo.parser(), extensionRegistry));
              break;
            }
            default: {
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.gingerps.net.proto.BrickBreakerDetailInfoOuterClass.internal_static_BrickBreakerDetailInfo_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.BrickBreakerDetailInfoOuterClass.internal_static_BrickBreakerDetailInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.BrickBreakerDetailInfoOuterClass.BrickBreakerDetailInfo.class, emu.gingerps.net.proto.BrickBreakerDetailInfoOuterClass.BrickBreakerDetailInfo.Builder.class);
    }

    public static final int STAGE_INFO_LIST_FIELD_NUMBER = 13;
    private java.util.List<emu.gingerps.net.proto.BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo> stageInfoList_;
    /**
     * <code>repeated .BrickBreakerActivityStageInfo stage_info_list = 13;</code>
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo> getStageInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfoOrBuilder> 
        getStageInfoListOrBuilderList() {
      return stageInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo getStageInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfoOrBuilder getStageInfoListOrBuilder(
        int index) {
      return stageInfoList_.get(index);
    }

    public static final int UNK3300_AIEGOACOINO_FIELD_NUMBER = 9;
    private java.util.List<emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo> unk3300AIEGOACOINO_;
    /**
     * <code>repeated .BrickBreakerLevelInfo Unk3300_AIEGOACOINO = 9;</code>
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo> getUnk3300AIEGOACOINOList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfoOrBuilder> 
        getUnk3300AIEGOACOINOOrBuilderList() {
      return unk3300AIEGOACOINO_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo getUnk3300AIEGOACOINO(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfoOrBuilder getUnk3300AIEGOACOINOOrBuilder(
        int index) {
      return unk3300AIEGOACOINO_.get(index);
    }

    public static final int UNK3300_BCHEELFPNCD_FIELD_NUMBER = 11;
    private java.util.List<emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo> unk3300BCHEELFPNCD_;
    /**
     * <code>repeated .BrickBreakerLevelInfo Unk3300_BCHEELFPNCD = 11;</code>
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo> getUnk3300BCHEELFPNCDList() {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo getUnk3300BCHEELFPNCD(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfoOrBuilder getUnk3300BCHEELFPNCDOrBuilder(
        int index) {
      return unk3300BCHEELFPNCD_.get(index);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.gingerps.net.proto.BrickBreakerDetailInfoOuterClass.internal_static_BrickBreakerDetailInfo_SkillInfoMapEntry_descriptor, 
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.BrickBreakerDetailInfoOuterClass.BrickBreakerDetailInfo)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.BrickBreakerDetailInfoOuterClass.BrickBreakerDetailInfo other = (emu.gingerps.net.proto.BrickBreakerDetailInfoOuterClass.BrickBreakerDetailInfo) obj;
    ...
    public static emu.gingerps.net.proto.BrickBreakerDetailInfoOuterClass.BrickBreakerDetailInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.BrickBreakerDetailInfoOuterClass.BrickBreakerDetailInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.BrickBreakerDetailInfoOuterClass.BrickBreakerDetailInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.BrickBreakerDetailInfoOuterClass.BrickBreakerDetailInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.BrickBreakerDetailInfoOuterClass.BrickBreakerDetailInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.BrickBreakerDetailInfoOuterClass.BrickBreakerDetailInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.BrickBreakerDetailInfoOuterClass.BrickBreakerDetailInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.BrickBreakerDetailInfoOuterClass.BrickBreakerDetailInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.BrickBreakerDetailInfoOuterClass.internal_static_BrickBreakerDetailInfo_descriptor;
      }
      ...
      // Construct using emu.gingerps.net.proto.BrickBreakerDetailInfoOuterClass.BrickBreakerDetailInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.BrickBreakerDetailInfoOuterClass.BrickBreakerDetailInfo getDefaultInstanceForType() {
        return emu.gingerps.net.proto.BrickBreakerDetailInfoOuterClass.BrickBreakerDetailInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.BrickBreakerDetailInfoOuterClass.BrickBreakerDetailInfo build() {
        emu.gingerps.net.proto.BrickBreakerDetailInfoOuterClass.BrickBreakerDetailInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.BrickBreakerDetailInfoOuterClass.BrickBreakerDetailInfo buildPartial() {
        emu.gingerps.net.proto.BrickBreakerDetailInfoOuterClass.BrickBreakerDetailInfo result = new emu.gingerps.net.proto.BrickBreakerDetailInfoOuterClass.BrickBreakerDetailInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.BrickBreakerDetailInfoOuterClass.BrickBreakerDetailInfo) {
          return mergeFrom((emu.gingerps.net.proto.BrickBreakerDetailInfoOuterClass.BrickBreakerDetailInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.BrickBreakerDetailInfoOuterClass.BrickBreakerDetailInfo other) {
        if (other == emu.gingerps.net.proto.BrickBreakerDetailInfoOuterClass.BrickBreakerDetailInfo.getDefaultInstance()) return this;
        if (stageInfoListBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        emu.gingerps.net.proto.BrickBreakerDetailInfoOuterClass.BrickBreakerDetailInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (emu.gingerps.net.proto.BrickBreakerDetailInfoOuterClass.BrickBreakerDetailInfo) e.getUnfinishedMessage();
      ...
      private void ensureStageInfoListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          stageInfoList_ = new java.util.ArrayList<emu.gingerps.net.proto.BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo>(stageInfoList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo, emu.gingerps.net.proto.BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo.Builder, emu.gingerps.net.proto.BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfoOrBuilder> stageInfoListBuilder_;
      ...
      public Builder setStageInfoList(
          int index, emu.gingerps.net.proto.BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo value) {
        if (stageInfoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setStageInfoList(
          int index, emu.gingerps.net.proto.BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo.Builder builderForValue) {
        if (stageInfoListBuilder_ == null) {
          ensureStageInfoListIsMutable();
       ...
       * <code>repeated .BrickBreakerActivityStageInfo stage_info_list = 13;</code>
       */
      public Builder addStageInfoList(emu.gingerps.net.proto.BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo value) {
        if (stageInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addStageInfoList(
          emu.gingerps.net.proto.BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo.Builder builderForValue) {
        if (stageInfoListBuilder_ == null) {
          ensureStageInfoListIsMutable();
      ...
      public Builder addAllStageInfoList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo> values) {
        if (stageInfoListBuilder_ == null) {
          ensureStageInfoListIsMutable();
       ...
       * <code>repeated .BrickBreakerActivityStageInfo stage_info_list = 13;</code>
       */
      public emu.gingerps.net.proto.BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo.Builder getStageInfoListBuilder(
          int index) {
       ...
       * <code>repeated .BrickBreakerActivityStageInfo stage_info_list = 13;</code>
       */
      public emu.gingerps.net.proto.BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo.Builder addStageInfoListBuilder() {
        return getStageInfoListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .BrickBreakerActivityStageInfo stage_info_list = 13;</code>
       */
      public emu.gingerps.net.proto.BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo.Builder addStageInfoListBuilder(
          int index) {
        return getStageInfoListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .BrickBreakerActivityStageInfo stage_info_list = 13;</code>
       */
      public java.util.List<emu.gingerps.net.proto.BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo.Builder> 
           getStageInfoListBuilderList() {
        return getStageInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo, emu.gingerps.net.proto.BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfo.Builder, emu.gingerps.net.proto.BrickBreakerActivityStageInfoOuterClass.BrickBreakerActivityStageInfoOrBuilder> 
          getStageInfoListFieldBuilder() {
        if (stageInfoListBuilder_ == null) {
      ...
      private void ensureUnk3300AIEGOACOINOIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          unk3300AIEGOACOINO_ = new java.util.ArrayList<emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo>(unk3300AIEGOACOINO_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo, emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.Builder, emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfoOrBuilder> unk3300AIEGOACOINOBuilder_;
      ...
      public Builder setUnk3300AIEGOACOINO(
          int index, emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo value) {
        if (unk3300AIEGOACOINOBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setUnk3300AIEGOACOINO(
          int index, emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.Builder builderForValue) {
        if (unk3300AIEGOACOINOBuilder_ == null) {
          ensureUnk3300AIEGOACOINOIsMutable();
       ...
       * <code>repeated .BrickBreakerLevelInfo Unk3300_AIEGOACOINO = 9;</code>
       */
      public Builder addUnk3300AIEGOACOINO(emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo value) {
        if (unk3300AIEGOACOINOBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addUnk3300AIEGOACOINO(
          emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.Builder builderForValue) {
        if (unk3300AIEGOACOINOBuilder_ == null) {
          ensureUnk3300AIEGOACOINOIsMutable();
      ...
      public Builder addAllUnk3300AIEGOACOINO(
          java.lang.Iterable<? extends emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo> values) {
        if (unk3300AIEGOACOINOBuilder_ == null) {
          ensureUnk3300AIEGOACOINOIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .BrickBreakerLevelInfo Unk3300_AIEGOACOINO = 9;</code>
       */
      public emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.Builder getUnk3300AIEGOACOINOBuilder(
          int index) {
       ...
       * <code>repeated .BrickBreakerLevelInfo Unk3300_AIEGOACOINO = 9;</code>
       */
      public emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.Builder addUnk3300AIEGOACOINOBuilder() {
        return getUnk3300AIEGOACOINOFieldBuilder().addBuilder(
            emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .BrickBreakerLevelInfo Unk3300_AIEGOACOINO = 9;</code>
       */
      public emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.Builder addUnk3300AIEGOACOINOBuilder(
          int index) {
        return getUnk3300AIEGOACOINOFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .BrickBreakerLevelInfo Unk3300_AIEGOACOINO = 9;</code>
       */
      public java.util.List<emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.Builder> 
           getUnk3300AIEGOACOINOBuilderList() {
        return getUnk3300AIEGOACOINOFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo, emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.Builder, emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfoOrBuilder> 
          getUnk3300AIEGOACOINOFieldBuilder() {
        if (unk3300AIEGOACOINOBuilder_ == null) {
      ...
      private void ensureUnk3300BCHEELFPNCDIsMutable() {
        if (!((bitField0_ & 0x00000004) != 0)) {
          unk3300BCHEELFPNCD_ = new java.util.ArrayList<emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo>(unk3300BCHEELFPNCD_);
          bitField0_ |= 0x00000004;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo, emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.Builder, emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfoOrBuilder> unk3300BCHEELFPNCDBuilder_;
       ...
       * <code>repeated .BrickBreakerLevelInfo Unk3300_BCHEELFPNCD = 11;</code>
       */
      public Builder addUnk3300BCHEELFPNCD(emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo value) {
        if (unk3300BCHEELFPNCDBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .BrickBreakerLevelInfo Unk3300_BCHEELFPNCD = 11;</code>
       */
      public emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.Builder getUnk3300BCHEELFPNCDBuilder(
          int index) {
       ...
       * <code>repeated .BrickBreakerLevelInfo Unk3300_BCHEELFPNCD = 11;</code>
       */
      public emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.Builder addUnk3300BCHEELFPNCDBuilder() {
    ...
    private static final emu.gingerps.net.proto.BrickBreakerDetailInfoOuterClass.BrickBreakerDetailInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.BrickBreakerDetailInfoOuterClass.BrickBreakerDetailInfo();
    }

    public static emu.gingerps.net.proto.BrickBreakerDetailInfoOuterClass.BrickBreakerDetailInfo getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.BrickBreakerActivityStageInfoOuterClass.getDescriptor(),
          emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.getDescriptor(),
        });
    internal_static_BrickBreakerDetailInfo_descriptor =
