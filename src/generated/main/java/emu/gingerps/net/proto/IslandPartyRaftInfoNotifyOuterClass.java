...
public final class IslandPartyRaftInfoNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.IslandPartyRaftInfoNotifyOuterClass.internal_static_IslandPartyRaftInfoNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.IslandPartyRaftInfoNotifyOuterClass.IslandPartyRaftInfoNotify.class, emu.gingerps.net.proto.IslandPartyRaftInfoNotifyOuterClass.IslandPartyRaftInfoNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.IslandPartyRaftInfoNotifyOuterClass.IslandPartyRaftInfoNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.IslandPartyRaftInfoNotifyOuterClass.IslandPartyRaftInfoNotify other = (emu.gingerps.net.proto.IslandPartyRaftInfoNotifyOuterClass.IslandPartyRaftInfoNotify) obj;
    ...
    public static emu.gingerps.net.proto.IslandPartyRaftInfoNotifyOuterClass.IslandPartyRaftInfoNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.IslandPartyRaftInfoNotifyOuterClass.IslandPartyRaftInfoNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.IslandPartyRaftInfoNotifyOuterClass.IslandPartyRaftInfoNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.IslandPartyRaftInfoNotifyOuterClass.IslandPartyRaftInfoNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.IslandPartyRaftInfoNotifyOuterClass.IslandPartyRaftInfoNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.IslandPartyRaftInfoNotifyOuterClass.IslandPartyRaftInfoNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.IslandPartyRaftInfoNotifyOuterClass.IslandPartyRaftInfoNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.IslandPartyRaftInfoNotifyOuterClass.IslandPartyRaftInfoNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.IslandPartyRaftInfoNotifyOuterClass.internal_static_IslandPartyRaftInfoNotify_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.IslandPartyRaftInfoNotifyOuterClass.IslandPartyRaftInfoNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.IslandPartyRaftInfoNotifyOuterClass.IslandPartyRaftInfoNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.IslandPartyRaftInfoNotifyOuterClass.IslandPartyRaftInfoNotify build() {
        emu.gingerps.net.proto.IslandPartyRaftInfoNotifyOuterClass.IslandPartyRaftInfoNotify result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.IslandPartyRaftInfoNotifyOuterClass.IslandPartyRaftInfoNotify) {
          return mergeFrom((emu.gingerps.net.proto.IslandPartyRaftInfoNotifyOuterClass.IslandPartyRaftInfoNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.IslandPartyRaftInfoNotifyOuterClass.IslandPartyRaftInfoNotify other) {
        if (other == emu.gingerps.net.proto.IslandPartyRaftInfoNotifyOuterClass.IslandPartyRaftInfoNotify.getDefaultInstance()) return this;
    ...
    private static final emu.gingerps.net.proto.IslandPartyRaftInfoNotifyOuterClass.IslandPartyRaftInfoNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.IslandPartyRaftInfoNotifyOuterClass.IslandPartyRaftInfoNotify();
    }

    public static emu.gingerps.net.proto.IslandPartyRaftInfoNotifyOuterClass.IslandPartyRaftInfoNotify getDefaultInstance() {
