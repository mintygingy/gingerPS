...
public final class SceneGalleryHandballInfoOuterClass {
  ...
  public interface SceneGalleryHandballInfoOrBuilder extends
     ...
     */
    emu.gingerps.net.proto.PlaceInfoOuterClass.PlaceInfo getBallPlaceInfo();
    /**
     * <code>.PlaceInfo ball_place_info = 6;</code>
     */
    emu.gingerps.net.proto.PlaceInfoOuterClass.PlaceInfoOrBuilder getBallPlaceInfoOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.SceneGalleryHandballInfoOuterClass.internal_static_SceneGalleryHandballInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.SceneGalleryHandballInfoOuterClass.SceneGalleryHandballInfo.class, emu.gingerps.net.proto.SceneGalleryHandballInfoOuterClass.SceneGalleryHandballInfo.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.PlaceInfoOuterClass.PlaceInfo getBallPlaceInfo() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.SceneGalleryHandballInfoOuterClass.SceneGalleryHandballInfo)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.SceneGalleryHandballInfoOuterClass.SceneGalleryHandballInfo other = (emu.gingerps.net.proto.SceneGalleryHandballInfoOuterClass.SceneGalleryHandballInfo) obj;
    ...
    public static emu.gingerps.net.proto.SceneGalleryHandballInfoOuterClass.SceneGalleryHandballInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.SceneGalleryHandballInfoOuterClass.SceneGalleryHandballInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.SceneGalleryHandballInfoOuterClass.SceneGalleryHandballInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.SceneGalleryHandballInfoOuterClass.SceneGalleryHandballInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.SceneGalleryHandballInfoOuterClass.SceneGalleryHandballInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.SceneGalleryHandballInfoOuterClass.SceneGalleryHandballInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.SceneGalleryHandballInfoOuterClass.SceneGalleryHandballInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.SceneGalleryHandballInfoOuterClass.SceneGalleryHandballInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.SceneGalleryHandballInfoOuterClass.internal_static_SceneGalleryHandballInfo_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.SceneGalleryHandballInfoOuterClass.SceneGalleryHandballInfo getDefaultInstanceForType() {
        return emu.gingerps.net.proto.SceneGalleryHandballInfoOuterClass.SceneGalleryHandballInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.SceneGalleryHandballInfoOuterClass.SceneGalleryHandballInfo build() {
        emu.gingerps.net.proto.SceneGalleryHandballInfoOuterClass.SceneGalleryHandballInfo result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.SceneGalleryHandballInfoOuterClass.SceneGalleryHandballInfo) {
          return mergeFrom((emu.gingerps.net.proto.SceneGalleryHandballInfoOuterClass.SceneGalleryHandballInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.SceneGalleryHandballInfoOuterClass.SceneGalleryHandballInfo other) {
        if (other == emu.gingerps.net.proto.SceneGalleryHandballInfoOuterClass.SceneGalleryHandballInfo.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.PlaceInfoOuterClass.PlaceInfo, emu.gingerps.net.proto.PlaceInfoOuterClass.PlaceInfo.Builder, emu.gingerps.net.proto.PlaceInfoOuterClass.PlaceInfoOrBuilder> ballPlaceInfoBuilder_;
      /**
       * <code>.PlaceInfo ball_place_info = 6;</code>
       * @return Whether the ballPlaceInfo field is set.
       */
       ...
       * <code>.PlaceInfo ball_place_info = 6;</code>
       */
      public Builder setBallPlaceInfo(emu.gingerps.net.proto.PlaceInfoOuterClass.PlaceInfo value) {
        if (ballPlaceInfoBuilder_ == null) {
          if (value == null) {
      ...
      public emu.gingerps.net.proto.PlaceInfoOuterClass.PlaceInfoOrBuilder getBallPlaceInfoOrBuilder() {
        if (ballPlaceInfoBuilder_ != null) {
          ...
          return ballPlaceInfo_ == null ?
              emu.gingerps.net.proto.PlaceInfoOuterClass.PlaceInfo.getDefaultInstance() : ballPlaceInfo_;
        }
      }
      /**
       * <code>.PlaceInfo ball_place_info = 6;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.PlaceInfoOuterClass.PlaceInfo, emu.gingerps.net.proto.PlaceInfoOuterClass.PlaceInfo.Builder, emu.gingerps.net.proto.PlaceInfoOuterClass.PlaceInfoOrBuilder> 
    ...
    private static final emu.gingerps.net.proto.SceneGalleryHandballInfoOuterClass.SceneGalleryHandballInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.SceneGalleryHandballInfoOuterClass.SceneGalleryHandballInfo();
    }

    public static emu.gingerps.net.proto.SceneGalleryHandballInfoOuterClass.SceneGalleryHandballInfo getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.PlaceInfoOuterClass.getDescriptor(),
        });
    internal_static_SceneGalleryHandballInfo_descriptor =
