...
public final class SalvageEscortSettleNotifyOuterClass {
  ...
  public interface SalvageEscortSettleNotifyOrBuilder extends
     ...
     */
    emu.gingerps.net.proto.SalvageEscortSettleInfoOuterClass.SalvageEscortSettleInfo getSettleInfo();
    /**
     * <code>.SalvageEscortSettleInfo settle_info = 1;</code>
     */
    emu.gingerps.net.proto.SalvageEscortSettleInfoOuterClass.SalvageEscortSettleInfoOrBuilder getSettleInfoOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.SalvageEscortSettleNotifyOuterClass.internal_static_SalvageEscortSettleNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.SalvageEscortSettleNotifyOuterClass.SalvageEscortSettleNotify.class, emu.gingerps.net.proto.SalvageEscortSettleNotifyOuterClass.SalvageEscortSettleNotify.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.SalvageEscortSettleInfoOuterClass.SalvageEscortSettleInfo getSettleInfo() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.SalvageEscortSettleNotifyOuterClass.SalvageEscortSettleNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.SalvageEscortSettleNotifyOuterClass.SalvageEscortSettleNotify other = (emu.gingerps.net.proto.SalvageEscortSettleNotifyOuterClass.SalvageEscortSettleNotify) obj;
    ...
    public static emu.gingerps.net.proto.SalvageEscortSettleNotifyOuterClass.SalvageEscortSettleNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.SalvageEscortSettleNotifyOuterClass.SalvageEscortSettleNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.SalvageEscortSettleNotifyOuterClass.SalvageEscortSettleNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.SalvageEscortSettleNotifyOuterClass.SalvageEscortSettleNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.SalvageEscortSettleNotifyOuterClass.SalvageEscortSettleNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.SalvageEscortSettleNotifyOuterClass.SalvageEscortSettleNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.SalvageEscortSettleNotifyOuterClass.SalvageEscortSettleNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.SalvageEscortSettleNotifyOuterClass.SalvageEscortSettleNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.SalvageEscortSettleNotifyOuterClass.internal_static_SalvageEscortSettleNotify_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.SalvageEscortSettleNotifyOuterClass.SalvageEscortSettleNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.SalvageEscortSettleNotifyOuterClass.SalvageEscortSettleNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.SalvageEscortSettleNotifyOuterClass.SalvageEscortSettleNotify build() {
        emu.gingerps.net.proto.SalvageEscortSettleNotifyOuterClass.SalvageEscortSettleNotify result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.SalvageEscortSettleNotifyOuterClass.SalvageEscortSettleNotify) {
          return mergeFrom((emu.gingerps.net.proto.SalvageEscortSettleNotifyOuterClass.SalvageEscortSettleNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.SalvageEscortSettleNotifyOuterClass.SalvageEscortSettleNotify other) {
        if (other == emu.gingerps.net.proto.SalvageEscortSettleNotifyOuterClass.SalvageEscortSettleNotify.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.SalvageEscortSettleInfoOuterClass.SalvageEscortSettleInfo, emu.gingerps.net.proto.SalvageEscortSettleInfoOuterClass.SalvageEscortSettleInfo.Builder, emu.gingerps.net.proto.SalvageEscortSettleInfoOuterClass.SalvageEscortSettleInfoOrBuilder> settleInfoBuilder_;
      /**
       * <code>.SalvageEscortSettleInfo settle_info = 1;</code>
       * @return Whether the settleInfo field is set.
       */
       ...
       * <code>.SalvageEscortSettleInfo settle_info = 1;</code>
       */
      public Builder setSettleInfo(emu.gingerps.net.proto.SalvageEscortSettleInfoOuterClass.SalvageEscortSettleInfo value) {
        if (settleInfoBuilder_ == null) {
          if (value == null) {
      ...
      public emu.gingerps.net.proto.SalvageEscortSettleInfoOuterClass.SalvageEscortSettleInfoOrBuilder getSettleInfoOrBuilder() {
        if (settleInfoBuilder_ != null) {
          ...
          return settleInfo_ == null ?
              emu.gingerps.net.proto.SalvageEscortSettleInfoOuterClass.SalvageEscortSettleInfo.getDefaultInstance() : settleInfo_;
        }
      }
      /**
       * <code>.SalvageEscortSettleInfo settle_info = 1;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.SalvageEscortSettleInfoOuterClass.SalvageEscortSettleInfo, emu.gingerps.net.proto.SalvageEscortSettleInfoOuterClass.SalvageEscortSettleInfo.Builder, emu.gingerps.net.proto.SalvageEscortSettleInfoOuterClass.SalvageEscortSettleInfoOrBuilder> 
    ...
    private static final emu.gingerps.net.proto.SalvageEscortSettleNotifyOuterClass.SalvageEscortSettleNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.SalvageEscortSettleNotifyOuterClass.SalvageEscortSettleNotify();
    }

    public static emu.gingerps.net.proto.SalvageEscortSettleNotifyOuterClass.SalvageEscortSettleNotify getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.SalvageEscortSettleInfoOuterClass.getDescriptor(),
        });
    internal_static_SalvageEscortSettleNotify_descriptor =
