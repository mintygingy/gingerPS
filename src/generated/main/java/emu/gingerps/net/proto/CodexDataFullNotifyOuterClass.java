...
public final class CodexDataFullNotifyOuterClass {
  ...
  public interface CodexDataFullNotifyOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.CodexTypeDataOuterClass.CodexTypeData> 
        getTypeDataListList();
    /**
     * <code>repeated .CodexTypeData type_data_list = 14;</code>
     */
    emu.gingerps.net.proto.CodexTypeDataOuterClass.CodexTypeData getTypeDataList(int index);
    /**
     * <code>repeated .CodexTypeData type_data_list = 14;</code>
     */
     ...
     * <code>repeated .CodexTypeData type_data_list = 14;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.CodexTypeDataOuterClass.CodexTypeDataOrBuilder> 
        getTypeDataListOrBuilderList();
    /**
     * <code>repeated .CodexTypeData type_data_list = 14;</code>
     */
    emu.gingerps.net.proto.CodexTypeDataOuterClass.CodexTypeDataOrBuilder getTypeDataListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.gingerps.net.proto.CodexDataFullNotifyOuterClass.internal_static_CodexDataFullNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.gingerps.net.proto.CodexDataFullNotifyOuterClass.internal_static_CodexDataFullNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.CodexDataFullNotifyOuterClass.CodexDataFullNotify.class, emu.gingerps.net.proto.CodexDataFullNotifyOuterClass.CodexDataFullNotify.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.CodexTypeDataOuterClass.CodexTypeData> getTypeDataListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.CodexTypeDataOuterClass.CodexTypeDataOrBuilder> 
        getTypeDataListOrBuilderList() {
      return typeDataList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.CodexTypeDataOuterClass.CodexTypeData getTypeDataList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.CodexTypeDataOuterClass.CodexTypeDataOrBuilder getTypeDataListOrBuilder(
        int index) {
      return typeDataList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.CodexDataFullNotifyOuterClass.CodexDataFullNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.CodexDataFullNotifyOuterClass.CodexDataFullNotify other = (emu.gingerps.net.proto.CodexDataFullNotifyOuterClass.CodexDataFullNotify) obj;
    ...
    public static emu.gingerps.net.proto.CodexDataFullNotifyOuterClass.CodexDataFullNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.CodexDataFullNotifyOuterClass.CodexDataFullNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.CodexDataFullNotifyOuterClass.CodexDataFullNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.CodexDataFullNotifyOuterClass.CodexDataFullNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.CodexDataFullNotifyOuterClass.CodexDataFullNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.CodexDataFullNotifyOuterClass.CodexDataFullNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.CodexDataFullNotifyOuterClass.CodexDataFullNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.CodexDataFullNotifyOuterClass.CodexDataFullNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.CodexDataFullNotifyOuterClass.internal_static_CodexDataFullNotify_descriptor;
      }
      ...
      // Construct using emu.gingerps.net.proto.CodexDataFullNotifyOuterClass.CodexDataFullNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.CodexDataFullNotifyOuterClass.CodexDataFullNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.CodexDataFullNotifyOuterClass.CodexDataFullNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.CodexDataFullNotifyOuterClass.CodexDataFullNotify build() {
        emu.gingerps.net.proto.CodexDataFullNotifyOuterClass.CodexDataFullNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.CodexDataFullNotifyOuterClass.CodexDataFullNotify buildPartial() {
        emu.gingerps.net.proto.CodexDataFullNotifyOuterClass.CodexDataFullNotify result = new emu.gingerps.net.proto.CodexDataFullNotifyOuterClass.CodexDataFullNotify(this);
      ...
      private void buildPartialRepeatedFields(emu.gingerps.net.proto.CodexDataFullNotifyOuterClass.CodexDataFullNotify result) {
        if (typeDataListBuilder_ == null) {
      ...
      private void buildPartial0(emu.gingerps.net.proto.CodexDataFullNotifyOuterClass.CodexDataFullNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.CodexDataFullNotifyOuterClass.CodexDataFullNotify) {
          return mergeFrom((emu.gingerps.net.proto.CodexDataFullNotifyOuterClass.CodexDataFullNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.CodexDataFullNotifyOuterClass.CodexDataFullNotify other) {
        if (other == emu.gingerps.net.proto.CodexDataFullNotifyOuterClass.CodexDataFullNotify.getDefaultInstance()) return this;
        if (typeDataListBuilder_ == null) {
      ...
      private void ensureTypeDataListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          typeDataList_ = new java.util.ArrayList<emu.gingerps.net.proto.CodexTypeDataOuterClass.CodexTypeData>(typeDataList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.CodexTypeDataOuterClass.CodexTypeData, emu.gingerps.net.proto.CodexTypeDataOuterClass.CodexTypeData.Builder, emu.gingerps.net.proto.CodexTypeDataOuterClass.CodexTypeDataOrBuilder> typeDataListBuilder_;
      ...
      public Builder setTypeDataList(
          int index, emu.gingerps.net.proto.CodexTypeDataOuterClass.CodexTypeData value) {
        if (typeDataListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setTypeDataList(
          int index, emu.gingerps.net.proto.CodexTypeDataOuterClass.CodexTypeData.Builder builderForValue) {
        if (typeDataListBuilder_ == null) {
          ensureTypeDataListIsMutable();
       ...
       * <code>repeated .CodexTypeData type_data_list = 14;</code>
       */
      public Builder addTypeDataList(emu.gingerps.net.proto.CodexTypeDataOuterClass.CodexTypeData value) {
        if (typeDataListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addTypeDataList(
          emu.gingerps.net.proto.CodexTypeDataOuterClass.CodexTypeData.Builder builderForValue) {
        if (typeDataListBuilder_ == null) {
          ensureTypeDataListIsMutable();
      ...
      public Builder addAllTypeDataList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.CodexTypeDataOuterClass.CodexTypeData> values) {
        if (typeDataListBuilder_ == null) {
          ensureTypeDataListIsMutable();
       ...
       * <code>repeated .CodexTypeData type_data_list = 14;</code>
       */
      public emu.gingerps.net.proto.CodexTypeDataOuterClass.CodexTypeData.Builder getTypeDataListBuilder(
          int index) {
       ...
       * <code>repeated .CodexTypeData type_data_list = 14;</code>
       */
      public emu.gingerps.net.proto.CodexTypeDataOuterClass.CodexTypeData.Builder addTypeDataListBuilder() {
        return getTypeDataListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.CodexTypeDataOuterClass.CodexTypeData.getDefaultInstance());
      }
      /**
       * <code>repeated .CodexTypeData type_data_list = 14;</code>
       */
      public emu.gingerps.net.proto.CodexTypeDataOuterClass.CodexTypeData.Builder addTypeDataListBuilder(
          int index) {
        return getTypeDataListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.CodexTypeDataOuterClass.CodexTypeData.getDefaultInstance());
      }
      /**
       * <code>repeated .CodexTypeData type_data_list = 14;</code>
       */
      public java.util.List<emu.gingerps.net.proto.CodexTypeDataOuterClass.CodexTypeData.Builder> 
           getTypeDataListBuilderList() {
        return getTypeDataListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.CodexTypeDataOuterClass.CodexTypeData, emu.gingerps.net.proto.CodexTypeDataOuterClass.CodexTypeData.Builder, emu.gingerps.net.proto.CodexTypeDataOuterClass.CodexTypeDataOrBuilder> 
    ...
    private static final emu.gingerps.net.proto.CodexDataFullNotifyOuterClass.CodexDataFullNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.CodexDataFullNotifyOuterClass.CodexDataFullNotify();
    }

    public static emu.gingerps.net.proto.CodexDataFullNotifyOuterClass.CodexDataFullNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ed_pushtips_list\030\001 \003(\rB\030\n\026emu.gingerps.n" +
      "et.protob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.CodexTypeDataOuterClass.getDescriptor(),
        });
    internal_static_CodexDataFullNotify_descriptor =
