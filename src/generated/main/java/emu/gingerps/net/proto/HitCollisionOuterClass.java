...
public final class HitCollisionOuterClass {
  ...
  public interface HitCollisionOrBuilder extends
     ...
     * @return The hitDir.
     */
    emu.gingerps.net.proto.VectorOuterClass.Vector getHitDir();
    /**
     * <code>.Vector hit_dir = 3;</code>
     */
    emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder getHitDirOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.HitCollisionOuterClass.internal_static_HitCollision_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.HitCollisionOuterClass.HitCollision.class, emu.gingerps.net.proto.HitCollisionOuterClass.HitCollision.Builder.class);
    }
    ...
    private emu.gingerps.net.proto.VectorOuterClass.Vector hitDir_;
    /**
     * <code>.Vector hit_dir = 3;</code>
     * @return Whether the hitDir field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.VectorOuterClass.Vector getHitDir() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.HitCollisionOuterClass.HitCollision)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.HitCollisionOuterClass.HitCollision other = (emu.gingerps.net.proto.HitCollisionOuterClass.HitCollision) obj;
    ...
    public static emu.gingerps.net.proto.HitCollisionOuterClass.HitCollision parseFrom(
    ...
    public static emu.gingerps.net.proto.HitCollisionOuterClass.HitCollision parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.HitCollisionOuterClass.HitCollision parseFrom(
    ...
    public static emu.gingerps.net.proto.HitCollisionOuterClass.HitCollision parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.HitCollisionOuterClass.HitCollision parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.HitCollisionOuterClass.HitCollision parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.HitCollisionOuterClass.HitCollision prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.HitCollisionOuterClass.HitCollisionOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.HitCollisionOuterClass.internal_static_HitCollision_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.HitCollisionOuterClass.HitCollision getDefaultInstanceForType() {
        return emu.gingerps.net.proto.HitCollisionOuterClass.HitCollision.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.HitCollisionOuterClass.HitCollision build() {
        emu.gingerps.net.proto.HitCollisionOuterClass.HitCollision result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.HitCollisionOuterClass.HitCollision) {
          return mergeFrom((emu.gingerps.net.proto.HitCollisionOuterClass.HitCollision)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.HitCollisionOuterClass.HitCollision other) {
        if (other == emu.gingerps.net.proto.HitCollisionOuterClass.HitCollision.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.VectorOuterClass.Vector, emu.gingerps.net.proto.VectorOuterClass.Vector.Builder, emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder> hitDirBuilder_;
      /**
       * <code>.Vector hit_dir = 3;</code>
       * @return Whether the hitDir field is set.
       */
       ...
       * <code>.Vector hit_dir = 3;</code>
       */
      public Builder setHitDir(emu.gingerps.net.proto.VectorOuterClass.Vector value) {
        if (hitDirBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder getHitDirOrBuilder() {
        if (hitDirBuilder_ != null) {
          ...
          return hitDir_ == null ?
              emu.gingerps.net.proto.VectorOuterClass.Vector.getDefaultInstance() : hitDir_;
        }
      }
      /**
       * <code>.Vector hit_dir = 3;</code>
    ...
    private static final emu.gingerps.net.proto.HitCollisionOuterClass.HitCollision DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.HitCollisionOuterClass.HitCollision();
    }

    public static emu.gingerps.net.proto.HitCollisionOuterClass.HitCollision getDefaultInstance() {
