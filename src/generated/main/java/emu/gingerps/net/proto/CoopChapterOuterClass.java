...
public final class CoopChapterOuterClass {
  ...
  public interface CoopChapterOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.CoopPointOuterClass.CoopPoint> 
        getCoopPointListList();
    /**
     * <code>repeated .CoopPoint coop_point_list = 12;</code>
     */
    emu.gingerps.net.proto.CoopPointOuterClass.CoopPoint getCoopPointList(int index);
    /**
     * <code>repeated .CoopPoint coop_point_list = 12;</code>
     */
     ...
     * <code>repeated .CoopPoint coop_point_list = 12;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.CoopPointOuterClass.CoopPointOrBuilder> 
        getCoopPointListOrBuilderList();
    /**
     * <code>repeated .CoopPoint coop_point_list = 12;</code>
     */
    emu.gingerps.net.proto.CoopPointOuterClass.CoopPointOrBuilder getCoopPointListOrBuilder(
        int index);
     ...
     * @return The state.
     */
    emu.gingerps.net.proto.CoopChapterOuterClass.CoopChapter.State getState();
     ...
     * <code>repeated .CoopReward coop_reward_list = 3;</code>
     */
    emu.gingerps.net.proto.CoopRewardOuterClass.CoopReward getCoopRewardList(int index);
    /**
     * <code>repeated .CoopReward coop_reward_list = 3;</code>
     */
     ...
     * <code>repeated .CoopReward coop_reward_list = 3;</code>
     */
    emu.gingerps.net.proto.CoopRewardOuterClass.CoopRewardOrBuilder getCoopRewardListOrBuilder(
        int index);
     ...
     */
    java.util.List<emu.gingerps.net.proto.CoopCgOuterClass.CoopCg> 
        getCoopCgListList();
    /**
     * <code>repeated .CoopCg coop_cg_list = 2;</code>
     */
    emu.gingerps.net.proto.CoopCgOuterClass.CoopCg getCoopCgList(int index);
    /**
     * <code>repeated .CoopCg coop_cg_list = 2;</code>
     */
     ...
     * <code>repeated .CoopCg coop_cg_list = 2;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.CoopCgOuterClass.CoopCgOrBuilder> 
        getCoopCgListOrBuilderList();
    /**
     * <code>repeated .CoopCg coop_cg_list = 2;</code>
     */
    emu.gingerps.net.proto.CoopCgOuterClass.CoopCgOrBuilder getCoopCgListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.gingerps.net.proto.CoopChapterOuterClass.internal_static_CoopChapter_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.CoopChapterOuterClass.internal_static_CoopChapter_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.CoopChapterOuterClass.CoopChapter.class, emu.gingerps.net.proto.CoopChapterOuterClass.CoopChapter.Builder.class);
    }
    ...
    public enum State
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return emu.gingerps.net.proto.CoopChapterOuterClass.CoopChapter.getDescriptor().getEnumTypes().get(0);
      }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.CoopPointOuterClass.CoopPoint> getCoopPointListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.CoopPointOuterClass.CoopPointOrBuilder> 
        getCoopPointListOrBuilderList() {
      return coopPointList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.CoopPointOuterClass.CoopPoint getCoopPointList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.CoopPointOuterClass.CoopPointOrBuilder getCoopPointListOrBuilder(
        int index) {
      return coopPointList_.get(index);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.CoopRewardOuterClass.CoopReward> getCoopRewardListList() {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.CoopRewardOuterClass.CoopReward getCoopRewardList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.CoopRewardOuterClass.CoopRewardOrBuilder getCoopRewardListOrBuilder(
        int index) {
      return coopRewardList_.get(index);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.CoopCgOuterClass.CoopCg> getCoopCgListList() {
      return coopCgList_;
    }
    /**
     * <code>repeated .CoopCg coop_cg_list = 2;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.CoopCgOuterClass.CoopCgOrBuilder> 
        getCoopCgListOrBuilderList() {
      return coopCgList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.CoopCgOuterClass.CoopCg getCoopCgList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.CoopCgOuterClass.CoopCgOrBuilder getCoopCgListOrBuilder(
        int index) {
      return coopCgList_.get(index);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.gingerps.net.proto.CoopChapterOuterClass.internal_static_CoopChapter_SeenEndingMapEntry_descriptor, 
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (state_ != emu.gingerps.net.proto.CoopChapterOuterClass.CoopChapter.State.STATE_CLOSE.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.CoopChapterOuterClass.CoopChapter)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.CoopChapterOuterClass.CoopChapter other = (emu.gingerps.net.proto.CoopChapterOuterClass.CoopChapter) obj;
    ...
    public static emu.gingerps.net.proto.CoopChapterOuterClass.CoopChapter parseFrom(
    ...
    public static emu.gingerps.net.proto.CoopChapterOuterClass.CoopChapter parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.CoopChapterOuterClass.CoopChapter parseFrom(
    ...
    public static emu.gingerps.net.proto.CoopChapterOuterClass.CoopChapter parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.CoopChapterOuterClass.CoopChapter parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.CoopChapterOuterClass.CoopChapter parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.CoopChapterOuterClass.CoopChapter prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.CoopChapterOuterClass.CoopChapterOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.CoopChapterOuterClass.internal_static_CoopChapter_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.CoopChapterOuterClass.CoopChapter getDefaultInstanceForType() {
        return emu.gingerps.net.proto.CoopChapterOuterClass.CoopChapter.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.CoopChapterOuterClass.CoopChapter build() {
        emu.gingerps.net.proto.CoopChapterOuterClass.CoopChapter result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.CoopChapterOuterClass.CoopChapter) {
          return mergeFrom((emu.gingerps.net.proto.CoopChapterOuterClass.CoopChapter)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.CoopChapterOuterClass.CoopChapter other) {
        if (other == emu.gingerps.net.proto.CoopChapterOuterClass.CoopChapter.getDefaultInstance()) return this;
        if (other.getId() != 0) {
          setId(other.getId());
        }
        if (coopPointListBuilder_ == null) {
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.CoopPointOuterClass.CoopPoint, emu.gingerps.net.proto.CoopPointOuterClass.CoopPoint.Builder, emu.gingerps.net.proto.CoopPointOuterClass.CoopPointOrBuilder> coopPointListBuilder_;
      ...
      public Builder setCoopPointList(
          int index, emu.gingerps.net.proto.CoopPointOuterClass.CoopPoint value) {
        if (coopPointListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setCoopPointList(
          int index, emu.gingerps.net.proto.CoopPointOuterClass.CoopPoint.Builder builderForValue) {
        if (coopPointListBuilder_ == null) {
          ensureCoopPointListIsMutable();
       ...
       * <code>repeated .CoopPoint coop_point_list = 12;</code>
       */
      public Builder addCoopPointList(emu.gingerps.net.proto.CoopPointOuterClass.CoopPoint value) {
        if (coopPointListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addAllCoopPointList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.CoopPointOuterClass.CoopPoint> values) {
        if (coopPointListBuilder_ == null) {
          ensureCoopPointListIsMutable();
       ...
       * <code>repeated .CoopPoint coop_point_list = 12;</code>
       */
      public emu.gingerps.net.proto.CoopPointOuterClass.CoopPoint.Builder getCoopPointListBuilder(
          int index) {
       ...
       * <code>repeated .CoopPoint coop_point_list = 12;</code>
       */
      public emu.gingerps.net.proto.CoopPointOuterClass.CoopPoint.Builder addCoopPointListBuilder() {
        return getCoopPointListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.CoopPointOuterClass.CoopPoint.getDefaultInstance());
      }
      /**
       * <code>repeated .CoopPoint coop_point_list = 12;</code>
       */
      public emu.gingerps.net.proto.CoopPointOuterClass.CoopPoint.Builder addCoopPointListBuilder(
          int index) {
        return getCoopPointListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.CoopPointOuterClass.CoopPoint.getDefaultInstance());
      }
      /**
       * <code>repeated .CoopPoint coop_point_list = 12;</code>
       */
      public java.util.List<emu.gingerps.net.proto.CoopPointOuterClass.CoopPoint.Builder> 
       ...
       * @return This builder for chaining.
       */
      public Builder setState(emu.gingerps.net.proto.CoopChapterOuterClass.CoopChapter.State value) {
        if (value == null) {
          throw new NullPointerException();
        }
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.CoopRewardOuterClass.CoopReward, emu.gingerps.net.proto.CoopRewardOuterClass.CoopReward.Builder, emu.gingerps.net.proto.CoopRewardOuterClass.CoopRewardOrBuilder> coopRewardListBuilder_;
       ...
       * <code>repeated .CoopReward coop_reward_list = 3;</code>
       */
      public Builder addCoopRewardList(emu.gingerps.net.proto.CoopRewardOuterClass.CoopReward value) {
        if (coopRewardListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .CoopReward coop_reward_list = 3;</code>
       */
      public emu.gingerps.net.proto.CoopRewardOuterClass.CoopReward.Builder getCoopRewardListBuilder(
          int index) {
       ...
       * <code>repeated .CoopReward coop_reward_list = 3;</code>
       */
      public emu.gingerps.net.proto.CoopRewardOuterClass.CoopReward.Builder addCoopRewardListBuilder() {
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.CoopCgOuterClass.CoopCg, emu.gingerps.net.proto.CoopCgOuterClass.CoopCg.Builder, emu.gingerps.net.proto.CoopCgOuterClass.CoopCgOrBuilder> coopCgListBuilder_;
      ...
      public Builder setCoopCgList(
          int index, emu.gingerps.net.proto.CoopCgOuterClass.CoopCg value) {
        if (coopCgListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setCoopCgList(
          int index, emu.gingerps.net.proto.CoopCgOuterClass.CoopCg.Builder builderForValue) {
        if (coopCgListBuilder_ == null) {
          ensureCoopCgListIsMutable();
       ...
       * <code>repeated .CoopCg coop_cg_list = 2;</code>
       */
      public Builder addCoopCgList(emu.gingerps.net.proto.CoopCgOuterClass.CoopCg value) {
        if (coopCgListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addCoopCgList(
          emu.gingerps.net.proto.CoopCgOuterClass.CoopCg.Builder builderForValue) {
        if (coopCgListBuilder_ == null) {
          ensureCoopCgListIsMutable();
      ...
      public Builder addAllCoopCgList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.CoopCgOuterClass.CoopCg> values) {
        if (coopCgListBuilder_ == null) {
          ensureCoopCgListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
              values, coopCgList_);
       ...
       * <code>repeated .CoopCg coop_cg_list = 2;</code>
       */
      public emu.gingerps.net.proto.CoopCgOuterClass.CoopCg.Builder getCoopCgListBuilder(
          int index) {
       ...
       * <code>repeated .CoopCg coop_cg_list = 2;</code>
       */
      public emu.gingerps.net.proto.CoopCgOuterClass.CoopCg.Builder addCoopCgListBuilder() {
        return getCoopCgListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.CoopCgOuterClass.CoopCg.getDefaultInstance());
      }
      /**
       * <code>repeated .CoopCg coop_cg_list = 2;</code>
       */
      public emu.gingerps.net.proto.CoopCgOuterClass.CoopCg.Builder addCoopCgListBuilder(
          int index) {
        return getCoopCgListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.CoopCgOuterClass.CoopCg.getDefaultInstance());
      }
      /**
       * <code>repeated .CoopCg coop_cg_list = 2;</code>
       */
      public java.util.List<emu.gingerps.net.proto.CoopCgOuterClass.CoopCg.Builder> 
    ...
    private static final emu.gingerps.net.proto.CoopChapterOuterClass.CoopChapter DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.CoopChapterOuterClass.CoopChapter();
    }

    public static emu.gingerps.net.proto.CoopChapterOuterClass.CoopChapter getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ND_MEET\020\002\022\020\n\014STATE_ACCEPT\020\003B\030\n\026emu.ginge" +
      "rps.net.protob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.CoopCgOuterClass.getDescriptor(),
          emu.gingerps.net.proto.CoopPointOuterClass.getDescriptor(),
