...
public final class GCGTavernNpcInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.GCGTavernNpcInfoOuterClass.internal_static_GCGTavernNpcInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.GCGTavernNpcInfoOuterClass.GCGTavernNpcInfo.class, emu.gingerps.net.proto.GCGTavernNpcInfoOuterClass.GCGTavernNpcInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.GCGTavernNpcInfoOuterClass.GCGTavernNpcInfo)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.GCGTavernNpcInfoOuterClass.GCGTavernNpcInfo other = (emu.gingerps.net.proto.GCGTavernNpcInfoOuterClass.GCGTavernNpcInfo) obj;
    ...
    public static emu.gingerps.net.proto.GCGTavernNpcInfoOuterClass.GCGTavernNpcInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.GCGTavernNpcInfoOuterClass.GCGTavernNpcInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.GCGTavernNpcInfoOuterClass.GCGTavernNpcInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.GCGTavernNpcInfoOuterClass.GCGTavernNpcInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.GCGTavernNpcInfoOuterClass.GCGTavernNpcInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.GCGTavernNpcInfoOuterClass.GCGTavernNpcInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.GCGTavernNpcInfoOuterClass.GCGTavernNpcInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.GCGTavernNpcInfoOuterClass.GCGTavernNpcInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.GCGTavernNpcInfoOuterClass.internal_static_GCGTavernNpcInfo_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.GCGTavernNpcInfoOuterClass.GCGTavernNpcInfo getDefaultInstanceForType() {
        return emu.gingerps.net.proto.GCGTavernNpcInfoOuterClass.GCGTavernNpcInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.GCGTavernNpcInfoOuterClass.GCGTavernNpcInfo build() {
        emu.gingerps.net.proto.GCGTavernNpcInfoOuterClass.GCGTavernNpcInfo result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.GCGTavernNpcInfoOuterClass.GCGTavernNpcInfo) {
          return mergeFrom((emu.gingerps.net.proto.GCGTavernNpcInfoOuterClass.GCGTavernNpcInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.GCGTavernNpcInfoOuterClass.GCGTavernNpcInfo other) {
        if (other == emu.gingerps.net.proto.GCGTavernNpcInfoOuterClass.GCGTavernNpcInfo.getDefaultInstance()) return this;
        if (other.getId() != 0) {
          setId(other.getId());
        }
    ...
    private static final emu.gingerps.net.proto.GCGTavernNpcInfoOuterClass.GCGTavernNpcInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.GCGTavernNpcInfoOuterClass.GCGTavernNpcInfo();
    }

    public static emu.gingerps.net.proto.GCGTavernNpcInfoOuterClass.GCGTavernNpcInfo getDefaultInstance() {
