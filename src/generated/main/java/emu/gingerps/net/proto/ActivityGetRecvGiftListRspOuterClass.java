...
public final class ActivityGetRecvGiftListRspOuterClass {
  ...
  public interface ActivityGetRecvGiftListRspOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.ActivityRecvGiftDataOuterClass.ActivityRecvGiftData> 
        getRecvGiftListList();
    /**
     * <code>repeated .ActivityRecvGiftData recv_gift_list = 10;</code>
     */
    emu.gingerps.net.proto.ActivityRecvGiftDataOuterClass.ActivityRecvGiftData getRecvGiftList(int index);
    /**
     * <code>repeated .ActivityRecvGiftData recv_gift_list = 10;</code>
     */
     ...
     * <code>repeated .ActivityRecvGiftData recv_gift_list = 10;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.ActivityRecvGiftDataOuterClass.ActivityRecvGiftDataOrBuilder> 
        getRecvGiftListOrBuilderList();
    /**
     * <code>repeated .ActivityRecvGiftData recv_gift_list = 10;</code>
     */
    emu.gingerps.net.proto.ActivityRecvGiftDataOuterClass.ActivityRecvGiftDataOrBuilder getRecvGiftListOrBuilder(
        int index);
  }
  /**
   * <pre>
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.ActivityGetRecvGiftListRspOuterClass.internal_static_ActivityGetRecvGiftListRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.ActivityGetRecvGiftListRspOuterClass.ActivityGetRecvGiftListRsp.class, emu.gingerps.net.proto.ActivityGetRecvGiftListRspOuterClass.ActivityGetRecvGiftListRsp.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.ActivityRecvGiftDataOuterClass.ActivityRecvGiftData> getRecvGiftListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.ActivityRecvGiftDataOuterClass.ActivityRecvGiftDataOrBuilder> 
        getRecvGiftListOrBuilderList() {
      return recvGiftList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.ActivityRecvGiftDataOuterClass.ActivityRecvGiftData getRecvGiftList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.ActivityRecvGiftDataOuterClass.ActivityRecvGiftDataOrBuilder getRecvGiftListOrBuilder(
        int index) {
      return recvGiftList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.ActivityGetRecvGiftListRspOuterClass.ActivityGetRecvGiftListRsp)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.ActivityGetRecvGiftListRspOuterClass.ActivityGetRecvGiftListRsp other = (emu.gingerps.net.proto.ActivityGetRecvGiftListRspOuterClass.ActivityGetRecvGiftListRsp) obj;
    ...
    public static emu.gingerps.net.proto.ActivityGetRecvGiftListRspOuterClass.ActivityGetRecvGiftListRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.ActivityGetRecvGiftListRspOuterClass.ActivityGetRecvGiftListRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.ActivityGetRecvGiftListRspOuterClass.ActivityGetRecvGiftListRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.ActivityGetRecvGiftListRspOuterClass.ActivityGetRecvGiftListRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.ActivityGetRecvGiftListRspOuterClass.ActivityGetRecvGiftListRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.ActivityGetRecvGiftListRspOuterClass.ActivityGetRecvGiftListRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.ActivityGetRecvGiftListRspOuterClass.ActivityGetRecvGiftListRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.ActivityGetRecvGiftListRspOuterClass.ActivityGetRecvGiftListRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.ActivityGetRecvGiftListRspOuterClass.internal_static_ActivityGetRecvGiftListRsp_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.ActivityGetRecvGiftListRspOuterClass.ActivityGetRecvGiftListRsp getDefaultInstanceForType() {
        return emu.gingerps.net.proto.ActivityGetRecvGiftListRspOuterClass.ActivityGetRecvGiftListRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.ActivityGetRecvGiftListRspOuterClass.ActivityGetRecvGiftListRsp build() {
        emu.gingerps.net.proto.ActivityGetRecvGiftListRspOuterClass.ActivityGetRecvGiftListRsp result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.ActivityGetRecvGiftListRspOuterClass.ActivityGetRecvGiftListRsp) {
          return mergeFrom((emu.gingerps.net.proto.ActivityGetRecvGiftListRspOuterClass.ActivityGetRecvGiftListRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.ActivityGetRecvGiftListRspOuterClass.ActivityGetRecvGiftListRsp other) {
        if (other == emu.gingerps.net.proto.ActivityGetRecvGiftListRspOuterClass.ActivityGetRecvGiftListRsp.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.ActivityRecvGiftDataOuterClass.ActivityRecvGiftData, emu.gingerps.net.proto.ActivityRecvGiftDataOuterClass.ActivityRecvGiftData.Builder, emu.gingerps.net.proto.ActivityRecvGiftDataOuterClass.ActivityRecvGiftDataOrBuilder> recvGiftListBuilder_;
      ...
      public Builder setRecvGiftList(
          int index, emu.gingerps.net.proto.ActivityRecvGiftDataOuterClass.ActivityRecvGiftData value) {
        if (recvGiftListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setRecvGiftList(
          int index, emu.gingerps.net.proto.ActivityRecvGiftDataOuterClass.ActivityRecvGiftData.Builder builderForValue) {
        if (recvGiftListBuilder_ == null) {
          ensureRecvGiftListIsMutable();
       ...
       * <code>repeated .ActivityRecvGiftData recv_gift_list = 10;</code>
       */
      public Builder addRecvGiftList(emu.gingerps.net.proto.ActivityRecvGiftDataOuterClass.ActivityRecvGiftData value) {
        if (recvGiftListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addRecvGiftList(
          emu.gingerps.net.proto.ActivityRecvGiftDataOuterClass.ActivityRecvGiftData.Builder builderForValue) {
        if (recvGiftListBuilder_ == null) {
          ensureRecvGiftListIsMutable();
      ...
      public Builder addAllRecvGiftList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.ActivityRecvGiftDataOuterClass.ActivityRecvGiftData> values) {
        if (recvGiftListBuilder_ == null) {
          ensureRecvGiftListIsMutable();
       ...
       * <code>repeated .ActivityRecvGiftData recv_gift_list = 10;</code>
       */
      public emu.gingerps.net.proto.ActivityRecvGiftDataOuterClass.ActivityRecvGiftData.Builder getRecvGiftListBuilder(
          int index) {
       ...
       * <code>repeated .ActivityRecvGiftData recv_gift_list = 10;</code>
       */
      public emu.gingerps.net.proto.ActivityRecvGiftDataOuterClass.ActivityRecvGiftData.Builder addRecvGiftListBuilder() {
        return getRecvGiftListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.ActivityRecvGiftDataOuterClass.ActivityRecvGiftData.getDefaultInstance());
      }
      /**
       * <code>repeated .ActivityRecvGiftData recv_gift_list = 10;</code>
       */
      public emu.gingerps.net.proto.ActivityRecvGiftDataOuterClass.ActivityRecvGiftData.Builder addRecvGiftListBuilder(
          int index) {
        return getRecvGiftListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.ActivityRecvGiftDataOuterClass.ActivityRecvGiftData.getDefaultInstance());
      }
      /**
       * <code>repeated .ActivityRecvGiftData recv_gift_list = 10;</code>
       */
      public java.util.List<emu.gingerps.net.proto.ActivityRecvGiftDataOuterClass.ActivityRecvGiftData.Builder> 
    ...
    private static final emu.gingerps.net.proto.ActivityGetRecvGiftListRspOuterClass.ActivityGetRecvGiftListRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.ActivityGetRecvGiftListRspOuterClass.ActivityGetRecvGiftListRsp();
    }

    public static emu.gingerps.net.proto.ActivityGetRecvGiftListRspOuterClass.ActivityGetRecvGiftListRsp getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ivityRecvGiftDataB\030\n\026emu.gingerps.net.pr" +
      "otob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.ActivityRecvGiftDataOuterClass.getDescriptor(),
        });
    internal_static_ActivityGetRecvGiftListRsp_descriptor =
