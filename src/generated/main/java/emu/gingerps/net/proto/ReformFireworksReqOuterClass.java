...
public final class ReformFireworksReqOuterClass {
  ...
  public interface ReformFireworksReqOrBuilder extends
     ...
     */
    emu.gingerps.net.proto.FireworksReformDataOuterClass.FireworksReformData getFireworksReformData();
    /**
     * <code>.FireworksReformData fireworks_reform_data = 1;</code>
     */
    emu.gingerps.net.proto.FireworksReformDataOuterClass.FireworksReformDataOrBuilder getFireworksReformDataOrBuilder();
  }
  /**
   * <pre>
   * enum CmdId {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.ReformFireworksReqOuterClass.internal_static_ReformFireworksReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.ReformFireworksReqOuterClass.ReformFireworksReq.class, emu.gingerps.net.proto.ReformFireworksReqOuterClass.ReformFireworksReq.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.FireworksReformDataOuterClass.FireworksReformData getFireworksReformData() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.ReformFireworksReqOuterClass.ReformFireworksReq)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.ReformFireworksReqOuterClass.ReformFireworksReq other = (emu.gingerps.net.proto.ReformFireworksReqOuterClass.ReformFireworksReq) obj;
    ...
    public static emu.gingerps.net.proto.ReformFireworksReqOuterClass.ReformFireworksReq parseFrom(
    ...
    public static emu.gingerps.net.proto.ReformFireworksReqOuterClass.ReformFireworksReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.ReformFireworksReqOuterClass.ReformFireworksReq parseFrom(
    ...
    public static emu.gingerps.net.proto.ReformFireworksReqOuterClass.ReformFireworksReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.ReformFireworksReqOuterClass.ReformFireworksReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.ReformFireworksReqOuterClass.ReformFireworksReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.ReformFireworksReqOuterClass.ReformFireworksReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.ReformFireworksReqOuterClass.ReformFireworksReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.ReformFireworksReqOuterClass.internal_static_ReformFireworksReq_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.ReformFireworksReqOuterClass.ReformFireworksReq getDefaultInstanceForType() {
        return emu.gingerps.net.proto.ReformFireworksReqOuterClass.ReformFireworksReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.ReformFireworksReqOuterClass.ReformFireworksReq build() {
        emu.gingerps.net.proto.ReformFireworksReqOuterClass.ReformFireworksReq result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.ReformFireworksReqOuterClass.ReformFireworksReq) {
          return mergeFrom((emu.gingerps.net.proto.ReformFireworksReqOuterClass.ReformFireworksReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.ReformFireworksReqOuterClass.ReformFireworksReq other) {
        if (other == emu.gingerps.net.proto.ReformFireworksReqOuterClass.ReformFireworksReq.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.FireworksReformDataOuterClass.FireworksReformData, emu.gingerps.net.proto.FireworksReformDataOuterClass.FireworksReformData.Builder, emu.gingerps.net.proto.FireworksReformDataOuterClass.FireworksReformDataOrBuilder> fireworksReformDataBuilder_;
      /**
       * <code>.FireworksReformData fireworks_reform_data = 1;</code>
       * @return Whether the fireworksReformData field is set.
       */
       ...
       * <code>.FireworksReformData fireworks_reform_data = 1;</code>
       */
      public Builder setFireworksReformData(emu.gingerps.net.proto.FireworksReformDataOuterClass.FireworksReformData value) {
        if (fireworksReformDataBuilder_ == null) {
          if (value == null) {
      ...
      public emu.gingerps.net.proto.FireworksReformDataOuterClass.FireworksReformDataOrBuilder getFireworksReformDataOrBuilder() {
        if (fireworksReformDataBuilder_ != null) {
          ...
          return fireworksReformData_ == null ?
              emu.gingerps.net.proto.FireworksReformDataOuterClass.FireworksReformData.getDefaultInstance() : fireworksReformData_;
        }
      }
      /**
       * <code>.FireworksReformData fireworks_reform_data = 1;</code>
    ...
    private static final emu.gingerps.net.proto.ReformFireworksReqOuterClass.ReformFireworksReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.ReformFireworksReqOuterClass.ReformFireworksReq();
    }

    public static emu.gingerps.net.proto.ReformFireworksReqOuterClass.ReformFireworksReq getDefaultInstance() {
