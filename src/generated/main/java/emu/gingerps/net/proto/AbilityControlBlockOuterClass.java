...
public final class AbilityControlBlockOuterClass {
  ...
  public interface AbilityControlBlockOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.AbilityEmbryoOuterClass.AbilityEmbryo> 
        getAbilityEmbryoListList();
    /**
     * <code>repeated .AbilityEmbryo ability_embryo_list = 1;</code>
     */
    emu.gingerps.net.proto.AbilityEmbryoOuterClass.AbilityEmbryo getAbilityEmbryoList(int index);
    /**
     * <code>repeated .AbilityEmbryo ability_embryo_list = 1;</code>
     */
     ...
     * <code>repeated .AbilityEmbryo ability_embryo_list = 1;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.AbilityEmbryoOuterClass.AbilityEmbryoOrBuilder> 
        getAbilityEmbryoListOrBuilderList();
    /**
     * <code>repeated .AbilityEmbryo ability_embryo_list = 1;</code>
     */
    emu.gingerps.net.proto.AbilityEmbryoOuterClass.AbilityEmbryoOrBuilder getAbilityEmbryoListOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.AbilityControlBlockOuterClass.internal_static_AbilityControlBlock_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.AbilityControlBlockOuterClass.AbilityControlBlock.class, emu.gingerps.net.proto.AbilityControlBlockOuterClass.AbilityControlBlock.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.AbilityEmbryoOuterClass.AbilityEmbryo> getAbilityEmbryoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.AbilityEmbryoOuterClass.AbilityEmbryoOrBuilder> 
        getAbilityEmbryoListOrBuilderList() {
      return abilityEmbryoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.AbilityEmbryoOuterClass.AbilityEmbryo getAbilityEmbryoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.AbilityEmbryoOuterClass.AbilityEmbryoOrBuilder getAbilityEmbryoListOrBuilder(
        int index) {
      return abilityEmbryoList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.AbilityControlBlockOuterClass.AbilityControlBlock)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.AbilityControlBlockOuterClass.AbilityControlBlock other = (emu.gingerps.net.proto.AbilityControlBlockOuterClass.AbilityControlBlock) obj;
    ...
    public static emu.gingerps.net.proto.AbilityControlBlockOuterClass.AbilityControlBlock parseFrom(
    ...
    public static emu.gingerps.net.proto.AbilityControlBlockOuterClass.AbilityControlBlock parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.AbilityControlBlockOuterClass.AbilityControlBlock parseFrom(
    ...
    public static emu.gingerps.net.proto.AbilityControlBlockOuterClass.AbilityControlBlock parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.AbilityControlBlockOuterClass.AbilityControlBlock parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.AbilityControlBlockOuterClass.AbilityControlBlock parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.AbilityControlBlockOuterClass.AbilityControlBlock prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.AbilityControlBlockOuterClass.AbilityControlBlockOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.AbilityControlBlockOuterClass.internal_static_AbilityControlBlock_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.AbilityControlBlockOuterClass.AbilityControlBlock getDefaultInstanceForType() {
        return emu.gingerps.net.proto.AbilityControlBlockOuterClass.AbilityControlBlock.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.AbilityControlBlockOuterClass.AbilityControlBlock build() {
        emu.gingerps.net.proto.AbilityControlBlockOuterClass.AbilityControlBlock result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.AbilityControlBlockOuterClass.AbilityControlBlock) {
          return mergeFrom((emu.gingerps.net.proto.AbilityControlBlockOuterClass.AbilityControlBlock)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.AbilityControlBlockOuterClass.AbilityControlBlock other) {
        if (other == emu.gingerps.net.proto.AbilityControlBlockOuterClass.AbilityControlBlock.getDefaultInstance()) return this;
        if (abilityEmbryoListBuilder_ == null) {
      ...
      private void ensureAbilityEmbryoListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          abilityEmbryoList_ = new java.util.ArrayList<emu.gingerps.net.proto.AbilityEmbryoOuterClass.AbilityEmbryo>(abilityEmbryoList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.AbilityEmbryoOuterClass.AbilityEmbryo, emu.gingerps.net.proto.AbilityEmbryoOuterClass.AbilityEmbryo.Builder, emu.gingerps.net.proto.AbilityEmbryoOuterClass.AbilityEmbryoOrBuilder> abilityEmbryoListBuilder_;
      ...
      public Builder setAbilityEmbryoList(
          int index, emu.gingerps.net.proto.AbilityEmbryoOuterClass.AbilityEmbryo value) {
        if (abilityEmbryoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setAbilityEmbryoList(
          int index, emu.gingerps.net.proto.AbilityEmbryoOuterClass.AbilityEmbryo.Builder builderForValue) {
        if (abilityEmbryoListBuilder_ == null) {
          ensureAbilityEmbryoListIsMutable();
       ...
       * <code>repeated .AbilityEmbryo ability_embryo_list = 1;</code>
       */
      public Builder addAbilityEmbryoList(emu.gingerps.net.proto.AbilityEmbryoOuterClass.AbilityEmbryo value) {
        if (abilityEmbryoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addAbilityEmbryoList(
          emu.gingerps.net.proto.AbilityEmbryoOuterClass.AbilityEmbryo.Builder builderForValue) {
        if (abilityEmbryoListBuilder_ == null) {
          ensureAbilityEmbryoListIsMutable();
      ...
      public Builder addAllAbilityEmbryoList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.AbilityEmbryoOuterClass.AbilityEmbryo> values) {
        if (abilityEmbryoListBuilder_ == null) {
          ensureAbilityEmbryoListIsMutable();
       ...
       * <code>repeated .AbilityEmbryo ability_embryo_list = 1;</code>
       */
      public emu.gingerps.net.proto.AbilityEmbryoOuterClass.AbilityEmbryo.Builder getAbilityEmbryoListBuilder(
          int index) {
       ...
       * <code>repeated .AbilityEmbryo ability_embryo_list = 1;</code>
       */
      public emu.gingerps.net.proto.AbilityEmbryoOuterClass.AbilityEmbryo.Builder addAbilityEmbryoListBuilder() {
        return getAbilityEmbryoListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.AbilityEmbryoOuterClass.AbilityEmbryo.getDefaultInstance());
      }
      /**
       * <code>repeated .AbilityEmbryo ability_embryo_list = 1;</code>
       */
      public emu.gingerps.net.proto.AbilityEmbryoOuterClass.AbilityEmbryo.Builder addAbilityEmbryoListBuilder(
          int index) {
        return getAbilityEmbryoListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.AbilityEmbryoOuterClass.AbilityEmbryo.getDefaultInstance());
      }
      /**
       * <code>repeated .AbilityEmbryo ability_embryo_list = 1;</code>
       */
      public java.util.List<emu.gingerps.net.proto.AbilityEmbryoOuterClass.AbilityEmbryo.Builder> 
           getAbilityEmbryoListBuilderList() {
        return getAbilityEmbryoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.AbilityEmbryoOuterClass.AbilityEmbryo, emu.gingerps.net.proto.AbilityEmbryoOuterClass.AbilityEmbryo.Builder, emu.gingerps.net.proto.AbilityEmbryoOuterClass.AbilityEmbryoOrBuilder> 
          getAbilityEmbryoListFieldBuilder() {
        if (abilityEmbryoListBuilder_ == null) {
    ...
    private static final emu.gingerps.net.proto.AbilityControlBlockOuterClass.AbilityControlBlock DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.AbilityControlBlockOuterClass.AbilityControlBlock();
    }

    public static emu.gingerps.net.proto.AbilityControlBlockOuterClass.AbilityControlBlock getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.AbilityEmbryoOuterClass.getDescriptor(),
        });
    internal_static_AbilityControlBlock_descriptor =
