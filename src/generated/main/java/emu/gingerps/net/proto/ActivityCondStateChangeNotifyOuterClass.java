...
public final class ActivityCondStateChangeNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.ActivityCondStateChangeNotifyOuterClass.internal_static_ActivityCondStateChangeNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify.class, emu.gingerps.net.proto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify other = (emu.gingerps.net.proto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify) obj;
    ...
    public static emu.gingerps.net.proto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.ActivityCondStateChangeNotifyOuterClass.internal_static_ActivityCondStateChangeNotify_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify build() {
        emu.gingerps.net.proto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify) {
          return mergeFrom((emu.gingerps.net.proto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify other) {
        if (other == emu.gingerps.net.proto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify.getDefaultInstance()) return this;
    ...
    private static final emu.gingerps.net.proto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify();
    }

    public static emu.gingerps.net.proto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify getDefaultInstance() {
