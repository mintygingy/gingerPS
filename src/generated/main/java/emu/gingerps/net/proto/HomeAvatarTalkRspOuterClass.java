...
public final class HomeAvatarTalkRspOuterClass {
  ...
  public interface HomeAvatarTalkRspOrBuilder extends
     ...
     */
    emu.gingerps.net.proto.HomeAvatarTalkFinishInfoOuterClass.HomeAvatarTalkFinishInfo getAvatarTalkInfo();
    /**
     * <code>.HomeAvatarTalkFinishInfo avatar_talk_info = 4;</code>
     */
    emu.gingerps.net.proto.HomeAvatarTalkFinishInfoOuterClass.HomeAvatarTalkFinishInfoOrBuilder getAvatarTalkInfoOrBuilder();
  }
  /**
   * <pre>
   * enum CmdId {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.HomeAvatarTalkRspOuterClass.internal_static_HomeAvatarTalkRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.HomeAvatarTalkRspOuterClass.HomeAvatarTalkRsp.class, emu.gingerps.net.proto.HomeAvatarTalkRspOuterClass.HomeAvatarTalkRsp.Builder.class);
    }
    ...
    private emu.gingerps.net.proto.HomeAvatarTalkFinishInfoOuterClass.HomeAvatarTalkFinishInfo avatarTalkInfo_;
    /**
     * <code>.HomeAvatarTalkFinishInfo avatar_talk_info = 4;</code>
     * @return Whether the avatarTalkInfo field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.HomeAvatarTalkFinishInfoOuterClass.HomeAvatarTalkFinishInfo getAvatarTalkInfo() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.HomeAvatarTalkRspOuterClass.HomeAvatarTalkRsp)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.HomeAvatarTalkRspOuterClass.HomeAvatarTalkRsp other = (emu.gingerps.net.proto.HomeAvatarTalkRspOuterClass.HomeAvatarTalkRsp) obj;
    ...
    public static emu.gingerps.net.proto.HomeAvatarTalkRspOuterClass.HomeAvatarTalkRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.HomeAvatarTalkRspOuterClass.HomeAvatarTalkRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.HomeAvatarTalkRspOuterClass.HomeAvatarTalkRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.HomeAvatarTalkRspOuterClass.HomeAvatarTalkRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.HomeAvatarTalkRspOuterClass.HomeAvatarTalkRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.HomeAvatarTalkRspOuterClass.HomeAvatarTalkRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.HomeAvatarTalkRspOuterClass.HomeAvatarTalkRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.HomeAvatarTalkRspOuterClass.HomeAvatarTalkRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.HomeAvatarTalkRspOuterClass.internal_static_HomeAvatarTalkRsp_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.HomeAvatarTalkRspOuterClass.HomeAvatarTalkRsp getDefaultInstanceForType() {
        return emu.gingerps.net.proto.HomeAvatarTalkRspOuterClass.HomeAvatarTalkRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.HomeAvatarTalkRspOuterClass.HomeAvatarTalkRsp build() {
        emu.gingerps.net.proto.HomeAvatarTalkRspOuterClass.HomeAvatarTalkRsp result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.HomeAvatarTalkRspOuterClass.HomeAvatarTalkRsp) {
          return mergeFrom((emu.gingerps.net.proto.HomeAvatarTalkRspOuterClass.HomeAvatarTalkRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.HomeAvatarTalkRspOuterClass.HomeAvatarTalkRsp other) {
        if (other == emu.gingerps.net.proto.HomeAvatarTalkRspOuterClass.HomeAvatarTalkRsp.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.HomeAvatarTalkFinishInfoOuterClass.HomeAvatarTalkFinishInfo, emu.gingerps.net.proto.HomeAvatarTalkFinishInfoOuterClass.HomeAvatarTalkFinishInfo.Builder, emu.gingerps.net.proto.HomeAvatarTalkFinishInfoOuterClass.HomeAvatarTalkFinishInfoOrBuilder> avatarTalkInfoBuilder_;
      /**
       * <code>.HomeAvatarTalkFinishInfo avatar_talk_info = 4;</code>
       * @return Whether the avatarTalkInfo field is set.
       */
       ...
       * <code>.HomeAvatarTalkFinishInfo avatar_talk_info = 4;</code>
       */
      public Builder setAvatarTalkInfo(emu.gingerps.net.proto.HomeAvatarTalkFinishInfoOuterClass.HomeAvatarTalkFinishInfo value) {
        if (avatarTalkInfoBuilder_ == null) {
          if (value == null) {
      ...
      public emu.gingerps.net.proto.HomeAvatarTalkFinishInfoOuterClass.HomeAvatarTalkFinishInfoOrBuilder getAvatarTalkInfoOrBuilder() {
        if (avatarTalkInfoBuilder_ != null) {
          ...
          return avatarTalkInfo_ == null ?
              emu.gingerps.net.proto.HomeAvatarTalkFinishInfoOuterClass.HomeAvatarTalkFinishInfo.getDefaultInstance() : avatarTalkInfo_;
        }
      }
      /**
       * <code>.HomeAvatarTalkFinishInfo avatar_talk_info = 4;</code>
    ...
    private static final emu.gingerps.net.proto.HomeAvatarTalkRspOuterClass.HomeAvatarTalkRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.HomeAvatarTalkRspOuterClass.HomeAvatarTalkRsp();
    }

    public static emu.gingerps.net.proto.HomeAvatarTalkRspOuterClass.HomeAvatarTalkRsp getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\0132\031.HomeAvatarTalkFinishInfoB\030\n\026emu.ging" +
