...
public final class PolygonRegionSizeOuterClass {
  ...
  public interface PolygonRegionSizeOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.VectorPlaneOuterClass.VectorPlane> 
        getPointListList();
    /**
     * <code>repeated .VectorPlane point_list = 9;</code>
     */
    emu.gingerps.net.proto.VectorPlaneOuterClass.VectorPlane getPointList(int index);
    /**
     * <code>repeated .VectorPlane point_list = 9;</code>
     */
     ...
     * <code>repeated .VectorPlane point_list = 9;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.VectorPlaneOuterClass.VectorPlaneOrBuilder> 
        getPointListOrBuilderList();
    /**
     * <code>repeated .VectorPlane point_list = 9;</code>
     */
    emu.gingerps.net.proto.VectorPlaneOuterClass.VectorPlaneOrBuilder getPointListOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.PolygonRegionSizeOuterClass.internal_static_PolygonRegionSize_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.PolygonRegionSizeOuterClass.PolygonRegionSize.class, emu.gingerps.net.proto.PolygonRegionSizeOuterClass.PolygonRegionSize.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.VectorPlaneOuterClass.VectorPlane> getPointListList() {
      return pointList_;
    }
    /**
     * <code>repeated .VectorPlane point_list = 9;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.VectorPlaneOuterClass.VectorPlaneOrBuilder> 
        getPointListOrBuilderList() {
      return pointList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.VectorPlaneOuterClass.VectorPlane getPointList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.VectorPlaneOuterClass.VectorPlaneOrBuilder getPointListOrBuilder(
        int index) {
      return pointList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.PolygonRegionSizeOuterClass.PolygonRegionSize)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.PolygonRegionSizeOuterClass.PolygonRegionSize other = (emu.gingerps.net.proto.PolygonRegionSizeOuterClass.PolygonRegionSize) obj;
    ...
    public static emu.gingerps.net.proto.PolygonRegionSizeOuterClass.PolygonRegionSize parseFrom(
    ...
    public static emu.gingerps.net.proto.PolygonRegionSizeOuterClass.PolygonRegionSize parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.PolygonRegionSizeOuterClass.PolygonRegionSize parseFrom(
    ...
    public static emu.gingerps.net.proto.PolygonRegionSizeOuterClass.PolygonRegionSize parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.PolygonRegionSizeOuterClass.PolygonRegionSize parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.PolygonRegionSizeOuterClass.PolygonRegionSize parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.PolygonRegionSizeOuterClass.PolygonRegionSize prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.PolygonRegionSizeOuterClass.PolygonRegionSizeOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.PolygonRegionSizeOuterClass.internal_static_PolygonRegionSize_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.PolygonRegionSizeOuterClass.PolygonRegionSize getDefaultInstanceForType() {
        return emu.gingerps.net.proto.PolygonRegionSizeOuterClass.PolygonRegionSize.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.PolygonRegionSizeOuterClass.PolygonRegionSize build() {
        emu.gingerps.net.proto.PolygonRegionSizeOuterClass.PolygonRegionSize result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.PolygonRegionSizeOuterClass.PolygonRegionSize) {
          return mergeFrom((emu.gingerps.net.proto.PolygonRegionSizeOuterClass.PolygonRegionSize)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.PolygonRegionSizeOuterClass.PolygonRegionSize other) {
        if (other == emu.gingerps.net.proto.PolygonRegionSizeOuterClass.PolygonRegionSize.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.VectorPlaneOuterClass.VectorPlane, emu.gingerps.net.proto.VectorPlaneOuterClass.VectorPlane.Builder, emu.gingerps.net.proto.VectorPlaneOuterClass.VectorPlaneOrBuilder> pointListBuilder_;
      ...
      public Builder setPointList(
          int index, emu.gingerps.net.proto.VectorPlaneOuterClass.VectorPlane value) {
        if (pointListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setPointList(
          int index, emu.gingerps.net.proto.VectorPlaneOuterClass.VectorPlane.Builder builderForValue) {
        if (pointListBuilder_ == null) {
          ensurePointListIsMutable();
       ...
       * <code>repeated .VectorPlane point_list = 9;</code>
       */
      public Builder addPointList(emu.gingerps.net.proto.VectorPlaneOuterClass.VectorPlane value) {
        if (pointListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addPointList(
          emu.gingerps.net.proto.VectorPlaneOuterClass.VectorPlane.Builder builderForValue) {
        if (pointListBuilder_ == null) {
          ensurePointListIsMutable();
      ...
      public Builder addAllPointList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.VectorPlaneOuterClass.VectorPlane> values) {
        if (pointListBuilder_ == null) {
          ensurePointListIsMutable();
       ...
       * <code>repeated .VectorPlane point_list = 9;</code>
       */
      public emu.gingerps.net.proto.VectorPlaneOuterClass.VectorPlane.Builder getPointListBuilder(
          int index) {
       ...
       * <code>repeated .VectorPlane point_list = 9;</code>
       */
      public emu.gingerps.net.proto.VectorPlaneOuterClass.VectorPlane.Builder addPointListBuilder() {
        return getPointListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.VectorPlaneOuterClass.VectorPlane.getDefaultInstance());
      }
      /**
       * <code>repeated .VectorPlane point_list = 9;</code>
       */
      public emu.gingerps.net.proto.VectorPlaneOuterClass.VectorPlane.Builder addPointListBuilder(
          int index) {
        return getPointListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.VectorPlaneOuterClass.VectorPlane.getDefaultInstance());
      }
      /**
       * <code>repeated .VectorPlane point_list = 9;</code>
       */
      public java.util.List<emu.gingerps.net.proto.VectorPlaneOuterClass.VectorPlane.Builder> 
    ...
    private static final emu.gingerps.net.proto.PolygonRegionSizeOuterClass.PolygonRegionSize DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.PolygonRegionSizeOuterClass.PolygonRegionSize();
    }

    public static emu.gingerps.net.proto.PolygonRegionSizeOuterClass.PolygonRegionSize getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.VectorPlaneOuterClass.getDescriptor(),
        });
    internal_static_PolygonRegionSize_descriptor =
