...
public final class GetPlayerTokenRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 15178: {
              ...
              stopServer_ = input.readMessage(emu.gingerps.net.proto.StopServerInfoOuterClass.StopServerInfo.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.gingerps.net.proto.GetPlayerTokenRspOuterClass.internal_static_GetPlayerTokenRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.gingerps.net.proto.GetPlayerTokenRspOuterClass.internal_static_GetPlayerTokenRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp.class, emu.gingerps.net.proto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp.Builder.class);
    }
    ...
    private emu.gingerps.net.proto.StopServerInfoOuterClass.StopServerInfo stopServer_;
    /**
     * <code>.StopServerInfo stop_server = 1897;</code>
     * @return Whether the stopServer field is set.
     */
    ...
    public emu.gingerps.net.proto.StopServerInfoOuterClass.StopServerInfo getStopServer() {
      return stopServer_ == null ? emu.gingerps.net.proto.StopServerInfoOuterClass.StopServerInfo.getDefaultInstance() : stopServer_;
    }
    /**
     * <code>.StopServerInfo stop_server = 1897;</code>
     */
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp other = (emu.gingerps.net.proto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp) obj;
    ...
    public static emu.gingerps.net.proto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.GetPlayerTokenRspOuterClass.GetPlayerTokenRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.GetPlayerTokenRspOuterClass.internal_static_GetPlayerTokenRsp_descriptor;
      }
      ...
      // Construct using emu.gingerps.net.proto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp getDefaultInstanceForType() {
        return emu.gingerps.net.proto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp build() {
        emu.gingerps.net.proto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp buildPartial() {
        emu.gingerps.net.proto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp result = new emu.gingerps.net.proto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp) {
          return mergeFrom((emu.gingerps.net.proto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp other) {
        if (other == emu.gingerps.net.proto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        emu.gingerps.net.proto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (emu.gingerps.net.proto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
      ...
      public Builder mergeStopServer(emu.gingerps.net.proto.StopServerInfoOuterClass.StopServerInfo value) {
        if (stopServerBuilder_ == null) {
          if (stopServer_ != null) {
            stopServer_ =
              emu.gingerps.net.proto.StopServerInfoOuterClass.StopServerInfo.newBuilder(stopServer_).mergeFrom(value).buildPartial();
          } else {
            stopServer_ = value;
          }
          onChanged();
      ...
      public emu.gingerps.net.proto.StopServerInfoOuterClass.StopServerInfoOrBuilder getStopServerOrBuilder() {
        if (stopServerBuilder_ != null) {
          ...
          return stopServer_ == null ?
              emu.gingerps.net.proto.StopServerInfoOuterClass.StopServerInfo.getDefaultInstance() : stopServer_;
        }
      }
      /**
       * <code>.StopServerInfo stop_server = 1897;</code>
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.gingerps.net.proto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp();
    }

    public static emu.gingerps.net.proto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp getDefaultInstance() {
