...
public final class HomeFurnitureGroupDataOuterClass {
  ...
  public interface HomeFurnitureGroupDataOrBuilder extends
     ...
     * <code>repeated .HomeFurnitureData virtual_furniture_list = 1;</code>
     */
    emu.gingerps.net.proto.HomeFurnitureDataOuterClass.HomeFurnitureData getVirtualFurnitureList(int index);
    /**
     * <code>repeated .HomeFurnitureData virtual_furniture_list = 1;</code>
     */
     ...
     * <code>repeated .HomeFurnitureData virtual_furniture_list = 1;</code>
     */
    emu.gingerps.net.proto.HomeFurnitureDataOuterClass.HomeFurnitureDataOrBuilder getVirtualFurnitureListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.HomeFurnitureGroupDataOuterClass.internal_static_HomeFurnitureGroupData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData.class, emu.gingerps.net.proto.HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.HomeFurnitureDataOuterClass.HomeFurnitureData> getVirtualFurnitureListList() {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.HomeFurnitureDataOuterClass.HomeFurnitureData getVirtualFurnitureList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.HomeFurnitureDataOuterClass.HomeFurnitureDataOrBuilder getVirtualFurnitureListOrBuilder(
        int index) {
      return virtualFurnitureList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData other = (emu.gingerps.net.proto.HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData) obj;
    ...
    public static emu.gingerps.net.proto.HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData parseFrom(
    ...
    public static emu.gingerps.net.proto.HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData parseFrom(
    ...
    public static emu.gingerps.net.proto.HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.HomeFurnitureGroupDataOuterClass.internal_static_HomeFurnitureGroupData_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData getDefaultInstanceForType() {
        return emu.gingerps.net.proto.HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData build() {
        emu.gingerps.net.proto.HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData) {
          return mergeFrom((emu.gingerps.net.proto.HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData other) {
        if (other == emu.gingerps.net.proto.HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData.getDefaultInstance()) return this;
        if (virtualFurnitureListBuilder_ == null) {
      ...
      private void ensureVirtualFurnitureListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          virtualFurnitureList_ = new java.util.ArrayList<emu.gingerps.net.proto.HomeFurnitureDataOuterClass.HomeFurnitureData>(virtualFurnitureList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.HomeFurnitureDataOuterClass.HomeFurnitureData, emu.gingerps.net.proto.HomeFurnitureDataOuterClass.HomeFurnitureData.Builder, emu.gingerps.net.proto.HomeFurnitureDataOuterClass.HomeFurnitureDataOrBuilder> virtualFurnitureListBuilder_;
       ...
       * <code>repeated .HomeFurnitureData virtual_furniture_list = 1;</code>
       */
      public Builder addVirtualFurnitureList(emu.gingerps.net.proto.HomeFurnitureDataOuterClass.HomeFurnitureData value) {
        if (virtualFurnitureListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .HomeFurnitureData virtual_furniture_list = 1;</code>
       */
      public emu.gingerps.net.proto.HomeFurnitureDataOuterClass.HomeFurnitureData.Builder getVirtualFurnitureListBuilder(
          int index) {
       ...
       * <code>repeated .HomeFurnitureData virtual_furniture_list = 1;</code>
       */
      public emu.gingerps.net.proto.HomeFurnitureDataOuterClass.HomeFurnitureData.Builder addVirtualFurnitureListBuilder() {
    ...
    private static final emu.gingerps.net.proto.HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData();
    }

    public static emu.gingerps.net.proto.HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData getDefaultInstance() {
