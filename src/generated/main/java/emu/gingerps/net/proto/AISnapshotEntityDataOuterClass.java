...
public final class AISnapshotEntityDataOuterClass {
  ...
  public interface AISnapshotEntityDataOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle> 
        getFinishedSkillCyclesList();
    /**
     * <code>repeated .AISnapshotEntitySkillCycle finished_skill_cycles = 14;</code>
     */
    emu.gingerps.net.proto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle getFinishedSkillCycles(int index);
    /**
     * <code>repeated .AISnapshotEntitySkillCycle finished_skill_cycles = 14;</code>
     */
     ...
     * <code>repeated .AISnapshotEntitySkillCycle finished_skill_cycles = 14;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycleOrBuilder> 
        getFinishedSkillCyclesOrBuilderList();
    /**
     * <code>repeated .AISnapshotEntitySkillCycle finished_skill_cycles = 14;</code>
     */
    emu.gingerps.net.proto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycleOrBuilder getFinishedSkillCyclesOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 114: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                finishedSkillCycles_ = new java.util.ArrayList<emu.gingerps.net.proto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle>();
                mutable_bitField0_ |= 0x00000001;
              }
              finishedSkillCycles_.add(
                  input.readMessage(emu.gingerps.net.proto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle.parser(), extensionRegistry));
              break;
            }
            case 125: {
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.gingerps.net.proto.AISnapshotEntityDataOuterClass.internal_static_AISnapshotEntityData_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.AISnapshotEntityDataOuterClass.internal_static_AISnapshotEntityData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.AISnapshotEntityDataOuterClass.AISnapshotEntityData.class, emu.gingerps.net.proto.AISnapshotEntityDataOuterClass.AISnapshotEntityData.Builder.class);
    }

    public static final int FINISHED_SKILL_CYCLES_FIELD_NUMBER = 14;
    private java.util.List<emu.gingerps.net.proto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle> finishedSkillCycles_;
    /**
     * <code>repeated .AISnapshotEntitySkillCycle finished_skill_cycles = 14;</code>
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle> getFinishedSkillCyclesList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycleOrBuilder> 
        getFinishedSkillCyclesOrBuilderList() {
      return finishedSkillCycles_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle getFinishedSkillCycles(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycleOrBuilder getFinishedSkillCyclesOrBuilder(
        int index) {
      return finishedSkillCycles_.get(index);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.gingerps.net.proto.AISnapshotEntityDataOuterClass.internal_static_AISnapshotEntityData_HittingAvatarsEntry_descriptor, 
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.AISnapshotEntityDataOuterClass.AISnapshotEntityData)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.AISnapshotEntityDataOuterClass.AISnapshotEntityData other = (emu.gingerps.net.proto.AISnapshotEntityDataOuterClass.AISnapshotEntityData) obj;
    ...
    public static emu.gingerps.net.proto.AISnapshotEntityDataOuterClass.AISnapshotEntityData parseFrom(
    ...
    public static emu.gingerps.net.proto.AISnapshotEntityDataOuterClass.AISnapshotEntityData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.AISnapshotEntityDataOuterClass.AISnapshotEntityData parseFrom(
    ...
    public static emu.gingerps.net.proto.AISnapshotEntityDataOuterClass.AISnapshotEntityData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.AISnapshotEntityDataOuterClass.AISnapshotEntityData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.AISnapshotEntityDataOuterClass.AISnapshotEntityData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.AISnapshotEntityDataOuterClass.AISnapshotEntityData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.AISnapshotEntityDataOuterClass.AISnapshotEntityDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.AISnapshotEntityDataOuterClass.internal_static_AISnapshotEntityData_descriptor;
      }
      ...
      // Construct using emu.gingerps.net.proto.AISnapshotEntityDataOuterClass.AISnapshotEntityData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.AISnapshotEntityDataOuterClass.AISnapshotEntityData getDefaultInstanceForType() {
        return emu.gingerps.net.proto.AISnapshotEntityDataOuterClass.AISnapshotEntityData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.AISnapshotEntityDataOuterClass.AISnapshotEntityData build() {
        emu.gingerps.net.proto.AISnapshotEntityDataOuterClass.AISnapshotEntityData result = buildPartial();
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.AISnapshotEntityDataOuterClass.AISnapshotEntityData buildPartial() {
        emu.gingerps.net.proto.AISnapshotEntityDataOuterClass.AISnapshotEntityData result = new emu.gingerps.net.proto.AISnapshotEntityDataOuterClass.AISnapshotEntityData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.AISnapshotEntityDataOuterClass.AISnapshotEntityData) {
          return mergeFrom((emu.gingerps.net.proto.AISnapshotEntityDataOuterClass.AISnapshotEntityData)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.AISnapshotEntityDataOuterClass.AISnapshotEntityData other) {
        if (other == emu.gingerps.net.proto.AISnapshotEntityDataOuterClass.AISnapshotEntityData.getDefaultInstance()) return this;
        if (finishedSkillCyclesBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        emu.gingerps.net.proto.AISnapshotEntityDataOuterClass.AISnapshotEntityData parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (emu.gingerps.net.proto.AISnapshotEntityDataOuterClass.AISnapshotEntityData) e.getUnfinishedMessage();
      ...
      private void ensureFinishedSkillCyclesIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          finishedSkillCycles_ = new java.util.ArrayList<emu.gingerps.net.proto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle>(finishedSkillCycles_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle, emu.gingerps.net.proto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle.Builder, emu.gingerps.net.proto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycleOrBuilder> finishedSkillCyclesBuilder_;
      ...
      public Builder setFinishedSkillCycles(
          int index, emu.gingerps.net.proto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle value) {
        if (finishedSkillCyclesBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setFinishedSkillCycles(
          int index, emu.gingerps.net.proto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle.Builder builderForValue) {
        if (finishedSkillCyclesBuilder_ == null) {
          ensureFinishedSkillCyclesIsMutable();
       ...
       * <code>repeated .AISnapshotEntitySkillCycle finished_skill_cycles = 14;</code>
       */
      public Builder addFinishedSkillCycles(emu.gingerps.net.proto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle value) {
        if (finishedSkillCyclesBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addFinishedSkillCycles(
          emu.gingerps.net.proto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle.Builder builderForValue) {
        if (finishedSkillCyclesBuilder_ == null) {
          ensureFinishedSkillCyclesIsMutable();
      ...
      public Builder addAllFinishedSkillCycles(
          java.lang.Iterable<? extends emu.gingerps.net.proto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle> values) {
        if (finishedSkillCyclesBuilder_ == null) {
          ensureFinishedSkillCyclesIsMutable();
       ...
       * <code>repeated .AISnapshotEntitySkillCycle finished_skill_cycles = 14;</code>
       */
      public emu.gingerps.net.proto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle.Builder getFinishedSkillCyclesBuilder(
          int index) {
       ...
       * <code>repeated .AISnapshotEntitySkillCycle finished_skill_cycles = 14;</code>
       */
      public emu.gingerps.net.proto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle.Builder addFinishedSkillCyclesBuilder() {
        return getFinishedSkillCyclesFieldBuilder().addBuilder(
            emu.gingerps.net.proto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle.getDefaultInstance());
      }
      /**
       * <code>repeated .AISnapshotEntitySkillCycle finished_skill_cycles = 14;</code>
       */
      public emu.gingerps.net.proto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle.Builder addFinishedSkillCyclesBuilder(
          int index) {
        return getFinishedSkillCyclesFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle.getDefaultInstance());
      }
      /**
       * <code>repeated .AISnapshotEntitySkillCycle finished_skill_cycles = 14;</code>
       */
      public java.util.List<emu.gingerps.net.proto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle.Builder> 
           getFinishedSkillCyclesBuilderList() {
        return getFinishedSkillCyclesFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle, emu.gingerps.net.proto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle.Builder, emu.gingerps.net.proto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycleOrBuilder> 
          getFinishedSkillCyclesFieldBuilder() {
        if (finishedSkillCyclesBuilder_ == null) {
    ...
    private static final emu.gingerps.net.proto.AISnapshotEntityDataOuterClass.AISnapshotEntityData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.AISnapshotEntityDataOuterClass.AISnapshotEntityData();
    }

    public static emu.gingerps.net.proto.AISnapshotEntityDataOuterClass.AISnapshotEntityData getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.AISnapshotEntitySkillCycleOuterClass.getDescriptor(),
        });
    internal_static_AISnapshotEntityData_descriptor =
