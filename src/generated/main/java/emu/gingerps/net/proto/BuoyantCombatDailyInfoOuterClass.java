...
public final class BuoyantCombatDailyInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.BuoyantCombatDailyInfoOuterClass.internal_static_BuoyantCombatDailyInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.BuoyantCombatDailyInfoOuterClass.BuoyantCombatDailyInfo.class, emu.gingerps.net.proto.BuoyantCombatDailyInfoOuterClass.BuoyantCombatDailyInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.BuoyantCombatDailyInfoOuterClass.BuoyantCombatDailyInfo)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.BuoyantCombatDailyInfoOuterClass.BuoyantCombatDailyInfo other = (emu.gingerps.net.proto.BuoyantCombatDailyInfoOuterClass.BuoyantCombatDailyInfo) obj;
    ...
    public static emu.gingerps.net.proto.BuoyantCombatDailyInfoOuterClass.BuoyantCombatDailyInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.BuoyantCombatDailyInfoOuterClass.BuoyantCombatDailyInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.BuoyantCombatDailyInfoOuterClass.BuoyantCombatDailyInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.BuoyantCombatDailyInfoOuterClass.BuoyantCombatDailyInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.BuoyantCombatDailyInfoOuterClass.BuoyantCombatDailyInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.BuoyantCombatDailyInfoOuterClass.BuoyantCombatDailyInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.BuoyantCombatDailyInfoOuterClass.BuoyantCombatDailyInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.BuoyantCombatDailyInfoOuterClass.BuoyantCombatDailyInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.BuoyantCombatDailyInfoOuterClass.internal_static_BuoyantCombatDailyInfo_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.BuoyantCombatDailyInfoOuterClass.BuoyantCombatDailyInfo getDefaultInstanceForType() {
        return emu.gingerps.net.proto.BuoyantCombatDailyInfoOuterClass.BuoyantCombatDailyInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.BuoyantCombatDailyInfoOuterClass.BuoyantCombatDailyInfo build() {
        emu.gingerps.net.proto.BuoyantCombatDailyInfoOuterClass.BuoyantCombatDailyInfo result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.BuoyantCombatDailyInfoOuterClass.BuoyantCombatDailyInfo) {
          return mergeFrom((emu.gingerps.net.proto.BuoyantCombatDailyInfoOuterClass.BuoyantCombatDailyInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.BuoyantCombatDailyInfoOuterClass.BuoyantCombatDailyInfo other) {
        if (other == emu.gingerps.net.proto.BuoyantCombatDailyInfoOuterClass.BuoyantCombatDailyInfo.getDefaultInstance()) return this;
    ...
    private static final emu.gingerps.net.proto.BuoyantCombatDailyInfoOuterClass.BuoyantCombatDailyInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.BuoyantCombatDailyInfoOuterClass.BuoyantCombatDailyInfo();
    }

    public static emu.gingerps.net.proto.BuoyantCombatDailyInfoOuterClass.BuoyantCombatDailyInfo getDefaultInstance() {
