...
public final class AbilityActionSetCrashDamageOuterClass {
  ...
  public interface AbilityActionSetCrashDamageOrBuilder extends
     ...
     * @return The hitPos.
     */
    emu.gingerps.net.proto.VectorOuterClass.Vector getHitPos();
    /**
     * <code>.Vector hit_pos = 8;</code>
     */
    emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder getHitPosOrBuilder();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.AbilityActionSetCrashDamageOuterClass.internal_static_AbilityActionSetCrashDamage_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.AbilityActionSetCrashDamageOuterClass.AbilityActionSetCrashDamage.class, emu.gingerps.net.proto.AbilityActionSetCrashDamageOuterClass.AbilityActionSetCrashDamage.Builder.class);
    }
    ...
    private emu.gingerps.net.proto.VectorOuterClass.Vector hitPos_;
    /**
     * <code>.Vector hit_pos = 8;</code>
     * @return Whether the hitPos field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.VectorOuterClass.Vector getHitPos() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.AbilityActionSetCrashDamageOuterClass.AbilityActionSetCrashDamage)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.AbilityActionSetCrashDamageOuterClass.AbilityActionSetCrashDamage other = (emu.gingerps.net.proto.AbilityActionSetCrashDamageOuterClass.AbilityActionSetCrashDamage) obj;
    ...
    public static emu.gingerps.net.proto.AbilityActionSetCrashDamageOuterClass.AbilityActionSetCrashDamage parseFrom(
    ...
    public static emu.gingerps.net.proto.AbilityActionSetCrashDamageOuterClass.AbilityActionSetCrashDamage parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.AbilityActionSetCrashDamageOuterClass.AbilityActionSetCrashDamage parseFrom(
    ...
    public static emu.gingerps.net.proto.AbilityActionSetCrashDamageOuterClass.AbilityActionSetCrashDamage parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.AbilityActionSetCrashDamageOuterClass.AbilityActionSetCrashDamage parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.AbilityActionSetCrashDamageOuterClass.AbilityActionSetCrashDamage parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.AbilityActionSetCrashDamageOuterClass.AbilityActionSetCrashDamage prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.AbilityActionSetCrashDamageOuterClass.AbilityActionSetCrashDamageOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.AbilityActionSetCrashDamageOuterClass.internal_static_AbilityActionSetCrashDamage_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.AbilityActionSetCrashDamageOuterClass.AbilityActionSetCrashDamage getDefaultInstanceForType() {
        return emu.gingerps.net.proto.AbilityActionSetCrashDamageOuterClass.AbilityActionSetCrashDamage.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.AbilityActionSetCrashDamageOuterClass.AbilityActionSetCrashDamage build() {
        emu.gingerps.net.proto.AbilityActionSetCrashDamageOuterClass.AbilityActionSetCrashDamage result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.AbilityActionSetCrashDamageOuterClass.AbilityActionSetCrashDamage) {
          return mergeFrom((emu.gingerps.net.proto.AbilityActionSetCrashDamageOuterClass.AbilityActionSetCrashDamage)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.AbilityActionSetCrashDamageOuterClass.AbilityActionSetCrashDamage other) {
        if (other == emu.gingerps.net.proto.AbilityActionSetCrashDamageOuterClass.AbilityActionSetCrashDamage.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.VectorOuterClass.Vector, emu.gingerps.net.proto.VectorOuterClass.Vector.Builder, emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder> hitPosBuilder_;
      /**
       * <code>.Vector hit_pos = 8;</code>
       * @return Whether the hitPos field is set.
       */
       ...
       * <code>.Vector hit_pos = 8;</code>
       */
      public Builder setHitPos(emu.gingerps.net.proto.VectorOuterClass.Vector value) {
        if (hitPosBuilder_ == null) {
          if (value == null) {
      ...
      public emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder getHitPosOrBuilder() {
        if (hitPosBuilder_ != null) {
          ...
          return hitPos_ == null ?
              emu.gingerps.net.proto.VectorOuterClass.Vector.getDefaultInstance() : hitPos_;
        }
      }
      /**
       * <code>.Vector hit_pos = 8;</code>
    ...
    private static final emu.gingerps.net.proto.AbilityActionSetCrashDamageOuterClass.AbilityActionSetCrashDamage DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.AbilityActionSetCrashDamageOuterClass.AbilityActionSetCrashDamage();
    }

    public static emu.gingerps.net.proto.AbilityActionSetCrashDamageOuterClass.AbilityActionSetCrashDamage getDefaultInstance() {
