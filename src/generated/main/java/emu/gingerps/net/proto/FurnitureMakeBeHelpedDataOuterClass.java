...
public final class FurnitureMakeBeHelpedDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.FurnitureMakeBeHelpedDataOuterClass.internal_static_FurnitureMakeBeHelpedData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData.class, emu.gingerps.net.proto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData other = (emu.gingerps.net.proto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData) obj;
    ...
    public static emu.gingerps.net.proto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData parseFrom(
    ...
    public static emu.gingerps.net.proto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData parseFrom(
    ...
    public static emu.gingerps.net.proto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.FurnitureMakeBeHelpedDataOuterClass.internal_static_FurnitureMakeBeHelpedData_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData getDefaultInstanceForType() {
        return emu.gingerps.net.proto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData build() {
        emu.gingerps.net.proto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData) {
          return mergeFrom((emu.gingerps.net.proto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData other) {
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.gingerps.net.proto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData();
    }

    public static emu.gingerps.net.proto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData getDefaultInstance() {
