...
public final class GachaTransferItemOuterClass {
  ...
  public interface GachaTransferItemOrBuilder extends
     ...
     * @return The item.
     */
    emu.gingerps.net.proto.ItemParamOuterClass.ItemParam getItem();
    /**
     * <code>.ItemParam item = 1;</code>
     */
    emu.gingerps.net.proto.ItemParamOuterClass.ItemParamOrBuilder getItemOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.GachaTransferItemOuterClass.internal_static_GachaTransferItem_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.GachaTransferItemOuterClass.GachaTransferItem.class, emu.gingerps.net.proto.GachaTransferItemOuterClass.GachaTransferItem.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.ItemParamOuterClass.ItemParam getItem() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.GachaTransferItemOuterClass.GachaTransferItem)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.GachaTransferItemOuterClass.GachaTransferItem other = (emu.gingerps.net.proto.GachaTransferItemOuterClass.GachaTransferItem) obj;
    ...
    public static emu.gingerps.net.proto.GachaTransferItemOuterClass.GachaTransferItem parseFrom(
    ...
    public static emu.gingerps.net.proto.GachaTransferItemOuterClass.GachaTransferItem parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.GachaTransferItemOuterClass.GachaTransferItem parseFrom(
    ...
    public static emu.gingerps.net.proto.GachaTransferItemOuterClass.GachaTransferItem parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.GachaTransferItemOuterClass.GachaTransferItem parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.GachaTransferItemOuterClass.GachaTransferItem parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.GachaTransferItemOuterClass.GachaTransferItem prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.GachaTransferItemOuterClass.GachaTransferItemOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.GachaTransferItemOuterClass.internal_static_GachaTransferItem_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.GachaTransferItemOuterClass.GachaTransferItem getDefaultInstanceForType() {
        return emu.gingerps.net.proto.GachaTransferItemOuterClass.GachaTransferItem.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.GachaTransferItemOuterClass.GachaTransferItem build() {
        emu.gingerps.net.proto.GachaTransferItemOuterClass.GachaTransferItem result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.GachaTransferItemOuterClass.GachaTransferItem) {
          return mergeFrom((emu.gingerps.net.proto.GachaTransferItemOuterClass.GachaTransferItem)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.GachaTransferItemOuterClass.GachaTransferItem other) {
        if (other == emu.gingerps.net.proto.GachaTransferItemOuterClass.GachaTransferItem.getDefaultInstance()) return this;
        if (other.hasItem()) {
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.ItemParamOuterClass.ItemParam, emu.gingerps.net.proto.ItemParamOuterClass.ItemParam.Builder, emu.gingerps.net.proto.ItemParamOuterClass.ItemParamOrBuilder> itemBuilder_;
      /**
       * <code>.ItemParam item = 1;</code>
       * @return Whether the item field is set.
       */
       ...
       * <code>.ItemParam item = 1;</code>
       */
      public Builder setItem(emu.gingerps.net.proto.ItemParamOuterClass.ItemParam value) {
        if (itemBuilder_ == null) {
          if (value == null) {
      ...
      public emu.gingerps.net.proto.ItemParamOuterClass.ItemParamOrBuilder getItemOrBuilder() {
        if (itemBuilder_ != null) {
          ...
          return item_ == null ?
              emu.gingerps.net.proto.ItemParamOuterClass.ItemParam.getDefaultInstance() : item_;
        }
      }
      /**
       * <code>.ItemParam item = 1;</code>
    ...
    private static final emu.gingerps.net.proto.GachaTransferItemOuterClass.GachaTransferItem DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.GachaTransferItemOuterClass.GachaTransferItem();
    }

    public static emu.gingerps.net.proto.GachaTransferItemOuterClass.GachaTransferItem getDefaultInstance() {
