...
public final class GCGBossChallengeDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.gingerps.net.proto.GCGBossChallengeDataOuterClass.internal_static_GCGBossChallengeData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.gingerps.net.proto.GCGBossChallengeDataOuterClass.internal_static_GCGBossChallengeData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.GCGBossChallengeDataOuterClass.GCGBossChallengeData.class, emu.gingerps.net.proto.GCGBossChallengeDataOuterClass.GCGBossChallengeData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.GCGBossChallengeDataOuterClass.GCGBossChallengeData)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.GCGBossChallengeDataOuterClass.GCGBossChallengeData other = (emu.gingerps.net.proto.GCGBossChallengeDataOuterClass.GCGBossChallengeData) obj;
    ...
    public static emu.gingerps.net.proto.GCGBossChallengeDataOuterClass.GCGBossChallengeData parseFrom(
    ...
    public static emu.gingerps.net.proto.GCGBossChallengeDataOuterClass.GCGBossChallengeData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.GCGBossChallengeDataOuterClass.GCGBossChallengeData parseFrom(
    ...
    public static emu.gingerps.net.proto.GCGBossChallengeDataOuterClass.GCGBossChallengeData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.GCGBossChallengeDataOuterClass.GCGBossChallengeData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.GCGBossChallengeDataOuterClass.GCGBossChallengeData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.GCGBossChallengeDataOuterClass.GCGBossChallengeData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.GCGBossChallengeDataOuterClass.GCGBossChallengeDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.GCGBossChallengeDataOuterClass.internal_static_GCGBossChallengeData_descriptor;
      }
      ...
      // Construct using emu.gingerps.net.proto.GCGBossChallengeDataOuterClass.GCGBossChallengeData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.GCGBossChallengeDataOuterClass.GCGBossChallengeData getDefaultInstanceForType() {
        return emu.gingerps.net.proto.GCGBossChallengeDataOuterClass.GCGBossChallengeData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.GCGBossChallengeDataOuterClass.GCGBossChallengeData build() {
        emu.gingerps.net.proto.GCGBossChallengeDataOuterClass.GCGBossChallengeData result = buildPartial();
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.GCGBossChallengeDataOuterClass.GCGBossChallengeData buildPartial() {
        emu.gingerps.net.proto.GCGBossChallengeDataOuterClass.GCGBossChallengeData result = new emu.gingerps.net.proto.GCGBossChallengeDataOuterClass.GCGBossChallengeData(this);
      ...
      private void buildPartialRepeatedFields(emu.gingerps.net.proto.GCGBossChallengeDataOuterClass.GCGBossChallengeData result) {
      ...
      private void buildPartial0(emu.gingerps.net.proto.GCGBossChallengeDataOuterClass.GCGBossChallengeData result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.GCGBossChallengeDataOuterClass.GCGBossChallengeData) {
          return mergeFrom((emu.gingerps.net.proto.GCGBossChallengeDataOuterClass.GCGBossChallengeData)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.GCGBossChallengeDataOuterClass.GCGBossChallengeData other) {
        if (other == emu.gingerps.net.proto.GCGBossChallengeDataOuterClass.GCGBossChallengeData.getDefaultInstance()) return this;
    ...
    private static final emu.gingerps.net.proto.GCGBossChallengeDataOuterClass.GCGBossChallengeData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.GCGBossChallengeDataOuterClass.GCGBossChallengeData();
    }

    public static emu.gingerps.net.proto.GCGBossChallengeDataOuterClass.GCGBossChallengeData getDefaultInstance() {
