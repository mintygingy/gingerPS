...
public final class GivingRecordChangeNotifyOuterClass {
  ...
  public interface GivingRecordChangeNotifyOrBuilder extends
     ...
     */
    emu.gingerps.net.proto.GivingRecordOuterClass.GivingRecord getGivingRecord();
    /**
     * <code>.GivingRecord giving_record = 15;</code>
     */
    emu.gingerps.net.proto.GivingRecordOuterClass.GivingRecordOrBuilder getGivingRecordOrBuilder();
  }
  /**
   * <pre>
   * enum CmdId {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.GivingRecordChangeNotifyOuterClass.internal_static_GivingRecordChangeNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.GivingRecordChangeNotifyOuterClass.GivingRecordChangeNotify.class, emu.gingerps.net.proto.GivingRecordChangeNotifyOuterClass.GivingRecordChangeNotify.Builder.class);
    }
    ...
    private emu.gingerps.net.proto.GivingRecordOuterClass.GivingRecord givingRecord_;
    /**
     * <code>.GivingRecord giving_record = 15;</code>
     * @return Whether the givingRecord field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.GivingRecordOuterClass.GivingRecord getGivingRecord() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.GivingRecordChangeNotifyOuterClass.GivingRecordChangeNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.GivingRecordChangeNotifyOuterClass.GivingRecordChangeNotify other = (emu.gingerps.net.proto.GivingRecordChangeNotifyOuterClass.GivingRecordChangeNotify) obj;
    ...
    public static emu.gingerps.net.proto.GivingRecordChangeNotifyOuterClass.GivingRecordChangeNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.GivingRecordChangeNotifyOuterClass.GivingRecordChangeNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.GivingRecordChangeNotifyOuterClass.GivingRecordChangeNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.GivingRecordChangeNotifyOuterClass.GivingRecordChangeNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.GivingRecordChangeNotifyOuterClass.GivingRecordChangeNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.GivingRecordChangeNotifyOuterClass.GivingRecordChangeNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.GivingRecordChangeNotifyOuterClass.GivingRecordChangeNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.GivingRecordChangeNotifyOuterClass.GivingRecordChangeNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.GivingRecordChangeNotifyOuterClass.internal_static_GivingRecordChangeNotify_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.GivingRecordChangeNotifyOuterClass.GivingRecordChangeNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.GivingRecordChangeNotifyOuterClass.GivingRecordChangeNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.GivingRecordChangeNotifyOuterClass.GivingRecordChangeNotify build() {
        emu.gingerps.net.proto.GivingRecordChangeNotifyOuterClass.GivingRecordChangeNotify result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.GivingRecordChangeNotifyOuterClass.GivingRecordChangeNotify) {
          return mergeFrom((emu.gingerps.net.proto.GivingRecordChangeNotifyOuterClass.GivingRecordChangeNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.GivingRecordChangeNotifyOuterClass.GivingRecordChangeNotify other) {
        if (other == emu.gingerps.net.proto.GivingRecordChangeNotifyOuterClass.GivingRecordChangeNotify.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.GivingRecordOuterClass.GivingRecord, emu.gingerps.net.proto.GivingRecordOuterClass.GivingRecord.Builder, emu.gingerps.net.proto.GivingRecordOuterClass.GivingRecordOrBuilder> givingRecordBuilder_;
      /**
       * <code>.GivingRecord giving_record = 15;</code>
       * @return Whether the givingRecord field is set.
       */
       ...
       * <code>.GivingRecord giving_record = 15;</code>
       */
      public Builder setGivingRecord(emu.gingerps.net.proto.GivingRecordOuterClass.GivingRecord value) {
        if (givingRecordBuilder_ == null) {
          if (value == null) {
      ...
      public emu.gingerps.net.proto.GivingRecordOuterClass.GivingRecordOrBuilder getGivingRecordOrBuilder() {
        if (givingRecordBuilder_ != null) {
          ...
          return givingRecord_ == null ?
              emu.gingerps.net.proto.GivingRecordOuterClass.GivingRecord.getDefaultInstance() : givingRecord_;
        }
      }
      /**
       * <code>.GivingRecord giving_record = 15;</code>
    ...
    private static final emu.gingerps.net.proto.GivingRecordChangeNotifyOuterClass.GivingRecordChangeNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.GivingRecordChangeNotifyOuterClass.GivingRecordChangeNotify();
    }

    public static emu.gingerps.net.proto.GivingRecordChangeNotifyOuterClass.GivingRecordChangeNotify getDefaultInstance() {
