...
public final class AvatarFetterInfoOuterClass {
  ...
  public interface AvatarFetterInfoOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.FetterDataOuterClass.FetterData> 
        getFetterListList();
    /**
     * <code>repeated .FetterData fetter_list = 6;</code>
     */
    emu.gingerps.net.proto.FetterDataOuterClass.FetterData getFetterList(int index);
    /**
     * <code>repeated .FetterData fetter_list = 6;</code>
     */
     ...
     * <code>repeated .FetterData fetter_list = 6;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.FetterDataOuterClass.FetterDataOrBuilder> 
        getFetterListOrBuilderList();
    /**
     * <code>repeated .FetterData fetter_list = 6;</code>
     */
    emu.gingerps.net.proto.FetterDataOuterClass.FetterDataOrBuilder getFetterListOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.AvatarFetterInfoOuterClass.internal_static_AvatarFetterInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.AvatarFetterInfoOuterClass.AvatarFetterInfo.class, emu.gingerps.net.proto.AvatarFetterInfoOuterClass.AvatarFetterInfo.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.FetterDataOuterClass.FetterData> getFetterListList() {
      return fetterList_;
    }
    /**
     * <code>repeated .FetterData fetter_list = 6;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.FetterDataOuterClass.FetterDataOrBuilder> 
        getFetterListOrBuilderList() {
      return fetterList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.FetterDataOuterClass.FetterData getFetterList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.FetterDataOuterClass.FetterDataOrBuilder getFetterListOrBuilder(
        int index) {
      return fetterList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.AvatarFetterInfoOuterClass.AvatarFetterInfo)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.AvatarFetterInfoOuterClass.AvatarFetterInfo other = (emu.gingerps.net.proto.AvatarFetterInfoOuterClass.AvatarFetterInfo) obj;
    ...
    public static emu.gingerps.net.proto.AvatarFetterInfoOuterClass.AvatarFetterInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.AvatarFetterInfoOuterClass.AvatarFetterInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.AvatarFetterInfoOuterClass.AvatarFetterInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.AvatarFetterInfoOuterClass.AvatarFetterInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.AvatarFetterInfoOuterClass.AvatarFetterInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.AvatarFetterInfoOuterClass.AvatarFetterInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.AvatarFetterInfoOuterClass.AvatarFetterInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.AvatarFetterInfoOuterClass.AvatarFetterInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.AvatarFetterInfoOuterClass.internal_static_AvatarFetterInfo_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.AvatarFetterInfoOuterClass.AvatarFetterInfo getDefaultInstanceForType() {
        return emu.gingerps.net.proto.AvatarFetterInfoOuterClass.AvatarFetterInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.AvatarFetterInfoOuterClass.AvatarFetterInfo build() {
        emu.gingerps.net.proto.AvatarFetterInfoOuterClass.AvatarFetterInfo result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.AvatarFetterInfoOuterClass.AvatarFetterInfo) {
          return mergeFrom((emu.gingerps.net.proto.AvatarFetterInfoOuterClass.AvatarFetterInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.AvatarFetterInfoOuterClass.AvatarFetterInfo other) {
        if (other == emu.gingerps.net.proto.AvatarFetterInfoOuterClass.AvatarFetterInfo.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.FetterDataOuterClass.FetterData, emu.gingerps.net.proto.FetterDataOuterClass.FetterData.Builder, emu.gingerps.net.proto.FetterDataOuterClass.FetterDataOrBuilder> fetterListBuilder_;
      ...
      public Builder setFetterList(
          int index, emu.gingerps.net.proto.FetterDataOuterClass.FetterData value) {
        if (fetterListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setFetterList(
          int index, emu.gingerps.net.proto.FetterDataOuterClass.FetterData.Builder builderForValue) {
        if (fetterListBuilder_ == null) {
          ensureFetterListIsMutable();
       ...
       * <code>repeated .FetterData fetter_list = 6;</code>
       */
      public Builder addFetterList(emu.gingerps.net.proto.FetterDataOuterClass.FetterData value) {
        if (fetterListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addFetterList(
          emu.gingerps.net.proto.FetterDataOuterClass.FetterData.Builder builderForValue) {
        if (fetterListBuilder_ == null) {
          ensureFetterListIsMutable();
      ...
      public Builder addAllFetterList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.FetterDataOuterClass.FetterData> values) {
        if (fetterListBuilder_ == null) {
          ensureFetterListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
              values, fetterList_);
       ...
       * <code>repeated .FetterData fetter_list = 6;</code>
       */
      public emu.gingerps.net.proto.FetterDataOuterClass.FetterData.Builder getFetterListBuilder(
          int index) {
       ...
       * <code>repeated .FetterData fetter_list = 6;</code>
       */
      public emu.gingerps.net.proto.FetterDataOuterClass.FetterData.Builder addFetterListBuilder() {
        return getFetterListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.FetterDataOuterClass.FetterData.getDefaultInstance());
      }
      /**
       * <code>repeated .FetterData fetter_list = 6;</code>
       */
      public emu.gingerps.net.proto.FetterDataOuterClass.FetterData.Builder addFetterListBuilder(
          int index) {
        return getFetterListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.FetterDataOuterClass.FetterData.getDefaultInstance());
      }
      /**
       * <code>repeated .FetterData fetter_list = 6;</code>
       */
      public java.util.List<emu.gingerps.net.proto.FetterDataOuterClass.FetterData.Builder> 
    ...
    private static final emu.gingerps.net.proto.AvatarFetterInfoOuterClass.AvatarFetterInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.AvatarFetterInfoOuterClass.AvatarFetterInfo();
    }

    public static emu.gingerps.net.proto.AvatarFetterInfoOuterClass.AvatarFetterInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\006 \003(\0132\013.FetterDataB\030\n\026emu.gingerps.net.p" +
      "rotob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.FetterDataOuterClass.getDescriptor(),
        });
    internal_static_AvatarFetterInfo_descriptor =
