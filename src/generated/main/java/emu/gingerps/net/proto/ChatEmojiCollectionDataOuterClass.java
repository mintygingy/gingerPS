...
public final class ChatEmojiCollectionDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.ChatEmojiCollectionDataOuterClass.internal_static_ChatEmojiCollectionData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData.class, emu.gingerps.net.proto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData other = (emu.gingerps.net.proto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData) obj;
    ...
    public static emu.gingerps.net.proto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData parseFrom(
    ...
    public static emu.gingerps.net.proto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData parseFrom(
    ...
    public static emu.gingerps.net.proto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.ChatEmojiCollectionDataOuterClass.internal_static_ChatEmojiCollectionData_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData getDefaultInstanceForType() {
        return emu.gingerps.net.proto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData build() {
        emu.gingerps.net.proto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData) {
          return mergeFrom((emu.gingerps.net.proto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData other) {
        if (other == emu.gingerps.net.proto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData.getDefaultInstance()) return this;
    ...
    private static final emu.gingerps.net.proto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData();
    }

    public static emu.gingerps.net.proto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData getDefaultInstance() {
