...
public final class WinterCampGetFriendWishListRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.gingerps.net.proto.WinterCampGetFriendWishListRspOuterClass.WinterCampGetFriendWishListRsp result) {
        if (wishDataListBuilder_ == null) {
      ...
      private void buildPartial0(emu.gingerps.net.proto.WinterCampGetFriendWishListRspOuterClass.WinterCampGetFriendWishListRsp result) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 26: {
                emu.gingerps.net.proto.WinterCampFriendWishDataOuterClass.WinterCampFriendWishData m =
                    input.readMessage(
                        emu.gingerps.net.proto.WinterCampFriendWishDataOuterClass.WinterCampFriendWishData.parser(),
                        extensionRegistry);
                if (wishDataListBuilder_ == null) {
                  ensureWishDataListIsMutable();
                  wishDataList_.add(m);
