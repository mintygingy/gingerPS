...
public final class DeathZoneInfoNotifyOuterClass {
  ...
  public interface DeathZoneInfoNotifyOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.DeathZoneInfoOuterClass.DeathZoneInfo> 
        getDeathZoneInfoListList();
    /**
     * <code>repeated .DeathZoneInfo death_zone_info_list = 15;</code>
     */
    emu.gingerps.net.proto.DeathZoneInfoOuterClass.DeathZoneInfo getDeathZoneInfoList(int index);
    /**
     * <code>repeated .DeathZoneInfo death_zone_info_list = 15;</code>
     */
     ...
     * <code>repeated .DeathZoneInfo death_zone_info_list = 15;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.DeathZoneInfoOuterClass.DeathZoneInfoOrBuilder> 
        getDeathZoneInfoListOrBuilderList();
    /**
     * <code>repeated .DeathZoneInfo death_zone_info_list = 15;</code>
     */
    emu.gingerps.net.proto.DeathZoneInfoOuterClass.DeathZoneInfoOrBuilder getDeathZoneInfoListOrBuilder(
        int index);
  }
  /**
   * <pre>
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.DeathZoneInfoNotifyOuterClass.internal_static_DeathZoneInfoNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.DeathZoneInfoNotifyOuterClass.DeathZoneInfoNotify.class, emu.gingerps.net.proto.DeathZoneInfoNotifyOuterClass.DeathZoneInfoNotify.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.DeathZoneInfoOuterClass.DeathZoneInfo> getDeathZoneInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.DeathZoneInfoOuterClass.DeathZoneInfoOrBuilder> 
        getDeathZoneInfoListOrBuilderList() {
      return deathZoneInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.DeathZoneInfoOuterClass.DeathZoneInfo getDeathZoneInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.DeathZoneInfoOuterClass.DeathZoneInfoOrBuilder getDeathZoneInfoListOrBuilder(
        int index) {
      return deathZoneInfoList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.DeathZoneInfoNotifyOuterClass.DeathZoneInfoNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.DeathZoneInfoNotifyOuterClass.DeathZoneInfoNotify other = (emu.gingerps.net.proto.DeathZoneInfoNotifyOuterClass.DeathZoneInfoNotify) obj;
    ...
    public static emu.gingerps.net.proto.DeathZoneInfoNotifyOuterClass.DeathZoneInfoNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.DeathZoneInfoNotifyOuterClass.DeathZoneInfoNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.DeathZoneInfoNotifyOuterClass.DeathZoneInfoNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.DeathZoneInfoNotifyOuterClass.DeathZoneInfoNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.DeathZoneInfoNotifyOuterClass.DeathZoneInfoNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.DeathZoneInfoNotifyOuterClass.DeathZoneInfoNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.DeathZoneInfoNotifyOuterClass.DeathZoneInfoNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.DeathZoneInfoNotifyOuterClass.DeathZoneInfoNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.DeathZoneInfoNotifyOuterClass.internal_static_DeathZoneInfoNotify_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.DeathZoneInfoNotifyOuterClass.DeathZoneInfoNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.DeathZoneInfoNotifyOuterClass.DeathZoneInfoNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.DeathZoneInfoNotifyOuterClass.DeathZoneInfoNotify build() {
        emu.gingerps.net.proto.DeathZoneInfoNotifyOuterClass.DeathZoneInfoNotify result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.DeathZoneInfoNotifyOuterClass.DeathZoneInfoNotify) {
          return mergeFrom((emu.gingerps.net.proto.DeathZoneInfoNotifyOuterClass.DeathZoneInfoNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.DeathZoneInfoNotifyOuterClass.DeathZoneInfoNotify other) {
        if (other == emu.gingerps.net.proto.DeathZoneInfoNotifyOuterClass.DeathZoneInfoNotify.getDefaultInstance()) return this;
        if (deathZoneInfoListBuilder_ == null) {
      ...
      private void ensureDeathZoneInfoListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          deathZoneInfoList_ = new java.util.ArrayList<emu.gingerps.net.proto.DeathZoneInfoOuterClass.DeathZoneInfo>(deathZoneInfoList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.DeathZoneInfoOuterClass.DeathZoneInfo, emu.gingerps.net.proto.DeathZoneInfoOuterClass.DeathZoneInfo.Builder, emu.gingerps.net.proto.DeathZoneInfoOuterClass.DeathZoneInfoOrBuilder> deathZoneInfoListBuilder_;
      ...
      public Builder setDeathZoneInfoList(
          int index, emu.gingerps.net.proto.DeathZoneInfoOuterClass.DeathZoneInfo value) {
        if (deathZoneInfoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setDeathZoneInfoList(
          int index, emu.gingerps.net.proto.DeathZoneInfoOuterClass.DeathZoneInfo.Builder builderForValue) {
        if (deathZoneInfoListBuilder_ == null) {
          ensureDeathZoneInfoListIsMutable();
       ...
       * <code>repeated .DeathZoneInfo death_zone_info_list = 15;</code>
       */
      public Builder addDeathZoneInfoList(emu.gingerps.net.proto.DeathZoneInfoOuterClass.DeathZoneInfo value) {
        if (deathZoneInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addDeathZoneInfoList(
          emu.gingerps.net.proto.DeathZoneInfoOuterClass.DeathZoneInfo.Builder builderForValue) {
        if (deathZoneInfoListBuilder_ == null) {
          ensureDeathZoneInfoListIsMutable();
      ...
      public Builder addAllDeathZoneInfoList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.DeathZoneInfoOuterClass.DeathZoneInfo> values) {
        if (deathZoneInfoListBuilder_ == null) {
          ensureDeathZoneInfoListIsMutable();
       ...
       * <code>repeated .DeathZoneInfo death_zone_info_list = 15;</code>
       */
      public emu.gingerps.net.proto.DeathZoneInfoOuterClass.DeathZoneInfo.Builder getDeathZoneInfoListBuilder(
          int index) {
       ...
       * <code>repeated .DeathZoneInfo death_zone_info_list = 15;</code>
       */
      public emu.gingerps.net.proto.DeathZoneInfoOuterClass.DeathZoneInfo.Builder addDeathZoneInfoListBuilder() {
        return getDeathZoneInfoListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.DeathZoneInfoOuterClass.DeathZoneInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .DeathZoneInfo death_zone_info_list = 15;</code>
       */
      public emu.gingerps.net.proto.DeathZoneInfoOuterClass.DeathZoneInfo.Builder addDeathZoneInfoListBuilder(
          int index) {
        return getDeathZoneInfoListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.DeathZoneInfoOuterClass.DeathZoneInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .DeathZoneInfo death_zone_info_list = 15;</code>
       */
      public java.util.List<emu.gingerps.net.proto.DeathZoneInfoOuterClass.DeathZoneInfo.Builder> 
           getDeathZoneInfoListBuilderList() {
        return getDeathZoneInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.DeathZoneInfoOuterClass.DeathZoneInfo, emu.gingerps.net.proto.DeathZoneInfoOuterClass.DeathZoneInfo.Builder, emu.gingerps.net.proto.DeathZoneInfoOuterClass.DeathZoneInfoOrBuilder> 
          getDeathZoneInfoListFieldBuilder() {
        if (deathZoneInfoListBuilder_ == null) {
    ...
    private static final emu.gingerps.net.proto.DeathZoneInfoNotifyOuterClass.DeathZoneInfoNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.DeathZoneInfoNotifyOuterClass.DeathZoneInfoNotify();
    }

    public static emu.gingerps.net.proto.DeathZoneInfoNotifyOuterClass.DeathZoneInfoNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "_zone_info_list\030\017 \003(\0132\016.DeathZoneInfoB\030\n" +
      "\026emu.gingerps.net.protob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.DeathZoneInfoOuterClass.getDescriptor(),
        });
    internal_static_DeathZoneInfoNotify_descriptor =
