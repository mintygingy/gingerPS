...
public final class RogueDiaryRoomInfoOuterClass {
  ...
  public interface RogueDiaryRoomInfoOrBuilder extends
     ...
     * <code>repeated .Uint32Pair monster_list = 4;</code>
     */
    emu.gingerps.net.proto.Uint32PairOuterClass.Uint32Pair getMonsterList(int index);
    /**
     * <code>repeated .Uint32Pair monster_list = 4;</code>
     */
     ...
     * <code>repeated .Uint32Pair monster_list = 4;</code>
     */
    emu.gingerps.net.proto.Uint32PairOuterClass.Uint32PairOrBuilder getMonsterListOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.RogueDiaryRoomInfoOuterClass.internal_static_RogueDiaryRoomInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo.class, emu.gingerps.net.proto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.Uint32PairOuterClass.Uint32Pair> getMonsterListList() {
      return monsterList_;
    }
    /**
     * <code>repeated .Uint32Pair monster_list = 4;</code>
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.Uint32PairOuterClass.Uint32Pair getMonsterList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.Uint32PairOuterClass.Uint32PairOrBuilder getMonsterListOrBuilder(
        int index) {
      return monsterList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo other = (emu.gingerps.net.proto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo) obj;
    ...
    public static emu.gingerps.net.proto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.RogueDiaryRoomInfoOuterClass.internal_static_RogueDiaryRoomInfo_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo getDefaultInstanceForType() {
        return emu.gingerps.net.proto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo build() {
        emu.gingerps.net.proto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo) {
          return mergeFrom((emu.gingerps.net.proto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo other) {
        if (other == emu.gingerps.net.proto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.Uint32PairOuterClass.Uint32Pair, emu.gingerps.net.proto.Uint32PairOuterClass.Uint32Pair.Builder, emu.gingerps.net.proto.Uint32PairOuterClass.Uint32PairOrBuilder> monsterListBuilder_;
       ...
       * <code>repeated .Uint32Pair monster_list = 4;</code>
       */
      public Builder addMonsterList(emu.gingerps.net.proto.Uint32PairOuterClass.Uint32Pair value) {
        if (monsterListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .Uint32Pair monster_list = 4;</code>
       */
      public emu.gingerps.net.proto.Uint32PairOuterClass.Uint32Pair.Builder getMonsterListBuilder(
          int index) {
       ...
       * <code>repeated .Uint32Pair monster_list = 4;</code>
       */
      public emu.gingerps.net.proto.Uint32PairOuterClass.Uint32Pair.Builder addMonsterListBuilder() {
    ...
    private static final emu.gingerps.net.proto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo();
    }

    public static emu.gingerps.net.proto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo getDefaultInstance() {
