...
public final class DynamicSVONodeOuterClass {
  ...
  public interface DynamicSVONodeOrBuilder extends
     ...
     * @return The referPos.
     */
    emu.gingerps.net.proto.VectorOuterClass.Vector getReferPos();
    /**
     * <code>.Vector refer_pos = 15;</code>
     */
    emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder getReferPosOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.DynamicSVONodeOuterClass.internal_static_DynamicSVONode_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.DynamicSVONodeOuterClass.DynamicSVONode.class, emu.gingerps.net.proto.DynamicSVONodeOuterClass.DynamicSVONode.Builder.class);
    }
    ...
    private emu.gingerps.net.proto.VectorOuterClass.Vector referPos_;
    /**
     * <code>.Vector refer_pos = 15;</code>
     * @return Whether the referPos field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.VectorOuterClass.Vector getReferPos() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.DynamicSVONodeOuterClass.DynamicSVONode)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.DynamicSVONodeOuterClass.DynamicSVONode other = (emu.gingerps.net.proto.DynamicSVONodeOuterClass.DynamicSVONode) obj;
    ...
    public static emu.gingerps.net.proto.DynamicSVONodeOuterClass.DynamicSVONode parseFrom(
    ...
    public static emu.gingerps.net.proto.DynamicSVONodeOuterClass.DynamicSVONode parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.DynamicSVONodeOuterClass.DynamicSVONode parseFrom(
    ...
    public static emu.gingerps.net.proto.DynamicSVONodeOuterClass.DynamicSVONode parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.DynamicSVONodeOuterClass.DynamicSVONode parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.DynamicSVONodeOuterClass.DynamicSVONode parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.DynamicSVONodeOuterClass.DynamicSVONode prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.DynamicSVONodeOuterClass.DynamicSVONodeOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.DynamicSVONodeOuterClass.internal_static_DynamicSVONode_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.DynamicSVONodeOuterClass.DynamicSVONode getDefaultInstanceForType() {
        return emu.gingerps.net.proto.DynamicSVONodeOuterClass.DynamicSVONode.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.DynamicSVONodeOuterClass.DynamicSVONode build() {
        emu.gingerps.net.proto.DynamicSVONodeOuterClass.DynamicSVONode result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.DynamicSVONodeOuterClass.DynamicSVONode) {
          return mergeFrom((emu.gingerps.net.proto.DynamicSVONodeOuterClass.DynamicSVONode)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.DynamicSVONodeOuterClass.DynamicSVONode other) {
        if (other == emu.gingerps.net.proto.DynamicSVONodeOuterClass.DynamicSVONode.getDefaultInstance()) return this;
        if (other.getArea() != 0) {
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.VectorOuterClass.Vector, emu.gingerps.net.proto.VectorOuterClass.Vector.Builder, emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder> referPosBuilder_;
      /**
       * <code>.Vector refer_pos = 15;</code>
       * @return Whether the referPos field is set.
       */
       ...
       * <code>.Vector refer_pos = 15;</code>
       */
      public Builder setReferPos(emu.gingerps.net.proto.VectorOuterClass.Vector value) {
        if (referPosBuilder_ == null) {
          if (value == null) {
      ...
      public emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder getReferPosOrBuilder() {
        if (referPosBuilder_ != null) {
          ...
          return referPos_ == null ?
              emu.gingerps.net.proto.VectorOuterClass.Vector.getDefaultInstance() : referPos_;
        }
      }
      /**
       * <code>.Vector refer_pos = 15;</code>
    ...
    private static final emu.gingerps.net.proto.DynamicSVONodeOuterClass.DynamicSVONode DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.DynamicSVONodeOuterClass.DynamicSVONode();
    }

    public static emu.gingerps.net.proto.DynamicSVONodeOuterClass.DynamicSVONode getDefaultInstance() {
