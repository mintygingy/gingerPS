...
public final class SocialDetailOuterClass {
  ...
  public interface SocialDetailOrBuilder extends
     ...
     * @return The birthday.
     */
    emu.gingerps.net.proto.BirthdayOuterClass.Birthday getBirthday();
    /**
     * <code>.Birthday birthday = 6;</code>
     */
    emu.gingerps.net.proto.BirthdayOuterClass.BirthdayOrBuilder getBirthdayOrBuilder();
     ...
     */
    emu.gingerps.net.proto.FriendOnlineStateOuterClass.FriendOnlineState getOnlineState();
     ...
     */
    java.util.List<emu.gingerps.net.proto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo> 
        getShowAvatarInfoListList();
    /**
     * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
     */
    emu.gingerps.net.proto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo getShowAvatarInfoList(int index);
    /**
     * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
     */
     ...
     * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfoOrBuilder> 
        getShowAvatarInfoListOrBuilderList();
    /**
     * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
     */
    emu.gingerps.net.proto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfoOrBuilder getShowAvatarInfoListOrBuilder(
        int index);
     ...
     */
    emu.gingerps.net.proto.FriendEnterHomeOptionOuterClass.FriendEnterHomeOption getFriendEnterHomeOption();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.gingerps.net.proto.SocialDetailOuterClass.internal_static_SocialDetail_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.gingerps.net.proto.SocialDetailOuterClass.internal_static_SocialDetail_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.SocialDetailOuterClass.SocialDetail.class, emu.gingerps.net.proto.SocialDetailOuterClass.SocialDetail.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.BirthdayOuterClass.Birthday getBirthday() {
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo> getShowAvatarInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfoOrBuilder> 
        getShowAvatarInfoListOrBuilderList() {
      return showAvatarInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo getShowAvatarInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfoOrBuilder getShowAvatarInfoListOrBuilder(
        int index) {
      return showAvatarInfoList_.get(index);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (onlineState_ != emu.gingerps.net.proto.FriendOnlineStateOuterClass.FriendOnlineState.FRIEND_ONLINE_STATE_DISCONNECT.getNumber()) {
      ...
      if (friendEnterHomeOption_ != emu.gingerps.net.proto.FriendEnterHomeOptionOuterClass.FriendEnterHomeOption.FRIEND_ENTER_HOME_OPTION_NEED_CONFIRM.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.SocialDetailOuterClass.SocialDetail)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.SocialDetailOuterClass.SocialDetail other = (emu.gingerps.net.proto.SocialDetailOuterClass.SocialDetail) obj;
    ...
    public static emu.gingerps.net.proto.SocialDetailOuterClass.SocialDetail parseFrom(
    ...
    public static emu.gingerps.net.proto.SocialDetailOuterClass.SocialDetail parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.SocialDetailOuterClass.SocialDetail parseFrom(
    ...
    public static emu.gingerps.net.proto.SocialDetailOuterClass.SocialDetail parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.SocialDetailOuterClass.SocialDetail parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.SocialDetailOuterClass.SocialDetail parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.SocialDetailOuterClass.SocialDetail prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.SocialDetailOuterClass.SocialDetailOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.SocialDetailOuterClass.internal_static_SocialDetail_descriptor;
      }
      ...
      // Construct using emu.gingerps.net.proto.SocialDetailOuterClass.SocialDetail.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.SocialDetailOuterClass.SocialDetail getDefaultInstanceForType() {
        return emu.gingerps.net.proto.SocialDetailOuterClass.SocialDetail.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.SocialDetailOuterClass.SocialDetail build() {
        emu.gingerps.net.proto.SocialDetailOuterClass.SocialDetail result = buildPartial();
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.SocialDetailOuterClass.SocialDetail buildPartial() {
        emu.gingerps.net.proto.SocialDetailOuterClass.SocialDetail result = new emu.gingerps.net.proto.SocialDetailOuterClass.SocialDetail(this);
      ...
      private void buildPartialRepeatedFields(emu.gingerps.net.proto.SocialDetailOuterClass.SocialDetail result) {
      ...
      private void buildPartial0(emu.gingerps.net.proto.SocialDetailOuterClass.SocialDetail result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.SocialDetailOuterClass.SocialDetail) {
          return mergeFrom((emu.gingerps.net.proto.SocialDetailOuterClass.SocialDetail)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.SocialDetailOuterClass.SocialDetail other) {
        if (other == emu.gingerps.net.proto.SocialDetailOuterClass.SocialDetail.getDefaultInstance()) return this;
        if (other.getUid() != 0) {
          setUid(other.getUid());
        }
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.BirthdayOuterClass.Birthday, emu.gingerps.net.proto.BirthdayOuterClass.Birthday.Builder, emu.gingerps.net.proto.BirthdayOuterClass.BirthdayOrBuilder> birthdayBuilder_;
      /**
       * <code>.Birthday birthday = 6;</code>
       * @return Whether the birthday field is set.
       */
       ...
       * <code>.Birthday birthday = 6;</code>
       */
      public Builder setBirthday(emu.gingerps.net.proto.BirthdayOuterClass.Birthday value) {
        if (birthdayBuilder_ == null) {
          if (value == null) {
      ...
      public emu.gingerps.net.proto.BirthdayOuterClass.BirthdayOrBuilder getBirthdayOrBuilder() {
        if (birthdayBuilder_ != null) {
          ...
          return birthday_ == null ?
              emu.gingerps.net.proto.BirthdayOuterClass.Birthday.getDefaultInstance() : birthday_;
        }
      }
      /**
       * <code>.Birthday birthday = 6;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.BirthdayOuterClass.Birthday, emu.gingerps.net.proto.BirthdayOuterClass.Birthday.Builder, emu.gingerps.net.proto.BirthdayOuterClass.BirthdayOrBuilder> 
       ...
       * @return This builder for chaining.
       */
      public Builder setOnlineState(emu.gingerps.net.proto.FriendOnlineStateOuterClass.FriendOnlineState value) {
        if (value == null) {
          throw new NullPointerException();
        }
        bitField0_ |= 0x00000100;
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo, emu.gingerps.net.proto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder, emu.gingerps.net.proto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfoOrBuilder> showAvatarInfoListBuilder_;
      ...
      public Builder setShowAvatarInfoList(
          int index, emu.gingerps.net.proto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo value) {
        if (showAvatarInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setShowAvatarInfoList(
          int index, emu.gingerps.net.proto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder builderForValue) {
        if (showAvatarInfoListBuilder_ == null) {
          ensureShowAvatarInfoListIsMutable();
       ...
       * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
       */
      public Builder addShowAvatarInfoList(emu.gingerps.net.proto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo value) {
        if (showAvatarInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addShowAvatarInfoList(
          emu.gingerps.net.proto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder builderForValue) {
        if (showAvatarInfoListBuilder_ == null) {
          ensureShowAvatarInfoListIsMutable();
      ...
      public Builder addAllShowAvatarInfoList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo> values) {
        if (showAvatarInfoListBuilder_ == null) {
          ensureShowAvatarInfoListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
       */
      public emu.gingerps.net.proto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder getShowAvatarInfoListBuilder(
          int index) {
       ...
       * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
       */
      public emu.gingerps.net.proto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder addShowAvatarInfoListBuilder() {
        return getShowAvatarInfoListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
       */
      public emu.gingerps.net.proto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder addShowAvatarInfoListBuilder(
          int index) {
        return getShowAvatarInfoListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
       */
      public java.util.List<emu.gingerps.net.proto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder> 
       ...
       * @return This builder for chaining.
       */
      public Builder setFriendEnterHomeOption(emu.gingerps.net.proto.FriendEnterHomeOptionOuterClass.FriendEnterHomeOption value) {
        if (value == null) {
          throw new NullPointerException();
        }
        bitField0_ |= 0x00800000;
    ...
    private static final emu.gingerps.net.proto.SocialDetailOuterClass.SocialDetail DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.SocialDetailOuterClass.SocialDetail();
    }

    public static emu.gingerps.net.proto.SocialDetailOuterClass.SocialDetail getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "_picture\030\031 \001(\0132\017.ProfilePictureB\030\n\026emu.g" +
      "ingerps.net.protob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.BirthdayOuterClass.getDescriptor(),
          emu.gingerps.net.proto.FriendEnterHomeOptionOuterClass.getDescriptor(),
          emu.gingerps.net.proto.FriendOnlineStateOuterClass.getDescriptor(),
          emu.gingerps.net.proto.ProfilePictureOuterClass.getDescriptor(),
          emu.gingerps.net.proto.SocialShowAvatarInfoOuterClass.getDescriptor(),
        });
    internal_static_SocialDetail_descriptor =
