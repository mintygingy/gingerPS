...
public final class RoutePointOuterClass {
  ...
  public interface RoutePointOrBuilder extends
     ...
     * @return The rotation.
     */
    emu.gingerps.net.proto.VectorOuterClass.Vector getRotation();
    /**
     * <code>.Vector rotation = 21;</code>
     */
    emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder getRotationOrBuilder();
     ...
     */
    emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternion getRotationSpeed();
    /**
     * <code>.MathQuaternion rotation_speed = 22;</code>
     */
    emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternionOrBuilder getRotationSpeedOrBuilder();
     ...
     */
    emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternion getAxisSpeed();
    /**
     * <code>.MathQuaternion axis_speed = 23;</code>
     */
    emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternionOrBuilder getAxisSpeedOrBuilder();

    public emu.gingerps.net.proto.RoutePointOuterClass.RoutePoint.MoveParamsCase getMoveParamsCase();

    public emu.gingerps.net.proto.RoutePointOuterClass.RoutePoint.RotateParamsCase getRotateParamsCase();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.RoutePointOuterClass.internal_static_RoutePoint_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.RoutePointOuterClass.RoutePoint.class, emu.gingerps.net.proto.RoutePointOuterClass.RoutePoint.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.VectorOuterClass.Vector getRotation() {
      if (rotateParamsCase_ == 21) {
         return (emu.gingerps.net.proto.VectorOuterClass.Vector) rotateParams_;
      }
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder getRotationOrBuilder() {
      if (rotateParamsCase_ == 21) {
         return (emu.gingerps.net.proto.VectorOuterClass.Vector) rotateParams_;
      }
      return emu.gingerps.net.proto.VectorOuterClass.Vector.getDefaultInstance();
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternion getRotationSpeed() {
      if (rotateParamsCase_ == 22) {
         return (emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternion) rotateParams_;
      }
      return emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternion.getDefaultInstance();
    }
    /**
     * <code>.MathQuaternion rotation_speed = 22;</code>
     */
    @java.lang.Override
    public emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternionOrBuilder getRotationSpeedOrBuilder() {
      if (rotateParamsCase_ == 22) {
         return (emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternion) rotateParams_;
      }
      return emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternion.getDefaultInstance();
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternion getAxisSpeed() {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternionOrBuilder getAxisSpeedOrBuilder() {
      if (rotateParamsCase_ == 23) {
         return (emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternion) rotateParams_;
      }
      return emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternion.getDefaultInstance();
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (rotateParamsCase_ == 21) {
        output.writeMessage(21, (emu.gingerps.net.proto.VectorOuterClass.Vector) rotateParams_);
      }
      if (rotateParamsCase_ == 22) {
        output.writeMessage(22, (emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternion) rotateParams_);
      }
      if (rotateParamsCase_ == 23) {
    ...
    public int getSerializedSize() {
      ...
      if (rotateParamsCase_ == 21) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(21, (emu.gingerps.net.proto.VectorOuterClass.Vector) rotateParams_);
      }
      if (rotateParamsCase_ == 22) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(22, (emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternion) rotateParams_);
      }
      if (rotateParamsCase_ == 23) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.RoutePointOuterClass.RoutePoint)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.RoutePointOuterClass.RoutePoint other = (emu.gingerps.net.proto.RoutePointOuterClass.RoutePoint) obj;
    ...
    public static emu.gingerps.net.proto.RoutePointOuterClass.RoutePoint parseFrom(
    ...
    public static emu.gingerps.net.proto.RoutePointOuterClass.RoutePoint parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.RoutePointOuterClass.RoutePoint parseFrom(
    ...
    public static emu.gingerps.net.proto.RoutePointOuterClass.RoutePoint parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.RoutePointOuterClass.RoutePoint parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.RoutePointOuterClass.RoutePoint parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.RoutePointOuterClass.RoutePoint prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.RoutePointOuterClass.RoutePointOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.RoutePointOuterClass.internal_static_RoutePoint_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.RoutePointOuterClass.RoutePoint getDefaultInstanceForType() {
        return emu.gingerps.net.proto.RoutePointOuterClass.RoutePoint.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.RoutePointOuterClass.RoutePoint build() {
        emu.gingerps.net.proto.RoutePointOuterClass.RoutePoint result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.RoutePointOuterClass.RoutePoint) {
          return mergeFrom((emu.gingerps.net.proto.RoutePointOuterClass.RoutePoint)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.RoutePointOuterClass.RoutePoint other) {
        if (other == emu.gingerps.net.proto.RoutePointOuterClass.RoutePoint.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.VectorOuterClass.Vector, emu.gingerps.net.proto.VectorOuterClass.Vector.Builder, emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder> rotationBuilder_;
      /**
       * <code>.Vector rotation = 21;</code>
       * @return Whether the rotation field is set.
       */
       ...
       * <code>.Vector rotation = 21;</code>
       */
      public Builder setRotation(emu.gingerps.net.proto.VectorOuterClass.Vector value) {
        if (rotationBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>.Vector rotation = 21;</code>
       */
      public Builder mergeRotation(emu.gingerps.net.proto.VectorOuterClass.Vector value) {
        if (rotationBuilder_ == null) {
          if (rotateParamsCase_ == 21 &&
              rotateParams_ != emu.gingerps.net.proto.VectorOuterClass.Vector.getDefaultInstance()) {
            rotateParams_ = emu.gingerps.net.proto.VectorOuterClass.Vector.newBuilder((emu.gingerps.net.proto.VectorOuterClass.Vector) rotateParams_)
       ...
       * <code>.Vector rotation = 21;</code>
       */
      public emu.gingerps.net.proto.VectorOuterClass.Vector.Builder getRotationBuilder() {
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
        ...
        if (rotationBuilder_ == null) {
          ...
          rotationBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
              emu.gingerps.net.proto.VectorOuterClass.Vector, emu.gingerps.net.proto.VectorOuterClass.Vector.Builder, emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder>(
                  (emu.gingerps.net.proto.VectorOuterClass.Vector) rotateParams_,
                  getParentForChildren(),
                  isClean());
          rotateParams_ = null;
        }
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternion, emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternion.Builder, emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternionOrBuilder> rotationSpeedBuilder_;
      /**
       * <code>.MathQuaternion rotation_speed = 22;</code>
       * @return Whether the rotationSpeed field is set.
       */
       ...
       * <code>.MathQuaternion rotation_speed = 22;</code>
       */
      public Builder setRotationSpeed(emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternion value) {
        if (rotationSpeedBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>.MathQuaternion rotation_speed = 22;</code>
       */
      public Builder mergeRotationSpeed(emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternion value) {
        if (rotationSpeedBuilder_ == null) {
          if (rotateParamsCase_ == 22 &&
              rotateParams_ != emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternion.getDefaultInstance()) {
            rotateParams_ = emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternion.newBuilder((emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternion) rotateParams_)
                .mergeFrom(value).buildPartial();
          } else {
            rotateParams_ = value;
          }
       ...
       * <code>.MathQuaternion rotation_speed = 22;</code>
       */
      public emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternion.Builder getRotationSpeedBuilder() {
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
        ...
        if (rotationSpeedBuilder_ == null) {
          ...
          rotationSpeedBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
              emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternion, emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternion.Builder, emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternionOrBuilder>(
                  (emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternion) rotateParams_,
                  getParentForChildren(),
                  isClean());
          rotateParams_ = null;
        }
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternion, emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternion.Builder, emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternionOrBuilder> axisSpeedBuilder_;
      /**
       * <code>.MathQuaternion axis_speed = 23;</code>
       * @return Whether the axisSpeed field is set.
       */
       ...
       * <code>.MathQuaternion axis_speed = 23;</code>
       */
      public Builder setAxisSpeed(emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternion value) {
        if (axisSpeedBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>.MathQuaternion axis_speed = 23;</code>
       */
      public Builder mergeAxisSpeed(emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternion value) {
        if (axisSpeedBuilder_ == null) {
          if (rotateParamsCase_ == 23 &&
              rotateParams_ != emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternion.getDefaultInstance()) {
            rotateParams_ = emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternion.newBuilder((emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternion) rotateParams_)
       ...
       * <code>.MathQuaternion axis_speed = 23;</code>
       */
      public emu.gingerps.net.proto.MathQuaternionOuterClass.MathQuaternion.Builder getAxisSpeedBuilder() {
    ...
    private static final emu.gingerps.net.proto.RoutePointOuterClass.RoutePoint DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.RoutePointOuterClass.RoutePoint();
    }

    public static emu.gingerps.net.proto.RoutePointOuterClass.RoutePoint getDefaultInstance() {
