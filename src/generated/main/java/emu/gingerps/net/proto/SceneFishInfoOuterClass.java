...
public final class SceneFishInfoOuterClass {
  ...
  public interface SceneFishInfoOrBuilder extends
     ...
     */
    emu.gingerps.net.proto.VectorOuterClass.Vector getFishPoolPos();
    /**
     * <code>.Vector fish_pool_pos = 3;</code>
     */
    emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder getFishPoolPosOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.SceneFishInfoOuterClass.internal_static_SceneFishInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo.class, emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo.Builder.class);
    }
    ...
    private emu.gingerps.net.proto.VectorOuterClass.Vector fishPoolPos_;
    /**
     * <code>.Vector fish_pool_pos = 3;</code>
     * @return Whether the fishPoolPos field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.VectorOuterClass.Vector getFishPoolPos() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo other = (emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo) obj;
    ...
    public static emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.SceneFishInfoOuterClass.internal_static_SceneFishInfo_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo getDefaultInstanceForType() {
        return emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo build() {
        emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo) {
          return mergeFrom((emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo other) {
        if (other == emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.VectorOuterClass.Vector, emu.gingerps.net.proto.VectorOuterClass.Vector.Builder, emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder> fishPoolPosBuilder_;
      /**
       * <code>.Vector fish_pool_pos = 3;</code>
       * @return Whether the fishPoolPos field is set.
       */
       ...
       * <code>.Vector fish_pool_pos = 3;</code>
       */
      public Builder setFishPoolPos(emu.gingerps.net.proto.VectorOuterClass.Vector value) {
        if (fishPoolPosBuilder_ == null) {
          if (value == null) {
      ...
      public emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder getFishPoolPosOrBuilder() {
        if (fishPoolPosBuilder_ != null) {
          ...
          return fishPoolPos_ == null ?
              emu.gingerps.net.proto.VectorOuterClass.Vector.getDefaultInstance() : fishPoolPos_;
        }
      }
      /**
       * <code>.Vector fish_pool_pos = 3;</code>
    ...
    private static final emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo();
    }

    public static emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\022\027\n\017last_shock_time\030\005 \001(\rB\030\n\026emu.gingerp" +
