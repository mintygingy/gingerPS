...
public final class GetRecentMpPlayerListRspOuterClass {
  ...
  public interface GetRecentMpPlayerListRspOrBuilder extends
     ...
     * <code>repeated .FriendBrief recent_mp_player_brief_list = 9;</code>
     */
    emu.gingerps.net.proto.FriendBriefOuterClass.FriendBrief getRecentMpPlayerBriefList(int index);
    /**
     * <code>repeated .FriendBrief recent_mp_player_brief_list = 9;</code>
     */
     ...
     * <code>repeated .FriendBrief recent_mp_player_brief_list = 9;</code>
     */
    emu.gingerps.net.proto.FriendBriefOuterClass.FriendBriefOrBuilder getRecentMpPlayerBriefListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.GetRecentMpPlayerListRspOuterClass.internal_static_GetRecentMpPlayerListRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.GetRecentMpPlayerListRspOuterClass.GetRecentMpPlayerListRsp.class, emu.gingerps.net.proto.GetRecentMpPlayerListRspOuterClass.GetRecentMpPlayerListRsp.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.FriendBriefOuterClass.FriendBrief> getRecentMpPlayerBriefListList() {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.FriendBriefOuterClass.FriendBrief getRecentMpPlayerBriefList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.FriendBriefOuterClass.FriendBriefOrBuilder getRecentMpPlayerBriefListOrBuilder(
        int index) {
      return recentMpPlayerBriefList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.GetRecentMpPlayerListRspOuterClass.GetRecentMpPlayerListRsp)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.GetRecentMpPlayerListRspOuterClass.GetRecentMpPlayerListRsp other = (emu.gingerps.net.proto.GetRecentMpPlayerListRspOuterClass.GetRecentMpPlayerListRsp) obj;
    ...
    public static emu.gingerps.net.proto.GetRecentMpPlayerListRspOuterClass.GetRecentMpPlayerListRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.GetRecentMpPlayerListRspOuterClass.GetRecentMpPlayerListRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.GetRecentMpPlayerListRspOuterClass.GetRecentMpPlayerListRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.GetRecentMpPlayerListRspOuterClass.GetRecentMpPlayerListRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.GetRecentMpPlayerListRspOuterClass.GetRecentMpPlayerListRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.GetRecentMpPlayerListRspOuterClass.GetRecentMpPlayerListRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.GetRecentMpPlayerListRspOuterClass.GetRecentMpPlayerListRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.GetRecentMpPlayerListRspOuterClass.GetRecentMpPlayerListRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.GetRecentMpPlayerListRspOuterClass.internal_static_GetRecentMpPlayerListRsp_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.GetRecentMpPlayerListRspOuterClass.GetRecentMpPlayerListRsp getDefaultInstanceForType() {
        return emu.gingerps.net.proto.GetRecentMpPlayerListRspOuterClass.GetRecentMpPlayerListRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.GetRecentMpPlayerListRspOuterClass.GetRecentMpPlayerListRsp build() {
        emu.gingerps.net.proto.GetRecentMpPlayerListRspOuterClass.GetRecentMpPlayerListRsp result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.GetRecentMpPlayerListRspOuterClass.GetRecentMpPlayerListRsp) {
          return mergeFrom((emu.gingerps.net.proto.GetRecentMpPlayerListRspOuterClass.GetRecentMpPlayerListRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.GetRecentMpPlayerListRspOuterClass.GetRecentMpPlayerListRsp other) {
        if (other == emu.gingerps.net.proto.GetRecentMpPlayerListRspOuterClass.GetRecentMpPlayerListRsp.getDefaultInstance()) return this;
        if (recentMpPlayerBriefListBuilder_ == null) {
      ...
      private void ensureRecentMpPlayerBriefListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          recentMpPlayerBriefList_ = new java.util.ArrayList<emu.gingerps.net.proto.FriendBriefOuterClass.FriendBrief>(recentMpPlayerBriefList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.FriendBriefOuterClass.FriendBrief, emu.gingerps.net.proto.FriendBriefOuterClass.FriendBrief.Builder, emu.gingerps.net.proto.FriendBriefOuterClass.FriendBriefOrBuilder> recentMpPlayerBriefListBuilder_;
       ...
       * <code>repeated .FriendBrief recent_mp_player_brief_list = 9;</code>
       */
      public Builder addRecentMpPlayerBriefList(emu.gingerps.net.proto.FriendBriefOuterClass.FriendBrief value) {
        if (recentMpPlayerBriefListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .FriendBrief recent_mp_player_brief_list = 9;</code>
       */
      public emu.gingerps.net.proto.FriendBriefOuterClass.FriendBrief.Builder getRecentMpPlayerBriefListBuilder(
          int index) {
       ...
       * <code>repeated .FriendBrief recent_mp_player_brief_list = 9;</code>
       */
      public emu.gingerps.net.proto.FriendBriefOuterClass.FriendBrief.Builder addRecentMpPlayerBriefListBuilder() {
    ...
    private static final emu.gingerps.net.proto.GetRecentMpPlayerListRspOuterClass.GetRecentMpPlayerListRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.GetRecentMpPlayerListRspOuterClass.GetRecentMpPlayerListRsp();
    }

    public static emu.gingerps.net.proto.GetRecentMpPlayerListRspOuterClass.GetRecentMpPlayerListRsp getDefaultInstance() {
