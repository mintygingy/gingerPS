...
public final class GCGDuelExtraOuterClass {
  ...
  public interface GCGDuelExtraOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.GCGChallengeDataOuterClass.GCGChallengeData> 
        getChallengeListList();
    /**
     * <code>repeated .GCGChallengeData challenge_list = 5;</code>
     */
    emu.gingerps.net.proto.GCGChallengeDataOuterClass.GCGChallengeData getChallengeList(int index);
    /**
     * <code>repeated .GCGChallengeData challenge_list = 5;</code>
     */
     ...
     * <code>repeated .GCGChallengeData challenge_list = 5;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.GCGChallengeDataOuterClass.GCGChallengeDataOrBuilder> 
        getChallengeListOrBuilderList();
    /**
     * <code>repeated .GCGChallengeData challenge_list = 5;</code>
     */
    emu.gingerps.net.proto.GCGChallengeDataOuterClass.GCGChallengeDataOrBuilder getChallengeListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.GCGDuelExtraOuterClass.internal_static_GCGDuelExtra_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.GCGDuelExtraOuterClass.GCGDuelExtra.class, emu.gingerps.net.proto.GCGDuelExtraOuterClass.GCGDuelExtra.Builder.class);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.gingerps.net.proto.GCGDuelExtraOuterClass.internal_static_GCGDuelExtra_CardFaceMapEntry_descriptor, 
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.GCGChallengeDataOuterClass.GCGChallengeData> getChallengeListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.GCGChallengeDataOuterClass.GCGChallengeDataOrBuilder> 
        getChallengeListOrBuilderList() {
      return challengeList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.GCGChallengeDataOuterClass.GCGChallengeData getChallengeList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.GCGChallengeDataOuterClass.GCGChallengeDataOrBuilder getChallengeListOrBuilder(
        int index) {
      return challengeList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.GCGDuelExtraOuterClass.GCGDuelExtra)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.GCGDuelExtraOuterClass.GCGDuelExtra other = (emu.gingerps.net.proto.GCGDuelExtraOuterClass.GCGDuelExtra) obj;
    ...
    public static emu.gingerps.net.proto.GCGDuelExtraOuterClass.GCGDuelExtra parseFrom(
    ...
    public static emu.gingerps.net.proto.GCGDuelExtraOuterClass.GCGDuelExtra parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.GCGDuelExtraOuterClass.GCGDuelExtra parseFrom(
    ...
    public static emu.gingerps.net.proto.GCGDuelExtraOuterClass.GCGDuelExtra parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.GCGDuelExtraOuterClass.GCGDuelExtra parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.GCGDuelExtraOuterClass.GCGDuelExtra parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.GCGDuelExtraOuterClass.GCGDuelExtra prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.GCGDuelExtraOuterClass.GCGDuelExtraOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.GCGDuelExtraOuterClass.internal_static_GCGDuelExtra_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.GCGDuelExtraOuterClass.GCGDuelExtra getDefaultInstanceForType() {
        return emu.gingerps.net.proto.GCGDuelExtraOuterClass.GCGDuelExtra.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.GCGDuelExtraOuterClass.GCGDuelExtra build() {
        emu.gingerps.net.proto.GCGDuelExtraOuterClass.GCGDuelExtra result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.GCGDuelExtraOuterClass.GCGDuelExtra) {
          return mergeFrom((emu.gingerps.net.proto.GCGDuelExtraOuterClass.GCGDuelExtra)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.GCGDuelExtraOuterClass.GCGDuelExtra other) {
        if (other == emu.gingerps.net.proto.GCGDuelExtraOuterClass.GCGDuelExtra.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.GCGChallengeDataOuterClass.GCGChallengeData, emu.gingerps.net.proto.GCGChallengeDataOuterClass.GCGChallengeData.Builder, emu.gingerps.net.proto.GCGChallengeDataOuterClass.GCGChallengeDataOrBuilder> challengeListBuilder_;
      ...
      public Builder setChallengeList(
          int index, emu.gingerps.net.proto.GCGChallengeDataOuterClass.GCGChallengeData value) {
        if (challengeListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setChallengeList(
          int index, emu.gingerps.net.proto.GCGChallengeDataOuterClass.GCGChallengeData.Builder builderForValue) {
        if (challengeListBuilder_ == null) {
          ensureChallengeListIsMutable();
       ...
       * <code>repeated .GCGChallengeData challenge_list = 5;</code>
       */
      public Builder addChallengeList(emu.gingerps.net.proto.GCGChallengeDataOuterClass.GCGChallengeData value) {
        if (challengeListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addChallengeList(
          emu.gingerps.net.proto.GCGChallengeDataOuterClass.GCGChallengeData.Builder builderForValue) {
        if (challengeListBuilder_ == null) {
          ensureChallengeListIsMutable();
      ...
      public Builder addAllChallengeList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.GCGChallengeDataOuterClass.GCGChallengeData> values) {
        if (challengeListBuilder_ == null) {
          ensureChallengeListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .GCGChallengeData challenge_list = 5;</code>
       */
      public emu.gingerps.net.proto.GCGChallengeDataOuterClass.GCGChallengeData.Builder getChallengeListBuilder(
          int index) {
       ...
       * <code>repeated .GCGChallengeData challenge_list = 5;</code>
       */
      public emu.gingerps.net.proto.GCGChallengeDataOuterClass.GCGChallengeData.Builder addChallengeListBuilder() {
        return getChallengeListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.GCGChallengeDataOuterClass.GCGChallengeData.getDefaultInstance());
      }
      /**
       * <code>repeated .GCGChallengeData challenge_list = 5;</code>
       */
      public emu.gingerps.net.proto.GCGChallengeDataOuterClass.GCGChallengeData.Builder addChallengeListBuilder(
          int index) {
        return getChallengeListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.GCGChallengeDataOuterClass.GCGChallengeData.getDefaultInstance());
      }
      /**
       * <code>repeated .GCGChallengeData challenge_list = 5;</code>
       */
      public java.util.List<emu.gingerps.net.proto.GCGChallengeDataOuterClass.GCGChallengeData.Builder> 
    ...
    private static final emu.gingerps.net.proto.GCGDuelExtraOuterClass.GCGDuelExtra DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.GCGDuelExtraOuterClass.GCGDuelExtra();
    }

    public static emu.gingerps.net.proto.GCGDuelExtraOuterClass.GCGDuelExtra getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.GCGChallengeDataOuterClass.getDescriptor(),
