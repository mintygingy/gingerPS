...
public final class MassivePropParamOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.MassivePropParamOuterClass.internal_static_MassivePropParam_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.MassivePropParamOuterClass.MassivePropParam.class, emu.gingerps.net.proto.MassivePropParamOuterClass.MassivePropParam.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.MassivePropParamOuterClass.MassivePropParam)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.MassivePropParamOuterClass.MassivePropParam other = (emu.gingerps.net.proto.MassivePropParamOuterClass.MassivePropParam) obj;
    ...
    public static emu.gingerps.net.proto.MassivePropParamOuterClass.MassivePropParam parseFrom(
    ...
    public static emu.gingerps.net.proto.MassivePropParamOuterClass.MassivePropParam parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.MassivePropParamOuterClass.MassivePropParam parseFrom(
    ...
    public static emu.gingerps.net.proto.MassivePropParamOuterClass.MassivePropParam parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.MassivePropParamOuterClass.MassivePropParam parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.MassivePropParamOuterClass.MassivePropParam parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.MassivePropParamOuterClass.MassivePropParam prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.MassivePropParamOuterClass.MassivePropParamOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.MassivePropParamOuterClass.internal_static_MassivePropParam_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.MassivePropParamOuterClass.MassivePropParam getDefaultInstanceForType() {
        return emu.gingerps.net.proto.MassivePropParamOuterClass.MassivePropParam.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.MassivePropParamOuterClass.MassivePropParam build() {
        emu.gingerps.net.proto.MassivePropParamOuterClass.MassivePropParam result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.MassivePropParamOuterClass.MassivePropParam) {
          return mergeFrom((emu.gingerps.net.proto.MassivePropParamOuterClass.MassivePropParam)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.MassivePropParamOuterClass.MassivePropParam other) {
        if (other == emu.gingerps.net.proto.MassivePropParamOuterClass.MassivePropParam.getDefaultInstance()) return this;
        if (other.getType() != 0) {
    ...
    private static final emu.gingerps.net.proto.MassivePropParamOuterClass.MassivePropParam DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.MassivePropParamOuterClass.MassivePropParam();
    }

    public static emu.gingerps.net.proto.MassivePropParamOuterClass.MassivePropParam getDefaultInstance() {
