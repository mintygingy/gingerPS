...
public final class FleurFairFallSettleInfoOuterClass {
  ...
  public interface FleurFairFallSettleInfoOrBuilder extends
     ...
     */
    emu.gingerps.net.proto.FallSettleInfoOuterClass.FallSettleInfo getSettleInfo();
    /**
     * <code>.FallSettleInfo settle_info = 3;</code>
     */
    emu.gingerps.net.proto.FallSettleInfoOuterClass.FallSettleInfoOrBuilder getSettleInfoOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.FleurFairFallSettleInfoOuterClass.internal_static_FleurFairFallSettleInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.FleurFairFallSettleInfoOuterClass.FleurFairFallSettleInfo.class, emu.gingerps.net.proto.FleurFairFallSettleInfoOuterClass.FleurFairFallSettleInfo.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.FallSettleInfoOuterClass.FallSettleInfo getSettleInfo() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.FleurFairFallSettleInfoOuterClass.FleurFairFallSettleInfo)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.FleurFairFallSettleInfoOuterClass.FleurFairFallSettleInfo other = (emu.gingerps.net.proto.FleurFairFallSettleInfoOuterClass.FleurFairFallSettleInfo) obj;
    ...
    public static emu.gingerps.net.proto.FleurFairFallSettleInfoOuterClass.FleurFairFallSettleInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.FleurFairFallSettleInfoOuterClass.FleurFairFallSettleInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.FleurFairFallSettleInfoOuterClass.FleurFairFallSettleInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.FleurFairFallSettleInfoOuterClass.FleurFairFallSettleInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.FleurFairFallSettleInfoOuterClass.FleurFairFallSettleInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.FleurFairFallSettleInfoOuterClass.FleurFairFallSettleInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.FleurFairFallSettleInfoOuterClass.FleurFairFallSettleInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.FleurFairFallSettleInfoOuterClass.FleurFairFallSettleInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.FleurFairFallSettleInfoOuterClass.internal_static_FleurFairFallSettleInfo_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.FleurFairFallSettleInfoOuterClass.FleurFairFallSettleInfo getDefaultInstanceForType() {
        return emu.gingerps.net.proto.FleurFairFallSettleInfoOuterClass.FleurFairFallSettleInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.FleurFairFallSettleInfoOuterClass.FleurFairFallSettleInfo build() {
        emu.gingerps.net.proto.FleurFairFallSettleInfoOuterClass.FleurFairFallSettleInfo result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.FleurFairFallSettleInfoOuterClass.FleurFairFallSettleInfo) {
          return mergeFrom((emu.gingerps.net.proto.FleurFairFallSettleInfoOuterClass.FleurFairFallSettleInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.FleurFairFallSettleInfoOuterClass.FleurFairFallSettleInfo other) {
        if (other == emu.gingerps.net.proto.FleurFairFallSettleInfoOuterClass.FleurFairFallSettleInfo.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.FallSettleInfoOuterClass.FallSettleInfo, emu.gingerps.net.proto.FallSettleInfoOuterClass.FallSettleInfo.Builder, emu.gingerps.net.proto.FallSettleInfoOuterClass.FallSettleInfoOrBuilder> settleInfoBuilder_;
      /**
       * <code>.FallSettleInfo settle_info = 3;</code>
       * @return Whether the settleInfo field is set.
       */
       ...
       * <code>.FallSettleInfo settle_info = 3;</code>
       */
      public Builder setSettleInfo(emu.gingerps.net.proto.FallSettleInfoOuterClass.FallSettleInfo value) {
        if (settleInfoBuilder_ == null) {
          if (value == null) {
      ...
      public emu.gingerps.net.proto.FallSettleInfoOuterClass.FallSettleInfoOrBuilder getSettleInfoOrBuilder() {
        if (settleInfoBuilder_ != null) {
          ...
          return settleInfo_ == null ?
              emu.gingerps.net.proto.FallSettleInfoOuterClass.FallSettleInfo.getDefaultInstance() : settleInfo_;
        }
      }
      /**
       * <code>.FallSettleInfo settle_info = 3;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.FallSettleInfoOuterClass.FallSettleInfo, emu.gingerps.net.proto.FallSettleInfoOuterClass.FallSettleInfo.Builder, emu.gingerps.net.proto.FallSettleInfoOuterClass.FallSettleInfoOrBuilder> 
    ...
    private static final emu.gingerps.net.proto.FleurFairFallSettleInfoOuterClass.FleurFairFallSettleInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.FleurFairFallSettleInfoOuterClass.FleurFairFallSettleInfo();
    }

    public static emu.gingerps.net.proto.FleurFairFallSettleInfoOuterClass.FleurFairFallSettleInfo getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.FallSettleInfoOuterClass.getDescriptor(),
        });
    internal_static_FleurFairFallSettleInfo_descriptor =
