...
public final class LuaEnvironmentEffectNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.LuaEnvironmentEffectNotifyOuterClass.internal_static_LuaEnvironmentEffectNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify.class, emu.gingerps.net.proto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify other = (emu.gingerps.net.proto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify) obj;
    ...
    public static emu.gingerps.net.proto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.LuaEnvironmentEffectNotifyOuterClass.internal_static_LuaEnvironmentEffectNotify_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify build() {
        emu.gingerps.net.proto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify) {
          return mergeFrom((emu.gingerps.net.proto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify other) {
        if (other == emu.gingerps.net.proto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify.getDefaultInstance()) return this;
        if (other.getType() != 0) {
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.gingerps.net.proto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify();
    }

    public static emu.gingerps.net.proto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify getDefaultInstance() {
