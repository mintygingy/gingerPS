...
public final class TakeCompoundOutputRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.gingerps.net.proto.TakeCompoundOutputRspOuterClass.internal_static_TakeCompoundOutputRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.gingerps.net.proto.TakeCompoundOutputRspOuterClass.internal_static_TakeCompoundOutputRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp.class, emu.gingerps.net.proto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp other = (emu.gingerps.net.proto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp) obj;
    ...
    public static emu.gingerps.net.proto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.TakeCompoundOutputRspOuterClass.internal_static_TakeCompoundOutputRsp_descriptor;
      }
      ...
      // Construct using emu.gingerps.net.proto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp getDefaultInstanceForType() {
        return emu.gingerps.net.proto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp build() {
        emu.gingerps.net.proto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp buildPartial() {
        emu.gingerps.net.proto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp result = new emu.gingerps.net.proto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp(this);
      ...
      private void buildPartialRepeatedFields(emu.gingerps.net.proto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp result) {
        if (itemListBuilder_ == null) {
      ...
      private void buildPartial0(emu.gingerps.net.proto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp) {
          return mergeFrom((emu.gingerps.net.proto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp other) {
        if (other == emu.gingerps.net.proto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp.getDefaultInstance()) return this;
        if (itemListBuilder_ == null) {
    ...
    private static final emu.gingerps.net.proto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp();
    }

    public static emu.gingerps.net.proto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp getDefaultInstance() {
