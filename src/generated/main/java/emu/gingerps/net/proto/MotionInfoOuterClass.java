...
public final class MotionInfoOuterClass {
  ...
  public interface MotionInfoOrBuilder extends
     ...
     * @return The speed.
     */
    emu.gingerps.net.proto.VectorOuterClass.Vector getSpeed();
    /**
     * <code>.Vector speed = 3;</code>
     */
    emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder getSpeedOrBuilder();
     ...
     * @return The state.
     */
    emu.gingerps.net.proto.MotionStateOuterClass.MotionState getState();
     ...
     * <code>repeated .Vector params = 5;</code>
     */
    emu.gingerps.net.proto.VectorOuterClass.Vector getParams(int index);
    /**
     * <code>repeated .Vector params = 5;</code>
     */
    int getParamsCount();
     ...
     * <code>repeated .Vector params = 5;</code>
     */
    emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder getParamsOrBuilder(
        int index);
     ...
     * @return The refPos.
     */
    emu.gingerps.net.proto.VectorOuterClass.Vector getRefPos();
    /**
     * <code>.Vector ref_pos = 6;</code>
     */
    emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder getRefPosOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.MotionInfoOuterClass.internal_static_MotionInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.MotionInfoOuterClass.MotionInfo.class, emu.gingerps.net.proto.MotionInfoOuterClass.MotionInfo.Builder.class);
    }
    ...
    private emu.gingerps.net.proto.VectorOuterClass.Vector speed_;
    /**
     * <code>.Vector speed = 3;</code>
     * @return Whether the speed field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.VectorOuterClass.Vector getSpeed() {
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.VectorOuterClass.Vector> getParamsList() {
      return params_;
    }
    /**
     * <code>repeated .Vector params = 5;</code>
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.VectorOuterClass.Vector getParams(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder getParamsOrBuilder(
        int index) {
      return params_.get(index);
    }

    public static final int REF_POS_FIELD_NUMBER = 6;
    private emu.gingerps.net.proto.VectorOuterClass.Vector refPos_;
    /**
     * <code>.Vector ref_pos = 6;</code>
     * @return Whether the refPos field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.VectorOuterClass.Vector getRefPos() {
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (state_ != emu.gingerps.net.proto.MotionStateOuterClass.MotionState.MOTION_STATE_NONE.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.MotionInfoOuterClass.MotionInfo)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.MotionInfoOuterClass.MotionInfo other = (emu.gingerps.net.proto.MotionInfoOuterClass.MotionInfo) obj;
    ...
    public static emu.gingerps.net.proto.MotionInfoOuterClass.MotionInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.MotionInfoOuterClass.MotionInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.MotionInfoOuterClass.MotionInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.MotionInfoOuterClass.MotionInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.MotionInfoOuterClass.MotionInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.MotionInfoOuterClass.MotionInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.MotionInfoOuterClass.MotionInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.MotionInfoOuterClass.MotionInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.MotionInfoOuterClass.internal_static_MotionInfo_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.MotionInfoOuterClass.MotionInfo getDefaultInstanceForType() {
        return emu.gingerps.net.proto.MotionInfoOuterClass.MotionInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.MotionInfoOuterClass.MotionInfo build() {
        emu.gingerps.net.proto.MotionInfoOuterClass.MotionInfo result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.MotionInfoOuterClass.MotionInfo) {
          return mergeFrom((emu.gingerps.net.proto.MotionInfoOuterClass.MotionInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.MotionInfoOuterClass.MotionInfo other) {
        if (other == emu.gingerps.net.proto.MotionInfoOuterClass.MotionInfo.getDefaultInstance()) return this;
        if (other.hasPos()) {
      ...
      private emu.gingerps.net.proto.VectorOuterClass.Vector speed_;
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.VectorOuterClass.Vector, emu.gingerps.net.proto.VectorOuterClass.Vector.Builder, emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder> speedBuilder_;
      /**
       * <code>.Vector speed = 3;</code>
       * @return Whether the speed field is set.
       */
       ...
       * <code>.Vector speed = 3;</code>
       */
      public Builder setSpeed(emu.gingerps.net.proto.VectorOuterClass.Vector value) {
        if (speedBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder getSpeedOrBuilder() {
        if (speedBuilder_ != null) {
          ...
          return speed_ == null ?
              emu.gingerps.net.proto.VectorOuterClass.Vector.getDefaultInstance() : speed_;
        }
      }
      /**
       * <code>.Vector speed = 3;</code>
       ...
       * @return This builder for chaining.
       */
      public Builder setState(emu.gingerps.net.proto.MotionStateOuterClass.MotionState value) {
        if (value == null) {
          throw new NullPointerException();
        }
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.VectorOuterClass.Vector, emu.gingerps.net.proto.VectorOuterClass.Vector.Builder, emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder> paramsBuilder_;
       ...
       * <code>repeated .Vector params = 5;</code>
       */
      public Builder addParams(emu.gingerps.net.proto.VectorOuterClass.Vector value) {
        if (paramsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .Vector params = 5;</code>
       */
      public emu.gingerps.net.proto.VectorOuterClass.Vector.Builder getParamsBuilder(
          int index) {
       ...
       * <code>repeated .Vector params = 5;</code>
       */
      public emu.gingerps.net.proto.VectorOuterClass.Vector.Builder addParamsBuilder() {
      ...
      private emu.gingerps.net.proto.VectorOuterClass.Vector refPos_;
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.VectorOuterClass.Vector, emu.gingerps.net.proto.VectorOuterClass.Vector.Builder, emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder> refPosBuilder_;
      /**
       * <code>.Vector ref_pos = 6;</code>
       * @return Whether the refPos field is set.
       */
       ...
       * <code>.Vector ref_pos = 6;</code>
       */
      public Builder setRefPos(emu.gingerps.net.proto.VectorOuterClass.Vector value) {
        if (refPosBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder getRefPosOrBuilder() {
        if (refPosBuilder_ != null) {
          ...
          return refPos_ == null ?
              emu.gingerps.net.proto.VectorOuterClass.Vector.getDefaultInstance() : refPos_;
        }
      }
      /**
       * <code>.Vector ref_pos = 6;</code>
    ...
    private static final emu.gingerps.net.proto.MotionInfoOuterClass.MotionInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.MotionInfoOuterClass.MotionInfo();
    }

    public static emu.gingerps.net.proto.MotionInfoOuterClass.MotionInfo getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.MotionStateOuterClass.getDescriptor(),
