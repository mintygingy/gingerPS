...
public final class ObstacleModifyNotifyOuterClass {
  ...
  public interface ObstacleModifyNotifyOrBuilder extends
     ...
     * <code>repeated .ObstacleInfo add_obstacles = 15;</code>
     */
    emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo getAddObstacles(int index);
    /**
     * <code>repeated .ObstacleInfo add_obstacles = 15;</code>
     */
     ...
     * <code>repeated .ObstacleInfo add_obstacles = 15;</code>
     */
    emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfoOrBuilder getAddObstaclesOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 122: {
              if (!((mutable_bitField0_ & 0x00000002) != 0)) {
                addObstacles_ = new java.util.ArrayList<emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo>();
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.gingerps.net.proto.ObstacleModifyNotifyOuterClass.internal_static_ObstacleModifyNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.gingerps.net.proto.ObstacleModifyNotifyOuterClass.internal_static_ObstacleModifyNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify.class, emu.gingerps.net.proto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify.Builder.class);
    }
    ...
    private java.util.List<emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo> addObstacles_;
    /**
     * <code>repeated .ObstacleInfo add_obstacles = 15;</code>
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo> getAddObstaclesList() {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo getAddObstacles(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfoOrBuilder getAddObstaclesOrBuilder(
        int index) {
      return addObstacles_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify other = (emu.gingerps.net.proto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify) obj;
    ...
    public static emu.gingerps.net.proto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.ObstacleModifyNotifyOuterClass.internal_static_ObstacleModifyNotify_descriptor;
      }
      ...
      // Construct using emu.gingerps.net.proto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify build() {
        emu.gingerps.net.proto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify buildPartial() {
        emu.gingerps.net.proto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify result = new emu.gingerps.net.proto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify) {
          return mergeFrom((emu.gingerps.net.proto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify other) {
        if (other == emu.gingerps.net.proto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        emu.gingerps.net.proto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (emu.gingerps.net.proto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify) e.getUnfinishedMessage();
      ...
      private void ensureAddObstaclesIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          addObstacles_ = new java.util.ArrayList<emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo>(addObstacles_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo, emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo.Builder, emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfoOrBuilder> addObstaclesBuilder_;
       ...
       * <code>repeated .ObstacleInfo add_obstacles = 15;</code>
       */
      public Builder addAddObstacles(emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo value) {
        if (addObstaclesBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .ObstacleInfo add_obstacles = 15;</code>
       */
      public emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo.Builder getAddObstaclesBuilder(
          int index) {
       ...
       * <code>repeated .ObstacleInfo add_obstacles = 15;</code>
       */
      public emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo.Builder addAddObstaclesBuilder() {
    ...
    private static final emu.gingerps.net.proto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify();
    }

    public static emu.gingerps.net.proto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify getDefaultInstance() {
