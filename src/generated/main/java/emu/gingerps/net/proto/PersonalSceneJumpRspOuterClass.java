...
public final class PersonalSceneJumpRspOuterClass {
  ...
  public interface PersonalSceneJumpRspOrBuilder extends
     ...
     * @return The destPos.
     */
    emu.gingerps.net.proto.VectorOuterClass.Vector getDestPos();
    /**
     * <code>.Vector dest_pos = 8;</code>
     */
    emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder getDestPosOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.PersonalSceneJumpRspOuterClass.internal_static_PersonalSceneJumpRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp.class, emu.gingerps.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp.Builder.class);
    }
    ...
    private emu.gingerps.net.proto.VectorOuterClass.Vector destPos_;
    /**
     * <code>.Vector dest_pos = 8;</code>
     * @return Whether the destPos field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.VectorOuterClass.Vector getDestPos() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp other = (emu.gingerps.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp) obj;
    ...
    public static emu.gingerps.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.PersonalSceneJumpRspOuterClass.internal_static_PersonalSceneJumpRsp_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp getDefaultInstanceForType() {
        return emu.gingerps.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp build() {
        emu.gingerps.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp) {
          return mergeFrom((emu.gingerps.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp other) {
        if (other == emu.gingerps.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.VectorOuterClass.Vector, emu.gingerps.net.proto.VectorOuterClass.Vector.Builder, emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder> destPosBuilder_;
      /**
       * <code>.Vector dest_pos = 8;</code>
       * @return Whether the destPos field is set.
       */
       ...
       * <code>.Vector dest_pos = 8;</code>
       */
      public Builder setDestPos(emu.gingerps.net.proto.VectorOuterClass.Vector value) {
        if (destPosBuilder_ == null) {
          if (value == null) {
      ...
      public emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder getDestPosOrBuilder() {
        if (destPosBuilder_ != null) {
          ...
          return destPos_ == null ?
              emu.gingerps.net.proto.VectorOuterClass.Vector.getDefaultInstance() : destPos_;
        }
      }
      /**
       * <code>.Vector dest_pos = 8;</code>
    ...
    private static final emu.gingerps.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp();
    }

    public static emu.gingerps.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp getDefaultInstance() {
