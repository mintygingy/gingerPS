...
public final class HomeBasicInfoNotifyOuterClass {
  ...
  public interface HomeBasicInfoNotifyOrBuilder extends
     ...
     */
    emu.gingerps.net.proto.HomeBasicInfoOuterClass.HomeBasicInfo getBasicInfo();
    /**
     * <code>.HomeBasicInfo basic_info = 3;</code>
     */
    emu.gingerps.net.proto.HomeBasicInfoOuterClass.HomeBasicInfoOrBuilder getBasicInfoOrBuilder();
  }
  /**
   * <pre>
   * enum CmdId {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.HomeBasicInfoNotifyOuterClass.internal_static_HomeBasicInfoNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.HomeBasicInfoNotifyOuterClass.HomeBasicInfoNotify.class, emu.gingerps.net.proto.HomeBasicInfoNotifyOuterClass.HomeBasicInfoNotify.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.HomeBasicInfoOuterClass.HomeBasicInfo getBasicInfo() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.HomeBasicInfoNotifyOuterClass.HomeBasicInfoNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.HomeBasicInfoNotifyOuterClass.HomeBasicInfoNotify other = (emu.gingerps.net.proto.HomeBasicInfoNotifyOuterClass.HomeBasicInfoNotify) obj;
    ...
    public static emu.gingerps.net.proto.HomeBasicInfoNotifyOuterClass.HomeBasicInfoNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.HomeBasicInfoNotifyOuterClass.HomeBasicInfoNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.HomeBasicInfoNotifyOuterClass.HomeBasicInfoNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.HomeBasicInfoNotifyOuterClass.HomeBasicInfoNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.HomeBasicInfoNotifyOuterClass.HomeBasicInfoNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.HomeBasicInfoNotifyOuterClass.HomeBasicInfoNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.HomeBasicInfoNotifyOuterClass.HomeBasicInfoNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.HomeBasicInfoNotifyOuterClass.HomeBasicInfoNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.HomeBasicInfoNotifyOuterClass.internal_static_HomeBasicInfoNotify_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.HomeBasicInfoNotifyOuterClass.HomeBasicInfoNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.HomeBasicInfoNotifyOuterClass.HomeBasicInfoNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.HomeBasicInfoNotifyOuterClass.HomeBasicInfoNotify build() {
        emu.gingerps.net.proto.HomeBasicInfoNotifyOuterClass.HomeBasicInfoNotify result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.HomeBasicInfoNotifyOuterClass.HomeBasicInfoNotify) {
          return mergeFrom((emu.gingerps.net.proto.HomeBasicInfoNotifyOuterClass.HomeBasicInfoNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.HomeBasicInfoNotifyOuterClass.HomeBasicInfoNotify other) {
        if (other == emu.gingerps.net.proto.HomeBasicInfoNotifyOuterClass.HomeBasicInfoNotify.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.HomeBasicInfoOuterClass.HomeBasicInfo, emu.gingerps.net.proto.HomeBasicInfoOuterClass.HomeBasicInfo.Builder, emu.gingerps.net.proto.HomeBasicInfoOuterClass.HomeBasicInfoOrBuilder> basicInfoBuilder_;
      /**
       * <code>.HomeBasicInfo basic_info = 3;</code>
       * @return Whether the basicInfo field is set.
       */
       ...
       * <code>.HomeBasicInfo basic_info = 3;</code>
       */
      public Builder setBasicInfo(emu.gingerps.net.proto.HomeBasicInfoOuterClass.HomeBasicInfo value) {
        if (basicInfoBuilder_ == null) {
          if (value == null) {
      ...
      public emu.gingerps.net.proto.HomeBasicInfoOuterClass.HomeBasicInfoOrBuilder getBasicInfoOrBuilder() {
        if (basicInfoBuilder_ != null) {
          ...
          return basicInfo_ == null ?
              emu.gingerps.net.proto.HomeBasicInfoOuterClass.HomeBasicInfo.getDefaultInstance() : basicInfo_;
        }
      }
      /**
       * <code>.HomeBasicInfo basic_info = 3;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.HomeBasicInfoOuterClass.HomeBasicInfo, emu.gingerps.net.proto.HomeBasicInfoOuterClass.HomeBasicInfo.Builder, emu.gingerps.net.proto.HomeBasicInfoOuterClass.HomeBasicInfoOrBuilder> 
    ...
    private static final emu.gingerps.net.proto.HomeBasicInfoNotifyOuterClass.HomeBasicInfoNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.HomeBasicInfoNotifyOuterClass.HomeBasicInfoNotify();
    }

    public static emu.gingerps.net.proto.HomeBasicInfoNotifyOuterClass.HomeBasicInfoNotify getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.HomeBasicInfoOuterClass.getDescriptor(),
        });
    internal_static_HomeBasicInfoNotify_descriptor =
