...
public final class StartCoopPointRspOuterClass {
  ...
  public interface StartCoopPointRspOrBuilder extends
     ...
     */
    emu.gingerps.net.proto.MainCoopOuterClass.MainCoop getStartMainCoop();
    /**
     * <code>.MainCoop start_main_coop = 4;</code>
     */
    emu.gingerps.net.proto.MainCoopOuterClass.MainCoopOrBuilder getStartMainCoopOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.StartCoopPointRspOuterClass.internal_static_StartCoopPointRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp.class, emu.gingerps.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.MainCoopOuterClass.MainCoop getStartMainCoop() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp other = (emu.gingerps.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp) obj;
    ...
    public static emu.gingerps.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.StartCoopPointRspOuterClass.StartCoopPointRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.StartCoopPointRspOuterClass.internal_static_StartCoopPointRsp_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp getDefaultInstanceForType() {
        return emu.gingerps.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp build() {
        emu.gingerps.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp) {
          return mergeFrom((emu.gingerps.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp other) {
        if (other == emu.gingerps.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.MainCoopOuterClass.MainCoop, emu.gingerps.net.proto.MainCoopOuterClass.MainCoop.Builder, emu.gingerps.net.proto.MainCoopOuterClass.MainCoopOrBuilder> startMainCoopBuilder_;
      /**
       * <code>.MainCoop start_main_coop = 4;</code>
       * @return Whether the startMainCoop field is set.
       */
       ...
       * <code>.MainCoop start_main_coop = 4;</code>
       */
      public Builder setStartMainCoop(emu.gingerps.net.proto.MainCoopOuterClass.MainCoop value) {
        if (startMainCoopBuilder_ == null) {
          if (value == null) {
      ...
      public emu.gingerps.net.proto.MainCoopOuterClass.MainCoopOrBuilder getStartMainCoopOrBuilder() {
        if (startMainCoopBuilder_ != null) {
          ...
          return startMainCoop_ == null ?
              emu.gingerps.net.proto.MainCoopOuterClass.MainCoop.getDefaultInstance() : startMainCoop_;
        }
      }
      /**
       * <code>.MainCoop start_main_coop = 4;</code>
    ...
    private static final emu.gingerps.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp();
    }

    public static emu.gingerps.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp getDefaultInstance() {
