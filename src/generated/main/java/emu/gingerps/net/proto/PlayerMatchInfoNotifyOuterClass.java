...
public final class PlayerMatchInfoNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.gingerps.net.proto.PlayerMatchInfoNotifyOuterClass.internal_static_PlayerMatchInfoNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.gingerps.net.proto.PlayerMatchInfoNotifyOuterClass.internal_static_PlayerMatchInfoNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify.class, emu.gingerps.net.proto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify other = (emu.gingerps.net.proto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify) obj;
    ...
    public static emu.gingerps.net.proto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.PlayerMatchInfoNotifyOuterClass.internal_static_PlayerMatchInfoNotify_descriptor;
      }
      ...
      // Construct using emu.gingerps.net.proto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify build() {
        emu.gingerps.net.proto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify buildPartial() {
        emu.gingerps.net.proto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify result = new emu.gingerps.net.proto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify(this);
      ...
      private void buildPartialRepeatedFields(emu.gingerps.net.proto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify result) {
      ...
      private void buildPartial0(emu.gingerps.net.proto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify) {
          return mergeFrom((emu.gingerps.net.proto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify other) {
        if (other == emu.gingerps.net.proto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify.getDefaultInstance()) return this;
    ...
    private static final emu.gingerps.net.proto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify();
    }

    public static emu.gingerps.net.proto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "tch_param_list\030\013 \003(\rB\030\n\026emu.gingerps.net" +
      ".protob\006proto3"
    };
