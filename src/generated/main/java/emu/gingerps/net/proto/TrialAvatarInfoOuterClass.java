...
public final class TrialAvatarInfoOuterClass {
  ...
  public interface TrialAvatarInfoOrBuilder extends
     ...
     * <code>repeated .Item trial_equip_list = 2;</code>
     */
    emu.gingerps.net.proto.ItemOuterClass.Item getTrialEquipList(int index);
    /**
     * <code>repeated .Item trial_equip_list = 2;</code>
     */
     ...
     * <code>repeated .Item trial_equip_list = 2;</code>
     */
    emu.gingerps.net.proto.ItemOuterClass.ItemOrBuilder getTrialEquipListOrBuilder(
        int index);
     ...
     */
    emu.gingerps.net.proto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord getGrantRecord();
    /**
     * <code>.TrialAvatarGrantRecord grant_record = 3;</code>
     */
    emu.gingerps.net.proto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecordOrBuilder getGrantRecordOrBuilder();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 18: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                trialEquipList_ = new java.util.ArrayList<emu.gingerps.net.proto.ItemOuterClass.Item>();
            ...
            case 26: {
              emu.gingerps.net.proto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord.Builder subBuilder = null;
              if (grantRecord_ != null) {
                subBuilder = grantRecord_.toBuilder();
              }
              grantRecord_ = input.readMessage(emu.gingerps.net.proto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.gingerps.net.proto.TrialAvatarInfoOuterClass.internal_static_TrialAvatarInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.gingerps.net.proto.TrialAvatarInfoOuterClass.internal_static_TrialAvatarInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.TrialAvatarInfoOuterClass.TrialAvatarInfo.class, emu.gingerps.net.proto.TrialAvatarInfoOuterClass.TrialAvatarInfo.Builder.class);
    }
    ...
    private java.util.List<emu.gingerps.net.proto.ItemOuterClass.Item> trialEquipList_;
    /**
     * <code>repeated .Item trial_equip_list = 2;</code>
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.ItemOuterClass.Item> getTrialEquipListList() {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.ItemOuterClass.Item getTrialEquipList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.ItemOuterClass.ItemOrBuilder getTrialEquipListOrBuilder(
        int index) {
      return trialEquipList_.get(index);
    }

    public static final int GRANT_RECORD_FIELD_NUMBER = 3;
    private emu.gingerps.net.proto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord grantRecord_;
    /**
     * <code>.TrialAvatarGrantRecord grant_record = 3;</code>
     * @return Whether the grantRecord field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord getGrantRecord() {
      return grantRecord_ == null ? emu.gingerps.net.proto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord.getDefaultInstance() : grantRecord_;
    }
    /**
     * <code>.TrialAvatarGrantRecord grant_record = 3;</code>
     */
    @java.lang.Override
    public emu.gingerps.net.proto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecordOrBuilder getGrantRecordOrBuilder() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.TrialAvatarInfoOuterClass.TrialAvatarInfo)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.TrialAvatarInfoOuterClass.TrialAvatarInfo other = (emu.gingerps.net.proto.TrialAvatarInfoOuterClass.TrialAvatarInfo) obj;
    ...
    public static emu.gingerps.net.proto.TrialAvatarInfoOuterClass.TrialAvatarInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.TrialAvatarInfoOuterClass.TrialAvatarInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.TrialAvatarInfoOuterClass.TrialAvatarInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.TrialAvatarInfoOuterClass.TrialAvatarInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.TrialAvatarInfoOuterClass.TrialAvatarInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.TrialAvatarInfoOuterClass.TrialAvatarInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.TrialAvatarInfoOuterClass.TrialAvatarInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.TrialAvatarInfoOuterClass.TrialAvatarInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.TrialAvatarInfoOuterClass.internal_static_TrialAvatarInfo_descriptor;
      }
      ...
      // Construct using emu.gingerps.net.proto.TrialAvatarInfoOuterClass.TrialAvatarInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.TrialAvatarInfoOuterClass.TrialAvatarInfo getDefaultInstanceForType() {
        return emu.gingerps.net.proto.TrialAvatarInfoOuterClass.TrialAvatarInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.TrialAvatarInfoOuterClass.TrialAvatarInfo build() {
        emu.gingerps.net.proto.TrialAvatarInfoOuterClass.TrialAvatarInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.TrialAvatarInfoOuterClass.TrialAvatarInfo buildPartial() {
        emu.gingerps.net.proto.TrialAvatarInfoOuterClass.TrialAvatarInfo result = new emu.gingerps.net.proto.TrialAvatarInfoOuterClass.TrialAvatarInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.TrialAvatarInfoOuterClass.TrialAvatarInfo) {
          return mergeFrom((emu.gingerps.net.proto.TrialAvatarInfoOuterClass.TrialAvatarInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.TrialAvatarInfoOuterClass.TrialAvatarInfo other) {
        if (other == emu.gingerps.net.proto.TrialAvatarInfoOuterClass.TrialAvatarInfo.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        emu.gingerps.net.proto.TrialAvatarInfoOuterClass.TrialAvatarInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (emu.gingerps.net.proto.TrialAvatarInfoOuterClass.TrialAvatarInfo) e.getUnfinishedMessage();
      ...
      private void ensureTrialEquipListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          trialEquipList_ = new java.util.ArrayList<emu.gingerps.net.proto.ItemOuterClass.Item>(trialEquipList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.ItemOuterClass.Item, emu.gingerps.net.proto.ItemOuterClass.Item.Builder, emu.gingerps.net.proto.ItemOuterClass.ItemOrBuilder> trialEquipListBuilder_;
       ...
       * <code>repeated .Item trial_equip_list = 2;</code>
       */
      public Builder addTrialEquipList(emu.gingerps.net.proto.ItemOuterClass.Item value) {
        if (trialEquipListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .Item trial_equip_list = 2;</code>
       */
      public emu.gingerps.net.proto.ItemOuterClass.Item.Builder getTrialEquipListBuilder(
          int index) {
       ...
       * <code>repeated .Item trial_equip_list = 2;</code>
       */
      public emu.gingerps.net.proto.ItemOuterClass.Item.Builder addTrialEquipListBuilder() {
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord, emu.gingerps.net.proto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord.Builder, emu.gingerps.net.proto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecordOrBuilder> grantRecordBuilder_;
      /**
       * <code>.TrialAvatarGrantRecord grant_record = 3;</code>
       * @return Whether the grantRecord field is set.
       */
       ...
       * <code>.TrialAvatarGrantRecord grant_record = 3;</code>
       */
      public Builder setGrantRecord(emu.gingerps.net.proto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord value) {
        if (grantRecordBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setGrantRecord(
          emu.gingerps.net.proto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord.Builder builderForValue) {
        if (grantRecordBuilder_ == null) {
       ...
       * <code>.TrialAvatarGrantRecord grant_record = 3;</code>
       */
      public Builder mergeGrantRecord(emu.gingerps.net.proto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord value) {
        if (grantRecordBuilder_ == null) {
          if (grantRecord_ != null) {
            grantRecord_ =
              emu.gingerps.net.proto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord.newBuilder(grantRecord_).mergeFrom(value).buildPartial();
          } else {
            grantRecord_ = value;
          }
          onChanged();
       ...
       * <code>.TrialAvatarGrantRecord grant_record = 3;</code>
       */
      public emu.gingerps.net.proto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord.Builder getGrantRecordBuilder() {
      ...
      public emu.gingerps.net.proto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecordOrBuilder getGrantRecordOrBuilder() {
        if (grantRecordBuilder_ != null) {
          ...
          return grantRecord_ == null ?
              emu.gingerps.net.proto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord.getDefaultInstance() : grantRecord_;
        }
      }
      /**
       * <code>.TrialAvatarGrantRecord grant_record = 3;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord, emu.gingerps.net.proto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord.Builder, emu.gingerps.net.proto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecordOrBuilder> 
    ...
    private static final emu.gingerps.net.proto.TrialAvatarInfoOuterClass.TrialAvatarInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.TrialAvatarInfoOuterClass.TrialAvatarInfo();
    }

    public static emu.gingerps.net.proto.TrialAvatarInfoOuterClass.TrialAvatarInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      " \001(\0132\027.TrialAvatarGrantRecordB\030\n\026emu.gin" +
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          ...
          emu.gingerps.net.proto.TrialAvatarGrantRecordOuterClass.getDescriptor(),
        });
    internal_static_TrialAvatarInfo_descriptor =
