...
public final class GetSceneNpcPositionRspOuterClass {
  ...
  public interface GetSceneNpcPositionRspOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.NpcPositionInfoOuterClass.NpcPositionInfo> 
        getNpcInfoListList();
    /**
     * <code>repeated .NpcPositionInfo npc_info_list = 2;</code>
     */
    emu.gingerps.net.proto.NpcPositionInfoOuterClass.NpcPositionInfo getNpcInfoList(int index);
    /**
     * <code>repeated .NpcPositionInfo npc_info_list = 2;</code>
     */
     ...
     * <code>repeated .NpcPositionInfo npc_info_list = 2;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.NpcPositionInfoOuterClass.NpcPositionInfoOrBuilder> 
        getNpcInfoListOrBuilderList();
    /**
     * <code>repeated .NpcPositionInfo npc_info_list = 2;</code>
     */
    emu.gingerps.net.proto.NpcPositionInfoOuterClass.NpcPositionInfoOrBuilder getNpcInfoListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.GetSceneNpcPositionRspOuterClass.internal_static_GetSceneNpcPositionRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.GetSceneNpcPositionRspOuterClass.GetSceneNpcPositionRsp.class, emu.gingerps.net.proto.GetSceneNpcPositionRspOuterClass.GetSceneNpcPositionRsp.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.NpcPositionInfoOuterClass.NpcPositionInfo> getNpcInfoListList() {
      return npcInfoList_;
    }
    /**
     * <code>repeated .NpcPositionInfo npc_info_list = 2;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.NpcPositionInfoOuterClass.NpcPositionInfoOrBuilder> 
        getNpcInfoListOrBuilderList() {
      return npcInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.NpcPositionInfoOuterClass.NpcPositionInfo getNpcInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.NpcPositionInfoOuterClass.NpcPositionInfoOrBuilder getNpcInfoListOrBuilder(
        int index) {
      return npcInfoList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.GetSceneNpcPositionRspOuterClass.GetSceneNpcPositionRsp)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.GetSceneNpcPositionRspOuterClass.GetSceneNpcPositionRsp other = (emu.gingerps.net.proto.GetSceneNpcPositionRspOuterClass.GetSceneNpcPositionRsp) obj;
    ...
    public static emu.gingerps.net.proto.GetSceneNpcPositionRspOuterClass.GetSceneNpcPositionRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.GetSceneNpcPositionRspOuterClass.GetSceneNpcPositionRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.GetSceneNpcPositionRspOuterClass.GetSceneNpcPositionRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.GetSceneNpcPositionRspOuterClass.GetSceneNpcPositionRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.GetSceneNpcPositionRspOuterClass.GetSceneNpcPositionRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.GetSceneNpcPositionRspOuterClass.GetSceneNpcPositionRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.GetSceneNpcPositionRspOuterClass.GetSceneNpcPositionRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.GetSceneNpcPositionRspOuterClass.GetSceneNpcPositionRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.GetSceneNpcPositionRspOuterClass.internal_static_GetSceneNpcPositionRsp_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.GetSceneNpcPositionRspOuterClass.GetSceneNpcPositionRsp getDefaultInstanceForType() {
        return emu.gingerps.net.proto.GetSceneNpcPositionRspOuterClass.GetSceneNpcPositionRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.GetSceneNpcPositionRspOuterClass.GetSceneNpcPositionRsp build() {
        emu.gingerps.net.proto.GetSceneNpcPositionRspOuterClass.GetSceneNpcPositionRsp result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.GetSceneNpcPositionRspOuterClass.GetSceneNpcPositionRsp) {
          return mergeFrom((emu.gingerps.net.proto.GetSceneNpcPositionRspOuterClass.GetSceneNpcPositionRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.GetSceneNpcPositionRspOuterClass.GetSceneNpcPositionRsp other) {
        if (other == emu.gingerps.net.proto.GetSceneNpcPositionRspOuterClass.GetSceneNpcPositionRsp.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.NpcPositionInfoOuterClass.NpcPositionInfo, emu.gingerps.net.proto.NpcPositionInfoOuterClass.NpcPositionInfo.Builder, emu.gingerps.net.proto.NpcPositionInfoOuterClass.NpcPositionInfoOrBuilder> npcInfoListBuilder_;
      ...
      public Builder setNpcInfoList(
          int index, emu.gingerps.net.proto.NpcPositionInfoOuterClass.NpcPositionInfo value) {
        if (npcInfoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setNpcInfoList(
          int index, emu.gingerps.net.proto.NpcPositionInfoOuterClass.NpcPositionInfo.Builder builderForValue) {
        if (npcInfoListBuilder_ == null) {
          ensureNpcInfoListIsMutable();
       ...
       * <code>repeated .NpcPositionInfo npc_info_list = 2;</code>
       */
      public Builder addNpcInfoList(emu.gingerps.net.proto.NpcPositionInfoOuterClass.NpcPositionInfo value) {
        if (npcInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addNpcInfoList(
          emu.gingerps.net.proto.NpcPositionInfoOuterClass.NpcPositionInfo.Builder builderForValue) {
        if (npcInfoListBuilder_ == null) {
          ensureNpcInfoListIsMutable();
      ...
      public Builder addAllNpcInfoList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.NpcPositionInfoOuterClass.NpcPositionInfo> values) {
        if (npcInfoListBuilder_ == null) {
          ensureNpcInfoListIsMutable();
       ...
       * <code>repeated .NpcPositionInfo npc_info_list = 2;</code>
       */
      public emu.gingerps.net.proto.NpcPositionInfoOuterClass.NpcPositionInfo.Builder getNpcInfoListBuilder(
          int index) {
       ...
       * <code>repeated .NpcPositionInfo npc_info_list = 2;</code>
       */
      public emu.gingerps.net.proto.NpcPositionInfoOuterClass.NpcPositionInfo.Builder addNpcInfoListBuilder() {
        return getNpcInfoListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.NpcPositionInfoOuterClass.NpcPositionInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .NpcPositionInfo npc_info_list = 2;</code>
       */
      public emu.gingerps.net.proto.NpcPositionInfoOuterClass.NpcPositionInfo.Builder addNpcInfoListBuilder(
          int index) {
        return getNpcInfoListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.NpcPositionInfoOuterClass.NpcPositionInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .NpcPositionInfo npc_info_list = 2;</code>
       */
      public java.util.List<emu.gingerps.net.proto.NpcPositionInfoOuterClass.NpcPositionInfo.Builder> 
    ...
    private static final emu.gingerps.net.proto.GetSceneNpcPositionRspOuterClass.GetSceneNpcPositionRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.GetSceneNpcPositionRspOuterClass.GetSceneNpcPositionRsp();
    }

    public static emu.gingerps.net.proto.GetSceneNpcPositionRspOuterClass.GetSceneNpcPositionRsp getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.NpcPositionInfoOuterClass.getDescriptor(),
        });
    internal_static_GetSceneNpcPositionRsp_descriptor =
