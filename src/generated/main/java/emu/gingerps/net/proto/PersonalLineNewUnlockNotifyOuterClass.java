...
public final class PersonalLineNewUnlockNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.gingerps.net.proto.PersonalLineNewUnlockNotifyOuterClass.internal_static_PersonalLineNewUnlockNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.gingerps.net.proto.PersonalLineNewUnlockNotifyOuterClass.internal_static_PersonalLineNewUnlockNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify.class, emu.gingerps.net.proto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify other = (emu.gingerps.net.proto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify) obj;
    ...
    public static emu.gingerps.net.proto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.PersonalLineNewUnlockNotifyOuterClass.internal_static_PersonalLineNewUnlockNotify_descriptor;
      }
      ...
      // Construct using emu.gingerps.net.proto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify build() {
        emu.gingerps.net.proto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify buildPartial() {
        emu.gingerps.net.proto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify result = new emu.gingerps.net.proto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify(this);
      ...
      private void buildPartialRepeatedFields(emu.gingerps.net.proto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify result) {
      ...
      private void buildPartial0(emu.gingerps.net.proto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify) {
          return mergeFrom((emu.gingerps.net.proto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify other) {
        if (other == emu.gingerps.net.proto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify.getDefaultInstance()) return this;
    ...
    private static final emu.gingerps.net.proto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify();
    }

    public static emu.gingerps.net.proto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ine_id_list\030\006 \003(\rB\030\n\026emu.gingerps.net.pr" +
      "otob\006proto3"
    };
