...
public final class LevelupCityRspOuterClass {
  ...
  public interface LevelupCityRspOrBuilder extends
     ...
     * @return The cityInfo.
     */
    emu.gingerps.net.proto.CityInfoOuterClass.CityInfo getCityInfo();
    /**
     * <code>.CityInfo city_info = 14;</code>
     */
    emu.gingerps.net.proto.CityInfoOuterClass.CityInfoOrBuilder getCityInfoOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.LevelupCityRspOuterClass.internal_static_LevelupCityRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.LevelupCityRspOuterClass.LevelupCityRsp.class, emu.gingerps.net.proto.LevelupCityRspOuterClass.LevelupCityRsp.Builder.class);
    }
    ...
    private emu.gingerps.net.proto.CityInfoOuterClass.CityInfo cityInfo_;
    /**
     * <code>.CityInfo city_info = 14;</code>
     * @return Whether the cityInfo field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.CityInfoOuterClass.CityInfo getCityInfo() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.LevelupCityRspOuterClass.LevelupCityRsp)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.LevelupCityRspOuterClass.LevelupCityRsp other = (emu.gingerps.net.proto.LevelupCityRspOuterClass.LevelupCityRsp) obj;
    ...
    public static emu.gingerps.net.proto.LevelupCityRspOuterClass.LevelupCityRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.LevelupCityRspOuterClass.LevelupCityRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.LevelupCityRspOuterClass.LevelupCityRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.LevelupCityRspOuterClass.LevelupCityRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.LevelupCityRspOuterClass.LevelupCityRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.LevelupCityRspOuterClass.LevelupCityRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.LevelupCityRspOuterClass.LevelupCityRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.LevelupCityRspOuterClass.LevelupCityRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.LevelupCityRspOuterClass.internal_static_LevelupCityRsp_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.LevelupCityRspOuterClass.LevelupCityRsp getDefaultInstanceForType() {
        return emu.gingerps.net.proto.LevelupCityRspOuterClass.LevelupCityRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.LevelupCityRspOuterClass.LevelupCityRsp build() {
        emu.gingerps.net.proto.LevelupCityRspOuterClass.LevelupCityRsp result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.LevelupCityRspOuterClass.LevelupCityRsp) {
          return mergeFrom((emu.gingerps.net.proto.LevelupCityRspOuterClass.LevelupCityRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.LevelupCityRspOuterClass.LevelupCityRsp other) {
        if (other == emu.gingerps.net.proto.LevelupCityRspOuterClass.LevelupCityRsp.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.CityInfoOuterClass.CityInfo, emu.gingerps.net.proto.CityInfoOuterClass.CityInfo.Builder, emu.gingerps.net.proto.CityInfoOuterClass.CityInfoOrBuilder> cityInfoBuilder_;
      /**
       * <code>.CityInfo city_info = 14;</code>
       * @return Whether the cityInfo field is set.
       */
       ...
       * <code>.CityInfo city_info = 14;</code>
       */
      public Builder setCityInfo(emu.gingerps.net.proto.CityInfoOuterClass.CityInfo value) {
        if (cityInfoBuilder_ == null) {
          if (value == null) {
      ...
      public emu.gingerps.net.proto.CityInfoOuterClass.CityInfoOrBuilder getCityInfoOrBuilder() {
        if (cityInfoBuilder_ != null) {
          ...
          return cityInfo_ == null ?
              emu.gingerps.net.proto.CityInfoOuterClass.CityInfo.getDefaultInstance() : cityInfo_;
        }
      }
      /**
       * <code>.CityInfo city_info = 14;</code>
    ...
    private static final emu.gingerps.net.proto.LevelupCityRspOuterClass.LevelupCityRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.LevelupCityRspOuterClass.LevelupCityRsp();
    }

    public static emu.gingerps.net.proto.LevelupCityRspOuterClass.LevelupCityRsp getDefaultInstance() {
