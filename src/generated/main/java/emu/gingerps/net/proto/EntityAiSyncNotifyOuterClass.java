...
public final class EntityAiSyncNotifyOuterClass {
  ...
  public interface EntityAiSyncNotifyOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.AiSyncInfoOuterClass.AiSyncInfo> 
        getInfoListList();
    /**
     * <code>repeated .AiSyncInfo info_list = 14;</code>
     */
    emu.gingerps.net.proto.AiSyncInfoOuterClass.AiSyncInfo getInfoList(int index);
    /**
     * <code>repeated .AiSyncInfo info_list = 14;</code>
     */
     ...
     * <code>repeated .AiSyncInfo info_list = 14;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.AiSyncInfoOuterClass.AiSyncInfoOrBuilder> 
        getInfoListOrBuilderList();
    /**
     * <code>repeated .AiSyncInfo info_list = 14;</code>
     */
    emu.gingerps.net.proto.AiSyncInfoOuterClass.AiSyncInfoOrBuilder getInfoListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.EntityAiSyncNotifyOuterClass.internal_static_EntityAiSyncNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify.class, emu.gingerps.net.proto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.AiSyncInfoOuterClass.AiSyncInfo> getInfoListList() {
      return infoList_;
    }
    /**
     * <code>repeated .AiSyncInfo info_list = 14;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.AiSyncInfoOuterClass.AiSyncInfoOrBuilder> 
        getInfoListOrBuilderList() {
      return infoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.AiSyncInfoOuterClass.AiSyncInfo getInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.AiSyncInfoOuterClass.AiSyncInfoOrBuilder getInfoListOrBuilder(
        int index) {
      return infoList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify other = (emu.gingerps.net.proto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify) obj;
    ...
    public static emu.gingerps.net.proto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.EntityAiSyncNotifyOuterClass.internal_static_EntityAiSyncNotify_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify build() {
        emu.gingerps.net.proto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify) {
          return mergeFrom((emu.gingerps.net.proto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify other) {
        if (other == emu.gingerps.net.proto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify.getDefaultInstance()) return this;
        if (infoListBuilder_ == null) {
      ...
      private void ensureInfoListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          infoList_ = new java.util.ArrayList<emu.gingerps.net.proto.AiSyncInfoOuterClass.AiSyncInfo>(infoList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.AiSyncInfoOuterClass.AiSyncInfo, emu.gingerps.net.proto.AiSyncInfoOuterClass.AiSyncInfo.Builder, emu.gingerps.net.proto.AiSyncInfoOuterClass.AiSyncInfoOrBuilder> infoListBuilder_;
      ...
      public Builder setInfoList(
          int index, emu.gingerps.net.proto.AiSyncInfoOuterClass.AiSyncInfo value) {
        if (infoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setInfoList(
          int index, emu.gingerps.net.proto.AiSyncInfoOuterClass.AiSyncInfo.Builder builderForValue) {
        if (infoListBuilder_ == null) {
          ensureInfoListIsMutable();
       ...
       * <code>repeated .AiSyncInfo info_list = 14;</code>
       */
      public Builder addInfoList(emu.gingerps.net.proto.AiSyncInfoOuterClass.AiSyncInfo value) {
        if (infoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addInfoList(
          emu.gingerps.net.proto.AiSyncInfoOuterClass.AiSyncInfo.Builder builderForValue) {
        if (infoListBuilder_ == null) {
          ensureInfoListIsMutable();
      ...
      public Builder addAllInfoList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.AiSyncInfoOuterClass.AiSyncInfo> values) {
        if (infoListBuilder_ == null) {
          ensureInfoListIsMutable();
       ...
       * <code>repeated .AiSyncInfo info_list = 14;</code>
       */
      public emu.gingerps.net.proto.AiSyncInfoOuterClass.AiSyncInfo.Builder getInfoListBuilder(
          int index) {
       ...
       * <code>repeated .AiSyncInfo info_list = 14;</code>
       */
      public emu.gingerps.net.proto.AiSyncInfoOuterClass.AiSyncInfo.Builder addInfoListBuilder() {
        return getInfoListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.AiSyncInfoOuterClass.AiSyncInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .AiSyncInfo info_list = 14;</code>
       */
      public emu.gingerps.net.proto.AiSyncInfoOuterClass.AiSyncInfo.Builder addInfoListBuilder(
          int index) {
        return getInfoListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.AiSyncInfoOuterClass.AiSyncInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .AiSyncInfo info_list = 14;</code>
       */
      public java.util.List<emu.gingerps.net.proto.AiSyncInfoOuterClass.AiSyncInfo.Builder> 
           getInfoListBuilderList() {
        return getInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.AiSyncInfoOuterClass.AiSyncInfo, emu.gingerps.net.proto.AiSyncInfoOuterClass.AiSyncInfo.Builder, emu.gingerps.net.proto.AiSyncInfoOuterClass.AiSyncInfoOrBuilder> 
          getInfoListFieldBuilder() {
        if (infoListBuilder_ == null) {
    ...
    private static final emu.gingerps.net.proto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify();
    }

    public static emu.gingerps.net.proto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.AiSyncInfoOuterClass.getDescriptor(),
        });
    internal_static_EntityAiSyncNotify_descriptor =
