...
public final class OpActivityDataNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.gingerps.net.proto.OpActivityDataNotifyOuterClass.internal_static_OpActivityDataNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.gingerps.net.proto.OpActivityDataNotifyOuterClass.internal_static_OpActivityDataNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.OpActivityDataNotifyOuterClass.OpActivityDataNotify.class, emu.gingerps.net.proto.OpActivityDataNotifyOuterClass.OpActivityDataNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.OpActivityDataNotifyOuterClass.OpActivityDataNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.OpActivityDataNotifyOuterClass.OpActivityDataNotify other = (emu.gingerps.net.proto.OpActivityDataNotifyOuterClass.OpActivityDataNotify) obj;
    ...
    public static emu.gingerps.net.proto.OpActivityDataNotifyOuterClass.OpActivityDataNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.OpActivityDataNotifyOuterClass.OpActivityDataNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.OpActivityDataNotifyOuterClass.OpActivityDataNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.OpActivityDataNotifyOuterClass.OpActivityDataNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.OpActivityDataNotifyOuterClass.OpActivityDataNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.OpActivityDataNotifyOuterClass.OpActivityDataNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.OpActivityDataNotifyOuterClass.OpActivityDataNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.OpActivityDataNotifyOuterClass.OpActivityDataNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.OpActivityDataNotifyOuterClass.internal_static_OpActivityDataNotify_descriptor;
      }
      ...
      // Construct using emu.gingerps.net.proto.OpActivityDataNotifyOuterClass.OpActivityDataNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.OpActivityDataNotifyOuterClass.OpActivityDataNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.OpActivityDataNotifyOuterClass.OpActivityDataNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.OpActivityDataNotifyOuterClass.OpActivityDataNotify build() {
        emu.gingerps.net.proto.OpActivityDataNotifyOuterClass.OpActivityDataNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.OpActivityDataNotifyOuterClass.OpActivityDataNotify buildPartial() {
        emu.gingerps.net.proto.OpActivityDataNotifyOuterClass.OpActivityDataNotify result = new emu.gingerps.net.proto.OpActivityDataNotifyOuterClass.OpActivityDataNotify(this);
      ...
      private void buildPartialRepeatedFields(emu.gingerps.net.proto.OpActivityDataNotifyOuterClass.OpActivityDataNotify result) {
        if (opActivityInfoListBuilder_ == null) {
      ...
      private void buildPartial0(emu.gingerps.net.proto.OpActivityDataNotifyOuterClass.OpActivityDataNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.OpActivityDataNotifyOuterClass.OpActivityDataNotify) {
          return mergeFrom((emu.gingerps.net.proto.OpActivityDataNotifyOuterClass.OpActivityDataNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.OpActivityDataNotifyOuterClass.OpActivityDataNotify other) {
        if (other == emu.gingerps.net.proto.OpActivityDataNotifyOuterClass.OpActivityDataNotify.getDefaultInstance()) return this;
        if (opActivityInfoListBuilder_ == null) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 34: {
                emu.gingerps.net.proto.OpActivityInfoOuterClass.OpActivityInfo m =
                    input.readMessage(
                        emu.gingerps.net.proto.OpActivityInfoOuterClass.OpActivityInfo.parser(),
                        extensionRegistry);
                if (opActivityInfoListBuilder_ == null) {
                  ensureOpActivityInfoListIsMutable();
    ...
    private static final emu.gingerps.net.proto.OpActivityDataNotifyOuterClass.OpActivityDataNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.OpActivityDataNotifyOuterClass.OpActivityDataNotify();
    }

    public static emu.gingerps.net.proto.OpActivityDataNotifyOuterClass.OpActivityDataNotify getDefaultInstance() {
