...
public final class ChatChannelDataNotifyOuterClass {
  ...
  public interface ChatChannelDataNotifyOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.ChatChannelInfoOuterClass.ChatChannelInfo> 
        getChannelInfoListList();
    /**
     * <code>repeated .ChatChannelInfo channel_info_list = 5;</code>
     */
    emu.gingerps.net.proto.ChatChannelInfoOuterClass.ChatChannelInfo getChannelInfoList(int index);
    /**
     * <code>repeated .ChatChannelInfo channel_info_list = 5;</code>
     */
     ...
     * <code>repeated .ChatChannelInfo channel_info_list = 5;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.ChatChannelInfoOuterClass.ChatChannelInfoOrBuilder> 
        getChannelInfoListOrBuilderList();
    /**
     * <code>repeated .ChatChannelInfo channel_info_list = 5;</code>
     */
    emu.gingerps.net.proto.ChatChannelInfoOuterClass.ChatChannelInfoOrBuilder getChannelInfoListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 42: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                channelInfoList_ = new java.util.ArrayList<emu.gingerps.net.proto.ChatChannelInfoOuterClass.ChatChannelInfo>();
                mutable_bitField0_ |= 0x00000001;
              }
              channelInfoList_.add(
                  input.readMessage(emu.gingerps.net.proto.ChatChannelInfoOuterClass.ChatChannelInfo.parser(), extensionRegistry));
              break;
            }
            default: {
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.gingerps.net.proto.ChatChannelDataNotifyOuterClass.internal_static_ChatChannelDataNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.gingerps.net.proto.ChatChannelDataNotifyOuterClass.internal_static_ChatChannelDataNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.ChatChannelDataNotifyOuterClass.ChatChannelDataNotify.class, emu.gingerps.net.proto.ChatChannelDataNotifyOuterClass.ChatChannelDataNotify.Builder.class);
    }

    public static final int CHANNEL_INFO_LIST_FIELD_NUMBER = 5;
    private java.util.List<emu.gingerps.net.proto.ChatChannelInfoOuterClass.ChatChannelInfo> channelInfoList_;
    /**
     * <code>repeated .ChatChannelInfo channel_info_list = 5;</code>
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.ChatChannelInfoOuterClass.ChatChannelInfo> getChannelInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.ChatChannelInfoOuterClass.ChatChannelInfoOrBuilder> 
        getChannelInfoListOrBuilderList() {
      return channelInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.ChatChannelInfoOuterClass.ChatChannelInfo getChannelInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.ChatChannelInfoOuterClass.ChatChannelInfoOrBuilder getChannelInfoListOrBuilder(
        int index) {
      return channelInfoList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.ChatChannelDataNotifyOuterClass.ChatChannelDataNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.ChatChannelDataNotifyOuterClass.ChatChannelDataNotify other = (emu.gingerps.net.proto.ChatChannelDataNotifyOuterClass.ChatChannelDataNotify) obj;
    ...
    public static emu.gingerps.net.proto.ChatChannelDataNotifyOuterClass.ChatChannelDataNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.ChatChannelDataNotifyOuterClass.ChatChannelDataNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.ChatChannelDataNotifyOuterClass.ChatChannelDataNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.ChatChannelDataNotifyOuterClass.ChatChannelDataNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.ChatChannelDataNotifyOuterClass.ChatChannelDataNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.ChatChannelDataNotifyOuterClass.ChatChannelDataNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.ChatChannelDataNotifyOuterClass.ChatChannelDataNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.ChatChannelDataNotifyOuterClass.ChatChannelDataNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.ChatChannelDataNotifyOuterClass.internal_static_ChatChannelDataNotify_descriptor;
      }
      ...
      // Construct using emu.gingerps.net.proto.ChatChannelDataNotifyOuterClass.ChatChannelDataNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.ChatChannelDataNotifyOuterClass.ChatChannelDataNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.ChatChannelDataNotifyOuterClass.ChatChannelDataNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.ChatChannelDataNotifyOuterClass.ChatChannelDataNotify build() {
        emu.gingerps.net.proto.ChatChannelDataNotifyOuterClass.ChatChannelDataNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.ChatChannelDataNotifyOuterClass.ChatChannelDataNotify buildPartial() {
        emu.gingerps.net.proto.ChatChannelDataNotifyOuterClass.ChatChannelDataNotify result = new emu.gingerps.net.proto.ChatChannelDataNotifyOuterClass.ChatChannelDataNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.ChatChannelDataNotifyOuterClass.ChatChannelDataNotify) {
          return mergeFrom((emu.gingerps.net.proto.ChatChannelDataNotifyOuterClass.ChatChannelDataNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.ChatChannelDataNotifyOuterClass.ChatChannelDataNotify other) {
        if (other == emu.gingerps.net.proto.ChatChannelDataNotifyOuterClass.ChatChannelDataNotify.getDefaultInstance()) return this;
        if (channelInfoListBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        emu.gingerps.net.proto.ChatChannelDataNotifyOuterClass.ChatChannelDataNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (emu.gingerps.net.proto.ChatChannelDataNotifyOuterClass.ChatChannelDataNotify) e.getUnfinishedMessage();
      ...
      private void ensureChannelInfoListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          channelInfoList_ = new java.util.ArrayList<emu.gingerps.net.proto.ChatChannelInfoOuterClass.ChatChannelInfo>(channelInfoList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.ChatChannelInfoOuterClass.ChatChannelInfo, emu.gingerps.net.proto.ChatChannelInfoOuterClass.ChatChannelInfo.Builder, emu.gingerps.net.proto.ChatChannelInfoOuterClass.ChatChannelInfoOrBuilder> channelInfoListBuilder_;
      ...
      public Builder setChannelInfoList(
          int index, emu.gingerps.net.proto.ChatChannelInfoOuterClass.ChatChannelInfo value) {
        if (channelInfoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setChannelInfoList(
          int index, emu.gingerps.net.proto.ChatChannelInfoOuterClass.ChatChannelInfo.Builder builderForValue) {
        if (channelInfoListBuilder_ == null) {
          ensureChannelInfoListIsMutable();
       ...
       * <code>repeated .ChatChannelInfo channel_info_list = 5;</code>
       */
      public Builder addChannelInfoList(emu.gingerps.net.proto.ChatChannelInfoOuterClass.ChatChannelInfo value) {
        if (channelInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addAllChannelInfoList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.ChatChannelInfoOuterClass.ChatChannelInfo> values) {
        if (channelInfoListBuilder_ == null) {
          ensureChannelInfoListIsMutable();
       ...
       * <code>repeated .ChatChannelInfo channel_info_list = 5;</code>
       */
      public emu.gingerps.net.proto.ChatChannelInfoOuterClass.ChatChannelInfo.Builder getChannelInfoListBuilder(
          int index) {
       ...
       * <code>repeated .ChatChannelInfo channel_info_list = 5;</code>
       */
      public emu.gingerps.net.proto.ChatChannelInfoOuterClass.ChatChannelInfo.Builder addChannelInfoListBuilder() {
        return getChannelInfoListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.ChatChannelInfoOuterClass.ChatChannelInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .ChatChannelInfo channel_info_list = 5;</code>
       */
      public emu.gingerps.net.proto.ChatChannelInfoOuterClass.ChatChannelInfo.Builder addChannelInfoListBuilder(
          int index) {
        return getChannelInfoListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.ChatChannelInfoOuterClass.ChatChannelInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .ChatChannelInfo channel_info_list = 5;</code>
       */
      public java.util.List<emu.gingerps.net.proto.ChatChannelInfoOuterClass.ChatChannelInfo.Builder> 
    ...
    private static final emu.gingerps.net.proto.ChatChannelDataNotifyOuterClass.ChatChannelDataNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.ChatChannelDataNotifyOuterClass.ChatChannelDataNotify();
    }

    public static emu.gingerps.net.proto.ChatChannelDataNotifyOuterClass.ChatChannelDataNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "fo\022\024\n\014channel_list\030\003 \003(\rB\030\n\026emu.gingerps" +
