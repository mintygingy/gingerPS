...
public final class ProudSkillChangeNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.ProudSkillChangeNotifyOuterClass.internal_static_ProudSkillChangeNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify.class, emu.gingerps.net.proto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify other = (emu.gingerps.net.proto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify) obj;
    ...
    public static emu.gingerps.net.proto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.ProudSkillChangeNotifyOuterClass.internal_static_ProudSkillChangeNotify_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify build() {
        emu.gingerps.net.proto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify) {
          return mergeFrom((emu.gingerps.net.proto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify other) {
        if (other == emu.gingerps.net.proto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify.getDefaultInstance()) return this;
    ...
    private static final emu.gingerps.net.proto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify();
    }

    public static emu.gingerps.net.proto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify getDefaultInstance() {
