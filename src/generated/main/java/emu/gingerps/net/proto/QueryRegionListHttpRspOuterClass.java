...
public final class QueryRegionListHttpRspOuterClass {
  ...
  public interface QueryRegionListHttpRspOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfo> 
        getRegionListList();
    /**
     * <code>repeated .RegionSimpleInfo region_list = 2;</code>
     */
    emu.gingerps.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfo getRegionList(int index);
    /**
     * <code>repeated .RegionSimpleInfo region_list = 2;</code>
     */
     ...
     * <code>repeated .RegionSimpleInfo region_list = 2;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfoOrBuilder> 
        getRegionListOrBuilderList();
    /**
     * <code>repeated .RegionSimpleInfo region_list = 2;</code>
     */
    emu.gingerps.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfoOrBuilder getRegionListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.QueryRegionListHttpRspOuterClass.internal_static_QueryRegionListHttpRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp.class, emu.gingerps.net.proto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfo> getRegionListList() {
      return regionList_;
    }
    /**
     * <code>repeated .RegionSimpleInfo region_list = 2;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfoOrBuilder> 
        getRegionListOrBuilderList() {
      return regionList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfo getRegionList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfoOrBuilder getRegionListOrBuilder(
        int index) {
      return regionList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp other = (emu.gingerps.net.proto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp) obj;
    ...
    public static emu.gingerps.net.proto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.QueryRegionListHttpRspOuterClass.internal_static_QueryRegionListHttpRsp_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp getDefaultInstanceForType() {
        return emu.gingerps.net.proto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp build() {
        emu.gingerps.net.proto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp) {
          return mergeFrom((emu.gingerps.net.proto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp other) {
        if (other == emu.gingerps.net.proto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfo, emu.gingerps.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfo.Builder, emu.gingerps.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfoOrBuilder> regionListBuilder_;
      ...
      public Builder setRegionList(
          int index, emu.gingerps.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfo value) {
        if (regionListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setRegionList(
          int index, emu.gingerps.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfo.Builder builderForValue) {
        if (regionListBuilder_ == null) {
          ensureRegionListIsMutable();
       ...
       * <code>repeated .RegionSimpleInfo region_list = 2;</code>
       */
      public Builder addRegionList(emu.gingerps.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfo value) {
        if (regionListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addRegionList(
          emu.gingerps.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfo.Builder builderForValue) {
        if (regionListBuilder_ == null) {
          ensureRegionListIsMutable();
      ...
      public Builder addAllRegionList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfo> values) {
        if (regionListBuilder_ == null) {
          ensureRegionListIsMutable();
       ...
       * <code>repeated .RegionSimpleInfo region_list = 2;</code>
       */
      public emu.gingerps.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfo.Builder getRegionListBuilder(
          int index) {
       ...
       * <code>repeated .RegionSimpleInfo region_list = 2;</code>
       */
      public emu.gingerps.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfo.Builder addRegionListBuilder() {
        return getRegionListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .RegionSimpleInfo region_list = 2;</code>
       */
      public emu.gingerps.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfo.Builder addRegionListBuilder(
          int index) {
        return getRegionListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .RegionSimpleInfo region_list = 2;</code>
       */
      public java.util.List<emu.gingerps.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfo.Builder> 
    ...
    private static final emu.gingerps.net.proto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp();
    }

    public static emu.gingerps.net.proto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\006 \001(\014\022\027\n\017enable_login_pc\030\007 \001(\010B\030\n\026emu.gi" +
      "ngerps.net.protob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.RegionSimpleInfoOuterClass.getDescriptor(),
        });
    internal_static_QueryRegionListHttpRsp_descriptor =
