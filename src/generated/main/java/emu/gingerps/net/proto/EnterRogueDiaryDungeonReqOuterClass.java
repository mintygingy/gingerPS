...
public final class EnterRogueDiaryDungeonReqOuterClass {
  ...
  public interface EnterRogueDiaryDungeonReqOrBuilder extends
     ...
     * <code>repeated .RogueDiaryAvatar chosen_avatar_list = 9;</code>
     */
    emu.gingerps.net.proto.RogueDiaryAvatarOuterClass.RogueDiaryAvatar getChosenAvatarList(int index);
    /**
     * <code>repeated .RogueDiaryAvatar chosen_avatar_list = 9;</code>
     */
     ...
     * <code>repeated .RogueDiaryAvatar chosen_avatar_list = 9;</code>
     */
    emu.gingerps.net.proto.RogueDiaryAvatarOuterClass.RogueDiaryAvatarOrBuilder getChosenAvatarListOrBuilder(
        int index);
  }
  /**
   * <pre>
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.EnterRogueDiaryDungeonReqOuterClass.internal_static_EnterRogueDiaryDungeonReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq.class, emu.gingerps.net.proto.EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.RogueDiaryAvatarOuterClass.RogueDiaryAvatar> getChosenAvatarListList() {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.RogueDiaryAvatarOuterClass.RogueDiaryAvatar getChosenAvatarList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.RogueDiaryAvatarOuterClass.RogueDiaryAvatarOrBuilder getChosenAvatarListOrBuilder(
        int index) {
      return chosenAvatarList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq other = (emu.gingerps.net.proto.EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq) obj;
    ...
    public static emu.gingerps.net.proto.EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq parseFrom(
    ...
    public static emu.gingerps.net.proto.EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq parseFrom(
    ...
    public static emu.gingerps.net.proto.EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.EnterRogueDiaryDungeonReqOuterClass.internal_static_EnterRogueDiaryDungeonReq_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq getDefaultInstanceForType() {
        return emu.gingerps.net.proto.EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq build() {
        emu.gingerps.net.proto.EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq) {
          return mergeFrom((emu.gingerps.net.proto.EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq other) {
        if (other == emu.gingerps.net.proto.EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq.getDefaultInstance()) return this;
      ...
      private void ensureChosenAvatarListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          chosenAvatarList_ = new java.util.ArrayList<emu.gingerps.net.proto.RogueDiaryAvatarOuterClass.RogueDiaryAvatar>(chosenAvatarList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.RogueDiaryAvatarOuterClass.RogueDiaryAvatar, emu.gingerps.net.proto.RogueDiaryAvatarOuterClass.RogueDiaryAvatar.Builder, emu.gingerps.net.proto.RogueDiaryAvatarOuterClass.RogueDiaryAvatarOrBuilder> chosenAvatarListBuilder_;
       ...
       * <code>repeated .RogueDiaryAvatar chosen_avatar_list = 9;</code>
       */
      public Builder addChosenAvatarList(emu.gingerps.net.proto.RogueDiaryAvatarOuterClass.RogueDiaryAvatar value) {
        if (chosenAvatarListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .RogueDiaryAvatar chosen_avatar_list = 9;</code>
       */
      public emu.gingerps.net.proto.RogueDiaryAvatarOuterClass.RogueDiaryAvatar.Builder getChosenAvatarListBuilder(
          int index) {
       ...
       * <code>repeated .RogueDiaryAvatar chosen_avatar_list = 9;</code>
       */
      public emu.gingerps.net.proto.RogueDiaryAvatarOuterClass.RogueDiaryAvatar.Builder addChosenAvatarListBuilder() {
    ...
    private static final emu.gingerps.net.proto.EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq();
    }

    public static emu.gingerps.net.proto.EnterRogueDiaryDungeonReqOuterClass.EnterRogueDiaryDungeonReq getDefaultInstance() {
