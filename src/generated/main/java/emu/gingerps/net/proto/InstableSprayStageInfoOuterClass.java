...
public final class InstableSprayStageInfoOuterClass {
  ...
  public interface InstableSprayStageInfoOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo> 
        getTeamInfoListList();
    /**
     * <code>repeated .InstableSprayTeamInfo team_info_list = 9;</code>
     */
    emu.gingerps.net.proto.InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo getTeamInfoList(int index);
    /**
     * <code>repeated .InstableSprayTeamInfo team_info_list = 9;</code>
     */
     ...
     * <code>repeated .InstableSprayTeamInfo team_info_list = 9;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.InstableSprayTeamInfoOuterClass.InstableSprayTeamInfoOrBuilder> 
        getTeamInfoListOrBuilderList();
    /**
     * <code>repeated .InstableSprayTeamInfo team_info_list = 9;</code>
     */
    emu.gingerps.net.proto.InstableSprayTeamInfoOuterClass.InstableSprayTeamInfoOrBuilder getTeamInfoListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.InstableSprayStageInfoOuterClass.internal_static_InstableSprayStageInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.InstableSprayStageInfoOuterClass.InstableSprayStageInfo.class, emu.gingerps.net.proto.InstableSprayStageInfoOuterClass.InstableSprayStageInfo.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo> getTeamInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.InstableSprayTeamInfoOuterClass.InstableSprayTeamInfoOrBuilder> 
        getTeamInfoListOrBuilderList() {
      return teamInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo getTeamInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.InstableSprayTeamInfoOuterClass.InstableSprayTeamInfoOrBuilder getTeamInfoListOrBuilder(
        int index) {
      return teamInfoList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.InstableSprayStageInfoOuterClass.InstableSprayStageInfo)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.InstableSprayStageInfoOuterClass.InstableSprayStageInfo other = (emu.gingerps.net.proto.InstableSprayStageInfoOuterClass.InstableSprayStageInfo) obj;
    ...
    public static emu.gingerps.net.proto.InstableSprayStageInfoOuterClass.InstableSprayStageInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.InstableSprayStageInfoOuterClass.InstableSprayStageInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.InstableSprayStageInfoOuterClass.InstableSprayStageInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.InstableSprayStageInfoOuterClass.InstableSprayStageInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.InstableSprayStageInfoOuterClass.InstableSprayStageInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.InstableSprayStageInfoOuterClass.InstableSprayStageInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.InstableSprayStageInfoOuterClass.InstableSprayStageInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.InstableSprayStageInfoOuterClass.InstableSprayStageInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.InstableSprayStageInfoOuterClass.internal_static_InstableSprayStageInfo_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.InstableSprayStageInfoOuterClass.InstableSprayStageInfo getDefaultInstanceForType() {
        return emu.gingerps.net.proto.InstableSprayStageInfoOuterClass.InstableSprayStageInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.InstableSprayStageInfoOuterClass.InstableSprayStageInfo build() {
        emu.gingerps.net.proto.InstableSprayStageInfoOuterClass.InstableSprayStageInfo result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.InstableSprayStageInfoOuterClass.InstableSprayStageInfo) {
          return mergeFrom((emu.gingerps.net.proto.InstableSprayStageInfoOuterClass.InstableSprayStageInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.InstableSprayStageInfoOuterClass.InstableSprayStageInfo other) {
        if (other == emu.gingerps.net.proto.InstableSprayStageInfoOuterClass.InstableSprayStageInfo.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo, emu.gingerps.net.proto.InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo.Builder, emu.gingerps.net.proto.InstableSprayTeamInfoOuterClass.InstableSprayTeamInfoOrBuilder> teamInfoListBuilder_;
      ...
      public Builder setTeamInfoList(
          int index, emu.gingerps.net.proto.InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo value) {
        if (teamInfoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setTeamInfoList(
          int index, emu.gingerps.net.proto.InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo.Builder builderForValue) {
        if (teamInfoListBuilder_ == null) {
          ensureTeamInfoListIsMutable();
       ...
       * <code>repeated .InstableSprayTeamInfo team_info_list = 9;</code>
       */
      public Builder addTeamInfoList(emu.gingerps.net.proto.InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo value) {
        if (teamInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addTeamInfoList(
          emu.gingerps.net.proto.InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo.Builder builderForValue) {
        if (teamInfoListBuilder_ == null) {
          ensureTeamInfoListIsMutable();
      ...
      public Builder addAllTeamInfoList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo> values) {
        if (teamInfoListBuilder_ == null) {
          ensureTeamInfoListIsMutable();
       ...
       * <code>repeated .InstableSprayTeamInfo team_info_list = 9;</code>
       */
      public emu.gingerps.net.proto.InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo.Builder getTeamInfoListBuilder(
          int index) {
       ...
       * <code>repeated .InstableSprayTeamInfo team_info_list = 9;</code>
       */
      public emu.gingerps.net.proto.InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo.Builder addTeamInfoListBuilder() {
        return getTeamInfoListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .InstableSprayTeamInfo team_info_list = 9;</code>
       */
      public emu.gingerps.net.proto.InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo.Builder addTeamInfoListBuilder(
          int index) {
        return getTeamInfoListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .InstableSprayTeamInfo team_info_list = 9;</code>
       */
      public java.util.List<emu.gingerps.net.proto.InstableSprayTeamInfoOuterClass.InstableSprayTeamInfo.Builder> 
    ...
    private static final emu.gingerps.net.proto.InstableSprayStageInfoOuterClass.InstableSprayStageInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.InstableSprayStageInfoOuterClass.InstableSprayStageInfo();
    }

    public static emu.gingerps.net.proto.InstableSprayStageInfoOuterClass.InstableSprayStageInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "SprayTeamInfo\022\021\n\tmax_score\030\007 \001(\rB\030\n\026emu." +
      "gingerps.net.protob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.InstableSprayTeamInfoOuterClass.getDescriptor(),
        });
    internal_static_InstableSprayStageInfo_descriptor =
