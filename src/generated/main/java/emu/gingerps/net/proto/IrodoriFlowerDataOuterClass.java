...
public final class IrodoriFlowerDataOuterClass {
  ...
  public interface IrodoriFlowerDataOrBuilder extends
     ...
     * <code>repeated .ItemParam used_flower_list = 8;</code>
     */
    emu.gingerps.net.proto.ItemParamOuterClass.ItemParam getUsedFlowerList(int index);
    /**
     * <code>repeated .ItemParam used_flower_list = 8;</code>
     */
     ...
     * <code>repeated .ItemParam used_flower_list = 8;</code>
     */
    emu.gingerps.net.proto.ItemParamOuterClass.ItemParamOrBuilder getUsedFlowerListOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 66: {
              if (!((mutable_bitField0_ & 0x00000002) != 0)) {
                usedFlowerList_ = new java.util.ArrayList<emu.gingerps.net.proto.ItemParamOuterClass.ItemParam>();
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.gingerps.net.proto.IrodoriFlowerDataOuterClass.internal_static_IrodoriFlowerData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.gingerps.net.proto.IrodoriFlowerDataOuterClass.internal_static_IrodoriFlowerData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.IrodoriFlowerDataOuterClass.IrodoriFlowerData.class, emu.gingerps.net.proto.IrodoriFlowerDataOuterClass.IrodoriFlowerData.Builder.class);
    }
    ...
    private java.util.List<emu.gingerps.net.proto.ItemParamOuterClass.ItemParam> usedFlowerList_;
    /**
     * <code>repeated .ItemParam used_flower_list = 8;</code>
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.ItemParamOuterClass.ItemParam> getUsedFlowerListList() {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.ItemParamOuterClass.ItemParam getUsedFlowerList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.ItemParamOuterClass.ItemParamOrBuilder getUsedFlowerListOrBuilder(
        int index) {
      return usedFlowerList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.IrodoriFlowerDataOuterClass.IrodoriFlowerData)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.IrodoriFlowerDataOuterClass.IrodoriFlowerData other = (emu.gingerps.net.proto.IrodoriFlowerDataOuterClass.IrodoriFlowerData) obj;
    ...
    public static emu.gingerps.net.proto.IrodoriFlowerDataOuterClass.IrodoriFlowerData parseFrom(
    ...
    public static emu.gingerps.net.proto.IrodoriFlowerDataOuterClass.IrodoriFlowerData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.IrodoriFlowerDataOuterClass.IrodoriFlowerData parseFrom(
    ...
    public static emu.gingerps.net.proto.IrodoriFlowerDataOuterClass.IrodoriFlowerData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.IrodoriFlowerDataOuterClass.IrodoriFlowerData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.IrodoriFlowerDataOuterClass.IrodoriFlowerData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.IrodoriFlowerDataOuterClass.IrodoriFlowerData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.IrodoriFlowerDataOuterClass.IrodoriFlowerDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.IrodoriFlowerDataOuterClass.internal_static_IrodoriFlowerData_descriptor;
      }
      ...
      // Construct using emu.gingerps.net.proto.IrodoriFlowerDataOuterClass.IrodoriFlowerData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.IrodoriFlowerDataOuterClass.IrodoriFlowerData getDefaultInstanceForType() {
        return emu.gingerps.net.proto.IrodoriFlowerDataOuterClass.IrodoriFlowerData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.IrodoriFlowerDataOuterClass.IrodoriFlowerData build() {
        emu.gingerps.net.proto.IrodoriFlowerDataOuterClass.IrodoriFlowerData result = buildPartial();
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.IrodoriFlowerDataOuterClass.IrodoriFlowerData buildPartial() {
        emu.gingerps.net.proto.IrodoriFlowerDataOuterClass.IrodoriFlowerData result = new emu.gingerps.net.proto.IrodoriFlowerDataOuterClass.IrodoriFlowerData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.IrodoriFlowerDataOuterClass.IrodoriFlowerData) {
          return mergeFrom((emu.gingerps.net.proto.IrodoriFlowerDataOuterClass.IrodoriFlowerData)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.IrodoriFlowerDataOuterClass.IrodoriFlowerData other) {
        if (other == emu.gingerps.net.proto.IrodoriFlowerDataOuterClass.IrodoriFlowerData.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        emu.gingerps.net.proto.IrodoriFlowerDataOuterClass.IrodoriFlowerData parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (emu.gingerps.net.proto.IrodoriFlowerDataOuterClass.IrodoriFlowerData) e.getUnfinishedMessage();
      ...
      private void ensureUsedFlowerListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          usedFlowerList_ = new java.util.ArrayList<emu.gingerps.net.proto.ItemParamOuterClass.ItemParam>(usedFlowerList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.ItemParamOuterClass.ItemParam, emu.gingerps.net.proto.ItemParamOuterClass.ItemParam.Builder, emu.gingerps.net.proto.ItemParamOuterClass.ItemParamOrBuilder> usedFlowerListBuilder_;
       ...
       * <code>repeated .ItemParam used_flower_list = 8;</code>
       */
      public Builder addUsedFlowerList(emu.gingerps.net.proto.ItemParamOuterClass.ItemParam value) {
        if (usedFlowerListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .ItemParam used_flower_list = 8;</code>
       */
      public emu.gingerps.net.proto.ItemParamOuterClass.ItemParam.Builder getUsedFlowerListBuilder(
          int index) {
       ...
       * <code>repeated .ItemParam used_flower_list = 8;</code>
       */
      public emu.gingerps.net.proto.ItemParamOuterClass.ItemParam.Builder addUsedFlowerListBuilder() {
    ...
    private static final emu.gingerps.net.proto.IrodoriFlowerDataOuterClass.IrodoriFlowerData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.IrodoriFlowerDataOuterClass.IrodoriFlowerData();
    }

    public static emu.gingerps.net.proto.IrodoriFlowerDataOuterClass.IrodoriFlowerData getDefaultInstance() {
