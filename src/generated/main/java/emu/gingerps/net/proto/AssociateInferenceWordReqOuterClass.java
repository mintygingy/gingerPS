...
public final class AssociateInferenceWordReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.AssociateInferenceWordReqOuterClass.internal_static_AssociateInferenceWordReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.AssociateInferenceWordReqOuterClass.AssociateInferenceWordReq.class, emu.gingerps.net.proto.AssociateInferenceWordReqOuterClass.AssociateInferenceWordReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.AssociateInferenceWordReqOuterClass.AssociateInferenceWordReq)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.AssociateInferenceWordReqOuterClass.AssociateInferenceWordReq other = (emu.gingerps.net.proto.AssociateInferenceWordReqOuterClass.AssociateInferenceWordReq) obj;
    ...
    public static emu.gingerps.net.proto.AssociateInferenceWordReqOuterClass.AssociateInferenceWordReq parseFrom(
    ...
    public static emu.gingerps.net.proto.AssociateInferenceWordReqOuterClass.AssociateInferenceWordReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.AssociateInferenceWordReqOuterClass.AssociateInferenceWordReq parseFrom(
    ...
    public static emu.gingerps.net.proto.AssociateInferenceWordReqOuterClass.AssociateInferenceWordReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.AssociateInferenceWordReqOuterClass.AssociateInferenceWordReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.AssociateInferenceWordReqOuterClass.AssociateInferenceWordReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.AssociateInferenceWordReqOuterClass.AssociateInferenceWordReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.AssociateInferenceWordReqOuterClass.AssociateInferenceWordReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.AssociateInferenceWordReqOuterClass.internal_static_AssociateInferenceWordReq_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.AssociateInferenceWordReqOuterClass.AssociateInferenceWordReq getDefaultInstanceForType() {
        return emu.gingerps.net.proto.AssociateInferenceWordReqOuterClass.AssociateInferenceWordReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.AssociateInferenceWordReqOuterClass.AssociateInferenceWordReq build() {
        emu.gingerps.net.proto.AssociateInferenceWordReqOuterClass.AssociateInferenceWordReq result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.AssociateInferenceWordReqOuterClass.AssociateInferenceWordReq) {
          return mergeFrom((emu.gingerps.net.proto.AssociateInferenceWordReqOuterClass.AssociateInferenceWordReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.AssociateInferenceWordReqOuterClass.AssociateInferenceWordReq other) {
        if (other == emu.gingerps.net.proto.AssociateInferenceWordReqOuterClass.AssociateInferenceWordReq.getDefaultInstance()) return this;
    ...
    private static final emu.gingerps.net.proto.AssociateInferenceWordReqOuterClass.AssociateInferenceWordReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.AssociateInferenceWordReqOuterClass.AssociateInferenceWordReq();
    }

    public static emu.gingerps.net.proto.AssociateInferenceWordReqOuterClass.AssociateInferenceWordReq getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "FDGLBLJOKOK\030\004 \001(\rB\030\n\026emu.gingerps.net.pr" +
      "otob\006proto3"
    };
