...
public final class ClientRemoveCombatEndModifierNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.ClientRemoveCombatEndModifierNotifyOuterClass.internal_static_ClientRemoveCombatEndModifierNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.ClientRemoveCombatEndModifierNotifyOuterClass.ClientRemoveCombatEndModifierNotify.class, emu.gingerps.net.proto.ClientRemoveCombatEndModifierNotifyOuterClass.ClientRemoveCombatEndModifierNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.ClientRemoveCombatEndModifierNotifyOuterClass.ClientRemoveCombatEndModifierNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.ClientRemoveCombatEndModifierNotifyOuterClass.ClientRemoveCombatEndModifierNotify other = (emu.gingerps.net.proto.ClientRemoveCombatEndModifierNotifyOuterClass.ClientRemoveCombatEndModifierNotify) obj;
    ...
    public static emu.gingerps.net.proto.ClientRemoveCombatEndModifierNotifyOuterClass.ClientRemoveCombatEndModifierNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.ClientRemoveCombatEndModifierNotifyOuterClass.ClientRemoveCombatEndModifierNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.ClientRemoveCombatEndModifierNotifyOuterClass.ClientRemoveCombatEndModifierNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.ClientRemoveCombatEndModifierNotifyOuterClass.ClientRemoveCombatEndModifierNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.ClientRemoveCombatEndModifierNotifyOuterClass.ClientRemoveCombatEndModifierNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.ClientRemoveCombatEndModifierNotifyOuterClass.ClientRemoveCombatEndModifierNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.ClientRemoveCombatEndModifierNotifyOuterClass.ClientRemoveCombatEndModifierNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.ClientRemoveCombatEndModifierNotifyOuterClass.ClientRemoveCombatEndModifierNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.ClientRemoveCombatEndModifierNotifyOuterClass.internal_static_ClientRemoveCombatEndModifierNotify_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.ClientRemoveCombatEndModifierNotifyOuterClass.ClientRemoveCombatEndModifierNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.ClientRemoveCombatEndModifierNotifyOuterClass.ClientRemoveCombatEndModifierNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.ClientRemoveCombatEndModifierNotifyOuterClass.ClientRemoveCombatEndModifierNotify build() {
        emu.gingerps.net.proto.ClientRemoveCombatEndModifierNotifyOuterClass.ClientRemoveCombatEndModifierNotify result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.ClientRemoveCombatEndModifierNotifyOuterClass.ClientRemoveCombatEndModifierNotify) {
          return mergeFrom((emu.gingerps.net.proto.ClientRemoveCombatEndModifierNotifyOuterClass.ClientRemoveCombatEndModifierNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.ClientRemoveCombatEndModifierNotifyOuterClass.ClientRemoveCombatEndModifierNotify other) {
        if (other == emu.gingerps.net.proto.ClientRemoveCombatEndModifierNotifyOuterClass.ClientRemoveCombatEndModifierNotify.getDefaultInstance()) return this;
    ...
    private static final emu.gingerps.net.proto.ClientRemoveCombatEndModifierNotifyOuterClass.ClientRemoveCombatEndModifierNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.ClientRemoveCombatEndModifierNotifyOuterClass.ClientRemoveCombatEndModifierNotify();
    }

    public static emu.gingerps.net.proto.ClientRemoveCombatEndModifierNotifyOuterClass.ClientRemoveCombatEndModifierNotify getDefaultInstance() {
