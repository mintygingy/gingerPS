...
public final class IrodoriPoetryDataOuterClass {
  ...
  public interface IrodoriPoetryDataOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.IrodoriPoetryThemeDataOuterClass.IrodoriPoetryThemeData> 
        getThemeDataListList();
    /**
     * <code>repeated .IrodoriPoetryThemeData theme_data_list = 2;</code>
     */
    emu.gingerps.net.proto.IrodoriPoetryThemeDataOuterClass.IrodoriPoetryThemeData getThemeDataList(int index);
    /**
     * <code>repeated .IrodoriPoetryThemeData theme_data_list = 2;</code>
     */
     ...
     * <code>repeated .IrodoriPoetryThemeData theme_data_list = 2;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.IrodoriPoetryThemeDataOuterClass.IrodoriPoetryThemeDataOrBuilder> 
        getThemeDataListOrBuilderList();
    /**
     * <code>repeated .IrodoriPoetryThemeData theme_data_list = 2;</code>
     */
    emu.gingerps.net.proto.IrodoriPoetryThemeDataOuterClass.IrodoriPoetryThemeDataOrBuilder getThemeDataListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.IrodoriPoetryDataOuterClass.internal_static_IrodoriPoetryData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.IrodoriPoetryDataOuterClass.IrodoriPoetryData.class, emu.gingerps.net.proto.IrodoriPoetryDataOuterClass.IrodoriPoetryData.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.IrodoriPoetryThemeDataOuterClass.IrodoriPoetryThemeData> getThemeDataListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.IrodoriPoetryThemeDataOuterClass.IrodoriPoetryThemeDataOrBuilder> 
        getThemeDataListOrBuilderList() {
      return themeDataList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.IrodoriPoetryThemeDataOuterClass.IrodoriPoetryThemeData getThemeDataList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.IrodoriPoetryThemeDataOuterClass.IrodoriPoetryThemeDataOrBuilder getThemeDataListOrBuilder(
        int index) {
      return themeDataList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.IrodoriPoetryDataOuterClass.IrodoriPoetryData)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.IrodoriPoetryDataOuterClass.IrodoriPoetryData other = (emu.gingerps.net.proto.IrodoriPoetryDataOuterClass.IrodoriPoetryData) obj;
    ...
    public static emu.gingerps.net.proto.IrodoriPoetryDataOuterClass.IrodoriPoetryData parseFrom(
    ...
    public static emu.gingerps.net.proto.IrodoriPoetryDataOuterClass.IrodoriPoetryData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.IrodoriPoetryDataOuterClass.IrodoriPoetryData parseFrom(
    ...
    public static emu.gingerps.net.proto.IrodoriPoetryDataOuterClass.IrodoriPoetryData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.IrodoriPoetryDataOuterClass.IrodoriPoetryData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.IrodoriPoetryDataOuterClass.IrodoriPoetryData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.IrodoriPoetryDataOuterClass.IrodoriPoetryData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.IrodoriPoetryDataOuterClass.IrodoriPoetryDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.IrodoriPoetryDataOuterClass.internal_static_IrodoriPoetryData_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.IrodoriPoetryDataOuterClass.IrodoriPoetryData getDefaultInstanceForType() {
        return emu.gingerps.net.proto.IrodoriPoetryDataOuterClass.IrodoriPoetryData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.IrodoriPoetryDataOuterClass.IrodoriPoetryData build() {
        emu.gingerps.net.proto.IrodoriPoetryDataOuterClass.IrodoriPoetryData result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.IrodoriPoetryDataOuterClass.IrodoriPoetryData) {
          return mergeFrom((emu.gingerps.net.proto.IrodoriPoetryDataOuterClass.IrodoriPoetryData)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.IrodoriPoetryDataOuterClass.IrodoriPoetryData other) {
        if (other == emu.gingerps.net.proto.IrodoriPoetryDataOuterClass.IrodoriPoetryData.getDefaultInstance()) return this;
        if (themeDataListBuilder_ == null) {
      ...
      private void ensureThemeDataListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          themeDataList_ = new java.util.ArrayList<emu.gingerps.net.proto.IrodoriPoetryThemeDataOuterClass.IrodoriPoetryThemeData>(themeDataList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.IrodoriPoetryThemeDataOuterClass.IrodoriPoetryThemeData, emu.gingerps.net.proto.IrodoriPoetryThemeDataOuterClass.IrodoriPoetryThemeData.Builder, emu.gingerps.net.proto.IrodoriPoetryThemeDataOuterClass.IrodoriPoetryThemeDataOrBuilder> themeDataListBuilder_;
      ...
      public Builder setThemeDataList(
          int index, emu.gingerps.net.proto.IrodoriPoetryThemeDataOuterClass.IrodoriPoetryThemeData value) {
        if (themeDataListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setThemeDataList(
          int index, emu.gingerps.net.proto.IrodoriPoetryThemeDataOuterClass.IrodoriPoetryThemeData.Builder builderForValue) {
        if (themeDataListBuilder_ == null) {
          ensureThemeDataListIsMutable();
       ...
       * <code>repeated .IrodoriPoetryThemeData theme_data_list = 2;</code>
       */
      public Builder addThemeDataList(emu.gingerps.net.proto.IrodoriPoetryThemeDataOuterClass.IrodoriPoetryThemeData value) {
        if (themeDataListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addAllThemeDataList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.IrodoriPoetryThemeDataOuterClass.IrodoriPoetryThemeData> values) {
        if (themeDataListBuilder_ == null) {
          ensureThemeDataListIsMutable();
       ...
       * <code>repeated .IrodoriPoetryThemeData theme_data_list = 2;</code>
       */
      public emu.gingerps.net.proto.IrodoriPoetryThemeDataOuterClass.IrodoriPoetryThemeData.Builder getThemeDataListBuilder(
          int index) {
       ...
       * <code>repeated .IrodoriPoetryThemeData theme_data_list = 2;</code>
       */
      public emu.gingerps.net.proto.IrodoriPoetryThemeDataOuterClass.IrodoriPoetryThemeData.Builder addThemeDataListBuilder() {
        return getThemeDataListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.IrodoriPoetryThemeDataOuterClass.IrodoriPoetryThemeData.getDefaultInstance());
      }
      /**
       * <code>repeated .IrodoriPoetryThemeData theme_data_list = 2;</code>
       */
      public emu.gingerps.net.proto.IrodoriPoetryThemeDataOuterClass.IrodoriPoetryThemeData.Builder addThemeDataListBuilder(
          int index) {
        return getThemeDataListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.IrodoriPoetryThemeDataOuterClass.IrodoriPoetryThemeData.getDefaultInstance());
      }
      /**
       * <code>repeated .IrodoriPoetryThemeData theme_data_list = 2;</code>
       */
      public java.util.List<emu.gingerps.net.proto.IrodoriPoetryThemeDataOuterClass.IrodoriPoetryThemeData.Builder> 
    ...
    private static final emu.gingerps.net.proto.IrodoriPoetryDataOuterClass.IrodoriPoetryData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.IrodoriPoetryDataOuterClass.IrodoriPoetryData();
    }

    public static emu.gingerps.net.proto.IrodoriPoetryDataOuterClass.IrodoriPoetryData getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "meData\022\024\n\014cur_theme_id\030\014 \001(\rB\030\n\026emu.ging" +
