...
public final class NormalUidOpNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.NormalUidOpNotifyOuterClass.internal_static_NormalUidOpNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.NormalUidOpNotifyOuterClass.NormalUidOpNotify.class, emu.gingerps.net.proto.NormalUidOpNotifyOuterClass.NormalUidOpNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.NormalUidOpNotifyOuterClass.NormalUidOpNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.NormalUidOpNotifyOuterClass.NormalUidOpNotify other = (emu.gingerps.net.proto.NormalUidOpNotifyOuterClass.NormalUidOpNotify) obj;
    ...
    public static emu.gingerps.net.proto.NormalUidOpNotifyOuterClass.NormalUidOpNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.NormalUidOpNotifyOuterClass.NormalUidOpNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.NormalUidOpNotifyOuterClass.NormalUidOpNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.NormalUidOpNotifyOuterClass.NormalUidOpNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.NormalUidOpNotifyOuterClass.NormalUidOpNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.NormalUidOpNotifyOuterClass.NormalUidOpNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.NormalUidOpNotifyOuterClass.NormalUidOpNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.NormalUidOpNotifyOuterClass.NormalUidOpNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.NormalUidOpNotifyOuterClass.internal_static_NormalUidOpNotify_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.NormalUidOpNotifyOuterClass.NormalUidOpNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.NormalUidOpNotifyOuterClass.NormalUidOpNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.NormalUidOpNotifyOuterClass.NormalUidOpNotify build() {
        emu.gingerps.net.proto.NormalUidOpNotifyOuterClass.NormalUidOpNotify result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.NormalUidOpNotifyOuterClass.NormalUidOpNotify) {
          return mergeFrom((emu.gingerps.net.proto.NormalUidOpNotifyOuterClass.NormalUidOpNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.NormalUidOpNotifyOuterClass.NormalUidOpNotify other) {
        if (other == emu.gingerps.net.proto.NormalUidOpNotifyOuterClass.NormalUidOpNotify.getDefaultInstance()) return this;
    ...
    private static final emu.gingerps.net.proto.NormalUidOpNotifyOuterClass.NormalUidOpNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.NormalUidOpNotifyOuterClass.NormalUidOpNotify();
    }

    public static emu.gingerps.net.proto.NormalUidOpNotifyOuterClass.NormalUidOpNotify getDefaultInstance() {
