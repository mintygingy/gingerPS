...
public final class PlayerCompoundMaterialBoostRspOuterClass {
  ...
  public interface PlayerCompoundMaterialBoostRspOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.CompoundQueueDataOuterClass.CompoundQueueData> 
        getCompoundQueueDataListList();
    /**
     * <code>repeated .CompoundQueueData compound_queue_data_list = 10;</code>
     */
    emu.gingerps.net.proto.CompoundQueueDataOuterClass.CompoundQueueData getCompoundQueueDataList(int index);
    /**
     * <code>repeated .CompoundQueueData compound_queue_data_list = 10;</code>
     */
     ...
     * <code>repeated .CompoundQueueData compound_queue_data_list = 10;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.CompoundQueueDataOuterClass.CompoundQueueDataOrBuilder> 
        getCompoundQueueDataListOrBuilderList();
    /**
     * <code>repeated .CompoundQueueData compound_queue_data_list = 10;</code>
     */
    emu.gingerps.net.proto.CompoundQueueDataOuterClass.CompoundQueueDataOrBuilder getCompoundQueueDataListOrBuilder(
        int index);
     ...
     */
    emu.gingerps.net.proto.CompoundBoostTakeStatusTypeOuterClass.CompoundBoostTakeStatusType getTakeStatus();
     ...
     * <code>repeated .ItemParam take_item_list = 3;</code>
     */
    emu.gingerps.net.proto.ItemParamOuterClass.ItemParam getTakeItemList(int index);
    /**
     * <code>repeated .ItemParam take_item_list = 3;</code>
     */
     ...
     * <code>repeated .ItemParam take_item_list = 3;</code>
     */
    emu.gingerps.net.proto.ItemParamOuterClass.ItemParamOrBuilder getTakeItemListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.PlayerCompoundMaterialBoostRspOuterClass.internal_static_PlayerCompoundMaterialBoostRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.PlayerCompoundMaterialBoostRspOuterClass.PlayerCompoundMaterialBoostRsp.class, emu.gingerps.net.proto.PlayerCompoundMaterialBoostRspOuterClass.PlayerCompoundMaterialBoostRsp.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.CompoundQueueDataOuterClass.CompoundQueueData> getCompoundQueueDataListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.CompoundQueueDataOuterClass.CompoundQueueDataOrBuilder> 
        getCompoundQueueDataListOrBuilderList() {
      return compoundQueueDataList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.CompoundQueueDataOuterClass.CompoundQueueData getCompoundQueueDataList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.CompoundQueueDataOuterClass.CompoundQueueDataOrBuilder getCompoundQueueDataListOrBuilder(
        int index) {
      return compoundQueueDataList_.get(index);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.ItemParamOuterClass.ItemParam> getTakeItemListList() {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.ItemParamOuterClass.ItemParam getTakeItemList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.ItemParamOuterClass.ItemParamOrBuilder getTakeItemListOrBuilder(
        int index) {
      return takeItemList_.get(index);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (takeStatus_ != emu.gingerps.net.proto.CompoundBoostTakeStatusTypeOuterClass.CompoundBoostTakeStatusType.COMPOUND_BOOST_TAKE_STATUS_TYPE_NONE.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.PlayerCompoundMaterialBoostRspOuterClass.PlayerCompoundMaterialBoostRsp)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.PlayerCompoundMaterialBoostRspOuterClass.PlayerCompoundMaterialBoostRsp other = (emu.gingerps.net.proto.PlayerCompoundMaterialBoostRspOuterClass.PlayerCompoundMaterialBoostRsp) obj;
    ...
    public static emu.gingerps.net.proto.PlayerCompoundMaterialBoostRspOuterClass.PlayerCompoundMaterialBoostRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.PlayerCompoundMaterialBoostRspOuterClass.PlayerCompoundMaterialBoostRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.PlayerCompoundMaterialBoostRspOuterClass.PlayerCompoundMaterialBoostRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.PlayerCompoundMaterialBoostRspOuterClass.PlayerCompoundMaterialBoostRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.PlayerCompoundMaterialBoostRspOuterClass.PlayerCompoundMaterialBoostRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.PlayerCompoundMaterialBoostRspOuterClass.PlayerCompoundMaterialBoostRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.PlayerCompoundMaterialBoostRspOuterClass.PlayerCompoundMaterialBoostRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.PlayerCompoundMaterialBoostRspOuterClass.PlayerCompoundMaterialBoostRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.PlayerCompoundMaterialBoostRspOuterClass.internal_static_PlayerCompoundMaterialBoostRsp_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.PlayerCompoundMaterialBoostRspOuterClass.PlayerCompoundMaterialBoostRsp getDefaultInstanceForType() {
        return emu.gingerps.net.proto.PlayerCompoundMaterialBoostRspOuterClass.PlayerCompoundMaterialBoostRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.PlayerCompoundMaterialBoostRspOuterClass.PlayerCompoundMaterialBoostRsp build() {
        emu.gingerps.net.proto.PlayerCompoundMaterialBoostRspOuterClass.PlayerCompoundMaterialBoostRsp result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.PlayerCompoundMaterialBoostRspOuterClass.PlayerCompoundMaterialBoostRsp) {
          return mergeFrom((emu.gingerps.net.proto.PlayerCompoundMaterialBoostRspOuterClass.PlayerCompoundMaterialBoostRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.PlayerCompoundMaterialBoostRspOuterClass.PlayerCompoundMaterialBoostRsp other) {
        if (other == emu.gingerps.net.proto.PlayerCompoundMaterialBoostRspOuterClass.PlayerCompoundMaterialBoostRsp.getDefaultInstance()) return this;
        if (compoundQueueDataListBuilder_ == null) {
      ...
      private void ensureCompoundQueueDataListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          compoundQueueDataList_ = new java.util.ArrayList<emu.gingerps.net.proto.CompoundQueueDataOuterClass.CompoundQueueData>(compoundQueueDataList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.CompoundQueueDataOuterClass.CompoundQueueData, emu.gingerps.net.proto.CompoundQueueDataOuterClass.CompoundQueueData.Builder, emu.gingerps.net.proto.CompoundQueueDataOuterClass.CompoundQueueDataOrBuilder> compoundQueueDataListBuilder_;
      ...
      public Builder setCompoundQueueDataList(
          int index, emu.gingerps.net.proto.CompoundQueueDataOuterClass.CompoundQueueData value) {
        if (compoundQueueDataListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setCompoundQueueDataList(
          int index, emu.gingerps.net.proto.CompoundQueueDataOuterClass.CompoundQueueData.Builder builderForValue) {
        if (compoundQueueDataListBuilder_ == null) {
          ensureCompoundQueueDataListIsMutable();
       ...
       * <code>repeated .CompoundQueueData compound_queue_data_list = 10;</code>
       */
      public Builder addCompoundQueueDataList(emu.gingerps.net.proto.CompoundQueueDataOuterClass.CompoundQueueData value) {
        if (compoundQueueDataListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addAllCompoundQueueDataList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.CompoundQueueDataOuterClass.CompoundQueueData> values) {
        if (compoundQueueDataListBuilder_ == null) {
          ensureCompoundQueueDataListIsMutable();
       ...
       * <code>repeated .CompoundQueueData compound_queue_data_list = 10;</code>
       */
      public emu.gingerps.net.proto.CompoundQueueDataOuterClass.CompoundQueueData.Builder getCompoundQueueDataListBuilder(
          int index) {
       ...
       * <code>repeated .CompoundQueueData compound_queue_data_list = 10;</code>
       */
      public emu.gingerps.net.proto.CompoundQueueDataOuterClass.CompoundQueueData.Builder addCompoundQueueDataListBuilder() {
        return getCompoundQueueDataListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.CompoundQueueDataOuterClass.CompoundQueueData.getDefaultInstance());
      }
      /**
       * <code>repeated .CompoundQueueData compound_queue_data_list = 10;</code>
       */
      public emu.gingerps.net.proto.CompoundQueueDataOuterClass.CompoundQueueData.Builder addCompoundQueueDataListBuilder(
          int index) {
        return getCompoundQueueDataListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.CompoundQueueDataOuterClass.CompoundQueueData.getDefaultInstance());
      }
      /**
       * <code>repeated .CompoundQueueData compound_queue_data_list = 10;</code>
       */
      public java.util.List<emu.gingerps.net.proto.CompoundQueueDataOuterClass.CompoundQueueData.Builder> 
       ...
       * @return This builder for chaining.
       */
      public Builder setTakeStatus(emu.gingerps.net.proto.CompoundBoostTakeStatusTypeOuterClass.CompoundBoostTakeStatusType value) {
        if (value == null) {
          throw new NullPointerException();
        }
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.ItemParamOuterClass.ItemParam, emu.gingerps.net.proto.ItemParamOuterClass.ItemParam.Builder, emu.gingerps.net.proto.ItemParamOuterClass.ItemParamOrBuilder> takeItemListBuilder_;
       ...
       * <code>repeated .ItemParam take_item_list = 3;</code>
       */
      public Builder addTakeItemList(emu.gingerps.net.proto.ItemParamOuterClass.ItemParam value) {
        if (takeItemListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .ItemParam take_item_list = 3;</code>
       */
      public emu.gingerps.net.proto.ItemParamOuterClass.ItemParam.Builder getTakeItemListBuilder(
          int index) {
       ...
       * <code>repeated .ItemParam take_item_list = 3;</code>
       */
      public emu.gingerps.net.proto.ItemParamOuterClass.ItemParam.Builder addTakeItemListBuilder() {
    ...
    private static final emu.gingerps.net.proto.PlayerCompoundMaterialBoostRspOuterClass.PlayerCompoundMaterialBoostRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.PlayerCompoundMaterialBoostRspOuterClass.PlayerCompoundMaterialBoostRsp();
    }

    public static emu.gingerps.net.proto.PlayerCompoundMaterialBoostRspOuterClass.PlayerCompoundMaterialBoostRsp getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.CompoundBoostTakeStatusTypeOuterClass.getDescriptor(),
