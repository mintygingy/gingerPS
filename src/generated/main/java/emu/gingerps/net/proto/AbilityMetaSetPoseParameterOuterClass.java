...
public final class AbilityMetaSetPoseParameterOuterClass {
  ...
  public interface AbilityMetaSetPoseParameterOrBuilder extends
     ...
     * @return The value.
     */
    emu.gingerps.net.proto.AnimatorParameterValueInfoPairOuterClass.AnimatorParameterValueInfoPair getValue();
    /**
     * <code>.AnimatorParameterValueInfoPair value = 7;</code>
     */
    emu.gingerps.net.proto.AnimatorParameterValueInfoPairOuterClass.AnimatorParameterValueInfoPairOrBuilder getValueOrBuilder();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.AbilityMetaSetPoseParameterOuterClass.internal_static_AbilityMetaSetPoseParameter_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.AbilityMetaSetPoseParameterOuterClass.AbilityMetaSetPoseParameter.class, emu.gingerps.net.proto.AbilityMetaSetPoseParameterOuterClass.AbilityMetaSetPoseParameter.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.AnimatorParameterValueInfoPairOuterClass.AnimatorParameterValueInfoPair getValue() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.AbilityMetaSetPoseParameterOuterClass.AbilityMetaSetPoseParameter)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.AbilityMetaSetPoseParameterOuterClass.AbilityMetaSetPoseParameter other = (emu.gingerps.net.proto.AbilityMetaSetPoseParameterOuterClass.AbilityMetaSetPoseParameter) obj;
    ...
    public static emu.gingerps.net.proto.AbilityMetaSetPoseParameterOuterClass.AbilityMetaSetPoseParameter parseFrom(
    ...
    public static emu.gingerps.net.proto.AbilityMetaSetPoseParameterOuterClass.AbilityMetaSetPoseParameter parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.AbilityMetaSetPoseParameterOuterClass.AbilityMetaSetPoseParameter parseFrom(
    ...
    public static emu.gingerps.net.proto.AbilityMetaSetPoseParameterOuterClass.AbilityMetaSetPoseParameter parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.AbilityMetaSetPoseParameterOuterClass.AbilityMetaSetPoseParameter parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.AbilityMetaSetPoseParameterOuterClass.AbilityMetaSetPoseParameter parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.AbilityMetaSetPoseParameterOuterClass.AbilityMetaSetPoseParameter prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.AbilityMetaSetPoseParameterOuterClass.AbilityMetaSetPoseParameterOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.AbilityMetaSetPoseParameterOuterClass.internal_static_AbilityMetaSetPoseParameter_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.AbilityMetaSetPoseParameterOuterClass.AbilityMetaSetPoseParameter getDefaultInstanceForType() {
        return emu.gingerps.net.proto.AbilityMetaSetPoseParameterOuterClass.AbilityMetaSetPoseParameter.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.AbilityMetaSetPoseParameterOuterClass.AbilityMetaSetPoseParameter build() {
        emu.gingerps.net.proto.AbilityMetaSetPoseParameterOuterClass.AbilityMetaSetPoseParameter result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.AbilityMetaSetPoseParameterOuterClass.AbilityMetaSetPoseParameter) {
          return mergeFrom((emu.gingerps.net.proto.AbilityMetaSetPoseParameterOuterClass.AbilityMetaSetPoseParameter)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.AbilityMetaSetPoseParameterOuterClass.AbilityMetaSetPoseParameter other) {
        if (other == emu.gingerps.net.proto.AbilityMetaSetPoseParameterOuterClass.AbilityMetaSetPoseParameter.getDefaultInstance()) return this;
        if (other.hasValue()) {
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.AnimatorParameterValueInfoPairOuterClass.AnimatorParameterValueInfoPair, emu.gingerps.net.proto.AnimatorParameterValueInfoPairOuterClass.AnimatorParameterValueInfoPair.Builder, emu.gingerps.net.proto.AnimatorParameterValueInfoPairOuterClass.AnimatorParameterValueInfoPairOrBuilder> valueBuilder_;
      /**
       * <code>.AnimatorParameterValueInfoPair value = 7;</code>
       * @return Whether the value field is set.
       */
       ...
       * <code>.AnimatorParameterValueInfoPair value = 7;</code>
       */
      public Builder setValue(emu.gingerps.net.proto.AnimatorParameterValueInfoPairOuterClass.AnimatorParameterValueInfoPair value) {
        if (valueBuilder_ == null) {
          if (value == null) {
      ...
      public emu.gingerps.net.proto.AnimatorParameterValueInfoPairOuterClass.AnimatorParameterValueInfoPairOrBuilder getValueOrBuilder() {
        if (valueBuilder_ != null) {
          ...
          return value_ == null ?
              emu.gingerps.net.proto.AnimatorParameterValueInfoPairOuterClass.AnimatorParameterValueInfoPair.getDefaultInstance() : value_;
        }
      }
      /**
       * <code>.AnimatorParameterValueInfoPair value = 7;</code>
    ...
    private static final emu.gingerps.net.proto.AbilityMetaSetPoseParameterOuterClass.AbilityMetaSetPoseParameter DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.AbilityMetaSetPoseParameterOuterClass.AbilityMetaSetPoseParameter();
    }

    public static emu.gingerps.net.proto.AbilityMetaSetPoseParameterOuterClass.AbilityMetaSetPoseParameter getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\037.AnimatorParameterValueInfoPairB\030\n\026emu." +
