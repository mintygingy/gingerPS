...
public final class SceneEntitiesMovesReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.gingerps.net.proto.SceneEntitiesMovesReqOuterClass.internal_static_SceneEntitiesMovesReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.gingerps.net.proto.SceneEntitiesMovesReqOuterClass.internal_static_SceneEntitiesMovesReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.SceneEntitiesMovesReqOuterClass.SceneEntitiesMovesReq.class, emu.gingerps.net.proto.SceneEntitiesMovesReqOuterClass.SceneEntitiesMovesReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.SceneEntitiesMovesReqOuterClass.SceneEntitiesMovesReq)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.SceneEntitiesMovesReqOuterClass.SceneEntitiesMovesReq other = (emu.gingerps.net.proto.SceneEntitiesMovesReqOuterClass.SceneEntitiesMovesReq) obj;
    ...
    public static emu.gingerps.net.proto.SceneEntitiesMovesReqOuterClass.SceneEntitiesMovesReq parseFrom(
    ...
    public static emu.gingerps.net.proto.SceneEntitiesMovesReqOuterClass.SceneEntitiesMovesReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.SceneEntitiesMovesReqOuterClass.SceneEntitiesMovesReq parseFrom(
    ...
    public static emu.gingerps.net.proto.SceneEntitiesMovesReqOuterClass.SceneEntitiesMovesReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.SceneEntitiesMovesReqOuterClass.SceneEntitiesMovesReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.SceneEntitiesMovesReqOuterClass.SceneEntitiesMovesReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.SceneEntitiesMovesReqOuterClass.SceneEntitiesMovesReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.SceneEntitiesMovesReqOuterClass.SceneEntitiesMovesReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.SceneEntitiesMovesReqOuterClass.internal_static_SceneEntitiesMovesReq_descriptor;
      }
      ...
      // Construct using emu.gingerps.net.proto.SceneEntitiesMovesReqOuterClass.SceneEntitiesMovesReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.SceneEntitiesMovesReqOuterClass.SceneEntitiesMovesReq getDefaultInstanceForType() {
        return emu.gingerps.net.proto.SceneEntitiesMovesReqOuterClass.SceneEntitiesMovesReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.SceneEntitiesMovesReqOuterClass.SceneEntitiesMovesReq build() {
        emu.gingerps.net.proto.SceneEntitiesMovesReqOuterClass.SceneEntitiesMovesReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.SceneEntitiesMovesReqOuterClass.SceneEntitiesMovesReq buildPartial() {
        emu.gingerps.net.proto.SceneEntitiesMovesReqOuterClass.SceneEntitiesMovesReq result = new emu.gingerps.net.proto.SceneEntitiesMovesReqOuterClass.SceneEntitiesMovesReq(this);
      ...
      private void buildPartialRepeatedFields(emu.gingerps.net.proto.SceneEntitiesMovesReqOuterClass.SceneEntitiesMovesReq result) {
        if (entityMoveInfoListBuilder_ == null) {
      ...
      private void buildPartial0(emu.gingerps.net.proto.SceneEntitiesMovesReqOuterClass.SceneEntitiesMovesReq result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.SceneEntitiesMovesReqOuterClass.SceneEntitiesMovesReq) {
          return mergeFrom((emu.gingerps.net.proto.SceneEntitiesMovesReqOuterClass.SceneEntitiesMovesReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.SceneEntitiesMovesReqOuterClass.SceneEntitiesMovesReq other) {
        if (other == emu.gingerps.net.proto.SceneEntitiesMovesReqOuterClass.SceneEntitiesMovesReq.getDefaultInstance()) return this;
        if (entityMoveInfoListBuilder_ == null) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 90: {
                emu.gingerps.net.proto.EntityMoveInfoOuterClass.EntityMoveInfo m =
                    input.readMessage(
                        emu.gingerps.net.proto.EntityMoveInfoOuterClass.EntityMoveInfo.parser(),
                        extensionRegistry);
                if (entityMoveInfoListBuilder_ == null) {
                  ensureEntityMoveInfoListIsMutable();
    ...
    private static final emu.gingerps.net.proto.SceneEntitiesMovesReqOuterClass.SceneEntitiesMovesReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.SceneEntitiesMovesReqOuterClass.SceneEntitiesMovesReq();
    }

    public static emu.gingerps.net.proto.SceneEntitiesMovesReqOuterClass.SceneEntitiesMovesReq getDefaultInstance() {
