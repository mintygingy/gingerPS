...
public final class PlayerEnterDungeonReqOuterClass {
  ...
  public interface PlayerEnterDungeonReqOrBuilder extends
     ...
     */
    emu.gingerps.net.proto.DungeonEnterPosInfoOuterClass.DungeonEnterPosInfo getEnterPosInfo();
    /**
     * <code>.DungeonEnterPosInfo enter_pos_info = 9;</code>
     */
    emu.gingerps.net.proto.DungeonEnterPosInfoOuterClass.DungeonEnterPosInfoOrBuilder getEnterPosInfoOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.PlayerEnterDungeonReqOuterClass.internal_static_PlayerEnterDungeonReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.PlayerEnterDungeonReqOuterClass.PlayerEnterDungeonReq.class, emu.gingerps.net.proto.PlayerEnterDungeonReqOuterClass.PlayerEnterDungeonReq.Builder.class);
    }
    ...
    private emu.gingerps.net.proto.DungeonEnterPosInfoOuterClass.DungeonEnterPosInfo enterPosInfo_;
    /**
     * <code>.DungeonEnterPosInfo enter_pos_info = 9;</code>
     * @return Whether the enterPosInfo field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.DungeonEnterPosInfoOuterClass.DungeonEnterPosInfo getEnterPosInfo() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.PlayerEnterDungeonReqOuterClass.PlayerEnterDungeonReq)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.PlayerEnterDungeonReqOuterClass.PlayerEnterDungeonReq other = (emu.gingerps.net.proto.PlayerEnterDungeonReqOuterClass.PlayerEnterDungeonReq) obj;
    ...
    public static emu.gingerps.net.proto.PlayerEnterDungeonReqOuterClass.PlayerEnterDungeonReq parseFrom(
    ...
    public static emu.gingerps.net.proto.PlayerEnterDungeonReqOuterClass.PlayerEnterDungeonReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.PlayerEnterDungeonReqOuterClass.PlayerEnterDungeonReq parseFrom(
    ...
    public static emu.gingerps.net.proto.PlayerEnterDungeonReqOuterClass.PlayerEnterDungeonReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.PlayerEnterDungeonReqOuterClass.PlayerEnterDungeonReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.PlayerEnterDungeonReqOuterClass.PlayerEnterDungeonReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.PlayerEnterDungeonReqOuterClass.PlayerEnterDungeonReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.PlayerEnterDungeonReqOuterClass.PlayerEnterDungeonReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.PlayerEnterDungeonReqOuterClass.internal_static_PlayerEnterDungeonReq_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.PlayerEnterDungeonReqOuterClass.PlayerEnterDungeonReq getDefaultInstanceForType() {
        return emu.gingerps.net.proto.PlayerEnterDungeonReqOuterClass.PlayerEnterDungeonReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.PlayerEnterDungeonReqOuterClass.PlayerEnterDungeonReq build() {
        emu.gingerps.net.proto.PlayerEnterDungeonReqOuterClass.PlayerEnterDungeonReq result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.PlayerEnterDungeonReqOuterClass.PlayerEnterDungeonReq) {
          return mergeFrom((emu.gingerps.net.proto.PlayerEnterDungeonReqOuterClass.PlayerEnterDungeonReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.PlayerEnterDungeonReqOuterClass.PlayerEnterDungeonReq other) {
        if (other == emu.gingerps.net.proto.PlayerEnterDungeonReqOuterClass.PlayerEnterDungeonReq.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.DungeonEnterPosInfoOuterClass.DungeonEnterPosInfo, emu.gingerps.net.proto.DungeonEnterPosInfoOuterClass.DungeonEnterPosInfo.Builder, emu.gingerps.net.proto.DungeonEnterPosInfoOuterClass.DungeonEnterPosInfoOrBuilder> enterPosInfoBuilder_;
      /**
       * <code>.DungeonEnterPosInfo enter_pos_info = 9;</code>
       * @return Whether the enterPosInfo field is set.
       */
       ...
       * <code>.DungeonEnterPosInfo enter_pos_info = 9;</code>
       */
      public Builder setEnterPosInfo(emu.gingerps.net.proto.DungeonEnterPosInfoOuterClass.DungeonEnterPosInfo value) {
        if (enterPosInfoBuilder_ == null) {
          if (value == null) {
      ...
      public emu.gingerps.net.proto.DungeonEnterPosInfoOuterClass.DungeonEnterPosInfoOrBuilder getEnterPosInfoOrBuilder() {
        if (enterPosInfoBuilder_ != null) {
          ...
          return enterPosInfo_ == null ?
              emu.gingerps.net.proto.DungeonEnterPosInfoOuterClass.DungeonEnterPosInfo.getDefaultInstance() : enterPosInfo_;
        }
      }
      /**
       * <code>.DungeonEnterPosInfo enter_pos_info = 9;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.DungeonEnterPosInfoOuterClass.DungeonEnterPosInfo, emu.gingerps.net.proto.DungeonEnterPosInfoOuterClass.DungeonEnterPosInfo.Builder, emu.gingerps.net.proto.DungeonEnterPosInfoOuterClass.DungeonEnterPosInfoOrBuilder> 
    ...
    private static final emu.gingerps.net.proto.PlayerEnterDungeonReqOuterClass.PlayerEnterDungeonReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.PlayerEnterDungeonReqOuterClass.PlayerEnterDungeonReq();
    }

    public static emu.gingerps.net.proto.PlayerEnterDungeonReqOuterClass.PlayerEnterDungeonReq getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.DungeonEnterPosInfoOuterClass.getDescriptor(),
        });
    internal_static_PlayerEnterDungeonReq_descriptor =
