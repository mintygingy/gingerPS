...
public final class HuntingRevealFinalNotifyOuterClass {
  ...
  public interface HuntingRevealFinalNotifyOrBuilder extends
     ...
     */
    emu.gingerps.net.proto.VectorOuterClass.Vector getFinalPosition();
    /**
     * <code>.Vector final_position = 3;</code>
     */
    emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder getFinalPositionOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 26: {
              ...
              finalPosition_ = input.readMessage(emu.gingerps.net.proto.VectorOuterClass.Vector.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.gingerps.net.proto.HuntingRevealFinalNotifyOuterClass.internal_static_HuntingRevealFinalNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.gingerps.net.proto.HuntingRevealFinalNotifyOuterClass.internal_static_HuntingRevealFinalNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify.class, emu.gingerps.net.proto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify.Builder.class);
    }

    public static final int FINAL_POSITION_FIELD_NUMBER = 3;
    private emu.gingerps.net.proto.VectorOuterClass.Vector finalPosition_;
    /**
     * <code>.Vector final_position = 3;</code>
     * @return Whether the finalPosition field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.VectorOuterClass.Vector getFinalPosition() {
      return finalPosition_ == null ? emu.gingerps.net.proto.VectorOuterClass.Vector.getDefaultInstance() : finalPosition_;
    }
    /**
     * <code>.Vector final_position = 3;</code>
     */
    @java.lang.Override
    public emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder getFinalPositionOrBuilder() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify other = (emu.gingerps.net.proto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify) obj;
    ...
    public static emu.gingerps.net.proto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.HuntingRevealFinalNotifyOuterClass.internal_static_HuntingRevealFinalNotify_descriptor;
      }
      ...
      // Construct using emu.gingerps.net.proto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify build() {
        emu.gingerps.net.proto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify buildPartial() {
        emu.gingerps.net.proto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify result = new emu.gingerps.net.proto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify(this);
        if (finalPositionBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify) {
          return mergeFrom((emu.gingerps.net.proto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify other) {
        if (other == emu.gingerps.net.proto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        emu.gingerps.net.proto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (emu.gingerps.net.proto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify) e.getUnfinishedMessage();
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.VectorOuterClass.Vector, emu.gingerps.net.proto.VectorOuterClass.Vector.Builder, emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder> finalPositionBuilder_;
      /**
       * <code>.Vector final_position = 3;</code>
       * @return Whether the finalPosition field is set.
       */
       ...
       * <code>.Vector final_position = 3;</code>
       */
      public Builder setFinalPosition(emu.gingerps.net.proto.VectorOuterClass.Vector value) {
        if (finalPositionBuilder_ == null) {
          if (value == null) {
       ...
       * <code>.Vector final_position = 3;</code>
       */
      public Builder mergeFinalPosition(emu.gingerps.net.proto.VectorOuterClass.Vector value) {
        if (finalPositionBuilder_ == null) {
          if (finalPosition_ != null) {
            finalPosition_ =
              emu.gingerps.net.proto.VectorOuterClass.Vector.newBuilder(finalPosition_).mergeFrom(value).buildPartial();
          } else {
            finalPosition_ = value;
          }
          onChanged();
       ...
       * <code>.Vector final_position = 3;</code>
       */
      public emu.gingerps.net.proto.VectorOuterClass.Vector.Builder getFinalPositionBuilder() {
      ...
      public emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder getFinalPositionOrBuilder() {
        if (finalPositionBuilder_ != null) {
          ...
          return finalPosition_ == null ?
              emu.gingerps.net.proto.VectorOuterClass.Vector.getDefaultInstance() : finalPosition_;
        }
      }
      /**
       * <code>.Vector final_position = 3;</code>
    ...
    private static final emu.gingerps.net.proto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify();
    }

    public static emu.gingerps.net.proto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ir\022\031\n\021finished_group_id\030\016 \001(\rB\030\n\026emu.gin" +
