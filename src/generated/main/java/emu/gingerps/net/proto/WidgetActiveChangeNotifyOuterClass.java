...
public final class WidgetActiveChangeNotifyOuterClass {
  ...
  public interface WidgetActiveChangeNotifyOrBuilder extends
     ...
     * <code>repeated .WidgetSlotData widget_data_list = 15;</code>
     */
    emu.gingerps.net.proto.WidgetSlotDataOuterClass.WidgetSlotData getWidgetDataList(int index);
    /**
     * <code>repeated .WidgetSlotData widget_data_list = 15;</code>
     */
     ...
     * <code>repeated .WidgetSlotData widget_data_list = 15;</code>
     */
    emu.gingerps.net.proto.WidgetSlotDataOuterClass.WidgetSlotDataOrBuilder getWidgetDataListOrBuilder(
        int index);
  }
  /**
   * <pre>
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.WidgetActiveChangeNotifyOuterClass.internal_static_WidgetActiveChangeNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify.class, emu.gingerps.net.proto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.WidgetSlotDataOuterClass.WidgetSlotData> getWidgetDataListList() {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.WidgetSlotDataOuterClass.WidgetSlotData getWidgetDataList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.WidgetSlotDataOuterClass.WidgetSlotDataOrBuilder getWidgetDataListOrBuilder(
        int index) {
      return widgetDataList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify other = (emu.gingerps.net.proto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify) obj;
    ...
    public static emu.gingerps.net.proto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.WidgetActiveChangeNotifyOuterClass.internal_static_WidgetActiveChangeNotify_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify build() {
        emu.gingerps.net.proto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify) {
          return mergeFrom((emu.gingerps.net.proto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify other) {
        if (other == emu.gingerps.net.proto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify.getDefaultInstance()) return this;
        if (widgetDataListBuilder_ == null) {
      ...
      private void ensureWidgetDataListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          widgetDataList_ = new java.util.ArrayList<emu.gingerps.net.proto.WidgetSlotDataOuterClass.WidgetSlotData>(widgetDataList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.WidgetSlotDataOuterClass.WidgetSlotData, emu.gingerps.net.proto.WidgetSlotDataOuterClass.WidgetSlotData.Builder, emu.gingerps.net.proto.WidgetSlotDataOuterClass.WidgetSlotDataOrBuilder> widgetDataListBuilder_;
       ...
       * <code>repeated .WidgetSlotData widget_data_list = 15;</code>
       */
      public Builder addWidgetDataList(emu.gingerps.net.proto.WidgetSlotDataOuterClass.WidgetSlotData value) {
        if (widgetDataListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .WidgetSlotData widget_data_list = 15;</code>
       */
      public emu.gingerps.net.proto.WidgetSlotDataOuterClass.WidgetSlotData.Builder getWidgetDataListBuilder(
          int index) {
       ...
       * <code>repeated .WidgetSlotData widget_data_list = 15;</code>
       */
      public emu.gingerps.net.proto.WidgetSlotDataOuterClass.WidgetSlotData.Builder addWidgetDataListBuilder() {
    ...
    private static final emu.gingerps.net.proto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify();
    }

    public static emu.gingerps.net.proto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify getDefaultInstance() {
