...
public final class SumoTeamDataOuterClass {
  ...
  public interface SumoTeamDataOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.SumoAvatarInfoOuterClass.SumoAvatarInfo> 
        getAvatarInfoListList();
    /**
     * <code>repeated .SumoAvatarInfo avatar_info_list = 4;</code>
     */
    emu.gingerps.net.proto.SumoAvatarInfoOuterClass.SumoAvatarInfo getAvatarInfoList(int index);
    /**
     * <code>repeated .SumoAvatarInfo avatar_info_list = 4;</code>
     */
     ...
     * <code>repeated .SumoAvatarInfo avatar_info_list = 4;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.SumoAvatarInfoOuterClass.SumoAvatarInfoOrBuilder> 
        getAvatarInfoListOrBuilderList();
    /**
     * <code>repeated .SumoAvatarInfo avatar_info_list = 4;</code>
     */
    emu.gingerps.net.proto.SumoAvatarInfoOuterClass.SumoAvatarInfoOrBuilder getAvatarInfoListOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.SumoTeamDataOuterClass.internal_static_SumoTeamData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.SumoTeamDataOuterClass.SumoTeamData.class, emu.gingerps.net.proto.SumoTeamDataOuterClass.SumoTeamData.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.SumoAvatarInfoOuterClass.SumoAvatarInfo> getAvatarInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.SumoAvatarInfoOuterClass.SumoAvatarInfoOrBuilder> 
        getAvatarInfoListOrBuilderList() {
      return avatarInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.SumoAvatarInfoOuterClass.SumoAvatarInfo getAvatarInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.SumoAvatarInfoOuterClass.SumoAvatarInfoOrBuilder getAvatarInfoListOrBuilder(
        int index) {
      return avatarInfoList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.SumoTeamDataOuterClass.SumoTeamData)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.SumoTeamDataOuterClass.SumoTeamData other = (emu.gingerps.net.proto.SumoTeamDataOuterClass.SumoTeamData) obj;
    ...
    public static emu.gingerps.net.proto.SumoTeamDataOuterClass.SumoTeamData parseFrom(
    ...
    public static emu.gingerps.net.proto.SumoTeamDataOuterClass.SumoTeamData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.SumoTeamDataOuterClass.SumoTeamData parseFrom(
    ...
    public static emu.gingerps.net.proto.SumoTeamDataOuterClass.SumoTeamData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.SumoTeamDataOuterClass.SumoTeamData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.SumoTeamDataOuterClass.SumoTeamData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.SumoTeamDataOuterClass.SumoTeamData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.SumoTeamDataOuterClass.SumoTeamDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.SumoTeamDataOuterClass.internal_static_SumoTeamData_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.SumoTeamDataOuterClass.SumoTeamData getDefaultInstanceForType() {
        return emu.gingerps.net.proto.SumoTeamDataOuterClass.SumoTeamData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.SumoTeamDataOuterClass.SumoTeamData build() {
        emu.gingerps.net.proto.SumoTeamDataOuterClass.SumoTeamData result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.SumoTeamDataOuterClass.SumoTeamData) {
          return mergeFrom((emu.gingerps.net.proto.SumoTeamDataOuterClass.SumoTeamData)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.SumoTeamDataOuterClass.SumoTeamData other) {
        if (other == emu.gingerps.net.proto.SumoTeamDataOuterClass.SumoTeamData.getDefaultInstance()) return this;
      ...
      private void ensureAvatarInfoListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          avatarInfoList_ = new java.util.ArrayList<emu.gingerps.net.proto.SumoAvatarInfoOuterClass.SumoAvatarInfo>(avatarInfoList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.SumoAvatarInfoOuterClass.SumoAvatarInfo, emu.gingerps.net.proto.SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder, emu.gingerps.net.proto.SumoAvatarInfoOuterClass.SumoAvatarInfoOrBuilder> avatarInfoListBuilder_;
      ...
      public Builder setAvatarInfoList(
          int index, emu.gingerps.net.proto.SumoAvatarInfoOuterClass.SumoAvatarInfo value) {
        if (avatarInfoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setAvatarInfoList(
          int index, emu.gingerps.net.proto.SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder builderForValue) {
        if (avatarInfoListBuilder_ == null) {
          ensureAvatarInfoListIsMutable();
       ...
       * <code>repeated .SumoAvatarInfo avatar_info_list = 4;</code>
       */
      public Builder addAvatarInfoList(emu.gingerps.net.proto.SumoAvatarInfoOuterClass.SumoAvatarInfo value) {
        if (avatarInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addAvatarInfoList(
          emu.gingerps.net.proto.SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder builderForValue) {
        if (avatarInfoListBuilder_ == null) {
          ensureAvatarInfoListIsMutable();
      ...
      public Builder addAllAvatarInfoList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.SumoAvatarInfoOuterClass.SumoAvatarInfo> values) {
        if (avatarInfoListBuilder_ == null) {
          ensureAvatarInfoListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .SumoAvatarInfo avatar_info_list = 4;</code>
       */
      public emu.gingerps.net.proto.SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder getAvatarInfoListBuilder(
          int index) {
       ...
       * <code>repeated .SumoAvatarInfo avatar_info_list = 4;</code>
       */
      public emu.gingerps.net.proto.SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder addAvatarInfoListBuilder() {
        return getAvatarInfoListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.SumoAvatarInfoOuterClass.SumoAvatarInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .SumoAvatarInfo avatar_info_list = 4;</code>
       */
      public emu.gingerps.net.proto.SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder addAvatarInfoListBuilder(
          int index) {
        return getAvatarInfoListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.SumoAvatarInfoOuterClass.SumoAvatarInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .SumoAvatarInfo avatar_info_list = 4;</code>
       */
      public java.util.List<emu.gingerps.net.proto.SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder> 
           getAvatarInfoListBuilderList() {
        return getAvatarInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.SumoAvatarInfoOuterClass.SumoAvatarInfo, emu.gingerps.net.proto.SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder, emu.gingerps.net.proto.SumoAvatarInfoOuterClass.SumoAvatarInfoOrBuilder> 
          getAvatarInfoListFieldBuilder() {
        if (avatarInfoListBuilder_ == null) {
    ...
    private static final emu.gingerps.net.proto.SumoTeamDataOuterClass.SumoTeamData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.SumoTeamDataOuterClass.SumoTeamData();
    }

    public static emu.gingerps.net.proto.SumoTeamDataOuterClass.SumoTeamData getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.SumoAvatarInfoOuterClass.getDescriptor(),
        });
    internal_static_SumoTeamData_descriptor =
