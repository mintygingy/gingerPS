...
public final class WorldOwnerBlossomScheduleInfoNotifyOuterClass {
  ...
  public interface WorldOwnerBlossomScheduleInfoNotifyOrBuilder extends
     ...
     */
    emu.gingerps.net.proto.BlossomScheduleInfoOuterClass.BlossomScheduleInfo getScheduleInfo();
    /**
     * <code>.BlossomScheduleInfo schedule_info = 10;</code>
     */
    emu.gingerps.net.proto.BlossomScheduleInfoOuterClass.BlossomScheduleInfoOrBuilder getScheduleInfoOrBuilder();
  }
  /**
   * <pre>
   * enum CmdId {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.WorldOwnerBlossomScheduleInfoNotifyOuterClass.internal_static_WorldOwnerBlossomScheduleInfoNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.WorldOwnerBlossomScheduleInfoNotifyOuterClass.WorldOwnerBlossomScheduleInfoNotify.class, emu.gingerps.net.proto.WorldOwnerBlossomScheduleInfoNotifyOuterClass.WorldOwnerBlossomScheduleInfoNotify.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.BlossomScheduleInfoOuterClass.BlossomScheduleInfo getScheduleInfo() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.WorldOwnerBlossomScheduleInfoNotifyOuterClass.WorldOwnerBlossomScheduleInfoNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.WorldOwnerBlossomScheduleInfoNotifyOuterClass.WorldOwnerBlossomScheduleInfoNotify other = (emu.gingerps.net.proto.WorldOwnerBlossomScheduleInfoNotifyOuterClass.WorldOwnerBlossomScheduleInfoNotify) obj;
    ...
    public static emu.gingerps.net.proto.WorldOwnerBlossomScheduleInfoNotifyOuterClass.WorldOwnerBlossomScheduleInfoNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.WorldOwnerBlossomScheduleInfoNotifyOuterClass.WorldOwnerBlossomScheduleInfoNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.WorldOwnerBlossomScheduleInfoNotifyOuterClass.WorldOwnerBlossomScheduleInfoNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.WorldOwnerBlossomScheduleInfoNotifyOuterClass.WorldOwnerBlossomScheduleInfoNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.WorldOwnerBlossomScheduleInfoNotifyOuterClass.WorldOwnerBlossomScheduleInfoNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.WorldOwnerBlossomScheduleInfoNotifyOuterClass.WorldOwnerBlossomScheduleInfoNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.WorldOwnerBlossomScheduleInfoNotifyOuterClass.WorldOwnerBlossomScheduleInfoNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.WorldOwnerBlossomScheduleInfoNotifyOuterClass.WorldOwnerBlossomScheduleInfoNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.WorldOwnerBlossomScheduleInfoNotifyOuterClass.internal_static_WorldOwnerBlossomScheduleInfoNotify_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.WorldOwnerBlossomScheduleInfoNotifyOuterClass.WorldOwnerBlossomScheduleInfoNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.WorldOwnerBlossomScheduleInfoNotifyOuterClass.WorldOwnerBlossomScheduleInfoNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.WorldOwnerBlossomScheduleInfoNotifyOuterClass.WorldOwnerBlossomScheduleInfoNotify build() {
        emu.gingerps.net.proto.WorldOwnerBlossomScheduleInfoNotifyOuterClass.WorldOwnerBlossomScheduleInfoNotify result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.WorldOwnerBlossomScheduleInfoNotifyOuterClass.WorldOwnerBlossomScheduleInfoNotify) {
          return mergeFrom((emu.gingerps.net.proto.WorldOwnerBlossomScheduleInfoNotifyOuterClass.WorldOwnerBlossomScheduleInfoNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.WorldOwnerBlossomScheduleInfoNotifyOuterClass.WorldOwnerBlossomScheduleInfoNotify other) {
        if (other == emu.gingerps.net.proto.WorldOwnerBlossomScheduleInfoNotifyOuterClass.WorldOwnerBlossomScheduleInfoNotify.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.BlossomScheduleInfoOuterClass.BlossomScheduleInfo, emu.gingerps.net.proto.BlossomScheduleInfoOuterClass.BlossomScheduleInfo.Builder, emu.gingerps.net.proto.BlossomScheduleInfoOuterClass.BlossomScheduleInfoOrBuilder> scheduleInfoBuilder_;
      /**
       * <code>.BlossomScheduleInfo schedule_info = 10;</code>
       * @return Whether the scheduleInfo field is set.
       */
       ...
       * <code>.BlossomScheduleInfo schedule_info = 10;</code>
       */
      public Builder setScheduleInfo(emu.gingerps.net.proto.BlossomScheduleInfoOuterClass.BlossomScheduleInfo value) {
        if (scheduleInfoBuilder_ == null) {
          if (value == null) {
      ...
      public emu.gingerps.net.proto.BlossomScheduleInfoOuterClass.BlossomScheduleInfoOrBuilder getScheduleInfoOrBuilder() {
        if (scheduleInfoBuilder_ != null) {
          ...
          return scheduleInfo_ == null ?
              emu.gingerps.net.proto.BlossomScheduleInfoOuterClass.BlossomScheduleInfo.getDefaultInstance() : scheduleInfo_;
        }
      }
      /**
       * <code>.BlossomScheduleInfo schedule_info = 10;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.BlossomScheduleInfoOuterClass.BlossomScheduleInfo, emu.gingerps.net.proto.BlossomScheduleInfoOuterClass.BlossomScheduleInfo.Builder, emu.gingerps.net.proto.BlossomScheduleInfoOuterClass.BlossomScheduleInfoOrBuilder> 
    ...
    private static final emu.gingerps.net.proto.WorldOwnerBlossomScheduleInfoNotifyOuterClass.WorldOwnerBlossomScheduleInfoNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.WorldOwnerBlossomScheduleInfoNotifyOuterClass.WorldOwnerBlossomScheduleInfoNotify();
    }

    public static emu.gingerps.net.proto.WorldOwnerBlossomScheduleInfoNotifyOuterClass.WorldOwnerBlossomScheduleInfoNotify getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.BlossomScheduleInfoOuterClass.getDescriptor(),
        });
    internal_static_WorldOwnerBlossomScheduleInfoNotify_descriptor =
