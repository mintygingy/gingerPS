...
public final class ActivityInfoNotifyOuterClass {
  ...
  public interface ActivityInfoNotifyOrBuilder extends
     ...
     */
    emu.gingerps.net.proto.ActivityInfoOuterClass.ActivityInfo getActivityInfo();
    /**
     * <code>.ActivityInfo activity_info = 12;</code>
     */
    emu.gingerps.net.proto.ActivityInfoOuterClass.ActivityInfoOrBuilder getActivityInfoOrBuilder();
  }
  /**
   * <pre>
   * enum CmdId {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.ActivityInfoNotifyOuterClass.internal_static_ActivityInfoNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.ActivityInfoNotifyOuterClass.ActivityInfoNotify.class, emu.gingerps.net.proto.ActivityInfoNotifyOuterClass.ActivityInfoNotify.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.ActivityInfoOuterClass.ActivityInfo getActivityInfo() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.ActivityInfoNotifyOuterClass.ActivityInfoNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.ActivityInfoNotifyOuterClass.ActivityInfoNotify other = (emu.gingerps.net.proto.ActivityInfoNotifyOuterClass.ActivityInfoNotify) obj;
    ...
    public static emu.gingerps.net.proto.ActivityInfoNotifyOuterClass.ActivityInfoNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.ActivityInfoNotifyOuterClass.ActivityInfoNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.ActivityInfoNotifyOuterClass.ActivityInfoNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.ActivityInfoNotifyOuterClass.ActivityInfoNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.ActivityInfoNotifyOuterClass.ActivityInfoNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.ActivityInfoNotifyOuterClass.ActivityInfoNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.ActivityInfoNotifyOuterClass.ActivityInfoNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.ActivityInfoNotifyOuterClass.ActivityInfoNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.ActivityInfoNotifyOuterClass.internal_static_ActivityInfoNotify_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.ActivityInfoNotifyOuterClass.ActivityInfoNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.ActivityInfoNotifyOuterClass.ActivityInfoNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.ActivityInfoNotifyOuterClass.ActivityInfoNotify build() {
        emu.gingerps.net.proto.ActivityInfoNotifyOuterClass.ActivityInfoNotify result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.ActivityInfoNotifyOuterClass.ActivityInfoNotify) {
          return mergeFrom((emu.gingerps.net.proto.ActivityInfoNotifyOuterClass.ActivityInfoNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.ActivityInfoNotifyOuterClass.ActivityInfoNotify other) {
        if (other == emu.gingerps.net.proto.ActivityInfoNotifyOuterClass.ActivityInfoNotify.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.ActivityInfoOuterClass.ActivityInfo, emu.gingerps.net.proto.ActivityInfoOuterClass.ActivityInfo.Builder, emu.gingerps.net.proto.ActivityInfoOuterClass.ActivityInfoOrBuilder> activityInfoBuilder_;
      /**
       * <code>.ActivityInfo activity_info = 12;</code>
       * @return Whether the activityInfo field is set.
       */
       ...
       * <code>.ActivityInfo activity_info = 12;</code>
       */
      public Builder setActivityInfo(emu.gingerps.net.proto.ActivityInfoOuterClass.ActivityInfo value) {
        if (activityInfoBuilder_ == null) {
          if (value == null) {
      ...
      public emu.gingerps.net.proto.ActivityInfoOuterClass.ActivityInfoOrBuilder getActivityInfoOrBuilder() {
        if (activityInfoBuilder_ != null) {
          ...
          return activityInfo_ == null ?
              emu.gingerps.net.proto.ActivityInfoOuterClass.ActivityInfo.getDefaultInstance() : activityInfo_;
        }
      }
      /**
       * <code>.ActivityInfo activity_info = 12;</code>
    ...
    private static final emu.gingerps.net.proto.ActivityInfoNotifyOuterClass.ActivityInfoNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.ActivityInfoNotifyOuterClass.ActivityInfoNotify();
    }

    public static emu.gingerps.net.proto.ActivityInfoNotifyOuterClass.ActivityInfoNotify getDefaultInstance() {
