...
public final class ScenePlayerInfoOuterClass {
  ...
  public interface ScenePlayerInfoOrBuilder extends
     ...
     */
    emu.gingerps.net.proto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo getOnlinePlayerInfo();
    /**
     * <code>.OnlinePlayerInfo online_player_info = 9;</code>
     */
    emu.gingerps.net.proto.OnlinePlayerInfoOuterClass.OnlinePlayerInfoOrBuilder getOnlinePlayerInfoOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.ScenePlayerInfoOuterClass.internal_static_ScenePlayerInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.ScenePlayerInfoOuterClass.ScenePlayerInfo.class, emu.gingerps.net.proto.ScenePlayerInfoOuterClass.ScenePlayerInfo.Builder.class);
    }
    ...
    private emu.gingerps.net.proto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo onlinePlayerInfo_;
    /**
     * <code>.OnlinePlayerInfo online_player_info = 9;</code>
     * @return Whether the onlinePlayerInfo field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo getOnlinePlayerInfo() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.ScenePlayerInfoOuterClass.ScenePlayerInfo)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.ScenePlayerInfoOuterClass.ScenePlayerInfo other = (emu.gingerps.net.proto.ScenePlayerInfoOuterClass.ScenePlayerInfo) obj;
    ...
    public static emu.gingerps.net.proto.ScenePlayerInfoOuterClass.ScenePlayerInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.ScenePlayerInfoOuterClass.ScenePlayerInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.ScenePlayerInfoOuterClass.ScenePlayerInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.ScenePlayerInfoOuterClass.ScenePlayerInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.ScenePlayerInfoOuterClass.ScenePlayerInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.ScenePlayerInfoOuterClass.ScenePlayerInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.ScenePlayerInfoOuterClass.ScenePlayerInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.ScenePlayerInfoOuterClass.ScenePlayerInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.ScenePlayerInfoOuterClass.internal_static_ScenePlayerInfo_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.ScenePlayerInfoOuterClass.ScenePlayerInfo getDefaultInstanceForType() {
        return emu.gingerps.net.proto.ScenePlayerInfoOuterClass.ScenePlayerInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.ScenePlayerInfoOuterClass.ScenePlayerInfo build() {
        emu.gingerps.net.proto.ScenePlayerInfoOuterClass.ScenePlayerInfo result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.ScenePlayerInfoOuterClass.ScenePlayerInfo) {
          return mergeFrom((emu.gingerps.net.proto.ScenePlayerInfoOuterClass.ScenePlayerInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.ScenePlayerInfoOuterClass.ScenePlayerInfo other) {
        if (other == emu.gingerps.net.proto.ScenePlayerInfoOuterClass.ScenePlayerInfo.getDefaultInstance()) return this;
        if (other.getUid() != 0) {
          setUid(other.getUid());
        }
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo, emu.gingerps.net.proto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo.Builder, emu.gingerps.net.proto.OnlinePlayerInfoOuterClass.OnlinePlayerInfoOrBuilder> onlinePlayerInfoBuilder_;
      /**
       * <code>.OnlinePlayerInfo online_player_info = 9;</code>
       * @return Whether the onlinePlayerInfo field is set.
       */
       ...
       * <code>.OnlinePlayerInfo online_player_info = 9;</code>
       */
      public Builder setOnlinePlayerInfo(emu.gingerps.net.proto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo value) {
        if (onlinePlayerInfoBuilder_ == null) {
          if (value == null) {
      ...
      public emu.gingerps.net.proto.OnlinePlayerInfoOuterClass.OnlinePlayerInfoOrBuilder getOnlinePlayerInfoOrBuilder() {
        if (onlinePlayerInfoBuilder_ != null) {
          ...
          return onlinePlayerInfo_ == null ?
              emu.gingerps.net.proto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo.getDefaultInstance() : onlinePlayerInfo_;
        }
      }
      /**
       * <code>.OnlinePlayerInfo online_player_info = 9;</code>
    ...
    private static final emu.gingerps.net.proto.ScenePlayerInfoOuterClass.ScenePlayerInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.ScenePlayerInfoOuterClass.ScenePlayerInfo();
    }

    public static emu.gingerps.net.proto.ScenePlayerInfoOuterClass.ScenePlayerInfo getDefaultInstance() {
