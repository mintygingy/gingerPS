...
public final class SingleStartBrickBreakerReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.SingleStartBrickBreakerReqOuterClass.internal_static_SingleStartBrickBreakerReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.SingleStartBrickBreakerReqOuterClass.SingleStartBrickBreakerReq.class, emu.gingerps.net.proto.SingleStartBrickBreakerReqOuterClass.SingleStartBrickBreakerReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.SingleStartBrickBreakerReqOuterClass.SingleStartBrickBreakerReq)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.SingleStartBrickBreakerReqOuterClass.SingleStartBrickBreakerReq other = (emu.gingerps.net.proto.SingleStartBrickBreakerReqOuterClass.SingleStartBrickBreakerReq) obj;
    ...
    public static emu.gingerps.net.proto.SingleStartBrickBreakerReqOuterClass.SingleStartBrickBreakerReq parseFrom(
    ...
    public static emu.gingerps.net.proto.SingleStartBrickBreakerReqOuterClass.SingleStartBrickBreakerReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.SingleStartBrickBreakerReqOuterClass.SingleStartBrickBreakerReq parseFrom(
    ...
    public static emu.gingerps.net.proto.SingleStartBrickBreakerReqOuterClass.SingleStartBrickBreakerReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.SingleStartBrickBreakerReqOuterClass.SingleStartBrickBreakerReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.SingleStartBrickBreakerReqOuterClass.SingleStartBrickBreakerReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.SingleStartBrickBreakerReqOuterClass.SingleStartBrickBreakerReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.SingleStartBrickBreakerReqOuterClass.SingleStartBrickBreakerReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.SingleStartBrickBreakerReqOuterClass.internal_static_SingleStartBrickBreakerReq_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.SingleStartBrickBreakerReqOuterClass.SingleStartBrickBreakerReq getDefaultInstanceForType() {
        return emu.gingerps.net.proto.SingleStartBrickBreakerReqOuterClass.SingleStartBrickBreakerReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.SingleStartBrickBreakerReqOuterClass.SingleStartBrickBreakerReq build() {
        emu.gingerps.net.proto.SingleStartBrickBreakerReqOuterClass.SingleStartBrickBreakerReq result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.SingleStartBrickBreakerReqOuterClass.SingleStartBrickBreakerReq) {
          return mergeFrom((emu.gingerps.net.proto.SingleStartBrickBreakerReqOuterClass.SingleStartBrickBreakerReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.SingleStartBrickBreakerReqOuterClass.SingleStartBrickBreakerReq other) {
        if (other == emu.gingerps.net.proto.SingleStartBrickBreakerReqOuterClass.SingleStartBrickBreakerReq.getDefaultInstance()) return this;
    ...
    private static final emu.gingerps.net.proto.SingleStartBrickBreakerReqOuterClass.SingleStartBrickBreakerReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.SingleStartBrickBreakerReqOuterClass.SingleStartBrickBreakerReq();
    }

    public static emu.gingerps.net.proto.SingleStartBrickBreakerReqOuterClass.SingleStartBrickBreakerReq getDefaultInstance() {
