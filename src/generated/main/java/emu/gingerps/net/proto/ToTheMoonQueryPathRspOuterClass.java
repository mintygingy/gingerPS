...
public final class ToTheMoonQueryPathRspOuterClass {
  ...
  public interface ToTheMoonQueryPathRspOrBuilder extends
     ...
     * <code>repeated .Vector corners = 3;</code>
     */
    emu.gingerps.net.proto.VectorOuterClass.Vector getCorners(int index);
    /**
     * <code>repeated .Vector corners = 3;</code>
     */
    int getCornersCount();
     ...
     * <code>repeated .Vector corners = 3;</code>
     */
    emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder getCornersOrBuilder(
        int index);
     ...
     */
    emu.gingerps.net.proto.ToTheMoonQueryPathRspOuterClass.ToTheMoonQueryPathRsp.PathStatusType getQueryStatus();
  }
  /**
   * <pre>
   * enum CmdId {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.ToTheMoonQueryPathRspOuterClass.internal_static_ToTheMoonQueryPathRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.ToTheMoonQueryPathRspOuterClass.ToTheMoonQueryPathRsp.class, emu.gingerps.net.proto.ToTheMoonQueryPathRspOuterClass.ToTheMoonQueryPathRsp.Builder.class);
    }
    ...
    public enum PathStatusType
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return emu.gingerps.net.proto.ToTheMoonQueryPathRspOuterClass.ToTheMoonQueryPathRsp.getDescriptor().getEnumTypes().get(0);
      }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.VectorOuterClass.Vector> getCornersList() {
      return corners_;
    }
    /**
     * <code>repeated .Vector corners = 3;</code>
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.VectorOuterClass.Vector getCorners(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder getCornersOrBuilder(
        int index) {
      return corners_.get(index);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (queryStatus_ != emu.gingerps.net.proto.ToTheMoonQueryPathRspOuterClass.ToTheMoonQueryPathRsp.PathStatusType.PATH_STATUS_TYPE_FAIL.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.ToTheMoonQueryPathRspOuterClass.ToTheMoonQueryPathRsp)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.ToTheMoonQueryPathRspOuterClass.ToTheMoonQueryPathRsp other = (emu.gingerps.net.proto.ToTheMoonQueryPathRspOuterClass.ToTheMoonQueryPathRsp) obj;
    ...
    public static emu.gingerps.net.proto.ToTheMoonQueryPathRspOuterClass.ToTheMoonQueryPathRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.ToTheMoonQueryPathRspOuterClass.ToTheMoonQueryPathRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.ToTheMoonQueryPathRspOuterClass.ToTheMoonQueryPathRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.ToTheMoonQueryPathRspOuterClass.ToTheMoonQueryPathRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.ToTheMoonQueryPathRspOuterClass.ToTheMoonQueryPathRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.ToTheMoonQueryPathRspOuterClass.ToTheMoonQueryPathRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.ToTheMoonQueryPathRspOuterClass.ToTheMoonQueryPathRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.ToTheMoonQueryPathRspOuterClass.ToTheMoonQueryPathRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.ToTheMoonQueryPathRspOuterClass.internal_static_ToTheMoonQueryPathRsp_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.ToTheMoonQueryPathRspOuterClass.ToTheMoonQueryPathRsp getDefaultInstanceForType() {
        return emu.gingerps.net.proto.ToTheMoonQueryPathRspOuterClass.ToTheMoonQueryPathRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.ToTheMoonQueryPathRspOuterClass.ToTheMoonQueryPathRsp build() {
        emu.gingerps.net.proto.ToTheMoonQueryPathRspOuterClass.ToTheMoonQueryPathRsp result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.ToTheMoonQueryPathRspOuterClass.ToTheMoonQueryPathRsp) {
          return mergeFrom((emu.gingerps.net.proto.ToTheMoonQueryPathRspOuterClass.ToTheMoonQueryPathRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.ToTheMoonQueryPathRspOuterClass.ToTheMoonQueryPathRsp other) {
        if (other == emu.gingerps.net.proto.ToTheMoonQueryPathRspOuterClass.ToTheMoonQueryPathRsp.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.VectorOuterClass.Vector, emu.gingerps.net.proto.VectorOuterClass.Vector.Builder, emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder> cornersBuilder_;
       ...
       * <code>repeated .Vector corners = 3;</code>
       */
      public Builder addCorners(emu.gingerps.net.proto.VectorOuterClass.Vector value) {
        if (cornersBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .Vector corners = 3;</code>
       */
      public emu.gingerps.net.proto.VectorOuterClass.Vector.Builder getCornersBuilder(
          int index) {
       ...
       * <code>repeated .Vector corners = 3;</code>
       */
      public emu.gingerps.net.proto.VectorOuterClass.Vector.Builder addCornersBuilder() {
       ...
       * @return This builder for chaining.
       */
      public Builder setQueryStatus(emu.gingerps.net.proto.ToTheMoonQueryPathRspOuterClass.ToTheMoonQueryPathRsp.PathStatusType value) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    private static final emu.gingerps.net.proto.ToTheMoonQueryPathRspOuterClass.ToTheMoonQueryPathRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.ToTheMoonQueryPathRspOuterClass.ToTheMoonQueryPathRsp();
    }

    public static emu.gingerps.net.proto.ToTheMoonQueryPathRspOuterClass.ToTheMoonQueryPathRsp getDefaultInstance() {
