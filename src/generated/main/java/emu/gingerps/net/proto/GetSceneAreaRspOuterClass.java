...
public final class GetSceneAreaRspOuterClass {
  ...
  public interface GetSceneAreaRspOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.CityInfoOuterClass.CityInfo> 
        getCityInfoListList();
    /**
     * <code>repeated .CityInfo city_info_list = 9;</code>
     */
    emu.gingerps.net.proto.CityInfoOuterClass.CityInfo getCityInfoList(int index);
    /**
     * <code>repeated .CityInfo city_info_list = 9;</code>
     */
     ...
     * <code>repeated .CityInfo city_info_list = 9;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.CityInfoOuterClass.CityInfoOrBuilder> 
        getCityInfoListOrBuilderList();
    /**
     * <code>repeated .CityInfo city_info_list = 9;</code>
     */
    emu.gingerps.net.proto.CityInfoOuterClass.CityInfoOrBuilder getCityInfoListOrBuilder(
        int index);
  }
  /**
   * <pre>
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.GetSceneAreaRspOuterClass.internal_static_GetSceneAreaRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.GetSceneAreaRspOuterClass.GetSceneAreaRsp.class, emu.gingerps.net.proto.GetSceneAreaRspOuterClass.GetSceneAreaRsp.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.CityInfoOuterClass.CityInfo> getCityInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.CityInfoOuterClass.CityInfoOrBuilder> 
        getCityInfoListOrBuilderList() {
      return cityInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.CityInfoOuterClass.CityInfo getCityInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.CityInfoOuterClass.CityInfoOrBuilder getCityInfoListOrBuilder(
        int index) {
      return cityInfoList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.GetSceneAreaRspOuterClass.GetSceneAreaRsp)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.GetSceneAreaRspOuterClass.GetSceneAreaRsp other = (emu.gingerps.net.proto.GetSceneAreaRspOuterClass.GetSceneAreaRsp) obj;
    ...
    public static emu.gingerps.net.proto.GetSceneAreaRspOuterClass.GetSceneAreaRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.GetSceneAreaRspOuterClass.GetSceneAreaRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.GetSceneAreaRspOuterClass.GetSceneAreaRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.GetSceneAreaRspOuterClass.GetSceneAreaRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.GetSceneAreaRspOuterClass.GetSceneAreaRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.GetSceneAreaRspOuterClass.GetSceneAreaRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.GetSceneAreaRspOuterClass.GetSceneAreaRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.GetSceneAreaRspOuterClass.GetSceneAreaRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.GetSceneAreaRspOuterClass.internal_static_GetSceneAreaRsp_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.GetSceneAreaRspOuterClass.GetSceneAreaRsp getDefaultInstanceForType() {
        return emu.gingerps.net.proto.GetSceneAreaRspOuterClass.GetSceneAreaRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.GetSceneAreaRspOuterClass.GetSceneAreaRsp build() {
        emu.gingerps.net.proto.GetSceneAreaRspOuterClass.GetSceneAreaRsp result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.GetSceneAreaRspOuterClass.GetSceneAreaRsp) {
          return mergeFrom((emu.gingerps.net.proto.GetSceneAreaRspOuterClass.GetSceneAreaRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.GetSceneAreaRspOuterClass.GetSceneAreaRsp other) {
        if (other == emu.gingerps.net.proto.GetSceneAreaRspOuterClass.GetSceneAreaRsp.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.CityInfoOuterClass.CityInfo, emu.gingerps.net.proto.CityInfoOuterClass.CityInfo.Builder, emu.gingerps.net.proto.CityInfoOuterClass.CityInfoOrBuilder> cityInfoListBuilder_;
      ...
      public Builder setCityInfoList(
          int index, emu.gingerps.net.proto.CityInfoOuterClass.CityInfo value) {
        if (cityInfoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setCityInfoList(
          int index, emu.gingerps.net.proto.CityInfoOuterClass.CityInfo.Builder builderForValue) {
        if (cityInfoListBuilder_ == null) {
          ensureCityInfoListIsMutable();
       ...
       * <code>repeated .CityInfo city_info_list = 9;</code>
       */
      public Builder addCityInfoList(emu.gingerps.net.proto.CityInfoOuterClass.CityInfo value) {
        if (cityInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addAllCityInfoList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.CityInfoOuterClass.CityInfo> values) {
        if (cityInfoListBuilder_ == null) {
          ensureCityInfoListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .CityInfo city_info_list = 9;</code>
       */
      public emu.gingerps.net.proto.CityInfoOuterClass.CityInfo.Builder getCityInfoListBuilder(
          int index) {
       ...
       * <code>repeated .CityInfo city_info_list = 9;</code>
       */
      public emu.gingerps.net.proto.CityInfoOuterClass.CityInfo.Builder addCityInfoListBuilder() {
        return getCityInfoListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.CityInfoOuterClass.CityInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .CityInfo city_info_list = 9;</code>
       */
      public emu.gingerps.net.proto.CityInfoOuterClass.CityInfo.Builder addCityInfoListBuilder(
          int index) {
        return getCityInfoListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.CityInfoOuterClass.CityInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .CityInfo city_info_list = 9;</code>
       */
      public java.util.List<emu.gingerps.net.proto.CityInfoOuterClass.CityInfo.Builder> 
    ...
    private static final emu.gingerps.net.proto.GetSceneAreaRspOuterClass.GetSceneAreaRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.GetSceneAreaRspOuterClass.GetSceneAreaRsp();
    }

    public static emu.gingerps.net.proto.GetSceneAreaRspOuterClass.GetSceneAreaRsp getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ity_info_list\030\t \003(\0132\t.CityInfoB\030\n\026emu.gi" +
      "ngerps.net.protob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.CityInfoOuterClass.getDescriptor(),
        });
    internal_static_GetSceneAreaRsp_descriptor =
