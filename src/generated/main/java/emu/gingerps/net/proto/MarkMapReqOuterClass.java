...
public final class MarkMapReqOuterClass {
  ...
  public interface MarkMapReqOrBuilder extends
     ...
     * @return The op.
     */
    emu.gingerps.net.proto.MarkMapReqOuterClass.MarkMapReq.Operation getOp();
     ...
     * @return The old.
     */
    emu.gingerps.net.proto.MapMarkPointOuterClass.MapMarkPoint getOld();
    /**
     * <code>.MapMarkPoint old = 6;</code>
     */
    emu.gingerps.net.proto.MapMarkPointOuterClass.MapMarkPointOrBuilder getOldOrBuilder();
     ...
     * @return The mark.
     */
    emu.gingerps.net.proto.MapMarkPointOuterClass.MapMarkPoint getMark();
    /**
     * <code>.MapMarkPoint mark = 13;</code>
     */
    emu.gingerps.net.proto.MapMarkPointOuterClass.MapMarkPointOrBuilder getMarkOrBuilder();
  }
  /**
   * <pre>
   * enum CmdId {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.MarkMapReqOuterClass.internal_static_MarkMapReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.MarkMapReqOuterClass.MarkMapReq.class, emu.gingerps.net.proto.MarkMapReqOuterClass.MarkMapReq.Builder.class);
    }
    ...
    public enum Operation
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return emu.gingerps.net.proto.MarkMapReqOuterClass.MarkMapReq.getDescriptor().getEnumTypes().get(0);
      }
    ...
    private emu.gingerps.net.proto.MapMarkPointOuterClass.MapMarkPoint old_;
    /**
     * <code>.MapMarkPoint old = 6;</code>
     * @return Whether the old field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.MapMarkPointOuterClass.MapMarkPoint getOld() {
    ...
    private emu.gingerps.net.proto.MapMarkPointOuterClass.MapMarkPoint mark_;
    /**
     * <code>.MapMarkPoint mark = 13;</code>
     * @return Whether the mark field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.MapMarkPointOuterClass.MapMarkPoint getMark() {
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (op_ != emu.gingerps.net.proto.MarkMapReqOuterClass.MarkMapReq.Operation.OPERATION_ADD.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.MarkMapReqOuterClass.MarkMapReq)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.MarkMapReqOuterClass.MarkMapReq other = (emu.gingerps.net.proto.MarkMapReqOuterClass.MarkMapReq) obj;
    ...
    public static emu.gingerps.net.proto.MarkMapReqOuterClass.MarkMapReq parseFrom(
    ...
    public static emu.gingerps.net.proto.MarkMapReqOuterClass.MarkMapReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.MarkMapReqOuterClass.MarkMapReq parseFrom(
    ...
    public static emu.gingerps.net.proto.MarkMapReqOuterClass.MarkMapReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.MarkMapReqOuterClass.MarkMapReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.MarkMapReqOuterClass.MarkMapReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.MarkMapReqOuterClass.MarkMapReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.MarkMapReqOuterClass.MarkMapReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.MarkMapReqOuterClass.internal_static_MarkMapReq_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.MarkMapReqOuterClass.MarkMapReq getDefaultInstanceForType() {
        return emu.gingerps.net.proto.MarkMapReqOuterClass.MarkMapReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.MarkMapReqOuterClass.MarkMapReq build() {
        emu.gingerps.net.proto.MarkMapReqOuterClass.MarkMapReq result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.MarkMapReqOuterClass.MarkMapReq) {
          return mergeFrom((emu.gingerps.net.proto.MarkMapReqOuterClass.MarkMapReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.MarkMapReqOuterClass.MarkMapReq other) {
        if (other == emu.gingerps.net.proto.MarkMapReqOuterClass.MarkMapReq.getDefaultInstance()) return this;
        if (other.op_ != 0) {
       ...
       * @return This builder for chaining.
       */
      public Builder setOp(emu.gingerps.net.proto.MarkMapReqOuterClass.MarkMapReq.Operation value) {
        if (value == null) {
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.MapMarkPointOuterClass.MapMarkPoint, emu.gingerps.net.proto.MapMarkPointOuterClass.MapMarkPoint.Builder, emu.gingerps.net.proto.MapMarkPointOuterClass.MapMarkPointOrBuilder> oldBuilder_;
      /**
       * <code>.MapMarkPoint old = 6;</code>
       * @return Whether the old field is set.
       */
       ...
       * <code>.MapMarkPoint old = 6;</code>
       */
      public Builder setOld(emu.gingerps.net.proto.MapMarkPointOuterClass.MapMarkPoint value) {
        if (oldBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public emu.gingerps.net.proto.MapMarkPointOuterClass.MapMarkPointOrBuilder getOldOrBuilder() {
        if (oldBuilder_ != null) {
          ...
          return old_ == null ?
              emu.gingerps.net.proto.MapMarkPointOuterClass.MapMarkPoint.getDefaultInstance() : old_;
        }
      }
      /**
       * <code>.MapMarkPoint old = 6;</code>
      ...
      private emu.gingerps.net.proto.MapMarkPointOuterClass.MapMarkPoint mark_;
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.MapMarkPointOuterClass.MapMarkPoint, emu.gingerps.net.proto.MapMarkPointOuterClass.MapMarkPoint.Builder, emu.gingerps.net.proto.MapMarkPointOuterClass.MapMarkPointOrBuilder> markBuilder_;
      /**
       * <code>.MapMarkPoint mark = 13;</code>
       * @return Whether the mark field is set.
       */
       ...
       * <code>.MapMarkPoint mark = 13;</code>
       */
      public Builder setMark(emu.gingerps.net.proto.MapMarkPointOuterClass.MapMarkPoint value) {
        if (markBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public emu.gingerps.net.proto.MapMarkPointOuterClass.MapMarkPointOrBuilder getMarkOrBuilder() {
        if (markBuilder_ != null) {
          ...
          return mark_ == null ?
              emu.gingerps.net.proto.MapMarkPointOuterClass.MapMarkPoint.getDefaultInstance() : mark_;
        }
      }
      /**
       * <code>.MapMarkPoint mark = 13;</code>
    ...
    private static final emu.gingerps.net.proto.MarkMapReqOuterClass.MarkMapReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.MarkMapReqOuterClass.MarkMapReq();
    }

    public static emu.gingerps.net.proto.MarkMapReqOuterClass.MarkMapReq getDefaultInstance() {
