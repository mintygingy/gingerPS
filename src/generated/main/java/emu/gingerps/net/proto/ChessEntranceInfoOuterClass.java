...
public final class ChessEntranceInfoOuterClass {
  ...
  public interface ChessEntranceInfoOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.ChessMonsterInfoOuterClass.ChessMonsterInfo> 
        getMonsterInfoListList();
    /**
     * <code>repeated .ChessMonsterInfo monster_info_list = 15;</code>
     */
    emu.gingerps.net.proto.ChessMonsterInfoOuterClass.ChessMonsterInfo getMonsterInfoList(int index);
    /**
     * <code>repeated .ChessMonsterInfo monster_info_list = 15;</code>
     */
     ...
     * <code>repeated .ChessMonsterInfo monster_info_list = 15;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.ChessMonsterInfoOuterClass.ChessMonsterInfoOrBuilder> 
        getMonsterInfoListOrBuilderList();
    /**
     * <code>repeated .ChessMonsterInfo monster_info_list = 15;</code>
     */
    emu.gingerps.net.proto.ChessMonsterInfoOuterClass.ChessMonsterInfoOrBuilder getMonsterInfoListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.ChessEntranceInfoOuterClass.internal_static_ChessEntranceInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.ChessEntranceInfoOuterClass.ChessEntranceInfo.class, emu.gingerps.net.proto.ChessEntranceInfoOuterClass.ChessEntranceInfo.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.ChessMonsterInfoOuterClass.ChessMonsterInfo> getMonsterInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.ChessMonsterInfoOuterClass.ChessMonsterInfoOrBuilder> 
        getMonsterInfoListOrBuilderList() {
      return monsterInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.ChessMonsterInfoOuterClass.ChessMonsterInfo getMonsterInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.ChessMonsterInfoOuterClass.ChessMonsterInfoOrBuilder getMonsterInfoListOrBuilder(
        int index) {
      return monsterInfoList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.ChessEntranceInfoOuterClass.ChessEntranceInfo)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.ChessEntranceInfoOuterClass.ChessEntranceInfo other = (emu.gingerps.net.proto.ChessEntranceInfoOuterClass.ChessEntranceInfo) obj;
    ...
    public static emu.gingerps.net.proto.ChessEntranceInfoOuterClass.ChessEntranceInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.ChessEntranceInfoOuterClass.ChessEntranceInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.ChessEntranceInfoOuterClass.ChessEntranceInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.ChessEntranceInfoOuterClass.ChessEntranceInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.ChessEntranceInfoOuterClass.ChessEntranceInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.ChessEntranceInfoOuterClass.ChessEntranceInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.ChessEntranceInfoOuterClass.ChessEntranceInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.ChessEntranceInfoOuterClass.ChessEntranceInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.ChessEntranceInfoOuterClass.internal_static_ChessEntranceInfo_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.ChessEntranceInfoOuterClass.ChessEntranceInfo getDefaultInstanceForType() {
        return emu.gingerps.net.proto.ChessEntranceInfoOuterClass.ChessEntranceInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.ChessEntranceInfoOuterClass.ChessEntranceInfo build() {
        emu.gingerps.net.proto.ChessEntranceInfoOuterClass.ChessEntranceInfo result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.ChessEntranceInfoOuterClass.ChessEntranceInfo) {
          return mergeFrom((emu.gingerps.net.proto.ChessEntranceInfoOuterClass.ChessEntranceInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.ChessEntranceInfoOuterClass.ChessEntranceInfo other) {
        if (other == emu.gingerps.net.proto.ChessEntranceInfoOuterClass.ChessEntranceInfo.getDefaultInstance()) return this;
        if (monsterInfoListBuilder_ == null) {
      ...
      private void ensureMonsterInfoListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          monsterInfoList_ = new java.util.ArrayList<emu.gingerps.net.proto.ChessMonsterInfoOuterClass.ChessMonsterInfo>(monsterInfoList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.ChessMonsterInfoOuterClass.ChessMonsterInfo, emu.gingerps.net.proto.ChessMonsterInfoOuterClass.ChessMonsterInfo.Builder, emu.gingerps.net.proto.ChessMonsterInfoOuterClass.ChessMonsterInfoOrBuilder> monsterInfoListBuilder_;
      ...
      public Builder setMonsterInfoList(
          int index, emu.gingerps.net.proto.ChessMonsterInfoOuterClass.ChessMonsterInfo value) {
        if (monsterInfoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setMonsterInfoList(
          int index, emu.gingerps.net.proto.ChessMonsterInfoOuterClass.ChessMonsterInfo.Builder builderForValue) {
        if (monsterInfoListBuilder_ == null) {
          ensureMonsterInfoListIsMutable();
       ...
       * <code>repeated .ChessMonsterInfo monster_info_list = 15;</code>
       */
      public Builder addMonsterInfoList(emu.gingerps.net.proto.ChessMonsterInfoOuterClass.ChessMonsterInfo value) {
        if (monsterInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addMonsterInfoList(
          emu.gingerps.net.proto.ChessMonsterInfoOuterClass.ChessMonsterInfo.Builder builderForValue) {
        if (monsterInfoListBuilder_ == null) {
          ensureMonsterInfoListIsMutable();
      ...
      public Builder addAllMonsterInfoList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.ChessMonsterInfoOuterClass.ChessMonsterInfo> values) {
        if (monsterInfoListBuilder_ == null) {
          ensureMonsterInfoListIsMutable();
       ...
       * <code>repeated .ChessMonsterInfo monster_info_list = 15;</code>
       */
      public emu.gingerps.net.proto.ChessMonsterInfoOuterClass.ChessMonsterInfo.Builder getMonsterInfoListBuilder(
          int index) {
       ...
       * <code>repeated .ChessMonsterInfo monster_info_list = 15;</code>
       */
      public emu.gingerps.net.proto.ChessMonsterInfoOuterClass.ChessMonsterInfo.Builder addMonsterInfoListBuilder() {
        return getMonsterInfoListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.ChessMonsterInfoOuterClass.ChessMonsterInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .ChessMonsterInfo monster_info_list = 15;</code>
       */
      public emu.gingerps.net.proto.ChessMonsterInfoOuterClass.ChessMonsterInfo.Builder addMonsterInfoListBuilder(
          int index) {
        return getMonsterInfoListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.ChessMonsterInfoOuterClass.ChessMonsterInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .ChessMonsterInfo monster_info_list = 15;</code>
       */
      public java.util.List<emu.gingerps.net.proto.ChessMonsterInfoOuterClass.ChessMonsterInfo.Builder> 
           getMonsterInfoListBuilderList() {
        return getMonsterInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.ChessMonsterInfoOuterClass.ChessMonsterInfo, emu.gingerps.net.proto.ChessMonsterInfoOuterClass.ChessMonsterInfo.Builder, emu.gingerps.net.proto.ChessMonsterInfoOuterClass.ChessMonsterInfoOrBuilder> 
          getMonsterInfoListFieldBuilder() {
        if (monsterInfoListBuilder_ == null) {
    ...
    private static final emu.gingerps.net.proto.ChessEntranceInfoOuterClass.ChessEntranceInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.ChessEntranceInfoOuterClass.ChessEntranceInfo();
    }

    public static emu.gingerps.net.proto.ChessEntranceInfoOuterClass.ChessEntranceInfo getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.ChessMonsterInfoOuterClass.getDescriptor(),
        });
    internal_static_ChessEntranceInfo_descriptor =
