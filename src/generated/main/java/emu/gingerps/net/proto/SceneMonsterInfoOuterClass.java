...
public final class SceneMonsterInfoOuterClass {
  ...
  public interface SceneMonsterInfoOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfo> 
        getWeaponListList();
    /**
     * <code>repeated .SceneWeaponInfo weapon_list = 4;</code>
     */
    emu.gingerps.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfo getWeaponList(int index);
    /**
     * <code>repeated .SceneWeaponInfo weapon_list = 4;</code>
     */
     ...
     * <code>repeated .SceneWeaponInfo weapon_list = 4;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfoOrBuilder> 
        getWeaponListOrBuilderList();
    /**
     * <code>repeated .SceneWeaponInfo weapon_list = 4;</code>
     */
    emu.gingerps.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfoOrBuilder getWeaponListOrBuilder(
        int index);
     ...
     * @return The bornType.
     */
    emu.gingerps.net.proto.MonsterBornTypeOuterClass.MonsterBornType getBornType();
     ...
     */
    emu.gingerps.net.proto.MonsterRouteOuterClass.MonsterRoute getMonsterRoute();
    /**
     * <code>.MonsterRoute monster_route = 18;</code>
     */
    emu.gingerps.net.proto.MonsterRouteOuterClass.MonsterRouteOrBuilder getMonsterRouteOrBuilder();
     ...
     * @return The fishInfo.
     */
    emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo getFishInfo();
    /**
     * <code>.SceneFishInfo fish_info = 50;</code>
     */
    emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfoOrBuilder getFishInfoOrBuilder();
     ...
     */
    emu.gingerps.net.proto.FishtankFishInfoOuterClass.FishtankFishInfo getFishtankFishInfo();
    /**
     * <code>.FishtankFishInfo fishtank_fish_info = 51;</code>
     */
    emu.gingerps.net.proto.FishtankFishInfoOuterClass.FishtankFishInfoOrBuilder getFishtankFishInfoOrBuilder();

    public emu.gingerps.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo.ContentCase getContentCase();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.SceneMonsterInfoOuterClass.internal_static_SceneMonsterInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo.class, emu.gingerps.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfo> getWeaponListList() {
      return weaponList_;
    }
    /**
     * <code>repeated .SceneWeaponInfo weapon_list = 4;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfoOrBuilder> 
        getWeaponListOrBuilderList() {
      return weaponList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfo getWeaponList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfoOrBuilder getWeaponListOrBuilder(
        int index) {
      return weaponList_.get(index);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.gingerps.net.proto.SceneMonsterInfoOuterClass.internal_static_SceneMonsterInfo_SummonTagMapEntry_descriptor, 
    ...
    private emu.gingerps.net.proto.MonsterRouteOuterClass.MonsterRoute monsterRoute_;
    /**
     * <code>.MonsterRoute monster_route = 18;</code>
     * @return Whether the monsterRoute field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.MonsterRouteOuterClass.MonsterRoute getMonsterRoute() {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo getFishInfo() {
      if (contentCase_ == 50) {
         return (emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo) content_;
      }
      return emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo.getDefaultInstance();
    }
    /**
     * <code>.SceneFishInfo fish_info = 50;</code>
     */
    @java.lang.Override
    public emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfoOrBuilder getFishInfoOrBuilder() {
      if (contentCase_ == 50) {
         return (emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo) content_;
      }
      return emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo.getDefaultInstance();
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.FishtankFishInfoOuterClass.FishtankFishInfo getFishtankFishInfo() {
      if (contentCase_ == 51) {
         return (emu.gingerps.net.proto.FishtankFishInfoOuterClass.FishtankFishInfo) content_;
      }
      return emu.gingerps.net.proto.FishtankFishInfoOuterClass.FishtankFishInfo.getDefaultInstance();
    }
    /**
     * <code>.FishtankFishInfo fishtank_fish_info = 51;</code>
     */
    @java.lang.Override
    public emu.gingerps.net.proto.FishtankFishInfoOuterClass.FishtankFishInfoOrBuilder getFishtankFishInfoOrBuilder() {
      if (contentCase_ == 51) {
         return (emu.gingerps.net.proto.FishtankFishInfoOuterClass.FishtankFishInfo) content_;
      }
      return emu.gingerps.net.proto.FishtankFishInfoOuterClass.FishtankFishInfo.getDefaultInstance();
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (bornType_ != emu.gingerps.net.proto.MonsterBornTypeOuterClass.MonsterBornType.MONSTER_BORN_TYPE_NONE.getNumber()) {
      ...
      if (contentCase_ == 50) {
        output.writeMessage(50, (emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo) content_);
      }
      if (contentCase_ == 51) {
    ...
    public int getSerializedSize() {
      ...
      if (contentCase_ == 50) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(50, (emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo) content_);
      }
      if (contentCase_ == 51) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo other = (emu.gingerps.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo) obj;
    ...
    public static emu.gingerps.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.SceneMonsterInfoOuterClass.internal_static_SceneMonsterInfo_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo getDefaultInstanceForType() {
        return emu.gingerps.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo build() {
        emu.gingerps.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo) {
          return mergeFrom((emu.gingerps.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo other) {
        if (other == emu.gingerps.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfo, emu.gingerps.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfo.Builder, emu.gingerps.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfoOrBuilder> weaponListBuilder_;
      ...
      public Builder setWeaponList(
          int index, emu.gingerps.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfo value) {
        if (weaponListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setWeaponList(
          int index, emu.gingerps.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfo.Builder builderForValue) {
        if (weaponListBuilder_ == null) {
          ensureWeaponListIsMutable();
       ...
       * <code>repeated .SceneWeaponInfo weapon_list = 4;</code>
       */
      public Builder addWeaponList(emu.gingerps.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfo value) {
        if (weaponListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addAllWeaponList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfo> values) {
        if (weaponListBuilder_ == null) {
          ensureWeaponListIsMutable();
       ...
       * <code>repeated .SceneWeaponInfo weapon_list = 4;</code>
       */
      public emu.gingerps.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfo.Builder getWeaponListBuilder(
          int index) {
       ...
       * <code>repeated .SceneWeaponInfo weapon_list = 4;</code>
       */
      public emu.gingerps.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfo.Builder addWeaponListBuilder() {
        return getWeaponListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .SceneWeaponInfo weapon_list = 4;</code>
       */
      public emu.gingerps.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfo.Builder addWeaponListBuilder(
          int index) {
        return getWeaponListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .SceneWeaponInfo weapon_list = 4;</code>
       */
      public java.util.List<emu.gingerps.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfo.Builder> 
       ...
       * @return This builder for chaining.
       */
      public Builder setBornType(emu.gingerps.net.proto.MonsterBornTypeOuterClass.MonsterBornType value) {
        if (value == null) {
          throw new NullPointerException();
        }
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.MonsterRouteOuterClass.MonsterRoute, emu.gingerps.net.proto.MonsterRouteOuterClass.MonsterRoute.Builder, emu.gingerps.net.proto.MonsterRouteOuterClass.MonsterRouteOrBuilder> monsterRouteBuilder_;
      /**
       * <code>.MonsterRoute monster_route = 18;</code>
       * @return Whether the monsterRoute field is set.
       */
       ...
       * <code>.MonsterRoute monster_route = 18;</code>
       */
      public Builder setMonsterRoute(emu.gingerps.net.proto.MonsterRouteOuterClass.MonsterRoute value) {
        if (monsterRouteBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public emu.gingerps.net.proto.MonsterRouteOuterClass.MonsterRouteOrBuilder getMonsterRouteOrBuilder() {
        if (monsterRouteBuilder_ != null) {
          ...
          return monsterRoute_ == null ?
              emu.gingerps.net.proto.MonsterRouteOuterClass.MonsterRoute.getDefaultInstance() : monsterRoute_;
        }
      }
      /**
       * <code>.MonsterRoute monster_route = 18;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.MonsterRouteOuterClass.MonsterRoute, emu.gingerps.net.proto.MonsterRouteOuterClass.MonsterRoute.Builder, emu.gingerps.net.proto.MonsterRouteOuterClass.MonsterRouteOrBuilder> 
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo, emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo.Builder, emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfoOrBuilder> fishInfoBuilder_;
      /**
       * <code>.SceneFishInfo fish_info = 50;</code>
       * @return Whether the fishInfo field is set.
       */
       ...
       * <code>.SceneFishInfo fish_info = 50;</code>
       */
      public Builder setFishInfo(emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo value) {
        if (fishInfoBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setFishInfo(
          emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo.Builder builderForValue) {
        if (fishInfoBuilder_ == null) {
       ...
       * <code>.SceneFishInfo fish_info = 50;</code>
       */
      public Builder mergeFishInfo(emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo value) {
        if (fishInfoBuilder_ == null) {
          if (contentCase_ == 50 &&
              content_ != emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo.getDefaultInstance()) {
            content_ = emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo.newBuilder((emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo) content_)
       ...
       * <code>.SceneFishInfo fish_info = 50;</code>
       */
      public emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo.Builder getFishInfoBuilder() {
       ...
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo, emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo.Builder, emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfoOrBuilder> 
        ...
        if (fishInfoBuilder_ == null) {
          ...
          fishInfoBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
              emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo, emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo.Builder, emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfoOrBuilder>(
                  (emu.gingerps.net.proto.SceneFishInfoOuterClass.SceneFishInfo) content_,
                  getParentForChildren(),
                  isClean());
          content_ = null;
        }
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.FishtankFishInfoOuterClass.FishtankFishInfo, emu.gingerps.net.proto.FishtankFishInfoOuterClass.FishtankFishInfo.Builder, emu.gingerps.net.proto.FishtankFishInfoOuterClass.FishtankFishInfoOrBuilder> fishtankFishInfoBuilder_;
      /**
       * <code>.FishtankFishInfo fishtank_fish_info = 51;</code>
       * @return Whether the fishtankFishInfo field is set.
       */
       ...
       * <code>.FishtankFishInfo fishtank_fish_info = 51;</code>
       */
      public Builder setFishtankFishInfo(emu.gingerps.net.proto.FishtankFishInfoOuterClass.FishtankFishInfo value) {
        if (fishtankFishInfoBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setFishtankFishInfo(
          emu.gingerps.net.proto.FishtankFishInfoOuterClass.FishtankFishInfo.Builder builderForValue) {
        if (fishtankFishInfoBuilder_ == null) {
          content_ = builderForValue.build();
          onChanged();
        } else {
       ...
       * <code>.FishtankFishInfo fishtank_fish_info = 51;</code>
       */
      public Builder mergeFishtankFishInfo(emu.gingerps.net.proto.FishtankFishInfoOuterClass.FishtankFishInfo value) {
        if (fishtankFishInfoBuilder_ == null) {
          if (contentCase_ == 51 &&
              content_ != emu.gingerps.net.proto.FishtankFishInfoOuterClass.FishtankFishInfo.getDefaultInstance()) {
            content_ = emu.gingerps.net.proto.FishtankFishInfoOuterClass.FishtankFishInfo.newBuilder((emu.gingerps.net.proto.FishtankFishInfoOuterClass.FishtankFishInfo) content_)
                .mergeFrom(value).buildPartial();
          } else {
            content_ = value;
          }
       ...
       * <code>.FishtankFishInfo fishtank_fish_info = 51;</code>
       */
      public emu.gingerps.net.proto.FishtankFishInfoOuterClass.FishtankFishInfo.Builder getFishtankFishInfoBuilder() {
       ...
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.FishtankFishInfoOuterClass.FishtankFishInfo, emu.gingerps.net.proto.FishtankFishInfoOuterClass.FishtankFishInfo.Builder, emu.gingerps.net.proto.FishtankFishInfoOuterClass.FishtankFishInfoOrBuilder> 
        ...
        if (fishtankFishInfoBuilder_ == null) {
          ...
          fishtankFishInfoBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
              emu.gingerps.net.proto.FishtankFishInfoOuterClass.FishtankFishInfo, emu.gingerps.net.proto.FishtankFishInfoOuterClass.FishtankFishInfo.Builder, emu.gingerps.net.proto.FishtankFishInfoOuterClass.FishtankFishInfoOrBuilder>(
                  (emu.gingerps.net.proto.FishtankFishInfoOuterClass.FishtankFishInfo) content_,
                  getParentForChildren(),
                  isClean());
          content_ = null;
        }
    ...
    private static final emu.gingerps.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo();
    }

    public static emu.gingerps.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.FishtankFishInfoOuterClass.getDescriptor(),
          emu.gingerps.net.proto.MonsterBornTypeOuterClass.getDescriptor(),
          emu.gingerps.net.proto.MonsterRouteOuterClass.getDescriptor(),
          emu.gingerps.net.proto.SceneFishInfoOuterClass.getDescriptor(),
