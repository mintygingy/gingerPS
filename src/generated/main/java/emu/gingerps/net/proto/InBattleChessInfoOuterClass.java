...
public final class InBattleChessInfoOuterClass {
  ...
  public interface InBattleChessInfoOrBuilder extends
     ...
     */
    emu.gingerps.net.proto.ChessMysteryInfoOuterClass.ChessMysteryInfo getMysteryInfo();
    /**
     * <code>.ChessMysteryInfo mystery_info = 6;</code>
     */
    emu.gingerps.net.proto.ChessMysteryInfoOuterClass.ChessMysteryInfoOrBuilder getMysteryInfoOrBuilder();
    ...
    java.util.Map<java.lang.Integer, emu.gingerps.net.proto.ChessPlayerInfoOuterClass.ChessPlayerInfo>
    getPlayerInfoMap();
    /**
     * <code>map&lt;uint32, .ChessPlayerInfo&gt; player_info_map = 15;</code>
     */
     ...
     */
    java.util.List<emu.gingerps.net.proto.ChessCardInfoOuterClass.ChessCardInfo> 
        getSelectedCardInfoListList();
    /**
     * <code>repeated .ChessCardInfo selected_card_info_list = 4;</code>
     */
    emu.gingerps.net.proto.ChessCardInfoOuterClass.ChessCardInfo getSelectedCardInfoList(int index);
    /**
     * <code>repeated .ChessCardInfo selected_card_info_list = 4;</code>
     */
     ...
     * <code>repeated .ChessCardInfo selected_card_info_list = 4;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.ChessCardInfoOuterClass.ChessCardInfoOrBuilder> 
        getSelectedCardInfoListOrBuilderList();
    /**
     * <code>repeated .ChessCardInfo selected_card_info_list = 4;</code>
     */
    emu.gingerps.net.proto.ChessCardInfoOuterClass.ChessCardInfoOrBuilder getSelectedCardInfoListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.InBattleChessInfoOuterClass.internal_static_InBattleChessInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.InBattleChessInfoOuterClass.InBattleChessInfo.class, emu.gingerps.net.proto.InBattleChessInfoOuterClass.InBattleChessInfo.Builder.class);
    }
    ...
    private emu.gingerps.net.proto.ChessMysteryInfoOuterClass.ChessMysteryInfo mysteryInfo_;
    /**
     * <code>.ChessMysteryInfo mystery_info = 6;</code>
     * @return Whether the mysteryInfo field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.ChessMysteryInfoOuterClass.ChessMysteryInfo getMysteryInfo() {
    ...
    private static final class PlayerInfoMapDefaultEntryHolder {
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, emu.gingerps.net.proto.ChessPlayerInfoOuterClass.ChessPlayerInfo> defaultEntry =
              com.google.protobuf.MapEntry
              .<java.lang.Integer, emu.gingerps.net.proto.ChessPlayerInfoOuterClass.ChessPlayerInfo>newDefaultInstance(
                  emu.gingerps.net.proto.InBattleChessInfoOuterClass.internal_static_InBattleChessInfo_PlayerInfoMapEntry_descriptor, 
    ...
    @java.lang.Override
    @java.lang.Deprecated
    public java.util.Map<java.lang.Integer, emu.gingerps.net.proto.ChessPlayerInfoOuterClass.ChessPlayerInfo> getPlayerInfoMap() {
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.ChessCardInfoOuterClass.ChessCardInfo> getSelectedCardInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.ChessCardInfoOuterClass.ChessCardInfoOrBuilder> 
        getSelectedCardInfoListOrBuilderList() {
      return selectedCardInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.ChessCardInfoOuterClass.ChessCardInfo getSelectedCardInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.ChessCardInfoOuterClass.ChessCardInfoOrBuilder getSelectedCardInfoListOrBuilder(
        int index) {
      return selectedCardInfoList_.get(index);
    }
    ...
    public int getSerializedSize() {
      ...
      for (java.util.Map.Entry<java.lang.Integer, emu.gingerps.net.proto.ChessPlayerInfoOuterClass.ChessPlayerInfo> entry
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.InBattleChessInfoOuterClass.InBattleChessInfo)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.InBattleChessInfoOuterClass.InBattleChessInfo other = (emu.gingerps.net.proto.InBattleChessInfoOuterClass.InBattleChessInfo) obj;
    ...
    public static emu.gingerps.net.proto.InBattleChessInfoOuterClass.InBattleChessInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.InBattleChessInfoOuterClass.InBattleChessInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.InBattleChessInfoOuterClass.InBattleChessInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.InBattleChessInfoOuterClass.InBattleChessInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.InBattleChessInfoOuterClass.InBattleChessInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.InBattleChessInfoOuterClass.InBattleChessInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.InBattleChessInfoOuterClass.InBattleChessInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.InBattleChessInfoOuterClass.InBattleChessInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.InBattleChessInfoOuterClass.internal_static_InBattleChessInfo_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.InBattleChessInfoOuterClass.InBattleChessInfo getDefaultInstanceForType() {
        return emu.gingerps.net.proto.InBattleChessInfoOuterClass.InBattleChessInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.InBattleChessInfoOuterClass.InBattleChessInfo build() {
        emu.gingerps.net.proto.InBattleChessInfoOuterClass.InBattleChessInfo result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.InBattleChessInfoOuterClass.InBattleChessInfo) {
          return mergeFrom((emu.gingerps.net.proto.InBattleChessInfoOuterClass.InBattleChessInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.InBattleChessInfoOuterClass.InBattleChessInfo other) {
        if (other == emu.gingerps.net.proto.InBattleChessInfoOuterClass.InBattleChessInfo.getDefaultInstance()) return this;
        if (other.getRound() != 0) {
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.ChessMysteryInfoOuterClass.ChessMysteryInfo, emu.gingerps.net.proto.ChessMysteryInfoOuterClass.ChessMysteryInfo.Builder, emu.gingerps.net.proto.ChessMysteryInfoOuterClass.ChessMysteryInfoOrBuilder> mysteryInfoBuilder_;
      /**
       * <code>.ChessMysteryInfo mystery_info = 6;</code>
       * @return Whether the mysteryInfo field is set.
       */
       ...
       * <code>.ChessMysteryInfo mystery_info = 6;</code>
       */
      public Builder setMysteryInfo(emu.gingerps.net.proto.ChessMysteryInfoOuterClass.ChessMysteryInfo value) {
        if (mysteryInfoBuilder_ == null) {
          if (value == null) {
      ...
      public emu.gingerps.net.proto.ChessMysteryInfoOuterClass.ChessMysteryInfoOrBuilder getMysteryInfoOrBuilder() {
        if (mysteryInfoBuilder_ != null) {
          ...
          return mysteryInfo_ == null ?
              emu.gingerps.net.proto.ChessMysteryInfoOuterClass.ChessMysteryInfo.getDefaultInstance() : mysteryInfo_;
        }
      }
      /**
       * <code>.ChessMysteryInfo mystery_info = 6;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.ChessMysteryInfoOuterClass.ChessMysteryInfo, emu.gingerps.net.proto.ChessMysteryInfoOuterClass.ChessMysteryInfo.Builder, emu.gingerps.net.proto.ChessMysteryInfoOuterClass.ChessMysteryInfoOrBuilder> 
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.ChessCardInfoOuterClass.ChessCardInfo, emu.gingerps.net.proto.ChessCardInfoOuterClass.ChessCardInfo.Builder, emu.gingerps.net.proto.ChessCardInfoOuterClass.ChessCardInfoOrBuilder> selectedCardInfoListBuilder_;
      ...
      public Builder setSelectedCardInfoList(
          int index, emu.gingerps.net.proto.ChessCardInfoOuterClass.ChessCardInfo value) {
        if (selectedCardInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setSelectedCardInfoList(
          int index, emu.gingerps.net.proto.ChessCardInfoOuterClass.ChessCardInfo.Builder builderForValue) {
        if (selectedCardInfoListBuilder_ == null) {
          ensureSelectedCardInfoListIsMutable();
       ...
       * <code>repeated .ChessCardInfo selected_card_info_list = 4;</code>
       */
      public Builder addSelectedCardInfoList(emu.gingerps.net.proto.ChessCardInfoOuterClass.ChessCardInfo value) {
        if (selectedCardInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addSelectedCardInfoList(
          emu.gingerps.net.proto.ChessCardInfoOuterClass.ChessCardInfo.Builder builderForValue) {
        if (selectedCardInfoListBuilder_ == null) {
          ensureSelectedCardInfoListIsMutable();
      ...
      public Builder addAllSelectedCardInfoList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.ChessCardInfoOuterClass.ChessCardInfo> values) {
        if (selectedCardInfoListBuilder_ == null) {
          ensureSelectedCardInfoListIsMutable();
       ...
       * <code>repeated .ChessCardInfo selected_card_info_list = 4;</code>
       */
      public emu.gingerps.net.proto.ChessCardInfoOuterClass.ChessCardInfo.Builder getSelectedCardInfoListBuilder(
          int index) {
       ...
       * <code>repeated .ChessCardInfo selected_card_info_list = 4;</code>
       */
      public emu.gingerps.net.proto.ChessCardInfoOuterClass.ChessCardInfo.Builder addSelectedCardInfoListBuilder() {
        return getSelectedCardInfoListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.ChessCardInfoOuterClass.ChessCardInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .ChessCardInfo selected_card_info_list = 4;</code>
       */
      public emu.gingerps.net.proto.ChessCardInfoOuterClass.ChessCardInfo.Builder addSelectedCardInfoListBuilder(
          int index) {
        return getSelectedCardInfoListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.ChessCardInfoOuterClass.ChessCardInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .ChessCardInfo selected_card_info_list = 4;</code>
       */
      public java.util.List<emu.gingerps.net.proto.ChessCardInfoOuterClass.ChessCardInfo.Builder> 
    ...
    private static final emu.gingerps.net.proto.InBattleChessInfoOuterClass.InBattleChessInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.InBattleChessInfoOuterClass.InBattleChessInfo();
    }

    public static emu.gingerps.net.proto.InBattleChessInfoOuterClass.InBattleChessInfo getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.ChessCardInfoOuterClass.getDescriptor(),
          emu.gingerps.net.proto.ChessMysteryInfoOuterClass.getDescriptor(),
          emu.gingerps.net.proto.ChessPlayerInfoOuterClass.getDescriptor(),
        });
    internal_static_InBattleChessInfo_descriptor =
