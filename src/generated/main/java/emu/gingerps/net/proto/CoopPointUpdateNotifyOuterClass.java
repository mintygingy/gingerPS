...
public final class CoopPointUpdateNotifyOuterClass {
  ...
  public interface CoopPointUpdateNotifyOrBuilder extends
     ...
     */
    emu.gingerps.net.proto.CoopPointOuterClass.CoopPoint getCoopPoint();
    /**
     * <code>.CoopPoint coop_point = 8;</code>
     */
    emu.gingerps.net.proto.CoopPointOuterClass.CoopPointOrBuilder getCoopPointOrBuilder();
  }
  /**
   * <pre>
   * enum CmdId {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.CoopPointUpdateNotifyOuterClass.internal_static_CoopPointUpdateNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.CoopPointUpdateNotifyOuterClass.CoopPointUpdateNotify.class, emu.gingerps.net.proto.CoopPointUpdateNotifyOuterClass.CoopPointUpdateNotify.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.CoopPointOuterClass.CoopPoint getCoopPoint() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.CoopPointUpdateNotifyOuterClass.CoopPointUpdateNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.CoopPointUpdateNotifyOuterClass.CoopPointUpdateNotify other = (emu.gingerps.net.proto.CoopPointUpdateNotifyOuterClass.CoopPointUpdateNotify) obj;
    ...
    public static emu.gingerps.net.proto.CoopPointUpdateNotifyOuterClass.CoopPointUpdateNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.CoopPointUpdateNotifyOuterClass.CoopPointUpdateNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.CoopPointUpdateNotifyOuterClass.CoopPointUpdateNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.CoopPointUpdateNotifyOuterClass.CoopPointUpdateNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.CoopPointUpdateNotifyOuterClass.CoopPointUpdateNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.CoopPointUpdateNotifyOuterClass.CoopPointUpdateNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.CoopPointUpdateNotifyOuterClass.CoopPointUpdateNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.CoopPointUpdateNotifyOuterClass.CoopPointUpdateNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.CoopPointUpdateNotifyOuterClass.internal_static_CoopPointUpdateNotify_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.CoopPointUpdateNotifyOuterClass.CoopPointUpdateNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.CoopPointUpdateNotifyOuterClass.CoopPointUpdateNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.CoopPointUpdateNotifyOuterClass.CoopPointUpdateNotify build() {
        emu.gingerps.net.proto.CoopPointUpdateNotifyOuterClass.CoopPointUpdateNotify result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.CoopPointUpdateNotifyOuterClass.CoopPointUpdateNotify) {
          return mergeFrom((emu.gingerps.net.proto.CoopPointUpdateNotifyOuterClass.CoopPointUpdateNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.CoopPointUpdateNotifyOuterClass.CoopPointUpdateNotify other) {
        if (other == emu.gingerps.net.proto.CoopPointUpdateNotifyOuterClass.CoopPointUpdateNotify.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.CoopPointOuterClass.CoopPoint, emu.gingerps.net.proto.CoopPointOuterClass.CoopPoint.Builder, emu.gingerps.net.proto.CoopPointOuterClass.CoopPointOrBuilder> coopPointBuilder_;
      /**
       * <code>.CoopPoint coop_point = 8;</code>
       * @return Whether the coopPoint field is set.
       */
       ...
       * <code>.CoopPoint coop_point = 8;</code>
       */
      public Builder setCoopPoint(emu.gingerps.net.proto.CoopPointOuterClass.CoopPoint value) {
        if (coopPointBuilder_ == null) {
          if (value == null) {
      ...
      public emu.gingerps.net.proto.CoopPointOuterClass.CoopPointOrBuilder getCoopPointOrBuilder() {
        if (coopPointBuilder_ != null) {
          ...
          return coopPoint_ == null ?
              emu.gingerps.net.proto.CoopPointOuterClass.CoopPoint.getDefaultInstance() : coopPoint_;
        }
      }
      /**
       * <code>.CoopPoint coop_point = 8;</code>
    ...
    private static final emu.gingerps.net.proto.CoopPointUpdateNotifyOuterClass.CoopPointUpdateNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.CoopPointUpdateNotifyOuterClass.CoopPointUpdateNotify();
    }

    public static emu.gingerps.net.proto.CoopPointUpdateNotifyOuterClass.CoopPointUpdateNotify getDefaultInstance() {
