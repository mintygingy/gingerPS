...
public final class ClientReconnectNotifyOuterClass {
  ...
  public interface ClientReconnectNotifyOrBuilder extends
     ...
     * @return The reason.
     */
    emu.gingerps.net.proto.ClientReconnectReasonOuterClass.ClientReconnectReason getReason();
  }
  /**
   * <pre>
   * enum CmdId {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.ClientReconnectNotifyOuterClass.internal_static_ClientReconnectNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.ClientReconnectNotifyOuterClass.ClientReconnectNotify.class, emu.gingerps.net.proto.ClientReconnectNotifyOuterClass.ClientReconnectNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.ClientReconnectNotifyOuterClass.ClientReconnectNotify)) {
    ...
    public static emu.gingerps.net.proto.ClientReconnectNotifyOuterClass.ClientReconnectNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.ClientReconnectNotifyOuterClass.ClientReconnectNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.ClientReconnectNotifyOuterClass.ClientReconnectNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.ClientReconnectNotifyOuterClass.ClientReconnectNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.ClientReconnectNotifyOuterClass.ClientReconnectNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.ClientReconnectNotifyOuterClass.ClientReconnectNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.ClientReconnectNotifyOuterClass.ClientReconnectNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.ClientReconnectNotifyOuterClass.ClientReconnectNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.ClientReconnectNotifyOuterClass.internal_static_ClientReconnectNotify_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.ClientReconnectNotifyOuterClass.ClientReconnectNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.ClientReconnectNotifyOuterClass.ClientReconnectNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.ClientReconnectNotifyOuterClass.ClientReconnectNotify build() {
        emu.gingerps.net.proto.ClientReconnectNotifyOuterClass.ClientReconnectNotify result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.ClientReconnectNotifyOuterClass.ClientReconnectNotify) {
          return mergeFrom((emu.gingerps.net.proto.ClientReconnectNotifyOuterClass.ClientReconnectNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.ClientReconnectNotifyOuterClass.ClientReconnectNotify other) {
        if (other == emu.gingerps.net.proto.ClientReconnectNotifyOuterClass.ClientReconnectNotify.getDefaultInstance()) return this;
        if (other.reason_ != 0) {
       ...
       * @return This builder for chaining.
       */
      public Builder setReason(emu.gingerps.net.proto.ClientReconnectReasonOuterClass.ClientReconnectReason value) {
        if (value == null) {
    ...
    private static final emu.gingerps.net.proto.ClientReconnectNotifyOuterClass.ClientReconnectNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.ClientReconnectNotifyOuterClass.ClientReconnectNotify();
    }

    public static emu.gingerps.net.proto.ClientReconnectNotifyOuterClass.ClientReconnectNotify getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.ClientReconnectReasonOuterClass.getDescriptor(),
        });
    internal_static_ClientReconnectNotify_descriptor =
