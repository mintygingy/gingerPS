...
public final class UgcActivityDetailInfoOuterClass {
  ...
  public interface UgcActivityDetailInfoOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon> 
        getOfficialCustomDungeonListList();
    /**
     * <code>repeated .OfficialCustomDungeon official_custom_dungeon_list = 10;</code>
     */
    emu.gingerps.net.proto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon getOfficialCustomDungeonList(int index);
    /**
     * <code>repeated .OfficialCustomDungeon official_custom_dungeon_list = 10;</code>
     */
     ...
     * <code>repeated .OfficialCustomDungeon official_custom_dungeon_list = 10;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.OfficialCustomDungeonOuterClass.OfficialCustomDungeonOrBuilder> 
        getOfficialCustomDungeonListOrBuilderList();
    /**
     * <code>repeated .OfficialCustomDungeon official_custom_dungeon_list = 10;</code>
     */
    emu.gingerps.net.proto.OfficialCustomDungeonOuterClass.OfficialCustomDungeonOrBuilder getOfficialCustomDungeonListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.UgcActivityDetailInfoOuterClass.internal_static_UgcActivityDetailInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo.class, emu.gingerps.net.proto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon> getOfficialCustomDungeonListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.OfficialCustomDungeonOuterClass.OfficialCustomDungeonOrBuilder> 
        getOfficialCustomDungeonListOrBuilderList() {
      return officialCustomDungeonList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon getOfficialCustomDungeonList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.OfficialCustomDungeonOuterClass.OfficialCustomDungeonOrBuilder getOfficialCustomDungeonListOrBuilder(
        int index) {
      return officialCustomDungeonList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo other = (emu.gingerps.net.proto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo) obj;
    ...
    public static emu.gingerps.net.proto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.UgcActivityDetailInfoOuterClass.internal_static_UgcActivityDetailInfo_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo getDefaultInstanceForType() {
        return emu.gingerps.net.proto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo build() {
        emu.gingerps.net.proto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo) {
          return mergeFrom((emu.gingerps.net.proto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo other) {
        if (other == emu.gingerps.net.proto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon, emu.gingerps.net.proto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon.Builder, emu.gingerps.net.proto.OfficialCustomDungeonOuterClass.OfficialCustomDungeonOrBuilder> officialCustomDungeonListBuilder_;
      ...
      public Builder setOfficialCustomDungeonList(
          int index, emu.gingerps.net.proto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon value) {
        if (officialCustomDungeonListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setOfficialCustomDungeonList(
          int index, emu.gingerps.net.proto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon.Builder builderForValue) {
        if (officialCustomDungeonListBuilder_ == null) {
          ensureOfficialCustomDungeonListIsMutable();
       ...
       * <code>repeated .OfficialCustomDungeon official_custom_dungeon_list = 10;</code>
       */
      public Builder addOfficialCustomDungeonList(emu.gingerps.net.proto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon value) {
        if (officialCustomDungeonListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addOfficialCustomDungeonList(
          emu.gingerps.net.proto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon.Builder builderForValue) {
        if (officialCustomDungeonListBuilder_ == null) {
          ensureOfficialCustomDungeonListIsMutable();
      ...
      public Builder addAllOfficialCustomDungeonList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon> values) {
        if (officialCustomDungeonListBuilder_ == null) {
          ensureOfficialCustomDungeonListIsMutable();
       ...
       * <code>repeated .OfficialCustomDungeon official_custom_dungeon_list = 10;</code>
       */
      public emu.gingerps.net.proto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon.Builder getOfficialCustomDungeonListBuilder(
          int index) {
       ...
       * <code>repeated .OfficialCustomDungeon official_custom_dungeon_list = 10;</code>
       */
      public emu.gingerps.net.proto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon.Builder addOfficialCustomDungeonListBuilder() {
        return getOfficialCustomDungeonListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon.getDefaultInstance());
      }
      /**
       * <code>repeated .OfficialCustomDungeon official_custom_dungeon_list = 10;</code>
       */
      public emu.gingerps.net.proto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon.Builder addOfficialCustomDungeonListBuilder(
          int index) {
        return getOfficialCustomDungeonListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon.getDefaultInstance());
      }
      /**
       * <code>repeated .OfficialCustomDungeon official_custom_dungeon_list = 10;</code>
       */
      public java.util.List<emu.gingerps.net.proto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon.Builder> 
    ...
    private static final emu.gingerps.net.proto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo();
    }

    public static emu.gingerps.net.proto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "(\r\022\035\n\025is_ugc_feature_closed\030\t \001(\010B\030\n\026emu" +
      ".gingerps.net.protob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.OfficialCustomDungeonOuterClass.getDescriptor(),
        });
    internal_static_UgcActivityDetailInfo_descriptor =
