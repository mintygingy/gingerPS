...
public final class ServerLogNotifyOuterClass {
  ...
  public interface ServerLogNotifyOrBuilder extends
     ...
     * @return The logLevel.
     */
    emu.gingerps.net.proto.ServerLogLevelOuterClass.ServerLogLevel getLogLevel();
     ...
     * @return The logType.
     */
    emu.gingerps.net.proto.ServerLogTypeOuterClass.ServerLogType getLogType();
  }
  /**
   * <pre>
   * enum CmdId {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.ServerLogNotifyOuterClass.internal_static_ServerLogNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.ServerLogNotifyOuterClass.ServerLogNotify.class, emu.gingerps.net.proto.ServerLogNotifyOuterClass.ServerLogNotify.Builder.class);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (logLevel_ != emu.gingerps.net.proto.ServerLogLevelOuterClass.ServerLogLevel.SERVER_LOG_LEVEL_NONE.getNumber()) {
        output.writeEnum(5, logLevel_);
      }
      if (logType_ != emu.gingerps.net.proto.ServerLogTypeOuterClass.ServerLogType.SERVER_LOG_TYPE_NONE.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.ServerLogNotifyOuterClass.ServerLogNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.ServerLogNotifyOuterClass.ServerLogNotify other = (emu.gingerps.net.proto.ServerLogNotifyOuterClass.ServerLogNotify) obj;
    ...
    public static emu.gingerps.net.proto.ServerLogNotifyOuterClass.ServerLogNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.ServerLogNotifyOuterClass.ServerLogNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.ServerLogNotifyOuterClass.ServerLogNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.ServerLogNotifyOuterClass.ServerLogNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.ServerLogNotifyOuterClass.ServerLogNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.ServerLogNotifyOuterClass.ServerLogNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.ServerLogNotifyOuterClass.ServerLogNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.ServerLogNotifyOuterClass.ServerLogNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.ServerLogNotifyOuterClass.internal_static_ServerLogNotify_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.ServerLogNotifyOuterClass.ServerLogNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.ServerLogNotifyOuterClass.ServerLogNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.ServerLogNotifyOuterClass.ServerLogNotify build() {
        emu.gingerps.net.proto.ServerLogNotifyOuterClass.ServerLogNotify result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.ServerLogNotifyOuterClass.ServerLogNotify) {
          return mergeFrom((emu.gingerps.net.proto.ServerLogNotifyOuterClass.ServerLogNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.ServerLogNotifyOuterClass.ServerLogNotify other) {
  ...
  checkByteStringIsUtf8(value);
       ...
       * @return This builder for chaining.
       */
      public Builder setLogLevel(emu.gingerps.net.proto.ServerLogLevelOuterClass.ServerLogLevel value) {
        if (value == null) {
          throw new NullPointerException();
        }
       ...
       * @return This builder for chaining.
       */
      public Builder setLogType(emu.gingerps.net.proto.ServerLogTypeOuterClass.ServerLogType value) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    private static final emu.gingerps.net.proto.ServerLogNotifyOuterClass.ServerLogNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.ServerLogNotifyOuterClass.ServerLogNotify();
    }

    public static emu.gingerps.net.proto.ServerLogNotifyOuterClass.ServerLogNotify getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.ServerLogLevelOuterClass.getDescriptor(),
          emu.gingerps.net.proto.ServerLogTypeOuterClass.getDescriptor(),
        });
    internal_static_ServerLogNotify_descriptor =
