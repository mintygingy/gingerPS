...
public final class HomeFurnitureSuiteDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.HomeFurnitureSuiteDataOuterClass.internal_static_HomeFurnitureSuiteData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData.class, emu.gingerps.net.proto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData other = (emu.gingerps.net.proto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData) obj;
    ...
    public static emu.gingerps.net.proto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData parseFrom(
    ...
    public static emu.gingerps.net.proto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData parseFrom(
    ...
    public static emu.gingerps.net.proto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.HomeFurnitureSuiteDataOuterClass.internal_static_HomeFurnitureSuiteData_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData getDefaultInstanceForType() {
        return emu.gingerps.net.proto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData build() {
        emu.gingerps.net.proto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData) {
          return mergeFrom((emu.gingerps.net.proto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData other) {
        if (other == emu.gingerps.net.proto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData.getDefaultInstance()) return this;
    ...
    private static final emu.gingerps.net.proto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData();
    }

    public static emu.gingerps.net.proto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData getDefaultInstance() {
