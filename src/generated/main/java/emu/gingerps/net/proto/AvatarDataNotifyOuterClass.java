...
public final class AvatarDataNotifyOuterClass {
  ...
  public interface AvatarDataNotifyOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.AvatarInfoOuterClass.AvatarInfo> 
        getAvatarListList();
    /**
     * <code>repeated .AvatarInfo avatar_list = 14;</code>
     */
    emu.gingerps.net.proto.AvatarInfoOuterClass.AvatarInfo getAvatarList(int index);
    /**
     * <code>repeated .AvatarInfo avatar_list = 14;</code>
     */
     ...
     * <code>repeated .AvatarInfo avatar_list = 14;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.AvatarInfoOuterClass.AvatarInfoOrBuilder> 
        getAvatarListOrBuilderList();
    /**
     * <code>repeated .AvatarInfo avatar_list = 14;</code>
     */
    emu.gingerps.net.proto.AvatarInfoOuterClass.AvatarInfoOrBuilder getAvatarListOrBuilder(
        int index);

    /**
     * <code>repeated .AvatarRenameInfo avatar_rename_list = 8;</code>
     */
    java.util.List<emu.gingerps.net.proto.AvatarRenameInfoOuterClass.AvatarRenameInfo> 
        getAvatarRenameListList();
    /**
     * <code>repeated .AvatarRenameInfo avatar_rename_list = 8;</code>
     */
    emu.gingerps.net.proto.AvatarRenameInfoOuterClass.AvatarRenameInfo getAvatarRenameList(int index);
    /**
     * <code>repeated .AvatarRenameInfo avatar_rename_list = 8;</code>
     */
     ...
     * <code>repeated .AvatarRenameInfo avatar_rename_list = 8;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.AvatarRenameInfoOuterClass.AvatarRenameInfoOrBuilder> 
        getAvatarRenameListOrBuilderList();
    /**
     * <code>repeated .AvatarRenameInfo avatar_rename_list = 8;</code>
     */
    emu.gingerps.net.proto.AvatarRenameInfoOuterClass.AvatarRenameInfoOrBuilder getAvatarRenameListOrBuilder(
        int index);
...
emu.gingerps.net.proto.AvatarTeamOuterClass.AvatarTeam defaultValue);
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.AvatarDataNotifyOuterClass.internal_static_AvatarDataNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.AvatarDataNotifyOuterClass.AvatarDataNotify.class, emu.gingerps.net.proto.AvatarDataNotifyOuterClass.AvatarDataNotify.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.AvatarInfoOuterClass.AvatarInfo> getAvatarListList() {
      return avatarList_;
    }
    /**
     * <code>repeated .AvatarInfo avatar_list = 14;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.AvatarInfoOuterClass.AvatarInfoOrBuilder> 
        getAvatarListOrBuilderList() {
      return avatarList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.AvatarInfoOuterClass.AvatarInfo getAvatarList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.AvatarInfoOuterClass.AvatarInfoOrBuilder getAvatarListOrBuilder(
        int index) {
      return avatarList_.get(index);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.AvatarRenameInfoOuterClass.AvatarRenameInfo> getAvatarRenameListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.AvatarRenameInfoOuterClass.AvatarRenameInfoOrBuilder> 
        getAvatarRenameListOrBuilderList() {
      return avatarRenameList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.AvatarRenameInfoOuterClass.AvatarRenameInfo getAvatarRenameList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.AvatarRenameInfoOuterClass.AvatarRenameInfoOrBuilder getAvatarRenameListOrBuilder(
        int index) {
      return avatarRenameList_.get(index);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, emu.gingerps.net.proto.AvatarTeamOuterClass.AvatarTeam> defaultEntry =
              ...
              .<java.lang.Integer, emu.gingerps.net.proto.AvatarTeamOuterClass.AvatarTeam>newDefaultInstance(
                  emu.gingerps.net.proto.AvatarDataNotifyOuterClass.internal_static_AvatarDataNotify_AvatarTeamMapEntry_descriptor, 
...
emu.gingerps.net.proto.AvatarTeamOuterClass.AvatarTeam defaultValue) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.AvatarDataNotifyOuterClass.AvatarDataNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.AvatarDataNotifyOuterClass.AvatarDataNotify other = (emu.gingerps.net.proto.AvatarDataNotifyOuterClass.AvatarDataNotify) obj;
    ...
    public static emu.gingerps.net.proto.AvatarDataNotifyOuterClass.AvatarDataNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.AvatarDataNotifyOuterClass.AvatarDataNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.AvatarDataNotifyOuterClass.AvatarDataNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.AvatarDataNotifyOuterClass.AvatarDataNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.AvatarDataNotifyOuterClass.AvatarDataNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.AvatarDataNotifyOuterClass.AvatarDataNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.AvatarDataNotifyOuterClass.AvatarDataNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.AvatarDataNotifyOuterClass.AvatarDataNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.AvatarDataNotifyOuterClass.internal_static_AvatarDataNotify_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.AvatarDataNotifyOuterClass.AvatarDataNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.AvatarDataNotifyOuterClass.AvatarDataNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.AvatarDataNotifyOuterClass.AvatarDataNotify build() {
        emu.gingerps.net.proto.AvatarDataNotifyOuterClass.AvatarDataNotify result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.AvatarDataNotifyOuterClass.AvatarDataNotify) {
          return mergeFrom((emu.gingerps.net.proto.AvatarDataNotifyOuterClass.AvatarDataNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.AvatarDataNotifyOuterClass.AvatarDataNotify other) {
        if (other == emu.gingerps.net.proto.AvatarDataNotifyOuterClass.AvatarDataNotify.getDefaultInstance()) return this;
        if (avatarListBuilder_ == null) {
      ...
      private void ensureAvatarListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          avatarList_ = new java.util.ArrayList<emu.gingerps.net.proto.AvatarInfoOuterClass.AvatarInfo>(avatarList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.AvatarInfoOuterClass.AvatarInfo, emu.gingerps.net.proto.AvatarInfoOuterClass.AvatarInfo.Builder, emu.gingerps.net.proto.AvatarInfoOuterClass.AvatarInfoOrBuilder> avatarListBuilder_;
      ...
      public Builder setAvatarList(
          int index, emu.gingerps.net.proto.AvatarInfoOuterClass.AvatarInfo value) {
        if (avatarListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setAvatarList(
          int index, emu.gingerps.net.proto.AvatarInfoOuterClass.AvatarInfo.Builder builderForValue) {
        if (avatarListBuilder_ == null) {
          ensureAvatarListIsMutable();
       ...
       * <code>repeated .AvatarInfo avatar_list = 14;</code>
       */
      public Builder addAvatarList(emu.gingerps.net.proto.AvatarInfoOuterClass.AvatarInfo value) {
        if (avatarListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addAllAvatarList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.AvatarInfoOuterClass.AvatarInfo> values) {
        if (avatarListBuilder_ == null) {
          ensureAvatarListIsMutable();
       ...
       * <code>repeated .AvatarInfo avatar_list = 14;</code>
       */
      public emu.gingerps.net.proto.AvatarInfoOuterClass.AvatarInfo.Builder getAvatarListBuilder(
          int index) {
       ...
       * <code>repeated .AvatarInfo avatar_list = 14;</code>
       */
      public emu.gingerps.net.proto.AvatarInfoOuterClass.AvatarInfo.Builder addAvatarListBuilder() {
        return getAvatarListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.AvatarInfoOuterClass.AvatarInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .AvatarInfo avatar_list = 14;</code>
       */
      public emu.gingerps.net.proto.AvatarInfoOuterClass.AvatarInfo.Builder addAvatarListBuilder(
          int index) {
        return getAvatarListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.AvatarInfoOuterClass.AvatarInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .AvatarInfo avatar_list = 14;</code>
       */
      public java.util.List<emu.gingerps.net.proto.AvatarInfoOuterClass.AvatarInfo.Builder> 
      ...
      private void ensureAvatarRenameListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          avatarRenameList_ = new java.util.ArrayList<emu.gingerps.net.proto.AvatarRenameInfoOuterClass.AvatarRenameInfo>(avatarRenameList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.AvatarRenameInfoOuterClass.AvatarRenameInfo, emu.gingerps.net.proto.AvatarRenameInfoOuterClass.AvatarRenameInfo.Builder, emu.gingerps.net.proto.AvatarRenameInfoOuterClass.AvatarRenameInfoOrBuilder> avatarRenameListBuilder_;
      ...
      public Builder setAvatarRenameList(
          int index, emu.gingerps.net.proto.AvatarRenameInfoOuterClass.AvatarRenameInfo value) {
        if (avatarRenameListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setAvatarRenameList(
          int index, emu.gingerps.net.proto.AvatarRenameInfoOuterClass.AvatarRenameInfo.Builder builderForValue) {
        if (avatarRenameListBuilder_ == null) {
          ensureAvatarRenameListIsMutable();
       ...
       * <code>repeated .AvatarRenameInfo avatar_rename_list = 8;</code>
       */
      public Builder addAvatarRenameList(emu.gingerps.net.proto.AvatarRenameInfoOuterClass.AvatarRenameInfo value) {
        if (avatarRenameListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addAvatarRenameList(
          emu.gingerps.net.proto.AvatarRenameInfoOuterClass.AvatarRenameInfo.Builder builderForValue) {
        if (avatarRenameListBuilder_ == null) {
          ensureAvatarRenameListIsMutable();
      ...
      public Builder addAllAvatarRenameList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.AvatarRenameInfoOuterClass.AvatarRenameInfo> values) {
        if (avatarRenameListBuilder_ == null) {
          ensureAvatarRenameListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .AvatarRenameInfo avatar_rename_list = 8;</code>
       */
      public emu.gingerps.net.proto.AvatarRenameInfoOuterClass.AvatarRenameInfo.Builder getAvatarRenameListBuilder(
          int index) {
       ...
       * <code>repeated .AvatarRenameInfo avatar_rename_list = 8;</code>
       */
      public emu.gingerps.net.proto.AvatarRenameInfoOuterClass.AvatarRenameInfo.Builder addAvatarRenameListBuilder() {
        return getAvatarRenameListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.AvatarRenameInfoOuterClass.AvatarRenameInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .AvatarRenameInfo avatar_rename_list = 8;</code>
       */
      public emu.gingerps.net.proto.AvatarRenameInfoOuterClass.AvatarRenameInfo.Builder addAvatarRenameListBuilder(
          int index) {
        return getAvatarRenameListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.AvatarRenameInfoOuterClass.AvatarRenameInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .AvatarRenameInfo avatar_rename_list = 8;</code>
       */
      public java.util.List<emu.gingerps.net.proto.AvatarRenameInfoOuterClass.AvatarRenameInfo.Builder> 
           getAvatarRenameListBuilderList() {
        return getAvatarRenameListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.AvatarRenameInfoOuterClass.AvatarRenameInfo, emu.gingerps.net.proto.AvatarRenameInfoOuterClass.AvatarRenameInfo.Builder, emu.gingerps.net.proto.AvatarRenameInfoOuterClass.AvatarRenameInfoOrBuilder> 
...
emu.gingerps.net.proto.AvatarTeamOuterClass.AvatarTeam defaultValue) {
    ...
    private static final emu.gingerps.net.proto.AvatarDataNotifyOuterClass.AvatarDataNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.AvatarDataNotifyOuterClass.AvatarDataNotify();
    }

    public static emu.gingerps.net.proto.AvatarDataNotifyOuterClass.AvatarDataNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "(\0132\013.AvatarTeam:\0028\001B\030\n\026emu.gingerps.net." +
      "protob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          ...
          emu.gingerps.net.proto.AvatarRenameInfoOuterClass.getDescriptor(),
