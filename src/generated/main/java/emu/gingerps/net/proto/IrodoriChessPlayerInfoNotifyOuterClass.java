...
public final class IrodoriChessPlayerInfoNotifyOuterClass {
  ...
  public interface IrodoriChessPlayerInfoNotifyOrBuilder extends
     ...
     */
    emu.gingerps.net.proto.IrodoriChessPlayerInfoOuterClass.IrodoriChessPlayerInfo getPlayerInfo();
    /**
     * <code>.IrodoriChessPlayerInfo player_info = 10;</code>
     */
    emu.gingerps.net.proto.IrodoriChessPlayerInfoOuterClass.IrodoriChessPlayerInfoOrBuilder getPlayerInfoOrBuilder();
  }
  /**
   * <pre>
   * enum CmdId {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.IrodoriChessPlayerInfoNotifyOuterClass.internal_static_IrodoriChessPlayerInfoNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.IrodoriChessPlayerInfoNotifyOuterClass.IrodoriChessPlayerInfoNotify.class, emu.gingerps.net.proto.IrodoriChessPlayerInfoNotifyOuterClass.IrodoriChessPlayerInfoNotify.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.IrodoriChessPlayerInfoOuterClass.IrodoriChessPlayerInfo getPlayerInfo() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.IrodoriChessPlayerInfoNotifyOuterClass.IrodoriChessPlayerInfoNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.IrodoriChessPlayerInfoNotifyOuterClass.IrodoriChessPlayerInfoNotify other = (emu.gingerps.net.proto.IrodoriChessPlayerInfoNotifyOuterClass.IrodoriChessPlayerInfoNotify) obj;
    ...
    public static emu.gingerps.net.proto.IrodoriChessPlayerInfoNotifyOuterClass.IrodoriChessPlayerInfoNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.IrodoriChessPlayerInfoNotifyOuterClass.IrodoriChessPlayerInfoNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.IrodoriChessPlayerInfoNotifyOuterClass.IrodoriChessPlayerInfoNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.IrodoriChessPlayerInfoNotifyOuterClass.IrodoriChessPlayerInfoNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.IrodoriChessPlayerInfoNotifyOuterClass.IrodoriChessPlayerInfoNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.IrodoriChessPlayerInfoNotifyOuterClass.IrodoriChessPlayerInfoNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.IrodoriChessPlayerInfoNotifyOuterClass.IrodoriChessPlayerInfoNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.IrodoriChessPlayerInfoNotifyOuterClass.IrodoriChessPlayerInfoNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.IrodoriChessPlayerInfoNotifyOuterClass.internal_static_IrodoriChessPlayerInfoNotify_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.IrodoriChessPlayerInfoNotifyOuterClass.IrodoriChessPlayerInfoNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.IrodoriChessPlayerInfoNotifyOuterClass.IrodoriChessPlayerInfoNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.IrodoriChessPlayerInfoNotifyOuterClass.IrodoriChessPlayerInfoNotify build() {
        emu.gingerps.net.proto.IrodoriChessPlayerInfoNotifyOuterClass.IrodoriChessPlayerInfoNotify result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.IrodoriChessPlayerInfoNotifyOuterClass.IrodoriChessPlayerInfoNotify) {
          return mergeFrom((emu.gingerps.net.proto.IrodoriChessPlayerInfoNotifyOuterClass.IrodoriChessPlayerInfoNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.IrodoriChessPlayerInfoNotifyOuterClass.IrodoriChessPlayerInfoNotify other) {
        if (other == emu.gingerps.net.proto.IrodoriChessPlayerInfoNotifyOuterClass.IrodoriChessPlayerInfoNotify.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.IrodoriChessPlayerInfoOuterClass.IrodoriChessPlayerInfo, emu.gingerps.net.proto.IrodoriChessPlayerInfoOuterClass.IrodoriChessPlayerInfo.Builder, emu.gingerps.net.proto.IrodoriChessPlayerInfoOuterClass.IrodoriChessPlayerInfoOrBuilder> playerInfoBuilder_;
      /**
       * <code>.IrodoriChessPlayerInfo player_info = 10;</code>
       * @return Whether the playerInfo field is set.
       */
       ...
       * <code>.IrodoriChessPlayerInfo player_info = 10;</code>
       */
      public Builder setPlayerInfo(emu.gingerps.net.proto.IrodoriChessPlayerInfoOuterClass.IrodoriChessPlayerInfo value) {
        if (playerInfoBuilder_ == null) {
          if (value == null) {
      ...
      public emu.gingerps.net.proto.IrodoriChessPlayerInfoOuterClass.IrodoriChessPlayerInfoOrBuilder getPlayerInfoOrBuilder() {
        if (playerInfoBuilder_ != null) {
          ...
          return playerInfo_ == null ?
              emu.gingerps.net.proto.IrodoriChessPlayerInfoOuterClass.IrodoriChessPlayerInfo.getDefaultInstance() : playerInfo_;
        }
      }
      /**
       * <code>.IrodoriChessPlayerInfo player_info = 10;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.IrodoriChessPlayerInfoOuterClass.IrodoriChessPlayerInfo, emu.gingerps.net.proto.IrodoriChessPlayerInfoOuterClass.IrodoriChessPlayerInfo.Builder, emu.gingerps.net.proto.IrodoriChessPlayerInfoOuterClass.IrodoriChessPlayerInfoOrBuilder> 
    ...
    private static final emu.gingerps.net.proto.IrodoriChessPlayerInfoNotifyOuterClass.IrodoriChessPlayerInfoNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.IrodoriChessPlayerInfoNotifyOuterClass.IrodoriChessPlayerInfoNotify();
    }

    public static emu.gingerps.net.proto.IrodoriChessPlayerInfoNotifyOuterClass.IrodoriChessPlayerInfoNotify getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.IrodoriChessPlayerInfoOuterClass.getDescriptor(),
        });
    internal_static_IrodoriChessPlayerInfoNotify_descriptor =
