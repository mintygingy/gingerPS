...
public final class DoGachaRspOuterClass {
  ...
  public interface DoGachaRspOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.GachaItemOuterClass.GachaItem> 
        getGachaItemListList();
    /**
     * <code>repeated .GachaItem gacha_item_list = 9;</code>
     */
    emu.gingerps.net.proto.GachaItemOuterClass.GachaItem getGachaItemList(int index);
    /**
     * <code>repeated .GachaItem gacha_item_list = 9;</code>
     */
     ...
     * <code>repeated .GachaItem gacha_item_list = 9;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.GachaItemOuterClass.GachaItemOrBuilder> 
        getGachaItemListOrBuilderList();
    /**
     * <code>repeated .GachaItem gacha_item_list = 9;</code>
     */
    emu.gingerps.net.proto.GachaItemOuterClass.GachaItemOrBuilder getGachaItemListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 74: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                gachaItemList_ = new java.util.ArrayList<emu.gingerps.net.proto.GachaItemOuterClass.GachaItem>();
                mutable_bitField0_ |= 0x00000001;
              }
              gachaItemList_.add(
                  input.readMessage(emu.gingerps.net.proto.GachaItemOuterClass.GachaItem.parser(), extensionRegistry));
              break;
            }
            case 80: {
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.gingerps.net.proto.DoGachaRspOuterClass.internal_static_DoGachaRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.gingerps.net.proto.DoGachaRspOuterClass.internal_static_DoGachaRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.DoGachaRspOuterClass.DoGachaRsp.class, emu.gingerps.net.proto.DoGachaRspOuterClass.DoGachaRsp.Builder.class);
    }
    ...
    private java.util.List<emu.gingerps.net.proto.GachaItemOuterClass.GachaItem> gachaItemList_;
    /**
     * <code>repeated .GachaItem gacha_item_list = 9;</code>
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.GachaItemOuterClass.GachaItem> getGachaItemListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.GachaItemOuterClass.GachaItemOrBuilder> 
        getGachaItemListOrBuilderList() {
      return gachaItemList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.GachaItemOuterClass.GachaItem getGachaItemList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.GachaItemOuterClass.GachaItemOrBuilder getGachaItemListOrBuilder(
        int index) {
      return gachaItemList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.DoGachaRspOuterClass.DoGachaRsp)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.DoGachaRspOuterClass.DoGachaRsp other = (emu.gingerps.net.proto.DoGachaRspOuterClass.DoGachaRsp) obj;
    ...
    public static emu.gingerps.net.proto.DoGachaRspOuterClass.DoGachaRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.DoGachaRspOuterClass.DoGachaRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.DoGachaRspOuterClass.DoGachaRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.DoGachaRspOuterClass.DoGachaRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.DoGachaRspOuterClass.DoGachaRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.DoGachaRspOuterClass.DoGachaRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.DoGachaRspOuterClass.DoGachaRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.DoGachaRspOuterClass.DoGachaRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.DoGachaRspOuterClass.internal_static_DoGachaRsp_descriptor;
      }
      ...
      // Construct using emu.gingerps.net.proto.DoGachaRspOuterClass.DoGachaRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.DoGachaRspOuterClass.DoGachaRsp getDefaultInstanceForType() {
        return emu.gingerps.net.proto.DoGachaRspOuterClass.DoGachaRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.DoGachaRspOuterClass.DoGachaRsp build() {
        emu.gingerps.net.proto.DoGachaRspOuterClass.DoGachaRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.DoGachaRspOuterClass.DoGachaRsp buildPartial() {
        emu.gingerps.net.proto.DoGachaRspOuterClass.DoGachaRsp result = new emu.gingerps.net.proto.DoGachaRspOuterClass.DoGachaRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.DoGachaRspOuterClass.DoGachaRsp) {
          return mergeFrom((emu.gingerps.net.proto.DoGachaRspOuterClass.DoGachaRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.DoGachaRspOuterClass.DoGachaRsp other) {
        if (other == emu.gingerps.net.proto.DoGachaRspOuterClass.DoGachaRsp.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        emu.gingerps.net.proto.DoGachaRspOuterClass.DoGachaRsp parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (emu.gingerps.net.proto.DoGachaRspOuterClass.DoGachaRsp) e.getUnfinishedMessage();
      ...
      private void ensureGachaItemListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          gachaItemList_ = new java.util.ArrayList<emu.gingerps.net.proto.GachaItemOuterClass.GachaItem>(gachaItemList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.GachaItemOuterClass.GachaItem, emu.gingerps.net.proto.GachaItemOuterClass.GachaItem.Builder, emu.gingerps.net.proto.GachaItemOuterClass.GachaItemOrBuilder> gachaItemListBuilder_;
      ...
      public Builder setGachaItemList(
          int index, emu.gingerps.net.proto.GachaItemOuterClass.GachaItem value) {
        if (gachaItemListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setGachaItemList(
          int index, emu.gingerps.net.proto.GachaItemOuterClass.GachaItem.Builder builderForValue) {
        if (gachaItemListBuilder_ == null) {
          ensureGachaItemListIsMutable();
       ...
       * <code>repeated .GachaItem gacha_item_list = 9;</code>
       */
      public Builder addGachaItemList(emu.gingerps.net.proto.GachaItemOuterClass.GachaItem value) {
        if (gachaItemListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addGachaItemList(
          emu.gingerps.net.proto.GachaItemOuterClass.GachaItem.Builder builderForValue) {
        if (gachaItemListBuilder_ == null) {
          ensureGachaItemListIsMutable();
      ...
      public Builder addAllGachaItemList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.GachaItemOuterClass.GachaItem> values) {
        if (gachaItemListBuilder_ == null) {
          ensureGachaItemListIsMutable();
       ...
       * <code>repeated .GachaItem gacha_item_list = 9;</code>
       */
      public emu.gingerps.net.proto.GachaItemOuterClass.GachaItem.Builder getGachaItemListBuilder(
          int index) {
       ...
       * <code>repeated .GachaItem gacha_item_list = 9;</code>
       */
      public emu.gingerps.net.proto.GachaItemOuterClass.GachaItem.Builder addGachaItemListBuilder() {
        return getGachaItemListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.GachaItemOuterClass.GachaItem.getDefaultInstance());
      }
      /**
       * <code>repeated .GachaItem gacha_item_list = 9;</code>
       */
      public emu.gingerps.net.proto.GachaItemOuterClass.GachaItem.Builder addGachaItemListBuilder(
          int index) {
        return getGachaItemListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.GachaItemOuterClass.GachaItem.getDefaultInstance());
      }
      /**
       * <code>repeated .GachaItem gacha_item_list = 9;</code>
       */
      public java.util.List<emu.gingerps.net.proto.GachaItemOuterClass.GachaItem.Builder> 
           getGachaItemListBuilderList() {
        return getGachaItemListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.GachaItemOuterClass.GachaItem, emu.gingerps.net.proto.GachaItemOuterClass.GachaItem.Builder, emu.gingerps.net.proto.GachaItemOuterClass.GachaItemOrBuilder> 
          getGachaItemListFieldBuilder() {
        if (gachaItemListBuilder_ == null) {
    ...
    private static final emu.gingerps.net.proto.DoGachaRspOuterClass.DoGachaRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.DoGachaRspOuterClass.DoGachaRsp();
    }

    public static emu.gingerps.net.proto.DoGachaRspOuterClass.DoGachaRsp getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "_item_num\030\002 \001(\r\022\034\n\023Unk3300_HLANONBCBLM\030\216" +
      "\014 \001(\r\022\024\n\014cost_item_id\030\007 \001(\r\022\031\n\021gacha_sch" +
      "edule_id\030\016 \001(\r\022\032\n\021daily_gacha_times\030\323\003 \001" +
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.GachaItemOuterClass.getDescriptor(),
        });
    internal_static_DoGachaRsp_descriptor =
    ...
    internal_static_DoGachaRsp_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_DoGachaRsp_descriptor,
        new java.lang.String[] { "Unk3300OHFMHIHJHPJ", "LeftGachaTimes", "GachaItemList", "Unk3300HBILIAEIHNK", "GachaType", "NewGachaRandom", "WishProgress", "WishMaxProgress", "GachaTimes", "GachaTimesLimit", "WishItemId", "TenCostItemId", "CostItemNum", "TenCostItemNum", "Unk3300HLANONBCBLM", "CostItemId", "GachaScheduleId", "DailyGachaTimes", "Retcode", });
    emu.gingerps.net.proto.GachaItemOuterClass.getDescriptor();
  }
