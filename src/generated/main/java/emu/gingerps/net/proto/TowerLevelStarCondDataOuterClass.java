...
public final class TowerLevelStarCondDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.TowerLevelStarCondDataOuterClass.internal_static_TowerLevelStarCondData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData.class, emu.gingerps.net.proto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData other = (emu.gingerps.net.proto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData) obj;
    ...
    public static emu.gingerps.net.proto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData parseFrom(
    ...
    public static emu.gingerps.net.proto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData parseFrom(
    ...
    public static emu.gingerps.net.proto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.TowerLevelStarCondDataOuterClass.internal_static_TowerLevelStarCondData_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData getDefaultInstanceForType() {
        return emu.gingerps.net.proto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData build() {
        emu.gingerps.net.proto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData) {
          return mergeFrom((emu.gingerps.net.proto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData other) {
        if (other == emu.gingerps.net.proto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData.getDefaultInstance()) return this;
    ...
    private static final emu.gingerps.net.proto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData();
    }

    public static emu.gingerps.net.proto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData getDefaultInstance() {
