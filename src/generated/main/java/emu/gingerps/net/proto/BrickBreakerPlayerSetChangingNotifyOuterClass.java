...
public final class BrickBreakerPlayerSetChangingNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.BrickBreakerPlayerSetChangingNotifyOuterClass.internal_static_BrickBreakerPlayerSetChangingNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.BrickBreakerPlayerSetChangingNotifyOuterClass.BrickBreakerPlayerSetChangingNotify.class, emu.gingerps.net.proto.BrickBreakerPlayerSetChangingNotifyOuterClass.BrickBreakerPlayerSetChangingNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.BrickBreakerPlayerSetChangingNotifyOuterClass.BrickBreakerPlayerSetChangingNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.BrickBreakerPlayerSetChangingNotifyOuterClass.BrickBreakerPlayerSetChangingNotify other = (emu.gingerps.net.proto.BrickBreakerPlayerSetChangingNotifyOuterClass.BrickBreakerPlayerSetChangingNotify) obj;
    ...
    public static emu.gingerps.net.proto.BrickBreakerPlayerSetChangingNotifyOuterClass.BrickBreakerPlayerSetChangingNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.BrickBreakerPlayerSetChangingNotifyOuterClass.BrickBreakerPlayerSetChangingNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.BrickBreakerPlayerSetChangingNotifyOuterClass.BrickBreakerPlayerSetChangingNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.BrickBreakerPlayerSetChangingNotifyOuterClass.BrickBreakerPlayerSetChangingNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.BrickBreakerPlayerSetChangingNotifyOuterClass.BrickBreakerPlayerSetChangingNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.BrickBreakerPlayerSetChangingNotifyOuterClass.BrickBreakerPlayerSetChangingNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.BrickBreakerPlayerSetChangingNotifyOuterClass.BrickBreakerPlayerSetChangingNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.BrickBreakerPlayerSetChangingNotifyOuterClass.BrickBreakerPlayerSetChangingNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.BrickBreakerPlayerSetChangingNotifyOuterClass.internal_static_BrickBreakerPlayerSetChangingNotify_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.BrickBreakerPlayerSetChangingNotifyOuterClass.BrickBreakerPlayerSetChangingNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.BrickBreakerPlayerSetChangingNotifyOuterClass.BrickBreakerPlayerSetChangingNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.BrickBreakerPlayerSetChangingNotifyOuterClass.BrickBreakerPlayerSetChangingNotify build() {
        emu.gingerps.net.proto.BrickBreakerPlayerSetChangingNotifyOuterClass.BrickBreakerPlayerSetChangingNotify result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.BrickBreakerPlayerSetChangingNotifyOuterClass.BrickBreakerPlayerSetChangingNotify) {
          return mergeFrom((emu.gingerps.net.proto.BrickBreakerPlayerSetChangingNotifyOuterClass.BrickBreakerPlayerSetChangingNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.BrickBreakerPlayerSetChangingNotifyOuterClass.BrickBreakerPlayerSetChangingNotify other) {
        if (other == emu.gingerps.net.proto.BrickBreakerPlayerSetChangingNotifyOuterClass.BrickBreakerPlayerSetChangingNotify.getDefaultInstance()) return this;
        if (other.getUid() != 0) {
          setUid(other.getUid());
        }
    ...
    private static final emu.gingerps.net.proto.BrickBreakerPlayerSetChangingNotifyOuterClass.BrickBreakerPlayerSetChangingNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.BrickBreakerPlayerSetChangingNotifyOuterClass.BrickBreakerPlayerSetChangingNotify();
    }

    public static emu.gingerps.net.proto.BrickBreakerPlayerSetChangingNotifyOuterClass.BrickBreakerPlayerSetChangingNotify getDefaultInstance() {
