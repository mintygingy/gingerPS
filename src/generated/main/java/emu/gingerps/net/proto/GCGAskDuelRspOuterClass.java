...
public final class GCGAskDuelRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.GCGAskDuelRspOuterClass.internal_static_GCGAskDuelRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.GCGAskDuelRspOuterClass.GCGAskDuelRsp.class, emu.gingerps.net.proto.GCGAskDuelRspOuterClass.GCGAskDuelRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.GCGAskDuelRspOuterClass.GCGAskDuelRsp)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.GCGAskDuelRspOuterClass.GCGAskDuelRsp other = (emu.gingerps.net.proto.GCGAskDuelRspOuterClass.GCGAskDuelRsp) obj;
    ...
    public static emu.gingerps.net.proto.GCGAskDuelRspOuterClass.GCGAskDuelRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.GCGAskDuelRspOuterClass.GCGAskDuelRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.GCGAskDuelRspOuterClass.GCGAskDuelRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.GCGAskDuelRspOuterClass.GCGAskDuelRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.GCGAskDuelRspOuterClass.GCGAskDuelRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.GCGAskDuelRspOuterClass.GCGAskDuelRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.GCGAskDuelRspOuterClass.GCGAskDuelRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.GCGAskDuelRspOuterClass.GCGAskDuelRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.GCGAskDuelRspOuterClass.internal_static_GCGAskDuelRsp_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.GCGAskDuelRspOuterClass.GCGAskDuelRsp getDefaultInstanceForType() {
        return emu.gingerps.net.proto.GCGAskDuelRspOuterClass.GCGAskDuelRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.GCGAskDuelRspOuterClass.GCGAskDuelRsp build() {
        emu.gingerps.net.proto.GCGAskDuelRspOuterClass.GCGAskDuelRsp result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.GCGAskDuelRspOuterClass.GCGAskDuelRsp) {
          return mergeFrom((emu.gingerps.net.proto.GCGAskDuelRspOuterClass.GCGAskDuelRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.GCGAskDuelRspOuterClass.GCGAskDuelRsp other) {
        if (other == emu.gingerps.net.proto.GCGAskDuelRspOuterClass.GCGAskDuelRsp.getDefaultInstance()) return this;
        if (other.hasDuel()) {
      ...
      public emu.gingerps.net.proto.GCGDuelOuterClass.GCGDuelOrBuilder getDuelOrBuilder() {
        if (duelBuilder_ != null) {
          ...
          return duel_ == null ?
              emu.gingerps.net.proto.GCGDuelOuterClass.GCGDuel.getDefaultInstance() : duel_;
        }
      }
      /**
       * <code>.GCGDuel duel = 9;</code>
    ...
    private static final emu.gingerps.net.proto.GCGAskDuelRspOuterClass.GCGAskDuelRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.GCGAskDuelRspOuterClass.GCGAskDuelRsp();
    }

    public static emu.gingerps.net.proto.GCGAskDuelRspOuterClass.GCGAskDuelRsp getDefaultInstance() {
