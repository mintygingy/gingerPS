...
public final class ShowMessageNotifyOuterClass {
  ...
  public interface ShowMessageNotifyOrBuilder extends
     ...
     * @return The msgId.
     */
    emu.gingerps.net.proto.SvrMsgIdOuterClass.SvrMsgId getMsgId();

    /**
     * <code>repeated .MsgParam params = 10;</code>
     */
    java.util.List<emu.gingerps.net.proto.MsgParamOuterClass.MsgParam> 
        getParamsList();
    /**
     * <code>repeated .MsgParam params = 10;</code>
     */
    emu.gingerps.net.proto.MsgParamOuterClass.MsgParam getParams(int index);
    /**
     * <code>repeated .MsgParam params = 10;</code>
     */
    int getParamsCount();
     ...
     * <code>repeated .MsgParam params = 10;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.MsgParamOuterClass.MsgParamOrBuilder> 
        getParamsOrBuilderList();
    /**
     * <code>repeated .MsgParam params = 10;</code>
     */
    emu.gingerps.net.proto.MsgParamOuterClass.MsgParamOrBuilder getParamsOrBuilder(
        int index);
  }
  /**
   * <pre>
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.ShowMessageNotifyOuterClass.internal_static_ShowMessageNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.ShowMessageNotifyOuterClass.ShowMessageNotify.class, emu.gingerps.net.proto.ShowMessageNotifyOuterClass.ShowMessageNotify.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.MsgParamOuterClass.MsgParam> getParamsList() {
      return params_;
    }
    /**
     * <code>repeated .MsgParam params = 10;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.MsgParamOuterClass.MsgParamOrBuilder> 
        getParamsOrBuilderList() {
      return params_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.MsgParamOuterClass.MsgParam getParams(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.MsgParamOuterClass.MsgParamOrBuilder getParamsOrBuilder(
        int index) {
      return params_.get(index);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (msgId_ != emu.gingerps.net.proto.SvrMsgIdOuterClass.SvrMsgId.SVR_MSG_ID_UNKNOWN.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.ShowMessageNotifyOuterClass.ShowMessageNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.ShowMessageNotifyOuterClass.ShowMessageNotify other = (emu.gingerps.net.proto.ShowMessageNotifyOuterClass.ShowMessageNotify) obj;
    ...
    public static emu.gingerps.net.proto.ShowMessageNotifyOuterClass.ShowMessageNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.ShowMessageNotifyOuterClass.ShowMessageNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.ShowMessageNotifyOuterClass.ShowMessageNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.ShowMessageNotifyOuterClass.ShowMessageNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.ShowMessageNotifyOuterClass.ShowMessageNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.ShowMessageNotifyOuterClass.ShowMessageNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.ShowMessageNotifyOuterClass.ShowMessageNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.ShowMessageNotifyOuterClass.ShowMessageNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.ShowMessageNotifyOuterClass.internal_static_ShowMessageNotify_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.ShowMessageNotifyOuterClass.ShowMessageNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.ShowMessageNotifyOuterClass.ShowMessageNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.ShowMessageNotifyOuterClass.ShowMessageNotify build() {
        emu.gingerps.net.proto.ShowMessageNotifyOuterClass.ShowMessageNotify result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.ShowMessageNotifyOuterClass.ShowMessageNotify) {
          return mergeFrom((emu.gingerps.net.proto.ShowMessageNotifyOuterClass.ShowMessageNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.ShowMessageNotifyOuterClass.ShowMessageNotify other) {
        if (other == emu.gingerps.net.proto.ShowMessageNotifyOuterClass.ShowMessageNotify.getDefaultInstance()) return this;
        if (other.msgId_ != 0) {
       ...
       * @return This builder for chaining.
       */
      public Builder setMsgId(emu.gingerps.net.proto.SvrMsgIdOuterClass.SvrMsgId value) {
        if (value == null) {
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.MsgParamOuterClass.MsgParam, emu.gingerps.net.proto.MsgParamOuterClass.MsgParam.Builder, emu.gingerps.net.proto.MsgParamOuterClass.MsgParamOrBuilder> paramsBuilder_;
      ...
      public Builder setParams(
          int index, emu.gingerps.net.proto.MsgParamOuterClass.MsgParam value) {
        if (paramsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setParams(
          int index, emu.gingerps.net.proto.MsgParamOuterClass.MsgParam.Builder builderForValue) {
        if (paramsBuilder_ == null) {
          ensureParamsIsMutable();
       ...
       * <code>repeated .MsgParam params = 10;</code>
       */
      public Builder addParams(emu.gingerps.net.proto.MsgParamOuterClass.MsgParam value) {
        if (paramsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addParams(
          emu.gingerps.net.proto.MsgParamOuterClass.MsgParam.Builder builderForValue) {
        if (paramsBuilder_ == null) {
          ensureParamsIsMutable();
      ...
      public Builder addAllParams(
          java.lang.Iterable<? extends emu.gingerps.net.proto.MsgParamOuterClass.MsgParam> values) {
        if (paramsBuilder_ == null) {
          ensureParamsIsMutable();
       ...
       * <code>repeated .MsgParam params = 10;</code>
       */
      public emu.gingerps.net.proto.MsgParamOuterClass.MsgParam.Builder getParamsBuilder(
          int index) {
       ...
       * <code>repeated .MsgParam params = 10;</code>
       */
      public emu.gingerps.net.proto.MsgParamOuterClass.MsgParam.Builder addParamsBuilder() {
        return getParamsFieldBuilder().addBuilder(
            emu.gingerps.net.proto.MsgParamOuterClass.MsgParam.getDefaultInstance());
      }
      /**
       * <code>repeated .MsgParam params = 10;</code>
       */
      public emu.gingerps.net.proto.MsgParamOuterClass.MsgParam.Builder addParamsBuilder(
          int index) {
        return getParamsFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.MsgParamOuterClass.MsgParam.getDefaultInstance());
      }
      /**
       * <code>repeated .MsgParam params = 10;</code>
       */
      public java.util.List<emu.gingerps.net.proto.MsgParamOuterClass.MsgParam.Builder> 
    ...
    private static final emu.gingerps.net.proto.ShowMessageNotifyOuterClass.ShowMessageNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.ShowMessageNotifyOuterClass.ShowMessageNotify();
    }

    public static emu.gingerps.net.proto.ShowMessageNotifyOuterClass.ShowMessageNotify getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.MsgParamOuterClass.getDescriptor(),
          emu.gingerps.net.proto.SvrMsgIdOuterClass.getDescriptor(),
        });
    internal_static_ShowMessageNotify_descriptor =
