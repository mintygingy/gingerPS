...
public final class BlitzRushActivityDetailInfoOuterClass {
  ...
  public interface BlitzRushActivityDetailInfoOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.ParkourLevelInfoOuterClass.ParkourLevelInfo> 
        getParkourLevelInfoListList();
    /**
     * <code>repeated .ParkourLevelInfo parkour_level_info_list = 4;</code>
     */
    emu.gingerps.net.proto.ParkourLevelInfoOuterClass.ParkourLevelInfo getParkourLevelInfoList(int index);
    /**
     * <code>repeated .ParkourLevelInfo parkour_level_info_list = 4;</code>
     */
     ...
     * <code>repeated .ParkourLevelInfo parkour_level_info_list = 4;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.ParkourLevelInfoOuterClass.ParkourLevelInfoOrBuilder> 
        getParkourLevelInfoListOrBuilderList();
    /**
     * <code>repeated .ParkourLevelInfo parkour_level_info_list = 4;</code>
     */
    emu.gingerps.net.proto.ParkourLevelInfoOuterClass.ParkourLevelInfoOrBuilder getParkourLevelInfoListOrBuilder(
        int index);

    /**
     * <code>repeated .BlitzRushStage stage_list = 6;</code>
     */
    java.util.List<emu.gingerps.net.proto.BlitzRushStageOuterClass.BlitzRushStage> 
        getStageListList();
    /**
     * <code>repeated .BlitzRushStage stage_list = 6;</code>
     */
    emu.gingerps.net.proto.BlitzRushStageOuterClass.BlitzRushStage getStageList(int index);
    /**
     * <code>repeated .BlitzRushStage stage_list = 6;</code>
     */
     ...
     * <code>repeated .BlitzRushStage stage_list = 6;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.BlitzRushStageOuterClass.BlitzRushStageOrBuilder> 
        getStageListOrBuilderList();
    /**
     * <code>repeated .BlitzRushStage stage_list = 6;</code>
     */
    emu.gingerps.net.proto.BlitzRushStageOuterClass.BlitzRushStageOrBuilder getStageListOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.BlitzRushActivityDetailInfoOuterClass.internal_static_BlitzRushActivityDetailInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.BlitzRushActivityDetailInfoOuterClass.BlitzRushActivityDetailInfo.class, emu.gingerps.net.proto.BlitzRushActivityDetailInfoOuterClass.BlitzRushActivityDetailInfo.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.ParkourLevelInfoOuterClass.ParkourLevelInfo> getParkourLevelInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.ParkourLevelInfoOuterClass.ParkourLevelInfoOrBuilder> 
        getParkourLevelInfoListOrBuilderList() {
      return parkourLevelInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.ParkourLevelInfoOuterClass.ParkourLevelInfo getParkourLevelInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.ParkourLevelInfoOuterClass.ParkourLevelInfoOrBuilder getParkourLevelInfoListOrBuilder(
        int index) {
      return parkourLevelInfoList_.get(index);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.BlitzRushStageOuterClass.BlitzRushStage> getStageListList() {
      return stageList_;
    }
    /**
     * <code>repeated .BlitzRushStage stage_list = 6;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.BlitzRushStageOuterClass.BlitzRushStageOrBuilder> 
        getStageListOrBuilderList() {
      return stageList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.BlitzRushStageOuterClass.BlitzRushStage getStageList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.BlitzRushStageOuterClass.BlitzRushStageOrBuilder getStageListOrBuilder(
        int index) {
      return stageList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.BlitzRushActivityDetailInfoOuterClass.BlitzRushActivityDetailInfo)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.BlitzRushActivityDetailInfoOuterClass.BlitzRushActivityDetailInfo other = (emu.gingerps.net.proto.BlitzRushActivityDetailInfoOuterClass.BlitzRushActivityDetailInfo) obj;
    ...
    public static emu.gingerps.net.proto.BlitzRushActivityDetailInfoOuterClass.BlitzRushActivityDetailInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.BlitzRushActivityDetailInfoOuterClass.BlitzRushActivityDetailInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.BlitzRushActivityDetailInfoOuterClass.BlitzRushActivityDetailInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.BlitzRushActivityDetailInfoOuterClass.BlitzRushActivityDetailInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.BlitzRushActivityDetailInfoOuterClass.BlitzRushActivityDetailInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.BlitzRushActivityDetailInfoOuterClass.BlitzRushActivityDetailInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.BlitzRushActivityDetailInfoOuterClass.BlitzRushActivityDetailInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.BlitzRushActivityDetailInfoOuterClass.BlitzRushActivityDetailInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.BlitzRushActivityDetailInfoOuterClass.internal_static_BlitzRushActivityDetailInfo_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.BlitzRushActivityDetailInfoOuterClass.BlitzRushActivityDetailInfo getDefaultInstanceForType() {
        return emu.gingerps.net.proto.BlitzRushActivityDetailInfoOuterClass.BlitzRushActivityDetailInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.BlitzRushActivityDetailInfoOuterClass.BlitzRushActivityDetailInfo build() {
        emu.gingerps.net.proto.BlitzRushActivityDetailInfoOuterClass.BlitzRushActivityDetailInfo result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.BlitzRushActivityDetailInfoOuterClass.BlitzRushActivityDetailInfo) {
          return mergeFrom((emu.gingerps.net.proto.BlitzRushActivityDetailInfoOuterClass.BlitzRushActivityDetailInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.BlitzRushActivityDetailInfoOuterClass.BlitzRushActivityDetailInfo other) {
        if (other == emu.gingerps.net.proto.BlitzRushActivityDetailInfoOuterClass.BlitzRushActivityDetailInfo.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.ParkourLevelInfoOuterClass.ParkourLevelInfo, emu.gingerps.net.proto.ParkourLevelInfoOuterClass.ParkourLevelInfo.Builder, emu.gingerps.net.proto.ParkourLevelInfoOuterClass.ParkourLevelInfoOrBuilder> parkourLevelInfoListBuilder_;
      ...
      public Builder setParkourLevelInfoList(
          int index, emu.gingerps.net.proto.ParkourLevelInfoOuterClass.ParkourLevelInfo value) {
        if (parkourLevelInfoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setParkourLevelInfoList(
          int index, emu.gingerps.net.proto.ParkourLevelInfoOuterClass.ParkourLevelInfo.Builder builderForValue) {
        if (parkourLevelInfoListBuilder_ == null) {
          ensureParkourLevelInfoListIsMutable();
       ...
       * <code>repeated .ParkourLevelInfo parkour_level_info_list = 4;</code>
       */
      public Builder addParkourLevelInfoList(emu.gingerps.net.proto.ParkourLevelInfoOuterClass.ParkourLevelInfo value) {
        if (parkourLevelInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addParkourLevelInfoList(
          emu.gingerps.net.proto.ParkourLevelInfoOuterClass.ParkourLevelInfo.Builder builderForValue) {
        if (parkourLevelInfoListBuilder_ == null) {
          ensureParkourLevelInfoListIsMutable();
      ...
      public Builder addAllParkourLevelInfoList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.ParkourLevelInfoOuterClass.ParkourLevelInfo> values) {
        if (parkourLevelInfoListBuilder_ == null) {
          ensureParkourLevelInfoListIsMutable();
       ...
       * <code>repeated .ParkourLevelInfo parkour_level_info_list = 4;</code>
       */
      public emu.gingerps.net.proto.ParkourLevelInfoOuterClass.ParkourLevelInfo.Builder getParkourLevelInfoListBuilder(
          int index) {
       ...
       * <code>repeated .ParkourLevelInfo parkour_level_info_list = 4;</code>
       */
      public emu.gingerps.net.proto.ParkourLevelInfoOuterClass.ParkourLevelInfo.Builder addParkourLevelInfoListBuilder() {
        return getParkourLevelInfoListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.ParkourLevelInfoOuterClass.ParkourLevelInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .ParkourLevelInfo parkour_level_info_list = 4;</code>
       */
      public emu.gingerps.net.proto.ParkourLevelInfoOuterClass.ParkourLevelInfo.Builder addParkourLevelInfoListBuilder(
          int index) {
        return getParkourLevelInfoListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.ParkourLevelInfoOuterClass.ParkourLevelInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .ParkourLevelInfo parkour_level_info_list = 4;</code>
       */
      public java.util.List<emu.gingerps.net.proto.ParkourLevelInfoOuterClass.ParkourLevelInfo.Builder> 
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.BlitzRushStageOuterClass.BlitzRushStage, emu.gingerps.net.proto.BlitzRushStageOuterClass.BlitzRushStage.Builder, emu.gingerps.net.proto.BlitzRushStageOuterClass.BlitzRushStageOrBuilder> stageListBuilder_;
      ...
      public Builder setStageList(
          int index, emu.gingerps.net.proto.BlitzRushStageOuterClass.BlitzRushStage value) {
        if (stageListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setStageList(
          int index, emu.gingerps.net.proto.BlitzRushStageOuterClass.BlitzRushStage.Builder builderForValue) {
        if (stageListBuilder_ == null) {
          ensureStageListIsMutable();
       ...
       * <code>repeated .BlitzRushStage stage_list = 6;</code>
       */
      public Builder addStageList(emu.gingerps.net.proto.BlitzRushStageOuterClass.BlitzRushStage value) {
        if (stageListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addStageList(
          emu.gingerps.net.proto.BlitzRushStageOuterClass.BlitzRushStage.Builder builderForValue) {
        if (stageListBuilder_ == null) {
          ensureStageListIsMutable();
      ...
      public Builder addAllStageList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.BlitzRushStageOuterClass.BlitzRushStage> values) {
        if (stageListBuilder_ == null) {
          ensureStageListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
              values, stageList_);
       ...
       * <code>repeated .BlitzRushStage stage_list = 6;</code>
       */
      public emu.gingerps.net.proto.BlitzRushStageOuterClass.BlitzRushStage.Builder getStageListBuilder(
          int index) {
       ...
       * <code>repeated .BlitzRushStage stage_list = 6;</code>
       */
      public emu.gingerps.net.proto.BlitzRushStageOuterClass.BlitzRushStage.Builder addStageListBuilder() {
        return getStageListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.BlitzRushStageOuterClass.BlitzRushStage.getDefaultInstance());
      }
      /**
       * <code>repeated .BlitzRushStage stage_list = 6;</code>
       */
      public emu.gingerps.net.proto.BlitzRushStageOuterClass.BlitzRushStage.Builder addStageListBuilder(
          int index) {
        return getStageListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.BlitzRushStageOuterClass.BlitzRushStage.getDefaultInstance());
      }
      /**
       * <code>repeated .BlitzRushStage stage_list = 6;</code>
       */
      public java.util.List<emu.gingerps.net.proto.BlitzRushStageOuterClass.BlitzRushStage.Builder> 
    ...
    private static final emu.gingerps.net.proto.BlitzRushActivityDetailInfoOuterClass.BlitzRushActivityDetailInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.BlitzRushActivityDetailInfoOuterClass.BlitzRushActivityDetailInfo();
    }

    public static emu.gingerps.net.proto.BlitzRushActivityDetailInfoOuterClass.BlitzRushActivityDetailInfo getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.BlitzRushStageOuterClass.getDescriptor(),
          emu.gingerps.net.proto.ParkourLevelInfoOuterClass.getDescriptor(),
        });
    internal_static_BlitzRushActivityDetailInfo_descriptor =
