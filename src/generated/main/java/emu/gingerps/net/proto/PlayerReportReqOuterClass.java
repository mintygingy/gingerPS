...
public final class PlayerReportReqOuterClass {
  ...
  public interface PlayerReportReqOrBuilder extends
     ...
     * @return The reason.
     */
    emu.gingerps.net.proto.ReportReasonTypeOuterClass.ReportReasonType getReason();
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.PlayerReportReqOuterClass.internal_static_PlayerReportReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.PlayerReportReqOuterClass.PlayerReportReq.class, emu.gingerps.net.proto.PlayerReportReqOuterClass.PlayerReportReq.Builder.class);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (reason_ != emu.gingerps.net.proto.ReportReasonTypeOuterClass.ReportReasonType.REPORT_REASON_TYPE_NONE.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.PlayerReportReqOuterClass.PlayerReportReq)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.PlayerReportReqOuterClass.PlayerReportReq other = (emu.gingerps.net.proto.PlayerReportReqOuterClass.PlayerReportReq) obj;
    ...
    public static emu.gingerps.net.proto.PlayerReportReqOuterClass.PlayerReportReq parseFrom(
    ...
    public static emu.gingerps.net.proto.PlayerReportReqOuterClass.PlayerReportReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.PlayerReportReqOuterClass.PlayerReportReq parseFrom(
    ...
    public static emu.gingerps.net.proto.PlayerReportReqOuterClass.PlayerReportReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.PlayerReportReqOuterClass.PlayerReportReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.PlayerReportReqOuterClass.PlayerReportReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.PlayerReportReqOuterClass.PlayerReportReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.PlayerReportReqOuterClass.PlayerReportReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.PlayerReportReqOuterClass.internal_static_PlayerReportReq_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.PlayerReportReqOuterClass.PlayerReportReq getDefaultInstanceForType() {
        return emu.gingerps.net.proto.PlayerReportReqOuterClass.PlayerReportReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.PlayerReportReqOuterClass.PlayerReportReq build() {
        emu.gingerps.net.proto.PlayerReportReqOuterClass.PlayerReportReq result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.PlayerReportReqOuterClass.PlayerReportReq) {
          return mergeFrom((emu.gingerps.net.proto.PlayerReportReqOuterClass.PlayerReportReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.PlayerReportReqOuterClass.PlayerReportReq other) {
  ...
  checkByteStringIsUtf8(value);
       ...
       * @return This builder for chaining.
       */
      public Builder setReason(emu.gingerps.net.proto.ReportReasonTypeOuterClass.ReportReasonType value) {
        if (value == null) {
          throw new NullPointerException();
        }
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.gingerps.net.proto.PlayerReportReqOuterClass.PlayerReportReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.PlayerReportReqOuterClass.PlayerReportReq();
    }

    public static emu.gingerps.net.proto.PlayerReportReqOuterClass.PlayerReportReq getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.ReportReasonTypeOuterClass.getDescriptor(),
        });
    internal_static_PlayerReportReq_descriptor =
