...
public final class RogueCellUpdateNotifyOuterClass {
  ...
  public interface RogueCellUpdateNotifyOrBuilder extends
     ...
     * @return The cellInfo.
     */
    emu.gingerps.net.proto.RogueCellInfoOuterClass.RogueCellInfo getCellInfo();
    /**
     * <code>.RogueCellInfo cell_info = 5;</code>
     */
    emu.gingerps.net.proto.RogueCellInfoOuterClass.RogueCellInfoOrBuilder getCellInfoOrBuilder();
  }
  /**
   * <pre>
   * enum CmdId {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.RogueCellUpdateNotifyOuterClass.internal_static_RogueCellUpdateNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.RogueCellUpdateNotifyOuterClass.RogueCellUpdateNotify.class, emu.gingerps.net.proto.RogueCellUpdateNotifyOuterClass.RogueCellUpdateNotify.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.RogueCellInfoOuterClass.RogueCellInfo getCellInfo() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.RogueCellUpdateNotifyOuterClass.RogueCellUpdateNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.RogueCellUpdateNotifyOuterClass.RogueCellUpdateNotify other = (emu.gingerps.net.proto.RogueCellUpdateNotifyOuterClass.RogueCellUpdateNotify) obj;
    ...
    public static emu.gingerps.net.proto.RogueCellUpdateNotifyOuterClass.RogueCellUpdateNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.RogueCellUpdateNotifyOuterClass.RogueCellUpdateNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.RogueCellUpdateNotifyOuterClass.RogueCellUpdateNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.RogueCellUpdateNotifyOuterClass.RogueCellUpdateNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.RogueCellUpdateNotifyOuterClass.RogueCellUpdateNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.RogueCellUpdateNotifyOuterClass.RogueCellUpdateNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.RogueCellUpdateNotifyOuterClass.RogueCellUpdateNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.RogueCellUpdateNotifyOuterClass.RogueCellUpdateNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.RogueCellUpdateNotifyOuterClass.internal_static_RogueCellUpdateNotify_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.RogueCellUpdateNotifyOuterClass.RogueCellUpdateNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.RogueCellUpdateNotifyOuterClass.RogueCellUpdateNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.RogueCellUpdateNotifyOuterClass.RogueCellUpdateNotify build() {
        emu.gingerps.net.proto.RogueCellUpdateNotifyOuterClass.RogueCellUpdateNotify result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.RogueCellUpdateNotifyOuterClass.RogueCellUpdateNotify) {
          return mergeFrom((emu.gingerps.net.proto.RogueCellUpdateNotifyOuterClass.RogueCellUpdateNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.RogueCellUpdateNotifyOuterClass.RogueCellUpdateNotify other) {
        if (other == emu.gingerps.net.proto.RogueCellUpdateNotifyOuterClass.RogueCellUpdateNotify.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.RogueCellInfoOuterClass.RogueCellInfo, emu.gingerps.net.proto.RogueCellInfoOuterClass.RogueCellInfo.Builder, emu.gingerps.net.proto.RogueCellInfoOuterClass.RogueCellInfoOrBuilder> cellInfoBuilder_;
      /**
       * <code>.RogueCellInfo cell_info = 5;</code>
       * @return Whether the cellInfo field is set.
       */
       ...
       * <code>.RogueCellInfo cell_info = 5;</code>
       */
      public Builder setCellInfo(emu.gingerps.net.proto.RogueCellInfoOuterClass.RogueCellInfo value) {
        if (cellInfoBuilder_ == null) {
          if (value == null) {
      ...
      public emu.gingerps.net.proto.RogueCellInfoOuterClass.RogueCellInfoOrBuilder getCellInfoOrBuilder() {
        if (cellInfoBuilder_ != null) {
          ...
          return cellInfo_ == null ?
              emu.gingerps.net.proto.RogueCellInfoOuterClass.RogueCellInfo.getDefaultInstance() : cellInfo_;
        }
      }
      /**
       * <code>.RogueCellInfo cell_info = 5;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.RogueCellInfoOuterClass.RogueCellInfo, emu.gingerps.net.proto.RogueCellInfoOuterClass.RogueCellInfo.Builder, emu.gingerps.net.proto.RogueCellInfoOuterClass.RogueCellInfoOrBuilder> 
    ...
    private static final emu.gingerps.net.proto.RogueCellUpdateNotifyOuterClass.RogueCellUpdateNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.RogueCellUpdateNotifyOuterClass.RogueCellUpdateNotify();
    }

    public static emu.gingerps.net.proto.RogueCellUpdateNotifyOuterClass.RogueCellUpdateNotify getDefaultInstance() {
