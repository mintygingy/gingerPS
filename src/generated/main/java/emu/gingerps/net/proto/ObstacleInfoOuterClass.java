...
public final class ObstacleInfoOuterClass {
  ...
  public interface ObstacleInfoOrBuilder extends
     ...
     * @return The shape.
     */
    emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo.ShapeType getShape();
     ...
     * @return The extents.
     */
    emu.gingerps.net.proto.Vector3IntOuterClass.Vector3Int getExtents();
    /**
     * <code>.Vector3Int extents = 4;</code>
     */
    emu.gingerps.net.proto.Vector3IntOuterClass.Vector3IntOrBuilder getExtentsOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.gingerps.net.proto.ObstacleInfoOuterClass.internal_static_ObstacleInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.gingerps.net.proto.ObstacleInfoOuterClass.internal_static_ObstacleInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo.class, emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo.Builder.class);
    }
    ...
    public enum ShapeType
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo.getDescriptor().getEnumTypes().get(0);
      }
     ...
     * @return The shape.
     */
    @java.lang.Override public emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo.ShapeType getShape() {
      @SuppressWarnings("deprecation")
      emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo.ShapeType result = emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo.ShapeType.valueOf(shape_);
      return result == null ? emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo.ShapeType.UNRECOGNIZED : result;
    }

    public static final int EXTENTS_FIELD_NUMBER = 4;
    private emu.gingerps.net.proto.Vector3IntOuterClass.Vector3Int extents_;
    /**
     * <code>.Vector3Int extents = 4;</code>
     * @return Whether the extents field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.Vector3IntOuterClass.Vector3Int getExtents() {
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (shape_ != emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo.ShapeType.SHAPE_TYPE_OBSTACLE_SHAPE_CAPSULE.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo other = (emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo) obj;
    ...
    public static emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.ObstacleInfoOuterClass.internal_static_ObstacleInfo_descriptor;
      }
      ...
      // Construct using emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo getDefaultInstanceForType() {
        return emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo build() {
        emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo buildPartial() {
        emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo result = new emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo(this);
        if (rotationBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo) {
          return mergeFrom((emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo other) {
        if (other == emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo) e.getUnfinishedMessage();
       ...
       */
      @java.lang.Override
      public emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo.ShapeType getShape() {
        @SuppressWarnings("deprecation")
        emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo.ShapeType result = emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo.ShapeType.valueOf(shape_);
        return result == null ? emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo.ShapeType.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setShape(emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo.ShapeType value) {
        if (value == null) {
          throw new NullPointerException();
        }
      ...
      private emu.gingerps.net.proto.Vector3IntOuterClass.Vector3Int extents_;
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.Vector3IntOuterClass.Vector3Int, emu.gingerps.net.proto.Vector3IntOuterClass.Vector3Int.Builder, emu.gingerps.net.proto.Vector3IntOuterClass.Vector3IntOrBuilder> extentsBuilder_;
      /**
       * <code>.Vector3Int extents = 4;</code>
       * @return Whether the extents field is set.
       */
       ...
       * <code>.Vector3Int extents = 4;</code>
       */
      public Builder setExtents(emu.gingerps.net.proto.Vector3IntOuterClass.Vector3Int value) {
        if (extentsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public emu.gingerps.net.proto.Vector3IntOuterClass.Vector3IntOrBuilder getExtentsOrBuilder() {
        if (extentsBuilder_ != null) {
          ...
          return extents_ == null ?
              emu.gingerps.net.proto.Vector3IntOuterClass.Vector3Int.getDefaultInstance() : extents_;
        }
      }
      /**
       * <code>.Vector3Int extents = 4;</code>
    ...
    private static final emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo();
    }

    public static emu.gingerps.net.proto.ObstacleInfoOuterClass.ObstacleInfo getDefaultInstance() {
