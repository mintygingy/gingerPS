...
public final class HomePlantFieldNotifyOuterClass {
  ...
  public interface HomePlantFieldNotifyOrBuilder extends
     ...
     * @return The field.
     */
    emu.gingerps.net.proto.HomePlantFieldDataOuterClass.HomePlantFieldData getField();
    /**
     * <code>.HomePlantFieldData field = 7;</code>
     */
    emu.gingerps.net.proto.HomePlantFieldDataOuterClass.HomePlantFieldDataOrBuilder getFieldOrBuilder();
  }
  /**
   * <pre>
   * enum CmdId {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.HomePlantFieldNotifyOuterClass.internal_static_HomePlantFieldNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.HomePlantFieldNotifyOuterClass.HomePlantFieldNotify.class, emu.gingerps.net.proto.HomePlantFieldNotifyOuterClass.HomePlantFieldNotify.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.HomePlantFieldDataOuterClass.HomePlantFieldData getField() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.HomePlantFieldNotifyOuterClass.HomePlantFieldNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.HomePlantFieldNotifyOuterClass.HomePlantFieldNotify other = (emu.gingerps.net.proto.HomePlantFieldNotifyOuterClass.HomePlantFieldNotify) obj;
    ...
    public static emu.gingerps.net.proto.HomePlantFieldNotifyOuterClass.HomePlantFieldNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.HomePlantFieldNotifyOuterClass.HomePlantFieldNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.HomePlantFieldNotifyOuterClass.HomePlantFieldNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.HomePlantFieldNotifyOuterClass.HomePlantFieldNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.HomePlantFieldNotifyOuterClass.HomePlantFieldNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.HomePlantFieldNotifyOuterClass.HomePlantFieldNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.HomePlantFieldNotifyOuterClass.HomePlantFieldNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.HomePlantFieldNotifyOuterClass.HomePlantFieldNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.HomePlantFieldNotifyOuterClass.internal_static_HomePlantFieldNotify_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.HomePlantFieldNotifyOuterClass.HomePlantFieldNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.HomePlantFieldNotifyOuterClass.HomePlantFieldNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.HomePlantFieldNotifyOuterClass.HomePlantFieldNotify build() {
        emu.gingerps.net.proto.HomePlantFieldNotifyOuterClass.HomePlantFieldNotify result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.HomePlantFieldNotifyOuterClass.HomePlantFieldNotify) {
          return mergeFrom((emu.gingerps.net.proto.HomePlantFieldNotifyOuterClass.HomePlantFieldNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.HomePlantFieldNotifyOuterClass.HomePlantFieldNotify other) {
        if (other == emu.gingerps.net.proto.HomePlantFieldNotifyOuterClass.HomePlantFieldNotify.getDefaultInstance()) return this;
        if (other.hasField()) {
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.HomePlantFieldDataOuterClass.HomePlantFieldData, emu.gingerps.net.proto.HomePlantFieldDataOuterClass.HomePlantFieldData.Builder, emu.gingerps.net.proto.HomePlantFieldDataOuterClass.HomePlantFieldDataOrBuilder> fieldBuilder_;
      /**
       * <code>.HomePlantFieldData field = 7;</code>
       * @return Whether the field field is set.
       */
       ...
       * <code>.HomePlantFieldData field = 7;</code>
       */
      public Builder setField(emu.gingerps.net.proto.HomePlantFieldDataOuterClass.HomePlantFieldData value) {
        if (fieldBuilder_ == null) {
          if (value == null) {
      ...
      public emu.gingerps.net.proto.HomePlantFieldDataOuterClass.HomePlantFieldDataOrBuilder getFieldOrBuilder() {
        if (fieldBuilder_ != null) {
          ...
          return field_ == null ?
              emu.gingerps.net.proto.HomePlantFieldDataOuterClass.HomePlantFieldData.getDefaultInstance() : field_;
        }
      }
      /**
       * <code>.HomePlantFieldData field = 7;</code>
    ...
    private static final emu.gingerps.net.proto.HomePlantFieldNotifyOuterClass.HomePlantFieldNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.HomePlantFieldNotifyOuterClass.HomePlantFieldNotify();
    }

    public static emu.gingerps.net.proto.HomePlantFieldNotifyOuterClass.HomePlantFieldNotify getDefaultInstance() {
