...
public final class BreakoutSyncSnapShotOuterClass {
  ...
  public interface BreakoutSyncSnapShotOrBuilder extends
     ...
     * @return The snapShot.
     */
    emu.gingerps.net.proto.BreakoutSnapShotOuterClass.BreakoutSnapShot getSnapShot();
    /**
     * <code>.BreakoutSnapShot snap_shot = 14;</code>
     */
    emu.gingerps.net.proto.BreakoutSnapShotOuterClass.BreakoutSnapShotOrBuilder getSnapShotOrBuilder();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.BreakoutSyncSnapShotOuterClass.internal_static_BreakoutSyncSnapShot_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot.class, emu.gingerps.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.BreakoutSnapShotOuterClass.BreakoutSnapShot getSnapShot() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot other = (emu.gingerps.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot) obj;
    ...
    public static emu.gingerps.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot parseFrom(
    ...
    public static emu.gingerps.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot parseFrom(
    ...
    public static emu.gingerps.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShotOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.BreakoutSyncSnapShotOuterClass.internal_static_BreakoutSyncSnapShot_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot getDefaultInstanceForType() {
        return emu.gingerps.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot build() {
        emu.gingerps.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot) {
          return mergeFrom((emu.gingerps.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot other) {
        if (other == emu.gingerps.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.BreakoutSnapShotOuterClass.BreakoutSnapShot, emu.gingerps.net.proto.BreakoutSnapShotOuterClass.BreakoutSnapShot.Builder, emu.gingerps.net.proto.BreakoutSnapShotOuterClass.BreakoutSnapShotOrBuilder> snapShotBuilder_;
      /**
       * <code>.BreakoutSnapShot snap_shot = 14;</code>
       * @return Whether the snapShot field is set.
       */
       ...
       * <code>.BreakoutSnapShot snap_shot = 14;</code>
       */
      public Builder setSnapShot(emu.gingerps.net.proto.BreakoutSnapShotOuterClass.BreakoutSnapShot value) {
        if (snapShotBuilder_ == null) {
          if (value == null) {
      ...
      public emu.gingerps.net.proto.BreakoutSnapShotOuterClass.BreakoutSnapShotOrBuilder getSnapShotOrBuilder() {
        if (snapShotBuilder_ != null) {
          ...
          return snapShot_ == null ?
              emu.gingerps.net.proto.BreakoutSnapShotOuterClass.BreakoutSnapShot.getDefaultInstance() : snapShot_;
        }
      }
      /**
       * <code>.BreakoutSnapShot snap_shot = 14;</code>
    ...
    private static final emu.gingerps.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot();
    }

    public static emu.gingerps.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot getDefaultInstance() {
