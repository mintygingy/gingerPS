...
public final class AbilityGadgetInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.gingerps.net.proto.AbilityGadgetInfoOuterClass.internal_static_AbilityGadgetInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.gingerps.net.proto.AbilityGadgetInfoOuterClass.internal_static_AbilityGadgetInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo.class, emu.gingerps.net.proto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo other = (emu.gingerps.net.proto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo) obj;
    ...
    public static emu.gingerps.net.proto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.AbilityGadgetInfoOuterClass.AbilityGadgetInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.AbilityGadgetInfoOuterClass.internal_static_AbilityGadgetInfo_descriptor;
      }
      ...
      // Construct using emu.gingerps.net.proto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo getDefaultInstanceForType() {
        return emu.gingerps.net.proto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo build() {
        emu.gingerps.net.proto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo buildPartial() {
        emu.gingerps.net.proto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo result = new emu.gingerps.net.proto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo) {
          return mergeFrom((emu.gingerps.net.proto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo other) {
        if (other == emu.gingerps.net.proto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        emu.gingerps.net.proto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (emu.gingerps.net.proto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo) e.getUnfinishedMessage();
    ...
    private static final emu.gingerps.net.proto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo();
    }

    public static emu.gingerps.net.proto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ype\030\002 \001(\r\022\030\n\020target_entity_id\030\003 \001(\rB\030\n\026e" +
