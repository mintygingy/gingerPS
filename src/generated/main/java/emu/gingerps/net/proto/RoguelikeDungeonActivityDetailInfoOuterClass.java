...
public final class RoguelikeDungeonActivityDetailInfoOuterClass {
  ...
  public interface RoguelikeDungeonActivityDetailInfoOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.RogueStageInfoOuterClass.RogueStageInfo> 
        getStageListList();
    /**
     * <code>repeated .RogueStageInfo stage_list = 14;</code>
     */
    emu.gingerps.net.proto.RogueStageInfoOuterClass.RogueStageInfo getStageList(int index);
    /**
     * <code>repeated .RogueStageInfo stage_list = 14;</code>
     */
     ...
     * <code>repeated .RogueStageInfo stage_list = 14;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.RogueStageInfoOuterClass.RogueStageInfoOrBuilder> 
        getStageListOrBuilderList();
    /**
     * <code>repeated .RogueStageInfo stage_list = 14;</code>
     */
    emu.gingerps.net.proto.RogueStageInfoOuterClass.RogueStageInfoOrBuilder getStageListOrBuilder(
        int index);
     ...
     */
    java.util.List<emu.gingerps.net.proto.RoguelikeShikigamiRecordOuterClass.RoguelikeShikigamiRecord> 
        getShikigamiListList();
    /**
     * <code>repeated .RoguelikeShikigamiRecord shikigami_list = 4;</code>
     */
    emu.gingerps.net.proto.RoguelikeShikigamiRecordOuterClass.RoguelikeShikigamiRecord getShikigamiList(int index);
    /**
     * <code>repeated .RoguelikeShikigamiRecord shikigami_list = 4;</code>
     */
     ...
     * <code>repeated .RoguelikeShikigamiRecord shikigami_list = 4;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.RoguelikeShikigamiRecordOuterClass.RoguelikeShikigamiRecordOrBuilder> 
        getShikigamiListOrBuilderList();
    /**
     * <code>repeated .RoguelikeShikigamiRecord shikigami_list = 4;</code>
     */
    emu.gingerps.net.proto.RoguelikeShikigamiRecordOuterClass.RoguelikeShikigamiRecordOrBuilder getShikigamiListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.RoguelikeDungeonActivityDetailInfoOuterClass.internal_static_RoguelikeDungeonActivityDetailInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.RoguelikeDungeonActivityDetailInfoOuterClass.RoguelikeDungeonActivityDetailInfo.class, emu.gingerps.net.proto.RoguelikeDungeonActivityDetailInfoOuterClass.RoguelikeDungeonActivityDetailInfo.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.RogueStageInfoOuterClass.RogueStageInfo> getStageListList() {
      return stageList_;
    }
    /**
     * <code>repeated .RogueStageInfo stage_list = 14;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.RogueStageInfoOuterClass.RogueStageInfoOrBuilder> 
        getStageListOrBuilderList() {
      return stageList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.RogueStageInfoOuterClass.RogueStageInfo getStageList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.RogueStageInfoOuterClass.RogueStageInfoOrBuilder getStageListOrBuilder(
        int index) {
      return stageList_.get(index);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.RoguelikeShikigamiRecordOuterClass.RoguelikeShikigamiRecord> getShikigamiListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.RoguelikeShikigamiRecordOuterClass.RoguelikeShikigamiRecordOrBuilder> 
        getShikigamiListOrBuilderList() {
      return shikigamiList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.RoguelikeShikigamiRecordOuterClass.RoguelikeShikigamiRecord getShikigamiList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.RoguelikeShikigamiRecordOuterClass.RoguelikeShikigamiRecordOrBuilder getShikigamiListOrBuilder(
        int index) {
      return shikigamiList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.RoguelikeDungeonActivityDetailInfoOuterClass.RoguelikeDungeonActivityDetailInfo)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.RoguelikeDungeonActivityDetailInfoOuterClass.RoguelikeDungeonActivityDetailInfo other = (emu.gingerps.net.proto.RoguelikeDungeonActivityDetailInfoOuterClass.RoguelikeDungeonActivityDetailInfo) obj;
    ...
    public static emu.gingerps.net.proto.RoguelikeDungeonActivityDetailInfoOuterClass.RoguelikeDungeonActivityDetailInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.RoguelikeDungeonActivityDetailInfoOuterClass.RoguelikeDungeonActivityDetailInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.RoguelikeDungeonActivityDetailInfoOuterClass.RoguelikeDungeonActivityDetailInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.RoguelikeDungeonActivityDetailInfoOuterClass.RoguelikeDungeonActivityDetailInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.RoguelikeDungeonActivityDetailInfoOuterClass.RoguelikeDungeonActivityDetailInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.RoguelikeDungeonActivityDetailInfoOuterClass.RoguelikeDungeonActivityDetailInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.RoguelikeDungeonActivityDetailInfoOuterClass.RoguelikeDungeonActivityDetailInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.RoguelikeDungeonActivityDetailInfoOuterClass.RoguelikeDungeonActivityDetailInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.RoguelikeDungeonActivityDetailInfoOuterClass.internal_static_RoguelikeDungeonActivityDetailInfo_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.RoguelikeDungeonActivityDetailInfoOuterClass.RoguelikeDungeonActivityDetailInfo getDefaultInstanceForType() {
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.RoguelikeDungeonActivityDetailInfoOuterClass.RoguelikeDungeonActivityDetailInfo build() {
        emu.gingerps.net.proto.RoguelikeDungeonActivityDetailInfoOuterClass.RoguelikeDungeonActivityDetailInfo result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.RoguelikeDungeonActivityDetailInfoOuterClass.RoguelikeDungeonActivityDetailInfo) {
          return mergeFrom((emu.gingerps.net.proto.RoguelikeDungeonActivityDetailInfoOuterClass.RoguelikeDungeonActivityDetailInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.RoguelikeDungeonActivityDetailInfoOuterClass.RoguelikeDungeonActivityDetailInfo other) {
        if (other == emu.gingerps.net.proto.RoguelikeDungeonActivityDetailInfoOuterClass.RoguelikeDungeonActivityDetailInfo.getDefaultInstance()) return this;
        if (stageListBuilder_ == null) {
      ...
      private void ensureStageListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          stageList_ = new java.util.ArrayList<emu.gingerps.net.proto.RogueStageInfoOuterClass.RogueStageInfo>(stageList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.RogueStageInfoOuterClass.RogueStageInfo, emu.gingerps.net.proto.RogueStageInfoOuterClass.RogueStageInfo.Builder, emu.gingerps.net.proto.RogueStageInfoOuterClass.RogueStageInfoOrBuilder> stageListBuilder_;
      ...
      public Builder setStageList(
          int index, emu.gingerps.net.proto.RogueStageInfoOuterClass.RogueStageInfo value) {
        if (stageListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setStageList(
          int index, emu.gingerps.net.proto.RogueStageInfoOuterClass.RogueStageInfo.Builder builderForValue) {
        if (stageListBuilder_ == null) {
          ensureStageListIsMutable();
       ...
       * <code>repeated .RogueStageInfo stage_list = 14;</code>
       */
      public Builder addStageList(emu.gingerps.net.proto.RogueStageInfoOuterClass.RogueStageInfo value) {
        if (stageListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addStageList(
          emu.gingerps.net.proto.RogueStageInfoOuterClass.RogueStageInfo.Builder builderForValue) {
        if (stageListBuilder_ == null) {
          ensureStageListIsMutable();
      ...
      public Builder addAllStageList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.RogueStageInfoOuterClass.RogueStageInfo> values) {
        if (stageListBuilder_ == null) {
          ensureStageListIsMutable();
       ...
       * <code>repeated .RogueStageInfo stage_list = 14;</code>
       */
      public emu.gingerps.net.proto.RogueStageInfoOuterClass.RogueStageInfo.Builder getStageListBuilder(
          int index) {
       ...
       * <code>repeated .RogueStageInfo stage_list = 14;</code>
       */
      public emu.gingerps.net.proto.RogueStageInfoOuterClass.RogueStageInfo.Builder addStageListBuilder() {
        return getStageListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.RogueStageInfoOuterClass.RogueStageInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .RogueStageInfo stage_list = 14;</code>
       */
      public emu.gingerps.net.proto.RogueStageInfoOuterClass.RogueStageInfo.Builder addStageListBuilder(
          int index) {
        return getStageListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.RogueStageInfoOuterClass.RogueStageInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .RogueStageInfo stage_list = 14;</code>
       */
      public java.util.List<emu.gingerps.net.proto.RogueStageInfoOuterClass.RogueStageInfo.Builder> 
           getStageListBuilderList() {
        return getStageListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.RogueStageInfoOuterClass.RogueStageInfo, emu.gingerps.net.proto.RogueStageInfoOuterClass.RogueStageInfo.Builder, emu.gingerps.net.proto.RogueStageInfoOuterClass.RogueStageInfoOrBuilder> 
          getStageListFieldBuilder() {
        if (stageListBuilder_ == null) {
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.RoguelikeShikigamiRecordOuterClass.RoguelikeShikigamiRecord, emu.gingerps.net.proto.RoguelikeShikigamiRecordOuterClass.RoguelikeShikigamiRecord.Builder, emu.gingerps.net.proto.RoguelikeShikigamiRecordOuterClass.RoguelikeShikigamiRecordOrBuilder> shikigamiListBuilder_;
      ...
      public Builder setShikigamiList(
          int index, emu.gingerps.net.proto.RoguelikeShikigamiRecordOuterClass.RoguelikeShikigamiRecord value) {
        if (shikigamiListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setShikigamiList(
          int index, emu.gingerps.net.proto.RoguelikeShikigamiRecordOuterClass.RoguelikeShikigamiRecord.Builder builderForValue) {
        if (shikigamiListBuilder_ == null) {
          ensureShikigamiListIsMutable();
       ...
       * <code>repeated .RoguelikeShikigamiRecord shikigami_list = 4;</code>
       */
      public Builder addShikigamiList(emu.gingerps.net.proto.RoguelikeShikigamiRecordOuterClass.RoguelikeShikigamiRecord value) {
        if (shikigamiListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addShikigamiList(
          emu.gingerps.net.proto.RoguelikeShikigamiRecordOuterClass.RoguelikeShikigamiRecord.Builder builderForValue) {
        if (shikigamiListBuilder_ == null) {
          ensureShikigamiListIsMutable();
      ...
      public Builder addAllShikigamiList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.RoguelikeShikigamiRecordOuterClass.RoguelikeShikigamiRecord> values) {
        if (shikigamiListBuilder_ == null) {
          ensureShikigamiListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .RoguelikeShikigamiRecord shikigami_list = 4;</code>
       */
      public emu.gingerps.net.proto.RoguelikeShikigamiRecordOuterClass.RoguelikeShikigamiRecord.Builder getShikigamiListBuilder(
          int index) {
       ...
       * <code>repeated .RoguelikeShikigamiRecord shikigami_list = 4;</code>
       */
      public emu.gingerps.net.proto.RoguelikeShikigamiRecordOuterClass.RoguelikeShikigamiRecord.Builder addShikigamiListBuilder() {
        return getShikigamiListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.RoguelikeShikigamiRecordOuterClass.RoguelikeShikigamiRecord.getDefaultInstance());
      }
      /**
       * <code>repeated .RoguelikeShikigamiRecord shikigami_list = 4;</code>
       */
      public emu.gingerps.net.proto.RoguelikeShikigamiRecordOuterClass.RoguelikeShikigamiRecord.Builder addShikigamiListBuilder(
          int index) {
        return getShikigamiListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.RoguelikeShikigamiRecordOuterClass.RoguelikeShikigamiRecord.getDefaultInstance());
      }
      /**
       * <code>repeated .RoguelikeShikigamiRecord shikigami_list = 4;</code>
       */
      public java.util.List<emu.gingerps.net.proto.RoguelikeShikigamiRecordOuterClass.RoguelikeShikigamiRecord.Builder> 
    ...
    private static final emu.gingerps.net.proto.RoguelikeDungeonActivityDetailInfoOuterClass.RoguelikeDungeonActivityDetailInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.RoguelikeDungeonActivityDetailInfoOuterClass.RoguelikeDungeonActivityDetailInfo();
    }

    public static emu.gingerps.net.proto.RoguelikeDungeonActivityDetailInfoOuterClass.RoguelikeDungeonActivityDetailInfo getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.RogueStageInfoOuterClass.getDescriptor(),
          emu.gingerps.net.proto.RoguelikeShikigamiRecordOuterClass.getDescriptor(),
        });
    internal_static_RoguelikeDungeonActivityDetailInfo_descriptor =
