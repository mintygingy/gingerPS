...
public final class SetWidgetSlotRspOuterClass {
  ...
  public interface SetWidgetSlotRspOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.WidgetSlotTagOuterClass.WidgetSlotTag> getTagListList();
    /**
     * <code>repeated .WidgetSlotTag tag_list = 15;</code>
     ...
     */
    emu.gingerps.net.proto.WidgetSlotTagOuterClass.WidgetSlotTag getTagList(int index);
    /**
     * <code>repeated .WidgetSlotTag tag_list = 15;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.gingerps.net.proto.SetWidgetSlotRspOuterClass.internal_static_SetWidgetSlotRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.gingerps.net.proto.SetWidgetSlotRspOuterClass.internal_static_SetWidgetSlotRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.SetWidgetSlotRspOuterClass.SetWidgetSlotRsp.class, emu.gingerps.net.proto.SetWidgetSlotRspOuterClass.SetWidgetSlotRsp.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.WidgetSlotTagOuterClass.WidgetSlotTag> getTagListList() {
      return new com.google.protobuf.Internal.ListAdapter<
          java.lang.Integer, emu.gingerps.net.proto.WidgetSlotTagOuterClass.WidgetSlotTag>(tagList_, tagList_converter_);
    }
    /**
     * <code>repeated .WidgetSlotTag tag_list = 15;</code>
     * @return The count of tagList.
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.WidgetSlotTagOuterClass.WidgetSlotTag getTagList(int index) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.SetWidgetSlotRspOuterClass.SetWidgetSlotRsp)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.SetWidgetSlotRspOuterClass.SetWidgetSlotRsp other = (emu.gingerps.net.proto.SetWidgetSlotRspOuterClass.SetWidgetSlotRsp) obj;
    ...
    public static emu.gingerps.net.proto.SetWidgetSlotRspOuterClass.SetWidgetSlotRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.SetWidgetSlotRspOuterClass.SetWidgetSlotRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.SetWidgetSlotRspOuterClass.SetWidgetSlotRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.SetWidgetSlotRspOuterClass.SetWidgetSlotRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.SetWidgetSlotRspOuterClass.SetWidgetSlotRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.SetWidgetSlotRspOuterClass.SetWidgetSlotRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.SetWidgetSlotRspOuterClass.SetWidgetSlotRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.SetWidgetSlotRspOuterClass.SetWidgetSlotRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.SetWidgetSlotRspOuterClass.internal_static_SetWidgetSlotRsp_descriptor;
      }
      ...
      // Construct using emu.gingerps.net.proto.SetWidgetSlotRspOuterClass.SetWidgetSlotRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.SetWidgetSlotRspOuterClass.SetWidgetSlotRsp getDefaultInstanceForType() {
        return emu.gingerps.net.proto.SetWidgetSlotRspOuterClass.SetWidgetSlotRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.SetWidgetSlotRspOuterClass.SetWidgetSlotRsp build() {
        emu.gingerps.net.proto.SetWidgetSlotRspOuterClass.SetWidgetSlotRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.SetWidgetSlotRspOuterClass.SetWidgetSlotRsp buildPartial() {
        emu.gingerps.net.proto.SetWidgetSlotRspOuterClass.SetWidgetSlotRsp result = new emu.gingerps.net.proto.SetWidgetSlotRspOuterClass.SetWidgetSlotRsp(this);
      ...
      private void buildPartialRepeatedFields(emu.gingerps.net.proto.SetWidgetSlotRspOuterClass.SetWidgetSlotRsp result) {
      ...
      private void buildPartial0(emu.gingerps.net.proto.SetWidgetSlotRspOuterClass.SetWidgetSlotRsp result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.SetWidgetSlotRspOuterClass.SetWidgetSlotRsp) {
          return mergeFrom((emu.gingerps.net.proto.SetWidgetSlotRspOuterClass.SetWidgetSlotRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.SetWidgetSlotRspOuterClass.SetWidgetSlotRsp other) {
        if (other == emu.gingerps.net.proto.SetWidgetSlotRspOuterClass.SetWidgetSlotRsp.getDefaultInstance()) return this;
      ...
      public Builder setTagList(
          int index, emu.gingerps.net.proto.WidgetSlotTagOuterClass.WidgetSlotTag value) {
        if (value == null) {
       ...
       * @return This builder for chaining.
       */
      public Builder addTagList(emu.gingerps.net.proto.WidgetSlotTagOuterClass.WidgetSlotTag value) {
        if (value == null) {
          throw new NullPointerException();
        }
        ensureTagListIsMutable();
      ...
      public Builder addAllTagList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.WidgetSlotTagOuterClass.WidgetSlotTag> values) {
        ensureTagListIsMutable();
        for (emu.gingerps.net.proto.WidgetSlotTagOuterClass.WidgetSlotTag value : values) {
          tagList_.add(value.getNumber());
        }
        onChanged();
        return this;
    ...
    private static final emu.gingerps.net.proto.SetWidgetSlotRspOuterClass.SetWidgetSlotRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.SetWidgetSlotRspOuterClass.SetWidgetSlotRsp();
    }

    public static emu.gingerps.net.proto.SetWidgetSlotRspOuterClass.SetWidgetSlotRsp getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\002op\030\005 \001(\0162\r.WidgetSlotOpB\030\n\026emu.gingerps" +
