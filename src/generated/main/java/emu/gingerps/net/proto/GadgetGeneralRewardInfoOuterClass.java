...
public final class GadgetGeneralRewardInfoOuterClass {
  ...
  public interface GadgetGeneralRewardInfoOrBuilder extends
     ...
     */
    emu.gingerps.net.proto.ItemParamOuterClass.ItemParam getItemParam();
    /**
     * <code>.ItemParam item_param = 5;</code>
     */
    emu.gingerps.net.proto.ItemParamOuterClass.ItemParamOrBuilder getItemParamOrBuilder();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 42: {
              ...
              itemParam_ = input.readMessage(emu.gingerps.net.proto.ItemParamOuterClass.ItemParam.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.gingerps.net.proto.GadgetGeneralRewardInfoOuterClass.internal_static_GadgetGeneralRewardInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.gingerps.net.proto.GadgetGeneralRewardInfoOuterClass.internal_static_GadgetGeneralRewardInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo.class, emu.gingerps.net.proto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo.Builder.class);
    }
    ...
    private emu.gingerps.net.proto.ItemParamOuterClass.ItemParam itemParam_;
    /**
     * <code>.ItemParam item_param = 5;</code>
     * @return Whether the itemParam field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.ItemParamOuterClass.ItemParam getItemParam() {
      return itemParam_ == null ? emu.gingerps.net.proto.ItemParamOuterClass.ItemParam.getDefaultInstance() : itemParam_;
    }
    /**
     * <code>.ItemParam item_param = 5;</code>
     */
    @java.lang.Override
    public emu.gingerps.net.proto.ItemParamOuterClass.ItemParamOrBuilder getItemParamOrBuilder() {
      return getItemParam();
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo other = (emu.gingerps.net.proto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo) obj;
    ...
    public static emu.gingerps.net.proto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.GadgetGeneralRewardInfoOuterClass.internal_static_GadgetGeneralRewardInfo_descriptor;
      }
      ...
      // Construct using emu.gingerps.net.proto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo getDefaultInstanceForType() {
        return emu.gingerps.net.proto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo build() {
        emu.gingerps.net.proto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo buildPartial() {
        emu.gingerps.net.proto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo result = new emu.gingerps.net.proto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo) {
          return mergeFrom((emu.gingerps.net.proto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo other) {
        if (other == emu.gingerps.net.proto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo.getDefaultInstance()) return this;
        if (other.getResin() != 0) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        emu.gingerps.net.proto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (emu.gingerps.net.proto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo) e.getUnfinishedMessage();
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.ItemParamOuterClass.ItemParam, emu.gingerps.net.proto.ItemParamOuterClass.ItemParam.Builder, emu.gingerps.net.proto.ItemParamOuterClass.ItemParamOrBuilder> itemParamBuilder_;
      /**
       * <code>.ItemParam item_param = 5;</code>
       * @return Whether the itemParam field is set.
       */
       ...
       * <code>.ItemParam item_param = 5;</code>
       */
      public Builder setItemParam(emu.gingerps.net.proto.ItemParamOuterClass.ItemParam value) {
        if (itemParamBuilder_ == null) {
          if (value == null) {
       ...
       * <code>.ItemParam item_param = 5;</code>
       */
      public Builder mergeItemParam(emu.gingerps.net.proto.ItemParamOuterClass.ItemParam value) {
        if (itemParamBuilder_ == null) {
          if (itemParam_ != null) {
            itemParam_ =
              emu.gingerps.net.proto.ItemParamOuterClass.ItemParam.newBuilder(itemParam_).mergeFrom(value).buildPartial();
          } else {
            itemParam_ = value;
          }
          onChanged();
       ...
       * <code>.ItemParam item_param = 5;</code>
       */
      public emu.gingerps.net.proto.ItemParamOuterClass.ItemParam.Builder getItemParamBuilder() {
      ...
      public emu.gingerps.net.proto.ItemParamOuterClass.ItemParamOrBuilder getItemParamOrBuilder() {
        if (itemParamBuilder_ != null) {
          ...
          return itemParam_ == null ?
              emu.gingerps.net.proto.ItemParamOuterClass.ItemParam.getDefaultInstance() : itemParam_;
        }
      }
      /**
       * <code>.ItemParam item_param = 5;</code>
    ...
    private static final emu.gingerps.net.proto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo();
    }

    public static emu.gingerps.net.proto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo getDefaultInstance() {
