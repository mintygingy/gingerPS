...
public final class WorldOwnerDailyTaskNotifyOuterClass {
  ...
  public interface WorldOwnerDailyTaskNotifyOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.DailyTaskInfoOuterClass.DailyTaskInfo> 
        getTaskListList();
    /**
     * <code>repeated .DailyTaskInfo task_list = 2;</code>
     */
    emu.gingerps.net.proto.DailyTaskInfoOuterClass.DailyTaskInfo getTaskList(int index);
    /**
     * <code>repeated .DailyTaskInfo task_list = 2;</code>
     */
     ...
     * <code>repeated .DailyTaskInfo task_list = 2;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.DailyTaskInfoOuterClass.DailyTaskInfoOrBuilder> 
        getTaskListOrBuilderList();
    /**
     * <code>repeated .DailyTaskInfo task_list = 2;</code>
     */
    emu.gingerps.net.proto.DailyTaskInfoOuterClass.DailyTaskInfoOrBuilder getTaskListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.WorldOwnerDailyTaskNotifyOuterClass.internal_static_WorldOwnerDailyTaskNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.WorldOwnerDailyTaskNotifyOuterClass.WorldOwnerDailyTaskNotify.class, emu.gingerps.net.proto.WorldOwnerDailyTaskNotifyOuterClass.WorldOwnerDailyTaskNotify.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.DailyTaskInfoOuterClass.DailyTaskInfo> getTaskListList() {
      return taskList_;
    }
    /**
     * <code>repeated .DailyTaskInfo task_list = 2;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.DailyTaskInfoOuterClass.DailyTaskInfoOrBuilder> 
        getTaskListOrBuilderList() {
      return taskList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.DailyTaskInfoOuterClass.DailyTaskInfo getTaskList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.DailyTaskInfoOuterClass.DailyTaskInfoOrBuilder getTaskListOrBuilder(
        int index) {
      return taskList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.WorldOwnerDailyTaskNotifyOuterClass.WorldOwnerDailyTaskNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.WorldOwnerDailyTaskNotifyOuterClass.WorldOwnerDailyTaskNotify other = (emu.gingerps.net.proto.WorldOwnerDailyTaskNotifyOuterClass.WorldOwnerDailyTaskNotify) obj;
    ...
    public static emu.gingerps.net.proto.WorldOwnerDailyTaskNotifyOuterClass.WorldOwnerDailyTaskNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.WorldOwnerDailyTaskNotifyOuterClass.WorldOwnerDailyTaskNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.WorldOwnerDailyTaskNotifyOuterClass.WorldOwnerDailyTaskNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.WorldOwnerDailyTaskNotifyOuterClass.WorldOwnerDailyTaskNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.WorldOwnerDailyTaskNotifyOuterClass.WorldOwnerDailyTaskNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.WorldOwnerDailyTaskNotifyOuterClass.WorldOwnerDailyTaskNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.WorldOwnerDailyTaskNotifyOuterClass.WorldOwnerDailyTaskNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.WorldOwnerDailyTaskNotifyOuterClass.WorldOwnerDailyTaskNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.WorldOwnerDailyTaskNotifyOuterClass.internal_static_WorldOwnerDailyTaskNotify_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.WorldOwnerDailyTaskNotifyOuterClass.WorldOwnerDailyTaskNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.WorldOwnerDailyTaskNotifyOuterClass.WorldOwnerDailyTaskNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.WorldOwnerDailyTaskNotifyOuterClass.WorldOwnerDailyTaskNotify build() {
        emu.gingerps.net.proto.WorldOwnerDailyTaskNotifyOuterClass.WorldOwnerDailyTaskNotify result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.WorldOwnerDailyTaskNotifyOuterClass.WorldOwnerDailyTaskNotify) {
          return mergeFrom((emu.gingerps.net.proto.WorldOwnerDailyTaskNotifyOuterClass.WorldOwnerDailyTaskNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.WorldOwnerDailyTaskNotifyOuterClass.WorldOwnerDailyTaskNotify other) {
        if (other == emu.gingerps.net.proto.WorldOwnerDailyTaskNotifyOuterClass.WorldOwnerDailyTaskNotify.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.DailyTaskInfoOuterClass.DailyTaskInfo, emu.gingerps.net.proto.DailyTaskInfoOuterClass.DailyTaskInfo.Builder, emu.gingerps.net.proto.DailyTaskInfoOuterClass.DailyTaskInfoOrBuilder> taskListBuilder_;
      ...
      public Builder setTaskList(
          int index, emu.gingerps.net.proto.DailyTaskInfoOuterClass.DailyTaskInfo value) {
        if (taskListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setTaskList(
          int index, emu.gingerps.net.proto.DailyTaskInfoOuterClass.DailyTaskInfo.Builder builderForValue) {
        if (taskListBuilder_ == null) {
          ensureTaskListIsMutable();
       ...
       * <code>repeated .DailyTaskInfo task_list = 2;</code>
       */
      public Builder addTaskList(emu.gingerps.net.proto.DailyTaskInfoOuterClass.DailyTaskInfo value) {
        if (taskListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addAllTaskList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.DailyTaskInfoOuterClass.DailyTaskInfo> values) {
        if (taskListBuilder_ == null) {
          ensureTaskListIsMutable();
       ...
       * <code>repeated .DailyTaskInfo task_list = 2;</code>
       */
      public emu.gingerps.net.proto.DailyTaskInfoOuterClass.DailyTaskInfo.Builder getTaskListBuilder(
          int index) {
       ...
       * <code>repeated .DailyTaskInfo task_list = 2;</code>
       */
      public emu.gingerps.net.proto.DailyTaskInfoOuterClass.DailyTaskInfo.Builder addTaskListBuilder() {
        return getTaskListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.DailyTaskInfoOuterClass.DailyTaskInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .DailyTaskInfo task_list = 2;</code>
       */
      public emu.gingerps.net.proto.DailyTaskInfoOuterClass.DailyTaskInfo.Builder addTaskListBuilder(
          int index) {
        return getTaskListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.DailyTaskInfoOuterClass.DailyTaskInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .DailyTaskInfo task_list = 2;</code>
       */
      public java.util.List<emu.gingerps.net.proto.DailyTaskInfoOuterClass.DailyTaskInfo.Builder> 
    ...
    private static final emu.gingerps.net.proto.WorldOwnerDailyTaskNotifyOuterClass.WorldOwnerDailyTaskNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.WorldOwnerDailyTaskNotifyOuterClass.WorldOwnerDailyTaskNotify();
    }

    public static emu.gingerps.net.proto.WorldOwnerDailyTaskNotifyOuterClass.WorldOwnerDailyTaskNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ify\022\026\n\016filter_city_id\030\004 \001(\r\022!\n\ttask_list" +
      "\030\002 \003(\0132\016.DailyTaskInfo\022\037\n\027finished_daily" +
      "_task_num\030\t \001(\rB\033\n\031emu.gingerps.net.p" +
      "rotob\006proto3"
    };
