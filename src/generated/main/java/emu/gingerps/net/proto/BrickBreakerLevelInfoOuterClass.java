...
public final class BrickBreakerLevelInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.internal_static_BrickBreakerLevelInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.internal_static_BrickBreakerLevelInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.class, emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo other = (emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo) obj;
    ...
    public static emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.internal_static_BrickBreakerLevelInfo_descriptor;
      }
      ...
      // Construct using emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo getDefaultInstanceForType() {
        return emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo build() {
        emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo buildPartial() {
        emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo result = new emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo(this);
      ...
      private void buildPartialRepeatedFields(emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo result) {
      ...
      private void buildPartial0(emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo) {
          return mergeFrom((emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo other) {
        if (other == emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.getDefaultInstance()) return this;
    ...
    private static final emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo();
    }

    public static emu.gingerps.net.proto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\030\016 \003(\r\022\024\n\014is_can_start\030\001 \001(\010B\030\n\026emu.ging" +
