...
public final class QuestProgressUpdateNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.gingerps.net.proto.QuestProgressUpdateNotifyOuterClass.internal_static_QuestProgressUpdateNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.gingerps.net.proto.QuestProgressUpdateNotifyOuterClass.internal_static_QuestProgressUpdateNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify.class, emu.gingerps.net.proto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify other = (emu.gingerps.net.proto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify) obj;
    ...
    public static emu.gingerps.net.proto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.QuestProgressUpdateNotifyOuterClass.internal_static_QuestProgressUpdateNotify_descriptor;
      }
      ...
      // Construct using emu.gingerps.net.proto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify build() {
        emu.gingerps.net.proto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify buildPartial() {
        emu.gingerps.net.proto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify result = new emu.gingerps.net.proto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify(this);
      ...
      private void buildPartialRepeatedFields(emu.gingerps.net.proto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify result) {
      ...
      private void buildPartial0(emu.gingerps.net.proto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify) {
          return mergeFrom((emu.gingerps.net.proto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify other) {
        if (other == emu.gingerps.net.proto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify.getDefaultInstance()) return this;
    ...
    private static final emu.gingerps.net.proto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify();
    }

    public static emu.gingerps.net.proto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "rogress_list\030\017 \003(\rB\030\n\026emu.gingerps.net.p" +
      "rotob\006proto3"
    };
