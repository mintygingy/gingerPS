...
public final class HuntingOfferDataOuterClass {
  ...
  public interface HuntingOfferDataOrBuilder extends
     ...
     * @return The state.
     */
    emu.gingerps.net.proto.HuntingOfferStateOuterClass.HuntingOfferState getState();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.gingerps.net.proto.HuntingOfferDataOuterClass.internal_static_HuntingOfferData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.gingerps.net.proto.HuntingOfferDataOuterClass.internal_static_HuntingOfferData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.HuntingOfferDataOuterClass.HuntingOfferData.class, emu.gingerps.net.proto.HuntingOfferDataOuterClass.HuntingOfferData.Builder.class);
    }
     ...
     * @return The state.
     */
    @java.lang.Override public emu.gingerps.net.proto.HuntingOfferStateOuterClass.HuntingOfferState getState() {
      @SuppressWarnings("deprecation")
      emu.gingerps.net.proto.HuntingOfferStateOuterClass.HuntingOfferState result = emu.gingerps.net.proto.HuntingOfferStateOuterClass.HuntingOfferState.valueOf(state_);
      return result == null ? emu.gingerps.net.proto.HuntingOfferStateOuterClass.HuntingOfferState.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (state_ != emu.gingerps.net.proto.HuntingOfferStateOuterClass.HuntingOfferState.HUNTING_OFFER_STATE_NONE.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.HuntingOfferDataOuterClass.HuntingOfferData)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.HuntingOfferDataOuterClass.HuntingOfferData other = (emu.gingerps.net.proto.HuntingOfferDataOuterClass.HuntingOfferData) obj;
    ...
    public static emu.gingerps.net.proto.HuntingOfferDataOuterClass.HuntingOfferData parseFrom(
    ...
    public static emu.gingerps.net.proto.HuntingOfferDataOuterClass.HuntingOfferData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.HuntingOfferDataOuterClass.HuntingOfferData parseFrom(
    ...
    public static emu.gingerps.net.proto.HuntingOfferDataOuterClass.HuntingOfferData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.HuntingOfferDataOuterClass.HuntingOfferData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.HuntingOfferDataOuterClass.HuntingOfferData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.HuntingOfferDataOuterClass.HuntingOfferData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.HuntingOfferDataOuterClass.HuntingOfferDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.HuntingOfferDataOuterClass.internal_static_HuntingOfferData_descriptor;
      }
      ...
      // Construct using emu.gingerps.net.proto.HuntingOfferDataOuterClass.HuntingOfferData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.HuntingOfferDataOuterClass.HuntingOfferData getDefaultInstanceForType() {
        return emu.gingerps.net.proto.HuntingOfferDataOuterClass.HuntingOfferData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.HuntingOfferDataOuterClass.HuntingOfferData build() {
        emu.gingerps.net.proto.HuntingOfferDataOuterClass.HuntingOfferData result = buildPartial();
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.HuntingOfferDataOuterClass.HuntingOfferData buildPartial() {
        emu.gingerps.net.proto.HuntingOfferDataOuterClass.HuntingOfferData result = new emu.gingerps.net.proto.HuntingOfferDataOuterClass.HuntingOfferData(this);
        if (huntingPairBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.HuntingOfferDataOuterClass.HuntingOfferData) {
          return mergeFrom((emu.gingerps.net.proto.HuntingOfferDataOuterClass.HuntingOfferData)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.HuntingOfferDataOuterClass.HuntingOfferData other) {
        if (other == emu.gingerps.net.proto.HuntingOfferDataOuterClass.HuntingOfferData.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        emu.gingerps.net.proto.HuntingOfferDataOuterClass.HuntingOfferData parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (emu.gingerps.net.proto.HuntingOfferDataOuterClass.HuntingOfferData) e.getUnfinishedMessage();
       ...
       */
      @java.lang.Override
      public emu.gingerps.net.proto.HuntingOfferStateOuterClass.HuntingOfferState getState() {
        @SuppressWarnings("deprecation")
        emu.gingerps.net.proto.HuntingOfferStateOuterClass.HuntingOfferState result = emu.gingerps.net.proto.HuntingOfferStateOuterClass.HuntingOfferState.valueOf(state_);
        return result == null ? emu.gingerps.net.proto.HuntingOfferStateOuterClass.HuntingOfferState.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setState(emu.gingerps.net.proto.HuntingOfferStateOuterClass.HuntingOfferState value) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    private static final emu.gingerps.net.proto.HuntingOfferDataOuterClass.HuntingOfferData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.HuntingOfferDataOuterClass.HuntingOfferData();
    }

    public static emu.gingerps.net.proto.HuntingOfferDataOuterClass.HuntingOfferData getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.HuntingOfferStateOuterClass.getDescriptor(),
