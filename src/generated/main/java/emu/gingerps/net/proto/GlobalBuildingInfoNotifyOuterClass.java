...
public final class GlobalBuildingInfoNotifyOuterClass {
  ...
  public interface GlobalBuildingInfoNotifyOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.BuildingInfoOuterClass.BuildingInfo> 
        getBuildingListList();
    /**
     * <code>repeated .BuildingInfo building_list = 15;</code>
     */
    emu.gingerps.net.proto.BuildingInfoOuterClass.BuildingInfo getBuildingList(int index);
    /**
     * <code>repeated .BuildingInfo building_list = 15;</code>
     */
     ...
     * <code>repeated .BuildingInfo building_list = 15;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.BuildingInfoOuterClass.BuildingInfoOrBuilder> 
        getBuildingListOrBuilderList();
    /**
     * <code>repeated .BuildingInfo building_list = 15;</code>
     */
    emu.gingerps.net.proto.BuildingInfoOuterClass.BuildingInfoOrBuilder getBuildingListOrBuilder(
        int index);
  }
  /**
   * <pre>
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.GlobalBuildingInfoNotifyOuterClass.internal_static_GlobalBuildingInfoNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.GlobalBuildingInfoNotifyOuterClass.GlobalBuildingInfoNotify.class, emu.gingerps.net.proto.GlobalBuildingInfoNotifyOuterClass.GlobalBuildingInfoNotify.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.BuildingInfoOuterClass.BuildingInfo> getBuildingListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.BuildingInfoOuterClass.BuildingInfoOrBuilder> 
        getBuildingListOrBuilderList() {
      return buildingList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.BuildingInfoOuterClass.BuildingInfo getBuildingList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.BuildingInfoOuterClass.BuildingInfoOrBuilder getBuildingListOrBuilder(
        int index) {
      return buildingList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.GlobalBuildingInfoNotifyOuterClass.GlobalBuildingInfoNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.GlobalBuildingInfoNotifyOuterClass.GlobalBuildingInfoNotify other = (emu.gingerps.net.proto.GlobalBuildingInfoNotifyOuterClass.GlobalBuildingInfoNotify) obj;
    ...
    public static emu.gingerps.net.proto.GlobalBuildingInfoNotifyOuterClass.GlobalBuildingInfoNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.GlobalBuildingInfoNotifyOuterClass.GlobalBuildingInfoNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.GlobalBuildingInfoNotifyOuterClass.GlobalBuildingInfoNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.GlobalBuildingInfoNotifyOuterClass.GlobalBuildingInfoNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.GlobalBuildingInfoNotifyOuterClass.GlobalBuildingInfoNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.GlobalBuildingInfoNotifyOuterClass.GlobalBuildingInfoNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.GlobalBuildingInfoNotifyOuterClass.GlobalBuildingInfoNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.GlobalBuildingInfoNotifyOuterClass.GlobalBuildingInfoNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.GlobalBuildingInfoNotifyOuterClass.internal_static_GlobalBuildingInfoNotify_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.GlobalBuildingInfoNotifyOuterClass.GlobalBuildingInfoNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.GlobalBuildingInfoNotifyOuterClass.GlobalBuildingInfoNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.GlobalBuildingInfoNotifyOuterClass.GlobalBuildingInfoNotify build() {
        emu.gingerps.net.proto.GlobalBuildingInfoNotifyOuterClass.GlobalBuildingInfoNotify result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.GlobalBuildingInfoNotifyOuterClass.GlobalBuildingInfoNotify) {
          return mergeFrom((emu.gingerps.net.proto.GlobalBuildingInfoNotifyOuterClass.GlobalBuildingInfoNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.GlobalBuildingInfoNotifyOuterClass.GlobalBuildingInfoNotify other) {
        if (other == emu.gingerps.net.proto.GlobalBuildingInfoNotifyOuterClass.GlobalBuildingInfoNotify.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.BuildingInfoOuterClass.BuildingInfo, emu.gingerps.net.proto.BuildingInfoOuterClass.BuildingInfo.Builder, emu.gingerps.net.proto.BuildingInfoOuterClass.BuildingInfoOrBuilder> buildingListBuilder_;
      ...
      public Builder setBuildingList(
          int index, emu.gingerps.net.proto.BuildingInfoOuterClass.BuildingInfo value) {
        if (buildingListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setBuildingList(
          int index, emu.gingerps.net.proto.BuildingInfoOuterClass.BuildingInfo.Builder builderForValue) {
        if (buildingListBuilder_ == null) {
          ensureBuildingListIsMutable();
       ...
       * <code>repeated .BuildingInfo building_list = 15;</code>
       */
      public Builder addBuildingList(emu.gingerps.net.proto.BuildingInfoOuterClass.BuildingInfo value) {
        if (buildingListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addBuildingList(
          emu.gingerps.net.proto.BuildingInfoOuterClass.BuildingInfo.Builder builderForValue) {
        if (buildingListBuilder_ == null) {
          ensureBuildingListIsMutable();
      ...
      public Builder addAllBuildingList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.BuildingInfoOuterClass.BuildingInfo> values) {
        if (buildingListBuilder_ == null) {
          ensureBuildingListIsMutable();
       ...
       * <code>repeated .BuildingInfo building_list = 15;</code>
       */
      public emu.gingerps.net.proto.BuildingInfoOuterClass.BuildingInfo.Builder getBuildingListBuilder(
          int index) {
       ...
       * <code>repeated .BuildingInfo building_list = 15;</code>
       */
      public emu.gingerps.net.proto.BuildingInfoOuterClass.BuildingInfo.Builder addBuildingListBuilder() {
        return getBuildingListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.BuildingInfoOuterClass.BuildingInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .BuildingInfo building_list = 15;</code>
       */
      public emu.gingerps.net.proto.BuildingInfoOuterClass.BuildingInfo.Builder addBuildingListBuilder(
          int index) {
        return getBuildingListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.BuildingInfoOuterClass.BuildingInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .BuildingInfo building_list = 15;</code>
       */
      public java.util.List<emu.gingerps.net.proto.BuildingInfoOuterClass.BuildingInfo.Builder> 
    ...
    private static final emu.gingerps.net.proto.GlobalBuildingInfoNotifyOuterClass.GlobalBuildingInfoNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.GlobalBuildingInfoNotifyOuterClass.GlobalBuildingInfoNotify();
    }

    public static emu.gingerps.net.proto.GlobalBuildingInfoNotifyOuterClass.GlobalBuildingInfoNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\n\rbuilding_list\030\017 \003(\0132\r.BuildingInfoB\030\n\026" +
      "emu.gingerps.net.protob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.BuildingInfoOuterClass.getDescriptor(),
        });
    internal_static_GlobalBuildingInfoNotify_descriptor =
