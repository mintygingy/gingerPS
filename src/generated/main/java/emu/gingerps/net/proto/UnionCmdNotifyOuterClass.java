...
public final class UnionCmdNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.gingerps.net.proto.UnionCmdNotifyOuterClass.UnionCmdNotify result) {
        if (cmdListBuilder_ == null) {
      ...
      private void buildPartial0(emu.gingerps.net.proto.UnionCmdNotifyOuterClass.UnionCmdNotify result) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 58: {
                emu.gingerps.net.proto.UnionCmdOuterClass.UnionCmd m =
                    input.readMessage(
                        emu.gingerps.net.proto.UnionCmdOuterClass.UnionCmd.parser(),
                        extensionRegistry);
                if (cmdListBuilder_ == null) {
                  ensureCmdListIsMutable();
                  cmdList_.add(m);
