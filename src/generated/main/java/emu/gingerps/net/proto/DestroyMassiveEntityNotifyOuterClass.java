...
public final class DestroyMassiveEntityNotifyOuterClass {
  ...
  public interface DestroyMassiveEntityNotifyOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.ClientMassiveEntityOuterClass.ClientMassiveEntity> 
        getMassiveEntityListList();
    /**
     * <code>repeated .ClientMassiveEntity massive_entity_list = 15;</code>
     */
    emu.gingerps.net.proto.ClientMassiveEntityOuterClass.ClientMassiveEntity getMassiveEntityList(int index);
    /**
     * <code>repeated .ClientMassiveEntity massive_entity_list = 15;</code>
     */
     ...
     * <code>repeated .ClientMassiveEntity massive_entity_list = 15;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.ClientMassiveEntityOuterClass.ClientMassiveEntityOrBuilder> 
        getMassiveEntityListOrBuilderList();
    /**
     * <code>repeated .ClientMassiveEntity massive_entity_list = 15;</code>
     */
    emu.gingerps.net.proto.ClientMassiveEntityOuterClass.ClientMassiveEntityOrBuilder getMassiveEntityListOrBuilder(
        int index);
  }
  /**
   * <pre>
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.DestroyMassiveEntityNotifyOuterClass.internal_static_DestroyMassiveEntityNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.DestroyMassiveEntityNotifyOuterClass.DestroyMassiveEntityNotify.class, emu.gingerps.net.proto.DestroyMassiveEntityNotifyOuterClass.DestroyMassiveEntityNotify.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.ClientMassiveEntityOuterClass.ClientMassiveEntity> getMassiveEntityListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.ClientMassiveEntityOuterClass.ClientMassiveEntityOrBuilder> 
        getMassiveEntityListOrBuilderList() {
      return massiveEntityList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.ClientMassiveEntityOuterClass.ClientMassiveEntity getMassiveEntityList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.ClientMassiveEntityOuterClass.ClientMassiveEntityOrBuilder getMassiveEntityListOrBuilder(
        int index) {
      return massiveEntityList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.DestroyMassiveEntityNotifyOuterClass.DestroyMassiveEntityNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.DestroyMassiveEntityNotifyOuterClass.DestroyMassiveEntityNotify other = (emu.gingerps.net.proto.DestroyMassiveEntityNotifyOuterClass.DestroyMassiveEntityNotify) obj;
    ...
    public static emu.gingerps.net.proto.DestroyMassiveEntityNotifyOuterClass.DestroyMassiveEntityNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.DestroyMassiveEntityNotifyOuterClass.DestroyMassiveEntityNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.DestroyMassiveEntityNotifyOuterClass.DestroyMassiveEntityNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.DestroyMassiveEntityNotifyOuterClass.DestroyMassiveEntityNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.DestroyMassiveEntityNotifyOuterClass.DestroyMassiveEntityNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.DestroyMassiveEntityNotifyOuterClass.DestroyMassiveEntityNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.DestroyMassiveEntityNotifyOuterClass.DestroyMassiveEntityNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.DestroyMassiveEntityNotifyOuterClass.DestroyMassiveEntityNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.DestroyMassiveEntityNotifyOuterClass.internal_static_DestroyMassiveEntityNotify_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.DestroyMassiveEntityNotifyOuterClass.DestroyMassiveEntityNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.DestroyMassiveEntityNotifyOuterClass.DestroyMassiveEntityNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.DestroyMassiveEntityNotifyOuterClass.DestroyMassiveEntityNotify build() {
        emu.gingerps.net.proto.DestroyMassiveEntityNotifyOuterClass.DestroyMassiveEntityNotify result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.DestroyMassiveEntityNotifyOuterClass.DestroyMassiveEntityNotify) {
          return mergeFrom((emu.gingerps.net.proto.DestroyMassiveEntityNotifyOuterClass.DestroyMassiveEntityNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.DestroyMassiveEntityNotifyOuterClass.DestroyMassiveEntityNotify other) {
        if (other == emu.gingerps.net.proto.DestroyMassiveEntityNotifyOuterClass.DestroyMassiveEntityNotify.getDefaultInstance()) return this;
        if (massiveEntityListBuilder_ == null) {
      ...
      private void ensureMassiveEntityListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          massiveEntityList_ = new java.util.ArrayList<emu.gingerps.net.proto.ClientMassiveEntityOuterClass.ClientMassiveEntity>(massiveEntityList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.ClientMassiveEntityOuterClass.ClientMassiveEntity, emu.gingerps.net.proto.ClientMassiveEntityOuterClass.ClientMassiveEntity.Builder, emu.gingerps.net.proto.ClientMassiveEntityOuterClass.ClientMassiveEntityOrBuilder> massiveEntityListBuilder_;
      ...
      public Builder setMassiveEntityList(
          int index, emu.gingerps.net.proto.ClientMassiveEntityOuterClass.ClientMassiveEntity value) {
        if (massiveEntityListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setMassiveEntityList(
          int index, emu.gingerps.net.proto.ClientMassiveEntityOuterClass.ClientMassiveEntity.Builder builderForValue) {
        if (massiveEntityListBuilder_ == null) {
          ensureMassiveEntityListIsMutable();
       ...
       * <code>repeated .ClientMassiveEntity massive_entity_list = 15;</code>
       */
      public Builder addMassiveEntityList(emu.gingerps.net.proto.ClientMassiveEntityOuterClass.ClientMassiveEntity value) {
        if (massiveEntityListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addMassiveEntityList(
          emu.gingerps.net.proto.ClientMassiveEntityOuterClass.ClientMassiveEntity.Builder builderForValue) {
        if (massiveEntityListBuilder_ == null) {
          ensureMassiveEntityListIsMutable();
      ...
      public Builder addAllMassiveEntityList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.ClientMassiveEntityOuterClass.ClientMassiveEntity> values) {
        if (massiveEntityListBuilder_ == null) {
          ensureMassiveEntityListIsMutable();
       ...
       * <code>repeated .ClientMassiveEntity massive_entity_list = 15;</code>
       */
      public emu.gingerps.net.proto.ClientMassiveEntityOuterClass.ClientMassiveEntity.Builder getMassiveEntityListBuilder(
          int index) {
       ...
       * <code>repeated .ClientMassiveEntity massive_entity_list = 15;</code>
       */
      public emu.gingerps.net.proto.ClientMassiveEntityOuterClass.ClientMassiveEntity.Builder addMassiveEntityListBuilder() {
        return getMassiveEntityListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.ClientMassiveEntityOuterClass.ClientMassiveEntity.getDefaultInstance());
      }
      /**
       * <code>repeated .ClientMassiveEntity massive_entity_list = 15;</code>
       */
      public emu.gingerps.net.proto.ClientMassiveEntityOuterClass.ClientMassiveEntity.Builder addMassiveEntityListBuilder(
          int index) {
        return getMassiveEntityListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.ClientMassiveEntityOuterClass.ClientMassiveEntity.getDefaultInstance());
      }
      /**
       * <code>repeated .ClientMassiveEntity massive_entity_list = 15;</code>
       */
      public java.util.List<emu.gingerps.net.proto.ClientMassiveEntityOuterClass.ClientMassiveEntity.Builder> 
           getMassiveEntityListBuilderList() {
        return getMassiveEntityListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.ClientMassiveEntityOuterClass.ClientMassiveEntity, emu.gingerps.net.proto.ClientMassiveEntityOuterClass.ClientMassiveEntity.Builder, emu.gingerps.net.proto.ClientMassiveEntityOuterClass.ClientMassiveEntityOrBuilder> 
    ...
    private static final emu.gingerps.net.proto.DestroyMassiveEntityNotifyOuterClass.DestroyMassiveEntityNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.DestroyMassiveEntityNotifyOuterClass.DestroyMassiveEntityNotify();
    }

    public static emu.gingerps.net.proto.DestroyMassiveEntityNotifyOuterClass.DestroyMassiveEntityNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "2\024.ClientMassiveEntityB\030\n\026emu.gingerps.n" +
      "et.protob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.ClientMassiveEntityOuterClass.getDescriptor(),
        });
    internal_static_DestroyMassiveEntityNotify_descriptor =
