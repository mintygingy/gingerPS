...
public final class DataResVersionNotifyOuterClass {
  ...
  public interface DataResVersionNotifyOrBuilder extends
     ...
     * @return The opType.
     */
    emu.gingerps.net.proto.DataResVersionNotifyOuterClass.DataResVersionNotify.DataResVersionOpType getOpType();
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.DataResVersionNotifyOuterClass.internal_static_DataResVersionNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.DataResVersionNotifyOuterClass.DataResVersionNotify.class, emu.gingerps.net.proto.DataResVersionNotifyOuterClass.DataResVersionNotify.Builder.class);
    }
    ...
    public enum DataResVersionOpType
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return emu.gingerps.net.proto.DataResVersionNotifyOuterClass.DataResVersionNotify.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (opType_ != emu.gingerps.net.proto.DataResVersionNotifyOuterClass.DataResVersionNotify.DataResVersionOpType.DATA_RES_VERSION_OP_TYPE_NONE.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.DataResVersionNotifyOuterClass.DataResVersionNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.DataResVersionNotifyOuterClass.DataResVersionNotify other = (emu.gingerps.net.proto.DataResVersionNotifyOuterClass.DataResVersionNotify) obj;
    ...
    public static emu.gingerps.net.proto.DataResVersionNotifyOuterClass.DataResVersionNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.DataResVersionNotifyOuterClass.DataResVersionNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.DataResVersionNotifyOuterClass.DataResVersionNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.DataResVersionNotifyOuterClass.DataResVersionNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.DataResVersionNotifyOuterClass.DataResVersionNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.DataResVersionNotifyOuterClass.DataResVersionNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.DataResVersionNotifyOuterClass.DataResVersionNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.DataResVersionNotifyOuterClass.DataResVersionNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.DataResVersionNotifyOuterClass.internal_static_DataResVersionNotify_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.DataResVersionNotifyOuterClass.DataResVersionNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.DataResVersionNotifyOuterClass.DataResVersionNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.DataResVersionNotifyOuterClass.DataResVersionNotify build() {
        emu.gingerps.net.proto.DataResVersionNotifyOuterClass.DataResVersionNotify result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.DataResVersionNotifyOuterClass.DataResVersionNotify) {
          return mergeFrom((emu.gingerps.net.proto.DataResVersionNotifyOuterClass.DataResVersionNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.DataResVersionNotifyOuterClass.DataResVersionNotify other) {
        if (other == emu.gingerps.net.proto.DataResVersionNotifyOuterClass.DataResVersionNotify.getDefaultInstance()) return this;
       ...
       * @return This builder for chaining.
       */
      public Builder setOpType(emu.gingerps.net.proto.DataResVersionNotifyOuterClass.DataResVersionNotify.DataResVersionOpType value) {
        if (value == null) {
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.gingerps.net.proto.DataResVersionNotifyOuterClass.DataResVersionNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.DataResVersionNotifyOuterClass.DataResVersionNotify();
    }

    public static emu.gingerps.net.proto.DataResVersionNotifyOuterClass.DataResVersionNotify getDefaultInstance() {
