...
public final class BlossomChestInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.BlossomChestInfoOuterClass.internal_static_BlossomChestInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.BlossomChestInfoOuterClass.BlossomChestInfo.class, emu.gingerps.net.proto.BlossomChestInfoOuterClass.BlossomChestInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.BlossomChestInfoOuterClass.BlossomChestInfo)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.BlossomChestInfoOuterClass.BlossomChestInfo other = (emu.gingerps.net.proto.BlossomChestInfoOuterClass.BlossomChestInfo) obj;
    ...
    public static emu.gingerps.net.proto.BlossomChestInfoOuterClass.BlossomChestInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.BlossomChestInfoOuterClass.BlossomChestInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.BlossomChestInfoOuterClass.BlossomChestInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.BlossomChestInfoOuterClass.BlossomChestInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.BlossomChestInfoOuterClass.BlossomChestInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.BlossomChestInfoOuterClass.BlossomChestInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.BlossomChestInfoOuterClass.BlossomChestInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.BlossomChestInfoOuterClass.BlossomChestInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.BlossomChestInfoOuterClass.internal_static_BlossomChestInfo_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.BlossomChestInfoOuterClass.BlossomChestInfo getDefaultInstanceForType() {
        return emu.gingerps.net.proto.BlossomChestInfoOuterClass.BlossomChestInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.BlossomChestInfoOuterClass.BlossomChestInfo build() {
        emu.gingerps.net.proto.BlossomChestInfoOuterClass.BlossomChestInfo result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.BlossomChestInfoOuterClass.BlossomChestInfo) {
          return mergeFrom((emu.gingerps.net.proto.BlossomChestInfoOuterClass.BlossomChestInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.BlossomChestInfoOuterClass.BlossomChestInfo other) {
        if (other == emu.gingerps.net.proto.BlossomChestInfoOuterClass.BlossomChestInfo.getDefaultInstance()) return this;
        if (other.getResin() != 0) {
    ...
    private static final emu.gingerps.net.proto.BlossomChestInfoOuterClass.BlossomChestInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.BlossomChestInfoOuterClass.BlossomChestInfo();
    }

    public static emu.gingerps.net.proto.BlossomChestInfoOuterClass.BlossomChestInfo getDefaultInstance() {
