...
public final class HomeStakePlayRecordOuterClass {
  ...
  public interface HomeStakePlayRecordOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo> 
        getEngagedPlayerInfoListList();
    /**
     * <code>repeated .HomeGroupPlayerInfo engaged_player_info_list = 7;</code>
     */
    emu.gingerps.net.proto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo getEngagedPlayerInfoList(int index);
    /**
     * <code>repeated .HomeGroupPlayerInfo engaged_player_info_list = 7;</code>
     */
     ...
     * <code>repeated .HomeGroupPlayerInfo engaged_player_info_list = 7;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfoOrBuilder> 
        getEngagedPlayerInfoListOrBuilderList();
    /**
     * <code>repeated .HomeGroupPlayerInfo engaged_player_info_list = 7;</code>
     */
    emu.gingerps.net.proto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfoOrBuilder getEngagedPlayerInfoListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.HomeStakePlayRecordOuterClass.internal_static_HomeStakePlayRecord_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord.class, emu.gingerps.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo> getEngagedPlayerInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfoOrBuilder> 
        getEngagedPlayerInfoListOrBuilderList() {
      return engagedPlayerInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo getEngagedPlayerInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfoOrBuilder getEngagedPlayerInfoListOrBuilder(
        int index) {
      return engagedPlayerInfoList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord other = (emu.gingerps.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord) obj;
    ...
    public static emu.gingerps.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord parseFrom(
    ...
    public static emu.gingerps.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord parseFrom(
    ...
    public static emu.gingerps.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecordOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.HomeStakePlayRecordOuterClass.internal_static_HomeStakePlayRecord_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord getDefaultInstanceForType() {
        return emu.gingerps.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord build() {
        emu.gingerps.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord) {
          return mergeFrom((emu.gingerps.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord other) {
        if (other == emu.gingerps.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord.getDefaultInstance()) return this;
        if (engagedPlayerInfoListBuilder_ == null) {
      ...
      private void ensureEngagedPlayerInfoListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          engagedPlayerInfoList_ = new java.util.ArrayList<emu.gingerps.net.proto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo>(engagedPlayerInfoList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo, emu.gingerps.net.proto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo.Builder, emu.gingerps.net.proto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfoOrBuilder> engagedPlayerInfoListBuilder_;
      ...
      public Builder setEngagedPlayerInfoList(
          int index, emu.gingerps.net.proto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo value) {
        if (engagedPlayerInfoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setEngagedPlayerInfoList(
          int index, emu.gingerps.net.proto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo.Builder builderForValue) {
        if (engagedPlayerInfoListBuilder_ == null) {
          ensureEngagedPlayerInfoListIsMutable();
       ...
       * <code>repeated .HomeGroupPlayerInfo engaged_player_info_list = 7;</code>
       */
      public Builder addEngagedPlayerInfoList(emu.gingerps.net.proto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo value) {
        if (engagedPlayerInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addAllEngagedPlayerInfoList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo> values) {
        if (engagedPlayerInfoListBuilder_ == null) {
          ensureEngagedPlayerInfoListIsMutable();
       ...
       * <code>repeated .HomeGroupPlayerInfo engaged_player_info_list = 7;</code>
       */
      public emu.gingerps.net.proto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo.Builder getEngagedPlayerInfoListBuilder(
          int index) {
       ...
       * <code>repeated .HomeGroupPlayerInfo engaged_player_info_list = 7;</code>
       */
      public emu.gingerps.net.proto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo.Builder addEngagedPlayerInfoListBuilder() {
        return getEngagedPlayerInfoListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .HomeGroupPlayerInfo engaged_player_info_list = 7;</code>
       */
      public emu.gingerps.net.proto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo.Builder addEngagedPlayerInfoListBuilder(
          int index) {
        return getEngagedPlayerInfoListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .HomeGroupPlayerInfo engaged_player_info_list = 7;</code>
       */
      public java.util.List<emu.gingerps.net.proto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo.Builder> 
    ...
    private static final emu.gingerps.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord();
    }

    public static emu.gingerps.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord getDefaultInstance() {
