...
public final class BartenderActivityDetailInfoOuterClass {
  ...
  public interface BartenderActivityDetailInfoOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.BartenderLevelInfoOuterClass.BartenderLevelInfo> 
        getUnlockLevelListList();
    /**
     * <code>repeated .BartenderLevelInfo unlock_level_list = 10;</code>
     */
    emu.gingerps.net.proto.BartenderLevelInfoOuterClass.BartenderLevelInfo getUnlockLevelList(int index);
    /**
     * <code>repeated .BartenderLevelInfo unlock_level_list = 10;</code>
     */
     ...
     * <code>repeated .BartenderLevelInfo unlock_level_list = 10;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.BartenderLevelInfoOuterClass.BartenderLevelInfoOrBuilder> 
        getUnlockLevelListOrBuilderList();
    /**
     * <code>repeated .BartenderLevelInfo unlock_level_list = 10;</code>
     */
    emu.gingerps.net.proto.BartenderLevelInfoOuterClass.BartenderLevelInfoOrBuilder getUnlockLevelListOrBuilder(
        int index);
     ...
     */
    java.util.List<emu.gingerps.net.proto.BartenderTaskInfoOuterClass.BartenderTaskInfo> 
        getUnlockTaskListList();
    /**
     * <code>repeated .BartenderTaskInfo unlock_task_list = 5;</code>
     */
    emu.gingerps.net.proto.BartenderTaskInfoOuterClass.BartenderTaskInfo getUnlockTaskList(int index);
    /**
     * <code>repeated .BartenderTaskInfo unlock_task_list = 5;</code>
     */
     ...
     * <code>repeated .BartenderTaskInfo unlock_task_list = 5;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.BartenderTaskInfoOuterClass.BartenderTaskInfoOrBuilder> 
        getUnlockTaskListOrBuilderList();
    /**
     * <code>repeated .BartenderTaskInfo unlock_task_list = 5;</code>
     */
    emu.gingerps.net.proto.BartenderTaskInfoOuterClass.BartenderTaskInfoOrBuilder getUnlockTaskListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 42: {
              if (!((mutable_bitField0_ & 0x00000008) != 0)) {
                unlockTaskList_ = new java.util.ArrayList<emu.gingerps.net.proto.BartenderTaskInfoOuterClass.BartenderTaskInfo>();
                mutable_bitField0_ |= 0x00000008;
              }
              unlockTaskList_.add(
                  input.readMessage(emu.gingerps.net.proto.BartenderTaskInfoOuterClass.BartenderTaskInfo.parser(), extensionRegistry));
              break;
            }
            case 48: {
            ...
            case 82: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                unlockLevelList_ = new java.util.ArrayList<emu.gingerps.net.proto.BartenderLevelInfoOuterClass.BartenderLevelInfo>();
                mutable_bitField0_ |= 0x00000001;
              }
              unlockLevelList_.add(
                  input.readMessage(emu.gingerps.net.proto.BartenderLevelInfoOuterClass.BartenderLevelInfo.parser(), extensionRegistry));
              break;
            }
            case 120: {
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.gingerps.net.proto.BartenderActivityDetailInfoOuterClass.internal_static_BartenderActivityDetailInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.gingerps.net.proto.BartenderActivityDetailInfoOuterClass.internal_static_BartenderActivityDetailInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo.class, emu.gingerps.net.proto.BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo.Builder.class);
    }
    ...
    private java.util.List<emu.gingerps.net.proto.BartenderLevelInfoOuterClass.BartenderLevelInfo> unlockLevelList_;
    /**
     * <code>repeated .BartenderLevelInfo unlock_level_list = 10;</code>
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.BartenderLevelInfoOuterClass.BartenderLevelInfo> getUnlockLevelListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.BartenderLevelInfoOuterClass.BartenderLevelInfoOrBuilder> 
        getUnlockLevelListOrBuilderList() {
      return unlockLevelList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.BartenderLevelInfoOuterClass.BartenderLevelInfo getUnlockLevelList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.BartenderLevelInfoOuterClass.BartenderLevelInfoOrBuilder getUnlockLevelListOrBuilder(
        int index) {
      return unlockLevelList_.get(index);
    }
    ...
    private java.util.List<emu.gingerps.net.proto.BartenderTaskInfoOuterClass.BartenderTaskInfo> unlockTaskList_;
    /**
     * <code>repeated .BartenderTaskInfo unlock_task_list = 5;</code>
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.BartenderTaskInfoOuterClass.BartenderTaskInfo> getUnlockTaskListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.BartenderTaskInfoOuterClass.BartenderTaskInfoOrBuilder> 
        getUnlockTaskListOrBuilderList() {
      return unlockTaskList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.BartenderTaskInfoOuterClass.BartenderTaskInfo getUnlockTaskList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.BartenderTaskInfoOuterClass.BartenderTaskInfoOrBuilder getUnlockTaskListOrBuilder(
        int index) {
      return unlockTaskList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo other = (emu.gingerps.net.proto.BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo) obj;
    ...
    public static emu.gingerps.net.proto.BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.BartenderActivityDetailInfoOuterClass.internal_static_BartenderActivityDetailInfo_descriptor;
      }
      ...
      // Construct using emu.gingerps.net.proto.BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo getDefaultInstanceForType() {
        return emu.gingerps.net.proto.BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo build() {
        emu.gingerps.net.proto.BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo buildPartial() {
        emu.gingerps.net.proto.BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo result = new emu.gingerps.net.proto.BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo) {
          return mergeFrom((emu.gingerps.net.proto.BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo other) {
        if (other == emu.gingerps.net.proto.BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        emu.gingerps.net.proto.BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (emu.gingerps.net.proto.BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo) e.getUnfinishedMessage();
      ...
      private void ensureUnlockLevelListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          unlockLevelList_ = new java.util.ArrayList<emu.gingerps.net.proto.BartenderLevelInfoOuterClass.BartenderLevelInfo>(unlockLevelList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.BartenderLevelInfoOuterClass.BartenderLevelInfo, emu.gingerps.net.proto.BartenderLevelInfoOuterClass.BartenderLevelInfo.Builder, emu.gingerps.net.proto.BartenderLevelInfoOuterClass.BartenderLevelInfoOrBuilder> unlockLevelListBuilder_;
      ...
      public Builder setUnlockLevelList(
          int index, emu.gingerps.net.proto.BartenderLevelInfoOuterClass.BartenderLevelInfo value) {
        if (unlockLevelListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setUnlockLevelList(
          int index, emu.gingerps.net.proto.BartenderLevelInfoOuterClass.BartenderLevelInfo.Builder builderForValue) {
        if (unlockLevelListBuilder_ == null) {
          ensureUnlockLevelListIsMutable();
       ...
       * <code>repeated .BartenderLevelInfo unlock_level_list = 10;</code>
       */
      public Builder addUnlockLevelList(emu.gingerps.net.proto.BartenderLevelInfoOuterClass.BartenderLevelInfo value) {
        if (unlockLevelListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addUnlockLevelList(
          emu.gingerps.net.proto.BartenderLevelInfoOuterClass.BartenderLevelInfo.Builder builderForValue) {
        if (unlockLevelListBuilder_ == null) {
          ensureUnlockLevelListIsMutable();
      ...
      public Builder addAllUnlockLevelList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.BartenderLevelInfoOuterClass.BartenderLevelInfo> values) {
        if (unlockLevelListBuilder_ == null) {
          ensureUnlockLevelListIsMutable();
       ...
       * <code>repeated .BartenderLevelInfo unlock_level_list = 10;</code>
       */
      public emu.gingerps.net.proto.BartenderLevelInfoOuterClass.BartenderLevelInfo.Builder getUnlockLevelListBuilder(
          int index) {
       ...
       * <code>repeated .BartenderLevelInfo unlock_level_list = 10;</code>
       */
      public emu.gingerps.net.proto.BartenderLevelInfoOuterClass.BartenderLevelInfo.Builder addUnlockLevelListBuilder() {
        return getUnlockLevelListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.BartenderLevelInfoOuterClass.BartenderLevelInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .BartenderLevelInfo unlock_level_list = 10;</code>
       */
      public emu.gingerps.net.proto.BartenderLevelInfoOuterClass.BartenderLevelInfo.Builder addUnlockLevelListBuilder(
          int index) {
        return getUnlockLevelListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.BartenderLevelInfoOuterClass.BartenderLevelInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .BartenderLevelInfo unlock_level_list = 10;</code>
       */
      public java.util.List<emu.gingerps.net.proto.BartenderLevelInfoOuterClass.BartenderLevelInfo.Builder> 
           getUnlockLevelListBuilderList() {
        return getUnlockLevelListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.BartenderLevelInfoOuterClass.BartenderLevelInfo, emu.gingerps.net.proto.BartenderLevelInfoOuterClass.BartenderLevelInfo.Builder, emu.gingerps.net.proto.BartenderLevelInfoOuterClass.BartenderLevelInfoOrBuilder> 
          getUnlockLevelListFieldBuilder() {
        if (unlockLevelListBuilder_ == null) {
      ...
      private void ensureUnlockTaskListIsMutable() {
        if (!((bitField0_ & 0x00000008) != 0)) {
          unlockTaskList_ = new java.util.ArrayList<emu.gingerps.net.proto.BartenderTaskInfoOuterClass.BartenderTaskInfo>(unlockTaskList_);
          bitField0_ |= 0x00000008;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.BartenderTaskInfoOuterClass.BartenderTaskInfo, emu.gingerps.net.proto.BartenderTaskInfoOuterClass.BartenderTaskInfo.Builder, emu.gingerps.net.proto.BartenderTaskInfoOuterClass.BartenderTaskInfoOrBuilder> unlockTaskListBuilder_;
      ...
      public Builder setUnlockTaskList(
          int index, emu.gingerps.net.proto.BartenderTaskInfoOuterClass.BartenderTaskInfo value) {
        if (unlockTaskListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setUnlockTaskList(
          int index, emu.gingerps.net.proto.BartenderTaskInfoOuterClass.BartenderTaskInfo.Builder builderForValue) {
        if (unlockTaskListBuilder_ == null) {
          ensureUnlockTaskListIsMutable();
       ...
       * <code>repeated .BartenderTaskInfo unlock_task_list = 5;</code>
       */
      public Builder addUnlockTaskList(emu.gingerps.net.proto.BartenderTaskInfoOuterClass.BartenderTaskInfo value) {
        if (unlockTaskListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addUnlockTaskList(
          emu.gingerps.net.proto.BartenderTaskInfoOuterClass.BartenderTaskInfo.Builder builderForValue) {
        if (unlockTaskListBuilder_ == null) {
          ensureUnlockTaskListIsMutable();
      ...
      public Builder addAllUnlockTaskList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.BartenderTaskInfoOuterClass.BartenderTaskInfo> values) {
        if (unlockTaskListBuilder_ == null) {
          ensureUnlockTaskListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .BartenderTaskInfo unlock_task_list = 5;</code>
       */
      public emu.gingerps.net.proto.BartenderTaskInfoOuterClass.BartenderTaskInfo.Builder getUnlockTaskListBuilder(
          int index) {
       ...
       * <code>repeated .BartenderTaskInfo unlock_task_list = 5;</code>
       */
      public emu.gingerps.net.proto.BartenderTaskInfoOuterClass.BartenderTaskInfo.Builder addUnlockTaskListBuilder() {
        return getUnlockTaskListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.BartenderTaskInfoOuterClass.BartenderTaskInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .BartenderTaskInfo unlock_task_list = 5;</code>
       */
      public emu.gingerps.net.proto.BartenderTaskInfoOuterClass.BartenderTaskInfo.Builder addUnlockTaskListBuilder(
          int index) {
        return getUnlockTaskListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.BartenderTaskInfoOuterClass.BartenderTaskInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .BartenderTaskInfo unlock_task_list = 5;</code>
       */
      public java.util.List<emu.gingerps.net.proto.BartenderTaskInfoOuterClass.BartenderTaskInfo.Builder> 
           getUnlockTaskListBuilderList() {
        return getUnlockTaskListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.BartenderTaskInfoOuterClass.BartenderTaskInfo, emu.gingerps.net.proto.BartenderTaskInfoOuterClass.BartenderTaskInfo.Builder, emu.gingerps.net.proto.BartenderTaskInfoOuterClass.BartenderTaskInfoOrBuilder> 
          getUnlockTaskListFieldBuilder() {
        if (unlockTaskListBuilder_ == null) {
    ...
    private static final emu.gingerps.net.proto.BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo();
    }

    public static emu.gingerps.net.proto.BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.BartenderLevelInfoOuterClass.getDescriptor(),
          emu.gingerps.net.proto.BartenderTaskInfoOuterClass.getDescriptor(),
        });
    internal_static_BartenderActivityDetailInfo_descriptor =
