...
public final class ScenePlayBattleInfoNotifyOuterClass {
  ...
  public interface ScenePlayBattleInfoNotifyOrBuilder extends
     ...
     */
    emu.gingerps.net.proto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfo getBattleInfo();
    /**
     * <code>.ScenePlayBattleInfo battle_info = 8;</code>
     */
    emu.gingerps.net.proto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfoOrBuilder getBattleInfoOrBuilder();
  }
  /**
   * <pre>
   * enum CmdId {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.ScenePlayBattleInfoNotifyOuterClass.internal_static_ScenePlayBattleInfoNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.ScenePlayBattleInfoNotifyOuterClass.ScenePlayBattleInfoNotify.class, emu.gingerps.net.proto.ScenePlayBattleInfoNotifyOuterClass.ScenePlayBattleInfoNotify.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfo getBattleInfo() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.ScenePlayBattleInfoNotifyOuterClass.ScenePlayBattleInfoNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.ScenePlayBattleInfoNotifyOuterClass.ScenePlayBattleInfoNotify other = (emu.gingerps.net.proto.ScenePlayBattleInfoNotifyOuterClass.ScenePlayBattleInfoNotify) obj;
    ...
    public static emu.gingerps.net.proto.ScenePlayBattleInfoNotifyOuterClass.ScenePlayBattleInfoNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.ScenePlayBattleInfoNotifyOuterClass.ScenePlayBattleInfoNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.ScenePlayBattleInfoNotifyOuterClass.ScenePlayBattleInfoNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.ScenePlayBattleInfoNotifyOuterClass.ScenePlayBattleInfoNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.ScenePlayBattleInfoNotifyOuterClass.ScenePlayBattleInfoNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.ScenePlayBattleInfoNotifyOuterClass.ScenePlayBattleInfoNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.ScenePlayBattleInfoNotifyOuterClass.ScenePlayBattleInfoNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.ScenePlayBattleInfoNotifyOuterClass.ScenePlayBattleInfoNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.ScenePlayBattleInfoNotifyOuterClass.internal_static_ScenePlayBattleInfoNotify_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.ScenePlayBattleInfoNotifyOuterClass.ScenePlayBattleInfoNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.ScenePlayBattleInfoNotifyOuterClass.ScenePlayBattleInfoNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.ScenePlayBattleInfoNotifyOuterClass.ScenePlayBattleInfoNotify build() {
        emu.gingerps.net.proto.ScenePlayBattleInfoNotifyOuterClass.ScenePlayBattleInfoNotify result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.ScenePlayBattleInfoNotifyOuterClass.ScenePlayBattleInfoNotify) {
          return mergeFrom((emu.gingerps.net.proto.ScenePlayBattleInfoNotifyOuterClass.ScenePlayBattleInfoNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.ScenePlayBattleInfoNotifyOuterClass.ScenePlayBattleInfoNotify other) {
        if (other == emu.gingerps.net.proto.ScenePlayBattleInfoNotifyOuterClass.ScenePlayBattleInfoNotify.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfo, emu.gingerps.net.proto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfo.Builder, emu.gingerps.net.proto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfoOrBuilder> battleInfoBuilder_;
      /**
       * <code>.ScenePlayBattleInfo battle_info = 8;</code>
       * @return Whether the battleInfo field is set.
       */
       ...
       * <code>.ScenePlayBattleInfo battle_info = 8;</code>
       */
      public Builder setBattleInfo(emu.gingerps.net.proto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfo value) {
        if (battleInfoBuilder_ == null) {
          if (value == null) {
      ...
      public emu.gingerps.net.proto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfoOrBuilder getBattleInfoOrBuilder() {
        if (battleInfoBuilder_ != null) {
          ...
          return battleInfo_ == null ?
              emu.gingerps.net.proto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfo.getDefaultInstance() : battleInfo_;
        }
      }
      /**
       * <code>.ScenePlayBattleInfo battle_info = 8;</code>
    ...
    private static final emu.gingerps.net.proto.ScenePlayBattleInfoNotifyOuterClass.ScenePlayBattleInfoNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.ScenePlayBattleInfoNotifyOuterClass.ScenePlayBattleInfoNotify();
    }

    public static emu.gingerps.net.proto.ScenePlayBattleInfoNotifyOuterClass.ScenePlayBattleInfoNotify getDefaultInstance() {
