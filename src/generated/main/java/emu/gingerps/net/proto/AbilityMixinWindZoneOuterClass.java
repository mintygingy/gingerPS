...
public final class AbilityMixinWindZoneOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.gingerps.net.proto.AbilityMixinWindZoneOuterClass.internal_static_AbilityMixinWindZone_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.gingerps.net.proto.AbilityMixinWindZoneOuterClass.internal_static_AbilityMixinWindZone_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.AbilityMixinWindZoneOuterClass.AbilityMixinWindZone.class, emu.gingerps.net.proto.AbilityMixinWindZoneOuterClass.AbilityMixinWindZone.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.AbilityMixinWindZoneOuterClass.AbilityMixinWindZone)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.AbilityMixinWindZoneOuterClass.AbilityMixinWindZone other = (emu.gingerps.net.proto.AbilityMixinWindZoneOuterClass.AbilityMixinWindZone) obj;
    ...
    public static emu.gingerps.net.proto.AbilityMixinWindZoneOuterClass.AbilityMixinWindZone parseFrom(
    ...
    public static emu.gingerps.net.proto.AbilityMixinWindZoneOuterClass.AbilityMixinWindZone parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.AbilityMixinWindZoneOuterClass.AbilityMixinWindZone parseFrom(
    ...
    public static emu.gingerps.net.proto.AbilityMixinWindZoneOuterClass.AbilityMixinWindZone parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.AbilityMixinWindZoneOuterClass.AbilityMixinWindZone parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.AbilityMixinWindZoneOuterClass.AbilityMixinWindZone parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.AbilityMixinWindZoneOuterClass.AbilityMixinWindZone prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.AbilityMixinWindZoneOuterClass.AbilityMixinWindZoneOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.AbilityMixinWindZoneOuterClass.internal_static_AbilityMixinWindZone_descriptor;
      }
      ...
      // Construct using emu.gingerps.net.proto.AbilityMixinWindZoneOuterClass.AbilityMixinWindZone.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.AbilityMixinWindZoneOuterClass.AbilityMixinWindZone getDefaultInstanceForType() {
        return emu.gingerps.net.proto.AbilityMixinWindZoneOuterClass.AbilityMixinWindZone.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.AbilityMixinWindZoneOuterClass.AbilityMixinWindZone build() {
        emu.gingerps.net.proto.AbilityMixinWindZoneOuterClass.AbilityMixinWindZone result = buildPartial();
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.AbilityMixinWindZoneOuterClass.AbilityMixinWindZone buildPartial() {
        emu.gingerps.net.proto.AbilityMixinWindZoneOuterClass.AbilityMixinWindZone result = new emu.gingerps.net.proto.AbilityMixinWindZoneOuterClass.AbilityMixinWindZone(this);
      ...
      private void buildPartialRepeatedFields(emu.gingerps.net.proto.AbilityMixinWindZoneOuterClass.AbilityMixinWindZone result) {
      ...
      private void buildPartial0(emu.gingerps.net.proto.AbilityMixinWindZoneOuterClass.AbilityMixinWindZone result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.AbilityMixinWindZoneOuterClass.AbilityMixinWindZone) {
          return mergeFrom((emu.gingerps.net.proto.AbilityMixinWindZoneOuterClass.AbilityMixinWindZone)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.AbilityMixinWindZoneOuterClass.AbilityMixinWindZone other) {
        if (other == emu.gingerps.net.proto.AbilityMixinWindZoneOuterClass.AbilityMixinWindZone.getDefaultInstance()) return this;
    ...
    private static final emu.gingerps.net.proto.AbilityMixinWindZoneOuterClass.AbilityMixinWindZone DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.AbilityMixinWindZoneOuterClass.AbilityMixinWindZone();
    }

    public static emu.gingerps.net.proto.AbilityMixinWindZoneOuterClass.AbilityMixinWindZone getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\r\022\033\n\023Unk3300_DJELBGDEDBH\030\014 \003(\rB\030\n\026emu.gi" +
