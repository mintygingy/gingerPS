...
public final class HideAndSeekSettleNotifyOuterClass {
  ...
  public interface HideAndSeekSettleNotifyOrBuilder extends
     ...
     * <code>repeated .ExhibitionDisplayInfo score_list = 11;</code>
     */
    emu.gingerps.net.proto.ExhibitionDisplayInfoOuterClass.ExhibitionDisplayInfo getScoreList(int index);
    /**
     * <code>repeated .ExhibitionDisplayInfo score_list = 11;</code>
     */
     ...
     * <code>repeated .ExhibitionDisplayInfo score_list = 11;</code>
     */
    emu.gingerps.net.proto.ExhibitionDisplayInfoOuterClass.ExhibitionDisplayInfoOrBuilder getScoreListOrBuilder(
        int index);
     ...
     * @return The reason.
     */
    emu.gingerps.net.proto.HideAndSeekSettleNotifyOuterClass.HideAndSeekSettleNotify.SettleReason getReason();
     ...
     */
    java.util.List<emu.gingerps.net.proto.HideAndSeekSettleInfoOuterClass.HideAndSeekSettleInfo> 
        getSettleInfoListList();
    /**
     * <code>repeated .HideAndSeekSettleInfo settle_info_list = 4;</code>
     */
    emu.gingerps.net.proto.HideAndSeekSettleInfoOuterClass.HideAndSeekSettleInfo getSettleInfoList(int index);
    /**
     * <code>repeated .HideAndSeekSettleInfo settle_info_list = 4;</code>
     */
     ...
     * <code>repeated .HideAndSeekSettleInfo settle_info_list = 4;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.HideAndSeekSettleInfoOuterClass.HideAndSeekSettleInfoOrBuilder> 
        getSettleInfoListOrBuilderList();
    /**
     * <code>repeated .HideAndSeekSettleInfo settle_info_list = 4;</code>
     */
    emu.gingerps.net.proto.HideAndSeekSettleInfoOuterClass.HideAndSeekSettleInfoOrBuilder getSettleInfoListOrBuilder(
        int index);
  }
  /**
   * <pre>
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.HideAndSeekSettleNotifyOuterClass.internal_static_HideAndSeekSettleNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.HideAndSeekSettleNotifyOuterClass.HideAndSeekSettleNotify.class, emu.gingerps.net.proto.HideAndSeekSettleNotifyOuterClass.HideAndSeekSettleNotify.Builder.class);
    }
    ...
    public enum SettleReason
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return emu.gingerps.net.proto.HideAndSeekSettleNotifyOuterClass.HideAndSeekSettleNotify.getDescriptor().getEnumTypes().get(0);
      }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.ExhibitionDisplayInfoOuterClass.ExhibitionDisplayInfo> getScoreListList() {
      return scoreList_;
    }
    /**
     * <code>repeated .ExhibitionDisplayInfo score_list = 11;</code>
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.ExhibitionDisplayInfoOuterClass.ExhibitionDisplayInfo getScoreList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.ExhibitionDisplayInfoOuterClass.ExhibitionDisplayInfoOrBuilder getScoreListOrBuilder(
        int index) {
      return scoreList_.get(index);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.HideAndSeekSettleInfoOuterClass.HideAndSeekSettleInfo> getSettleInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.HideAndSeekSettleInfoOuterClass.HideAndSeekSettleInfoOrBuilder> 
        getSettleInfoListOrBuilderList() {
      return settleInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.HideAndSeekSettleInfoOuterClass.HideAndSeekSettleInfo getSettleInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.HideAndSeekSettleInfoOuterClass.HideAndSeekSettleInfoOrBuilder getSettleInfoListOrBuilder(
        int index) {
      return settleInfoList_.get(index);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      getSerializedSize();
      if (reason_ != emu.gingerps.net.proto.HideAndSeekSettleNotifyOuterClass.HideAndSeekSettleNotify.SettleReason.SETTLE_REASON_TIME_OUT.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.HideAndSeekSettleNotifyOuterClass.HideAndSeekSettleNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.HideAndSeekSettleNotifyOuterClass.HideAndSeekSettleNotify other = (emu.gingerps.net.proto.HideAndSeekSettleNotifyOuterClass.HideAndSeekSettleNotify) obj;
    ...
    public static emu.gingerps.net.proto.HideAndSeekSettleNotifyOuterClass.HideAndSeekSettleNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.HideAndSeekSettleNotifyOuterClass.HideAndSeekSettleNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.HideAndSeekSettleNotifyOuterClass.HideAndSeekSettleNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.HideAndSeekSettleNotifyOuterClass.HideAndSeekSettleNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.HideAndSeekSettleNotifyOuterClass.HideAndSeekSettleNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.HideAndSeekSettleNotifyOuterClass.HideAndSeekSettleNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.HideAndSeekSettleNotifyOuterClass.HideAndSeekSettleNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.HideAndSeekSettleNotifyOuterClass.HideAndSeekSettleNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.HideAndSeekSettleNotifyOuterClass.internal_static_HideAndSeekSettleNotify_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.HideAndSeekSettleNotifyOuterClass.HideAndSeekSettleNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.HideAndSeekSettleNotifyOuterClass.HideAndSeekSettleNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.HideAndSeekSettleNotifyOuterClass.HideAndSeekSettleNotify build() {
        emu.gingerps.net.proto.HideAndSeekSettleNotifyOuterClass.HideAndSeekSettleNotify result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.HideAndSeekSettleNotifyOuterClass.HideAndSeekSettleNotify) {
          return mergeFrom((emu.gingerps.net.proto.HideAndSeekSettleNotifyOuterClass.HideAndSeekSettleNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.HideAndSeekSettleNotifyOuterClass.HideAndSeekSettleNotify other) {
        if (other == emu.gingerps.net.proto.HideAndSeekSettleNotifyOuterClass.HideAndSeekSettleNotify.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.ExhibitionDisplayInfoOuterClass.ExhibitionDisplayInfo, emu.gingerps.net.proto.ExhibitionDisplayInfoOuterClass.ExhibitionDisplayInfo.Builder, emu.gingerps.net.proto.ExhibitionDisplayInfoOuterClass.ExhibitionDisplayInfoOrBuilder> scoreListBuilder_;
       ...
       * <code>repeated .ExhibitionDisplayInfo score_list = 11;</code>
       */
      public Builder addScoreList(emu.gingerps.net.proto.ExhibitionDisplayInfoOuterClass.ExhibitionDisplayInfo value) {
        if (scoreListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .ExhibitionDisplayInfo score_list = 11;</code>
       */
      public emu.gingerps.net.proto.ExhibitionDisplayInfoOuterClass.ExhibitionDisplayInfo.Builder getScoreListBuilder(
          int index) {
       ...
       * <code>repeated .ExhibitionDisplayInfo score_list = 11;</code>
       */
      public emu.gingerps.net.proto.ExhibitionDisplayInfoOuterClass.ExhibitionDisplayInfo.Builder addScoreListBuilder() {
       ...
       * @return This builder for chaining.
       */
      public Builder setReason(emu.gingerps.net.proto.HideAndSeekSettleNotifyOuterClass.HideAndSeekSettleNotify.SettleReason value) {
        if (value == null) {
          throw new NullPointerException();
        }
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.HideAndSeekSettleInfoOuterClass.HideAndSeekSettleInfo, emu.gingerps.net.proto.HideAndSeekSettleInfoOuterClass.HideAndSeekSettleInfo.Builder, emu.gingerps.net.proto.HideAndSeekSettleInfoOuterClass.HideAndSeekSettleInfoOrBuilder> settleInfoListBuilder_;
      ...
      public Builder setSettleInfoList(
          int index, emu.gingerps.net.proto.HideAndSeekSettleInfoOuterClass.HideAndSeekSettleInfo value) {
        if (settleInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setSettleInfoList(
          int index, emu.gingerps.net.proto.HideAndSeekSettleInfoOuterClass.HideAndSeekSettleInfo.Builder builderForValue) {
        if (settleInfoListBuilder_ == null) {
          ensureSettleInfoListIsMutable();
       ...
       * <code>repeated .HideAndSeekSettleInfo settle_info_list = 4;</code>
       */
      public Builder addSettleInfoList(emu.gingerps.net.proto.HideAndSeekSettleInfoOuterClass.HideAndSeekSettleInfo value) {
        if (settleInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addSettleInfoList(
          emu.gingerps.net.proto.HideAndSeekSettleInfoOuterClass.HideAndSeekSettleInfo.Builder builderForValue) {
        if (settleInfoListBuilder_ == null) {
          ensureSettleInfoListIsMutable();
      ...
      public Builder addAllSettleInfoList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.HideAndSeekSettleInfoOuterClass.HideAndSeekSettleInfo> values) {
        if (settleInfoListBuilder_ == null) {
          ensureSettleInfoListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .HideAndSeekSettleInfo settle_info_list = 4;</code>
       */
      public emu.gingerps.net.proto.HideAndSeekSettleInfoOuterClass.HideAndSeekSettleInfo.Builder getSettleInfoListBuilder(
          int index) {
       ...
       * <code>repeated .HideAndSeekSettleInfo settle_info_list = 4;</code>
       */
      public emu.gingerps.net.proto.HideAndSeekSettleInfoOuterClass.HideAndSeekSettleInfo.Builder addSettleInfoListBuilder() {
        return getSettleInfoListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.HideAndSeekSettleInfoOuterClass.HideAndSeekSettleInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .HideAndSeekSettleInfo settle_info_list = 4;</code>
       */
      public emu.gingerps.net.proto.HideAndSeekSettleInfoOuterClass.HideAndSeekSettleInfo.Builder addSettleInfoListBuilder(
          int index) {
        return getSettleInfoListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.HideAndSeekSettleInfoOuterClass.HideAndSeekSettleInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .HideAndSeekSettleInfo settle_info_list = 4;</code>
       */
      public java.util.List<emu.gingerps.net.proto.HideAndSeekSettleInfoOuterClass.HideAndSeekSettleInfo.Builder> 
    ...
    private static final emu.gingerps.net.proto.HideAndSeekSettleNotifyOuterClass.HideAndSeekSettleNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.HideAndSeekSettleNotifyOuterClass.HideAndSeekSettleNotify();
    }

    public static emu.gingerps.net.proto.HideAndSeekSettleNotifyOuterClass.HideAndSeekSettleNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "D\020\001\022\035\n\031SETTLE_REASON_PLAYER_QUIT\020\002B\030\n\026em" +
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          ...
          emu.gingerps.net.proto.HideAndSeekSettleInfoOuterClass.getDescriptor(),
        });
    internal_static_HideAndSeekSettleNotify_descriptor =
