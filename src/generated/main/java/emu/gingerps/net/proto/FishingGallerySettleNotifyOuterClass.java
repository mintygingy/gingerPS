...
public final class FishingGallerySettleNotifyOuterClass {
  ...
  public interface FishingGallerySettleNotifyOrBuilder extends
     ...
     */
    emu.gingerps.net.proto.FishingGallerySettleInfoOuterClass.FishingGallerySettleInfo getSettleInfo();
    /**
     * <code>.FishingGallerySettleInfo settle_info = 4;</code>
     */
    emu.gingerps.net.proto.FishingGallerySettleInfoOuterClass.FishingGallerySettleInfoOrBuilder getSettleInfoOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.FishingGallerySettleNotifyOuterClass.internal_static_FishingGallerySettleNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.FishingGallerySettleNotifyOuterClass.FishingGallerySettleNotify.class, emu.gingerps.net.proto.FishingGallerySettleNotifyOuterClass.FishingGallerySettleNotify.Builder.class);
    }
    ...
    private emu.gingerps.net.proto.FishingGallerySettleInfoOuterClass.FishingGallerySettleInfo settleInfo_;
    /**
     * <code>.FishingGallerySettleInfo settle_info = 4;</code>
     * @return Whether the settleInfo field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.FishingGallerySettleInfoOuterClass.FishingGallerySettleInfo getSettleInfo() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.FishingGallerySettleNotifyOuterClass.FishingGallerySettleNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.FishingGallerySettleNotifyOuterClass.FishingGallerySettleNotify other = (emu.gingerps.net.proto.FishingGallerySettleNotifyOuterClass.FishingGallerySettleNotify) obj;
    ...
    public static emu.gingerps.net.proto.FishingGallerySettleNotifyOuterClass.FishingGallerySettleNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.FishingGallerySettleNotifyOuterClass.FishingGallerySettleNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.FishingGallerySettleNotifyOuterClass.FishingGallerySettleNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.FishingGallerySettleNotifyOuterClass.FishingGallerySettleNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.FishingGallerySettleNotifyOuterClass.FishingGallerySettleNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.FishingGallerySettleNotifyOuterClass.FishingGallerySettleNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.FishingGallerySettleNotifyOuterClass.FishingGallerySettleNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.FishingGallerySettleNotifyOuterClass.FishingGallerySettleNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.FishingGallerySettleNotifyOuterClass.internal_static_FishingGallerySettleNotify_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.FishingGallerySettleNotifyOuterClass.FishingGallerySettleNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.FishingGallerySettleNotifyOuterClass.FishingGallerySettleNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.FishingGallerySettleNotifyOuterClass.FishingGallerySettleNotify build() {
        emu.gingerps.net.proto.FishingGallerySettleNotifyOuterClass.FishingGallerySettleNotify result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.FishingGallerySettleNotifyOuterClass.FishingGallerySettleNotify) {
          return mergeFrom((emu.gingerps.net.proto.FishingGallerySettleNotifyOuterClass.FishingGallerySettleNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.FishingGallerySettleNotifyOuterClass.FishingGallerySettleNotify other) {
        if (other == emu.gingerps.net.proto.FishingGallerySettleNotifyOuterClass.FishingGallerySettleNotify.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.FishingGallerySettleInfoOuterClass.FishingGallerySettleInfo, emu.gingerps.net.proto.FishingGallerySettleInfoOuterClass.FishingGallerySettleInfo.Builder, emu.gingerps.net.proto.FishingGallerySettleInfoOuterClass.FishingGallerySettleInfoOrBuilder> settleInfoBuilder_;
      /**
       * <code>.FishingGallerySettleInfo settle_info = 4;</code>
       * @return Whether the settleInfo field is set.
       */
       ...
       * <code>.FishingGallerySettleInfo settle_info = 4;</code>
       */
      public Builder setSettleInfo(emu.gingerps.net.proto.FishingGallerySettleInfoOuterClass.FishingGallerySettleInfo value) {
        if (settleInfoBuilder_ == null) {
          if (value == null) {
      ...
      public emu.gingerps.net.proto.FishingGallerySettleInfoOuterClass.FishingGallerySettleInfoOrBuilder getSettleInfoOrBuilder() {
        if (settleInfoBuilder_ != null) {
          ...
          return settleInfo_ == null ?
              emu.gingerps.net.proto.FishingGallerySettleInfoOuterClass.FishingGallerySettleInfo.getDefaultInstance() : settleInfo_;
        }
      }
      /**
       * <code>.FishingGallerySettleInfo settle_info = 4;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.FishingGallerySettleInfoOuterClass.FishingGallerySettleInfo, emu.gingerps.net.proto.FishingGallerySettleInfoOuterClass.FishingGallerySettleInfo.Builder, emu.gingerps.net.proto.FishingGallerySettleInfoOuterClass.FishingGallerySettleInfoOrBuilder> 
    ...
    private static final emu.gingerps.net.proto.FishingGallerySettleNotifyOuterClass.FishingGallerySettleNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.FishingGallerySettleNotifyOuterClass.FishingGallerySettleNotify();
    }

    public static emu.gingerps.net.proto.FishingGallerySettleNotifyOuterClass.FishingGallerySettleNotify getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.FishingGallerySettleInfoOuterClass.getDescriptor(),
        });
    internal_static_FishingGallerySettleNotify_descriptor =
