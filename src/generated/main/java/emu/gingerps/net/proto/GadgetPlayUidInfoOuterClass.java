...
public final class GadgetPlayUidInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.GadgetPlayUidInfoOuterClass.internal_static_GadgetPlayUidInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.GadgetPlayUidInfoOuterClass.GadgetPlayUidInfo.class, emu.gingerps.net.proto.GadgetPlayUidInfoOuterClass.GadgetPlayUidInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.GadgetPlayUidInfoOuterClass.GadgetPlayUidInfo)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.GadgetPlayUidInfoOuterClass.GadgetPlayUidInfo other = (emu.gingerps.net.proto.GadgetPlayUidInfoOuterClass.GadgetPlayUidInfo) obj;
    ...
    public static emu.gingerps.net.proto.GadgetPlayUidInfoOuterClass.GadgetPlayUidInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.GadgetPlayUidInfoOuterClass.GadgetPlayUidInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.GadgetPlayUidInfoOuterClass.GadgetPlayUidInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.GadgetPlayUidInfoOuterClass.GadgetPlayUidInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.GadgetPlayUidInfoOuterClass.GadgetPlayUidInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.GadgetPlayUidInfoOuterClass.GadgetPlayUidInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.GadgetPlayUidInfoOuterClass.GadgetPlayUidInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.GadgetPlayUidInfoOuterClass.GadgetPlayUidInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.GadgetPlayUidInfoOuterClass.internal_static_GadgetPlayUidInfo_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.GadgetPlayUidInfoOuterClass.GadgetPlayUidInfo getDefaultInstanceForType() {
        return emu.gingerps.net.proto.GadgetPlayUidInfoOuterClass.GadgetPlayUidInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.GadgetPlayUidInfoOuterClass.GadgetPlayUidInfo build() {
        emu.gingerps.net.proto.GadgetPlayUidInfoOuterClass.GadgetPlayUidInfo result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.GadgetPlayUidInfoOuterClass.GadgetPlayUidInfo) {
          return mergeFrom((emu.gingerps.net.proto.GadgetPlayUidInfoOuterClass.GadgetPlayUidInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.GadgetPlayUidInfoOuterClass.GadgetPlayUidInfo other) {
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.gingerps.net.proto.GadgetPlayUidInfoOuterClass.GadgetPlayUidInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.GadgetPlayUidInfoOuterClass.GadgetPlayUidInfo();
    }

    public static emu.gingerps.net.proto.GadgetPlayUidInfoOuterClass.GadgetPlayUidInfo getDefaultInstance() {
