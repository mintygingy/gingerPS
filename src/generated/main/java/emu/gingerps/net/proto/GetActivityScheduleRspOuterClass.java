...
public final class GetActivityScheduleRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.GetActivityScheduleRspOuterClass.internal_static_GetActivityScheduleRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.GetActivityScheduleRspOuterClass.GetActivityScheduleRsp.class, emu.gingerps.net.proto.GetActivityScheduleRspOuterClass.GetActivityScheduleRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.GetActivityScheduleRspOuterClass.GetActivityScheduleRsp)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.GetActivityScheduleRspOuterClass.GetActivityScheduleRsp other = (emu.gingerps.net.proto.GetActivityScheduleRspOuterClass.GetActivityScheduleRsp) obj;
    ...
    public static emu.gingerps.net.proto.GetActivityScheduleRspOuterClass.GetActivityScheduleRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.GetActivityScheduleRspOuterClass.GetActivityScheduleRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.GetActivityScheduleRspOuterClass.GetActivityScheduleRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.GetActivityScheduleRspOuterClass.GetActivityScheduleRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.GetActivityScheduleRspOuterClass.GetActivityScheduleRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.GetActivityScheduleRspOuterClass.GetActivityScheduleRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.GetActivityScheduleRspOuterClass.GetActivityScheduleRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.GetActivityScheduleRspOuterClass.GetActivityScheduleRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.GetActivityScheduleRspOuterClass.internal_static_GetActivityScheduleRsp_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.GetActivityScheduleRspOuterClass.GetActivityScheduleRsp getDefaultInstanceForType() {
        return emu.gingerps.net.proto.GetActivityScheduleRspOuterClass.GetActivityScheduleRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.GetActivityScheduleRspOuterClass.GetActivityScheduleRsp build() {
        emu.gingerps.net.proto.GetActivityScheduleRspOuterClass.GetActivityScheduleRsp result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.GetActivityScheduleRspOuterClass.GetActivityScheduleRsp) {
          return mergeFrom((emu.gingerps.net.proto.GetActivityScheduleRspOuterClass.GetActivityScheduleRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.GetActivityScheduleRspOuterClass.GetActivityScheduleRsp other) {
        if (other == emu.gingerps.net.proto.GetActivityScheduleRspOuterClass.GetActivityScheduleRsp.getDefaultInstance()) return this;
        if (activityScheduleListBuilder_ == null) {
    ...
    private static final emu.gingerps.net.proto.GetActivityScheduleRspOuterClass.GetActivityScheduleRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.GetActivityScheduleRspOuterClass.GetActivityScheduleRsp();
    }

    public static emu.gingerps.net.proto.GetActivityScheduleRspOuterClass.GetActivityScheduleRsp getDefaultInstance() {
