...
public final class AbilityAppliedModifierOuterClass {
  ...
  public interface AbilityAppliedModifierOrBuilder extends
     ...
     */
    emu.gingerps.net.proto.ModifierDurabilityOuterClass.ModifierDurability getModifierDurability();
    /**
     * <code>.ModifierDurability modifier_durability = 11;</code>
     */
    emu.gingerps.net.proto.ModifierDurabilityOuterClass.ModifierDurabilityOrBuilder getModifierDurabilityOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.AbilityAppliedModifierOuterClass.internal_static_AbilityAppliedModifier_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.AbilityAppliedModifierOuterClass.AbilityAppliedModifier.class, emu.gingerps.net.proto.AbilityAppliedModifierOuterClass.AbilityAppliedModifier.Builder.class);
    }
    ...
    private emu.gingerps.net.proto.ModifierDurabilityOuterClass.ModifierDurability modifierDurability_;
    /**
     * <code>.ModifierDurability modifier_durability = 11;</code>
     * @return Whether the modifierDurability field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.ModifierDurabilityOuterClass.ModifierDurability getModifierDurability() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.AbilityAppliedModifierOuterClass.AbilityAppliedModifier)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.AbilityAppliedModifierOuterClass.AbilityAppliedModifier other = (emu.gingerps.net.proto.AbilityAppliedModifierOuterClass.AbilityAppliedModifier) obj;
    ...
    public static emu.gingerps.net.proto.AbilityAppliedModifierOuterClass.AbilityAppliedModifier parseFrom(
    ...
    public static emu.gingerps.net.proto.AbilityAppliedModifierOuterClass.AbilityAppliedModifier parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.AbilityAppliedModifierOuterClass.AbilityAppliedModifier parseFrom(
    ...
    public static emu.gingerps.net.proto.AbilityAppliedModifierOuterClass.AbilityAppliedModifier parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.AbilityAppliedModifierOuterClass.AbilityAppliedModifier parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.AbilityAppliedModifierOuterClass.AbilityAppliedModifier parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.AbilityAppliedModifierOuterClass.AbilityAppliedModifier prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.AbilityAppliedModifierOuterClass.AbilityAppliedModifierOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.AbilityAppliedModifierOuterClass.internal_static_AbilityAppliedModifier_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.AbilityAppliedModifierOuterClass.AbilityAppliedModifier getDefaultInstanceForType() {
        return emu.gingerps.net.proto.AbilityAppliedModifierOuterClass.AbilityAppliedModifier.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.AbilityAppliedModifierOuterClass.AbilityAppliedModifier build() {
        emu.gingerps.net.proto.AbilityAppliedModifierOuterClass.AbilityAppliedModifier result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.AbilityAppliedModifierOuterClass.AbilityAppliedModifier) {
          return mergeFrom((emu.gingerps.net.proto.AbilityAppliedModifierOuterClass.AbilityAppliedModifier)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.AbilityAppliedModifierOuterClass.AbilityAppliedModifier other) {
        if (other == emu.gingerps.net.proto.AbilityAppliedModifierOuterClass.AbilityAppliedModifier.getDefaultInstance()) return this;
      ...
      private emu.gingerps.net.proto.ModifierDurabilityOuterClass.ModifierDurability modifierDurability_;
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.ModifierDurabilityOuterClass.ModifierDurability, emu.gingerps.net.proto.ModifierDurabilityOuterClass.ModifierDurability.Builder, emu.gingerps.net.proto.ModifierDurabilityOuterClass.ModifierDurabilityOrBuilder> modifierDurabilityBuilder_;
      /**
       * <code>.ModifierDurability modifier_durability = 11;</code>
       * @return Whether the modifierDurability field is set.
       */
       ...
       * <code>.ModifierDurability modifier_durability = 11;</code>
       */
      public Builder setModifierDurability(emu.gingerps.net.proto.ModifierDurabilityOuterClass.ModifierDurability value) {
        if (modifierDurabilityBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public emu.gingerps.net.proto.ModifierDurabilityOuterClass.ModifierDurabilityOrBuilder getModifierDurabilityOrBuilder() {
        if (modifierDurabilityBuilder_ != null) {
          ...
          return modifierDurability_ == null ?
              emu.gingerps.net.proto.ModifierDurabilityOuterClass.ModifierDurability.getDefaultInstance() : modifierDurability_;
        }
      }
      /**
       * <code>.ModifierDurability modifier_durability = 11;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.ModifierDurabilityOuterClass.ModifierDurability, emu.gingerps.net.proto.ModifierDurabilityOuterClass.ModifierDurability.Builder, emu.gingerps.net.proto.ModifierDurabilityOuterClass.ModifierDurabilityOrBuilder> 
    ...
    private static final emu.gingerps.net.proto.AbilityAppliedModifierOuterClass.AbilityAppliedModifier DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.AbilityAppliedModifierOuterClass.AbilityAppliedModifier();
    }

    public static emu.gingerps.net.proto.AbilityAppliedModifierOuterClass.AbilityAppliedModifier getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          ...
          emu.gingerps.net.proto.ModifierDurabilityOuterClass.getDescriptor(),
        });
    internal_static_AbilityAppliedModifier_descriptor =
