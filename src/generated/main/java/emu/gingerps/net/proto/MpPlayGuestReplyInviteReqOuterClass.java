...
public final class MpPlayGuestReplyInviteReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.MpPlayGuestReplyInviteReqOuterClass.internal_static_MpPlayGuestReplyInviteReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.MpPlayGuestReplyInviteReqOuterClass.MpPlayGuestReplyInviteReq.class, emu.gingerps.net.proto.MpPlayGuestReplyInviteReqOuterClass.MpPlayGuestReplyInviteReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.MpPlayGuestReplyInviteReqOuterClass.MpPlayGuestReplyInviteReq)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.MpPlayGuestReplyInviteReqOuterClass.MpPlayGuestReplyInviteReq other = (emu.gingerps.net.proto.MpPlayGuestReplyInviteReqOuterClass.MpPlayGuestReplyInviteReq) obj;
    ...
    public static emu.gingerps.net.proto.MpPlayGuestReplyInviteReqOuterClass.MpPlayGuestReplyInviteReq parseFrom(
    ...
    public static emu.gingerps.net.proto.MpPlayGuestReplyInviteReqOuterClass.MpPlayGuestReplyInviteReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.MpPlayGuestReplyInviteReqOuterClass.MpPlayGuestReplyInviteReq parseFrom(
    ...
    public static emu.gingerps.net.proto.MpPlayGuestReplyInviteReqOuterClass.MpPlayGuestReplyInviteReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.MpPlayGuestReplyInviteReqOuterClass.MpPlayGuestReplyInviteReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.MpPlayGuestReplyInviteReqOuterClass.MpPlayGuestReplyInviteReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.MpPlayGuestReplyInviteReqOuterClass.MpPlayGuestReplyInviteReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.MpPlayGuestReplyInviteReqOuterClass.MpPlayGuestReplyInviteReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.MpPlayGuestReplyInviteReqOuterClass.internal_static_MpPlayGuestReplyInviteReq_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.MpPlayGuestReplyInviteReqOuterClass.MpPlayGuestReplyInviteReq getDefaultInstanceForType() {
        return emu.gingerps.net.proto.MpPlayGuestReplyInviteReqOuterClass.MpPlayGuestReplyInviteReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.MpPlayGuestReplyInviteReqOuterClass.MpPlayGuestReplyInviteReq build() {
        emu.gingerps.net.proto.MpPlayGuestReplyInviteReqOuterClass.MpPlayGuestReplyInviteReq result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.MpPlayGuestReplyInviteReqOuterClass.MpPlayGuestReplyInviteReq) {
          return mergeFrom((emu.gingerps.net.proto.MpPlayGuestReplyInviteReqOuterClass.MpPlayGuestReplyInviteReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.MpPlayGuestReplyInviteReqOuterClass.MpPlayGuestReplyInviteReq other) {
        if (other == emu.gingerps.net.proto.MpPlayGuestReplyInviteReqOuterClass.MpPlayGuestReplyInviteReq.getDefaultInstance()) return this;
    ...
    private static final emu.gingerps.net.proto.MpPlayGuestReplyInviteReqOuterClass.MpPlayGuestReplyInviteReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.MpPlayGuestReplyInviteReqOuterClass.MpPlayGuestReplyInviteReq();
    }

    public static emu.gingerps.net.proto.MpPlayGuestReplyInviteReqOuterClass.MpPlayGuestReplyInviteReq getDefaultInstance() {
