...
public final class AddSeenMonsterNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.gingerps.net.proto.AddSeenMonsterNotifyOuterClass.internal_static_AddSeenMonsterNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.gingerps.net.proto.AddSeenMonsterNotifyOuterClass.internal_static_AddSeenMonsterNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify.class, emu.gingerps.net.proto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify other = (emu.gingerps.net.proto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify) obj;
    ...
    public static emu.gingerps.net.proto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.AddSeenMonsterNotifyOuterClass.internal_static_AddSeenMonsterNotify_descriptor;
      }
      ...
      // Construct using emu.gingerps.net.proto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify build() {
        emu.gingerps.net.proto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify buildPartial() {
        emu.gingerps.net.proto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify result = new emu.gingerps.net.proto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify(this);
      ...
      private void buildPartialRepeatedFields(emu.gingerps.net.proto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify result) {
      ...
      private void buildPartial0(emu.gingerps.net.proto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify) {
          return mergeFrom((emu.gingerps.net.proto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify other) {
        if (other == emu.gingerps.net.proto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify.getDefaultInstance()) return this;
    ...
    private static final emu.gingerps.net.proto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify();
    }

    public static emu.gingerps.net.proto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "onsterNotify\022\027\n\017monster_id_list\030\016 \003(\rB\030\n" +
