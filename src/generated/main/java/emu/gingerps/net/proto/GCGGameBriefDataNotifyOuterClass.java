...
public final class GCGGameBriefDataNotifyOuterClass {
  ...
  public interface GCGGameBriefDataNotifyOrBuilder extends
     ...
     */
    emu.gingerps.net.proto.GCGGameBriefDataOuterClass.GCGGameBriefData getGcgBriefData();
    /**
     * <code>.GCGGameBriefData gcg_brief_data = 3;</code>
     */
    emu.gingerps.net.proto.GCGGameBriefDataOuterClass.GCGGameBriefDataOrBuilder getGcgBriefDataOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.GCGGameBriefDataNotifyOuterClass.internal_static_GCGGameBriefDataNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.GCGGameBriefDataNotifyOuterClass.GCGGameBriefDataNotify.class, emu.gingerps.net.proto.GCGGameBriefDataNotifyOuterClass.GCGGameBriefDataNotify.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.GCGGameBriefDataOuterClass.GCGGameBriefData getGcgBriefData() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.GCGGameBriefDataNotifyOuterClass.GCGGameBriefDataNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.GCGGameBriefDataNotifyOuterClass.GCGGameBriefDataNotify other = (emu.gingerps.net.proto.GCGGameBriefDataNotifyOuterClass.GCGGameBriefDataNotify) obj;
    ...
    public static emu.gingerps.net.proto.GCGGameBriefDataNotifyOuterClass.GCGGameBriefDataNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.GCGGameBriefDataNotifyOuterClass.GCGGameBriefDataNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.GCGGameBriefDataNotifyOuterClass.GCGGameBriefDataNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.GCGGameBriefDataNotifyOuterClass.GCGGameBriefDataNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.GCGGameBriefDataNotifyOuterClass.GCGGameBriefDataNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.GCGGameBriefDataNotifyOuterClass.GCGGameBriefDataNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.GCGGameBriefDataNotifyOuterClass.GCGGameBriefDataNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.GCGGameBriefDataNotifyOuterClass.GCGGameBriefDataNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.GCGGameBriefDataNotifyOuterClass.internal_static_GCGGameBriefDataNotify_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.GCGGameBriefDataNotifyOuterClass.GCGGameBriefDataNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.GCGGameBriefDataNotifyOuterClass.GCGGameBriefDataNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.GCGGameBriefDataNotifyOuterClass.GCGGameBriefDataNotify build() {
        emu.gingerps.net.proto.GCGGameBriefDataNotifyOuterClass.GCGGameBriefDataNotify result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.GCGGameBriefDataNotifyOuterClass.GCGGameBriefDataNotify) {
          return mergeFrom((emu.gingerps.net.proto.GCGGameBriefDataNotifyOuterClass.GCGGameBriefDataNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.GCGGameBriefDataNotifyOuterClass.GCGGameBriefDataNotify other) {
        if (other == emu.gingerps.net.proto.GCGGameBriefDataNotifyOuterClass.GCGGameBriefDataNotify.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.GCGGameBriefDataOuterClass.GCGGameBriefData, emu.gingerps.net.proto.GCGGameBriefDataOuterClass.GCGGameBriefData.Builder, emu.gingerps.net.proto.GCGGameBriefDataOuterClass.GCGGameBriefDataOrBuilder> gcgBriefDataBuilder_;
      /**
       * <code>.GCGGameBriefData gcg_brief_data = 3;</code>
       * @return Whether the gcgBriefData field is set.
       */
       ...
       * <code>.GCGGameBriefData gcg_brief_data = 3;</code>
       */
      public Builder setGcgBriefData(emu.gingerps.net.proto.GCGGameBriefDataOuterClass.GCGGameBriefData value) {
        if (gcgBriefDataBuilder_ == null) {
          if (value == null) {
      ...
      public emu.gingerps.net.proto.GCGGameBriefDataOuterClass.GCGGameBriefDataOrBuilder getGcgBriefDataOrBuilder() {
        if (gcgBriefDataBuilder_ != null) {
          ...
          return gcgBriefData_ == null ?
              emu.gingerps.net.proto.GCGGameBriefDataOuterClass.GCGGameBriefData.getDefaultInstance() : gcgBriefData_;
        }
      }
      /**
       * <code>.GCGGameBriefData gcg_brief_data = 3;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.GCGGameBriefDataOuterClass.GCGGameBriefData, emu.gingerps.net.proto.GCGGameBriefDataOuterClass.GCGGameBriefData.Builder, emu.gingerps.net.proto.GCGGameBriefDataOuterClass.GCGGameBriefDataOrBuilder> 
    ...
    private static final emu.gingerps.net.proto.GCGGameBriefDataNotifyOuterClass.GCGGameBriefDataNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.GCGGameBriefDataNotifyOuterClass.GCGGameBriefDataNotify();
    }

    public static emu.gingerps.net.proto.GCGGameBriefDataNotifyOuterClass.GCGGameBriefDataNotify getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.GCGGameBriefDataOuterClass.getDescriptor(),
        });
    internal_static_GCGGameBriefDataNotify_descriptor =
