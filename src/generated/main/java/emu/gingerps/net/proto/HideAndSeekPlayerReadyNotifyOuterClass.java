...
public final class HideAndSeekPlayerReadyNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.HideAndSeekPlayerReadyNotifyOuterClass.internal_static_HideAndSeekPlayerReadyNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.HideAndSeekPlayerReadyNotifyOuterClass.HideAndSeekPlayerReadyNotify.class, emu.gingerps.net.proto.HideAndSeekPlayerReadyNotifyOuterClass.HideAndSeekPlayerReadyNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.HideAndSeekPlayerReadyNotifyOuterClass.HideAndSeekPlayerReadyNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.HideAndSeekPlayerReadyNotifyOuterClass.HideAndSeekPlayerReadyNotify other = (emu.gingerps.net.proto.HideAndSeekPlayerReadyNotifyOuterClass.HideAndSeekPlayerReadyNotify) obj;
    ...
    public static emu.gingerps.net.proto.HideAndSeekPlayerReadyNotifyOuterClass.HideAndSeekPlayerReadyNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.HideAndSeekPlayerReadyNotifyOuterClass.HideAndSeekPlayerReadyNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.HideAndSeekPlayerReadyNotifyOuterClass.HideAndSeekPlayerReadyNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.HideAndSeekPlayerReadyNotifyOuterClass.HideAndSeekPlayerReadyNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.HideAndSeekPlayerReadyNotifyOuterClass.HideAndSeekPlayerReadyNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.HideAndSeekPlayerReadyNotifyOuterClass.HideAndSeekPlayerReadyNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.HideAndSeekPlayerReadyNotifyOuterClass.HideAndSeekPlayerReadyNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.HideAndSeekPlayerReadyNotifyOuterClass.HideAndSeekPlayerReadyNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.HideAndSeekPlayerReadyNotifyOuterClass.internal_static_HideAndSeekPlayerReadyNotify_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.HideAndSeekPlayerReadyNotifyOuterClass.HideAndSeekPlayerReadyNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.HideAndSeekPlayerReadyNotifyOuterClass.HideAndSeekPlayerReadyNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.HideAndSeekPlayerReadyNotifyOuterClass.HideAndSeekPlayerReadyNotify build() {
        emu.gingerps.net.proto.HideAndSeekPlayerReadyNotifyOuterClass.HideAndSeekPlayerReadyNotify result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.HideAndSeekPlayerReadyNotifyOuterClass.HideAndSeekPlayerReadyNotify) {
          return mergeFrom((emu.gingerps.net.proto.HideAndSeekPlayerReadyNotifyOuterClass.HideAndSeekPlayerReadyNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.HideAndSeekPlayerReadyNotifyOuterClass.HideAndSeekPlayerReadyNotify other) {
        if (other == emu.gingerps.net.proto.HideAndSeekPlayerReadyNotifyOuterClass.HideAndSeekPlayerReadyNotify.getDefaultInstance()) return this;
    ...
    private static final emu.gingerps.net.proto.HideAndSeekPlayerReadyNotifyOuterClass.HideAndSeekPlayerReadyNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.HideAndSeekPlayerReadyNotifyOuterClass.HideAndSeekPlayerReadyNotify();
    }

    public static emu.gingerps.net.proto.HideAndSeekPlayerReadyNotifyOuterClass.HideAndSeekPlayerReadyNotify getDefaultInstance() {
