...
public final class VehicleInfoOuterClass {
  ...
  public interface VehicleInfoOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.VehicleMemberOuterClass.VehicleMember> 
        getMemberListList();
    /**
     * <code>repeated .VehicleMember member_list = 1;</code>
     */
    emu.gingerps.net.proto.VehicleMemberOuterClass.VehicleMember getMemberList(int index);
    /**
     * <code>repeated .VehicleMember member_list = 1;</code>
     */
     ...
     * <code>repeated .VehicleMember member_list = 1;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.VehicleMemberOuterClass.VehicleMemberOrBuilder> 
        getMemberListOrBuilderList();
    /**
     * <code>repeated .VehicleMember member_list = 1;</code>
     */
    emu.gingerps.net.proto.VehicleMemberOuterClass.VehicleMemberOrBuilder getMemberListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.VehicleInfoOuterClass.internal_static_VehicleInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.VehicleInfoOuterClass.VehicleInfo.class, emu.gingerps.net.proto.VehicleInfoOuterClass.VehicleInfo.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.VehicleMemberOuterClass.VehicleMember> getMemberListList() {
      return memberList_;
    }
    /**
     * <code>repeated .VehicleMember member_list = 1;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.VehicleMemberOuterClass.VehicleMemberOrBuilder> 
        getMemberListOrBuilderList() {
      return memberList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.VehicleMemberOuterClass.VehicleMember getMemberList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.VehicleMemberOuterClass.VehicleMemberOrBuilder getMemberListOrBuilder(
        int index) {
      return memberList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.VehicleInfoOuterClass.VehicleInfo)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.VehicleInfoOuterClass.VehicleInfo other = (emu.gingerps.net.proto.VehicleInfoOuterClass.VehicleInfo) obj;
    ...
    public static emu.gingerps.net.proto.VehicleInfoOuterClass.VehicleInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.VehicleInfoOuterClass.VehicleInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.VehicleInfoOuterClass.VehicleInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.VehicleInfoOuterClass.VehicleInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.VehicleInfoOuterClass.VehicleInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.VehicleInfoOuterClass.VehicleInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.VehicleInfoOuterClass.VehicleInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.VehicleInfoOuterClass.VehicleInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.VehicleInfoOuterClass.internal_static_VehicleInfo_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.VehicleInfoOuterClass.VehicleInfo getDefaultInstanceForType() {
        return emu.gingerps.net.proto.VehicleInfoOuterClass.VehicleInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.VehicleInfoOuterClass.VehicleInfo build() {
        emu.gingerps.net.proto.VehicleInfoOuterClass.VehicleInfo result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.VehicleInfoOuterClass.VehicleInfo) {
          return mergeFrom((emu.gingerps.net.proto.VehicleInfoOuterClass.VehicleInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.VehicleInfoOuterClass.VehicleInfo other) {
        if (other == emu.gingerps.net.proto.VehicleInfoOuterClass.VehicleInfo.getDefaultInstance()) return this;
        if (memberListBuilder_ == null) {
      ...
      private void ensureMemberListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          memberList_ = new java.util.ArrayList<emu.gingerps.net.proto.VehicleMemberOuterClass.VehicleMember>(memberList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.VehicleMemberOuterClass.VehicleMember, emu.gingerps.net.proto.VehicleMemberOuterClass.VehicleMember.Builder, emu.gingerps.net.proto.VehicleMemberOuterClass.VehicleMemberOrBuilder> memberListBuilder_;
      ...
      public Builder setMemberList(
          int index, emu.gingerps.net.proto.VehicleMemberOuterClass.VehicleMember value) {
        if (memberListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setMemberList(
          int index, emu.gingerps.net.proto.VehicleMemberOuterClass.VehicleMember.Builder builderForValue) {
        if (memberListBuilder_ == null) {
          ensureMemberListIsMutable();
       ...
       * <code>repeated .VehicleMember member_list = 1;</code>
       */
      public Builder addMemberList(emu.gingerps.net.proto.VehicleMemberOuterClass.VehicleMember value) {
        if (memberListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addAllMemberList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.VehicleMemberOuterClass.VehicleMember> values) {
        if (memberListBuilder_ == null) {
          ensureMemberListIsMutable();
       ...
       * <code>repeated .VehicleMember member_list = 1;</code>
       */
      public emu.gingerps.net.proto.VehicleMemberOuterClass.VehicleMember.Builder getMemberListBuilder(
          int index) {
       ...
       * <code>repeated .VehicleMember member_list = 1;</code>
       */
      public emu.gingerps.net.proto.VehicleMemberOuterClass.VehicleMember.Builder addMemberListBuilder() {
        return getMemberListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.VehicleMemberOuterClass.VehicleMember.getDefaultInstance());
      }
      /**
       * <code>repeated .VehicleMember member_list = 1;</code>
       */
      public emu.gingerps.net.proto.VehicleMemberOuterClass.VehicleMember.Builder addMemberListBuilder(
          int index) {
        return getMemberListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.VehicleMemberOuterClass.VehicleMember.getDefaultInstance());
      }
      /**
       * <code>repeated .VehicleMember member_list = 1;</code>
       */
      public java.util.List<emu.gingerps.net.proto.VehicleMemberOuterClass.VehicleMember.Builder> 
           getMemberListBuilderList() {
        return getMemberListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.VehicleMemberOuterClass.VehicleMember, emu.gingerps.net.proto.VehicleMemberOuterClass.VehicleMember.Builder, emu.gingerps.net.proto.VehicleMemberOuterClass.VehicleMemberOrBuilder> 
          getMemberListFieldBuilder() {
        if (memberListBuilder_ == null) {
    ...
    private static final emu.gingerps.net.proto.VehicleInfoOuterClass.VehicleInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.VehicleInfoOuterClass.VehicleInfo();
    }

    public static emu.gingerps.net.proto.VehicleInfoOuterClass.VehicleInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "tamina\030\003 \001(\002B\030\n\026emu.gingerps.net.protob\006" +
      "proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.VehicleMemberOuterClass.getDescriptor(),
        });
    internal_static_VehicleInfo_descriptor =
