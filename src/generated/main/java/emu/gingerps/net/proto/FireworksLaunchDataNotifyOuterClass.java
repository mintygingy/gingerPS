...
public final class FireworksLaunchDataNotifyOuterClass {
  ...
  public interface FireworksLaunchDataNotifyOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.FireworksLaunchSchemeDataOuterClass.FireworksLaunchSchemeData> 
        getSchemeDataListList();
    /**
     * <code>repeated .FireworksLaunchSchemeData scheme_data_list = 8;</code>
     */
    emu.gingerps.net.proto.FireworksLaunchSchemeDataOuterClass.FireworksLaunchSchemeData getSchemeDataList(int index);
    /**
     * <code>repeated .FireworksLaunchSchemeData scheme_data_list = 8;</code>
     */
     ...
     * <code>repeated .FireworksLaunchSchemeData scheme_data_list = 8;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.FireworksLaunchSchemeDataOuterClass.FireworksLaunchSchemeDataOrBuilder> 
        getSchemeDataListOrBuilderList();
    /**
     * <code>repeated .FireworksLaunchSchemeData scheme_data_list = 8;</code>
     */
    emu.gingerps.net.proto.FireworksLaunchSchemeDataOuterClass.FireworksLaunchSchemeDataOrBuilder getSchemeDataListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.FireworksLaunchDataNotifyOuterClass.internal_static_FireworksLaunchDataNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.FireworksLaunchDataNotifyOuterClass.FireworksLaunchDataNotify.class, emu.gingerps.net.proto.FireworksLaunchDataNotifyOuterClass.FireworksLaunchDataNotify.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.FireworksLaunchSchemeDataOuterClass.FireworksLaunchSchemeData> getSchemeDataListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.FireworksLaunchSchemeDataOuterClass.FireworksLaunchSchemeDataOrBuilder> 
        getSchemeDataListOrBuilderList() {
      return schemeDataList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.FireworksLaunchSchemeDataOuterClass.FireworksLaunchSchemeData getSchemeDataList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.FireworksLaunchSchemeDataOuterClass.FireworksLaunchSchemeDataOrBuilder getSchemeDataListOrBuilder(
        int index) {
      return schemeDataList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.FireworksLaunchDataNotifyOuterClass.FireworksLaunchDataNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.FireworksLaunchDataNotifyOuterClass.FireworksLaunchDataNotify other = (emu.gingerps.net.proto.FireworksLaunchDataNotifyOuterClass.FireworksLaunchDataNotify) obj;
    ...
    public static emu.gingerps.net.proto.FireworksLaunchDataNotifyOuterClass.FireworksLaunchDataNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.FireworksLaunchDataNotifyOuterClass.FireworksLaunchDataNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.FireworksLaunchDataNotifyOuterClass.FireworksLaunchDataNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.FireworksLaunchDataNotifyOuterClass.FireworksLaunchDataNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.FireworksLaunchDataNotifyOuterClass.FireworksLaunchDataNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.FireworksLaunchDataNotifyOuterClass.FireworksLaunchDataNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.FireworksLaunchDataNotifyOuterClass.FireworksLaunchDataNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.FireworksLaunchDataNotifyOuterClass.FireworksLaunchDataNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.FireworksLaunchDataNotifyOuterClass.internal_static_FireworksLaunchDataNotify_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.FireworksLaunchDataNotifyOuterClass.FireworksLaunchDataNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.FireworksLaunchDataNotifyOuterClass.FireworksLaunchDataNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.FireworksLaunchDataNotifyOuterClass.FireworksLaunchDataNotify build() {
        emu.gingerps.net.proto.FireworksLaunchDataNotifyOuterClass.FireworksLaunchDataNotify result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.FireworksLaunchDataNotifyOuterClass.FireworksLaunchDataNotify) {
          return mergeFrom((emu.gingerps.net.proto.FireworksLaunchDataNotifyOuterClass.FireworksLaunchDataNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.FireworksLaunchDataNotifyOuterClass.FireworksLaunchDataNotify other) {
        if (other == emu.gingerps.net.proto.FireworksLaunchDataNotifyOuterClass.FireworksLaunchDataNotify.getDefaultInstance()) return this;
        if (schemeDataListBuilder_ == null) {
      ...
      private void ensureSchemeDataListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          schemeDataList_ = new java.util.ArrayList<emu.gingerps.net.proto.FireworksLaunchSchemeDataOuterClass.FireworksLaunchSchemeData>(schemeDataList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.FireworksLaunchSchemeDataOuterClass.FireworksLaunchSchemeData, emu.gingerps.net.proto.FireworksLaunchSchemeDataOuterClass.FireworksLaunchSchemeData.Builder, emu.gingerps.net.proto.FireworksLaunchSchemeDataOuterClass.FireworksLaunchSchemeDataOrBuilder> schemeDataListBuilder_;
      ...
      public Builder setSchemeDataList(
          int index, emu.gingerps.net.proto.FireworksLaunchSchemeDataOuterClass.FireworksLaunchSchemeData value) {
        if (schemeDataListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setSchemeDataList(
          int index, emu.gingerps.net.proto.FireworksLaunchSchemeDataOuterClass.FireworksLaunchSchemeData.Builder builderForValue) {
        if (schemeDataListBuilder_ == null) {
          ensureSchemeDataListIsMutable();
       ...
       * <code>repeated .FireworksLaunchSchemeData scheme_data_list = 8;</code>
       */
      public Builder addSchemeDataList(emu.gingerps.net.proto.FireworksLaunchSchemeDataOuterClass.FireworksLaunchSchemeData value) {
        if (schemeDataListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addAllSchemeDataList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.FireworksLaunchSchemeDataOuterClass.FireworksLaunchSchemeData> values) {
        if (schemeDataListBuilder_ == null) {
          ensureSchemeDataListIsMutable();
       ...
       * <code>repeated .FireworksLaunchSchemeData scheme_data_list = 8;</code>
       */
      public emu.gingerps.net.proto.FireworksLaunchSchemeDataOuterClass.FireworksLaunchSchemeData.Builder getSchemeDataListBuilder(
          int index) {
       ...
       * <code>repeated .FireworksLaunchSchemeData scheme_data_list = 8;</code>
       */
      public emu.gingerps.net.proto.FireworksLaunchSchemeDataOuterClass.FireworksLaunchSchemeData.Builder addSchemeDataListBuilder() {
        return getSchemeDataListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.FireworksLaunchSchemeDataOuterClass.FireworksLaunchSchemeData.getDefaultInstance());
      }
      /**
       * <code>repeated .FireworksLaunchSchemeData scheme_data_list = 8;</code>
       */
      public emu.gingerps.net.proto.FireworksLaunchSchemeDataOuterClass.FireworksLaunchSchemeData.Builder addSchemeDataListBuilder(
          int index) {
        return getSchemeDataListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.FireworksLaunchSchemeDataOuterClass.FireworksLaunchSchemeData.getDefaultInstance());
      }
      /**
       * <code>repeated .FireworksLaunchSchemeData scheme_data_list = 8;</code>
       */
      public java.util.List<emu.gingerps.net.proto.FireworksLaunchSchemeDataOuterClass.FireworksLaunchSchemeData.Builder> 
    ...
    private static final emu.gingerps.net.proto.FireworksLaunchDataNotifyOuterClass.FireworksLaunchDataNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.FireworksLaunchDataNotifyOuterClass.FireworksLaunchDataNotify();
    }

    public static emu.gingerps.net.proto.FireworksLaunchDataNotifyOuterClass.FireworksLaunchDataNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "e_scheme_id\030\017 \001(\rB\030\n\026emu.gingerps.net.pr" +
      "otob\006proto3"
    };
