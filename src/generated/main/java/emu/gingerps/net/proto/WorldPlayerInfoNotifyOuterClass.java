...
public final class WorldPlayerInfoNotifyOuterClass {
  ...
  public interface WorldPlayerInfoNotifyOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo> 
        getPlayerWidgetInfoListList();
    /**
     * <code>repeated .PlayerWidgetInfo player_widget_info_list = 7;</code>
     */
    emu.gingerps.net.proto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo getPlayerWidgetInfoList(int index);
    /**
     * <code>repeated .PlayerWidgetInfo player_widget_info_list = 7;</code>
     */
     ...
     * <code>repeated .PlayerWidgetInfo player_widget_info_list = 7;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.PlayerWidgetInfoOuterClass.PlayerWidgetInfoOrBuilder> 
        getPlayerWidgetInfoListOrBuilderList();
    /**
     * <code>repeated .PlayerWidgetInfo player_widget_info_list = 7;</code>
     */
    emu.gingerps.net.proto.PlayerWidgetInfoOuterClass.PlayerWidgetInfoOrBuilder getPlayerWidgetInfoListOrBuilder(
        int index);
     ...
     */
    java.util.List<emu.gingerps.net.proto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo> 
        getPlayerInfoListList();
    /**
     * <code>repeated .OnlinePlayerInfo player_info_list = 15;</code>
     */
    emu.gingerps.net.proto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo getPlayerInfoList(int index);
    /**
     * <code>repeated .OnlinePlayerInfo player_info_list = 15;</code>
     */
     ...
     * <code>repeated .OnlinePlayerInfo player_info_list = 15;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.OnlinePlayerInfoOuterClass.OnlinePlayerInfoOrBuilder> 
        getPlayerInfoListOrBuilderList();
    /**
     * <code>repeated .OnlinePlayerInfo player_info_list = 15;</code>
     */
    emu.gingerps.net.proto.OnlinePlayerInfoOuterClass.OnlinePlayerInfoOrBuilder getPlayerInfoListOrBuilder(
        int index);
  }
  /**
   * <pre>
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.WorldPlayerInfoNotifyOuterClass.internal_static_WorldPlayerInfoNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify.class, emu.gingerps.net.proto.WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo> getPlayerWidgetInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.PlayerWidgetInfoOuterClass.PlayerWidgetInfoOrBuilder> 
        getPlayerWidgetInfoListOrBuilderList() {
      return playerWidgetInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo getPlayerWidgetInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.PlayerWidgetInfoOuterClass.PlayerWidgetInfoOrBuilder getPlayerWidgetInfoListOrBuilder(
        int index) {
      return playerWidgetInfoList_.get(index);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo> getPlayerInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.OnlinePlayerInfoOuterClass.OnlinePlayerInfoOrBuilder> 
        getPlayerInfoListOrBuilderList() {
      return playerInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo getPlayerInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.OnlinePlayerInfoOuterClass.OnlinePlayerInfoOrBuilder getPlayerInfoListOrBuilder(
        int index) {
      return playerInfoList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify other = (emu.gingerps.net.proto.WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify) obj;
    ...
    public static emu.gingerps.net.proto.WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify parseFrom(
    ...
    public static emu.gingerps.net.proto.WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.WorldPlayerInfoNotifyOuterClass.internal_static_WorldPlayerInfoNotify_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify getDefaultInstanceForType() {
        return emu.gingerps.net.proto.WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify build() {
        emu.gingerps.net.proto.WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify) {
          return mergeFrom((emu.gingerps.net.proto.WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify other) {
        if (other == emu.gingerps.net.proto.WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify.getDefaultInstance()) return this;
        if (playerWidgetInfoListBuilder_ == null) {
      ...
      private void ensurePlayerWidgetInfoListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          playerWidgetInfoList_ = new java.util.ArrayList<emu.gingerps.net.proto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo>(playerWidgetInfoList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo, emu.gingerps.net.proto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo.Builder, emu.gingerps.net.proto.PlayerWidgetInfoOuterClass.PlayerWidgetInfoOrBuilder> playerWidgetInfoListBuilder_;
      ...
      public Builder setPlayerWidgetInfoList(
          int index, emu.gingerps.net.proto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo value) {
        if (playerWidgetInfoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setPlayerWidgetInfoList(
          int index, emu.gingerps.net.proto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo.Builder builderForValue) {
        if (playerWidgetInfoListBuilder_ == null) {
          ensurePlayerWidgetInfoListIsMutable();
       ...
       * <code>repeated .PlayerWidgetInfo player_widget_info_list = 7;</code>
       */
      public Builder addPlayerWidgetInfoList(emu.gingerps.net.proto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo value) {
        if (playerWidgetInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addPlayerWidgetInfoList(
          emu.gingerps.net.proto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo.Builder builderForValue) {
        if (playerWidgetInfoListBuilder_ == null) {
          ensurePlayerWidgetInfoListIsMutable();
      ...
      public Builder addAllPlayerWidgetInfoList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo> values) {
        if (playerWidgetInfoListBuilder_ == null) {
          ensurePlayerWidgetInfoListIsMutable();
       ...
       * <code>repeated .PlayerWidgetInfo player_widget_info_list = 7;</code>
       */
      public emu.gingerps.net.proto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo.Builder getPlayerWidgetInfoListBuilder(
          int index) {
       ...
       * <code>repeated .PlayerWidgetInfo player_widget_info_list = 7;</code>
       */
      public emu.gingerps.net.proto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo.Builder addPlayerWidgetInfoListBuilder() {
        return getPlayerWidgetInfoListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .PlayerWidgetInfo player_widget_info_list = 7;</code>
       */
      public emu.gingerps.net.proto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo.Builder addPlayerWidgetInfoListBuilder(
          int index) {
        return getPlayerWidgetInfoListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .PlayerWidgetInfo player_widget_info_list = 7;</code>
       */
      public java.util.List<emu.gingerps.net.proto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo.Builder> 
           getPlayerWidgetInfoListBuilderList() {
        return getPlayerWidgetInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo, emu.gingerps.net.proto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo.Builder, emu.gingerps.net.proto.PlayerWidgetInfoOuterClass.PlayerWidgetInfoOrBuilder> 
      ...
      private void ensurePlayerInfoListIsMutable() {
        if (!((bitField0_ & 0x00000004) != 0)) {
          playerInfoList_ = new java.util.ArrayList<emu.gingerps.net.proto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo>(playerInfoList_);
          bitField0_ |= 0x00000004;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo, emu.gingerps.net.proto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo.Builder, emu.gingerps.net.proto.OnlinePlayerInfoOuterClass.OnlinePlayerInfoOrBuilder> playerInfoListBuilder_;
      ...
      public Builder setPlayerInfoList(
          int index, emu.gingerps.net.proto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo value) {
        if (playerInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setPlayerInfoList(
          int index, emu.gingerps.net.proto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo.Builder builderForValue) {
        if (playerInfoListBuilder_ == null) {
          ensurePlayerInfoListIsMutable();
       ...
       * <code>repeated .OnlinePlayerInfo player_info_list = 15;</code>
       */
      public Builder addPlayerInfoList(emu.gingerps.net.proto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo value) {
        if (playerInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addAllPlayerInfoList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo> values) {
        if (playerInfoListBuilder_ == null) {
          ensurePlayerInfoListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .OnlinePlayerInfo player_info_list = 15;</code>
       */
      public emu.gingerps.net.proto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo.Builder getPlayerInfoListBuilder(
          int index) {
       ...
       * <code>repeated .OnlinePlayerInfo player_info_list = 15;</code>
       */
      public emu.gingerps.net.proto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo.Builder addPlayerInfoListBuilder() {
        return getPlayerInfoListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .OnlinePlayerInfo player_info_list = 15;</code>
       */
      public emu.gingerps.net.proto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo.Builder addPlayerInfoListBuilder(
          int index) {
        return getPlayerInfoListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .OnlinePlayerInfo player_info_list = 15;</code>
       */
      public java.util.List<emu.gingerps.net.proto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo.Builder> 
    ...
    private static final emu.gingerps.net.proto.WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify();
    }

    public static emu.gingerps.net.proto.WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\030\017 \003(\0132\021.OnlinePlayerInfoB\030\n\026emu.gingerp" +
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          ...
          emu.gingerps.net.proto.PlayerWidgetInfoOuterClass.getDescriptor(),
        });
    internal_static_WorldPlayerInfoNotify_descriptor =
