...
public final class PotionResetChallengeRspOuterClass {
  ...
  public interface PotionResetChallengeRspOrBuilder extends
     ...
     */
    emu.gingerps.net.proto.PotionStageDataOuterClass.PotionStageData getStageData();
    /**
     * <code>.PotionStageData stage_data = 5;</code>
     */
    emu.gingerps.net.proto.PotionStageDataOuterClass.PotionStageDataOrBuilder getStageDataOrBuilder();
  }
  /**
   * <pre>
   * enum CmdId {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.PotionResetChallengeRspOuterClass.internal_static_PotionResetChallengeRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.PotionResetChallengeRspOuterClass.PotionResetChallengeRsp.class, emu.gingerps.net.proto.PotionResetChallengeRspOuterClass.PotionResetChallengeRsp.Builder.class);
    }
    ...
    private emu.gingerps.net.proto.PotionStageDataOuterClass.PotionStageData stageData_;
    /**
     * <code>.PotionStageData stage_data = 5;</code>
     * @return Whether the stageData field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.PotionStageDataOuterClass.PotionStageData getStageData() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.PotionResetChallengeRspOuterClass.PotionResetChallengeRsp)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.PotionResetChallengeRspOuterClass.PotionResetChallengeRsp other = (emu.gingerps.net.proto.PotionResetChallengeRspOuterClass.PotionResetChallengeRsp) obj;
    ...
    public static emu.gingerps.net.proto.PotionResetChallengeRspOuterClass.PotionResetChallengeRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.PotionResetChallengeRspOuterClass.PotionResetChallengeRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.PotionResetChallengeRspOuterClass.PotionResetChallengeRsp parseFrom(
    ...
    public static emu.gingerps.net.proto.PotionResetChallengeRspOuterClass.PotionResetChallengeRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.PotionResetChallengeRspOuterClass.PotionResetChallengeRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.PotionResetChallengeRspOuterClass.PotionResetChallengeRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.PotionResetChallengeRspOuterClass.PotionResetChallengeRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.PotionResetChallengeRspOuterClass.PotionResetChallengeRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.PotionResetChallengeRspOuterClass.internal_static_PotionResetChallengeRsp_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.PotionResetChallengeRspOuterClass.PotionResetChallengeRsp getDefaultInstanceForType() {
        return emu.gingerps.net.proto.PotionResetChallengeRspOuterClass.PotionResetChallengeRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.PotionResetChallengeRspOuterClass.PotionResetChallengeRsp build() {
        emu.gingerps.net.proto.PotionResetChallengeRspOuterClass.PotionResetChallengeRsp result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.PotionResetChallengeRspOuterClass.PotionResetChallengeRsp) {
          return mergeFrom((emu.gingerps.net.proto.PotionResetChallengeRspOuterClass.PotionResetChallengeRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.PotionResetChallengeRspOuterClass.PotionResetChallengeRsp other) {
        if (other == emu.gingerps.net.proto.PotionResetChallengeRspOuterClass.PotionResetChallengeRsp.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.PotionStageDataOuterClass.PotionStageData, emu.gingerps.net.proto.PotionStageDataOuterClass.PotionStageData.Builder, emu.gingerps.net.proto.PotionStageDataOuterClass.PotionStageDataOrBuilder> stageDataBuilder_;
      /**
       * <code>.PotionStageData stage_data = 5;</code>
       * @return Whether the stageData field is set.
       */
       ...
       * <code>.PotionStageData stage_data = 5;</code>
       */
      public Builder setStageData(emu.gingerps.net.proto.PotionStageDataOuterClass.PotionStageData value) {
        if (stageDataBuilder_ == null) {
          if (value == null) {
      ...
      public emu.gingerps.net.proto.PotionStageDataOuterClass.PotionStageDataOrBuilder getStageDataOrBuilder() {
        if (stageDataBuilder_ != null) {
          ...
          return stageData_ == null ?
              emu.gingerps.net.proto.PotionStageDataOuterClass.PotionStageData.getDefaultInstance() : stageData_;
        }
      }
      /**
       * <code>.PotionStageData stage_data = 5;</code>
    ...
    private static final emu.gingerps.net.proto.PotionResetChallengeRspOuterClass.PotionResetChallengeRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.PotionResetChallengeRspOuterClass.PotionResetChallengeRsp();
    }

    public static emu.gingerps.net.proto.PotionResetChallengeRspOuterClass.PotionResetChallengeRsp getDefaultInstance() {
