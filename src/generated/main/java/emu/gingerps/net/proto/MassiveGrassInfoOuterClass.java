...
public final class MassiveGrassInfoOuterClass {
  ...
  public interface MassiveGrassInfoOrBuilder extends
     ...
     * @return The size.
     */
    emu.gingerps.net.proto.VectorOuterClass.Vector getSize();
    /**
     * <code>.Vector size = 3;</code>
     */
    emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder getSizeOrBuilder();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.MassiveGrassInfoOuterClass.internal_static_MassiveGrassInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.MassiveGrassInfoOuterClass.MassiveGrassInfo.class, emu.gingerps.net.proto.MassiveGrassInfoOuterClass.MassiveGrassInfo.Builder.class);
    }
    ...
    private emu.gingerps.net.proto.VectorOuterClass.Vector size_;
    /**
     * <code>.Vector size = 3;</code>
     * @return Whether the size field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.VectorOuterClass.Vector getSize() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.MassiveGrassInfoOuterClass.MassiveGrassInfo)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.MassiveGrassInfoOuterClass.MassiveGrassInfo other = (emu.gingerps.net.proto.MassiveGrassInfoOuterClass.MassiveGrassInfo) obj;
    ...
    public static emu.gingerps.net.proto.MassiveGrassInfoOuterClass.MassiveGrassInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.MassiveGrassInfoOuterClass.MassiveGrassInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.MassiveGrassInfoOuterClass.MassiveGrassInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.MassiveGrassInfoOuterClass.MassiveGrassInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.MassiveGrassInfoOuterClass.MassiveGrassInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.MassiveGrassInfoOuterClass.MassiveGrassInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.MassiveGrassInfoOuterClass.MassiveGrassInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.MassiveGrassInfoOuterClass.MassiveGrassInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.MassiveGrassInfoOuterClass.internal_static_MassiveGrassInfo_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.MassiveGrassInfoOuterClass.MassiveGrassInfo getDefaultInstanceForType() {
        return emu.gingerps.net.proto.MassiveGrassInfoOuterClass.MassiveGrassInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.MassiveGrassInfoOuterClass.MassiveGrassInfo build() {
        emu.gingerps.net.proto.MassiveGrassInfoOuterClass.MassiveGrassInfo result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.MassiveGrassInfoOuterClass.MassiveGrassInfo) {
          return mergeFrom((emu.gingerps.net.proto.MassiveGrassInfoOuterClass.MassiveGrassInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.MassiveGrassInfoOuterClass.MassiveGrassInfo other) {
        if (other == emu.gingerps.net.proto.MassiveGrassInfoOuterClass.MassiveGrassInfo.getDefaultInstance()) return this;
        if (other.getId() != 0) {
          setId(other.getId());
        }
        if (other.hasCenter()) {
      ...
      private emu.gingerps.net.proto.VectorOuterClass.Vector size_;
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.VectorOuterClass.Vector, emu.gingerps.net.proto.VectorOuterClass.Vector.Builder, emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder> sizeBuilder_;
      /**
       * <code>.Vector size = 3;</code>
       * @return Whether the size field is set.
       */
       ...
       * <code>.Vector size = 3;</code>
       */
      public Builder setSize(emu.gingerps.net.proto.VectorOuterClass.Vector value) {
        if (sizeBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public emu.gingerps.net.proto.VectorOuterClass.VectorOrBuilder getSizeOrBuilder() {
        if (sizeBuilder_ != null) {
          ...
          return size_ == null ?
              emu.gingerps.net.proto.VectorOuterClass.Vector.getDefaultInstance() : size_;
        }
      }
      /**
       * <code>.Vector size = 3;</code>
    ...
    private static final emu.gingerps.net.proto.MassiveGrassInfoOuterClass.MassiveGrassInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.MassiveGrassInfoOuterClass.MassiveGrassInfo();
    }

    public static emu.gingerps.net.proto.MassiveGrassInfoOuterClass.MassiveGrassInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\030\002 \001(\0132\007.Vector\022\025\n\004size\030\003 \001(\0132\007.VectorB\030" +
