...
public final class MailDataOuterClass {
  ...
  public interface MailDataOrBuilder extends
     ...
     */
    emu.gingerps.net.proto.MailTextContentOuterClass.MailTextContent getMailTextContent();
    /**
     * <code>.MailTextContent mail_text_content = 4;</code>
     */
    emu.gingerps.net.proto.MailTextContentOuterClass.MailTextContentOrBuilder getMailTextContentOrBuilder();

    /**
     * <code>repeated .MailItem item_list = 7;</code>
     */
    java.util.List<emu.gingerps.net.proto.MailItemOuterClass.MailItem> 
        getItemListList();
    /**
     * <code>repeated .MailItem item_list = 7;</code>
     */
    emu.gingerps.net.proto.MailItemOuterClass.MailItem getItemList(int index);
    /**
     * <code>repeated .MailItem item_list = 7;</code>
     */
     ...
     * <code>repeated .MailItem item_list = 7;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.MailItemOuterClass.MailItemOrBuilder> 
        getItemListOrBuilderList();
    /**
     * <code>repeated .MailItem item_list = 7;</code>
     */
    emu.gingerps.net.proto.MailItemOuterClass.MailItemOrBuilder getItemListOrBuilder(
        int index);
     ...
     */
    emu.gingerps.net.proto.MailCollectStateOuterClass.MailCollectState getCollectState();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.MailDataOuterClass.internal_static_MailData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.MailDataOuterClass.MailData.class, emu.gingerps.net.proto.MailDataOuterClass.MailData.Builder.class);
    }
    ...
    private emu.gingerps.net.proto.MailTextContentOuterClass.MailTextContent mailTextContent_;
    /**
     * <code>.MailTextContent mail_text_content = 4;</code>
     * @return Whether the mailTextContent field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.MailTextContentOuterClass.MailTextContent getMailTextContent() {
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.MailItemOuterClass.MailItem> getItemListList() {
      return itemList_;
    }
    /**
     * <code>repeated .MailItem item_list = 7;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.MailItemOuterClass.MailItemOrBuilder> 
        getItemListOrBuilderList() {
      return itemList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.MailItemOuterClass.MailItem getItemList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.MailItemOuterClass.MailItemOrBuilder getItemListOrBuilder(
        int index) {
      return itemList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.MailDataOuterClass.MailData)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.MailDataOuterClass.MailData other = (emu.gingerps.net.proto.MailDataOuterClass.MailData) obj;
    ...
    public static emu.gingerps.net.proto.MailDataOuterClass.MailData parseFrom(
    ...
    public static emu.gingerps.net.proto.MailDataOuterClass.MailData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.MailDataOuterClass.MailData parseFrom(
    ...
    public static emu.gingerps.net.proto.MailDataOuterClass.MailData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.MailDataOuterClass.MailData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.MailDataOuterClass.MailData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.MailDataOuterClass.MailData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.MailDataOuterClass.MailDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.MailDataOuterClass.internal_static_MailData_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.MailDataOuterClass.MailData getDefaultInstanceForType() {
        return emu.gingerps.net.proto.MailDataOuterClass.MailData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.MailDataOuterClass.MailData build() {
        emu.gingerps.net.proto.MailDataOuterClass.MailData result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.MailDataOuterClass.MailData) {
          return mergeFrom((emu.gingerps.net.proto.MailDataOuterClass.MailData)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.MailDataOuterClass.MailData other) {
        if (other == emu.gingerps.net.proto.MailDataOuterClass.MailData.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.MailTextContentOuterClass.MailTextContent, emu.gingerps.net.proto.MailTextContentOuterClass.MailTextContent.Builder, emu.gingerps.net.proto.MailTextContentOuterClass.MailTextContentOrBuilder> mailTextContentBuilder_;
      /**
       * <code>.MailTextContent mail_text_content = 4;</code>
       * @return Whether the mailTextContent field is set.
       */
       ...
       * <code>.MailTextContent mail_text_content = 4;</code>
       */
      public Builder setMailTextContent(emu.gingerps.net.proto.MailTextContentOuterClass.MailTextContent value) {
        if (mailTextContentBuilder_ == null) {
          if (value == null) {
      ...
      public emu.gingerps.net.proto.MailTextContentOuterClass.MailTextContentOrBuilder getMailTextContentOrBuilder() {
        if (mailTextContentBuilder_ != null) {
          ...
          return mailTextContent_ == null ?
              emu.gingerps.net.proto.MailTextContentOuterClass.MailTextContent.getDefaultInstance() : mailTextContent_;
        }
      }
      /**
       * <code>.MailTextContent mail_text_content = 4;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.gingerps.net.proto.MailTextContentOuterClass.MailTextContent, emu.gingerps.net.proto.MailTextContentOuterClass.MailTextContent.Builder, emu.gingerps.net.proto.MailTextContentOuterClass.MailTextContentOrBuilder> 
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.MailItemOuterClass.MailItem, emu.gingerps.net.proto.MailItemOuterClass.MailItem.Builder, emu.gingerps.net.proto.MailItemOuterClass.MailItemOrBuilder> itemListBuilder_;
      ...
      public Builder setItemList(
          int index, emu.gingerps.net.proto.MailItemOuterClass.MailItem value) {
        if (itemListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setItemList(
          int index, emu.gingerps.net.proto.MailItemOuterClass.MailItem.Builder builderForValue) {
        if (itemListBuilder_ == null) {
          ensureItemListIsMutable();
       ...
       * <code>repeated .MailItem item_list = 7;</code>
       */
      public Builder addItemList(emu.gingerps.net.proto.MailItemOuterClass.MailItem value) {
        if (itemListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addItemList(
          emu.gingerps.net.proto.MailItemOuterClass.MailItem.Builder builderForValue) {
        if (itemListBuilder_ == null) {
          ensureItemListIsMutable();
      ...
      public Builder addAllItemList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.MailItemOuterClass.MailItem> values) {
        if (itemListBuilder_ == null) {
          ensureItemListIsMutable();
       ...
       * <code>repeated .MailItem item_list = 7;</code>
       */
      public emu.gingerps.net.proto.MailItemOuterClass.MailItem.Builder getItemListBuilder(
          int index) {
       ...
       * <code>repeated .MailItem item_list = 7;</code>
       */
      public emu.gingerps.net.proto.MailItemOuterClass.MailItem.Builder addItemListBuilder() {
        return getItemListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.MailItemOuterClass.MailItem.getDefaultInstance());
      }
      /**
       * <code>repeated .MailItem item_list = 7;</code>
       */
      public emu.gingerps.net.proto.MailItemOuterClass.MailItem.Builder addItemListBuilder(
          int index) {
        return getItemListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.MailItemOuterClass.MailItem.getDefaultInstance());
      }
      /**
       * <code>repeated .MailItem item_list = 7;</code>
       */
      public java.util.List<emu.gingerps.net.proto.MailItemOuterClass.MailItem.Builder> 
  ...
  checkByteStringIsUtf8(value);
       ...
       * @return This builder for chaining.
       */
      public Builder setCollectState(emu.gingerps.net.proto.MailCollectStateOuterClass.MailCollectState value) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    private static final emu.gingerps.net.proto.MailDataOuterClass.MailData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.MailDataOuterClass.MailData();
    }

    public static emu.gingerps.net.proto.MailDataOuterClass.MailData getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.MailCollectStateOuterClass.getDescriptor(),
          emu.gingerps.net.proto.MailItemOuterClass.getDescriptor(),
          emu.gingerps.net.proto.MailTextContentOuterClass.getDescriptor(),
        });
    internal_static_MailData_descriptor =
