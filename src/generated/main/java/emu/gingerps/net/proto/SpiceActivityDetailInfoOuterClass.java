...
public final class SpiceActivityDetailInfoOuterClass {
  ...
  public interface SpiceActivityDetailInfoOrBuilder extends
     ...
     */
    java.util.List<emu.gingerps.net.proto.SpiceStageDataOuterClass.SpiceStageData> 
        getSpiceStageDataListList();
    /**
     * <code>repeated .SpiceStageData spice_stage_data_list = 6;</code>
     */
    emu.gingerps.net.proto.SpiceStageDataOuterClass.SpiceStageData getSpiceStageDataList(int index);
    /**
     * <code>repeated .SpiceStageData spice_stage_data_list = 6;</code>
     */
     ...
     * <code>repeated .SpiceStageData spice_stage_data_list = 6;</code>
     */
    java.util.List<? extends emu.gingerps.net.proto.SpiceStageDataOuterClass.SpiceStageDataOrBuilder> 
        getSpiceStageDataListOrBuilderList();
    /**
     * <code>repeated .SpiceStageData spice_stage_data_list = 6;</code>
     */
    emu.gingerps.net.proto.SpiceStageDataOuterClass.SpiceStageDataOrBuilder getSpiceStageDataListOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.gingerps.net.proto.SpiceActivityDetailInfoOuterClass.internal_static_SpiceActivityDetailInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.gingerps.net.proto.SpiceActivityDetailInfoOuterClass.SpiceActivityDetailInfo.class, emu.gingerps.net.proto.SpiceActivityDetailInfoOuterClass.SpiceActivityDetailInfo.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.gingerps.net.proto.SpiceStageDataOuterClass.SpiceStageData> getSpiceStageDataListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.gingerps.net.proto.SpiceStageDataOuterClass.SpiceStageDataOrBuilder> 
        getSpiceStageDataListOrBuilderList() {
      return spiceStageDataList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.SpiceStageDataOuterClass.SpiceStageData getSpiceStageDataList(int index) {
     ...
     */
    @java.lang.Override
    public emu.gingerps.net.proto.SpiceStageDataOuterClass.SpiceStageDataOrBuilder getSpiceStageDataListOrBuilder(
        int index) {
      return spiceStageDataList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.gingerps.net.proto.SpiceActivityDetailInfoOuterClass.SpiceActivityDetailInfo)) {
        return super.equals(obj);
      }
      emu.gingerps.net.proto.SpiceActivityDetailInfoOuterClass.SpiceActivityDetailInfo other = (emu.gingerps.net.proto.SpiceActivityDetailInfoOuterClass.SpiceActivityDetailInfo) obj;
    ...
    public static emu.gingerps.net.proto.SpiceActivityDetailInfoOuterClass.SpiceActivityDetailInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.SpiceActivityDetailInfoOuterClass.SpiceActivityDetailInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.gingerps.net.proto.SpiceActivityDetailInfoOuterClass.SpiceActivityDetailInfo parseFrom(
    ...
    public static emu.gingerps.net.proto.SpiceActivityDetailInfoOuterClass.SpiceActivityDetailInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.gingerps.net.proto.SpiceActivityDetailInfoOuterClass.SpiceActivityDetailInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.gingerps.net.proto.SpiceActivityDetailInfoOuterClass.SpiceActivityDetailInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.gingerps.net.proto.SpiceActivityDetailInfoOuterClass.SpiceActivityDetailInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.gingerps.net.proto.SpiceActivityDetailInfoOuterClass.SpiceActivityDetailInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.gingerps.net.proto.SpiceActivityDetailInfoOuterClass.internal_static_SpiceActivityDetailInfo_descriptor;
      }
      ...
      @java.lang.Override
      public emu.gingerps.net.proto.SpiceActivityDetailInfoOuterClass.SpiceActivityDetailInfo getDefaultInstanceForType() {
        return emu.gingerps.net.proto.SpiceActivityDetailInfoOuterClass.SpiceActivityDetailInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.gingerps.net.proto.SpiceActivityDetailInfoOuterClass.SpiceActivityDetailInfo build() {
        emu.gingerps.net.proto.SpiceActivityDetailInfoOuterClass.SpiceActivityDetailInfo result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.gingerps.net.proto.SpiceActivityDetailInfoOuterClass.SpiceActivityDetailInfo) {
          return mergeFrom((emu.gingerps.net.proto.SpiceActivityDetailInfoOuterClass.SpiceActivityDetailInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.gingerps.net.proto.SpiceActivityDetailInfoOuterClass.SpiceActivityDetailInfo other) {
        if (other == emu.gingerps.net.proto.SpiceActivityDetailInfoOuterClass.SpiceActivityDetailInfo.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.gingerps.net.proto.SpiceStageDataOuterClass.SpiceStageData, emu.gingerps.net.proto.SpiceStageDataOuterClass.SpiceStageData.Builder, emu.gingerps.net.proto.SpiceStageDataOuterClass.SpiceStageDataOrBuilder> spiceStageDataListBuilder_;
      ...
      public Builder setSpiceStageDataList(
          int index, emu.gingerps.net.proto.SpiceStageDataOuterClass.SpiceStageData value) {
        if (spiceStageDataListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setSpiceStageDataList(
          int index, emu.gingerps.net.proto.SpiceStageDataOuterClass.SpiceStageData.Builder builderForValue) {
        if (spiceStageDataListBuilder_ == null) {
          ensureSpiceStageDataListIsMutable();
       ...
       * <code>repeated .SpiceStageData spice_stage_data_list = 6;</code>
       */
      public Builder addSpiceStageDataList(emu.gingerps.net.proto.SpiceStageDataOuterClass.SpiceStageData value) {
        if (spiceStageDataListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addSpiceStageDataList(
          emu.gingerps.net.proto.SpiceStageDataOuterClass.SpiceStageData.Builder builderForValue) {
        if (spiceStageDataListBuilder_ == null) {
          ensureSpiceStageDataListIsMutable();
      ...
      public Builder addAllSpiceStageDataList(
          java.lang.Iterable<? extends emu.gingerps.net.proto.SpiceStageDataOuterClass.SpiceStageData> values) {
        if (spiceStageDataListBuilder_ == null) {
          ensureSpiceStageDataListIsMutable();
       ...
       * <code>repeated .SpiceStageData spice_stage_data_list = 6;</code>
       */
      public emu.gingerps.net.proto.SpiceStageDataOuterClass.SpiceStageData.Builder getSpiceStageDataListBuilder(
          int index) {
       ...
       * <code>repeated .SpiceStageData spice_stage_data_list = 6;</code>
       */
      public emu.gingerps.net.proto.SpiceStageDataOuterClass.SpiceStageData.Builder addSpiceStageDataListBuilder() {
        return getSpiceStageDataListFieldBuilder().addBuilder(
            emu.gingerps.net.proto.SpiceStageDataOuterClass.SpiceStageData.getDefaultInstance());
      }
      /**
       * <code>repeated .SpiceStageData spice_stage_data_list = 6;</code>
       */
      public emu.gingerps.net.proto.SpiceStageDataOuterClass.SpiceStageData.Builder addSpiceStageDataListBuilder(
          int index) {
        return getSpiceStageDataListFieldBuilder().addBuilder(
            index, emu.gingerps.net.proto.SpiceStageDataOuterClass.SpiceStageData.getDefaultInstance());
      }
      /**
       * <code>repeated .SpiceStageData spice_stage_data_list = 6;</code>
       */
      public java.util.List<emu.gingerps.net.proto.SpiceStageDataOuterClass.SpiceStageData.Builder> 
    ...
    private static final emu.gingerps.net.proto.SpiceActivityDetailInfoOuterClass.SpiceActivityDetailInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.gingerps.net.proto.SpiceActivityDetailInfoOuterClass.SpiceActivityDetailInfo();
    }

    public static emu.gingerps.net.proto.SpiceActivityDetailInfoOuterClass.SpiceActivityDetailInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "list\030\006 \003(\0132\017.SpiceStageDataB\030\n\026emu.ginge" +
      "rps.net.protob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.gingerps.net.proto.SpiceStageDataOuterClass.getDescriptor(),
        });
    internal_static_SpiceActivityDetailInfo_descriptor =
