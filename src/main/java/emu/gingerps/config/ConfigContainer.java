...
import static emu.gingerps.gingerps.config;
...
public class ConfigContainer {
    ...
    public static void updateConfig() {
        try { // Check if the server is using a legacy config.
            JsonObject configObject = JsonUtils.loadToClass(gingerps.configFile.toPath(), JsonObject.class);
            if (!configObject.has("version")) {
                gingerps.getLogger().info("Updating legacy ..");
                gingerps.saveConfig(null);
            }
        ...
        Arrays.stream(fields).forEach(field -> {
            try {
                ...
                gingerps.getLogger().error("Failed to update a configuration field.", exception);
            }
        }); updated.version = version();

        try { // Save configuration & reload.
            gingerps.saveConfig(updated);
            gingerps.loadConfig();
        } catch (Exception exception) {
            gingerps.getLogger().warn("Failed to inject the updated ", exception);
        }
    }
    ...
    public static class Database {
        ...
        public static class DataStore {
            ...
            public String collection = "gingerps";
        }
    }
    ...
    public static class Dispatch {
        ...
        public String defaultName = "gingerps";
    ...
    *  (see StartupArguments.enableDebug) */
    ...
    public static class JoinOptions {
        ...
        public String welcomeMessage = "Welcome to a gingerps server.";
        public JoinOptions.Mail welcomeMail = new JoinOptions.Mail();

        public static class Mail {
            public String title = "Welcome to gingerps!";
            public String content = """
                    Hi there!\r
                    First of all, welcome to gingerps. If you have any issues, please let us know so that Lawnmower can help you! \r
                    \r
                    Check out our:\r
                    <type="browser" text="Discord" href="https://discord.gg/T5vZU6UyeG"/>
                    """;
            public String sender = "Lawnmower";
            public emu.gingerps.game.mail.Mail.MailItem[] items = {
                    new emu.gingerps.game.mail.Mail.MailItem(13509, 1, 1),
                    new emu.gingerps.game.mail.Mail.MailItem(201, 99999, 1)
            };
        }
    }
    ...
    public static class ConsoleAccount {
        ...
        public String signature = "Welcome to gingerps!";
    }
