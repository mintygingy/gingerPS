...
import emu.gingerps.net.proto.FriendEnterHomeOptionOuterClass;
import emu.gingerps.net.proto.RetcodeOuterClass;
import emu.gingerps.net.proto.TryEnterHomeReqOuterClass;
import emu.gingerps.server.event.player.PlayerTeleportEvent.TeleportType;
import emu.gingerps.server.game.GameSession;
import emu.gingerps.server.packet.send.PacketTryEnterHomeRsp;
