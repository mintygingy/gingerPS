package emu.gingerps.server.game;
...
import emu.gingerps.game.battlepass.BattlePassSystem;
import emu.gingerps.game.chat.ChatSystem;
import emu.gingerps.game.chat.ChatSystemHandler;
import emu.gingerps.game.combine.CombineManger;
import emu.gingerps.game.drop.DropSystem;
import emu.gingerps.game.dungeons.DungeonSystem;
import emu.gingerps.game.dungeons.challenge.DungeonChallenge;
import emu.gingerps.game.expedition.ExpeditionSystem;
...
import emu.gingerps.game.quest.QuestSystem;
import emu.gingerps.game.shop.ShopSystem;
import emu.gingerps.game.systems.AnnouncementSystem;
import emu.gingerps.game.systems.InventorySystem;
import emu.gingerps.game.systems.MultiplayerSystem;
...
import emu.gingerps.server.event.game.ServerTickEvent;
import emu.gingerps.server.event.internal.ServerStartEvent;
import emu.gingerps.server.event.internal.ServerStopEvent;
import emu.gingerps.server.scheduler.ServerTaskScheduler;
import emu.gingerps.task.TaskMap;
        ...
        gameLoop.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                try {
                    ...
                    gingerps.getLogger().error(translate("messages.game.game_update_error"), e);
                }
            }
        }, new Date(), 1000L);
        gingerps.getLogger().info(translate("messages.status.free_software"));
        gingerps.getLogger().info(translate("messages.game.address_bind", GAME_INFO.accessAddress, address.getPort()));
