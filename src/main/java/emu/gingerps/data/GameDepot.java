...
public class GameDepot {
    ...
    public static void load() {
        ...
        if (relicMainPropDepot.size() == 0 || relicAffixDepot.size() == 0) {
            gingerps.getLogger().error("Relic properties are missing weights! Please check your ReliquaryMainPropExcelConfigData or ReliquaryAffixExcelConfigData files in your ExcelBinOutput folder.");
        }
    }
