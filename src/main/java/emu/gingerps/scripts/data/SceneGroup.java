...
public class SceneGroup {
    ...
    public synchronized SceneGroup load(int sceneId) {
        ...
        try {
            ...
            gingerps.getLogger().error("An error occurred while loading group " + this.id + " in scene " + sceneId + ".", e);
        }

        gingerps.getLogger().debug("Successfully loaded group {} in scene {}.", this.id, sceneId);
        return this;
    }
