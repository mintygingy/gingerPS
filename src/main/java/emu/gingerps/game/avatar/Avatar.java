package emu.gingerps.game.avatar;
...
import emu.gingerps.data.binout.OpenConfigEntry;
import emu.gingerps.data.binout.OpenConfigEntry.SkillPointModifier;
import emu.gingerps.data.common.FightPropData;
import emu.gingerps.data.excels.AvatarData;
import emu.gingerps.data.excels.AvatarPromoteData;
import emu.gingerps.data.excels.AvatarSkillData;
import emu.gingerps.data.excels.AvatarSkillDepotData;
import emu.gingerps.data.excels.AvatarTalentData;
import emu.gingerps.data.excels.EquipAffixData;
import emu.gingerps.data.excels.ProudSkillData;
import emu.gingerps.data.excels.ReliquaryAffixData;
import emu.gingerps.data.excels.ReliquaryLevelData;
import emu.gingerps.data.excels.ReliquaryMainPropData;
import emu.gingerps.data.excels.ReliquarySetData;
import emu.gingerps.data.excels.WeaponCurveData;
import emu.gingerps.data.excels.WeaponPromoteData;
import emu.gingerps.data.excels.AvatarSkillDepotData.InherentProudSkillOpens;
import emu.gingerps.data.excels.ItemData.WeaponProperty;
...
import emu.gingerps.net.proto.AvatarInfoOuterClass.AvatarInfo;
...
import emu.gingerps.net.proto.ShowAvatarInfoOuterClass;
import emu.gingerps.net.proto.ShowAvatarInfoOuterClass.ShowAvatarInfo;
import emu.gingerps.net.proto.ShowEquipOuterClass.ShowEquip;
