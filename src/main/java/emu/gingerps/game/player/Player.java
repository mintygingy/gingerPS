package emu.gingerps.game.player;

import dev.morphia.annotations.*;
import emu.gingerps.GameConstants;
import emu.gingerps.gingerps;
import emu.gingerps.data.GameData;
import emu.gingerps.data.excels.PlayerLevelData;
import emu.gingerps.data.excels.WeatherData;
import emu.gingerps.database.DatabaseHelper;
import emu.gingerps.game.Account;
import emu.gingerps.game.CoopRequest;
import emu.gingerps.game.ability.AbilityManager;
import emu.gingerps.game.activity.ActivityManager;
import emu.gingerps.game.avatar.Avatar;
import emu.gingerps.game.avatar.AvatarStorage;
import emu.gingerps.game.battlepass.BattlePassManager;
import emu.gingerps.game.entity.*;
import emu.gingerps.game.home.GameHome;
import emu.gingerps.game.expedition.ExpeditionInfo;
import emu.gingerps.game.friends.FriendsList;
import emu.gingerps.game.friends.PlayerProfile;
import emu.gingerps.game.gacha.PlayerGachaInfo;
...
import emu.gingerps.game.mail.MailHandler;
import emu.gingerps.game.managers.cooking.ActiveCookCompoundData;
import emu.gingerps.game.managers.cooking.CookingCompoundManager;
import emu.gingerps.game.managers.cooking.CookingManager;
import emu.gingerps.game.managers.FurnitureManager;
import emu.gingerps.game.managers.ResinManager;
import emu.gingerps.game.managers.deforestation.DeforestationManager;
import emu.gingerps.game.managers.energy.EnergyManager;
import emu.gingerps.game.managers.forging.ActiveForgeData;
import emu.gingerps.game.managers.forging.ForgingManager;
import emu.gingerps.game.managers.mapmark.*;
import emu.gingerps.game.managers.stamina.StaminaManager;
import emu.gingerps.game.managers.SotSManager;
import emu.gingerps.game.props.ActionReason;
import emu.gingerps.game.props.ClimateType;
...
import emu.gingerps.game.tower.TowerData;
...
import emu.gingerps.net.proto.AttackResultOuterClass.AttackResult;
...
import emu.gingerps.net.proto.MpSettingTypeOuterClass.MpSettingType;
import emu.gingerps.net.proto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo;
import emu.gingerps.net.proto.PlayerLocationInfoOuterClass.PlayerLocationInfo;
...
import emu.gingerps.scripts.data.SceneRegion;
import emu.gingerps.server.event.player.PlayerJoinEvent;
import emu.gingerps.server.event.player.PlayerQuitEvent;
...
import emu.gingerps.utils.MessageHandler;
...
public class Player {
    ...
    public void onLogout() {
        try {
            ...
            e.printStackTrace();
            gingerps.getLogger().warn("Player (UID {}) save failure", getUid());
        }finally {
            removeFromServer();
        }
    }
