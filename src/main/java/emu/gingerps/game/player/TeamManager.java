...
import emu.gingerps.server.event.player.PlayerTeamDeathEvent;
import emu.gingerps.server.packet.send.PacketAddBackupAvatarTeamRsp;
import emu.gingerps.server.packet.send.PacketAvatarDieAnimationEndRsp;
...
import emu.gingerps.server.packet.send.PacketAvatarTeamAllDataNotify;
import emu.gingerps.server.packet.send.PacketAvatarTeamUpdateNotify;
import emu.gingerps.server.packet.send.PacketChangeAvatarRsp;
import emu.gingerps.server.packet.send.PacketChangeMpTeamAvatarRsp;
import emu.gingerps.server.packet.send.PacketChangeTeamNameRsp;
import emu.gingerps.server.packet.send.PacketChooseCurAvatarTeamRsp;
import emu.gingerps.server.packet.send.PacketDelBackupAvatarTeamRsp;
import emu.gingerps.server.packet.send.PacketPlayerEnterSceneNotify;
import emu.gingerps.server.packet.send.PacketSceneTeamUpdateNotify;
import emu.gingerps.server.packet.send.PacketSetUpAvatarTeamRsp;
import emu.gingerps.server.packet.send.PacketWorldPlayerDieNotify;
