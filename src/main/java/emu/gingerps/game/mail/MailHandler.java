package emu.gingerps.game.mail;
...
import emu.gingerps.server.event.player.PlayerReceiveMailEvent;
...
public class MailHandler extends BasePlayerManager {
    ...
    public void sendMail(Mail message) {
        ...
        gingerps.getLogger().debug("Mail sent to user [" + this.getPlayer().getUid()  + ":" + this.getPlayer().getNickname() + "]!");
