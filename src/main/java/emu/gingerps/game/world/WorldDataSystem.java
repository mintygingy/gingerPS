...
import emu.gingerps.data.excels.InvestigationMonsterData;
...
import emu.gingerps.game.entity.gadget.chest.ChestInteractHandler;
import emu.gingerps.game.entity.gadget.chest.NormalChestInteractHandler;
import emu.gingerps.game.player.Player;
import emu.gingerps.net.proto.InvestigationMonsterOuterClass;
...
public class WorldDataSystem extends BaseGameSystem {
    ...
    public synchronized void loadChestConfig() {
        ...
        try {
            ...
            gingerps.getLogger().error("Unable to load chest reward config.", e);
        }
    }
...
//                builder.setBossChestNum(bossChest.get().take_num);
    ...
    public List<InvestigationMonsterOuterClass.InvestigationMonster> getInvestigationMonstersByCityId(Player player, int cityId) {
        ...
        if (cityData == null) {
            gingerps.getLogger().warn("City not exist {}", cityId);
            return List.of();
        }
