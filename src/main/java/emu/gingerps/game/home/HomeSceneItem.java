...
import emu.gingerps.data.binout.HomeworldDefaultSaveData;
import emu.gingerps.net.proto.HomeSceneArrangementInfoOuterClass.HomeSceneArrangementInfo;
...
public class HomeSceneItem {
    ...
    public void update(HomeSceneArrangementInfo arrangementInfo) {
        for (var blockItem : arrangementInfo.getBlockArrangementInfoListList()) {
            ...
            if (block == null) {
                gingerps.getLogger().warn("Could not found the Home Block {}", blockItem.getBlockId());
                continue;
            }
