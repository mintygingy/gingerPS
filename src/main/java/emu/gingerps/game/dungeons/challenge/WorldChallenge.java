...
import emu.gingerps.server.packet.send.PacketDungeonChallengeBeginNotify;
import emu.gingerps.server.packet.send.PacketDungeonChallengeFinishNotify;
...
public class WorldChallenge {
    ...
    public void start(){
        if(inProgress()){
            gingerps.getLogger().info("Could not start a in progress challenge.");
            return;
        }
        this.progress = true;
