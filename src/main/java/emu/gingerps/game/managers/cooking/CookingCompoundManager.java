package emu.gingerps.game.managers.cooking;

import emu.gingerps.data.GameData;
import emu.gingerps.data.common.ItemParamData;
import emu.gingerps.data.excels.CompoundData;
...
import emu.gingerps.net.proto.GetCompoundDataReqOuterClass.GetCompoundDataReq;
import emu.gingerps.net.proto.ItemParamOuterClass.ItemParam;
import emu.gingerps.net.proto.PlayerCompoundMaterialReqOuterClass.PlayerCompoundMaterialReq;
import emu.gingerps.net.proto.RetcodeOuterClass.Retcode;
import emu.gingerps.net.proto.TakeCompoundOutputReqOuterClass.TakeCompoundOutputReq;
import emu.gingerps.server.packet.send.PackageTakeCompoundOutputRsp;
import emu.gingerps.server.packet.send.PacketCompoundDataNotify;
import emu.gingerps.server.packet.send.PacketGetCompoundDataRsp;
import emu.gingerps.server.packet.send.PacketPlayerCompoundMaterialRsp;
