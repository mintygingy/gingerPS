package emu.gingerps.game.managers.mapmark;

import emu.gingerps.config.Configuration;
import emu.gingerps.game.player.BasePlayerManager;
import emu.gingerps.game.player.Player;
import emu.gingerps.net.proto.MapMarkPointTypeOuterClass.MapMarkPointType;
import emu.gingerps.net.proto.MarkMapReqOuterClass.MarkMapReq;
import emu.gingerps.net.proto.MarkMapReqOuterClass.MarkMapReq.Operation;
import emu.gingerps.server.event.player.PlayerTeleportEvent.TeleportType;
import emu.gingerps.server.packet.send.PacketMarkMapRsp;
import emu.gingerps.server.packet.send.PacketSceneEntityAppearNotify;
