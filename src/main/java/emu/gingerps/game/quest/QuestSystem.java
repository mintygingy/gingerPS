...
public class QuestSystem extends BaseGameSystem {
    ...
    public void registerHandlers() {
        this.registerHandlers(this.condHandlers, "emu.gingerps.game.quest.conditions", QuestBaseHandler.class);
        this.registerHandlers(this.contHandlers, "emu.gingerps.game.quest.content", QuestBaseHandler.class);
        this.registerHandlers(this.execHandlers, "emu.gingerps.game.quest.exec", QuestExecHandler.class);
    }
    ...
    public boolean triggerCondition(GameQuest quest, QuestCondition condition, String paramStr, int... params) {
        ...
        if (handler == null || quest.getQuestData() == null) {
            gingerps.getLogger().debug("Could not trigger condition {} at {}", condition.getType().getValue(), quest.getQuestData());
            return false;
        }
    ...
    public boolean triggerContent(GameQuest quest, QuestCondition condition, String paramStr, int... params) {
        ...
        if (handler == null || quest.getQuestData() == null) {
            gingerps.getLogger().debug("Could not trigger content {} at {}", condition.getType().getValue(), quest.getQuestData());
            return false;
        }
    ...
    public boolean triggerExec(GameQuest quest, QuestExecParam execParam, String... params) {
        ...
        if (handler == null || quest.getQuestData() == null) {
            gingerps.getLogger().debug("Could not trigger exec {} at {}", execParam.getType().getValue(), quest.getQuestData());
            return false;
        }
