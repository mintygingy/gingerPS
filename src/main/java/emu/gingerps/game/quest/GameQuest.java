...
import emu.gingerps.data.excels.ChapterData;
...
import emu.gingerps.server.packet.send.PacketChapterStateNotify;
...
public class GameQuest {
    ...
    public void start() {
        ...
        gingerps.getLogger().debug("Quest {} is started", subQuestId);
    }
    ...
    public void finish() {
        ...
        gingerps.getLogger().debug("Quest {} is finished", subQuestId);
    }
