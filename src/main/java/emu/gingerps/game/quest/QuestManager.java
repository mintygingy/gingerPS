...
public class QuestManager extends BasePlayerManager {
    ...
    */
    ...
    public void setQuestGlobalVarValue(Integer variable, Integer value) {
        ...
        gingerps.getLogger().debug("Changed questGlobalVar {} value from {} to {}", variable, previousValue==null ? 0: previousValue, value);
    }
    public void incQuestGlobalVarValue(Integer variable, Integer inc) {
        ...
        gingerps.getLogger().debug("Incremented questGlobalVar {} value from {} to {}", variable, previousValue, previousValue + inc);
    }
    ...
    public void decQuestGlobalVarValue(Integer variable, Integer dec) {
        ...
        gingerps.getLogger().debug("Decremented questGlobalVar {} value from {} to {}", variable, previousValue, previousValue - dec);
    }
    ...
    public void triggerEvent(QuestTrigger condType, String paramStr, int... params) {
        gingerps.getLogger().debug("Trigger Event {}, {}, {}", condType, paramStr, params);
        ...
        switch (condType) {
            ...
            default:
                gingerps.getLogger().error("Unhandled QuestTrigger {}", condType);
        }
