package emu.gingerps.game.ability;

import com.google.protobuf.InvalidProtocolBufferException;

import emu.gingerps.data.GameData;
import emu.gingerps.data.binout.AbilityModifierEntry;
...
import emu.gingerps.game.entity.gadget.GadgetGatherObject;
import emu.gingerps.game.player.BasePlayerManager;
import emu.gingerps.game.player.Player;
import emu.gingerps.net.proto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead;
import emu.gingerps.net.proto.AbilityInvokeEntryOuterClass.AbilityInvokeEntry;
import emu.gingerps.net.proto.AbilityMetaModifierChangeOuterClass.AbilityMetaModifierChange;
import emu.gingerps.net.proto.AbilityMetaReInitOverrideMapOuterClass.AbilityMetaReInitOverrideMap;
import emu.gingerps.net.proto.AbilityMixinCostStaminaOuterClass.AbilityMixinCostStamina;
import emu.gingerps.net.proto.AbilityScalarValueEntryOuterClass.AbilityScalarValueEntry;
import emu.gingerps.net.proto.ModifierActionOuterClass.ModifierAction;
...
public final class AbilityManager extends BasePlayerManager {
    ...
    public void onAbilityInvoke(AbilityInvokeEntry invoke) throws Exception {
        this.healAbilityManager.healHandler(invoke);
         ...
         //gingerps.getLogger().info(invoke.getArgumentType() + " (" + invoke.getArgumentTypeValue() + "): " + Utils.bytesToHex(invoke.toByteArray()));
