local base_info = {group_id = 220135003}
monsters = {}
npcs = {}
gadgets = {
  {
...
triggers = {
  {
    config_id = 1003011,
    name = "VARIABLE_CHANGE_3011",
    event = EventType.EVENT_VARIABLE_CHANGE,
    source = "",
    condition = "",
    action = "action_EVENT_VARIABLE_CHANGE_3011",
    trigger_count = 0
  },
  {
    config_id = 1003012,
    name = "GROUP_LOAD_3012",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "",
    action = "action_EVENT_GROUP_LOAD_3012",
    trigger_count = 0
  },
  {
    config_id = 1003013,
    name = "VARIABLE_CHANGE_3013",
    event = EventType.EVENT_VARIABLE_CHANGE,
    source = "",
    condition = "",
    action = "action_EVENT_VARIABLE_CHANGE_3013",
    trigger_count = 0
  },
  {
    config_id = 1003014,
    name = "VARIABLE_CHANGE_3014",
    event = EventType.EVENT_VARIABLE_CHANGE,
    source = "",
    condition = "",
    action = "action_EVENT_VARIABLE_CHANGE_3014",
    trigger_count = 0
  },
  {
    config_id = 1003018,
  ...
  {
    config_id = 1003020,
    name = "ENTER_REGION_3020",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_3020",
    action = "action_EVENT_ENTER_REGION_3020",
    trigger_count = 0
  },
  {
    config_id = 1003021,
...
garbages = {
  ...
  triggers = {
    {
      config_id = 1003001,
      name = "GROUP_LOAD_3001",
      event = EventType.EVENT_GROUP_LOAD,
      source = "",
      condition = "",
      action = "action_EVENT_GROUP_LOAD_3001",
      trigger_count = 0
    },
    {
      config_id = 1003002,
    ...
    {
      config_id = 1003004,
      name = "ENTER_REGION_3004",
      event = EventType.EVENT_ENTER_REGION,
      source = "",
      condition = "condition_EVENT_ENTER_REGION_3004",
      action = "action_EVENT_ENTER_REGION_3004",
      trigger_count = 0
    },
    {
      config_id = 1003005,
    ...
    {
      config_id = 1003007,
      name = "ENTER_REGION_3007",
      event = EventType.EVENT_ENTER_REGION,
      source = "",
      condition = "condition_EVENT_ENTER_REGION_3007",
      action = "action_EVENT_ENTER_REGION_3007",
      trigger_count = 0
    },
    {
      config_id = 1003008,
    ...
    {
      config_id = 1003009,
      name = "ENTER_REGION_3009",
      event = EventType.EVENT_ENTER_REGION,
      source = "",
      condition = "condition_EVENT_ENTER_REGION_3009",
      action = "action_EVENT_ENTER_REGION_3009",
      trigger_count = 0
    }
  }
}
...
suites = {
  {
    ...
    regions = {3022},
    triggers = {
      "VARIABLE_CHANGE_3011",
      "GROUP_LOAD_3012",
      "VARIABLE_CHANGE_3013",
      "VARIABLE_CHANGE_3014",
      "ENTER_REGION_3022"
    },
    rand_weight = 100
  },
