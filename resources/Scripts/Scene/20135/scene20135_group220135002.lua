local base_info = {group_id = 220135002}
local defs = {
  serve_items = {2004}
}
monsters = {}
...
triggers = {
  ...
  {
    config_id = 1002007,
    name = "QUEST_START_2007",
    event = EventType.EVENT_QUEST_START,
    source = "4006608",
    condition = "condition_EVENT_QUEST_START_2007",
    action = "action_EVENT_QUEST_START_2007",
    trigger_count = 0
  },
  {
    config_id = 1002008,
  ...
  {
    config_id = 1002009,
    name = "GROUP_LOAD_2009",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "",
    action = "action_EVENT_GROUP_LOAD_2009",
    trigger_count = 0
  },
  {
    config_id = 1002010,
  ...
  {
    config_id = 1002012,
    name = "GROUP_LOAD_2012",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "condition_EVENT_GROUP_LOAD_2012",
    action = "action_EVENT_GROUP_LOAD_2012",
    trigger_count = 0
  },
  {
    config_id = 1002013,
...
function action_EVENT_GROUP_LOAD_2009(context, evt)
  ...
  if ScriptLib.GetGroupVariableValue(context, "turn") == 0 then
    ScriptLib.SetPlatformPointArray(context, 2001, 6, {1}, {
...
function action_EVENT_SELECT_OPTION_2010(context, evt)
  if evt.param1 == 2005 and evt.param2 == 7 and ScriptLib.GetGroupVariableValue(context, "turn") == 0 then
    ...
    ScriptLib.SetPlatformPointArray(context, 2001, 1, {1}, {
      route_type = RouteType.OneWay,
      turn_mode = true,
  ...
  elseif evt.param1 == 2005 and evt.param2 == 7 and ScriptLib.GetGroupVariableValue(context, "turn") == 1 then
    ScriptLib.SetGroupVariableValueByGroup(context, "room1", 0, 220135003)
    ScriptLib.SetGroupVariableValue(context, "turn", 0)
    ScriptLib.SetPlatformPointArray(context, 2001, 1, {2}, {
      route_type = RouteType.OneWay,
      turn_mode = true,
      record_mode = RouteRecordMode.Prereach,
      speed_level = 0,
