local base_info = {group_id = 235850001}
local defs = {
  starter = 1001,
  option_id = 94,
  delay = 3,
...
triggers = {
  ...
  {
    config_id = 1001044,
    name = "GROUP_REFRESH_1044",
    event = EventType.EVENT_GROUP_REFRESH,
    source = "",
    condition = "condition_EVENT_GROUP_REFRESH_1044",
    action = "action_EVENT_GROUP_REFRESH_1044",
    trigger_count = 0
  },
  {
    config_id = 1001045,
    name = "VARIABLE_CHANGE_1045",
    event = EventType.EVENT_VARIABLE_CHANGE,
    source = "",
    condition = "condition_EVENT_VARIABLE_CHANGE_1045",
    action = "action_EVENT_VARIABLE_CHANGE_1045",
    trigger_count = 0
  },
  {
    config_id = 1001047,
    name = "GADGET_CREATE_1047",
    event = EventType.EVENT_GADGET_CREATE,
    source = "",
    condition = "condition_EVENT_GADGET_CREATE_1047",
    action = "action_EVENT_GADGET_CREATE_1047",
    trigger_count = 0
  }
}
variables = {
...
garbages = {
  ...
  triggers = {
    {
      config_id = 1001041,
      name = "VARIABLE_CHANGE_1041",
      event = EventType.EVENT_VARIABLE_CHANGE,
      source = "",
      condition = "condition_EVENT_VARIABLE_CHANGE_1041",
      action = "action_EVENT_VARIABLE_CHANGE_1041",
      trigger_count = 0
    }
  }
}
