local base_info = {group_id = 247022002}
local defs = {
  gallery_id = 27005,
  finish_region = 2020,
  operator_time_1 = 20,
...
gadgets = {
  {
    ...
    server_global_value_config = {SGV_Switch_Dir = 2}
  },
  {
    config_id = 2002,
    gadget_id = 70800247,
  ...
  },
  {
    ...
    state = GadgetState.GearStart,
    is_guest_can_operate = true,
    server_global_value_config = {SGV_Switch_Dir = 1}
  },
  {
    config_id = 2012,
    gadget_id = 70800269,
  ...
  },
  {
    ...
    state = GadgetState.GearStart,
    is_guest_can_operate = true,
    server_global_value_config = {SGV_Switch_Dir = 3}
  },
  {
    config_id = 2027,
    gadget_id = 70800281,
...
triggers = {
  ...
  {
    config_id = 1002020,
    name = "ENTER_REGION_2020",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_2020",
    action = "action_EVENT_ENTER_REGION_2020",
    trigger_count = 0,
    forbid_guest = false
  },
  {
  ...
  {
    config_id = 1002039,
    name = "ENTER_REGION_2039",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_2039",
    action = "action_EVENT_ENTER_REGION_2039",
    forbid_guest = false
  },
  {
    config_id = 1002041,
    name = "ENTER_REGION_2041",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_2041",
    action = "action_EVENT_ENTER_REGION_2041",
    trigger_count = 0,
    forbid_guest = false
  },
  {
    config_id = 1002043,
    name = "ENTER_REGION_2043",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_2043",
    action = "action_EVENT_ENTER_REGION_2043",
    forbid_guest = false
  },
  {
    config_id = 1002045,
    name = "VARIABLE_CHANGE_2045",
    event = EventType.EVENT_VARIABLE_CHANGE,
    source = "",
    condition = "condition_EVENT_VARIABLE_CHANGE_2045",
    action = "action_EVENT_VARIABLE_CHANGE_2045"
  },
  {
    config_id = 1002055,
    name = "ANY_MONSTER_DIE_2055",
    event = EventType.EVENT_ANY_MONSTER_DIE,
    source = "",
    condition = "condition_EVENT_ANY_MONSTER_DIE_2055",
    action = "action_EVENT_ANY_MONSTER_DIE_2055"
  },
  {
    config_id = 1002071,
    name = "GADGET_STATE_CHANGE_2071",
    event = EventType.EVENT_GADGET_STATE_CHANGE,
    source = "",
    condition = "condition_EVENT_GADGET_STATE_CHANGE_2071",
    action = "action_EVENT_GADGET_STATE_CHANGE_2071"
  },
  {
    config_id = 1002074,
    name = "GADGET_CREATE_2074",
    event = EventType.EVENT_GADGET_CREATE,
    source = "",
    condition = "condition_EVENT_GADGET_CREATE_2074",
    action = "action_EVENT_GADGET_CREATE_2074"
  },
  {
    config_id = 1002075,
    name = "SELECT_OPTION_2075",
    event = EventType.EVENT_SELECT_OPTION,
    source = "",
    condition = "condition_EVENT_SELECT_OPTION_2075",
    action = "action_EVENT_SELECT_OPTION_2075",
    forbid_guest = false
  },
  {
    config_id = 1002083,
    name = "ENTER_REGION_2083",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "",
    action = "",
  ...
  {
    config_id = 1002103,
    name = "ENTER_REGION_2103",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_2103",
    action = "action_EVENT_ENTER_REGION_2103"
  },
  {
    config_id = 1002107,
    name = "ENTER_REGION_2107",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_2107",
    action = "action_EVENT_ENTER_REGION_2107",
    forbid_guest = false
  },
  {
    config_id = 1002127,
    name = "ENTER_REGION_2127",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_2127",
    action = "action_EVENT_ENTER_REGION_2127",
    forbid_guest = false
  },
  {
    config_id = 1002128,
    name = "ENTER_REGION_2128",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_2128",
    action = "action_EVENT_ENTER_REGION_2128"
  },
  {
    config_id = 1002129,
    name = "ENTER_REGION_2129",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_2129",
    action = "action_EVENT_ENTER_REGION_2129",
    forbid_guest = false
  },
  {
    config_id = 1002130,
    name = "ENTER_REGION_2130",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_2130",
    action = "action_EVENT_ENTER_REGION_2130"
  },
  {
    config_id = 1002131,
    name = "ENTER_REGION_2131",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_2131",
    action = "action_EVENT_ENTER_REGION_2131"
  },
  {
    config_id = 1002132,
    name = "ENTER_REGION_2132",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_2132",
    action = "action_EVENT_ENTER_REGION_2132"
  },
  {
    config_id = 1002133,
    name = "ENTER_REGION_2133",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_2133",
    action = "action_EVENT_ENTER_REGION_2133"
  },
  {
    config_id = 1002135,
    name = "ENTER_REGION_2135",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "",
    action = "",
  ...
  {
    config_id = 1002136,
    name = "ENTER_REGION_2136",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_2136",
    action = "action_EVENT_ENTER_REGION_2136"
  },
  {
    config_id = 1002137,
    name = "ENTER_REGION_2137",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_2137",
    action = "action_EVENT_ENTER_REGION_2137",
    trigger_count = 0
  },
  {
    config_id = 1002138,
    name = "ENTER_REGION_2138",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_2138",
    action = "action_EVENT_ENTER_REGION_2138",
    forbid_guest = false
  },
  {
    config_id = 1002140,
    name = "ENTER_REGION_2140",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_2140",
    action = "action_EVENT_ENTER_REGION_2140",
    trigger_count = 0
  },
  {
    config_id = 1002141,
    name = "ENTER_REGION_2141",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_2141",
    action = "action_EVENT_ENTER_REGION_2141",
    trigger_count = 0,
    forbid_guest = false
  }
}
...
suites = {
  {
    ...
    triggers = {
      ...
      "ENTER_REGION_2041",
      "ENTER_REGION_2043",
      "VARIABLE_CHANGE_2045",
      "ANY_MONSTER_DIE_2055",
      "GADGET_STATE_CHANGE_2071",
      "GADGET_CREATE_2074",
      "SELECT_OPTION_2075",
      "ENTER_REGION_2107",
      "ENTER_REGION_2127",
...
function action_EVENT_ENTER_REGION_2131(context, evt)
  ...
  if count == 1 then
    ScriptLib.AssignPlayerShowTemplateReminder(context, 206, {
      param_vec = {},
      param_uid_vec = {},
      uid_vec = {
        context.uid
