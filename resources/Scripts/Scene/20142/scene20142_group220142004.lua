local base_info = {group_id = 220142004}
local defs = {
  fireMachineList = {4001},
  initConfig = {
    [4001] = 1
  },
  controlRelation = {},
...
gadgets = {
  ...
  },
  {
    ...
    isOneoff = true,
    persistent = true,
    server_global_value_config = {SGV_Kazuha_CrystalDis = 35}
  },
  {
    config_id = 4033,
    gadget_id = 70310188,
...
triggers = {
  ...
  {
    config_id = 1004015,
    name = "ANY_GADGET_DIE_4015",
    event = EventType.EVENT_ANY_GADGET_DIE,
    source = "",
    condition = "condition_EVENT_ANY_GADGET_DIE_4015",
    action = "action_EVENT_ANY_GADGET_DIE_4015",
    trigger_count = 0
  },
  {
    config_id = 1004034,
    name = "ANY_GADGET_DIE_4034",
    event = EventType.EVENT_ANY_GADGET_DIE,
    source = "",
    condition = "condition_EVENT_ANY_GADGET_DIE_4034",
    action = "action_EVENT_ANY_GADGET_DIE_4034",
    trigger_count = 0
  },
  {
    config_id = 1004035,
    name = "GADGET_STATE_CHANGE_4035",
    event = EventType.EVENT_GADGET_STATE_CHANGE,
    source = "",
    condition = "condition_EVENT_GADGET_STATE_CHANGE_4035",
    action = "action_EVENT_GADGET_STATE_CHANGE_4035",
    trigger_count = 0
  },
  {
    config_id = 1004036,
    name = "ANY_GADGET_DIE_4036",
    event = EventType.EVENT_ANY_GADGET_DIE,
    source = "",
    condition = "condition_EVENT_ANY_GADGET_DIE_4036",
    action = "action_EVENT_ANY_GADGET_DIE_4036",
    trigger_count = 0
  },
  {
    config_id = 1004042,
    name = "GADGET_STATE_CHANGE_4042",
    event = EventType.EVENT_GADGET_STATE_CHANGE,
    source = "",
    condition = "condition_EVENT_GADGET_STATE_CHANGE_4042",
    action = "action_EVENT_GADGET_STATE_CHANGE_4042",
    trigger_count = 0
  },
  {
    config_id = 1004043,
    name = "TIME_AXIS_PASS_4043",
    event = EventType.EVENT_TIME_AXIS_PASS,
    source = "stone1",
    condition = "condition_EVENT_TIME_AXIS_PASS_4043",
    action = "action_EVENT_TIME_AXIS_PASS_4043",
    trigger_count = 0
  },
  {
    config_id = 1004044,
  ...
  {
    config_id = 1004045,
    name = "VARIABLE_CHANGE_4045",
    event = EventType.EVENT_VARIABLE_CHANGE,
    source = "stone2",
    condition = "",
    action = "action_EVENT_VARIABLE_CHANGE_4045",
    trigger_count = 0
  },
  {
    config_id = 1004046,
    name = "LEVEL_TAG_CHANGE_4046",
    event = EventType.EVENT_LEVEL_TAG_CHANGE,
    source = "",
    condition = "",
    action = "action_EVENT_LEVEL_TAG_CHANGE_4046",
    trigger_count = 0
  },
  {
    config_id = 1004047,
    name = "GROUP_LOAD_4047",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "",
    action = "action_EVENT_GROUP_LOAD_4047",
    trigger_count = 0
  },
  {
    config_id = 1004048,
    name = "TIME_AXIS_PASS_4048",
    event = EventType.EVENT_TIME_AXIS_PASS,
    source = "stone2",
    condition = "condition_EVENT_TIME_AXIS_PASS_4048",
    action = "action_EVENT_TIME_AXIS_PASS_4048",
    trigger_count = 0
  }
}
variables = {
...
suites = {
  {
    ...
    triggers = {
      "ANY_GADGET_DIE_4015",
      "ANY_GADGET_DIE_4034",
      "GADGET_STATE_CHANGE_4035",
      "ANY_GADGET_DIE_4036",
      "GADGET_STATE_CHANGE_4042",
      "TIME_AXIS_PASS_4043",
      "VARIABLE_CHANGE_4044",
      "VARIABLE_CHANGE_4045",
      "LEVEL_TAG_CHANGE_4046",
      "GROUP_LOAD_4047",
      "TIME_AXIS_PASS_4048"
    },
    rand_weight = 100
...
function action_EVENT_GROUP_LOAD_4047(context, evt)
  ...
  elseif ScriptLib.GetGroupVariableValue(context, "stone1") == 2 then
    ScriptLib.SetGroupVariableValue(context, "stone1", 1)
  end
  if ScriptLib.CheckSceneTag(context, 20142, 1057) then
    ScriptLib.AddExtraGroupSuite(context, 0, 3)
  ...
  elseif ScriptLib.GetGroupVariableValue(context, "stone2") == 2 then
    ScriptLib.SetGroupVariableValue(context, "stone2", 1)
  end
  if ScriptLib.CheckSceneTag(context, 20142, 1058) then
    ScriptLib.AddExtraGroupSuite(context, 0, 2)
