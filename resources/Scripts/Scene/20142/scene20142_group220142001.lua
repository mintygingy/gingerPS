local base_info = {group_id = 220142001}
monsters = {}
npcs = {}
gadgets = {
  {
...
triggers = {
  ...
  {
    config_id = 1001006,
    name = "TIME_AXIS_PASS_1006",
    event = EventType.EVENT_TIME_AXIS_PASS,
    source = "temp3",
    condition = "",
    action = "action_EVENT_TIME_AXIS_PASS_1006",
    trigger_count = 0
  },
  {
    config_id = 1001007,
  ...
  {
    config_id = 1001009,
    name = "QUEST_FINISH_1009",
    event = EventType.EVENT_QUEST_FINISH,
    source = "4006507",
    condition = "",
    action = "action_EVENT_QUEST_FINISH_1009",
    trigger_count = 0
  },
  {
    config_id = 1001010,
  ...
  {
    config_id = 1001011,
    name = "SELECT_OPTION_1011",
    event = EventType.EVENT_SELECT_OPTION,
    source = "",
    condition = "condition_EVENT_SELECT_OPTION_1011",
    action = "action_EVENT_SELECT_OPTION_1011",
    trigger_count = 0
  },
  {
    config_id = 1001012,
    name = "SELECT_OPTION_1012",
    event = EventType.EVENT_SELECT_OPTION,
    source = "",
    condition = "condition_EVENT_SELECT_OPTION_1012",
    action = "action_EVENT_SELECT_OPTION_1012",
    trigger_count = 0
  },
  {
    config_id = 1001013,
    name = "GROUP_LOAD_1013",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "",
    action = "action_EVENT_GROUP_LOAD_1013",
    trigger_count = 0
  },
  {
    config_id = 1001014,
  ...
  {
    config_id = 1001015,
    name = "SELECT_OPTION_1015",
    event = EventType.EVENT_SELECT_OPTION,
    source = "",
    condition = "",
    action = "action_EVENT_SELECT_OPTION_1015",
    trigger_count = 0
  }
}
variables = {
...
function action_EVENT_GROUP_LOAD_1013(context, evt)
  ...
  if ScriptLib.GetGroupVariableValue(context, "open") == 1 and ScriptLib.GetGroupVariableValue(context, "room2") == 1 then
    ScriptLib.SetWorktopOptionsByGroupId(context, 0, 1001, {603, 604})
  elseif ScriptLib.GetGroupVariableValue(context, "open") == 1 then
    ScriptLib.SetWorktopOptionsByGroupId(context, 0, 1001, {603, 614})
  else
...
function action_EVENT_SELECT_OPTION_1015(context, evt)
  if evt.param1 == 1001 and (evt.param2 == 603 or evt.param2 == 604 or evt.param2 == 614) then
