local base_info = {group_id = 220142003}
monsters = {}
npcs = {}
gadgets = {
  {
...
triggers = {
  ...
  {
    config_id = 1003004,
    name = "TIME_AXIS_PASS_3004",
    event = EventType.EVENT_TIME_AXIS_PASS,
    source = "temp",
    condition = "",
    action = "action_EVENT_TIME_AXIS_PASS_3004",
    trigger_count = 0
  },
  {
    config_id = 1003005,
  ...
  {
    config_id = 1003006,
    name = "TIME_AXIS_PASS_3006",
    event = EventType.EVENT_TIME_AXIS_PASS,
    source = "temp3",
    condition = "",
    action = "action_EVENT_TIME_AXIS_PASS_3006",
    trigger_count = 0
  },
  {
    config_id = 1003007,
    name = "TIME_AXIS_PASS_3007",
    event = EventType.EVENT_TIME_AXIS_PASS,
    source = "temp4",
    condition = "",
    action = "action_EVENT_TIME_AXIS_PASS_3007",
    trigger_count = 0
  },
  {
    config_id = 1003008,
  ...
  {
    config_id = 1003009,
    name = "TIME_AXIS_PASS_3009",
    event = EventType.EVENT_TIME_AXIS_PASS,
    source = "temp6",
    condition = "",
    action = "action_EVENT_TIME_AXIS_PASS_3009",
    trigger_count = 0
  },
  {
    config_id = 1003010,
    name = "TIME_AXIS_PASS_3010",
    event = EventType.EVENT_TIME_AXIS_PASS,
    source = "temp7",
    condition = "",
    action = "action_EVENT_TIME_AXIS_PASS_3010",
    trigger_count = 0
  },
  {
    config_id = 1003011,
  ...
  {
    config_id = 1003014,
    name = "SELECT_OPTION_3014",
    event = EventType.EVENT_SELECT_OPTION,
    source = "",
    condition = "condition_EVENT_SELECT_OPTION_3014",
    action = "action_EVENT_SELECT_OPTION_3014",
    trigger_count = 0
  },
  {
    config_id = 1003015,
    name = "SELECT_OPTION_3015",
    event = EventType.EVENT_SELECT_OPTION,
    source = "",
    condition = "condition_EVENT_SELECT_OPTION_3015",
    action = "action_EVENT_SELECT_OPTION_3015",
    trigger_count = 0
  },
  {
    config_id = 1003016,
    name = "SELECT_OPTION_3016",
    event = EventType.EVENT_SELECT_OPTION,
    source = "",
    condition = "condition_EVENT_SELECT_OPTION_3016",
    action = "action_EVENT_SELECT_OPTION_3016",
    trigger_count = 0
  },
  {
    config_id = 1003017,
    name = "SELECT_OPTION_3017",
    event = EventType.EVENT_SELECT_OPTION,
    source = "",
    condition = "condition_EVENT_SELECT_OPTION_3017",
    action = "action_EVENT_SELECT_OPTION_3017",
    trigger_count = 0
  },
  {
    config_id = 1003018,
    name = "GROUP_LOAD_3018",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "",
    action = "action_EVENT_GROUP_LOAD_3018",
    trigger_count = 0
  },
  {
    config_id = 1003019,
  ...
  {
    config_id = 1003020,
    name = "SELECT_OPTION_3020",
    event = EventType.EVENT_SELECT_OPTION,
    source = "",
    condition = "",
    action = "action_EVENT_SELECT_OPTION_3020",
    trigger_count = 0
  }
}
variables = {
...
function action_EVENT_TIME_AXIS_PASS_3004(context, evt)
  ...
  if evt.source_name == "temp" and evt.param1 == 2 then
    if ScriptLib.GetGroupVariableValue(context, "room2") == 1 and ScriptLib.GetGroupVariableValue(context, "room3") == 1 and ScriptLib.GetGroupVariableValue(context, "room4") == 1 then
      ScriptLib.SetWorktopOptionsByGroupId(context, 0, 3001, {
        608,
        609,
        610,
        611
      })
    elseif ScriptLib.GetGroupVariableValue(context, "room2") == 1 and ScriptLib.GetGroupVariableValue(context, "room3") == 1 then
      ScriptLib.SetWorktopOptionsByGroupId(context, 0, 3001, {
        608,
        609,
        610,
    ...
    elseif ScriptLib.GetGroupVariableValue(context, "room4") == 0 then
      ...
      elseif ScriptLib.GetGroupVariableValue(context, "room2") == 1 then
        ScriptLib.SetWorktopOptionsByGroupId(context, 0, 3001, {
          608,
          609,
          618,
    ...
    elseif ScriptLib.GetGroupVariableValue(context, "room2") == 0 and ScriptLib.GetGroupVariableValue(context, "room3") == 0 then
      ScriptLib.SetWorktopOptionsByGroupId(context, 0, 3001, {
        608,
        617,
        618,
...
function action_EVENT_TIME_AXIS_PASS_3005(context, evt)
  ...
  if evt.source_name == "temp2" and evt.param1 == 2 then
    ...
    elseif ScriptLib.GetGroupVariableValue(context, "room3") == 1 then
      ScriptLib.SetWorktopOptionsByGroupId(context, 0, 3001, {
        608,
        609,
        610,
    ...
    elseif ScriptLib.GetGroupVariableValue(context, "room4") == 1 then
      ScriptLib.SetWorktopOptionsByGroupId(context, 0, 3001, {
        608,
        609,
        618,
...
function action_EVENT_GROUP_LOAD_3018(context, evt)
  ...
  elseif ScriptLib.GetGroupVariableValue(context, "room2") == 1 and ScriptLib.GetGroupVariableValue(context, "room3") == 1 and ScriptLib.GetGroupVariableValue(context, "room4") == 0 then
    ScriptLib.SetWorktopOptionsByGroupId(context, 0, 3001, {
      608,
      609,
      610,
  ...
  elseif ScriptLib.GetGroupVariableValue(context, "room2") == 1 and ScriptLib.GetGroupVariableValue(context, "room3") == 0 and ScriptLib.GetGroupVariableValue(context, "room4") == 1 then
    ScriptLib.SetWorktopOptionsByGroupId(context, 0, 3001, {
      608,
      609,
      618,
  ...
  elseif ScriptLib.GetGroupVariableValue(context, "room2") == 1 and ScriptLib.GetGroupVariableValue(context, "room3") == 0 and ScriptLib.GetGroupVariableValue(context, "room4") == 0 then
    ScriptLib.SetWorktopOptionsByGroupId(context, 0, 3001, {
      608,
      609,
      618,
  ...
  elseif ScriptLib.GetGroupVariableValue(context, "room2") == 0 and ScriptLib.GetGroupVariableValue(context, "room3") == 1 and ScriptLib.GetGroupVariableValue(context, "room4") == 1 then
    ScriptLib.SetWorktopOptionsByGroupId(context, 0, 3001, {
      608,
      617,
      610,
  ...
  elseif ScriptLib.GetGroupVariableValue(context, "room2") == 0 and ScriptLib.GetGroupVariableValue(context, "room3") == 1 and ScriptLib.GetGroupVariableValue(context, "room4") == 0 then
    ScriptLib.SetWorktopOptionsByGroupId(context, 0, 3001, {
      608,
      617,
      610,
  ...
  elseif ScriptLib.GetGroupVariableValue(context, "room2") == 0 and ScriptLib.GetGroupVariableValue(context, "room3") == 0 and ScriptLib.GetGroupVariableValue(context, "room4") == 1 then
    ScriptLib.SetWorktopOptionsByGroupId(context, 0, 3001, {
      608,
      617,
      618,
  ...
  elseif ScriptLib.GetGroupVariableValue(context, "room2") == 0 and ScriptLib.GetGroupVariableValue(context, "room3") == 0 and ScriptLib.GetGroupVariableValue(context, "room4") == 0 then
    ScriptLib.SetWorktopOptionsByGroupId(context, 0, 3001, {
      608,
      617,
      618,
...
function action_EVENT_SELECT_OPTION_3020(context, evt)
  if evt.param1 == 3001 and (evt.param2 == 608 or evt.param2 == 609 or evt.param2 == 610 or evt.param2 == 611 or evt.param2 == 617 or evt.param2 == 618 or evt.param2 == 619) then
