local base_info = {group_id = 220142013}
defs = {
  levelTagGroupID = 7,
  switchByLevelTag = 1,
...
triggers = {
  ...
  {
    config_id = 1013006,
    name = "GADGET_STATE_CHANGE_13006",
    event = EventType.EVENT_GADGET_STATE_CHANGE,
    source = "",
    condition = "",
    action = "action_EVENT_GADGET_STATE_CHANGE_13006",
    trigger_count = 0
  },
  {
    config_id = 1013014,
    name = "QUEST_FINISH_13014",
    event = EventType.EVENT_QUEST_FINISH,
    source = "4006501",
    condition = "condition_EVENT_QUEST_FINISH_13014",
    action = "action_EVENT_QUEST_FINISH_13014",
    trigger_count = 0
  },
  {
    config_id = 1013015,
    name = "QUEST_FINISH_13015",
    event = EventType.EVENT_QUEST_FINISH,
    source = "4006518",
    condition = "condition_EVENT_QUEST_FINISH_13015",
    action = "action_EVENT_QUEST_FINISH_13015",
    trigger_count = 0
  },
  {
    config_id = 1013016,
    name = "QUEST_FINISH_13016",
    event = EventType.EVENT_QUEST_FINISH,
    source = "4006519",
    condition = "condition_EVENT_QUEST_FINISH_13016",
    action = "action_EVENT_QUEST_FINISH_13016",
    trigger_count = 0
  },
  {
    config_id = 1013017,
    name = "QUEST_START_13017",
    event = EventType.EVENT_QUEST_START,
    source = "4006522",
    condition = "condition_EVENT_QUEST_START_13017",
    action = "action_EVENT_QUEST_START_13017",
    trigger_count = 0
  },
  {
    config_id = 1013018,
    name = "GADGET_STATE_CHANGE_13018",
    event = EventType.EVENT_GADGET_STATE_CHANGE,
    source = "",
    condition = "condition_EVENT_GADGET_STATE_CHANGE_13018",
    action = "action_EVENT_GADGET_STATE_CHANGE_13018",
    trigger_count = 0
  },
  {
    config_id = 1013019,
    name = "GADGET_STATE_CHANGE_13019",
    event = EventType.EVENT_GADGET_STATE_CHANGE,
    source = "",
    condition = "condition_EVENT_GADGET_STATE_CHANGE_13019",
    action = "action_EVENT_GADGET_STATE_CHANGE_13019",
    trigger_count = 0
  },
  {
    config_id = 1013020,
    name = "QUEST_START_13020",
    event = EventType.EVENT_QUEST_START,
    source = "4006520",
    condition = "",
    action = "action_EVENT_QUEST_START_13020",
    trigger_count = 0
  },
  {
    config_id = 1013021,
    name = "QUEST_START_13021",
    event = EventType.EVENT_QUEST_START,
    source = "4006521",
    condition = "",
    action = "action_EVENT_QUEST_START_13021",
    trigger_count = 0
  },
  {
    config_id = 1013022,
    name = "QUEST_START_13022",
    event = EventType.EVENT_QUEST_START,
    source = "4006508",
    condition = "",
    action = "action_EVENT_QUEST_START_13022",
    trigger_count = 0
  },
  {
    config_id = 1013023,
    name = "QUEST_START_13023",
    event = EventType.EVENT_QUEST_START,
    source = "4006501",
    condition = "condition_EVENT_QUEST_START_13023",
    action = "action_EVENT_QUEST_START_13023",
    trigger_count = 0
  },
  {
    config_id = 1013024,
    name = "QUEST_START_13024",
    event = EventType.EVENT_QUEST_START,
    source = "4006518",
    condition = "condition_EVENT_QUEST_START_13024",
    action = "action_EVENT_QUEST_START_13024",
    trigger_count = 0
  },
  {
    config_id = 1013025,
    name = "QUEST_START_13025",
    event = EventType.EVENT_QUEST_START,
    source = "4006519",
    condition = "condition_EVENT_QUEST_START_13025",
    action = "action_EVENT_QUEST_START_13025",
    trigger_count = 0
  },
  {
    config_id = 1013026,
    name = "QUEST_START_13026",
    event = EventType.EVENT_QUEST_START,
    source = "4006522",
    condition = "condition_EVENT_QUEST_START_13026",
    action = "action_EVENT_QUEST_START_13026",
    trigger_count = 0
  },
  {
    config_id = 1013027,
    name = "QUEST_START_13027",
    event = EventType.EVENT_QUEST_START,
    source = "4006522",
    condition = "condition_EVENT_QUEST_START_13027",
    action = "action_EVENT_QUEST_START_13027",
    trigger_count = 0
  }
}
variables = {
...
suites = {
  ...
  },
  {
    ...
    triggers = {
      ...
      "GADGET_STATE_CHANGE_13006",
      "QUEST_FINISH_13014",
      "QUEST_FINISH_13015",
      "QUEST_FINISH_13016",
      "QUEST_START_13017",
      "GADGET_STATE_CHANGE_13018",
      "GADGET_STATE_CHANGE_13019",
      "QUEST_START_13020",
      "QUEST_START_13021",
      "QUEST_START_13022",
      "QUEST_START_13023",
