local base_info = {group_id = 220142002}
monsters = {}
npcs = {}
gadgets = {
  {
...
triggers = {
  ...
  {
    config_id = 1002004,
    name = "TIME_AXIS_PASS_2004",
    event = EventType.EVENT_TIME_AXIS_PASS,
    source = "temp",
    condition = "",
    action = "action_EVENT_TIME_AXIS_PASS_2004",
    trigger_count = 0
  },
  {
    config_id = 1002005,
    name = "TIME_AXIS_PASS_2005",
    event = EventType.EVENT_TIME_AXIS_PASS,
    source = "temp2",
    condition = "",
    action = "action_EVENT_TIME_AXIS_PASS_2005",
    trigger_count = 0
  },
  {
    config_id = 1002006,
    name = "TIME_AXIS_PASS_2006",
    event = EventType.EVENT_TIME_AXIS_PASS,
    source = "temp3",
    condition = "",
    action = "action_EVENT_TIME_AXIS_PASS_2006",
    trigger_count = 0
  },
  {
    config_id = 1002007,
    name = "TIME_AXIS_PASS_2007",
    event = EventType.EVENT_TIME_AXIS_PASS,
    source = "temp4",
    condition = "",
    action = "action_EVENT_TIME_AXIS_PASS_2007",
    trigger_count = 0
  },
  {
    config_id = 1002008,
    name = "TIME_AXIS_PASS_2008",
    event = EventType.EVENT_TIME_AXIS_PASS,
    source = "temp5",
    condition = "",
    action = "action_EVENT_TIME_AXIS_PASS_2008",
    trigger_count = 0
  },
  {
    config_id = 1002009,
    name = "SELECT_OPTION_2009",
    event = EventType.EVENT_SELECT_OPTION,
    source = "",
    condition = "",
    action = "action_EVENT_SELECT_OPTION_2009",
    trigger_count = 0
  },
  {
    config_id = 1002010,
    name = "TIME_AXIS_PASS_2010",
    event = EventType.EVENT_TIME_AXIS_PASS,
    source = "message1",
    condition = "",
    action = "action_EVENT_TIME_AXIS_PASS_2010",
    trigger_count = 0
  },
  {
    config_id = 1002011,
    name = "QUEST_FINISH_2011",
    event = EventType.EVENT_QUEST_FINISH,
    source = "4006516",
    condition = "",
    action = "action_EVENT_QUEST_FINISH_2011",
    trigger_count = 0
  },
  {
    config_id = 1002012,
  ...
  {
    config_id = 1002017,
    name = "GROUP_LOAD_2017",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "",
    action = "action_EVENT_GROUP_LOAD_2017",
    trigger_count = 0
  },
  {
    config_id = 1002018,
  ...
  {
    config_id = 1002019,
    name = "SELECT_OPTION_2019",
    event = EventType.EVENT_SELECT_OPTION,
    source = "",
    condition = "",
    action = "action_EVENT_SELECT_OPTION_2019",
    trigger_count = 0
  }
}
variables = {
...
function action_EVENT_SELECT_OPTION_2003(context, evt)
  if evt.param2 == 606 then
    ...
    if evt.param2 == 607 then
      ScriptLib.SetGadgetStateByConfigId(context, 2002, GadgetState.Default)
      ScriptLib.InitTimeAxis(context, "temp3", {
        2,
        3,
        7
      }, false)
    ...
    if evt.param2 == 616 then
      ScriptLib.SetGadgetStateByConfigId(context, 2002, GadgetState.Default)
      ScriptLib.InitTimeAxis(context, "temp5", {
        2,
        3,
        7
      }, false)
...
function action_EVENT_TIME_AXIS_PASS_2004(context, evt)
  ...
  if evt.source_name == "temp" and evt.param1 == 2 then
    if ScriptLib.GetGroupVariableValue(context, "room2") == 1 and ScriptLib.GetGroupVariableValue(context, "room3") == 1 then
      ScriptLib.SetWorktopOptionsByGroupId(context, 0, 2001, {
        606,
        605,
        607
      })
...
function action_EVENT_QUEST_FINISH_2011(context, evt)
  ...
  if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 220142002, 2001, {
    606,
    615,
    616
  }) then
...
function action_EVENT_GROUP_LOAD_2017(context, evt)
  ...
  elseif ScriptLib.GetGroupVariableValue(context, "open") == 1 and ScriptLib.GetGroupVariableValue(context, "room2") == 1 and ScriptLib.GetGroupVariableValue(context, "room3") == 0 then
    ScriptLib.SetWorktopOptionsByGroupId(context, 0, 2001, {
      606,
      605,
      616
    })
  elseif ScriptLib.GetGroupVariableValue(context, "open") == 1 and ScriptLib.GetGroupVariableValue(context, "room2") == 0 and ScriptLib.GetGroupVariableValue(context, "room3") == 1 then
    ScriptLib.SetWorktopOptionsByGroupId(context, 0, 2001, {
      606,
      615,
      607
    })
  elseif ScriptLib.GetGroupVariableValue(context, "open") == 1 and ScriptLib.GetGroupVariableValue(context, "room2") == 0 and ScriptLib.GetGroupVariableValue(context, "room3") == 0 then
    ScriptLib.SetWorktopOptionsByGroupId(context, 0, 2001, {
      606,
      615,
      616
    })
  elseif ScriptLib.GetGroupVariableValue(context, "open") == 0 and ScriptLib.GetGroupVariableValue(context, "room2") == 0 and ScriptLib.GetGroupVariableValue(context, "room3") == 0 then
    ScriptLib.SetWorktopOptionsByGroupId(context, 0, 2001, {
      624,
      623,
      625
...
function action_EVENT_SELECT_OPTION_2019(context, evt)
  if evt.param1 == 2001 and (evt.param2 == 605 or evt.param2 == 606 or evt.param2 == 607 or evt.param2 == 615 or evt.param2 == 616) then
