local base_info = {group_id = 247021001}
local defs = {
  gallery_id = 27004,
  finish_region = 1005,
  operator_time_1 = 10,
...
gadgets = {
  ...
  },
  {
    ...
    level = 1,
    is_guest_can_operate = true,
    server_global_value_config = {SGV_Switch_OnOff = 1}
  },
  {
    config_id = 1041,
    gadget_id = 70800247,
...
triggers = {
  ...
  {
    config_id = 1001036,
    name = "ANY_MONSTER_DIE_1036",
    event = EventType.EVENT_ANY_MONSTER_DIE,
    source = "",
    condition = "condition_EVENT_ANY_MONSTER_DIE_1036",
    action = "action_EVENT_ANY_MONSTER_DIE_1036"
  },
  {
    config_id = 1001044,
    name = "GADGET_CREATE_1044",
    event = EventType.EVENT_GADGET_CREATE,
    source = "",
    condition = "condition_EVENT_GADGET_CREATE_1044",
    action = "action_EVENT_GADGET_CREATE_1044"
  },
  {
    config_id = 1001096,
    name = "ENTER_REGION_1096",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "",
    action = "",
  ...
  {
    config_id = 1001105,
    name = "SELECT_OPTION_1105",
    event = EventType.EVENT_SELECT_OPTION,
    source = "",
    condition = "condition_EVENT_SELECT_OPTION_1105",
    action = "action_EVENT_SELECT_OPTION_1105",
    forbid_guest = false
  },
  {
    config_id = 1001128,
  ...
  {
    config_id = 1001129,
    name = "ENTER_REGION_1129",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_1129",
    action = "action_EVENT_ENTER_REGION_1129",
    forbid_guest = false
  },
  {
    config_id = 1001130,
    name = "ENTER_REGION_1130",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_1130",
    action = "action_EVENT_ENTER_REGION_1130",
    forbid_guest = false
  },
  {
    config_id = 1001131,
  ...
  {
    config_id = 1001139,
    name = "ENTER_REGION_1139",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_1139",
    action = "action_EVENT_ENTER_REGION_1139"
  },
  {
    config_id = 1001140,
    name = "ENTER_REGION_1140",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_1140",
    action = "action_EVENT_ENTER_REGION_1140"
  },
  {
    config_id = 1001142,
  ...
  {
    config_id = 1001150,
    name = "ENTER_REGION_1150",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_1150",
    action = "action_EVENT_ENTER_REGION_1150",
    trigger_count = 0,
    forbid_guest = false
  }
}
...
function action_EVENT_ENTER_REGION_1140(context, evt)
  ...
  if count == 1 then
    ScriptLib.AssignPlayerShowTemplateReminder(context, 207, {
      param_vec = {},
      param_uid_vec = {},
      uid_vec = {
        context.uid
