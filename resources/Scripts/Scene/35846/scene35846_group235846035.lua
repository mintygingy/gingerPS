local base_info = {group_id = 235846035}
local defs = {
...
triggers = {
  {
    config_id = 1035002,
    name = "GADGET_STATE_CHANGE_35002",
    event = EventType.EVENT_GADGET_STATE_CHANGE,
    source = "",
    condition = "condition_EVENT_GADGET_STATE_CHANGE_35002",
    action = "action_EVENT_GADGET_STATE_CHANGE_35002",
    trigger_count = 0
  },
  {
    config_id = 1035005,
    name = "GADGET_STATE_CHANGE_35005",
    event = EventType.EVENT_GADGET_STATE_CHANGE,
    source = "",
    condition = "condition_EVENT_GADGET_STATE_CHANGE_35005",
    action = "action_EVENT_GADGET_STATE_CHANGE_35005",
    trigger_count = 0
  },
  {
    config_id = 1035006,
    name = "TIME_AXIS_PASS_35006",
    event = EventType.EVENT_TIME_AXIS_PASS,
    source = "",
    condition = "condition_EVENT_TIME_AXIS_PASS_35006",
    action = "action_EVENT_TIME_AXIS_PASS_35006",
    trigger_count = 0
  },
  {
    config_id = 1035018,
    name = "ENTER_REGION_35018",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_35018",
    action = "action_EVENT_ENTER_REGION_35018"
  },
  {
    config_id = 1035025,
    name = "SELECT_OPTION_35025",
    event = EventType.EVENT_SELECT_OPTION,
    source = "",
    condition = "condition_EVENT_SELECT_OPTION_35025",
    action = "action_EVENT_SELECT_OPTION_35025",
    trigger_count = 0
  },
  {
    config_id = 1035050,
    name = "GADGET_STATE_CHANGE_35050",
    event = EventType.EVENT_GADGET_STATE_CHANGE,
    source = "",
    condition = "condition_EVENT_GADGET_STATE_CHANGE_35050",
    action = "action_EVENT_GADGET_STATE_CHANGE_35050",
    trigger_count = 0
  },
  {
    config_id = 1035052,
    name = "GADGET_STATE_CHANGE_35052",
    event = EventType.EVENT_GADGET_STATE_CHANGE,
    source = "",
    condition = "condition_EVENT_GADGET_STATE_CHANGE_35052",
    action = "action_EVENT_GADGET_STATE_CHANGE_35052",
    trigger_count = 0
  },
  {
    config_id = 1035053,
    name = "CHALLENGE_SUCCESS_35053",
    event = EventType.EVENT_CHALLENGE_SUCCESS,
    source = "2010054",
    condition = "",
    action = "action_EVENT_CHALLENGE_SUCCESS_35053",
    trigger_count = 0
  },
  {
    config_id = 1035054,
    name = "TIME_AXIS_PASS_35054",
    event = EventType.EVENT_TIME_AXIS_PASS,
    source = "",
    condition = "condition_EVENT_TIME_AXIS_PASS_35054",
    action = "action_EVENT_TIME_AXIS_PASS_35054",
    trigger_count = 0
  },
  {
    config_id = 1035055,
    name = "CHALLENGE_FAIL_35055",
    event = EventType.EVENT_CHALLENGE_FAIL,
    source = "2010054",
    condition = "",
    action = "action_EVENT_CHALLENGE_FAIL_35055",
    trigger_count = 0
  }
}
variables = {
...
garbages = {
  ...
  triggers = {
    {
      config_id = 1035022,
      name = "GADGET_STATE_CHANGE_35022",
      event = EventType.EVENT_GADGET_STATE_CHANGE,
      source = "",
      condition = "condition_EVENT_GADGET_STATE_CHANGE_35022",
      action = "action_EVENT_GADGET_STATE_CHANGE_35022"
    },
    {
      config_id = 1035051,
      name = "GADGET_STATE_CHANGE_35051",
      event = EventType.EVENT_GADGET_STATE_CHANGE,
      source = "",
      condition = "condition_EVENT_GADGET_STATE_CHANGE_35051",
      action = "action_EVENT_GADGET_STATE_CHANGE_35051",
      trigger_count = 0
    },
    {
      config_id = 1035056,
      name = "GADGET_STATE_CHANGE_35056",
      event = EventType.EVENT_GADGET_STATE_CHANGE,
      source = "",
      condition = "condition_EVENT_GADGET_STATE_CHANGE_35056",
      action = "action_EVENT_GADGET_STATE_CHANGE_35056",
      trigger_count = 0
    },
    {
      config_id = 1035057,
      name = "TIME_AXIS_PASS_35057",
      event = EventType.EVENT_TIME_AXIS_PASS,
      source = "",
      condition = "condition_EVENT_TIME_AXIS_PASS_35057",
      action = "action_EVENT_TIME_AXIS_PASS_35057",
      trigger_count = 0
    }
  }
}
...
suites = {
  {
    ...
    triggers = {
      "ENTER_REGION_35018",
      "SELECT_OPTION_35025",
      "CHALLENGE_SUCCESS_35053",
      "CHALLENGE_FAIL_35055"
    },
    rand_weight = 100
  },
  {
  ...
  },
  {
    ...
    regions = {},
    triggers = {
      "GADGET_STATE_CHANGE_35002",
      "GADGET_STATE_CHANGE_35005",
      "TIME_AXIS_PASS_35006",
      "GADGET_STATE_CHANGE_35050",
      "GADGET_STATE_CHANGE_35052",
      "TIME_AXIS_PASS_35054"
    },
    rand_weight = 100
  },
  {
