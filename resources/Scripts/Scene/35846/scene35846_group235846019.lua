local base_info = {group_id = 235846019}
local defs = {
...
triggers = {
  {
    config_id = 1019002,
    name = "SELECT_OPTION_19002",
    event = EventType.EVENT_SELECT_OPTION,
    source = "",
    condition = "condition_EVENT_SELECT_OPTION_19002",
    action = "action_EVENT_SELECT_OPTION_19002",
    trigger_count = 0
  },
  {
    config_id = 1019039,
    name = "GADGET_STATE_CHANGE_19039",
    event = EventType.EVENT_GADGET_STATE_CHANGE,
    source = "",
    condition = "condition_EVENT_GADGET_STATE_CHANGE_19039",
    action = "action_EVENT_GADGET_STATE_CHANGE_19039",
    trigger_count = 0
  },
  {
    config_id = 1019047,
    name = "GADGET_STATE_CHANGE_19047",
    event = EventType.EVENT_GADGET_STATE_CHANGE,
    source = "",
    condition = "condition_EVENT_GADGET_STATE_CHANGE_19047",
    action = "action_EVENT_GADGET_STATE_CHANGE_19047",
    trigger_count = 0
  },
  {
    config_id = 1019050,
    name = "GADGET_STATE_CHANGE_19050",
    event = EventType.EVENT_GADGET_STATE_CHANGE,
    source = "",
    condition = "condition_EVENT_GADGET_STATE_CHANGE_19050",
    action = "action_EVENT_GADGET_STATE_CHANGE_19050",
    trigger_count = 0
  },
  {
    config_id = 1019051,
    name = "CHALLENGE_SUCCESS_19051",
    event = EventType.EVENT_CHALLENGE_SUCCESS,
    source = "2010046",
    condition = "",
    action = "action_EVENT_CHALLENGE_SUCCESS_19051",
    trigger_count = 0
  },
  {
    config_id = 1019052,
    name = "TIME_AXIS_PASS_19052",
    event = EventType.EVENT_TIME_AXIS_PASS,
    source = "",
    condition = "condition_EVENT_TIME_AXIS_PASS_19052",
    action = "action_EVENT_TIME_AXIS_PASS_19052",
    trigger_count = 0
  },
  {
    config_id = 1019055,
    name = "CHALLENGE_FAIL_19055",
    event = EventType.EVENT_CHALLENGE_FAIL,
    source = "2010046",
    condition = "",
    action = "action_EVENT_CHALLENGE_FAIL_19055",
    trigger_count = 0
  },
  {
    config_id = 1019056,
    name = "GADGET_STATE_CHANGE_19056",
    event = EventType.EVENT_GADGET_STATE_CHANGE,
    source = "",
    condition = "condition_EVENT_GADGET_STATE_CHANGE_19056",
    action = "action_EVENT_GADGET_STATE_CHANGE_19056",
    trigger_count = 0
  },
  {
    config_id = 1019058,
    name = "TIME_AXIS_PASS_19058",
    event = EventType.EVENT_TIME_AXIS_PASS,
    source = "",
    condition = "condition_EVENT_TIME_AXIS_PASS_19058",
    action = "action_EVENT_TIME_AXIS_PASS_19058",
    trigger_count = 0
  },
  {
    config_id = 1019072,
    name = "SELECT_OPTION_19072",
    event = EventType.EVENT_SELECT_OPTION,
    source = "",
    condition = "condition_EVENT_SELECT_OPTION_19072",
    action = "action_EVENT_SELECT_OPTION_19072"
  },
  {
    config_id = 1019077,
    name = "VARIABLE_CHANGE_19077",
    event = EventType.EVENT_VARIABLE_CHANGE,
    source = "",
    condition = "condition_EVENT_VARIABLE_CHANGE_19077",
    action = "action_EVENT_VARIABLE_CHANGE_19077",
    trigger_count = 0
  },
  {
    config_id = 1019078,
    name = "GROUP_LOAD_19078",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "condition_EVENT_GROUP_LOAD_19078",
    action = "action_EVENT_GROUP_LOAD_19078",
    trigger_count = 0
  },
  {
    config_id = 1019079,
    name = "GROUP_REFRESH_19079",
    event = EventType.EVENT_GROUP_REFRESH,
    source = "",
    condition = "condition_EVENT_GROUP_REFRESH_19079",
    action = "action_EVENT_GROUP_REFRESH_19079",
    trigger_count = 0
  }
}
variables = {
...
suites = {
  {
    ...
    triggers = {
      "SELECT_OPTION_19002",
      "CHALLENGE_SUCCESS_19051",
      "CHALLENGE_FAIL_19055",
      "SELECT_OPTION_19072",
      "VARIABLE_CHANGE_19077",
      "GROUP_LOAD_19078",
      "GROUP_REFRESH_19079"
    },
    rand_weight = 100
  ...
  },
  {
    ...
    regions = {},
    triggers = {
      "GADGET_STATE_CHANGE_19039",
      "GADGET_STATE_CHANGE_19050",
      "TIME_AXIS_PASS_19052"
    },
    rand_weight = 100
  },
  {
    ...
    regions = {},
    triggers = {
      "GADGET_STATE_CHANGE_19047",
      "GADGET_STATE_CHANGE_19056",
      "TIME_AXIS_PASS_19058"
    },
    rand_weight = 100
  },
  {
