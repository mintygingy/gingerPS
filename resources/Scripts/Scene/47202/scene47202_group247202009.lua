local base_info = {group_id = 247202009}
local defs = {
  group_1 = 247202009,
  challenge1 = 201,
...
triggers = {
  ...
  {
    config_id = 1009009,
    name = "ANY_MONSTER_DIE_9009",
    event = EventType.EVENT_ANY_MONSTER_DIE,
    source = "",
    condition = "condition_EVENT_ANY_MONSTER_DIE_9009",
    action = "action_EVENT_ANY_MONSTER_DIE_9009"
  },
  {
    config_id = 1009013,
