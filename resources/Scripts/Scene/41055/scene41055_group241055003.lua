local base_info = {group_id = 241055003}
monsters = {
  {
    config_id = 3001,
    monster_id = 20011201,
...
triggers = {
  ...
  {
    config_id = 1003028,
    name = "ANY_MONSTER_DIE_3028",
    event = EventType.EVENT_ANY_MONSTER_DIE,
    source = "",
    condition = "condition_EVENT_ANY_MONSTER_DIE_3028",
    action = "action_EVENT_ANY_MONSTER_DIE_3028",
    trigger_count = 0
  }
}
variables = {
...
function action_EVENT_ANY_MONSTER_DIE_3013(context, evt)
  if 0 ~= ScriptLib.AutoMonsterTide(context, 1, 241055003, {
    3015,
    3016,
    3017,
    3018,
