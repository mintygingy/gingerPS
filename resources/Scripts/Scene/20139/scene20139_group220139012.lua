local base_info = {group_id = 220139012}
monsters = {}
npcs = {}
gadgets = {
  {
...
triggers = {
  {
    config_id = 1012002,
    name = "GADGET_STATE_CHANGE_12002",
    event = EventType.EVENT_GADGET_STATE_CHANGE,
    source = "",
    condition = "condition_EVENT_GADGET_STATE_CHANGE_12002",
    action = "action_EVENT_GADGET_STATE_CHANGE_12002"
  },
  {
    config_id = 1012003,
    name = "GADGET_STATE_CHANGE_12003",
    event = EventType.EVENT_GADGET_STATE_CHANGE,
    source = "",
    condition = "condition_EVENT_GADGET_STATE_CHANGE_12003",
    action = "action_EVENT_GADGET_STATE_CHANGE_12003"
  },
  {
    config_id = 1012007,
    name = "OBSERVATION_POINT_NOTIFY_12007",
    event = EventType.EVENT_OBSERVATION_POINT_NOTIFY,
    source = "",
    condition = "",
    action = "action_EVENT_OBSERVATION_POINT_NOTIFY_12007",
    trigger_count = 0
  },
  {
    config_id = 1012008,
    name = "OBSERVATION_POINT_NOTIFY_12008",
    event = EventType.EVENT_OBSERVATION_POINT_NOTIFY,
    source = "",
    condition = "",
    action = "action_EVENT_OBSERVATION_POINT_NOTIFY_12008",
    trigger_count = 0
  },
  {
    config_id = 1012012,
    name = "OBSERVATION_POINT_NOTIFY_12012",
    event = EventType.EVENT_OBSERVATION_POINT_NOTIFY,
    source = "",
    condition = "",
    action = "action_EVENT_OBSERVATION_POINT_NOTIFY_12012",
    trigger_count = 0
  },
  {
    config_id = 1012013,
    name = "OBSERVATION_POINT_NOTIFY_12013",
    event = EventType.EVENT_OBSERVATION_POINT_NOTIFY,
    source = "",
    condition = "",
    action = "action_EVENT_OBSERVATION_POINT_NOTIFY_12013",
    trigger_count = 0
  },
  {
    config_id = 1012017,
    name = "OBSERVATION_POINT_NOTIFY_12017",
    event = EventType.EVENT_OBSERVATION_POINT_NOTIFY,
    source = "",
    condition = "",
    action = "action_EVENT_OBSERVATION_POINT_NOTIFY_12017",
    trigger_count = 0
  },
  {
    config_id = 1012018,
    name = "GADGET_STATE_CHANGE_12018",
    event = EventType.EVENT_GADGET_STATE_CHANGE,
    source = "",
    condition = "condition_EVENT_GADGET_STATE_CHANGE_12018",
    action = "action_EVENT_GADGET_STATE_CHANGE_12018"
  },
  {
    config_id = 1012019,
    name = "GROUP_LOAD_12019",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "condition_EVENT_GROUP_LOAD_12019",
    action = "action_EVENT_GROUP_LOAD_12019",
    trigger_count = 0
  },
  {
    config_id = 1012020,
    name = "GROUP_LOAD_12020",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "condition_EVENT_GROUP_LOAD_12020",
    action = "action_EVENT_GROUP_LOAD_12020",
    trigger_count = 0
  }
}
variables = {
...
suites = {
  {
    ...
    regions = {},
    triggers = {
      "GADGET_STATE_CHANGE_12002",
      "GADGET_STATE_CHANGE_12003",
      "OBSERVATION_POINT_NOTIFY_12007",
      "OBSERVATION_POINT_NOTIFY_12008",
      "OBSERVATION_POINT_NOTIFY_12012",
      "OBSERVATION_POINT_NOTIFY_12013",
      "OBSERVATION_POINT_NOTIFY_12017",
      "GADGET_STATE_CHANGE_12018",
      "GROUP_LOAD_12019",
      "GROUP_LOAD_12020"
    },
    rand_weight = 100
...
function action_EVENT_GADGET_STATE_CHANGE_12003(context, evt)
  local tempParam = {route_type = 0, turn_mode = false}
  if 0 ~= ScriptLib.SetPlatformPointArray(context, 12001, 1, {
    3,
    4,
    5
  }, tempParam) then
