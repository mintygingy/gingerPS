local base_info = {group_id = 220139003}
monsters = {}
npcs = {}
gadgets = {
  {
...
triggers = {
  {
    config_id = 1003004,
    name = "OBSERVATION_POINT_NOTIFY_3004",
    event = EventType.EVENT_OBSERVATION_POINT_NOTIFY,
    source = "",
    condition = "",
    action = "action_EVENT_OBSERVATION_POINT_NOTIFY_3004",
    trigger_count = 0
  },
  {
    config_id = 1003006,
...
function action_EVENT_GROUP_LOAD_3006(context, evt)
  ...
  if 0 ~= ScriptLib.SetPlatformPointArray(context, 3005, 2, {
    1,
    2,
    3
  }, tempParam) then
