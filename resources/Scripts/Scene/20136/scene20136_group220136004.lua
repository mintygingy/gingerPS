local base_info = {group_id = 220136004}
local defs = {
  queue = {
    [1] = {
      config_id = 4010,
...
regions = {
  ...
  [4048] = {
    ...
    team_ability_group_list = {
      "MonaDreamland_Enter_StartChallenge_Handle"
    }
  }
}
triggers = {
  {
    ...
    source = "",
    condition = "condition_EVENT_ENTER_REGION_4002",
    action = "action_EVENT_ENTER_REGION_4002",
    trigger_count = 0
  },
  {
    config_id = 1004008,
    name = "CHALLENGE_SUCCESS_4008",
    event = EventType.EVENT_CHALLENGE_SUCCESS,
    source = "260",
    condition = "",
    action = "action_EVENT_CHALLENGE_SUCCESS_4008",
    trigger_count = 0
  },
  {
    config_id = 1004009,
    name = "CHALLENGE_FAIL_4009",
    event = EventType.EVENT_CHALLENGE_FAIL,
    source = "260",
    condition = "",
    action = "action_EVENT_CHALLENGE_FAIL_4009",
    trigger_count = 0
  },
  {
    config_id = 1004014,
    name = "QUEST_START_4014",
    event = EventType.EVENT_QUEST_START,
    source = "4007410",
    condition = "condition_EVENT_QUEST_START_4014",
    action = "action_EVENT_QUEST_START_4014",
    trigger_count = 0
  },
  {
    config_id = 1004043,
  ...
  {
    config_id = 1004044,
    name = "GROUP_LOAD_4044",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "",
    action = "action_EVENT_GROUP_LOAD_4044",
    trigger_count = 0
  }
}
variables = {
...
garbages = {
  ...
  triggers = {
    {
      config_id = 1004007,
      name = "SELECT_OPTION_4007",
      event = EventType.EVENT_SELECT_OPTION,
      source = "",
      condition = "condition_EVENT_SELECT_OPTION_4007",
      action = "action_EVENT_SELECT_OPTION_4007",
      trigger_count = 0
    },
    {
      config_id = 1004042,
      name = "GROUP_LOAD_4042",
      event = EventType.EVENT_GROUP_LOAD,
      source = "",
      condition = "",
      action = "action_EVENT_GROUP_LOAD_4042",
      trigger_count = 0
    },
    {
      config_id = 1004047,
      name = "TIME_AXIS_PASS_4047",
      event = EventType.EVENT_TIME_AXIS_PASS,
      source = "star",
      condition = "",
      action = "action_EVENT_TIME_AXIS_PASS_4047",
      trigger_count = 0
    }
  }
}
...
function action_EVENT_QUEST_START_4014(context, evt)
  ScriptLib.CreateFatherChallenge(context, 260, 262, 61, {
    success = 1,
    fail = 1,
    fail_on_wipe = true
  })
  ScriptLib.StartFatherChallenge(context, 260)
  ScriptLib.AttachChildChallenge(context, 260, 262, 260, {
    3,
    777,
    30,
    0,
