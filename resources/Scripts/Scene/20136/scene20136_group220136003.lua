local base_info = {group_id = 220136003}
local defs = {
  point_sum = 20,
  route_2 = 65,
  gadget_seelie = 3033
...
triggers = {
  ...
  {
    config_id = 1003049,
    name = "ENTER_REGION_3049",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_3049",
    action = "action_EVENT_ENTER_REGION_3049",
    trigger_count = 0
  },
  {
    config_id = 1003064,
    name = "ENTER_REGION_3064",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_3064",
    action = "action_EVENT_ENTER_REGION_3064",
    trigger_count = 0
  },
  {
    config_id = 1003065,
    name = "PLATFORM_REACH_POINT_3065",
    event = EventType.EVENT_PLATFORM_REACH_POINT,
    source = "",
    condition = "condition_EVENT_PLATFORM_REACH_POINT_3065",
    action = "action_EVENT_PLATFORM_REACH_POINT_3065",
    trigger_count = 0
  },
  {
    config_id = 1003082,
    name = "ENTER_REGION_3082",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_3082",
    action = "action_EVENT_ENTER_REGION_3082",
    trigger_count = 0
  },
  {
    config_id = 1003083,
    name = "ENTER_REGION_3083",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_3083",
    action = "action_EVENT_ENTER_REGION_3083",
    trigger_count = 0
  },
  {
    config_id = 1003085,
    name = "ENTER_REGION_3085",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_3085",
    action = "action_EVENT_ENTER_REGION_3085",
    trigger_count = 0
  },
  {
    config_id = 1003086,
    name = "GROUP_LOAD_3086",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "",
    action = "action_EVENT_GROUP_LOAD_3086",
    trigger_count = 0
  },
  {
    config_id = 1003087,
    name = "ENTER_REGION_3087",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_3087",
    action = "action_EVENT_ENTER_REGION_3087",
    trigger_count = 0
  },
  {
    config_id = 1003094,
    name = "ENTER_REGION_3094",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_3094",
    action = "action_EVENT_ENTER_REGION_3094",
    trigger_count = 0
  },
  {
    config_id = 1003095,
    name = "ENTER_REGION_3095",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_3095",
    action = "action_EVENT_ENTER_REGION_3095",
    trigger_count = 0
  },
  {
    config_id = 1003096,
    name = "ENTER_REGION_3096",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_3096",
    action = "action_EVENT_ENTER_REGION_3096",
    trigger_count = 0
  }
}
variables = {
...
function action_EVENT_ENTER_REGION_3028(context, evt)
  ScriptLib.SetPlatformPointArray(context, 3002, 1, {1}, {
...
function action_EVENT_ENTER_REGION_3029(context, evt)
  ScriptLib.SetPlatformPointArray(context, 3002, 1, {2}, {
    route_type = RouteType.OneWay,
    record_mode = RouteRecordMode.Prereach
  })
...
function action_EVENT_ENTER_REGION_3030(context, evt)
  ScriptLib.SetPlatformPointArray(context, 3002, 1, {3}, {
    route_type = RouteType.OneWay,
    record_mode = RouteRecordMode.Prereach
  })
...
function action_EVENT_ENTER_REGION_3031(context, evt)
  ScriptLib.SetPlatformPointArray(context, 3002, 1, {4}, {
    route_type = RouteType.OneWay,
    record_mode = RouteRecordMode.Prereach
  })
...
function action_EVENT_GROUP_LOAD_3086(context, evt)
  if ScriptLib.GetHostQuestState(context, 4007617) == 2 or ScriptLib.GetHostQuestState(context, 4007611) == 2 or ScriptLib.GetHostQuestState(context, 4007614) == 2 then
...
function action_EVENT_ENTER_REGION_3096(context, evt)
  ...
  ScriptLib.SetPlatformPointArray(context, 3002, 1, {p}, {
    route_type = RouteType.OneWay,
    record_mode = RouteRecordMode.Prereach
  })
