local base_info = {group_id = 220136007}
local defs = {
  queue = {
    [1] = {
      config_id = 7006,
...
triggers = {
  {
    config_id = 1007008,
    name = "ENTER_REGION_7008",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_7008",
    action = "action_EVENT_ENTER_REGION_7008",
    trigger_count = 0
  },
  {
    config_id = 1007009,
  ...
  {
    config_id = 1007010,
    name = "CHALLENGE_SUCCESS_7010",
    event = EventType.EVENT_CHALLENGE_SUCCESS,
    source = "262",
    condition = "",
    action = "action_EVENT_CHALLENGE_SUCCESS_7010",
    trigger_count = 0
  },
  {
    config_id = 1007011,
    name = "CHALLENGE_FAIL_7011",
    event = EventType.EVENT_CHALLENGE_FAIL,
    source = "262",
    condition = "",
    action = "action_EVENT_CHALLENGE_FAIL_7011",
    trigger_count = 0
  },
  {
    config_id = 1007059,
    name = "GROUP_REFRESH_7059",
    event = EventType.EVENT_GROUP_REFRESH,
    source = "",
    condition = "",
    action = "action_EVENT_GROUP_REFRESH_7059",
    trigger_count = 0
  }
}
variables = {}
...
function action_EVENT_SELECT_OPTION_7009(context, evt)
  ScriptLib.CreateFatherChallenge(context, 262, 262, 61, {
    success = 1,
    fail = 1,
    fail_on_wipe = true
  })
  ScriptLib.AttachChildChallenge(context, 262, 260, 260, {
    3,
    777,
    10,
    0,
