local base_info = {group_id = 247023001}
local defs = {
  gallery_id = 27006,
  finish_region = 1094,
  operator_time_1 = 20,
...
triggers = {
  ...
  {
    config_id = 1001110,
    name = "ANY_MONSTER_DIE_1110",
    event = EventType.EVENT_ANY_MONSTER_DIE,
    source = "",
    condition = "condition_EVENT_ANY_MONSTER_DIE_1110",
    action = "action_EVENT_ANY_MONSTER_DIE_1110"
  },
  {
    config_id = 1001143,
  ...
  {
    config_id = 1001157,
    name = "ENTER_REGION_1157",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_1157",
    action = "action_EVENT_ENTER_REGION_1157",
    forbid_guest = false
  },
  {
    config_id = 1001188,
    name = "ENTER_REGION_1188",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_1188",
    action = "action_EVENT_ENTER_REGION_1188"
  },
  {
    config_id = 1001189,
    name = "ENTER_REGION_1189",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_1189",
    action = "action_EVENT_ENTER_REGION_1189"
  },
  {
    config_id = 1001190,
    name = "ENTER_REGION_1190",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_1190",
    action = "action_EVENT_ENTER_REGION_1190"
  },
  {
    config_id = 1001191,
    name = "ENTER_REGION_1191",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_1191",
    action = "action_EVENT_ENTER_REGION_1191"
  },
  {
    config_id = 1001192,
    name = "ENTER_REGION_1192",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_1192",
    action = "action_EVENT_ENTER_REGION_1192",
    forbid_guest = false
  },
  {
    config_id = 1001193,
    name = "ENTER_REGION_1193",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_1193",
    action = "action_EVENT_ENTER_REGION_1193",
    forbid_guest = false
  },
  {
    config_id = 1001194,
    name = "ENTER_REGION_1194",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_1194",
    action = "action_EVENT_ENTER_REGION_1194",
    forbid_guest = false
  },
  {
    config_id = 1001195,
    name = "ENTER_REGION_1195",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_1195",
    action = "action_EVENT_ENTER_REGION_1195",
    forbid_guest = false
  },
  {
    config_id = 1001196,
    name = "ENTER_REGION_1196",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "",
    action = "",
...
function action_EVENT_ENTER_REGION_1189(context, evt)
  ...
  if count == 1 then
    ScriptLib.AssignPlayerShowTemplateReminder(context, 210, {
      param_vec = {},
      param_uid_vec = {},
      uid_vec = {
        context.uid
