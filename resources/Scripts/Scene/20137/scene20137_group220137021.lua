local base_info = {group_id = 220137021}
monsters = {}
npcs = {}
gadgets = {
  {
...
triggers = {
  {
    config_id = 1021006,
    name = "GROUP_LOAD_21006",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "condition_EVENT_GROUP_LOAD_21006",
    action = "action_EVENT_GROUP_LOAD_21006",
    trigger_count = 0
  },
  {
    config_id = 1021033,
    name = "PLATFORM_ARRIVAL_21033",
    event = EventType.EVENT_PLATFORM_ARRIVAL,
    source = "",
    condition = "condition_EVENT_PLATFORM_ARRIVAL_21033",
    action = "action_EVENT_PLATFORM_ARRIVAL_21033",
    trigger_count = 0
  },
  {
    config_id = 1021034,
    name = "QUEST_FINISH_21034",
    event = EventType.EVENT_QUEST_FINISH,
    source = "4007110",
    condition = "",
    action = "action_EVENT_QUEST_FINISH_21034",
    trigger_count = 0
  },
  {
    config_id = 1021035,
    name = "PLATFORM_ARRIVAL_21035",
    event = EventType.EVENT_PLATFORM_ARRIVAL,
    source = "",
    condition = "condition_EVENT_PLATFORM_ARRIVAL_21035",
    action = "action_EVENT_PLATFORM_ARRIVAL_21035",
    trigger_count = 0
  },
  {
    config_id = 1021036,
    name = "VARIABLE_CHANGE_21036",
    event = EventType.EVENT_VARIABLE_CHANGE,
    source = "",
    condition = "condition_EVENT_VARIABLE_CHANGE_21036",
    action = "action_EVENT_VARIABLE_CHANGE_21036",
    trigger_count = 0
  },
  {
    config_id = 1021037,
    name = "VARIABLE_CHANGE_21037",
    event = EventType.EVENT_VARIABLE_CHANGE,
    source = "",
    condition = "condition_EVENT_VARIABLE_CHANGE_21037",
    action = "action_EVENT_VARIABLE_CHANGE_21037",
    trigger_count = 0
  },
  {
    config_id = 1021038,
    name = "VARIABLE_CHANGE_21038",
    event = EventType.EVENT_VARIABLE_CHANGE,
    source = "",
    condition = "condition_EVENT_VARIABLE_CHANGE_21038",
    action = "action_EVENT_VARIABLE_CHANGE_21038",
    trigger_count = 0
  },
  {
    config_id = 1021039,
    name = "PLATFORM_ARRIVAL_21039",
    event = EventType.EVENT_PLATFORM_ARRIVAL,
    source = "",
    condition = "condition_EVENT_PLATFORM_ARRIVAL_21039",
    action = "action_EVENT_PLATFORM_ARRIVAL_21039",
    trigger_count = 0
  },
  {
    config_id = 1021040,
    name = "PLATFORM_ARRIVAL_21040",
    event = EventType.EVENT_PLATFORM_ARRIVAL,
    source = "",
    condition = "condition_EVENT_PLATFORM_ARRIVAL_21040",
    action = "action_EVENT_PLATFORM_ARRIVAL_21040",
    trigger_count = 0
  },
  {
    config_id = 1021041,
    name = "PLATFORM_ARRIVAL_21041",
    event = EventType.EVENT_PLATFORM_ARRIVAL,
    source = "",
    condition = "condition_EVENT_PLATFORM_ARRIVAL_21041",
    action = "action_EVENT_PLATFORM_ARRIVAL_21041",
    trigger_count = 0
  },
  {
    config_id = 1021042,
    name = "PLATFORM_ARRIVAL_21042",
    event = EventType.EVENT_PLATFORM_ARRIVAL,
    source = "",
    condition = "condition_EVENT_PLATFORM_ARRIVAL_21042",
    action = "action_EVENT_PLATFORM_ARRIVAL_21042",
    trigger_count = 0
  },
  {
    config_id = 1021044,
    name = "GROUP_LOAD_21044",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "",
    action = "action_EVENT_GROUP_LOAD_21044",
    trigger_count = 0
  },
  {
    config_id = 1021047,
    name = "GROUP_LOAD_21047",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "",
    action = "action_EVENT_GROUP_LOAD_21047",
    trigger_count = 0
  },
  {
    config_id = 1021048,
    name = "QUEST_START_21048",
    event = EventType.EVENT_QUEST_START,
    source = "4007119",
    condition = "",
    action = "action_EVENT_QUEST_START_21048",
    trigger_count = 0
  },
  {
    config_id = 1021049,
    name = "GROUP_REFRESH_21049",
    event = EventType.EVENT_GROUP_REFRESH,
    source = "",
    condition = "",
    action = "action_EVENT_GROUP_REFRESH_21049",
    trigger_count = 0
  },
  {
    config_id = 1021050,
    name = "QUEST_FINISH_21050",
    event = EventType.EVENT_QUEST_FINISH,
    source = "4007119",
    condition = "",
    action = "action_EVENT_QUEST_FINISH_21050",
    trigger_count = 0
  },
  {
    config_id = 1021051,
    name = "GROUP_LOAD_21051",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "condition_EVENT_GROUP_LOAD_21051",
    action = "action_EVENT_GROUP_LOAD_21051",
    trigger_count = 0
  },
  {
    config_id = 1021052,
    name = "QUEST_START_21052",
    event = EventType.EVENT_QUEST_START,
    source = "4007111",
    condition = "condition_EVENT_QUEST_START_21052",
    action = "action_EVENT_QUEST_START_21052",
    trigger_count = 0
  }
}
variables = {
...
suites = {
  {
    ...
    triggers = {
      "GROUP_LOAD_21006",
      "PLATFORM_ARRIVAL_21033",
      "QUEST_FINISH_21034",
      "PLATFORM_ARRIVAL_21035",
      "VARIABLE_CHANGE_21036",
      "VARIABLE_CHANGE_21037",
      "VARIABLE_CHANGE_21038",
      "PLATFORM_ARRIVAL_21039",
      "PLATFORM_ARRIVAL_21040",
      "PLATFORM_ARRIVAL_21041",
      "PLATFORM_ARRIVAL_21042",
      "GROUP_LOAD_21044",
      "GROUP_LOAD_21051",
      "QUEST_START_21052"
    },
...
function action_EVENT_GROUP_LOAD_21006(context, evt)
  ...
  if 0 ~= ScriptLib.SetPlatformPointArray(context, 21032, 2, {
    1,
    2,
    3,
    4,
...
function action_EVENT_VARIABLE_CHANGE_21037(context, evt)
  local tempParam = {route_type = 0, turn_mode = false}
  if 0 ~= ScriptLib.SetPlatformPointArray(context, 21032, 5, {
    1,
    2,
    3
  }, tempParam) then
...
function action_EVENT_VARIABLE_CHANGE_21038(context, evt)
  local tempParam = {route_type = 0, turn_mode = false}
  if 0 ~= ScriptLib.SetPlatformPointArray(context, 21032, 4, {
    1,
    2,
    3,
    4
...
function action_EVENT_PLATFORM_ARRIVAL_21041(context, evt)
  ...
  local tempParam = {route_type = 0, turn_mode = false}
  if 0 ~= ScriptLib.SetPlatformPointArray(context, 21032, 12, {
    1,
    2,
    3,
    4
