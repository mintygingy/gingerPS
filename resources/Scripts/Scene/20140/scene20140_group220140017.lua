local base_info = {group_id = 220140017}
local defs = {
  fireMachineList = {17001},
  initConfig = {
    [17001] = 5
  },
  controlRelation = {},
...
triggers = {
  ...
  {
    config_id = 1017009,
    name = "GROUP_LOAD_17009",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "",
    action = "action_EVENT_GROUP_LOAD_17009",
    trigger_count = 0
  },
  {
    config_id = 1017010,
    name = "QUEST_START_17010",
    event = EventType.EVENT_QUEST_START,
    source = "4006704",
    condition = "condition_EVENT_QUEST_START_17010",
    action = "action_EVENT_QUEST_START_17010",
    trigger_count = 0
  },
  {
    config_id = 1017011,
    name = "GROUP_LOAD_17011",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "condition_EVENT_GROUP_LOAD_17011",
    action = "action_EVENT_GROUP_LOAD_17011",
    trigger_count = 0
  },
  {
    config_id = 1017014,
    name = "GROUP_LOAD_17014",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "condition_EVENT_GROUP_LOAD_17014",
    action = "action_EVENT_GROUP_LOAD_17014",
    trigger_count = 0
  }
}
variables = {
