local base_info = {group_id = 220140021}
local defs = {
  fireMachineList = {21002},
  initConfig = {
    [21002] = 1
  },
  controlRelation = {},
...
triggers = {
  {
    config_id = 1021001,
    name = "GROUP_LOAD_21001",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "condition_EVENT_GROUP_LOAD_21001",
    action = "action_EVENT_GROUP_LOAD_21001",
    trigger_count = 0
  },
  {
    config_id = 1021009,
  ...
  {
    config_id = 1021010,
    name = "TIME_AXIS_PASS_21010",
    event = EventType.EVENT_TIME_AXIS_PASS,
    source = "fire",
    condition = "condition_EVENT_TIME_AXIS_PASS_21010",
    action = "action_EVENT_TIME_AXIS_PASS_21010"
  },
  {
    config_id = 1021011,
    name = "SELECT_OPTION_21011",
    event = EventType.EVENT_SELECT_OPTION,
    source = "",
    condition = "condition_EVENT_SELECT_OPTION_21011",
    action = "action_EVENT_SELECT_OPTION_21011"
  },
  {
    config_id = 1021012,
    name = "GROUP_LOAD_21012",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "",
    action = "action_EVENT_GROUP_LOAD_21012",
    trigger_count = 0
  },
  {
    config_id = 1021016,
    name = "TIME_AXIS_PASS_21016",
    event = EventType.EVENT_TIME_AXIS_PASS,
    source = "fire",
    condition = "condition_EVENT_TIME_AXIS_PASS_21016",
    action = "action_EVENT_TIME_AXIS_PASS_21016"
  },
  {
    config_id = 1021018,
    name = "VARIABLE_CHANGE_21018",
    event = EventType.EVENT_VARIABLE_CHANGE,
    source = "fire",
    condition = "condition_EVENT_VARIABLE_CHANGE_21018",
    action = "action_EVENT_VARIABLE_CHANGE_21018",
    trigger_count = 0
  },
  {
    config_id = 1021022,
    name = "GROUP_LOAD_21022",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "",
    action = "action_EVENT_GROUP_LOAD_21022",
    trigger_count = 0
  },
  {
    config_id = 1021023,
    name = "ANY_MONSTER_DIE_21023",
    event = EventType.EVENT_ANY_MONSTER_DIE,
    source = "",
    condition = "condition_EVENT_ANY_MONSTER_DIE_21023",
    action = "action_EVENT_ANY_MONSTER_DIE_21023",
    trigger_count = 0
  },
  {
    config_id = 1021024,
    name = "GADGET_STATE_CHANGE_21024",
    event = EventType.EVENT_GADGET_STATE_CHANGE,
    source = "",
    condition = "",
    action = "action_EVENT_GADGET_STATE_CHANGE_21024",
    trigger_count = 0
  },
  {
    config_id = 1021026,
    name = "GROUP_LOAD_21026",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "",
    action = "action_EVENT_GROUP_LOAD_21026",
    trigger_count = 0
  },
  {
    config_id = 1021027,
    name = "GROUP_LOAD_21027",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "",
    action = "action_EVENT_GROUP_LOAD_21027",
    trigger_count = 0
  },
  {
    config_id = 1021028,
    name = "QUEST_START_21028",
    event = EventType.EVENT_QUEST_START,
    source = "4006717",
    condition = "condition_EVENT_QUEST_START_21028",
    action = "action_EVENT_QUEST_START_21028",
    trigger_count = 0
  },
  {
    config_id = 1021029,
    name = "GROUP_LOAD_21029",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "condition_EVENT_GROUP_LOAD_21029",
    action = "action_EVENT_GROUP_LOAD_21029",
    trigger_count = 0
  },
  {
    config_id = 1021030,
    name = "GROUP_LOAD_21030",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "",
    action = "action_EVENT_GROUP_LOAD_21030",
    trigger_count = 0
  },
  {
    config_id = 1021031,
    name = "GROUP_LOAD_21031",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "",
    action = "action_EVENT_GROUP_LOAD_21031",
    trigger_count = 0
  },
  {
    config_id = 1021032,
    name = "GROUP_LOAD_21032",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "",
    action = "action_EVENT_GROUP_LOAD_21032",
    trigger_count = 0
  },
  {
    config_id = 1021033,
    name = "ANY_MONSTER_DIE_21033",
    event = EventType.EVENT_ANY_MONSTER_DIE,
    source = "",
    condition = "condition_EVENT_ANY_MONSTER_DIE_21033",
    action = "action_EVENT_ANY_MONSTER_DIE_21033",
    trigger_count = 0
  },
  {
    config_id = 1021034,
    name = "GROUP_LOAD_21034",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "",
    action = "action_EVENT_GROUP_LOAD_21034",
    trigger_count = 0
  },
  {
    config_id = 1021035,
    name = "GROUP_LOAD_21035",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "",
    action = "action_EVENT_GROUP_LOAD_21035",
    trigger_count = 0
  },
  {
    config_id = 1021036,
    name = "GROUP_LOAD_21036",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "",
    action = "action_EVENT_GROUP_LOAD_21036",
    trigger_count = 0
  }
}
variables = {
...
suites = {
  {
    ...
    triggers = {
      "GROUP_LOAD_21001",
      "GROUP_LOAD_21012",
      "VARIABLE_CHANGE_21018",
      "GROUP_LOAD_21022",
      "GADGET_STATE_CHANGE_21024",
      "GROUP_LOAD_21026",
      "GROUP_LOAD_21027",
      "QUEST_START_21028",
      "GROUP_LOAD_21029",
  ...
  },
  {
    ...
    triggers = {
      ...
      "TIME_AXIS_PASS_21010",
      "SELECT_OPTION_21011",
      "TIME_AXIS_PASS_21016"
    },
    rand_weight = 100
  },
  {
    ...
    regions = {},
    triggers = {
      "ANY_MONSTER_DIE_21023",
      "ANY_MONSTER_DIE_21033"
    },
    rand_weight = 100
  }
}
...
function action_EVENT_SELECT_OPTION_21011(context, evt)
  ...
  ScriptLib.InitTimeAxis(context, "fire", {
    1,
    2,
    3
  }, false)
