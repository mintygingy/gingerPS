local base_info = {group_id = 220140004}
local defs = {
  fireMachineList = {4007},
  initConfig = {
    [4007] = 1
  },
  controlRelation = {},
...
gadgets = {
  ...
  },
  {
    ...
    level = 16,
    drop_tag = "\232\167\163\232\176\156\233\171\152\231\186\167\231\190\164\229\178\155",
    isOneoff = true,
    persistent = true
  },
  {
...
triggers = {
  {
    config_id = 1004003,
    name = "PLATFORM_ARRIVAL_4003",
    event = EventType.EVENT_PLATFORM_ARRIVAL,
    source = "",
    condition = "condition_EVENT_PLATFORM_ARRIVAL_4003",
    action = "action_EVENT_PLATFORM_ARRIVAL_4003",
    trigger_count = 0
  },
  {
    config_id = 1004004,
  ...
  {
    config_id = 1004013,
    name = "VARIABLE_CHANGE_4013",
    event = EventType.EVENT_VARIABLE_CHANGE,
    source = "plat",
    condition = "condition_EVENT_VARIABLE_CHANGE_4013",
    action = "action_EVENT_VARIABLE_CHANGE_4013",
    trigger_count = 0
  },
  {
    config_id = 1004014,
    name = "VARIABLE_CHANGE_4014",
    event = EventType.EVENT_VARIABLE_CHANGE,
    source = "plat",
    condition = "condition_EVENT_VARIABLE_CHANGE_4014",
    action = "action_EVENT_VARIABLE_CHANGE_4014",
    trigger_count = 0
  },
  {
    config_id = 1004022,
    name = "ANY_GADGET_DIE_4022",
    event = EventType.EVENT_ANY_GADGET_DIE,
    source = "",
    condition = "condition_EVENT_ANY_GADGET_DIE_4022",
    action = "action_EVENT_ANY_GADGET_DIE_4022",
    trigger_count = 0
  },
  {
    config_id = 1004024,
    name = "ANY_GADGET_DIE_4024",
    event = EventType.EVENT_ANY_GADGET_DIE,
    source = "",
    condition = "condition_EVENT_ANY_GADGET_DIE_4024",
    action = "action_EVENT_ANY_GADGET_DIE_4024",
    trigger_count = 0
  },
  {
    config_id = 1004025,
    name = "GADGET_STATE_CHANGE_4025",
    event = EventType.EVENT_GADGET_STATE_CHANGE,
    source = "",
    condition = "",
    action = "action_EVENT_GADGET_STATE_CHANGE_4025",
    trigger_count = 0
  },
  {
    config_id = 1004026,
    name = "PLATFORM_ARRIVAL_4026",
    event = EventType.EVENT_PLATFORM_ARRIVAL,
    source = "",
    condition = "condition_EVENT_PLATFORM_ARRIVAL_4026",
    action = "action_EVENT_PLATFORM_ARRIVAL_4026",
    trigger_count = 0
  },
  {
    config_id = 1004028,
    name = "ENTER_REGION_4028",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_4028",
    action = "action_EVENT_ENTER_REGION_4028",
    trigger_count = 0
  },
  {
    config_id = 1004029,
    name = "ENTER_REGION_4029",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_4029",
    action = "action_EVENT_ENTER_REGION_4029",
    trigger_count = 0
  },
  {
    config_id = 1004031,
    name = "ENTER_REGION_4031",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_4031",
    action = "action_EVENT_ENTER_REGION_4031",
    trigger_count = 0
  },
  {
    config_id = 1004032,
    name = "GADGET_STATE_CHANGE_4032",
    event = EventType.EVENT_GADGET_STATE_CHANGE,
    source = "",
    condition = "condition_EVENT_GADGET_STATE_CHANGE_4032",
    action = "action_EVENT_GADGET_STATE_CHANGE_4032",
    trigger_count = 0
  },
  {
    config_id = 1004033,
    name = "VARIABLE_CHANGE_4033",
    event = EventType.EVENT_VARIABLE_CHANGE,
    source = "plat",
    condition = "condition_EVENT_VARIABLE_CHANGE_4033",
    action = "action_EVENT_VARIABLE_CHANGE_4033",
    trigger_count = 0
  },
  {
    config_id = 1004034,
    name = "ENTER_REGION_4034",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_4034",
    action = "action_EVENT_ENTER_REGION_4034",
    trigger_count = 0
  },
  {
    config_id = 1004035,
    name = "GROUP_LOAD_4035",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "condition_EVENT_GROUP_LOAD_4035",
    action = "action_EVENT_GROUP_LOAD_4035",
    trigger_count = 0
  },
  {
    config_id = 1004037,
    name = "VARIABLE_CHANGE_4037",
    event = EventType.EVENT_VARIABLE_CHANGE,
    source = "plat",
    condition = "condition_EVENT_VARIABLE_CHANGE_4037",
    action = "action_EVENT_VARIABLE_CHANGE_4037",
    trigger_count = 0
  },
  {
    config_id = 1004038,
    name = "VARIABLE_CHANGE_4038",
    event = EventType.EVENT_VARIABLE_CHANGE,
    source = "plat",
    condition = "condition_EVENT_VARIABLE_CHANGE_4038",
    action = "action_EVENT_VARIABLE_CHANGE_4038",
    trigger_count = 0
  },
  {
    config_id = 1004039,
    name = "VARIABLE_CHANGE_4039",
    event = EventType.EVENT_VARIABLE_CHANGE,
    source = "plat",
    condition = "condition_EVENT_VARIABLE_CHANGE_4039",
    action = "action_EVENT_VARIABLE_CHANGE_4039",
    trigger_count = 0
  },
  {
    config_id = 1004040,
    name = "VARIABLE_CHANGE_4040",
    event = EventType.EVENT_VARIABLE_CHANGE,
    source = "plat",
    condition = "condition_EVENT_VARIABLE_CHANGE_4040",
    action = "action_EVENT_VARIABLE_CHANGE_4040",
    trigger_count = 0
  },
  {
    config_id = 1004041,
    name = "VARIABLE_CHANGE_4041",
    event = EventType.EVENT_VARIABLE_CHANGE,
    source = "plat",
    condition = "condition_EVENT_VARIABLE_CHANGE_4041",
    action = "action_EVENT_VARIABLE_CHANGE_4041",
    trigger_count = 0
  },
  {
    config_id = 1004042,
    name = "AVATAR_NEAR_PLATFORM_4042",
    event = EventType.EVENT_AVATAR_NEAR_PLATFORM,
    source = "",
    condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_4042",
    action = "action_EVENT_AVATAR_NEAR_PLATFORM_4042",
    trigger_count = 0
  },
  {
    config_id = 1004043,
    name = "ENTER_REGION_4043",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_4043",
    action = "action_EVENT_ENTER_REGION_4043",
    trigger_count = 0
  },
  {
    config_id = 1004044,
    name = "VARIABLE_CHANGE_4044",
    event = EventType.EVENT_VARIABLE_CHANGE,
    source = "plat",
    condition = "condition_EVENT_VARIABLE_CHANGE_4044",
    action = "action_EVENT_VARIABLE_CHANGE_4044",
    trigger_count = 0
  },
  {
    config_id = 1004045,
    name = "AVATAR_NEAR_PLATFORM_4045",
    event = EventType.EVENT_AVATAR_NEAR_PLATFORM,
    source = "",
    condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_4045",
    action = "action_EVENT_AVATAR_NEAR_PLATFORM_4045",
    trigger_count = 0
  },
  {
    config_id = 1004046,
    name = "VARIABLE_CHANGE_4046",
    event = EventType.EVENT_VARIABLE_CHANGE,
    source = "plat",
    condition = "condition_EVENT_VARIABLE_CHANGE_4046",
    action = "action_EVENT_VARIABLE_CHANGE_4046",
    trigger_count = 0
  },
  {
    config_id = 1004047,
    name = "PLATFORM_ARRIVAL_4047",
    event = EventType.EVENT_PLATFORM_ARRIVAL,
    source = "",
    condition = "condition_EVENT_PLATFORM_ARRIVAL_4047",
    action = "action_EVENT_PLATFORM_ARRIVAL_4047",
    trigger_count = 0
  },
  {
    config_id = 1004049,
    name = "VARIABLE_CHANGE_4049",
    event = EventType.EVENT_VARIABLE_CHANGE,
    source = "extra",
    condition = "condition_EVENT_VARIABLE_CHANGE_4049",
    action = "action_EVENT_VARIABLE_CHANGE_4049",
    trigger_count = 0
  },
  {
    config_id = 1004051,
    name = "PLATFORM_ARRIVAL_4051",
    event = EventType.EVENT_PLATFORM_ARRIVAL,
    source = "",
    condition = "condition_EVENT_PLATFORM_ARRIVAL_4051",
    action = "action_EVENT_PLATFORM_ARRIVAL_4051",
    trigger_count = 0
  },
  {
    config_id = 1004052,
    name = "QUEST_START_4052",
    event = EventType.EVENT_QUEST_START,
    source = "4006707",
    condition = "condition_EVENT_QUEST_START_4052",
    action = "action_EVENT_QUEST_START_4052",
    trigger_count = 0
  },
  {
    config_id = 1004053,
    name = "GROUP_LOAD_4053",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "condition_EVENT_GROUP_LOAD_4053",
    action = "action_EVENT_GROUP_LOAD_4053",
    trigger_count = 0
  },
  {
    config_id = 1004054,
    name = "GROUP_LOAD_4054",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "",
    action = "action_EVENT_GROUP_LOAD_4054",
    trigger_count = 0
  },
  {
    config_id = 1004055,
    name = "PLATFORM_ARRIVAL_4055",
    event = EventType.EVENT_PLATFORM_ARRIVAL,
    source = "",
    condition = "condition_EVENT_PLATFORM_ARRIVAL_4055",
    action = "action_EVENT_PLATFORM_ARRIVAL_4055",
    trigger_count = 0
  },
  {
    config_id = 1004056,
    name = "GROUP_LOAD_4056",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "",
    action = "action_EVENT_GROUP_LOAD_4056",
    trigger_count = 0
  },
  {
    config_id = 1004057,
    name = "AVATAR_NEAR_PLATFORM_4057",
    event = EventType.EVENT_AVATAR_NEAR_PLATFORM,
    source = "",
    condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_4057",
    action = "action_EVENT_AVATAR_NEAR_PLATFORM_4057",
    trigger_count = 0
  },
  {
    config_id = 1004059,
    name = "AVATAR_NEAR_PLATFORM_4059",
    event = EventType.EVENT_AVATAR_NEAR_PLATFORM,
    source = "",
    condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_4059",
    action = "action_EVENT_AVATAR_NEAR_PLATFORM_4059",
    trigger_count = 0
  },
  {
    config_id = 1004060,
    name = "PLATFORM_ARRIVAL_4060",
    event = EventType.EVENT_PLATFORM_ARRIVAL,
    source = "",
    condition = "condition_EVENT_PLATFORM_ARRIVAL_4060",
    action = "action_EVENT_PLATFORM_ARRIVAL_4060",
    trigger_count = 0
  },
  {
    config_id = 1004061,
    name = "GROUP_LOAD_4061",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "condition_EVENT_GROUP_LOAD_4061",
    action = "action_EVENT_GROUP_LOAD_4061",
    trigger_count = 0
  }
}
variables = {
...
garbages = {
  triggers = {
    {
      config_id = 1004058,
      name = "AVATAR_NEAR_PLATFORM_4058",
      event = EventType.EVENT_AVATAR_NEAR_PLATFORM,
      source = "",
      condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_4058",
      action = "action_EVENT_AVATAR_NEAR_PLATFORM_4058",
      trigger_count = 0
    }
  }
}
...
suites = {
  {
    ...
    triggers = {
      "PLATFORM_ARRIVAL_4003",
      "TIME_AXIS_PASS_4004",
      "TIME_AXIS_PASS_4011",
      "VARIABLE_CHANGE_4013",
      "VARIABLE_CHANGE_4014",
      "ANY_GADGET_DIE_4022",
      "ANY_GADGET_DIE_4024",
      "GADGET_STATE_CHANGE_4025",
      "PLATFORM_ARRIVAL_4026",
      "ENTER_REGION_4028",
      "ENTER_REGION_4029",
      "ENTER_REGION_4031",
      "GADGET_STATE_CHANGE_4032",
      "VARIABLE_CHANGE_4033",
      "GROUP_LOAD_4035",
      "VARIABLE_CHANGE_4037",
      "VARIABLE_CHANGE_4038",
      "VARIABLE_CHANGE_4039",
      "VARIABLE_CHANGE_4040",
      "VARIABLE_CHANGE_4041",
      "AVATAR_NEAR_PLATFORM_4042",
      "ENTER_REGION_4043",
      "VARIABLE_CHANGE_4044",
      "AVATAR_NEAR_PLATFORM_4045",
      "VARIABLE_CHANGE_4046",
      "PLATFORM_ARRIVAL_4047",
      "VARIABLE_CHANGE_4049",
      "PLATFORM_ARRIVAL_4051",
      "QUEST_START_4052",
      "GROUP_LOAD_4053",
      "GROUP_LOAD_4054",
      "PLATFORM_ARRIVAL_4055",
      "GROUP_LOAD_4056",
      "AVATAR_NEAR_PLATFORM_4057",
      "AVATAR_NEAR_PLATFORM_4059",
      "PLATFORM_ARRIVAL_4060",
      "GROUP_LOAD_4061"
    },
    rand_weight = 100
  },
