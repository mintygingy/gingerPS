local base_info = {group_id = 220140018}
local defs = {
  fireMachineList = {18002},
  initConfig = {
    [18002] = 1
  },
  controlRelation = {},
...
triggers = {
  {
    config_id = 1018007,
    name = "GADGET_STATE_CHANGE_18007",
    event = EventType.EVENT_GADGET_STATE_CHANGE,
    source = "",
    condition = "condition_EVENT_GADGET_STATE_CHANGE_18007",
    action = "action_EVENT_GADGET_STATE_CHANGE_18007",
    trigger_count = 0
  },
  {
    config_id = 1018008,
    name = "QUEST_START_18008",
    event = EventType.EVENT_QUEST_START,
    source = "4006708",
    condition = "condition_EVENT_QUEST_START_18008",
    action = "action_EVENT_QUEST_START_18008",
    trigger_count = 0
  },
  {
    config_id = 1018011,
    name = "ANY_GADGET_DIE_18011",
    event = EventType.EVENT_ANY_GADGET_DIE,
    source = "",
    condition = "condition_EVENT_ANY_GADGET_DIE_18011",
    action = "action_EVENT_ANY_GADGET_DIE_18011",
    trigger_count = 0
  },
  {
    config_id = 1018013,
    name = "GADGET_STATE_CHANGE_18013",
    event = EventType.EVENT_GADGET_STATE_CHANGE,
    source = "",
    condition = "condition_EVENT_GADGET_STATE_CHANGE_18013",
    action = "action_EVENT_GADGET_STATE_CHANGE_18013",
    trigger_count = 0
  },
  {
    config_id = 1018014,
    name = "LUA_NOTIFY_18014",
    event = EventType.EVENT_LUA_NOTIFY,
    source = "",
    condition = "condition_EVENT_LUA_NOTIFY_18014",
    action = "action_EVENT_LUA_NOTIFY_18014",
    trigger_count = 0
  },
  {
    config_id = 1018016,
    name = "TIME_AXIS_PASS_18016",
    event = EventType.EVENT_TIME_AXIS_PASS,
    source = "message",
    condition = "condition_EVENT_TIME_AXIS_PASS_18016",
    action = "action_EVENT_TIME_AXIS_PASS_18016",
    trigger_count = 0
  },
  {
    config_id = 1018017,
    name = "GROUP_LOAD_18017",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "",
    action = "action_EVENT_GROUP_LOAD_18017",
    trigger_count = 0
  },
  {
    config_id = 1018018,
    name = "TIME_AXIS_PASS_18018",
    event = EventType.EVENT_TIME_AXIS_PASS,
    source = "temp",
    condition = "condition_EVENT_TIME_AXIS_PASS_18018",
    action = "action_EVENT_TIME_AXIS_PASS_18018",
    trigger_count = 0
  }
}
variables = {
...
suites = {
  ...
  },
  {
    ...
    regions = {},
    triggers = {
      "GADGET_STATE_CHANGE_18007",
      "ANY_GADGET_DIE_18011",
      "GADGET_STATE_CHANGE_18013",
      "LUA_NOTIFY_18014",
      "TIME_AXIS_PASS_18016",
      "TIME_AXIS_PASS_18018"
    },
    rand_weight = 100
  }
}
