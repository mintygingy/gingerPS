local base_info = {group_id = 220151014}
monsters = {}
npcs = {}
gadgets = {
  {
...
triggers = {
  ...
  {
    config_id = 1014009,
    name = "ENTER_REGION_14009",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_14009",
    action = "action_EVENT_ENTER_REGION_14009"
  },
  {
    config_id = 1014010,
    name = "ENTER_REGION_14010",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_14010",
    action = "action_EVENT_ENTER_REGION_14010"
  },
  {
    config_id = 1014011,
  ...
  {
    config_id = 1014012,
    name = "ENTER_REGION_14012",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_14012",
    action = "action_EVENT_ENTER_REGION_14012"
  },
  {
    config_id = 1014013,
    name = "ENTER_REGION_14013",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_14013",
    action = "action_EVENT_ENTER_REGION_14013"
  }
}
variables = {}
init_config = {
