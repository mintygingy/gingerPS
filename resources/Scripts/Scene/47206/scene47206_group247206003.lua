local base_info = {group_id = 247206003}
local defs = {
  gadget_1 = 3001,
  group_1 = 247206003,
  challenge1 = 2,
...
triggers = {
  ...
  {
    config_id = 1003009,
    name = "ANY_MONSTER_DIE_3009",
    event = EventType.EVENT_ANY_MONSTER_DIE,
    source = "",
    condition = "condition_EVENT_ANY_MONSTER_DIE_3009",
    action = "action_EVENT_ANY_MONSTER_DIE_3009"
  }
}
variables = {
  {
