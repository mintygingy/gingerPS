local base_info = {group_id = 220133067}
local defs = {
  active_step = 201,
  inactive_step = 0,
  gadget_array = {
...
triggers = {
  {
    config_id = 1067005,
    name = "ENTER_REGION_67005",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "",
    action = "action_EVENT_ENTER_REGION_67005"
  },
  {
    config_id = 1067007,
    name = "GADGET_STATE_CHANGE_67007",
    event = EventType.EVENT_GADGET_STATE_CHANGE,
    source = "",
    condition = "condition_EVENT_GADGET_STATE_CHANGE_67007",
    action = "action_EVENT_GADGET_STATE_CHANGE_67007",
    trigger_count = 0
  },
  {
    config_id = 1067008,
    name = "VARIABLE_CHANGE_67008",
    event = EventType.EVENT_VARIABLE_CHANGE,
    source = "gear_reset",
    condition = "",
    action = "action_EVENT_VARIABLE_CHANGE_67008",
    trigger_count = 0
  },
  {
    config_id = 1067009,
    name = "VARIABLE_CHANGE_67009",
    event = EventType.EVENT_VARIABLE_CHANGE,
    source = "trigger_output",
    condition = "condition_EVENT_VARIABLE_CHANGE_67009",
    action = "",
    trigger_count = 0
  },
  {
    config_id = 1067010,
    name = "VARIABLE_CHANGE_67010",
    event = EventType.EVENT_VARIABLE_CHANGE,
    source = "trigger_output",
    condition = "condition_EVENT_VARIABLE_CHANGE_67010",
    action = "action_EVENT_VARIABLE_CHANGE_67010",
    trigger_count = 0
  }
}
variables = {
...
garbages = {
  triggers = {
    {
      config_id = 1067011,
      name = "GADGET_CREATE_67011",
      event = EventType.EVENT_GADGET_CREATE,
      source = "",
      condition = "condition_EVENT_GADGET_CREATE_67011",
      action = "action_EVENT_GADGET_CREATE_67011",
      trigger_count = 0
    }
  }
}
...
suites = {
  {
    ...
    triggers = {
      "ENTER_REGION_67005",
      "GADGET_STATE_CHANGE_67007",
      "VARIABLE_CHANGE_67008",
      "VARIABLE_CHANGE_67009",
      "VARIABLE_CHANGE_67010"
    },
    rand_weight = 100
  }
}
