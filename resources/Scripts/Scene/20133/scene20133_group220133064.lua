local base_info = {group_id = 220133064}
local defs = {
  selectID_horizon = 54,
...
triggers = {
  {
    config_id = 1064011,
    name = "QUEST_FINISH_64011",
    event = EventType.EVENT_QUEST_FINISH,
    source = "4006904",
    condition = "",
    action = "action_EVENT_QUEST_FINISH_64011",
    trigger_count = 0
  },
  {
    config_id = 1064012,
    name = "ANY_GADGET_DIE_64012",
    event = EventType.EVENT_ANY_GADGET_DIE,
    source = "",
    condition = "condition_EVENT_ANY_GADGET_DIE_64012",
    action = "action_EVENT_ANY_GADGET_DIE_64012",
    trigger_count = 0
  },
  {
    config_id = 1064019,
    name = "QUEST_START_64019",
    event = EventType.EVENT_QUEST_START,
    source = "4006905",
    condition = "condition_EVENT_QUEST_START_64019",
    action = "action_EVENT_QUEST_START_64019",
    trigger_count = 0
  },
  {
    config_id = 1064020,
    name = "GROUP_LOAD_64020",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "condition_EVENT_GROUP_LOAD_64020",
    action = "action_EVENT_GROUP_LOAD_64020",
    trigger_count = 0
  }
}
variables = {
