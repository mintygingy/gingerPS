local base_info = {group_id = 220133101}
monsters = {}
npcs = {}
gadgets = {
  {
    ...
    level = 1,
    persistent = true,
    server_global_value_config = {SGV_XinyanPortal_Pic = 323}
  },
  {
    config_id = 101002,
    gadget_id = 70290264,
...
triggers = {
  {
    config_id = 1101005,
    name = "GADGET_STATE_CHANGE_101005",
    event = EventType.EVENT_GADGET_STATE_CHANGE,
    source = "",
    condition = "condition_EVENT_GADGET_STATE_CHANGE_101005",
    action = "action_EVENT_GADGET_STATE_CHANGE_101005",
    trigger_count = 0
  },
  {
    config_id = 1101006,
    name = "LEAVE_REGION_101006",
    event = EventType.EVENT_LEAVE_REGION,
    source = "",
    condition = "condition_EVENT_LEAVE_REGION_101006",
    action = "action_EVENT_LEAVE_REGION_101006",
    trigger_count = 0
  },
  {
    config_id = 1101007,
    name = "GADGET_CREATE_101007",
    event = EventType.EVENT_GADGET_CREATE,
    source = "",
    condition = "condition_EVENT_GADGET_CREATE_101007",
    action = "action_EVENT_GADGET_CREATE_101007",
    trigger_count = 0
  },
  {
    config_id = 1101009,
    name = "GROUP_LOAD_101009",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "",
    action = "action_EVENT_GROUP_LOAD_101009",
    trigger_count = 0
  },
  {
    config_id = 1101010,
    name = "TIME_AXIS_PASS_101010",
    event = EventType.EVENT_TIME_AXIS_PASS,
    source = "",
    condition = "condition_EVENT_TIME_AXIS_PASS_101010",
    action = "action_EVENT_TIME_AXIS_PASS_101010",
    trigger_count = 0
  }
}
variables = {}
garbages = {
  ...
  triggers = {
    {
      config_id = 1101004,
      name = "GADGET_STATE_CHANGE_101004",
      event = EventType.EVENT_GADGET_STATE_CHANGE,
      source = "",
      condition = "condition_EVENT_GADGET_STATE_CHANGE_101004",
      action = "action_EVENT_GADGET_STATE_CHANGE_101004",
      trigger_count = 0
    }
  }
}
...
suites = {
  {
    ...
    regions = {101006},
    triggers = {
      "GADGET_STATE_CHANGE_101005",
      "LEAVE_REGION_101006",
      "GADGET_CREATE_101007",
      "GROUP_LOAD_101009",
      "TIME_AXIS_PASS_101010"
    },
    rand_weight = 100
  },
  {
