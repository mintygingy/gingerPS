local base_info = {group_id = 234738007}
monsters = {
  {
    config_id = 7001,
    monster_id = 25100101,
...
triggers = {
  {
    config_id = 1007005,
    name = "ANY_MONSTER_LIVE_7005",
    event = EventType.EVENT_ANY_MONSTER_LIVE,
    source = "",
    condition = "condition_EVENT_ANY_MONSTER_LIVE_7005",
    action = "action_EVENT_ANY_MONSTER_LIVE_7005"
  },
  {
    config_id = 1007013,
