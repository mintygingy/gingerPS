local base_info = {group_id = 235852004}
local defs = {
  starter = 4001,
  option_id = 94,
  delay = 2,
...
gadgets = {
  ...
  [4012] = {
    ...
    server_global_value_config = {SGV_Constellation_Mark = 4012, SGV_Constellation_Target = 4013}
  },
  [4013] = {
    config_id = 4013,
    gadget_id = 70220119,
    ...
    level = 1,
    server_global_value_config = {SGV_Constellation_Mark = 4013, SGV_Constellation_Target = 4014}
  },
  [4014] = {
    config_id = 4014,
    gadget_id = 70220119,
    ...
    level = 1,
    server_global_value_config = {SGV_Constellation_Mark = 4014, SGV_Constellation_Target = 4012}
  },
  [4015] = {
    config_id = 4015,
    gadget_id = 70220119,
    ...
    level = 1,
    server_global_value_config = {SGV_Constellation_Mark = 4015, SGV_Constellation_Target = 4013}
  },
  [4016] = {
    config_id = 4016,
    gadget_id = 70220119,
    ...
    level = 1,
    server_global_value_config = {SGV_Constellation_Mark = 4016, SGV_Constellation_Target = 4015}
  },
  [4017] = {
    config_id = 4017,
    gadget_id = 70220119,
    ...
    level = 1,
    server_global_value_config = {SGV_Constellation_Mark = 4017, SGV_Constellation_Target = 4016}
  },
  [4018] = {
    config_id = 4018,
    gadget_id = 70220119,
    ...
    level = 1,
    server_global_value_config = {SGV_Constellation_Mark = 4018, SGV_Constellation_Target = 4017}
  },
  [4019] = {
    config_id = 4019,
    gadget_id = 70310323,
...
triggers = {
  {
    config_id = 1004026,
    name = "CHALLENGE_SUCCESS_4026",
    event = EventType.EVENT_CHALLENGE_SUCCESS,
    source = "2010055",
    condition = "",
    action = "action_EVENT_CHALLENGE_SUCCESS_4026",
    trigger_count = 0
  },
  {
    config_id = 1004029,
    name = "SELECT_OPTION_4029",
    event = EventType.EVENT_SELECT_OPTION,
    source = "",
    condition = "condition_EVENT_SELECT_OPTION_4029",
    action = "action_EVENT_SELECT_OPTION_4029",
    trigger_count = 0
  },
  {
    config_id = 1004030,
    name = "CHALLENGE_FAIL_4030",
    event = EventType.EVENT_CHALLENGE_FAIL,
    source = "2010055",
    condition = "",
    action = "action_EVENT_CHALLENGE_FAIL_4030",
    trigger_count = 0
  },
  {
    config_id = 1004031,
  ...
  {
    config_id = 1004078,
    name = "ENTER_REGION_4078",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_4078",
    action = "action_EVENT_ENTER_REGION_4078"
  }
}
variables = {}
init_config = {
