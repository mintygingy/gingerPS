local base_info = {group_id = 235852001}
local defs = {
  starter = 1001,
  option_id = 94,
  delay = 2,
...
gadgets = {
  ...
  [1038] = {
    ...
    level = 1,
    server_global_value_config = {SGV_Constellation_Mark = 1038, SGV_Constellation_Target = 1039}
  },
  [1039] = {
    config_id = 1039,
    gadget_id = 70220119,
    ...
    level = 1,
    server_global_value_config = {SGV_Constellation_Mark = 1039, SGV_Constellation_Target = 1040}
  },
  [1040] = {
    config_id = 1040,
    gadget_id = 70220119,
    ...
    level = 1,
    server_global_value_config = {SGV_Constellation_Mark = 1040, SGV_Constellation_Target = 1041}
  },
  [1041] = {
    config_id = 1041,
    gadget_id = 70220119,
    ...
    level = 1,
    server_global_value_config = {SGV_Constellation_Mark = 1041, SGV_Constellation_Target = 1042}
  },
  [1042] = {
    config_id = 1042,
    gadget_id = 70220119,
    ...
    level = 1,
    server_global_value_config = {SGV_Constellation_Mark = 1042, SGV_Constellation_Target = 1043}
  },
  [1043] = {
    config_id = 1043,
    gadget_id = 70220119,
    ...
    level = 1,
    server_global_value_config = {SGV_Constellation_Mark = 1043, SGV_Constellation_Target = 1042}
  },
  [1044] = {
    config_id = 1044,
    gadget_id = 70310323,
...
triggers = {
  {
    config_id = 1001037,
    name = "SELECT_OPTION_1037",
    event = EventType.EVENT_SELECT_OPTION,
    source = "",
    condition = "condition_EVENT_SELECT_OPTION_1037",
    action = "action_EVENT_SELECT_OPTION_1037",
    trigger_count = 0
  },
  {
    config_id = 1001051,
    name = "CHALLENGE_FAIL_1051",
    event = EventType.EVENT_CHALLENGE_FAIL,
    source = "2010055",
    condition = "",
    action = "action_EVENT_CHALLENGE_FAIL_1051",
    trigger_count = 0
  },
  {
    config_id = 1001052,
    name = "ENTER_REGION_1052",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_1052",
    action = "action_EVENT_ENTER_REGION_1052",
    trigger_count = 0
  },
  {
    config_id = 1001111,
    name = "CHALLENGE_SUCCESS_1111",
    event = EventType.EVENT_CHALLENGE_SUCCESS,
    source = "2010055",
    condition = "",
    action = "action_EVENT_CHALLENGE_SUCCESS_1111",
    trigger_count = 0
  }
}
variables = {}
