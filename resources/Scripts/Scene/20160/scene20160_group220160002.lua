local base_info = {group_id = 220160002}
monsters = {
  {
    config_id = 2002,
    monster_id = 25410201,
...
triggers = {
  {
    config_id = 1002009,
    name = "GADGET_CREATE_2009",
    event = EventType.EVENT_GADGET_CREATE,
    source = "",
    condition = "condition_EVENT_GADGET_CREATE_2009",
    action = "action_EVENT_GADGET_CREATE_2009",
    trigger_count = 0
  },
  {
    config_id = 1002010,
    name = "SELECT_OPTION_2010",
    event = EventType.EVENT_SELECT_OPTION,
    source = "",
    condition = "condition_EVENT_SELECT_OPTION_2010",
    action = "action_EVENT_SELECT_OPTION_2010",
    trigger_count = 0
  },
  {
    config_id = 1002011,
    name = "CHALLENGE_SUCCESS_2011",
    event = EventType.EVENT_CHALLENGE_SUCCESS,
    source = "2010074",
    condition = "",
    action = "action_EVENT_CHALLENGE_SUCCESS_2011",
    trigger_count = 0
  },
  {
    config_id = 1002013,
    name = "CHALLENGE_FAIL_2013",
    event = EventType.EVENT_CHALLENGE_FAIL,
    source = "2010074",
    condition = "",
    action = "action_EVENT_CHALLENGE_FAIL_2013",
    trigger_count = 0
  },
  {
    config_id = 1002027,
  ...
  {
    config_id = 1002032,
    name = "ANY_MONSTER_DIE_2032",
    event = EventType.EVENT_ANY_MONSTER_DIE,
    source = "",
    condition = "condition_EVENT_ANY_MONSTER_DIE_2032",
    action = "action_EVENT_ANY_MONSTER_DIE_2032"
  },
  {
    config_id = 1002033,
    name = "ANY_MONSTER_DIE_2033",
    event = EventType.EVENT_ANY_MONSTER_DIE,
    source = "",
    condition = "condition_EVENT_ANY_MONSTER_DIE_2033",
    action = "action_EVENT_ANY_MONSTER_DIE_2033"
  },
  {
    config_id = 1002034,
    name = "ANY_MONSTER_DIE_2034",
    event = EventType.EVENT_ANY_MONSTER_DIE,
    source = "",
    condition = "condition_EVENT_ANY_MONSTER_DIE_2034",
    action = "action_EVENT_ANY_MONSTER_DIE_2034"
  }
}
variables = {}
init_config = {
