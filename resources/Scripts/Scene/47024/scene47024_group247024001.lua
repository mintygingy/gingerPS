local base_info = {group_id = 247024001}
local defs = {
  gallery_id = 27007,
  finish_region = 1104,
  operator_time_1 = 20,
...
gadgets = {
  ...
  },
  {
    ...
    server_global_value_config = {SGV_Switch_StrongWind = 1, SGV_Switch_UpDown = 1}
  },
  {
    config_id = 1006,
    gadget_id = 70800246,
  ...
  },
  {
    ...
    state = GadgetState.GearStart,
    is_guest_can_operate = true,
    server_global_value_config = {SGV_Switch_StrongWind = 1}
  },
  {
    config_id = 1008,
    gadget_id = 70800246,
  ...
  },
  {
    ...
    state = GadgetState.GearStart,
    is_guest_can_operate = true,
    server_global_value_config = {SGV_Switch_StrongWind = 1, SGV_Switch__Dir = 2}
  },
  {
    config_id = 1032,
    gadget_id = 70800246,
  ...
  },
  {
    ...
    level = 1,
    server_global_value_config = {SGV_Left_Dir = 1, SGV_Right_Dir = 3}
  },
  {
    config_id = 1069,
    gadget_id = 70800246,
  ...
  },
  {
    ...
    state = GadgetState.GearStart,
    is_guest_can_operate = true,
    server_global_value_config = {SGV_Switch_StrongWind = 1, SGV_Switch_Dir = 2}
  },
  {
    config_id = 1071,
    gadget_id = 70800277,
  ...
  },
  {
    ...
    level = 1,
    server_global_value_config = {SGV_Right_Dir = 3, SGV_Left_Dir = 1}
  },
  {
    config_id = 1073,
    gadget_id = 70800246,
  ...
  },
  {
    ...
    state = GadgetState.GearStart,
    is_guest_can_operate = true,
    server_global_value_config = {SGV_Switch_StrongWind = 1, SGV_Switch_Dir = 3}
  },
  {
    config_id = 1075,
    gadget_id = 70800290,
...
triggers = {
  {
    ...
    action = "action_EVENT_ENTER_REGION_1013"
  },
  {
    config_id = 1001043,
    name = "GADGET_CREATE_1043",
    event = EventType.EVENT_GADGET_CREATE,
    source = "",
    condition = "condition_EVENT_GADGET_CREATE_1043",
    action = "action_EVENT_GADGET_CREATE_1043"
  },
  {
    config_id = 1001046,
  ...
  {
    config_id = 1001047,
    name = "SELECT_OPTION_1047",
    event = EventType.EVENT_SELECT_OPTION,
    source = "",
    condition = "condition_EVENT_SELECT_OPTION_1047",
    action = "action_EVENT_SELECT_OPTION_1047",
    trigger_count = 0,
    forbid_guest = false
  },
  {
    config_id = 1001049,
    name = "SELECT_OPTION_1049",
    event = EventType.EVENT_SELECT_OPTION,
    source = "",
    condition = "condition_EVENT_SELECT_OPTION_1049",
    action = "action_EVENT_SELECT_OPTION_1049",
    trigger_count = 0,
    forbid_guest = false
  },
  {
    config_id = 1001066,
    name = "ENTER_REGION_1066",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_1066",
    action = "action_EVENT_ENTER_REGION_1066",
    forbid_guest = false
  },
  {
    config_id = 1001067,
    name = "ANY_MONSTER_DIE_1067",
    event = EventType.EVENT_ANY_MONSTER_DIE,
    source = "",
    condition = "condition_EVENT_ANY_MONSTER_DIE_1067",
    action = "action_EVENT_ANY_MONSTER_DIE_1067"
  },
  {
    config_id = 1001093,
    name = "GADGET_CREATE_1093",
    event = EventType.EVENT_GADGET_CREATE,
    source = "",
    condition = "condition_EVENT_GADGET_CREATE_1093",
    action = "action_EVENT_GADGET_CREATE_1093"
  },
  {
    config_id = 1001094,
    name = "SELECT_OPTION_1094",
    event = EventType.EVENT_SELECT_OPTION,
    source = "",
    condition = "condition_EVENT_SELECT_OPTION_1094",
    action = "action_EVENT_SELECT_OPTION_1094",
    trigger_count = 0,
    forbid_guest = false
  },
  {
  ...
  {
    config_id = 1001131,
    name = "ENTER_REGION_1131",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_1131",
    action = "action_EVENT_ENTER_REGION_1131"
  },
  {
    config_id = 1001134,
  ...
  {
    config_id = 1001138,
    name = "PLATFORM_ARRIVAL_1138",
    event = EventType.EVENT_PLATFORM_ARRIVAL,
    source = "",
    condition = "condition_EVENT_PLATFORM_ARRIVAL_1138",
    action = "action_EVENT_PLATFORM_ARRIVAL_1138",
    trigger_count = 0
  },
  {
    config_id = 1001142,
    ...
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_1142",
    action = "action_EVENT_ENTER_REGION_1142",
    forbid_guest = false
  },
  {
    config_id = 1001143,
  ...
  {
    config_id = 1001144,
    name = "ENTER_REGION_1144",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_1144",
    action = "action_EVENT_ENTER_REGION_1144",
    forbid_guest = false
  },
  {
    config_id = 1001145,
  ...
  {
    config_id = 1001146,
    name = "ENTER_REGION_1146",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_1146",
    action = "action_EVENT_ENTER_REGION_1146",
    forbid_guest = false
  },
  {
    config_id = 1001148,
    name = "ENTER_REGION_1148",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_1148",
    action = "action_EVENT_ENTER_REGION_1148",
    forbid_guest = false
  },
  {
    config_id = 1001149,
    ...
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_1149",
    action = "action_EVENT_ENTER_REGION_1149",
    forbid_guest = false
  },
  {
    config_id = 1001155,
    name = "PLATFORM_ARRIVAL_1155",
    event = EventType.EVENT_PLATFORM_ARRIVAL,
    source = "",
    condition = "condition_EVENT_PLATFORM_ARRIVAL_1155",
    action = "action_EVENT_PLATFORM_ARRIVAL_1155",
    trigger_count = 0
  },
  {
    config_id = 1001161,
    name = "PLATFORM_ARRIVAL_1161",
    event = EventType.EVENT_PLATFORM_ARRIVAL,
    source = "",
    condition = "condition_EVENT_PLATFORM_ARRIVAL_1161",
    action = "action_EVENT_PLATFORM_ARRIVAL_1161",
    trigger_count = 0
  },
  {
    config_id = 1001162,
    name = "ENTER_REGION_1162",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "",
    action = "",
  ...
  {
    config_id = 1001163,
    name = "TIME_AXIS_PASS_1163",
    event = EventType.EVENT_TIME_AXIS_PASS,
    source = "",
    condition = "condition_EVENT_TIME_AXIS_PASS_1163",
    action = "action_EVENT_TIME_AXIS_PASS_1163",
    trigger_count = 0
  },
  {
    config_id = 1001164,
    name = "PLATFORM_ARRIVAL_1164",
    event = EventType.EVENT_PLATFORM_ARRIVAL,
    source = "",
    condition = "condition_EVENT_PLATFORM_ARRIVAL_1164",
    action = "action_EVENT_PLATFORM_ARRIVAL_1164",
    trigger_count = 0
  },
  {
    config_id = 1001165,
    name = "TIME_AXIS_PASS_1165",
    event = EventType.EVENT_TIME_AXIS_PASS,
    source = "",
    condition = "condition_EVENT_TIME_AXIS_PASS_1165",
    action = "action_EVENT_TIME_AXIS_PASS_1165",
    trigger_count = 0
  },
  {
    config_id = 1001166,
    name = "PLATFORM_ARRIVAL_1166",
    event = EventType.EVENT_PLATFORM_ARRIVAL,
    source = "",
    condition = "condition_EVENT_PLATFORM_ARRIVAL_1166",
    action = "action_EVENT_PLATFORM_ARRIVAL_1166",
    trigger_count = 0
  },
  {
    config_id = 1001167,
    name = "TIME_AXIS_PASS_1167",
    event = EventType.EVENT_TIME_AXIS_PASS,
    source = "",
    condition = "condition_EVENT_TIME_AXIS_PASS_1167",
    action = "action_EVENT_TIME_AXIS_PASS_1167",
    trigger_count = 0
  },
  {
    config_id = 1001168,
    name = "PLATFORM_ARRIVAL_1168",
    event = EventType.EVENT_PLATFORM_ARRIVAL,
    source = "",
    condition = "condition_EVENT_PLATFORM_ARRIVAL_1168",
    action = "action_EVENT_PLATFORM_ARRIVAL_1168",
    trigger_count = 0
  },
  {
    config_id = 1001169,
    name = "ENTER_REGION_1169",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "",
    action = "",
  ...
  {
    config_id = 1001170,
    name = "ENTER_REGION_1170",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_1170",
    action = "action_EVENT_ENTER_REGION_1170"
  },
  {
    config_id = 1001171,
    name = "ENTER_REGION_1171",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "",
    action = "",
...
suites = {
  {
    ...
    triggers = {
      ...
      "ENTER_REGION_1148",
      "ENTER_REGION_1149",
      "PLATFORM_ARRIVAL_1155",
      "PLATFORM_ARRIVAL_1161",
      "ENTER_REGION_1162",
      "TIME_AXIS_PASS_1163",
      "PLATFORM_ARRIVAL_1164",
      "TIME_AXIS_PASS_1165",
      "PLATFORM_ARRIVAL_1166",
      "TIME_AXIS_PASS_1167",
      "PLATFORM_ARRIVAL_1168",
      "ENTER_REGION_1169",
      "ENTER_REGION_1170",
      "ENTER_REGION_1171",
      "ENTER_REGION_1172",
...
function action_EVENT_ENTER_REGION_1013(context, evt)
  local list = {
    ScriptLib.GetSceneUidList(context)
  }
  local count = 0
  ...
  if count == 1 then
    ScriptLib.AssignPlayerShowTemplateReminder(context, 209, {
      param_vec = {},
      param_uid_vec = {},
      uid_vec = {
        context.uid
...
function action_EVENT_ENTER_REGION_1131(context, evt)
  ...
  if count == 1 then
    ScriptLib.AssignPlayerShowTemplateReminder(context, 208, {
      param_vec = {},
      param_uid_vec = {},
      uid_vec = {
        context.uid
