local base_info = {group_id = 220134071}
monsters = {}
npcs = {}
gadgets = {}
regions = {
...
triggers = {
  {
    config_id = 1071001,
    name = "ENTER_REGION_71001",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_71001",
    action = "action_EVENT_ENTER_REGION_71001",
    trigger_count = 0
  },
  {
    config_id = 1071002,
    name = "ENTER_REGION_71002",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_71002",
    action = "action_EVENT_ENTER_REGION_71002",
    trigger_count = 0
  }
}
variables = {}
