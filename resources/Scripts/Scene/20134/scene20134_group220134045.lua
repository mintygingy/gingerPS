local base_info = {group_id = 220134045}
local defs = {
  gear_info = {
    [1] = {
      config_id = 45001,
...
triggers = {
  {
    config_id = 1045012,
    name = "VARIABLE_CHANGE_45012",
    event = EventType.EVENT_VARIABLE_CHANGE,
    source = "",
    condition = "condition_EVENT_VARIABLE_CHANGE_45012",
    action = "action_EVENT_VARIABLE_CHANGE_45012",
    trigger_count = 0
  }
}
variables = {}
