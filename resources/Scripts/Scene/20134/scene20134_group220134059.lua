local base_info = {group_id = 220134059}
monsters = {}
npcs = {}
gadgets = {
  {
...
triggers = {
  {
    config_id = 1059002,
    name = "ENTER_REGION_59002",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_59002",
    action = "action_EVENT_ENTER_REGION_59002",
    trigger_count = 0
  }
}
variables = {}
