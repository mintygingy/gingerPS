local base_info = {group_id = 220134053}
monsters = {}
npcs = {}
gadgets = {
  {
...
triggers = {
  {
    config_id = 1053002,
    name = "ENTER_REGION_53002",
    event = EventType.EVENT_ENTER_REGION,
    source = "",
    condition = "condition_EVENT_ENTER_REGION_53002",
    action = "action_EVENT_ENTER_REGION_53002",
    trigger_count = 0
  }
}
variables = {}
