local base_info = {group_id = 220134014}
...
regions = {
  [14009] = {
    ...
    ability_group_list = {
      "RegionAbility_Dreamland_MonaCamera"
    }
  },
  [14026] = {
    config_id = 14026,
    ...
    team_ability_group_list = {
      "MonaDreamland_Enter_TransPlayer_Handle_2"
    }
  }
}
triggers = {
  {
    config_id = 1014005,
    name = "SELECT_OPTION_14005",
    event = EventType.EVENT_SELECT_OPTION,
    source = "",
    condition = "condition_EVENT_SELECT_OPTION_14005",
    action = "action_EVENT_SELECT_OPTION_14005",
    trigger_count = 0
  },
  {
    config_id = 1014006,
    name = "SELECT_OPTION_14006",
    event = EventType.EVENT_SELECT_OPTION,
    source = "",
    condition = "condition_EVENT_SELECT_OPTION_14006",
    action = "action_EVENT_SELECT_OPTION_14006",
    trigger_count = 0
  },
  {
    config_id = 1014007,
    name = "SELECT_OPTION_14007",
    event = EventType.EVENT_SELECT_OPTION,
    source = "",
    condition = "condition_EVENT_SELECT_OPTION_14007",
    action = "action_EVENT_SELECT_OPTION_14007",
    trigger_count = 0
  },
  {
    config_id = 1014008,
    name = "VARIABLE_CHANGE_14008",
    event = EventType.EVENT_VARIABLE_CHANGE,
    source = "",
    condition = "condition_EVENT_VARIABLE_CHANGE_14008",
    action = "action_EVENT_VARIABLE_CHANGE_14008",
    trigger_count = 0
  },
  {
    config_id = 1014014,
    name = "PLATFORM_REACH_POINT_14014",
    event = EventType.EVENT_PLATFORM_REACH_POINT,
    source = "",
    condition = "condition_EVENT_PLATFORM_REACH_POINT_14014",
    action = "action_EVENT_PLATFORM_REACH_POINT_14014",
    trigger_count = 0
  },
  {
    config_id = 1014015,
    name = "PLATFORM_REACH_POINT_14015",
    event = EventType.EVENT_PLATFORM_REACH_POINT,
    source = "",
    condition = "condition_EVENT_PLATFORM_REACH_POINT_14015",
    action = "action_EVENT_PLATFORM_REACH_POINT_14015",
    trigger_count = 0
  },
  {
    config_id = 1014017,
    name = "SELECT_OPTION_14017",
    event = EventType.EVENT_SELECT_OPTION,
    source = "",
    condition = "condition_EVENT_SELECT_OPTION_14017",
    action = "action_EVENT_SELECT_OPTION_14017",
    trigger_count = 0
  },
  {
    config_id = 1014018,
    name = "SELECT_OPTION_14018",
    event = EventType.EVENT_SELECT_OPTION,
    source = "",
    condition = "condition_EVENT_SELECT_OPTION_14018",
    action = "action_EVENT_SELECT_OPTION_14018",
    trigger_count = 0
  },
  {
    config_id = 1014021,
    name = "PLATFORM_REACH_POINT_14021",
    event = EventType.EVENT_PLATFORM_REACH_POINT,
    source = "",
    condition = "condition_EVENT_PLATFORM_REACH_POINT_14021",
    action = "action_EVENT_PLATFORM_REACH_POINT_14021",
    trigger_count = 0
  },
  {
    config_id = 1014022,
    name = "PLATFORM_REACH_POINT_14022",
    event = EventType.EVENT_PLATFORM_REACH_POINT,
    source = "",
    condition = "condition_EVENT_PLATFORM_REACH_POINT_14022",
    action = "action_EVENT_PLATFORM_REACH_POINT_14022",
    trigger_count = 0
  },
  {
    config_id = 1014023,
    name = "PLATFORM_REACH_POINT_14023",
    event = EventType.EVENT_PLATFORM_REACH_POINT,
    source = "",
    condition = "condition_EVENT_PLATFORM_REACH_POINT_14023",
    action = "action_EVENT_PLATFORM_REACH_POINT_14023",
    trigger_count = 0
  },
  {
    config_id = 1014024,
    name = "PLATFORM_REACH_POINT_14024",
    event = EventType.EVENT_PLATFORM_REACH_POINT,
    source = "",
    condition = "condition_EVENT_PLATFORM_REACH_POINT_14024",
    action = "action_EVENT_PLATFORM_REACH_POINT_14024",
    trigger_count = 0
  },
  {
    config_id = 1014025,
    name = "SELECT_OPTION_14025",
    event = EventType.EVENT_SELECT_OPTION,
    source = "",
    condition = "condition_EVENT_SELECT_OPTION_14025",
    action = "action_EVENT_SELECT_OPTION_14025",
    trigger_count = 0
  },
  {
    config_id = 1014027,
    name = "PLATFORM_REACH_POINT_14027",
    event = EventType.EVENT_PLATFORM_REACH_POINT,
    source = "",
    condition = "condition_EVENT_PLATFORM_REACH_POINT_14027",
    action = "action_EVENT_PLATFORM_REACH_POINT_14027",
    trigger_count = 0
  },
  {
    config_id = 1014028,
    name = "GROUP_LOAD_14028",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "",
    action = "action_EVENT_GROUP_LOAD_14028",
    trigger_count = 0
  }
}
variables = {
...
suites = {
  {
    ...
    triggers = {
      ...
      "SELECT_OPTION_14006",
      "SELECT_OPTION_14007",
      "VARIABLE_CHANGE_14008",
      "PLATFORM_REACH_POINT_14014",
      "PLATFORM_REACH_POINT_14015",
      "SELECT_OPTION_14017",
      "SELECT_OPTION_14018",
      "PLATFORM_REACH_POINT_14021",
      "PLATFORM_REACH_POINT_14022",
      "PLATFORM_REACH_POINT_14023",
      "PLATFORM_REACH_POINT_14024",
      "SELECT_OPTION_14025",
      "PLATFORM_REACH_POINT_14027",
      "GROUP_LOAD_14028"
    },
    rand_weight = 100
  },
