local base_info = {group_id = 220134056}
local defs = {
  is_movable = 1,
  patterns = {
    [1] = {
...
triggers = {
  {
    config_id = 1056009,
    name = "GROUP_LOAD_56009",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "condition_EVENT_GROUP_LOAD_56009",
    action = "action_EVENT_GROUP_LOAD_56009",
    trigger_count = 0
  },
  {
    config_id = 1056010,
    name = "GROUP_LOAD_56010",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "condition_EVENT_GROUP_LOAD_56010",
    action = "action_EVENT_GROUP_LOAD_56010",
    trigger_count = 0
  },
  {
    config_id = 1056011,
    name = "GROUP_LOAD_56011",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "condition_EVENT_GROUP_LOAD_56011",
    action = "action_EVENT_GROUP_LOAD_56011",
    trigger_count = 0
  }
}
variables = {
