local base_info = {group_id = 220138012}
monsters = {}
npcs = {}
gadgets = {
  {
...
triggers = {
  ...
  {
    config_id = 1012022,
    name = "OBSERVATION_POINT_NOTIFY_12022",
    event = EventType.EVENT_OBSERVATION_POINT_NOTIFY,
    source = "",
    condition = "",
    action = "action_EVENT_OBSERVATION_POINT_NOTIFY_12022",
    trigger_count = 0
  },
  {
    config_id = 1012023,
    name = "GROUP_LOAD_12023",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "condition_EVENT_GROUP_LOAD_12023",
    action = "action_EVENT_GROUP_LOAD_12023",
    trigger_count = 0
  }
}
variables = {}
...
suites = {
  {
    ...
    triggers = {
      ...
      "OBSERVATION_POINT_NOTIFY_12022",
      "GROUP_LOAD_12023"
    },
    rand_weight = 100
  },
