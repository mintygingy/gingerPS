local base_info = {group_id = 220138019}
monsters = {}
npcs = {}
gadgets = {}
regions = {}
...
garbages = {
  ...
  triggers = {
    ...
    {
      config_id = 1019009,
      name = "GADGET_STATE_CHANGE_19009",
      event = EventType.EVENT_GADGET_STATE_CHANGE,
      source = "",
      condition = "condition_EVENT_GADGET_STATE_CHANGE_19009",
      action = "action_EVENT_GADGET_STATE_CHANGE_19009",
      trigger_count = 0
    },
    {
      config_id = 1019010,
      name = "PLATFORM_ARRIVAL_19010",
      event = EventType.EVENT_PLATFORM_ARRIVAL,
      source = "",
      condition = "condition_EVENT_PLATFORM_ARRIVAL_19010",
      action = "action_EVENT_PLATFORM_ARRIVAL_19010",
      trigger_count = 0
    },
    {
      config_id = 1019011,
      name = "PLATFORM_ARRIVAL_19011",
      event = EventType.EVENT_PLATFORM_ARRIVAL,
      source = "",
      condition = "condition_EVENT_PLATFORM_ARRIVAL_19011",
      action = "action_EVENT_PLATFORM_ARRIVAL_19011",
      trigger_count = 0
    },
    {
      config_id = 1019012,
      name = "GADGET_CREATE_19012",
      event = EventType.EVENT_GADGET_CREATE,
      source = "",
      condition = "condition_EVENT_GADGET_CREATE_19012",
      action = "action_EVENT_GADGET_CREATE_19012",
      trigger_count = 0
    }
  }
}
