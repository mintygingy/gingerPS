local base_info = {group_id = 220138015}
local defs = {
  rotate_queue = {
    1,
    2,
...
triggers = {
  {
    config_id = 1015001,
    name = "VARIABLE_CHANGE_15001",
    event = EventType.EVENT_VARIABLE_CHANGE,
    source = "",
    condition = "condition_EVENT_VARIABLE_CHANGE_15001",
    action = "action_EVENT_VARIABLE_CHANGE_15001",
    trigger_count = 0
  },
  {
    config_id = 1015002,
    name = "VARIABLE_CHANGE_15002",
    event = EventType.EVENT_VARIABLE_CHANGE,
    source = "",
    condition = "condition_EVENT_VARIABLE_CHANGE_15002",
    action = "action_EVENT_VARIABLE_CHANGE_15002",
    trigger_count = 0
  },
  {
    config_id = 1015003,
    name = "VARIABLE_CHANGE_15003",
    event = EventType.EVENT_VARIABLE_CHANGE,
    source = "",
    condition = "condition_EVENT_VARIABLE_CHANGE_15003",
    action = "action_EVENT_VARIABLE_CHANGE_15003",
    trigger_count = 0
  },
  {
    config_id = 1015007,
    name = "GADGET_CREATE_15007",
    event = EventType.EVENT_GADGET_CREATE,
    source = "",
    condition = "condition_EVENT_GADGET_CREATE_15007",
    action = "action_EVENT_GADGET_CREATE_15007",
    trigger_count = 0
  },
  {
    config_id = 1015008,
    name = "GADGET_CREATE_15008",
    event = EventType.EVENT_GADGET_CREATE,
    source = "",
    condition = "condition_EVENT_GADGET_CREATE_15008",
    action = "action_EVENT_GADGET_CREATE_15008",
    trigger_count = 0
  },
  {
    config_id = 1015009,
  ...
  {
    config_id = 1015010,
    name = "SELECT_OPTION_15010",
    event = EventType.EVENT_SELECT_OPTION,
    source = "",
    condition = "condition_EVENT_SELECT_OPTION_15010",
    action = "action_EVENT_SELECT_OPTION_15010",
    trigger_count = 0
  },
  {
    config_id = 1015011,
    name = "SELECT_OPTION_15011",
    event = EventType.EVENT_SELECT_OPTION,
    source = "",
    condition = "condition_EVENT_SELECT_OPTION_15011",
    action = "action_EVENT_SELECT_OPTION_15011",
    trigger_count = 0
  },
  {
    config_id = 1015012,
    name = "SELECT_OPTION_15012",
    event = EventType.EVENT_SELECT_OPTION,
    source = "",
    condition = "condition_EVENT_SELECT_OPTION_15012",
    action = "action_EVENT_SELECT_OPTION_15012",
    trigger_count = 0
  },
  {
    config_id = 1015013,
    name = "VARIABLE_CHANGE_15013",
    event = EventType.EVENT_VARIABLE_CHANGE,
    source = "",
    condition = "condition_EVENT_VARIABLE_CHANGE_15013",
    action = "action_EVENT_VARIABLE_CHANGE_15013",
    trigger_count = 0
  },
  {
    config_id = 1015017,
    name = "OBSERVATION_POINT_NOTIFY_15017",
    event = EventType.EVENT_OBSERVATION_POINT_NOTIFY,
    source = "",
    condition = "",
    action = "action_EVENT_OBSERVATION_POINT_NOTIFY_15017",
    trigger_count = 0
  },
  {
    config_id = 1015019,
    name = "GADGET_STATE_CHANGE_15019",
    event = EventType.EVENT_GADGET_STATE_CHANGE,
    source = "",
    condition = "condition_EVENT_GADGET_STATE_CHANGE_15019",
    action = "action_EVENT_GADGET_STATE_CHANGE_15019",
    trigger_count = 0
  },
  {
    config_id = 1015020,
    name = "SELECT_OPTION_15020",
    event = EventType.EVENT_SELECT_OPTION,
    source = "",
    condition = "condition_EVENT_SELECT_OPTION_15020",
    action = "action_EVENT_SELECT_OPTION_15020"
  },
  {
    config_id = 1015021,
    name = "SELECT_OPTION_15021",
    event = EventType.EVENT_SELECT_OPTION,
    source = "",
    condition = "condition_EVENT_SELECT_OPTION_15021",
    action = "action_EVENT_SELECT_OPTION_15021"
  },
  {
    config_id = 1015022,
    name = "SELECT_OPTION_15022",
    event = EventType.EVENT_SELECT_OPTION,
    source = "",
    condition = "condition_EVENT_SELECT_OPTION_15022",
    action = "action_EVENT_SELECT_OPTION_15022"
  },
  {
    config_id = 1015024,
    name = "OBSERVATION_POINT_NOTIFY_15024",
    event = EventType.EVENT_OBSERVATION_POINT_NOTIFY,
    source = "",
    condition = "",
    action = "action_EVENT_OBSERVATION_POINT_NOTIFY_15024",
    trigger_count = 0
  },
  {
    config_id = 1015025,
    name = "PLATFORM_ARRIVAL_15025",
    event = EventType.EVENT_PLATFORM_ARRIVAL,
    source = "",
    condition = "",
    action = "action_EVENT_PLATFORM_ARRIVAL_15025",
    trigger_count = 0
  },
  {
    config_id = 1015026,
    name = "GROUP_LOAD_15026",
    event = EventType.EVENT_GROUP_LOAD,
    source = "",
    condition = "",
    action = "action_EVENT_GROUP_LOAD_15026",
    trigger_count = 0
  }
}
variables = {
...
suites = {
  {
    ...
    regions = {},
    triggers = {
      "VARIABLE_CHANGE_15001",
      "VARIABLE_CHANGE_15002",
      "VARIABLE_CHANGE_15003",
      "GADGET_CREATE_15007",
      "GADGET_CREATE_15008",
      "GADGET_CREATE_15009",
      "SELECT_OPTION_15010",
      "SELECT_OPTION_15011",
      "SELECT_OPTION_15012",
      "VARIABLE_CHANGE_15013",
      "OBSERVATION_POINT_NOTIFY_15017",
      "GADGET_STATE_CHANGE_15019",
      "SELECT_OPTION_15020",
      "SELECT_OPTION_15021",
      "SELECT_OPTION_15022",
      "OBSERVATION_POINT_NOTIFY_15024",
      "PLATFORM_ARRIVAL_15025",
      "GROUP_LOAD_15026"
    },
    rand_weight = 100
  }
...
function action_EVENT_SELECT_OPTION_15010(context, evt)
  ...
  if 0 ~= ScriptLib.SetPlatformPointArray(context, 15014, 3, {
    defs.rotate_queue[next_index]
  }, tempParam) then
