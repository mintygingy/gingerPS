local base_info = {group_id = 247102001}
local defs = {
...
triggers = {
  {
    config_id = 1001023,
    name = "ANY_MONSTER_DIE_1023",
    event = EventType.EVENT_ANY_MONSTER_DIE,
    source = "",
    condition = "condition_EVENT_ANY_MONSTER_DIE_1023",
    action = "action_EVENT_ANY_MONSTER_DIE_1023"
  },
  {
    config_id = 1001024,
    name = "ANY_MONSTER_LIVE_1024",
    event = EventType.EVENT_ANY_MONSTER_LIVE,
    source = "",
    condition = "condition_EVENT_ANY_MONSTER_LIVE_1024",
    action = "action_EVENT_ANY_MONSTER_LIVE_1024"
  }
}
points = {
  {
...
suites = {
  ...
  },
  {
    ...
    regions = {},
    triggers = {
      "ANY_MONSTER_DIE_1023",
      "ANY_MONSTER_LIVE_1024"
    },
    rand_weight = 100
  },
  {
