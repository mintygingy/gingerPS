local base_info = {group_id = 247201001}
local defs = {
  elevatorRegion = 1016,
...
triggers = {
  ...
  },
  {
    ...
    source = "",
    condition = "condition_EVENT_ENTER_REGION_1023",
    action = "action_EVENT_ENTER_REGION_1023"
  },
  {
    config_id = 1001024,
  ...
  {
    config_id = 1001038,
    name = "DUNGEON_SETTLE_1038",
    event = EventType.EVENT_DUNGEON_SETTLE,
    source = "",
    condition = "",
    action = "action_EVENT_DUNGEON_SETTLE_1038"
  }
}
variables = {
  {
...
function action_EVENT_VARIABLE_CHANGE_1025(context, evt)
  ...
  elseif TLC_check_variable_equal_1(context, evt, "KeyRoom1") and TLC_check_variable_equal_1(context, evt, "KeyRoom3") then
