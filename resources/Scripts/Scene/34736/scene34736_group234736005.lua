local base_info = {group_id = 234736005}
monsters = {
  {
    config_id = 5002,
    monster_id = 24020201,
...
triggers = {
  {
    config_id = 1005001,
    name = "ANY_MONSTER_LIVE_5001",
    event = EventType.EVENT_ANY_MONSTER_LIVE,
    source = "",
    condition = "condition_EVENT_ANY_MONSTER_LIVE_5001",
    action = "action_EVENT_ANY_MONSTER_LIVE_5001"
  },
  {
    config_id = 1005004,
